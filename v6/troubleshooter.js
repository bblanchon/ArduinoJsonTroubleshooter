(function(){"use strict";function ln(e,s){const n=Object.create(null),t=e.split(",");for(let o=0;o<t.length;o++)n[t[o]]=!0;return s?o=>!!n[o.toLowerCase()]:o=>!!n[o]}const B={},ts=[],ve=()=>{},$o=()=>!1,Ko=/^on[^a-z]/,Ds=e=>Ko.test(e),cn=e=>e.startsWith("onUpdate:"),Z=Object.assign,pn=(e,s)=>{const n=e.indexOf(s);n>-1&&e.splice(n,1)},Go=Object.prototype.hasOwnProperty,E=(e,s)=>Go.call(e,s),D=Array.isArray,os=e=>xs(e)==="[object Map]",rt=e=>xs(e)==="[object Set]",I=e=>typeof e=="function",Q=e=>typeof e=="string",un=e=>typeof e=="symbol",M=e=>e!==null&&typeof e=="object",lt=e=>M(e)&&I(e.then)&&I(e.catch),ct=Object.prototype.toString,xs=e=>ct.call(e),Xo=e=>xs(e).slice(8,-1),pt=e=>xs(e)==="[object Object]",dn=e=>Q(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,Ns=ln(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),zs=e=>{const s=Object.create(null);return n=>s[n]||(s[n]=e(n))},Zo=/-(\w)/g,Se=zs(e=>e.replace(Zo,(s,n)=>n?n.toUpperCase():"")),Qo=/\B([A-Z])/g,as=zs(e=>e.replace(Qo,"-$1").toLowerCase()),Is=zs(e=>e.charAt(0).toUpperCase()+e.slice(1)),hn=zs(e=>e?`on${Is(e)}`:""),Os=(e,s)=>!Object.is(e,s),mn=(e,s)=>{for(let n=0;n<e.length;n++)e[n](s)},Cs=(e,s,n)=>{Object.defineProperty(e,s,{configurable:!0,enumerable:!1,value:n})},ea=e=>{const s=parseFloat(e);return isNaN(s)?e:s},sa=e=>{const s=Q(e)?Number(e):NaN;return isNaN(s)?e:s};let ut;const fn=()=>ut||(ut=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function gn(e){if(D(e)){const s={};for(let n=0;n<e.length;n++){const t=e[n],o=Q(t)?aa(t):gn(t);if(o)for(const a in o)s[a]=o[a]}return s}else{if(Q(e))return e;if(M(e))return e}}const na=/;(?![^(]*\))/g,ta=/:([^]+)/,oa=/\/\*[^]*?\*\//g;function aa(e){const s={};return e.replace(oa,"").split(na).forEach(n=>{if(n){const t=n.split(ta);t.length>1&&(s[t[0].trim()]=t[1].trim())}}),s}function fs(e){let s="";if(Q(e))s=e;else if(D(e))for(let n=0;n<e.length;n++){const t=fs(e[n]);t&&(s+=t+" ")}else if(M(e))for(const n in e)e[n]&&(s+=n+" ");return s.trim()}const ia=ln("itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly");function dt(e){return!!e||e===""}const Es=e=>Q(e)?e:e==null?"":D(e)||M(e)&&(e.toString===ct||!I(e.toString))?JSON.stringify(e,ht,2):String(e),ht=(e,s)=>s&&s.__v_isRef?ht(e,s.value):os(s)?{[`Map(${s.size})`]:[...s.entries()].reduce((n,[t,o])=>(n[`${t} =>`]=o,n),{})}:rt(s)?{[`Set(${s.size})`]:[...s.values()]}:M(s)&&!D(s)&&!pt(s)?String(s):s;let je;class ra{constructor(s=!1){this.detached=s,this._active=!0,this.effects=[],this.cleanups=[],this.parent=je,!s&&je&&(this.index=(je.scopes||(je.scopes=[])).push(this)-1)}get active(){return this._active}run(s){if(this._active){const n=je;try{return je=this,s()}finally{je=n}}}on(){je=this}off(){je=this.parent}stop(s){if(this._active){let n,t;for(n=0,t=this.effects.length;n<t;n++)this.effects[n].stop();for(n=0,t=this.cleanups.length;n<t;n++)this.cleanups[n]();if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!s){const o=this.parent.scopes.pop();o&&o!==this&&(this.parent.scopes[this.index]=o,o.index=this.index)}this.parent=void 0,this._active=!1}}}function la(e,s=je){s&&s.active&&s.effects.push(e)}function ca(){return je}const yn=e=>{const s=new Set(e);return s.w=0,s.n=0,s},mt=e=>(e.w&Re)>0,ft=e=>(e.n&Re)>0,pa=({deps:e})=>{if(e.length)for(let s=0;s<e.length;s++)e[s].w|=Re},ua=e=>{const{deps:s}=e;if(s.length){let n=0;for(let t=0;t<s.length;t++){const o=s[t];mt(o)&&!ft(o)?o.delete(e):s[n++]=o,o.w&=~Re,o.n&=~Re}s.length=n}},bn=new WeakMap;let gs=0,Re=1;const vn=30;let we;const We=Symbol(""),jn=Symbol("");class wn{constructor(s,n=null,t){this.fn=s,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,la(this,t)}run(){if(!this.active)return this.fn();let s=we,n=Fe;for(;s;){if(s===this)return;s=s.parent}try{return this.parent=we,we=this,Fe=!0,Re=1<<++gs,gs<=vn?pa(this):gt(this),this.fn()}finally{gs<=vn&&ua(this),Re=1<<--gs,we=this.parent,Fe=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){we===this?this.deferStop=!0:this.active&&(gt(this),this.onStop&&this.onStop(),this.active=!1)}}function gt(e){const{deps:s}=e;if(s.length){for(let n=0;n<s.length;n++)s[n].delete(e);s.length=0}}let Fe=!0;const yt=[];function is(){yt.push(Fe),Fe=!1}function rs(){const e=yt.pop();Fe=e===void 0?!0:e}function pe(e,s,n){if(Fe&&we){let t=bn.get(e);t||bn.set(e,t=new Map);let o=t.get(n);o||t.set(n,o=yn()),bt(o)}}function bt(e,s){let n=!1;gs<=vn?ft(e)||(e.n|=Re,n=!mt(e)):n=!e.has(we),n&&(e.add(we),we.deps.push(e))}function Ce(e,s,n,t,o,a){const i=bn.get(e);if(!i)return;let l=[];if(s==="clear")l=[...i.values()];else if(n==="length"&&D(e)){const c=Number(t);i.forEach((u,h)=>{(h==="length"||h>=c)&&l.push(u)})}else switch(n!==void 0&&l.push(i.get(n)),s){case"add":D(e)?dn(n)&&l.push(i.get("length")):(l.push(i.get(We)),os(e)&&l.push(i.get(jn)));break;case"delete":D(e)||(l.push(i.get(We)),os(e)&&l.push(i.get(jn)));break;case"set":os(e)&&l.push(i.get(We));break}if(l.length===1)l[0]&&Jn(l[0]);else{const c=[];for(const u of l)u&&c.push(...u);Jn(yn(c))}}function Jn(e,s){const n=D(e)?e:[...e];for(const t of n)t.computed&&vt(t);for(const t of n)t.computed||vt(t)}function vt(e,s){(e!==we||e.allowRecurse)&&(e.scheduler?e.scheduler():e.run())}const da=ln("__proto__,__v_isRef,__isVue"),jt=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(un)),ha=_n(),ma=_n(!1,!0),fa=_n(!0),wt=ya();function ya(){const e={};return["includes","indexOf","lastIndexOf"].forEach(s=>{e[s]=function(...n){const t=q(this);for(let a=0,i=this.length;a<i;a++)pe(t,"get",a+"");const o=t[s](...n);return o===-1||o===!1?t[s](...n.map(q)):o}}),["push","pop","shift","unshift","splice"].forEach(s=>{e[s]=function(...n){is();const t=q(this)[s].apply(this,n);return rs(),t}}),e}function ba(e){const s=q(this);return pe(s,"has",e),s.hasOwnProperty(e)}function _n(e=!1,s=!1){return function(t,o,a){if(o==="__v_isReactive")return!e;if(o==="__v_isReadonly")return e;if(o==="__v_isShallow")return s;if(o==="__v_raw"&&a===(e?s?Ca:Nt:s?xt:Dt).get(t))return t;const i=D(t);if(!e){if(i&&E(wt,o))return Reflect.get(wt,o,a);if(o==="hasOwnProperty")return ba}const l=Reflect.get(t,o,a);return(un(o)?jt.has(o):da(o))||(e||pe(t,"get",o),s)?l:re(l)?i&&dn(o)?l:l.value:M(l)?e?zt(l):kn(l):l}}const va=Jt(),ja=Jt(!0);function Jt(e=!1){return function(n,t,o,a){let i=n[t];if(ys(i)&&re(i)&&!re(o))return!1;if(!e&&(!Dn(o)&&!ys(o)&&(i=q(i),o=q(o)),!D(n)&&re(i)&&!re(o)))return i.value=o,!0;const l=D(n)&&dn(t)?Number(t)<n.length:E(n,t),c=Reflect.set(n,t,o,a);return n===q(a)&&(l?Os(o,i)&&Ce(n,"set",t,o):Ce(n,"add",t,o)),c}}function wa(e,s){const n=E(e,s);e[s];const t=Reflect.deleteProperty(e,s);return t&&n&&Ce(e,"delete",s,void 0),t}function Ja(e,s){const n=Reflect.has(e,s);return(!un(s)||!jt.has(s))&&pe(e,"has",s),n}function _a(e){return pe(e,"iterate",D(e)?"length":We),Reflect.ownKeys(e)}const _t={get:ha,set:va,deleteProperty:wa,has:Ja,ownKeys:_a},Ta={get:fa,set(e,s){return!0},deleteProperty(e,s){return!0}},Sa=Z({},_t,{get:ma,set:ja}),Tn=e=>e,Ps=e=>Reflect.getPrototypeOf(e);function qs(e,s,n=!1,t=!1){e=e.__v_raw;const o=q(e),a=q(s);n||(s!==a&&pe(o,"get",s),pe(o,"get",a));const{has:i}=Ps(o),l=t?Tn:n?Nn:xn;if(i.call(o,s))return l(e.get(s));if(i.call(o,a))return l(e.get(a));e!==o&&e.get(s)}function Rs(e,s=!1){const n=this.__v_raw,t=q(n),o=q(e);return s||(e!==o&&pe(t,"has",e),pe(t,"has",o)),e===o?n.has(e):n.has(e)||n.has(o)}function Fs(e,s=!1){return e=e.__v_raw,!s&&pe(q(e),"iterate",We),Reflect.get(e,"size",e)}function Tt(e){e=q(e);const s=q(this);return Ps(s).has.call(s,e)||(s.add(e),Ce(s,"add",e,e)),this}function St(e,s){s=q(s);const n=q(this),{has:t,get:o}=Ps(n);let a=t.call(n,e);a||(e=q(e),a=t.call(n,e));const i=o.call(n,e);return n.set(e,s),a?Os(s,i)&&Ce(n,"set",e,s):Ce(n,"add",e,s),this}function kt(e){const s=q(this),{has:n,get:t}=Ps(s);let o=n.call(s,e);o||(e=q(e),o=n.call(s,e)),t&&t.call(s,e);const a=s.delete(e);return o&&Ce(s,"delete",e,void 0),a}function At(){const e=q(this),s=e.size!==0,n=e.clear();return s&&Ce(e,"clear",void 0,void 0),n}function Hs(e,s){return function(t,o){const a=this,i=a.__v_raw,l=q(i),c=s?Tn:e?Nn:xn;return!e&&pe(l,"iterate",We),i.forEach((u,h)=>t.call(o,c(u),c(h),a))}}function Ms(e,s,n){return function(...t){const o=this.__v_raw,a=q(o),i=os(a),l=e==="entries"||e===Symbol.iterator&&i,c=e==="keys"&&i,u=o[e](...t),h=n?Tn:s?Nn:xn;return!s&&pe(a,"iterate",c?jn:We),{next(){const{value:y,done:j}=u.next();return j?{value:y,done:j}:{value:l?[h(y[0]),h(y[1])]:h(y),done:j}},[Symbol.iterator](){return this}}}}function He(e){return function(...s){return e==="delete"?!1:this}}function ka(){const e={get(a){return qs(this,a)},get size(){return Fs(this)},has:Rs,add:Tt,set:St,delete:kt,clear:At,forEach:Hs(!1,!1)},s={get(a){return qs(this,a,!1,!0)},get size(){return Fs(this)},has:Rs,add:Tt,set:St,delete:kt,clear:At,forEach:Hs(!1,!0)},n={get(a){return qs(this,a,!0)},get size(){return Fs(this,!0)},has(a){return Rs.call(this,a,!0)},add:He("add"),set:He("set"),delete:He("delete"),clear:He("clear"),forEach:Hs(!0,!1)},t={get(a){return qs(this,a,!0,!0)},get size(){return Fs(this,!0)},has(a){return Rs.call(this,a,!0)},add:He("add"),set:He("set"),delete:He("delete"),clear:He("clear"),forEach:Hs(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(a=>{e[a]=Ms(a,!1,!1),n[a]=Ms(a,!0,!1),s[a]=Ms(a,!1,!0),t[a]=Ms(a,!0,!0)}),[e,n,s,t]}const[Aa,Da,xa,Na]=ka();function Sn(e,s){const n=s?e?Na:xa:e?Da:Aa;return(t,o,a)=>o==="__v_isReactive"?!e:o==="__v_isReadonly"?e:o==="__v_raw"?t:Reflect.get(E(n,o)&&o in t?n:t,o,a)}const za={get:Sn(!1,!1)},Ia={get:Sn(!1,!0)},Oa={get:Sn(!0,!1)},Dt=new WeakMap,xt=new WeakMap,Nt=new WeakMap,Ca=new WeakMap;function Ea(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Pa(e){return e.__v_skip||!Object.isExtensible(e)?0:Ea(Xo(e))}function kn(e){return ys(e)?e:An(e,!1,_t,za,Dt)}function qa(e){return An(e,!1,Sa,Ia,xt)}function zt(e){return An(e,!0,Ta,Oa,Nt)}function An(e,s,n,t,o){if(!M(e)||e.__v_raw&&!(s&&e.__v_isReactive))return e;const a=o.get(e);if(a)return a;const i=Pa(e);if(i===0)return e;const l=new Proxy(e,i===2?t:n);return o.set(e,l),l}function ls(e){return ys(e)?ls(e.__v_raw):!!(e&&e.__v_isReactive)}function ys(e){return!!(e&&e.__v_isReadonly)}function Dn(e){return!!(e&&e.__v_isShallow)}function It(e){return ls(e)||ys(e)}function q(e){const s=e&&e.__v_raw;return s?q(s):e}function Ot(e){return Cs(e,"__v_skip",!0),e}const xn=e=>M(e)?kn(e):e,Nn=e=>M(e)?zt(e):e;function Ra(e){Fe&&we&&(e=q(e),bt(e.dep||(e.dep=yn())))}function Fa(e,s){e=q(e);const n=e.dep;n&&Jn(n)}function re(e){return!!(e&&e.__v_isRef===!0)}function Ha(e){return re(e)?e.value:e}const Ma={get:(e,s,n)=>Ha(Reflect.get(e,s,n)),set:(e,s,n,t)=>{const o=e[s];return re(o)&&!re(n)?(o.value=n,!0):Reflect.set(e,s,n,t)}};function Ct(e){return ls(e)?e:new Proxy(e,Ma)}class Ya{constructor(s,n,t,o){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this._dirty=!0,this.effect=new wn(s,()=>{this._dirty||(this._dirty=!0,Fa(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!o,this.__v_isReadonly=t}get value(){const s=q(this);return Ra(s),(s._dirty||!s._cacheable)&&(s._dirty=!1,s._value=s.effect.run()),s._value}set value(s){this._setter(s)}}function Ua(e,s,n=!1){let t,o;const a=I(e);return a?(t=e,o=ve):(t=e.get,o=e.set),new Ya(t,o,a||!o,n)}function dl(e,...s){}function Me(e,s,n,t){let o;try{o=t?e(...t):e()}catch(a){Ys(a,s,n)}return o}function fe(e,s,n,t){if(I(e)){const a=Me(e,s,n,t);return a&&lt(a)&&a.catch(i=>{Ys(i,s,n)}),a}const o=[];for(let a=0;a<e.length;a++)o.push(fe(e[a],s,n,t));return o}function Ys(e,s,n,t=!0){const o=s?s.vnode:null;if(s){let a=s.parent;const i=s.proxy,l=n;for(;a;){const u=a.ec;if(u){for(let h=0;h<u.length;h++)if(u[h](e,i,l)===!1)return}a=a.parent}const c=s.appContext.config.errorHandler;if(c){Me(c,null,10,[e,i,l]);return}}Ba(e,n,o,t)}function Ba(e,s,n,t=!0){console.error(e)}let bs=!1,zn=!1;const ae=[];let ke=0;const cs=[];let Ee=null,Ve=0;const Et=Promise.resolve();let In=null;function La(e){const s=In||Et;return e?s.then(this?e.bind(this):e):s}function Wa(e){let s=ke+1,n=ae.length;for(;s<n;){const t=s+n>>>1;vs(ae[t])<e?s=t+1:n=t}return s}function On(e){(!ae.length||!ae.includes(e,bs&&e.allowRecurse?ke+1:ke))&&(e.id==null?ae.push(e):ae.splice(Wa(e.id),0,e),Pt())}function Pt(){!bs&&!zn&&(zn=!0,In=Et.then(Ft))}function Va(e){const s=ae.indexOf(e);s>ke&&ae.splice(s,1)}function $a(e){D(e)?cs.push(...e):(!Ee||!Ee.includes(e,e.allowRecurse?Ve+1:Ve))&&cs.push(e),Pt()}function qt(e,s=bs?ke+1:0){for(;s<ae.length;s++){const n=ae[s];n&&n.pre&&(ae.splice(s,1),s--,n())}}function Rt(e){if(cs.length){const s=[...new Set(cs)];if(cs.length=0,Ee){Ee.push(...s);return}for(Ee=s,Ee.sort((n,t)=>vs(n)-vs(t)),Ve=0;Ve<Ee.length;Ve++)Ee[Ve]();Ee=null,Ve=0}}const vs=e=>e.id==null?1/0:e.id,Ka=(e,s)=>{const n=vs(e)-vs(s);if(n===0){if(e.pre&&!s.pre)return-1;if(s.pre&&!e.pre)return 1}return n};function Ft(e){zn=!1,bs=!0,ae.sort(Ka);const s=ve;try{for(ke=0;ke<ae.length;ke++){const n=ae[ke];n&&n.active!==!1&&Me(n,null,14)}}finally{ke=0,ae.length=0,Rt(),bs=!1,In=null,(ae.length||cs.length)&&Ft()}}function Ga(e,s,...n){if(e.isUnmounted)return;const t=e.vnode.props||B;let o=n;const a=s.startsWith("update:"),i=a&&s.slice(7);if(i&&i in t){const h=`${i==="modelValue"?"model":i}Modifiers`,{number:y,trim:j}=t[h]||B;j&&(o=n.map(A=>Q(A)?A.trim():A)),y&&(o=n.map(ea))}let l,c=t[l=hn(s)]||t[l=hn(Se(s))];!c&&a&&(c=t[l=hn(as(s))]),c&&fe(c,e,6,o);const u=t[l+"Once"];if(u){if(!e.emitted)e.emitted={};else if(e.emitted[l])return;e.emitted[l]=!0,fe(u,e,6,o)}}function Ht(e,s,n=!1){const t=s.emitsCache,o=t.get(e);if(o!==void 0)return o;const a=e.emits;let i={},l=!1;if(!I(e)){const c=u=>{const h=Ht(u,s,!0);h&&(l=!0,Z(i,h))};!n&&s.mixins.length&&s.mixins.forEach(c),e.extends&&c(e.extends),e.mixins&&e.mixins.forEach(c)}return!a&&!l?(M(e)&&t.set(e,null),null):(D(a)?a.forEach(c=>i[c]=null):Z(i,a),M(e)&&t.set(e,i),i)}function Us(e,s){return!e||!Ds(s)?!1:(s=s.slice(2).replace(/Once$/,""),E(e,s[0].toLowerCase()+s.slice(1))||E(e,as(s))||E(e,s))}let ge=null,Mt=null;function Bs(e){const s=ge;return ge=e,Mt=e&&e.type.__scopeId||null,s}function Yt(e,s=ge,n){if(!s||e._n)return e;const t=(...o)=>{t._d&&jo(-1);const a=Bs(s);let i;try{i=e(...o)}finally{Bs(a),t._d&&jo(1)}return i};return t._n=!0,t._c=!0,t._d=!0,t}function hl(){}function Cn(e){const{type:s,vnode:n,proxy:t,withProxy:o,props:a,propsOptions:[i],slots:l,attrs:c,emit:u,render:h,renderCache:y,data:j,setupState:A,ctx:P,inheritAttrs:x}=e;let Y,L;const W=Bs(e);try{if(n.shapeFlag&4){const N=o||t;Y=De(h.call(N,N,y,a,A,j,P)),L=c}else{const N=s;Y=De(N.length>1?N(a,{attrs:c,slots:l,emit:u}):N(a,null)),L=s.props?c:Xa(c)}}catch(N){Js.length=0,Ys(N,e,1),Y=ce(Je)}let V=Y;if(L&&x!==!1){const N=Object.keys(L),{shapeFlag:te}=V;N.length&&te&7&&(i&&N.some(cn)&&(L=Za(L,i)),V=Ye(V,L))}return n.dirs&&(V=Ye(V),V.dirs=V.dirs?V.dirs.concat(n.dirs):n.dirs),n.transition&&(V.transition=n.transition),Y=V,Bs(W),Y}const Xa=e=>{let s;for(const n in e)(n==="class"||n==="style"||Ds(n))&&((s||(s={}))[n]=e[n]);return s},Za=(e,s)=>{const n={};for(const t in e)(!cn(t)||!(t.slice(9)in s))&&(n[t]=e[t]);return n};function Qa(e,s,n){const{props:t,children:o,component:a}=e,{props:i,children:l,patchFlag:c}=s,u=a.emitsOptions;if(s.dirs||s.transition)return!0;if(n&&c>=0){if(c&1024)return!0;if(c&16)return t?Ut(t,i,u):!!i;if(c&8){const h=s.dynamicProps;for(let y=0;y<h.length;y++){const j=h[y];if(i[j]!==t[j]&&!Us(u,j))return!0}}}else return(o||l)&&(!l||!l.$stable)?!0:t===i?!1:t?i?Ut(t,i,u):!0:!!i;return!1}function Ut(e,s,n){const t=Object.keys(s);if(t.length!==Object.keys(e).length)return!0;for(let o=0;o<t.length;o++){const a=t[o];if(s[a]!==e[a]&&!Us(n,a))return!0}return!1}function ei({vnode:e,parent:s},n){for(;s&&s.subTree===e;)(e=s.vnode).el=n,s=s.parent}const si=e=>e.__isSuspense;function ni(e,s){s&&s.pendingBranch?D(e)?s.effects.push(...e):s.effects.push(e):$a(e)}const Ls={};function En(e,s,n){return Bt(e,s,n)}function Bt(e,s,{immediate:n,deep:t,flush:o,onTrack:a,onTrigger:i}=B){var l;const c=ca()===((l=ne)==null?void 0:l.scope)?ne:null;let u,h=!1,y=!1;if(re(e)?(u=()=>e.value,h=Dn(e)):ls(e)?(u=()=>e,t=!0):D(e)?(y=!0,h=e.some(N=>ls(N)||Dn(N)),u=()=>e.map(N=>{if(re(N))return N.value;if(ls(N))return ps(N);if(I(N))return Me(N,c,2)})):I(e)?s?u=()=>Me(e,c,2):u=()=>{if(!(c&&c.isUnmounted))return j&&j(),fe(e,c,3,[A])}:u=ve,s&&t){const N=u;u=()=>ps(N())}let j,A=N=>{j=W.onStop=()=>{Me(N,c,4)}},P;if(Ts)if(A=ve,s?n&&fe(s,c,3,[u(),y?[]:void 0,A]):u(),o==="sync"){const N=er();P=N.__watcherHandles||(N.__watcherHandles=[])}else return ve;let x=y?new Array(e.length).fill(Ls):Ls;const Y=()=>{if(W.active)if(s){const N=W.run();(t||h||(y?N.some((te,Ne)=>Os(te,x[Ne])):Os(N,x)))&&(j&&j(),fe(s,c,3,[N,x===Ls?void 0:y&&x[0]===Ls?[]:x,A]),x=N)}else W.run()};Y.allowRecurse=!!s;let L;o==="sync"?L=Y:o==="post"?L=()=>ue(Y,c&&c.suspense):(Y.pre=!0,c&&(Y.id=c.uid),L=()=>On(Y));const W=new wn(u,L);s?n?Y():x=W.run():o==="post"?ue(W.run.bind(W),c&&c.suspense):W.run();const V=()=>{W.stop(),c&&c.scope&&pn(c.scope.effects,W)};return P&&P.push(V),V}function ti(e,s,n){const t=this.proxy,o=Q(e)?e.includes(".")?Lt(t,e):()=>t[e]:e.bind(t,t);let a;I(s)?a=s:(a=s.handler,n=s);const i=ne;ds(this);const l=Bt(o,a.bind(t),n);return i?ds(i):Xe(),l}function Lt(e,s){const n=s.split(".");return()=>{let t=e;for(let o=0;o<n.length&&t;o++)t=t[n[o]];return t}}function ps(e,s){if(!M(e)||e.__v_skip||(s=s||new Set,s.has(e)))return e;if(s.add(e),re(e))ps(e.value,s);else if(D(e))for(let n=0;n<e.length;n++)ps(e[n],s);else if(rt(e)||os(e))e.forEach(n=>{ps(n,s)});else if(pt(e))for(const n in e)ps(e[n],s);return e}function $e(e,s,n,t){const o=e.dirs,a=s&&s.dirs;for(let i=0;i<o.length;i++){const l=o[i];a&&(l.oldValue=a[i].value);let c=l.dir[t];c&&(is(),fe(c,n,8,[e.el,l,e,s]),rs())}}function oi(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Xt(()=>{e.isMounted=!0}),Zt(()=>{e.isUnmounting=!0}),e}const ye=[Function,Array],Wt={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:ye,onEnter:ye,onAfterEnter:ye,onEnterCancelled:ye,onBeforeLeave:ye,onLeave:ye,onAfterLeave:ye,onLeaveCancelled:ye,onBeforeAppear:ye,onAppear:ye,onAfterAppear:ye,onAppearCancelled:ye},ai={name:"BaseTransition",props:Wt,setup(e,{slots:s}){const n=Bi(),t=oi();let o;return()=>{const a=s.default&&Kt(s.default(),!0);if(!a||!a.length)return;let i=a[0];if(a.length>1){for(const x of a)if(x.type!==Je){i=x;break}}const l=q(e),{mode:c}=l;if(t.isLeaving)return qn(i);const u=$t(i);if(!u)return qn(i);const h=Pn(u,l,t,n);Rn(u,h);const y=n.subTree,j=y&&$t(y);let A=!1;const{getTransitionKey:P}=u.type;if(P){const x=P();o===void 0?o=x:x!==o&&(o=x,A=!0)}if(j&&j.type!==Je&&(!Ge(u,j)||A)){const x=Pn(j,l,t,n);if(Rn(j,x),c==="out-in")return t.isLeaving=!0,x.afterLeave=()=>{t.isLeaving=!1,n.update.active!==!1&&n.update()},qn(i);c==="in-out"&&u.type!==Je&&(x.delayLeave=(Y,L,W)=>{const V=Vt(t,j);V[String(j.key)]=j,Y._leaveCb=()=>{L(),Y._leaveCb=void 0,delete h.delayedLeave},h.delayedLeave=W})}return i}}};function Vt(e,s){const{leavingVNodes:n}=e;let t=n.get(s.type);return t||(t=Object.create(null),n.set(s.type,t)),t}function Pn(e,s,n,t){const{appear:o,mode:a,persisted:i=!1,onBeforeEnter:l,onEnter:c,onAfterEnter:u,onEnterCancelled:h,onBeforeLeave:y,onLeave:j,onAfterLeave:A,onLeaveCancelled:P,onBeforeAppear:x,onAppear:Y,onAfterAppear:L,onAppearCancelled:W}=s,V=String(e.key),N=Vt(n,e),te=(O,G)=>{O&&fe(O,t,9,G)},Ne=(O,G)=>{const U=G[1];te(O,G),D(O)?O.every(ie=>ie.length<=1)&&U():O.length<=1&&U()},ze={mode:a,persisted:i,beforeEnter(O){let G=l;if(!n.isMounted)if(o)G=x||l;else return;O._leaveCb&&O._leaveCb(!0);const U=N[V];U&&Ge(e,U)&&U.el._leaveCb&&U.el._leaveCb(),te(G,[O])},enter(O){let G=c,U=u,ie=h;if(!n.isMounted)if(o)G=Y||c,U=L||u,ie=W||h;else return;let T=!1;const K=O._enterCb=he=>{T||(T=!0,he?te(ie,[O]):te(U,[O]),ze.delayedLeave&&ze.delayedLeave(),O._enterCb=void 0)};G?Ne(G,[O,K]):K()},leave(O,G){const U=String(e.key);if(O._enterCb&&O._enterCb(!0),n.isUnmounting)return G();te(y,[O]);let ie=!1;const T=O._leaveCb=K=>{ie||(ie=!0,G(),K?te(P,[O]):te(A,[O]),O._leaveCb=void 0,N[U]===e&&delete N[U])};N[U]=e,j?Ne(j,[O,T]):T()},clone(O){return Pn(O,s,n,t)}};return ze}function qn(e){if(Vs(e))return e=Ye(e),e.children=null,e}function $t(e){return Vs(e)?e.children?e.children[0]:void 0:e}function Rn(e,s){e.shapeFlag&6&&e.component?Rn(e.component.subTree,s):e.shapeFlag&128?(e.ssContent.transition=s.clone(e.ssContent),e.ssFallback.transition=s.clone(e.ssFallback)):e.transition=s}function Kt(e,s=!1,n){let t=[],o=0;for(let a=0;a<e.length;a++){let i=e[a];const l=n==null?i.key:String(n)+String(i.key!=null?i.key:a);i.type===be?(i.patchFlag&128&&o++,t=t.concat(Kt(i.children,s,l))):(s||i.type!==Je)&&t.push(l!=null?Ye(i,{key:l}):i)}if(o>1)for(let a=0;a<t.length;a++)t[a].patchFlag=-2;return t}function Fn(e,s){return I(e)?(()=>Z({name:e.name},s,{setup:e}))():e}const Ws=e=>!!e.type.__asyncLoader,Vs=e=>e.type.__isKeepAlive;function ii(e,s){Gt(e,"a",s)}function ri(e,s){Gt(e,"da",s)}function Gt(e,s,n=ne){const t=e.__wdc||(e.__wdc=()=>{let o=n;for(;o;){if(o.isDeactivated)return;o=o.parent}return e()});if($s(s,t,n),n){let o=n.parent;for(;o&&o.parent;)Vs(o.parent.vnode)&&li(t,s,n,o),o=o.parent}}function li(e,s,n,t){const o=$s(s,e,t,!0);Qt(()=>{pn(t[s],o)},n)}function $s(e,s,n=ne,t=!1){if(n){const o=n[e]||(n[e]=[]),a=s.__weh||(s.__weh=(...i)=>{if(n.isUnmounted)return;is(),ds(n);const l=fe(s,n,e,i);return Xe(),rs(),l});return t?o.unshift(a):o.push(a),a}}const Pe=e=>(s,n=ne)=>(!Ts||e==="sp")&&$s(e,(...t)=>s(...t),n),ci=Pe("bm"),Xt=Pe("m"),pi=Pe("bu"),ui=Pe("u"),Zt=Pe("bum"),Qt=Pe("um"),di=Pe("sp"),hi=Pe("rtg"),mi=Pe("rtc");function fi(e,s=ne){$s("ec",e,s)}const eo="components";function Hn(e,s){return yi(eo,e,!0,s)||e}const gi=Symbol.for("v-ndc");function yi(e,s,n=!0,t=!1){const o=ge||ne;if(o){const a=o.type;if(e===eo){const l=Ki(a,!1);if(l&&(l===s||l===Se(s)||l===Is(Se(s))))return a}const i=so(o[e]||a[e],s)||so(o.appContext[e],s);return!i&&t?a:i}}function so(e,s){return e&&(e[s]||e[Se(s)]||e[Is(Se(s))])}function no(e,s,n,t){let o;const a=n&&n[t];if(D(e)||Q(e)){o=new Array(e.length);for(let i=0,l=e.length;i<l;i++)o[i]=s(e[i],i,void 0,a&&a[i])}else if(typeof e=="number"){o=new Array(e);for(let i=0;i<e;i++)o[i]=s(i+1,i,void 0,a&&a[i])}else if(M(e))if(e[Symbol.iterator])o=Array.from(e,(i,l)=>s(i,l,void 0,a&&a[l]));else{const i=Object.keys(e);o=new Array(i.length);for(let l=0,c=i.length;l<c;l++){const u=i[l];o[l]=s(e[u],u,l,a&&a[l])}}else o=[];return n&&(n[t]=o),o}const Mn=e=>e?To(e)?Qn(e)||e.proxy:Mn(e.parent):null,js=Z(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Mn(e.parent),$root:e=>Mn(e.root),$emit:e=>e.emit,$options:e=>Bn(e),$forceUpdate:e=>e.f||(e.f=()=>On(e.update)),$nextTick:e=>e.n||(e.n=La.bind(e.proxy)),$watch:e=>ti.bind(e)}),Yn=(e,s)=>e!==B&&!e.__isScriptSetup&&E(e,s),bi={get({_:e},s){const{ctx:n,setupState:t,data:o,props:a,accessCache:i,type:l,appContext:c}=e;let u;if(s[0]!=="$"){const A=i[s];if(A!==void 0)switch(A){case 1:return t[s];case 2:return o[s];case 4:return n[s];case 3:return a[s]}else{if(Yn(t,s))return i[s]=1,t[s];if(o!==B&&E(o,s))return i[s]=2,o[s];if((u=e.propsOptions[0])&&E(u,s))return i[s]=3,a[s];if(n!==B&&E(n,s))return i[s]=4,n[s];Un&&(i[s]=0)}}const h=js[s];let y,j;if(h)return s==="$attrs"&&pe(e,"get",s),h(e);if((y=l.__cssModules)&&(y=y[s]))return y;if(n!==B&&E(n,s))return i[s]=4,n[s];if(j=c.config.globalProperties,E(j,s))return j[s]},set({_:e},s,n){const{data:t,setupState:o,ctx:a}=e;return Yn(o,s)?(o[s]=n,!0):t!==B&&E(t,s)?(t[s]=n,!0):E(e.props,s)||s[0]==="$"&&s.slice(1)in e?!1:(a[s]=n,!0)},has({_:{data:e,setupState:s,accessCache:n,ctx:t,appContext:o,propsOptions:a}},i){let l;return!!n[i]||e!==B&&E(e,i)||Yn(s,i)||(l=a[0])&&E(l,i)||E(t,i)||E(js,i)||E(o.config.globalProperties,i)},defineProperty(e,s,n){return n.get!=null?e._.accessCache[s]=0:E(n,"value")&&this.set(e,s,n.value,null),Reflect.defineProperty(e,s,n)}};function to(e){return D(e)?e.reduce((s,n)=>(s[n]=null,s),{}):e}let Un=!0;function vi(e){const s=Bn(e),n=e.proxy,t=e.ctx;Un=!1,s.beforeCreate&&oo(s.beforeCreate,e,"bc");const{data:o,computed:a,methods:i,watch:l,provide:c,inject:u,created:h,beforeMount:y,mounted:j,beforeUpdate:A,updated:P,activated:x,deactivated:Y,beforeDestroy:L,beforeUnmount:W,destroyed:V,unmounted:N,render:te,renderTracked:Ne,renderTriggered:ze,errorCaptured:O,serverPrefetch:G,expose:U,inheritAttrs:ie,components:T,directives:K,filters:he}=s;if(u&&ji(u,t,null),i)for(const X in i){const F=i[X];I(F)&&(t[X]=F.bind(n))}if(o){const X=o.call(n,n);M(X)&&(e.data=kn(X))}if(Un=!0,a)for(const X in a){const F=a[X],ss=I(F)?F.bind(n,n):I(F.get)?F.get.bind(n,n):ve,an=!I(F)&&I(F.set)?F.set.bind(n):ve,ns=Xi({get:ss,set:an});Object.defineProperty(t,X,{enumerable:!0,configurable:!0,get:()=>ns.value,set:Ie=>ns.value=Ie})}if(l)for(const X in l)ao(l[X],t,n,X);if(c){const X=I(c)?c.call(n):c;Reflect.ownKeys(X).forEach(F=>{ki(F,X[F])})}h&&oo(h,e,"c");function oe(X,F){D(F)?F.forEach(ss=>X(ss.bind(n))):F&&X(F.bind(n))}if(oe(ci,y),oe(Xt,j),oe(pi,A),oe(ui,P),oe(ii,x),oe(ri,Y),oe(fi,O),oe(mi,Ne),oe(hi,ze),oe(Zt,W),oe(Qt,N),oe(di,G),D(U))if(U.length){const X=e.exposed||(e.exposed={});U.forEach(F=>{Object.defineProperty(X,F,{get:()=>n[F],set:ss=>n[F]=ss})})}else e.exposed||(e.exposed={});te&&e.render===ve&&(e.render=te),ie!=null&&(e.inheritAttrs=ie),T&&(e.components=T),K&&(e.directives=K)}function ji(e,s,n=ve){D(e)&&(e=Ln(e));for(const t in e){const o=e[t];let a;M(o)?"default"in o?a=Xs(o.from||t,o.default,!0):a=Xs(o.from||t):a=Xs(o),re(a)?Object.defineProperty(s,t,{enumerable:!0,configurable:!0,get:()=>a.value,set:i=>a.value=i}):s[t]=a}}function oo(e,s,n){fe(D(e)?e.map(t=>t.bind(s.proxy)):e.bind(s.proxy),s,n)}function ao(e,s,n,t){const o=t.includes(".")?Lt(n,t):()=>n[t];if(Q(e)){const a=s[e];I(a)&&En(o,a)}else if(I(e))En(o,e.bind(n));else if(M(e))if(D(e))e.forEach(a=>ao(a,s,n,t));else{const a=I(e.handler)?e.handler.bind(n):s[e.handler];I(a)&&En(o,a,e)}}function Bn(e){const s=e.type,{mixins:n,extends:t}=s,{mixins:o,optionsCache:a,config:{optionMergeStrategies:i}}=e.appContext,l=a.get(s);let c;return l?c=l:!o.length&&!n&&!t?c=s:(c={},o.length&&o.forEach(u=>Ks(c,u,i,!0)),Ks(c,s,i)),M(s)&&a.set(s,c),c}function Ks(e,s,n,t=!1){const{mixins:o,extends:a}=s;a&&Ks(e,a,n,!0),o&&o.forEach(i=>Ks(e,i,n,!0));for(const i in s)if(!(t&&i==="expose")){const l=wi[i]||n&&n[i];e[i]=l?l(e[i],s[i]):s[i]}return e}const wi={data:io,props:ro,emits:ro,methods:ws,computed:ws,beforeCreate:le,created:le,beforeMount:le,mounted:le,beforeUpdate:le,updated:le,beforeDestroy:le,beforeUnmount:le,destroyed:le,unmounted:le,activated:le,deactivated:le,errorCaptured:le,serverPrefetch:le,components:ws,directives:ws,watch:_i,provide:io,inject:Ji};function io(e,s){return s?e?function(){return Z(I(e)?e.call(this,this):e,I(s)?s.call(this,this):s)}:s:e}function Ji(e,s){return ws(Ln(e),Ln(s))}function Ln(e){if(D(e)){const s={};for(let n=0;n<e.length;n++)s[e[n]]=e[n];return s}return e}function le(e,s){return e?[...new Set([].concat(e,s))]:s}function ws(e,s){return e?Z(Object.create(null),e,s):s}function ro(e,s){return e?D(e)&&D(s)?[...new Set([...e,...s])]:Z(Object.create(null),to(e),to(s??{})):s}function _i(e,s){if(!e)return s;if(!s)return e;const n=Z(Object.create(null),e);for(const t in s)n[t]=le(e[t],s[t]);return n}function lo(){return{app:null,config:{isNativeTag:$o,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Ti=0;function Si(e,s){return function(t,o=null){I(t)||(t=Z({},t)),o!=null&&!M(o)&&(o=null);const a=lo(),i=new Set;let l=!1;const c=a.app={_uid:Ti++,_component:t,_props:o,_container:null,_context:a,_instance:null,version:sr,get config(){return a.config},set config(u){},use(u,...h){return i.has(u)||(u&&I(u.install)?(i.add(u),u.install(c,...h)):I(u)&&(i.add(u),u(c,...h))),c},mixin(u){return a.mixins.includes(u)||a.mixins.push(u),c},component(u,h){return h?(a.components[u]=h,c):a.components[u]},directive(u,h){return h?(a.directives[u]=h,c):a.directives[u]},mount(u,h,y){if(!l){const j=ce(t,o);return j.appContext=a,h&&s?s(j,u):e(j,u,y),l=!0,c._container=u,u.__vue_app__=c,Qn(j.component)||j.component.proxy}},unmount(){l&&(e(null,c._container),delete c._container.__vue_app__)},provide(u,h){return a.provides[u]=h,c},runWithContext(u){Gs=c;try{return u()}finally{Gs=null}}};return c}}let Gs=null;function ki(e,s){if(ne){let n=ne.provides;const t=ne.parent&&ne.parent.provides;t===n&&(n=ne.provides=Object.create(t)),n[e]=s}}function Xs(e,s,n=!1){const t=ne||ge;if(t||Gs){const o=t?t.parent==null?t.vnode.appContext&&t.vnode.appContext.provides:t.parent.provides:Gs._context.provides;if(o&&e in o)return o[e];if(arguments.length>1)return n&&I(s)?s.call(t&&t.proxy):s}}function Ai(e,s,n,t=!1){const o={},a={};Cs(a,sn,1),e.propsDefaults=Object.create(null),co(e,s,o,a);for(const i in e.propsOptions[0])i in o||(o[i]=void 0);n?e.props=t?o:qa(o):e.type.props?e.props=o:e.props=a,e.attrs=a}function Di(e,s,n,t){const{props:o,attrs:a,vnode:{patchFlag:i}}=e,l=q(o),[c]=e.propsOptions;let u=!1;if((t||i>0)&&!(i&16)){if(i&8){const h=e.vnode.dynamicProps;for(let y=0;y<h.length;y++){let j=h[y];if(Us(e.emitsOptions,j))continue;const A=s[j];if(c)if(E(a,j))A!==a[j]&&(a[j]=A,u=!0);else{const P=Se(j);o[P]=Wn(c,l,P,A,e,!1)}else A!==a[j]&&(a[j]=A,u=!0)}}}else{co(e,s,o,a)&&(u=!0);let h;for(const y in l)(!s||!E(s,y)&&((h=as(y))===y||!E(s,h)))&&(c?n&&(n[y]!==void 0||n[h]!==void 0)&&(o[y]=Wn(c,l,y,void 0,e,!0)):delete o[y]);if(a!==l)for(const y in a)(!s||!E(s,y))&&(delete a[y],u=!0)}u&&Ce(e,"set","$attrs")}function co(e,s,n,t){const[o,a]=e.propsOptions;let i=!1,l;if(s)for(let c in s){if(Ns(c))continue;const u=s[c];let h;o&&E(o,h=Se(c))?!a||!a.includes(h)?n[h]=u:(l||(l={}))[h]=u:Us(e.emitsOptions,c)||(!(c in t)||u!==t[c])&&(t[c]=u,i=!0)}if(a){const c=q(n),u=l||B;for(let h=0;h<a.length;h++){const y=a[h];n[y]=Wn(o,c,y,u[y],e,!E(u,y))}}return i}function Wn(e,s,n,t,o,a){const i=e[n];if(i!=null){const l=E(i,"default");if(l&&t===void 0){const c=i.default;if(i.type!==Function&&!i.skipFactory&&I(c)){const{propsDefaults:u}=o;n in u?t=u[n]:(ds(o),t=u[n]=c.call(null,s),Xe())}else t=c}i[0]&&(a&&!l?t=!1:i[1]&&(t===""||t===as(n))&&(t=!0))}return t}function po(e,s,n=!1){const t=s.propsCache,o=t.get(e);if(o)return o;const a=e.props,i={},l=[];let c=!1;if(!I(e)){const h=y=>{c=!0;const[j,A]=po(y,s,!0);Z(i,j),A&&l.push(...A)};!n&&s.mixins.length&&s.mixins.forEach(h),e.extends&&h(e.extends),e.mixins&&e.mixins.forEach(h)}if(!a&&!c)return M(e)&&t.set(e,ts),ts;if(D(a))for(let h=0;h<a.length;h++){const y=Se(a[h]);uo(y)&&(i[y]=B)}else if(a)for(const h in a){const y=Se(h);if(uo(y)){const j=a[h],A=i[y]=D(j)||I(j)?{type:j}:Z({},j);if(A){const P=fo(Boolean,A.type),x=fo(String,A.type);A[0]=P>-1,A[1]=x<0||P<x,(P>-1||E(A,"default"))&&l.push(y)}}}const u=[i,l];return M(e)&&t.set(e,u),u}function uo(e){return e[0]!=="$"}function ho(e){const s=e&&e.toString().match(/^\s*(function|class) (\w+)/);return s?s[2]:e===null?"null":""}function mo(e,s){return ho(e)===ho(s)}function fo(e,s){return D(s)?s.findIndex(n=>mo(n,e)):I(s)&&mo(s,e)?0:-1}const go=e=>e[0]==="_"||e==="$stable",Vn=e=>D(e)?e.map(De):[De(e)],xi=(e,s,n)=>{if(s._n)return s;const t=Yt((...o)=>Vn(s(...o)),n);return t._c=!1,t},yo=(e,s,n)=>{const t=e._ctx;for(const o in e){if(go(o))continue;const a=e[o];if(I(a))s[o]=xi(o,a,t);else if(a!=null){const i=Vn(a);s[o]=()=>i}}},bo=(e,s)=>{const n=Vn(s);e.slots.default=()=>n},Ni=(e,s)=>{if(e.vnode.shapeFlag&32){const n=s._;n?(e.slots=q(s),Cs(s,"_",n)):yo(s,e.slots={})}else e.slots={},s&&bo(e,s);Cs(e.slots,sn,1)},zi=(e,s,n)=>{const{vnode:t,slots:o}=e;let a=!0,i=B;if(t.shapeFlag&32){const l=s._;l?n&&l===1?a=!1:(Z(o,s),!n&&l===1&&delete o._):(a=!s.$stable,yo(s,o)),i=s}else s&&(bo(e,s),i={default:1});if(a)for(const l in o)!go(l)&&!(l in i)&&delete o[l]};function $n(e,s,n,t,o=!1){if(D(e)){e.forEach((j,A)=>$n(j,s&&(D(s)?s[A]:s),n,t,o));return}if(Ws(t)&&!o)return;const a=t.shapeFlag&4?Qn(t.component)||t.component.proxy:t.el,i=o?null:a,{i:l,r:c}=e,u=s&&s.r,h=l.refs===B?l.refs={}:l.refs,y=l.setupState;if(u!=null&&u!==c&&(Q(u)?(h[u]=null,E(y,u)&&(y[u]=null)):re(u)&&(u.value=null)),I(c))Me(c,l,12,[i,h]);else{const j=Q(c),A=re(c);if(j||A){const P=()=>{if(e.f){const x=j?E(y,c)?y[c]:h[c]:c.value;o?D(x)&&pn(x,a):D(x)?x.includes(a)||x.push(a):j?(h[c]=[a],E(y,c)&&(y[c]=h[c])):(c.value=[a],e.k&&(h[e.k]=c.value))}else j?(h[c]=i,E(y,c)&&(y[c]=i)):A&&(c.value=i,e.k&&(h[e.k]=i))};i?(P.id=-1,ue(P,n)):P()}}}const ue=ni;function Ii(e){return Oi(e)}function Oi(e,s){const n=fn();n.__VUE__=!0;const{insert:t,remove:o,patchProp:a,createElement:i,createText:l,createComment:c,setText:u,setElementText:h,parentNode:y,nextSibling:j,setScopeId:A=ve,insertStaticContent:P}=e,x=(r,p,d,f=null,m=null,v=null,J=!1,b=null,w=!!p.dynamicChildren)=>{if(r===p)return;r&&!Ge(r,p)&&(f=rn(r),Ie(r,m,v,!0),r=null),p.patchFlag===-2&&(w=!1,p.dynamicChildren=null);const{type:g,ref:S,shapeFlag:_}=p;switch(g){case Zs:Y(r,p,d,f);break;case Je:L(r,p,d,f);break;case Qs:r==null&&W(p,d,f,J);break;case be:T(r,p,d,f,m,v,J,b,w);break;default:_&1?te(r,p,d,f,m,v,J,b,w):_&6?K(r,p,d,f,m,v,J,b,w):(_&64||_&128)&&g.process(r,p,d,f,m,v,J,b,w,hs)}S!=null&&m&&$n(S,r&&r.ref,v,p||r,!p)},Y=(r,p,d,f)=>{if(r==null)t(p.el=l(p.children),d,f);else{const m=p.el=r.el;p.children!==r.children&&u(m,p.children)}},L=(r,p,d,f)=>{r==null?t(p.el=c(p.children||""),d,f):p.el=r.el},W=(r,p,d,f)=>{[r.el,r.anchor]=P(r.children,p,d,f,r.el,r.anchor)},V=({el:r,anchor:p},d,f)=>{let m;for(;r&&r!==p;)m=j(r),t(r,d,f),r=m;t(p,d,f)},N=({el:r,anchor:p})=>{let d;for(;r&&r!==p;)d=j(r),o(r),r=d;o(p)},te=(r,p,d,f,m,v,J,b,w)=>{J=J||p.type==="svg",r==null?Ne(p,d,f,m,v,J,b,w):G(r,p,m,v,J,b,w)},Ne=(r,p,d,f,m,v,J,b)=>{let w,g;const{type:S,props:_,shapeFlag:k,transition:z,dirs:C}=r;if(w=r.el=i(r.type,v,_&&_.is,_),k&8?h(w,r.children):k&16&&O(r.children,w,null,f,m,v&&S!=="foreignObject",J,b),C&&$e(r,null,f,"created"),ze(w,r,r.scopeId,J,f),_){for(const R in _)R!=="value"&&!Ns(R)&&a(w,R,null,_[R],v,r.children,f,m,qe);"value"in _&&a(w,"value",null,_.value),(g=_.onVnodeBeforeMount)&&xe(g,f,r)}C&&$e(r,null,f,"beforeMount");const H=(!m||m&&!m.pendingBranch)&&z&&!z.persisted;H&&z.beforeEnter(w),t(w,p,d),((g=_&&_.onVnodeMounted)||H||C)&&ue(()=>{g&&xe(g,f,r),H&&z.enter(w),C&&$e(r,null,f,"mounted")},m)},ze=(r,p,d,f,m)=>{if(d&&A(r,d),f)for(let v=0;v<f.length;v++)A(r,f[v]);if(m){let v=m.subTree;if(p===v){const J=m.vnode;ze(r,J,J.scopeId,J.slotScopeIds,m.parent)}}},O=(r,p,d,f,m,v,J,b,w=0)=>{for(let g=w;g<r.length;g++){const S=r[g]=b?Ue(r[g]):De(r[g]);x(null,S,p,d,f,m,v,J,b)}},G=(r,p,d,f,m,v,J)=>{const b=p.el=r.el;let{patchFlag:w,dynamicChildren:g,dirs:S}=p;w|=r.patchFlag&16;const _=r.props||B,k=p.props||B;let z;d&&Ke(d,!1),(z=k.onVnodeBeforeUpdate)&&xe(z,d,p,r),S&&$e(p,r,d,"beforeUpdate"),d&&Ke(d,!0);const C=m&&p.type!=="foreignObject";if(g?U(r.dynamicChildren,g,b,d,f,C,v):J||F(r,p,b,null,d,f,C,v,!1),w>0){if(w&16)ie(b,p,_,k,d,f,m);else if(w&2&&_.class!==k.class&&a(b,"class",null,k.class,m),w&4&&a(b,"style",_.style,k.style,m),w&8){const H=p.dynamicProps;for(let R=0;R<H.length;R++){const ee=H[R],Te=_[ee],ms=k[ee];(ms!==Te||ee==="value")&&a(b,ee,Te,ms,m,r.children,d,f,qe)}}w&1&&r.children!==p.children&&h(b,p.children)}else!J&&g==null&&ie(b,p,_,k,d,f,m);((z=k.onVnodeUpdated)||S)&&ue(()=>{z&&xe(z,d,p,r),S&&$e(p,r,d,"updated")},f)},U=(r,p,d,f,m,v,J)=>{for(let b=0;b<p.length;b++){const w=r[b],g=p[b],S=w.el&&(w.type===be||!Ge(w,g)||w.shapeFlag&70)?y(w.el):d;x(w,g,S,null,f,m,v,J,!0)}},ie=(r,p,d,f,m,v,J)=>{if(d!==f){if(d!==B)for(const b in d)!Ns(b)&&!(b in f)&&a(r,b,d[b],null,J,p.children,m,v,qe);for(const b in f){if(Ns(b))continue;const w=f[b],g=d[b];w!==g&&b!=="value"&&a(r,b,g,w,J,p.children,m,v,qe)}"value"in f&&a(r,"value",d.value,f.value)}},T=(r,p,d,f,m,v,J,b,w)=>{const g=p.el=r?r.el:l(""),S=p.anchor=r?r.anchor:l("");let{patchFlag:_,dynamicChildren:k,slotScopeIds:z}=p;z&&(b=b?b.concat(z):z),r==null?(t(g,d,f),t(S,d,f),O(p.children,d,S,m,v,J,b,w)):_>0&&_&64&&k&&r.dynamicChildren?(U(r.dynamicChildren,k,d,m,v,J,b),(p.key!=null||m&&p===m.subTree)&&vo(r,p,!0)):F(r,p,d,S,m,v,J,b,w)},K=(r,p,d,f,m,v,J,b,w)=>{p.slotScopeIds=b,r==null?p.shapeFlag&512?m.ctx.activate(p,d,f,J,w):he(p,d,f,m,v,J,w):ks(r,p,w)},he=(r,p,d,f,m,v,J)=>{const b=r.component=Ui(r,f,m);if(Vs(r)&&(b.ctx.renderer=hs),Li(b),b.asyncDep){if(m&&m.registerDep(b,oe),!r.el){const w=b.subTree=ce(Je);L(null,w,p,d)}return}oe(b,r,p,d,m,v,J)},ks=(r,p,d)=>{const f=p.component=r.component;if(Qa(r,p,d))if(f.asyncDep&&!f.asyncResolved){X(f,p,d);return}else f.next=p,Va(f.update),f.update();else p.el=r.el,f.vnode=p},oe=(r,p,d,f,m,v,J)=>{const b=()=>{if(r.isMounted){let{next:S,bu:_,u:k,parent:z,vnode:C}=r,H=S,R;Ke(r,!1),S?(S.el=C.el,X(r,S,J)):S=C,_&&mn(_),(R=S.props&&S.props.onVnodeBeforeUpdate)&&xe(R,z,S,C),Ke(r,!0);const ee=Cn(r),Te=r.subTree;r.subTree=ee,x(Te,ee,y(Te.el),rn(Te),r,m,v),S.el=ee.el,H===null&&ei(r,ee.el),k&&ue(k,m),(R=S.props&&S.props.onVnodeUpdated)&&ue(()=>xe(R,z,S,C),m)}else{let S;const{el:_,props:k}=p,{bm:z,m:C,parent:H}=r,R=Ws(p);if(Ke(r,!1),z&&mn(z),!R&&(S=k&&k.onVnodeBeforeMount)&&xe(S,H,p),Ke(r,!0),_&&it){const ee=()=>{r.subTree=Cn(r),it(_,r.subTree,r,m,null)};R?p.type.__asyncLoader().then(()=>!r.isUnmounted&&ee()):ee()}else{const ee=r.subTree=Cn(r);x(null,ee,d,f,r,m,v),p.el=ee.el}if(C&&ue(C,m),!R&&(S=k&&k.onVnodeMounted)){const ee=p;ue(()=>xe(S,H,ee),m)}(p.shapeFlag&256||H&&Ws(H.vnode)&&H.vnode.shapeFlag&256)&&r.a&&ue(r.a,m),r.isMounted=!0,p=d=f=null}},w=r.effect=new wn(b,()=>On(g),r.scope),g=r.update=()=>w.run();g.id=r.uid,Ke(r,!0),g()},X=(r,p,d)=>{p.component=r;const f=r.vnode.props;r.vnode=p,r.next=null,Di(r,p.props,f,d),zi(r,p.children,d),is(),qt(),rs()},F=(r,p,d,f,m,v,J,b,w=!1)=>{const g=r&&r.children,S=r?r.shapeFlag:0,_=p.children,{patchFlag:k,shapeFlag:z}=p;if(k>0){if(k&128){an(g,_,d,f,m,v,J,b,w);return}else if(k&256){ss(g,_,d,f,m,v,J,b,w);return}}z&8?(S&16&&qe(g,m,v),_!==g&&h(d,_)):S&16?z&16?an(g,_,d,f,m,v,J,b,w):qe(g,m,v,!0):(S&8&&h(d,""),z&16&&O(_,d,f,m,v,J,b,w))},ss=(r,p,d,f,m,v,J,b,w)=>{r=r||ts,p=p||ts;const g=r.length,S=p.length,_=Math.min(g,S);let k;for(k=0;k<_;k++){const z=p[k]=w?Ue(p[k]):De(p[k]);x(r[k],z,d,null,m,v,J,b,w)}g>S?qe(r,m,v,!0,!1,_):O(p,d,f,m,v,J,b,w,_)},an=(r,p,d,f,m,v,J,b,w)=>{let g=0;const S=p.length;let _=r.length-1,k=S-1;for(;g<=_&&g<=k;){const z=r[g],C=p[g]=w?Ue(p[g]):De(p[g]);if(Ge(z,C))x(z,C,d,null,m,v,J,b,w);else break;g++}for(;g<=_&&g<=k;){const z=r[_],C=p[k]=w?Ue(p[k]):De(p[k]);if(Ge(z,C))x(z,C,d,null,m,v,J,b,w);else break;_--,k--}if(g>_){if(g<=k){const z=k+1,C=z<S?p[z].el:f;for(;g<=k;)x(null,p[g]=w?Ue(p[g]):De(p[g]),d,C,m,v,J,b,w),g++}}else if(g>k)for(;g<=_;)Ie(r[g],m,v,!0),g++;else{const z=g,C=g,H=new Map;for(g=C;g<=k;g++){const me=p[g]=w?Ue(p[g]):De(p[g]);me.key!=null&&H.set(me.key,g)}let R,ee=0;const Te=k-C+1;let ms=!1,Lo=0;const As=new Array(Te);for(g=0;g<Te;g++)As[g]=0;for(g=z;g<=_;g++){const me=r[g];if(ee>=Te){Ie(me,m,v,!0);continue}let Oe;if(me.key!=null)Oe=H.get(me.key);else for(R=C;R<=k;R++)if(As[R-C]===0&&Ge(me,p[R])){Oe=R;break}Oe===void 0?Ie(me,m,v,!0):(As[Oe-C]=g+1,Oe>=Lo?Lo=Oe:ms=!0,x(me,p[Oe],d,null,m,v,J,b,w),ee++)}const Wo=ms?Ci(As):ts;for(R=Wo.length-1,g=Te-1;g>=0;g--){const me=C+g,Oe=p[me],Vo=me+1<S?p[me+1].el:f;As[g]===0?x(null,Oe,d,Vo,m,v,J,b,w):ms&&(R<0||g!==Wo[R]?ns(Oe,d,Vo,2):R--)}}},ns=(r,p,d,f,m=null)=>{const{el:v,type:J,transition:b,children:w,shapeFlag:g}=r;if(g&6){ns(r.component.subTree,p,d,f);return}if(g&128){r.suspense.move(p,d,f);return}if(g&64){J.move(r,p,d,hs);return}if(J===be){t(v,p,d);for(let _=0;_<w.length;_++)ns(w[_],p,d,f);t(r.anchor,p,d);return}if(J===Qs){V(r,p,d);return}if(f!==2&&g&1&&b)if(f===0)b.beforeEnter(v),t(v,p,d),ue(()=>b.enter(v),m);else{const{leave:_,delayLeave:k,afterLeave:z}=b,C=()=>t(v,p,d),H=()=>{_(v,()=>{C(),z&&z()})};k?k(v,C,H):H()}else t(v,p,d)},Ie=(r,p,d,f=!1,m=!1)=>{const{type:v,props:J,ref:b,children:w,dynamicChildren:g,shapeFlag:S,patchFlag:_,dirs:k}=r;if(b!=null&&$n(b,null,d,r,!0),S&256){p.ctx.deactivate(r);return}const z=S&1&&k,C=!Ws(r);let H;if(C&&(H=J&&J.onVnodeBeforeUnmount)&&xe(H,p,r),S&6)pl(r.component,d,f);else{if(S&128){r.suspense.unmount(d,f);return}z&&$e(r,null,p,"beforeUnmount"),S&64?r.type.remove(r,p,d,m,hs,f):g&&(v!==be||_>0&&_&64)?qe(g,p,d,!1,!0):(v===be&&_&384||!m&&S&16)&&qe(w,p,d),f&&Uo(r)}(C&&(H=J&&J.onVnodeUnmounted)||z)&&ue(()=>{H&&xe(H,p,r),z&&$e(r,null,p,"unmounted")},d)},Uo=r=>{const{type:p,el:d,anchor:f,transition:m}=r;if(p===be){cl(d,f);return}if(p===Qs){N(r);return}const v=()=>{o(d),m&&!m.persisted&&m.afterLeave&&m.afterLeave()};if(r.shapeFlag&1&&m&&!m.persisted){const{leave:J,delayLeave:b}=m,w=()=>J(d,v);b?b(r.el,v,w):w()}else v()},cl=(r,p)=>{let d;for(;r!==p;)d=j(r),o(r),r=d;o(p)},pl=(r,p,d)=>{const{bum:f,scope:m,update:v,subTree:J,um:b}=r;f&&mn(f),m.stop(),v&&(v.active=!1,Ie(J,r,p,d)),b&&ue(b,p),ue(()=>{r.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&r.asyncDep&&!r.asyncResolved&&r.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},qe=(r,p,d,f=!1,m=!1,v=0)=>{for(let J=v;J<r.length;J++)Ie(r[J],p,d,f,m)},rn=r=>r.shapeFlag&6?rn(r.component.subTree):r.shapeFlag&128?r.suspense.next():j(r.anchor||r.el),Bo=(r,p,d)=>{r==null?p._vnode&&Ie(p._vnode,null,null,!0):x(p._vnode||null,r,p,null,null,null,d),qt(),Rt(),p._vnode=r},hs={p:x,um:Ie,m:ns,r:Uo,mt:he,mc:O,pc:F,pbc:U,n:rn,o:e};let at,it;return s&&([at,it]=s(hs)),{render:Bo,hydrate:at,createApp:Si(Bo,at)}}function Ke({effect:e,update:s},n){e.allowRecurse=s.allowRecurse=n}function vo(e,s,n=!1){const t=e.children,o=s.children;if(D(t)&&D(o))for(let a=0;a<t.length;a++){const i=t[a];let l=o[a];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=o[a]=Ue(o[a]),l.el=i.el),n||vo(i,l)),l.type===Zs&&(l.el=i.el)}}function Ci(e){const s=e.slice(),n=[0];let t,o,a,i,l;const c=e.length;for(t=0;t<c;t++){const u=e[t];if(u!==0){if(o=n[n.length-1],e[o]<u){s[t]=o,n.push(t);continue}for(a=0,i=n.length-1;a<i;)l=a+i>>1,e[n[l]]<u?a=l+1:i=l;u<e[n[a]]&&(a>0&&(s[t]=n[a-1]),n[a]=t)}}for(a=n.length,i=n[a-1];a-- >0;)n[a]=i,i=s[i];return n}const Ei=e=>e.__isTeleport,be=Symbol.for("v-fgt"),Zs=Symbol.for("v-txt"),Je=Symbol.for("v-cmt"),Qs=Symbol.for("v-stc"),Js=[];let _e=null;function de(e=!1){Js.push(_e=e?null:[])}function Pi(){Js.pop(),_e=Js[Js.length-1]||null}let _s=1;function jo(e){_s+=e}function wo(e){return e.dynamicChildren=_s>0?_e||ts:null,Pi(),_s>0&&_e&&_e.push(e),e}function Ae(e,s,n,t,o,a){return wo(se(e,s,n,t,o,a,!0))}function en(e,s,n,t,o){return wo(ce(e,s,n,t,o,!0))}function Kn(e){return e?e.__v_isVNode===!0:!1}function Ge(e,s){return e.type===s.type&&e.key===s.key}const sn="__vInternal",Jo=({key:e})=>e??null,nn=({ref:e,ref_key:s,ref_for:n})=>(typeof e=="number"&&(e=""+e),e!=null?Q(e)||re(e)||I(e)?{i:ge,r:e,k:s,f:!!n}:e:null);function se(e,s=null,n=null,t=0,o=null,a=e===be?0:1,i=!1,l=!1){const c={__v_isVNode:!0,__v_skip:!0,type:e,props:s,key:s&&Jo(s),ref:s&&nn(s),scopeId:Mt,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:a,patchFlag:t,dynamicProps:o,dynamicChildren:null,appContext:null,ctx:ge};return l?(Xn(c,n),a&128&&e.normalize(c)):n&&(c.shapeFlag|=Q(n)?8:16),_s>0&&!i&&_e&&(c.patchFlag>0||a&6)&&c.patchFlag!==32&&_e.push(c),c}const ce=qi;function qi(e,s=null,n=null,t=0,o=null,a=!1){if((!e||e===gi)&&(e=Je),Kn(e)){const l=Ye(e,s,!0);return n&&Xn(l,n),_s>0&&!a&&_e&&(l.shapeFlag&6?_e[_e.indexOf(e)]=l:_e.push(l)),l.patchFlag|=-2,l}if(Gi(e)&&(e=e.__vccOpts),s){s=Ri(s);let{class:l,style:c}=s;l&&!Q(l)&&(s.class=fs(l)),M(c)&&(It(c)&&!D(c)&&(c=Z({},c)),s.style=gn(c))}const i=Q(e)?1:si(e)?128:Ei(e)?64:M(e)?4:I(e)?2:0;return se(e,s,n,t,o,i,a,!0)}function Ri(e){return e?It(e)||sn in e?Z({},e):e:null}function Ye(e,s,n=!1){const{props:t,ref:o,patchFlag:a,children:i}=e,l=s?Hi(t||{},s):t;return{__v_isVNode:!0,__v_skip:!0,type:e.type,props:l,key:l&&Jo(l),ref:s&&s.ref?n&&o?D(o)?o.concat(nn(s)):[o,nn(s)]:nn(s):o,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:i,target:e.target,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:s&&e.type!==be?a===-1?16:a|16:a,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:e.transition,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Ye(e.ssContent),ssFallback:e.ssFallback&&Ye(e.ssFallback),el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce}}function tn(e=" ",s=0){return ce(Zs,null,e,s)}function Fi(e,s){const n=ce(Qs,null,e);return n.staticCount=s,n}function Gn(e="",s=!1){return s?(de(),en(Je,null,e)):ce(Je,null,e)}function De(e){return e==null||typeof e=="boolean"?ce(Je):D(e)?ce(be,null,e.slice()):typeof e=="object"?Ue(e):ce(Zs,null,String(e))}function Ue(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Ye(e)}function Xn(e,s){let n=0;const{shapeFlag:t}=e;if(s==null)s=null;else if(D(s))n=16;else if(typeof s=="object")if(t&65){const o=s.default;o&&(o._c&&(o._d=!1),Xn(e,o()),o._c&&(o._d=!0));return}else{n=32;const o=s._;!o&&!(sn in s)?s._ctx=ge:o===3&&ge&&(ge.slots._===1?s._=1:(s._=2,e.patchFlag|=1024))}else I(s)?(s={default:s,_ctx:ge},n=32):(s=String(s),t&64?(n=16,s=[tn(s)]):n=8);e.children=s,e.shapeFlag|=n}function Hi(...e){const s={};for(let n=0;n<e.length;n++){const t=e[n];for(const o in t)if(o==="class")s.class!==t.class&&(s.class=fs([s.class,t.class]));else if(o==="style")s.style=gn([s.style,t.style]);else if(Ds(o)){const a=s[o],i=t[o];i&&a!==i&&!(D(a)&&a.includes(i))&&(s[o]=a?[].concat(a,i):i)}else o!==""&&(s[o]=t[o])}return s}function xe(e,s,n,t=null){fe(e,s,7,[n,t])}const Mi=lo();let Yi=0;function Ui(e,s,n){const t=e.type,o=(s?s.appContext:e.appContext)||Mi,a={uid:Yi++,vnode:e,type:t,parent:s,appContext:o,root:null,next:null,subTree:null,effect:null,update:null,scope:new ra(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:s?s.provides:Object.create(o.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:po(t,o),emitsOptions:Ht(t,o),emit:null,emitted:null,propsDefaults:B,inheritAttrs:t.inheritAttrs,ctx:B,data:B,props:B,attrs:B,slots:B,refs:B,setupState:B,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return a.ctx={_:a},a.root=s?s.root:a,a.emit=Ga.bind(null,a),e.ce&&e.ce(a),a}let ne=null;const Bi=()=>ne||ge;let Zn,us,_o="__VUE_INSTANCE_SETTERS__";(us=fn()[_o])||(us=fn()[_o]=[]),us.push(e=>ne=e),Zn=e=>{us.length>1?us.forEach(s=>s(e)):us[0](e)};const ds=e=>{Zn(e),e.scope.on()},Xe=()=>{ne&&ne.scope.off(),Zn(null)};function To(e){return e.vnode.shapeFlag&4}let Ts=!1;function Li(e,s=!1){Ts=s;const{props:n,children:t}=e.vnode,o=To(e);Ai(e,n,o,s),Ni(e,t);const a=o?Wi(e,s):void 0;return Ts=!1,a}function Wi(e,s){const n=e.type;e.accessCache=Object.create(null),e.proxy=Ot(new Proxy(e.ctx,bi));const{setup:t}=n;if(t){const o=e.setupContext=t.length>1?$i(e):null;ds(e),is();const a=Me(t,e,0,[e.props,o]);if(rs(),Xe(),lt(a)){if(a.then(Xe,Xe),s)return a.then(i=>{So(e,i,s)}).catch(i=>{Ys(i,e,0)});e.asyncDep=a}else So(e,a,s)}else Ao(e,s)}function So(e,s,n){I(s)?e.type.__ssrInlineRender?e.ssrRender=s:e.render=s:M(s)&&(e.setupState=Ct(s)),Ao(e,n)}let ko;function Ao(e,s,n){const t=e.type;if(!e.render){if(!s&&ko&&!t.render){const o=t.template||Bn(e).template;if(o){const{isCustomElement:a,compilerOptions:i}=e.appContext.config,{delimiters:l,compilerOptions:c}=t,u=Z(Z({isCustomElement:a,delimiters:l},i),c);t.render=ko(o,u)}}e.render=t.render||ve}ds(e),is(),vi(e),rs(),Xe()}function Vi(e){return e.attrsProxy||(e.attrsProxy=new Proxy(e.attrs,{get(s,n){return pe(e,"get","$attrs"),s[n]}}))}function $i(e){const s=n=>{e.exposed=n||{}};return{get attrs(){return Vi(e)},slots:e.slots,emit:e.emit,expose:s}}function Qn(e){if(e.exposed)return e.exposeProxy||(e.exposeProxy=new Proxy(Ct(Ot(e.exposed)),{get(s,n){if(n in s)return s[n];if(n in js)return js[n](e)},has(s,n){return n in s||n in js}}))}function Ki(e,s=!0){return I(e)?e.displayName||e.name:e.name||s&&e.__name}function Gi(e){return I(e)&&"__vccOpts"in e}const Xi=(e,s)=>Ua(e,s,Ts);function Zi(e,s,n){const t=arguments.length;return t===2?M(s)&&!D(s)?Kn(s)?ce(e,null,[s]):ce(e,s):ce(e,null,s):(t>3?n=Array.prototype.slice.call(arguments,2):t===3&&Kn(n)&&(n=[n]),ce(e,s,n))}const Qi=Symbol.for("v-scx"),er=()=>Xs(Qi),sr="3.3.4",nr="http://www.w3.org/2000/svg",Ze=typeof document<"u"?document:null,Do=Ze&&Ze.createElement("template"),tr={insert:(e,s,n)=>{s.insertBefore(e,n||null)},remove:e=>{const s=e.parentNode;s&&s.removeChild(e)},createElement:(e,s,n,t)=>{const o=s?Ze.createElementNS(nr,e):Ze.createElement(e,n?{is:n}:void 0);return e==="select"&&t&&t.multiple!=null&&o.setAttribute("multiple",t.multiple),o},createText:e=>Ze.createTextNode(e),createComment:e=>Ze.createComment(e),setText:(e,s)=>{e.nodeValue=s},setElementText:(e,s)=>{e.textContent=s},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Ze.querySelector(e),setScopeId(e,s){e.setAttribute(s,"")},insertStaticContent(e,s,n,t,o,a){const i=n?n.previousSibling:s.lastChild;if(o&&(o===a||o.nextSibling))for(;s.insertBefore(o.cloneNode(!0),n),!(o===a||!(o=o.nextSibling)););else{Do.innerHTML=t?`<svg>${e}</svg>`:e;const l=Do.content;if(t){const c=l.firstChild;for(;c.firstChild;)l.appendChild(c.firstChild);l.removeChild(c)}s.insertBefore(l,n)}return[i?i.nextSibling:s.firstChild,n?n.previousSibling:s.lastChild]}};function or(e,s,n){const t=e._vtc;t&&(s=(s?[s,...t]:[...t]).join(" ")),s==null?e.removeAttribute("class"):n?e.setAttribute("class",s):e.className=s}function ar(e,s,n){const t=e.style,o=Q(n);if(n&&!o){if(s&&!Q(s))for(const a in s)n[a]==null&&et(t,a,"");for(const a in n)et(t,a,n[a])}else{const a=t.display;o?s!==n&&(t.cssText=n):s&&e.removeAttribute("style"),"_vod"in e&&(t.display=a)}}const xo=/\s*!important$/;function et(e,s,n){if(D(n))n.forEach(t=>et(e,s,t));else if(n==null&&(n=""),s.startsWith("--"))e.setProperty(s,n);else{const t=ir(e,s);xo.test(n)?e.setProperty(as(t),n.replace(xo,""),"important"):e[t]=n}}const No=["Webkit","Moz","ms"],st={};function ir(e,s){const n=st[s];if(n)return n;let t=Se(s);if(t!=="filter"&&t in e)return st[s]=t;t=Is(t);for(let o=0;o<No.length;o++){const a=No[o]+t;if(a in e)return st[s]=a}return s}const zo="http://www.w3.org/1999/xlink";function rr(e,s,n,t,o){if(t&&s.startsWith("xlink:"))n==null?e.removeAttributeNS(zo,s.slice(6,s.length)):e.setAttributeNS(zo,s,n);else{const a=ia(s);n==null||a&&!dt(n)?e.removeAttribute(s):e.setAttribute(s,a?"":n)}}function lr(e,s,n,t,o,a,i){if(s==="innerHTML"||s==="textContent"){t&&i(t,o,a),e[s]=n??"";return}const l=e.tagName;if(s==="value"&&l!=="PROGRESS"&&!l.includes("-")){e._value=n;const u=l==="OPTION"?e.getAttribute("value"):e.value,h=n??"";u!==h&&(e.value=h),n==null&&e.removeAttribute(s);return}let c=!1;if(n===""||n==null){const u=typeof e[s];u==="boolean"?n=dt(n):n==null&&u==="string"?(n="",c=!0):u==="number"&&(n=0,c=!0)}try{e[s]=n}catch{}c&&e.removeAttribute(s)}function cr(e,s,n,t){e.addEventListener(s,n,t)}function pr(e,s,n,t){e.removeEventListener(s,n,t)}function ur(e,s,n,t,o=null){const a=e._vei||(e._vei={}),i=a[s];if(t&&i)i.value=t;else{const[l,c]=dr(s);if(t){const u=a[s]=fr(t,o);cr(e,l,u,c)}else i&&(pr(e,l,i,c),a[s]=void 0)}}const Io=/(?:Once|Passive|Capture)$/;function dr(e){let s;if(Io.test(e)){s={};let t;for(;t=e.match(Io);)e=e.slice(0,e.length-t[0].length),s[t[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):as(e.slice(2)),s]}let nt=0;const hr=Promise.resolve(),mr=()=>nt||(hr.then(()=>nt=0),nt=Date.now());function fr(e,s){const n=t=>{if(!t._vts)t._vts=Date.now();else if(t._vts<=n.attached)return;fe(gr(t,n.value),s,5,[t])};return n.value=e,n.attached=mr(),n}function gr(e,s){if(D(s)){const n=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{n.call(e),e._stopped=!0},s.map(t=>o=>!o._stopped&&t&&t(o))}else return s}const Oo=/^on[a-z]/,yr=(e,s,n,t,o=!1,a,i,l,c)=>{s==="class"?or(e,t,o):s==="style"?ar(e,n,t):Ds(s)?cn(s)||ur(e,s,n,t,i):(s[0]==="."?(s=s.slice(1),!0):s[0]==="^"?(s=s.slice(1),!1):br(e,s,t,o))?lr(e,s,t,a,i,l,c):(s==="true-value"?e._trueValue=t:s==="false-value"&&(e._falseValue=t),rr(e,s,t,o))};function br(e,s,n,t){return t?!!(s==="innerHTML"||s==="textContent"||s in e&&Oo.test(s)&&I(n)):s==="spellcheck"||s==="draggable"||s==="translate"||s==="form"||s==="list"&&e.tagName==="INPUT"||s==="type"&&e.tagName==="TEXTAREA"||Oo.test(s)&&Q(n)?!1:s in e}const Be="transition",Ss="animation",tt=(e,{slots:s})=>Zi(ai,vr(e),s);tt.displayName="Transition";const Co={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};tt.props=Z({},Wt,Co);const Qe=(e,s=[])=>{D(e)?e.forEach(n=>n(...s)):e&&e(...s)},Eo=e=>e?D(e)?e.some(s=>s.length>1):e.length>1:!1;function vr(e){const s={};for(const T in e)T in Co||(s[T]=e[T]);if(e.css===!1)return s;const{name:n="v",type:t,duration:o,enterFromClass:a=`${n}-enter-from`,enterActiveClass:i=`${n}-enter-active`,enterToClass:l=`${n}-enter-to`,appearFromClass:c=a,appearActiveClass:u=i,appearToClass:h=l,leaveFromClass:y=`${n}-leave-from`,leaveActiveClass:j=`${n}-leave-active`,leaveToClass:A=`${n}-leave-to`}=e,P=jr(o),x=P&&P[0],Y=P&&P[1],{onBeforeEnter:L,onEnter:W,onEnterCancelled:V,onLeave:N,onLeaveCancelled:te,onBeforeAppear:Ne=L,onAppear:ze=W,onAppearCancelled:O=V}=s,G=(T,K,he)=>{es(T,K?h:l),es(T,K?u:i),he&&he()},U=(T,K)=>{T._isLeaving=!1,es(T,y),es(T,A),es(T,j),K&&K()},ie=T=>(K,he)=>{const ks=T?ze:W,oe=()=>G(K,T,he);Qe(ks,[K,oe]),Po(()=>{es(K,T?c:a),Le(K,T?h:l),Eo(ks)||qo(K,t,x,oe)})};return Z(s,{onBeforeEnter(T){Qe(L,[T]),Le(T,a),Le(T,i)},onBeforeAppear(T){Qe(Ne,[T]),Le(T,c),Le(T,u)},onEnter:ie(!1),onAppear:ie(!0),onLeave(T,K){T._isLeaving=!0;const he=()=>U(T,K);Le(T,y),_r(),Le(T,j),Po(()=>{T._isLeaving&&(es(T,y),Le(T,A),Eo(N)||qo(T,t,Y,he))}),Qe(N,[T,he])},onEnterCancelled(T){G(T,!1),Qe(V,[T])},onAppearCancelled(T){G(T,!0),Qe(O,[T])},onLeaveCancelled(T){U(T),Qe(te,[T])}})}function jr(e){if(e==null)return null;if(M(e))return[ot(e.enter),ot(e.leave)];{const s=ot(e);return[s,s]}}function ot(e){return sa(e)}function Le(e,s){s.split(/\s+/).forEach(n=>n&&e.classList.add(n)),(e._vtc||(e._vtc=new Set)).add(s)}function es(e,s){s.split(/\s+/).forEach(t=>t&&e.classList.remove(t));const{_vtc:n}=e;n&&(n.delete(s),n.size||(e._vtc=void 0))}function Po(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let wr=0;function qo(e,s,n,t){const o=e._endId=++wr,a=()=>{o===e._endId&&t()};if(n)return setTimeout(a,n);const{type:i,timeout:l,propCount:c}=Jr(e,s);if(!i)return t();const u=i+"end";let h=0;const y=()=>{e.removeEventListener(u,j),a()},j=A=>{A.target===e&&++h>=c&&y()};setTimeout(()=>{h<c&&y()},l+1),e.addEventListener(u,j)}function Jr(e,s){const n=window.getComputedStyle(e),t=P=>(n[P]||"").split(", "),o=t(`${Be}Delay`),a=t(`${Be}Duration`),i=Ro(o,a),l=t(`${Ss}Delay`),c=t(`${Ss}Duration`),u=Ro(l,c);let h=null,y=0,j=0;s===Be?i>0&&(h=Be,y=i,j=a.length):s===Ss?u>0&&(h=Ss,y=u,j=c.length):(y=Math.max(i,u),h=y>0?i>u?Be:Ss:null,j=h?h===Be?a.length:c.length:0);const A=h===Be&&/\b(transform|all)(,|$)/.test(t(`${Be}Property`).toString());return{type:h,timeout:y,propCount:j,hasTransform:A}}function Ro(e,s){for(;e.length<s.length;)e=e.concat(e);return Math.max(...s.map((n,t)=>Fo(n)+Fo(e[t])))}function Fo(e){return Number(e.slice(0,-1).replace(",","."))*1e3}function _r(){return document.body.offsetHeight}const Tr=["ctrl","shift","alt","meta"],Sr={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,s)=>Tr.some(n=>e[`${n}Key`]&&!s.includes(n))},kr=(e,s)=>(n,...t)=>{for(let o=0;o<s.length;o++){const a=Sr[s[o]];if(a&&a(n,s))return}return e(n,...t)},Ar=Z({patchProp:yr},tr);let Ho;function Dr(){return Ho||(Ho=Ii(Ar))}const xr=(...e)=>{const s=Dr().createApp(...e),{mount:n}=s;return s.mount=t=>{const o=Nr(t);if(!o)return;const a=s._component;!I(a)&&!a.render&&!a.template&&(a.template=o.innerHTML),o.innerHTML="";const i=n(o,!1,o instanceof SVGElement);return o instanceof Element&&(o.removeAttribute("v-cloak"),o.setAttribute("data-v-app","")),i},s};function Nr(e){return Q(e)?document.querySelector(e):e}const on=(e,s)=>{const n=e.__vccOpts||e;for(const[t,o]of s)n[t]=o;return n},zr=Fn({props:{report:{type:String,required:!0}},methods:{createIssue(){const e=new FormData(this.$refs.issueForm),s=e.get("title");let n="";const t=e.get("description");t&&(n+=`**Description**
${t}
...
`,options:[{id:"success",page:164,label:"Yes",summary:"Casting the `JsonVariant` fixes the issue"},{id:"failure",page:37,label:"No",summary:"Casting the `JsonVariant` doesn't fix the issue"}]},{content:`<p>This error occurs when you pass a string to <a href="/v6/api/jsonarray/subscript/"><code>JsonArray::operator[]</code></a>; i.e., when you use an array like an object.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Using an integer or switching to an object fixes the issue"},{id:"failure",page:37,label:"No",summary:"Neither using an integer nor switching to an object fixes the issue"}]},{content:`<p>This is a linting error you may have in Visual Studio Code if your program contains something like this:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Passing the capacity to the constructor fixes the issue"},{id:"failure",page:37,label:"No",summary:"Passing the capacity to the constructor doesn't fix the issue"}]},{content:`<p>The error should look like this:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Changing the pointer type fixes the issue"},{id:"failure",page:37,label:"No",summary:"Changing the pointer type doesn't fix the issue"}]},{content:`<p>I recommend that you download <a href="https://github.com/bblanchon/ArduinoJson/releases/download/v5.13.5/ArduinoJson-v5.13.5.h"><code>ArduinoJson-v5.13.5.h</code></a> and save it among the project files, this way you're sure that the project is distributed with the right version of the library.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Downloading ArduinoJson 5 fixes the issue"},{id:"failure",page:37,label:"No",summary:"Downloading ArduinoJson 5 doesn't fix the issue"}]},{content:`<p>Upgrading from v5 to v6 isn't trivial but isn't complicated either.<br>
Please follow the <a href="/v6/doc/upgrade/">upgrade instructions</a>.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Upgrading fixes the issue"},{id:"failure",page:37,label:"No",summary:"Upgrading doesn't fix the issue"}]},{content:`<p>This error occurs when you try to use ArduinoJson 6 with a program written for ArduinoJson 5.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Moving statement to `setup()` fixes the issue"},{id:"failure",page:37,label:"No",summary:"Moving statement to `setup()` doesn't fix the issue"}]},{content:`<p>Somewhere in your program, there is a conversion from <a href="/v6/api/jsonvariantconst/"><code>JsonVariantConst</code></a> to <a href="/v6/api/jsonarray/"><code>JsonArray</code></a>. This conversion is invalid because it would convert a <em>read-only</em> reference to a <em>read-write</em> reference.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Replacing `JsonArray` with `JsonArrayConst` fixes the issue"},{id:"failure",page:37,label:"No",summary:"Replacing `JsonArray` with `JsonArrayConst` doesn't fix the issue"}]},{content:`<p>Somewhere in your program, there is a conversion from <a href="/v6/api/jsonvariantconst/"><code>JsonVariantConst</code></a> to <a href="/v6/api/jsonobject/"><code>JsonObject</code></a>. This conversion is invalid because it would convert a <em>read-only</em> reference to a <em>read-write</em> reference.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Replacing `JsonObject` with `JsonObjectConst` fixes the issue"},{id:"failure",page:37,label:"No",summary:"Replacing `JsonObject` with `JsonObjectConst` doesn't fix the issue"}]},{content:`<p>Somewhere in your program, there is a conversion from <a href="/v6/api/jsonvariantconst/"><code>JsonVariantConst</code></a> to <a href="/v6/api/jsonvariant/"><code>JsonVariant</code></a>. This conversion is invalid because it would convert a <em>read-only</em> reference to a <em>read-write</em> reference.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Replacing `JsonVariant` with `JsonVariantConst` fixes the issue"},{id:"failure",page:37,label:"No",summary:"Replacing `JsonVariant` with `JsonVariantConst` doesn't fix the issue"}]},{content:`<p>Assuming we removed the namespace <code>ArduinoJson6XXX</code> from the error message, what type is incomplete?</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Calling `as<JsonObject>()` or `as<JsonArray>()` solves the issue"},{id:"failure",page:37,label:"No",summary:"Calling `as<JsonObject>()` or `as<JsonArray>()` doesn't solve the issue"}]},{content:`<p><a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> doesn't support copying.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Using a reference solves the issue"},{id:"failure",page:37,label:"No",summary:"Using a reference doesn't solve the issue"}]},{content:`<p>This is a bug in some Arduino cores, most notably the one for <a href="https://en.wikipedia.org/wiki/Atmel_ARM-based_processors#SAM_D">SAMD21</a>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Defining `ARDUINOJSON_ENABLE_STD_STRING` and `ARDUINOJSON_ENABLE_STD_STREAM` to `0` solves the issue"},{id:"failure",page:37,label:"No",summary:"Defining `ARDUINOJSON_ENABLE_STD_STRING` and `ARDUINOJSON_ENABLE_STD_STREAM` to `0` doesn't solve the issue"}]},{content:`<p>This error occurs when you pass a <code>char*</code> to <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a> but forget to pass the third argument.
For example:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Replacing `char*` with `const char*` fixes the issue"},{id:"failure",page:37,label:"No",summary:"Replacing `char*` with `const char*` doesn't fix the issue"}]},{content:`<p>This error happens when you write the following:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc[<span class="hljs-string">&quot;key&quot;</span>].<span class="hljs-built_in">as</span>&lt;<span class="hljs-type">char</span>*&gt;());
<span class="hljs-comment">// or</span>
<span class="hljs-type">char</span> value = doc[<span class="hljs-string">&quot;key&quot;</span>];
</code></pre>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Replacing `char` with `int8_t` fixes the issue"},{id:"failure",page:37,label:"No",summary:"Replacing `char` with `int8_t` doesn't fix the issue"}]},{content:`<p>This error occurs when you forget to pass the capacity to the constructor of <a href="/v6/api/dynamicjsondocument/"><code>DynamicJsonDocument</code></a>, like so:</p>
<pre><code class="hljs language-c++">DynamicJsonDocument doc;
</code></pre>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Converting the value fixes the issue"},{id:"failure",page:37,label:"No",summary:"Converting the value doesn't fix the issue"}]},{content:`<p>This error happens when you write the following:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:`It's the "Most vexing parse"`},{id:"failure",page:37,label:"No",summary:`It's not the "Most vexing parse"`}]},{content:`<p>This error happens when you write the following:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Replacing `char*` with `const char*` fixes the issue"},{id:"failure",page:37,label:"No",summary:"Replacing `char*` with `const char*` doesn't fix the issue"}]},{content:`<p>We typically see this error when your program does somethink like this:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Adding the parentheses fixes the issue"},{id:"failure",page:37,label:"No",summary:"Adding the parentheses doesn't fix the issue"}]},{content:`<p>Please open the file where this error occurs.</p>
<p>Which header does this file includes?</p>
`,options:[{id:"arduinojson-h",page:37,label:"<code>ArduinoJson.h</code>",summary:"The file includes `ArduinoJson.h`"},{id:"arduinojson-hpp",page:28,label:"<code>ArduinoJson.hpp</code>",summary:"The file includes `ArduinoJson.hpp`"},{id:"none",page:29,label:"None of the above",summary:"The file includes neither `ArduinoJson.h` nor  `ArduinoJson.hpp`"}]},{content:`<p>Unlike <code>ArduinoJson.h</code>, <code>ArduinoJson.hpp</code> keeps everything in the <code>ArduinoJson</code> namespace.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Adding `using namespace ArduinoJson` fixes the issue"},{id:"failure",page:37,label:"No",summary:"Adding `using namespace ArduinoJson`doesn't fix the issue"}]},{content:`<p>Please add the following line at the top of your program:</p>
...
`,options:[{id:"success",page:164,label:"Yes",summary:"Including `ArduinoJson.h` fixes the issue"},{id:"failure",page:37,label:"No",summary:"Including `ArduinoJson.h` doesn't fix the issue"}]},{content:`<p>This error comes from a bug in the <a href="https://github.com/arduino/ArduinoCore-API">Arduino Core API</a> (or <code>Arduino.h</code>, if you prefer).
...
<p>Did this fix your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Defining `ARDUINOJSON_ENABLE_PROGMEM` to `0` solves the issue"},{id:"failure",page:37,label:"No",summary:"Defining `ARDUINOJSON_ENABLE_PROGMEM` to `0` doesn't solve the issue"}]},{content:`<p>In your program, there is a line that look like this:</p>
...
`,options:[{id:"success",page:164,label:"Yes",summary:"Using a queue solves the issue."},{id:"failure",page:37,label:"No",summary:"Cannot use a queue."}]},{content:`<p>This problem is not related to ArduinoJson, but it's a known issue on Windows.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Casting the value or using `serializeJson()` solves the issue"},{id:"failure",page:37,label:"No",summary:"Neither casting the value nor using `serializeJson()` solves the issue"}]},{content:`<p>If you try to use ArduinoJson with a C compiler (or a C++ compiler targeting the C language), you'll get the following error message:</p>
<blockquote>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Changing the file extension to `.cpp` fixes the error"},{id:"failure",page:37,label:"No",summary:"Changing the file extension to `.cpp` doesn't fix the error"}]},{content:`<p>Please click on the &quot;Contact Support&quot; button below and provide the following information:</p>
<ul>
...
`,options:[{id:"ok",page:117,label:"<code>Ok</code>",summary:"`deserializeJson()` returns `Ok`"},{id:"emptyinput",page:53,label:"<code>EmptyInput</code>",summary:"`deserializeJson()` returns `EmptyInput`"},{id:"incompleteinput",page:68,label:"<code>IncompleteInput</code>",summary:"`deserializeJson()` returns `IncompleteInput`"},{id:"invalidinput",page:75,label:"<code>InvalidInput</code>",summary:"`deserializeJson()` returns `InvalidInput`"},{id:"nomemory",page:150,label:"<code>NoMemory</code>",summary:"`deserializeJson()` returns `NoMemory`"},{id:"notsupported",page:158,label:"<code>NotSupported</code>",summary:"`deserializeJson()` returns `NotSupported`"},{id:"toodeep",page:163,label:"<code>TooDeep</code>",summary:"`deserializeJson()` returns `TooDeep`"},{id:"crash",page:40,label:"I can't tell because the program crashes",summary:"The program crashes"},{id:"unknown",page:39,label:"I don't know what you're talking about",summary:"The program doesn't check the error"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/"><code>DeserializationError</code></a> is the return type of <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>. It tells whether the operation succeeded and indicates the cause of the error.</p>
...
`,options:[{id:"before",page:46,label:"None: program crashes before calling <code>deserializeJson()</code>",summary:"Program crashes before calling `deserializeJson()`"},{id:"inside",page:48,label:"Only one: program crashes inside <code>deserializeJson()</code>",summary:"Program crashes inside `deserializeJson()`"},{id:"after",page:41,label:"Two traces: program crashes after calling <code>deserializeJson()</code>",summary:"Program crashes after calling `deserializeJson()`"}]},{content:`<p>Most of the time, when a program crashes after <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, it's because it dereferences a null pointer returned by the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>.</p>
...
`,options:[{id:"strcmp",page:44,label:"Yes, there is a call to <code>strcmp()</code>",summary:"Program calls `strcmp()`"},{id:"strcpy",page:45,label:"Yes, there is a call to <code>strcpy()</code>",summary:"Program calls `strcpy()`"},{id:"printf",page:43,label:"Yes, there is a call to <code>printf()</code>, <code>sprintf()</code>, or <code>snprintf()</code>",summary:"Program calls `printf()`, `sprintf()`, or `snprintf()`"},{id:"success",page:164,label:"Yes, I found the issue",summary:"Program dereferences a null pointer"},{id:"no-usual-suspect",page:42,label:"No",summary:"Program calls neither `strcmp()`, nor `strcpy()`, not `printf()`"}]},{content:`<p>A programs can also crash after calling <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> because it keeps a pointer to a string stored in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Replacing pointer with a `String` solves the issue"},{id:"failure",page:37,label:"No",summary:"Replacing pointer with a `String` doesn't solve the issue"}]},{content:`<p>As far as the standard is concerned, the behavior of <code>printf()</code>, <code>sprintf()</code>, and <code>snprintf()</code> is undefined if a <code>%s</code> refers to a null string.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Replacing `strcmp()` with `==` solves the issue"},{id:"failure",page:37,label:"No",summary:"Replacing `strcmp()` with `==` doesn't solve the issue"}]},{content:`<p>As per the standard, the behavior of <a href="https://en.cppreference.com/w/c/string/byte/strcpy"><code>strcpy()</code></a> (and <a href="https://en.wikibooks.org/wiki/C_Programming/C_Reference/nonstandard/strlcpy"><code>strlcpy()</code></a>) is undefined if one of the pointers is null.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Providing a non-null default solves the issue"},{id:"failure",page:37,label:"No",summary:"Providing a non-null default doesn't solve the issue"}]},{content:`<p>A stack-overflow could cause the crash.</p>
<p>Do you use a <a href="/v6/api/staticjsondocument/"><code>StaticJsonDocument</code></a>?</p>
`,options:[{id:"static",page:52,label:"Yes",summary:"Program uses `StaticJsonDocument`"},{id:"no-static",page:47,label:"No",summary:"Program doesn't use `StaticJsonDocument`"}]},{content:`<p>I still think this could be a stack-overflow.</p>
...
`,options:[{id:"failure",page:37,label:"Yes",summary:"Reducing stack usage doesn't prevent the crash"},{id:"success",page:164,label:"No",summary:"Reducing stack usage prevents the crash"}]},{content:`<p>Passing a dangling pointer could cause a crash.</p>
...
<p>Does your program still crash?</p>
`,options:[{id:"no-dangling-ptr",page:46,label:"Yes",summary:"Removing dangling pointers doesn't prevent the crash"},{id:"success",page:164,label:"No",summary:"Removing dangling pointers prevents the crash"}]},{content:`<p>Well, that's very bad news. It seems that your microcontroller doesn't have enough RAM to hold the JSON document.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Increasing the capacity fixes the issue"},{id:"failure",page:37,label:"No",summary:"Increasing the capacity doesn't fix the issue"}]},{content:`<p>It looks like the allocation failed.</p>
...
`,options:[{id:"success",page:164,label:"Yes",summary:"Switching to `DynamicJsonDocument` prevents the crash"},{id:"nomemory",page:51,label:"Yes, but now <code>deserializeJson()</code> returns <code>NoMemory</code>",summary:"Switching to `DynamicJsonDocument` produces `NoMemory`"},{id:"dynamicjsondocument-too",page:47,label:"No",summary:"Switching to `DynamicJsonDocument` doesn't prevent the crash"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#emptyinput"><code>EmptyInput</code></a> means that the input was empty or contained only spaces or comments.</p>
<p>Where does your JSON input come from?</p>
`,options:[{id:"http",page:60,label:"An HTTP response",summary:"Input comes from an HTTP response"},{id:"file",page:54,label:"A file",summary:"Input comes from a file"},{id:"serial",page:67,label:"A serial port",summary:"Input comes from a serial port"},{id:"other",page:65,label:"Something else",summary:"Input comes neither from an HTTP response, nor a file, nor a serial port"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#emptyinput"><code>EmptyInput</code></a> in the context of a file usually means:</p>
<ul>
...
`,options:[{id:"success",page:164,label:"Yes",summary:"The file was the problem"},{id:"failure",page:37,label:"No",summary:"The file is not the problem"}]},{content:`<p>We tried everything we could on the client side, so I'm starting to suspect an issue with the server.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Following the redirection fixes the issue"},{id:"follow",page:61,label:"No",summary:"Following the redirection doesn't fix the issue"}]},{content:`<p>A negative number indicates an error on the client side.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"certificate-problem",page:57,label:"Yes",summary:"Calling `WiFiClientSecure::setInsecure()` solves the issue."},{id:"certificate-ok",page:56,label:"No",summary:"Calling `WiFiClientSecure::setInsecure()` doesn't solve the issue."}]},{content:`<p>Please check the HTTP status</p>
<p>For example, if you use <code>HTTPClient</code>, what value is returned by <code>http.GET()</code>?</p>
`,options:[{id:"redirect",page:58,label:"<code>300</code> to <code>399</code>",summary:"The status code indicates a redirection"},{id:"negative",page:59,label:"A negative number",summary:"The status code is negative"},{id:"status-ok",page:61,label:"None of the above",summary:"The status code is not in the list"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#emptyinput"><code>EmptyInput</code></a> could be caused by a timeout while reading the response.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Increasing the timeout fixes the issue"},{id:"timeout-increased",page:55,label:"No",summary:"Increasing the timeout doesn't fix the issue"}]},{content:`<p>This confirms that the problem comes from the input: it is indeed empty, or at least starts with a NUL character.</p>
...
<p>What do you see?</p>
`,options:[{id:"zero",page:62,label:"<code>0</code>",summary:"The first character is NUL"},{id:"non-zero",page:37,label:"Something else",summary:"The first character is not NUL"}]},{content:`<p>Please print the ASCII code for the first character, like so:</p>
...
<p>What do you see?</p>
`,options:[{id:"zero",page:62,label:"<code>0</code>",summary:"The first character is NUL"},{id:"non-zero",page:37,label:"Something else",summary:"The first character is not NUL"}]},{content:`<p>The input is probably starting with a NUL character.</p>
<p>What type of input are you passing to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>?</p>
`,options:[{id:"string",page:64,label:"A string (<code>const char*</code>, <code>String</code>, <code>std::string</code>...)",summary:"Input type is a string"},{id:"stream",page:63,label:"A stream (<code>Serial</code>, <code>WiFiClient</code>, <code>File</code>...)",summary:"Input type is a stream"}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> also returns <a href="/v6/api/misc/deserializationerror/#emptyinput"><code>EmptyInput</code></a> when the input contains only spaces.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Removing CRLF fixes the issue"},{id:"failure",page:37,label:"No",summary:"Removing CRLF doesn't fix the issue"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#emptyinput"><code>EmptyInput</code></a> can be caused by a timeout while waiting for the input.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Adding a wait loop fixes the issue"},{id:"available",page:66,label:"No",summary:"Adding a wait loop doesn't fix the issue"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#incompleteinput"><code>IncompleteInput</code></a> means that <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> managed to parse the beginning of the JSON document, but the end was missing.</p>
<p>What type of input do you pass to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>?</p>
`,options:[{id:"stream",page:71,label:"A stream",summary:"Input comes from a stream"},{id:"string",page:72,label:"A string object (like <code>String</code>)",summary:"Input comes from a string object"},{id:"pointer",page:73,label:"A pointer (like <code>char*</code> or <code>const char*</code>)",summary:"Input comes from a pointer"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#incompleteinput"><code>IncompleteInput</code></a> can be caused by an interruped connection. For example, this problem happens when the client reads to slowly.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Adding a buffer solves the issue"},{id:"same-with-buffer",page:70,label:"No",summary:"Adding a buffer doesn't solve the issue"}]},{content:`<p>Maybe seeing where the input stops will give you an idea of what's going wrong.</p>
...
`,options:[{id:"success",page:164,label:"Yes",summary:"Logging helped fixing the issue"},{id:"failure",page:37,label:"No",summary:"Logging didn't help fixing the issue"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#incompleteinput"><code>IncompleteInput</code></a> can be caused by a timeout.</p>
<p>Please increase the value of the timeout by calling <a href="https://www.arduino.cc/reference/en/language/functions/communication/stream/streamsettimeout/"><code>Stream::setTimeout()</code></a> before calling <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>. For example:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Inreasing the timeout solves the issue"},{id:"timeout-increased",page:69,label:"No",summary:"Inreasing the timeout doesn't solve the issue"}]},{content:`<p>Please print the content of the string to the serial port, like so:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:164,label:"Yes",summary:"Calling `String::reserve()` solves the issue"},{id:"1",page:74,label:"No",summary:"Calling `String::reserve()` doesn't solve the issue"}]},{content:`<p>I'll assume that your input is stored in a buffer similar to this one:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:164,label:"Yes",summary:"Increasing the buffer size solves the issue"},{id:"1",page:74,label:"No",summary:"Increasing the buffer size doesn't solve the issue"}]},{content:`<p>To reduce the memory usage, you should try to pass the source (file, connection, stream, etc) directly to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, either via the <a href="https://www.arduino.cc/reference/en/language/functions/communication/stream/"><code>Stream</code></a> interface or via a <a href="/news/2019/11/01/version-6-13-0/">custom reader</a>. This will avoid the need for an intermediate buffer.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:164,label:"Yes",summary:"Reading from stream fixes the issue"},{id:"1",page:37,label:"No",summary:"Reading from stream doesn't fix the issue"}]},{content:`<p>Where does the input come from?</p>
`,options:[{id:"http",page:84,label:"An HTTP response",summary:"Input comes from HTTP"},{id:"serial",page:111,label:"A serial port",summary:"Input comes from a serial port"},{id:"file",page:83,label:"A file",summary:"Input comes from a file"},{id:"stream",page:114,label:"A stream",summary:"Input comes from a stream"},{id:"string",page:116,label:"A string (like <code>String</code> or <code>const char*</code>)",summary:"Input comes from a string"},{id:"char-ptr",page:78,label:"A char array or pointer (like <code>char[]</code> or <code>char*</code>)",summary:"Input comes from a char array"}]},{content:`<p>If you must keep the two calls to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, you need to disable the zero-copy mode by passing a read-only input buffer. Casting the pointer will do the trick:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// replace this:</span>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Casting the pointer fixes the issue"},{id:"cast",page:116,label:"No",summary:"Casting the pointer doesn't fix the issue"}]},{content:`<p>When you pass a writeable buffer as the input of <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, ArduinoJson uses the zero-copy mode. Instead of copying the strings from the input into the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, it stores pointers to the input buffer.</p>
...
`,options:[{id:"success",page:164,label:"Yes, and it fixes the issue",summary:"Removing the second call fixes the issue"},{id:"second-removed",page:116,label:"Yes, but it doesn't fix the issue",summary:"Removing the second call doesn't fix the issue"},{id:"cannot-remove",page:76,label:"No",summary:"The second call cannot be removed"}]},{content:`<p>Did you call <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> twice with the same input buffer?</p>
`,options:[{id:"two-calls",page:77,label:"Yes",summary:"Program calls `deserializeJson()` twice"},{id:"one-call",page:116,label:"No",summary:"Program doesn't call `deserializeJson()` twice"}]},{content:`<p>So, the JSON document is valid and not preceded by anything; yet, <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> returns <a href="/v6/api/misc/deserializationerror/#invalidinput"><code>InvalidInput</code></a>.</p>
...
`,options:[{id:"success",page:164,label:"Yes",summary:"Skipping the first 3 bytes solves the issue"},{id:"failure",page:37,label:"No",summary:"Skipping the first 3 bytes doesn't solve the issue"}]},{content:`<p>We must check that the JSON document is not preceded by a <a href="https://en.wikipedia.org/wiki/Byte_order_mark">Byte Order Mark</a> (BOM).</p>
...
`,options:[{id:"utf8",page:81,label:"<code>239</code>",summary:"Input's first byte suggests a UTF-8 BOM"},{id:"utf16",page:80,label:"<code>254</code> or <code>255</code>",summary:"Input's first byte suggests a UTF-16 BOM"},{id:"no-bom",page:79,label:"Something else",summary:"Input's first byte doesn't suggest a BOM"}]},{content:`<p>We need to make sure that the JSON document is valid.
...
`,options:[{id:"valid",page:82,label:"Yes",summary:"`jsonlint` says the document is valid"},{id:"invalid",page:100,label:"No",summary:"`jsonlint` says the document is invalid"}]},{content:`<p>Do you use an HTTP library?</p>
`,options:[{id:"httpclient",page:85,label:"Yes, I'm using <code>HTTPClient</code>",summary:"Program uses `HTTPClient`"},{id:"http-library",page:98,label:"Yes, but it's not <code>HTTPClient</code>",summary:"Program uses an unknown HTTP library"},{id:"no-library",page:94,label:"No",summary:"Program doesn't use an HTTP library"}]},{content:`<p>Did you check the status code?</p>
`,options:[{id:"status-ok",page:87,label:"Yes",summary:"The program already checks the status code"},{id:"check-status",page:86,label:"No",summary:"The program doesn't check the status code"}]},{content:`<p>Please check the status code like so:</p>
...
<p>What do you get?</p>
`,options:[{id:"ok",page:87,label:"<code>200</code>",summary:"The status code is `200`"},{id:"positive",page:90,label:"A positive number (but not <code>200</code>)",summary:"The status code is positive"},{id:"negative",page:89,label:"A negative number",summary:"The status code is negative"}]},{content:`<p>Which function of <code>HTTPClient</code> do you call to get the response?</p>
`,options:[{id:"getstream",page:93,label:"<code>getStream()</code>",summary:"Response comes from `HTTPClient::getStream()`"},{id:"getstring",page:116,label:"<code>getString()</code>",summary:"Response comes from `HTTPClient::getString()`"},{id:"readstring",page:88,label:"<code>readString()</code>",summary:"Response comes from `HTTPClient::readString()`"}]},{content:`<p>You're calling the wrong function:</p>
<ul>
...
`,options:[{id:"success",page:164,label:"Yes",summary:"Calling `HTTPClient::getString()` solves the issue"},{id:"getstring",page:116,label:"No",summary:"Calling `HTTPClient::getString()` doesn't solves the issue"}]},{content:`<p>A negative number indicates an error on the client side.</p>
<p>Here are the possible values that I'm aware of:</p>
<table class="table">
<thead>
<tr>
...
<p>Did this solve your problem?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Calling `HTTPClient::useHTTP10(true)` solves the issue"},{id:"changed",page:92,label:"No",summary:"Calling `HTTPClient::useHTTP10(true)` doesn't solve the issue"}]},{content:`<p>We need to make sure that the JSON document is valid.
...
<p>Is the JSON document valid?</p>
`,options:[{id:"valid",page:112,label:"Yes",summary:"jsonlint says the document is valid"},{id:"invalid",page:100,label:"No",summary:"jsonlint says the document is invalid"}]},{content:`<p>Did you call <code>HTTPClient::useHTTP10(true)</code>?</p>
`,options:[{id:"http10-true",page:92,label:"Yes",summary:"Program calls `HTTPClient::useHTTP10(true)`"},{id:"http10-false",page:91,label:"No",summary:"Program doesn't call `HTTPClient::useHTTP10(true)`"}]},{content:`<p>Before calling <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, did you skip the HTTP headers?</p>
`,options:[{id:"headers-skipped",page:97,label:"Yes",summary:"HTTP headers are skipped"},{id:"headers-not-skipped",page:96,label:"No",summary:"HTTP headers are not skipped"}]},{content:`<p>On some Arduino core (most notably <a href="https://github.com/arduino/ArduinoCore-avr/blob/master/cores/arduino/Stream.h">AVR core</a>), <a href="https://www.arduino.cc/reference/en/language/functions/communication/stream/streamfind/"><code>Stream::find()</code></a> takes a <code>char*</code> instead of a <code>const char*</code>. In this case, you'll get a compiler warning, which you can fix by extracting a char array, like so:</p>
...
<p>Did this fix your problem?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Using a `char[]` fixes the warning"},{id:"failure",page:37,label:"No",summary:"Using a `char[]` doesn't fix the warning"}]},{content:`<p>Just like the HTTP request, the response contains some headers, followed by an empty line, and then followed by the body.
...
<p>Did this fix your problem?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Skipping HTTP headers solves the issue"},{id:"warning",page:95,label:"Yes, but there is a compiler warning about <code>client.find()</code>",summary:"Skipping HTTP headers solves the issue, but there is a warning"},{id:"header-skipped",page:97,label:"No",summary:"Skipping HTTP headers doesn't solve the issue"}]},{content:`<p>When you use HTTP 1.1, the server can send the response with <a href="https://en.wikipedia.org/wiki/Chunked_transfer_encoding">Chunked Transfer Encoding</a>.
As a result, the response's body may contain some hexadecimal number at the begining of each chunk.
The most straightforward workaround is to downgrade the connection to HTTP 1.0.</p>
<p>To do this, replace <code>HTTP/1.1</code> with <code>HTTP/1.0</code> in the first line of the request.</p>
<p>Did this solve your problem?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Using `HTTP/1.0` solves the issue"},{id:"http10",page:99,label:"No",summary:"Using `HTTP/1.0` doesn't solve the issue"}]},{content:`<p>Unfortunately, I only know how to use the following HTTP libraries:</p>
<ul>
...
`,options:[{id:"stream",page:112,label:"A stream",summary:"The input is a stream"},{id:"string",page:115,label:"A string",summary:"The input is a string"}]},{content:`<p>What is wrong with this JSON document?</p>
`,options:[{id:"comments",page:101,label:"It contains comments",summary:"The document contains comments"},{id:"other-error",page:102,label:"Something else",summary:"The document doesn't contain comments"}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> can read JSON documents that contain comments, but the support is disabled by default to reduce the footprint of the library.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Setting ARDUINOJSON_ENABLE_COMMENTS to 1 solves the issue"},{id:"failure",page:37,label:"No",summary:"Setting ARDUINOJSON_ENABLE_COMMENTS to 1 doesn't solve the issue"}]},{content:`<p>Well, if the JSON document is invalid, you have to fix it, otherwise ArduinoJson won't be able to parse it.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Increasing serial buffer size solves the issue"},{id:"larger-buffer",page:112,label:"No",summary:"Increasing serial buffer size doesn't solves the issue"}]},{content:`<p>Any electric wire acts as an antenna; the longer the wire, the stronger the effect. This antenna picks up every electromagnetic field in the environment, which induces a current in the wire. On long wires, this current is strong enough to introduce errors in the communication.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Upgrading the cables solves the issue"},{id:"improved",page:106,label:"Somehow",summary:"Upgrading the cables improves the situation"},{id:"no-improvment",page:107,label:"No",summary:"Upgrading the cables doesn't solve the issue"}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> may return <a href="/v6/api/misc/deserializationerror/#invalidinput"><code>InvalidInput</code></a> because it starts reading the input mid-stream.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Flushing the serial buffer fixes the issue"},{id:"flush",page:110,label:"No",summary:"Flushing the serial buffer doesn't fix the issue"}]},{content:`<p><a href="https://en.wikipedia.org/wiki/Error_correction_code">Error-correction codes (ECC)</a> are a way of transmitting the data with redundant information that allows the receiver to fix most of the errors.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Error-correction codes fix the issue"},{id:"ecc",page:107,label:"No",summary:"Error-correction codes doesn't fix the issue"}]},{content:`<p>We need to make sure that the JSON document is valid.
To do that, please print the input to the serial port, like so:</p>
...
<p>Then, copy the response and paste it in a JSON linter, like <a href="https://jsonlint.com/">jsonlint.com</a>.</p>
<p>Is the JSON document valid?</p>
`,options:[{id:"valid",page:103,label:"Yes",summary:"`jsonlint` says the document is valid"},{id:"invalid",page:100,label:"No",summary:"`jsonlint` says the document is invalid"}]},{content:`<p>Any kind of communication is subject to errors: sometimes you send a <code>1</code> and receive a <code>0</code>.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Removing `SoftwareSerial` solves the issue"},{id:"removed",page:110,label:"No",summary:"Removing `SoftwareSerial` doesn't solve the issue"}]},{content:`<p>Not all microcontrollers use the same voltage for the serial port.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"The issue is a voltage mismatch"},{id:"voltage-ok",page:108,label:"No",summary:"The issue is not a voltage mismatch"}]},{content:`<p>Are you using <a href="https://www.arduino.cc/en/Reference/SoftwareSerial"><code>SoftwareSerial</code></a>?</p>
`,options:[{id:"software",page:109,label:"Yes",summary:"Program uses `SoftwareSerial`"},{id:"hardware",page:105,label:"No",summary:"Program doesn't use `SoftwareSerial`"}]},{content:`<p>We must check that the JSON document is not preceded by a  <a href="https://en.wikipedia.org/wiki/Byte_order_mark">Byte Order Mark</a> (BOM).</p>
...
<p>What value does it print?</p>
`,options:[{id:"utf8",page:81,label:"<code>239</code>",summary:"Input's first byte suggests a UTF-8 BOM"},{id:"utf16",page:80,label:"<code>254</code> or <code>255</code>",summary:"Input's first byte suggests a UTF-16 BOM"},{id:"no-bom",page:79,label:"Something else",summary:"Input's first byte doesn't suggest a BOM"}]},{content:`<p>Sometimes, the input is invalid because some bytes were dropped when receiving the document.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Adding a buffer solves the issue"},{id:"buffer",page:112,label:"No",summary:"Adding a buffer doesn't solve the issue"}]},{content:`<p>We need to make sure that the JSON document is valid.
To do that, please print the input to the serial port, like so:</p>
...
<p>Then, copy the response and paste it in a JSON linter, like <a href="https://jsonlint.com/">jsonlint.com</a>.</p>
<p>Is the JSON document valid?</p>
`,options:[{id:"valid",page:113,label:"Yes",summary:"`jsonlint` says the document is valid"},{id:"invalid",page:100,label:"No",summary:"`jsonlint` says the document is invalid"}]},{content:`<p>We must check that the JSON document is not preceded by a  <a href="https://en.wikipedia.org/wiki/Byte_order_mark">Byte Order Mark</a> (BOM).</p>
...
<p>Then, copy the response and paste it in a JSON linter, like <a href="https://jsonlint.com/">jsonlint.com</a>.</p>
<p>Is the JSON document valid?</p>
`,options:[{id:"valid",page:115,label:"Yes",summary:"`jsonlint` says the document is valid"},{id:"invalid",page:100,label:"No",summary:"`jsonlint` says the document is invalid"}]},{content:`<p>So, what's the problem then?</p>
`,options:[{id:"slow",page:141,label:"It's slow",summary:"Deserialisation is slow"},{id:"invalid",page:118,label:"I expected <code>InvalidInput</code> instead of <code>Ok</code>",summary:"`Ok` is incorrect; it should be `InvalidInput`"},{id:"crash",page:41,label:"My program crashes after calling <code>deserializeJson()</code>",summary:"Program crashes after calling `deserializeJson()`"},{id:"empty",page:130,label:"<code>JsonDocument</code> returns empty/null values",summary:"Program fails to extract values from the `JsonDocument`"},{id:"garbage",page:122,label:"<code>JsonDocument</code> returns garbage",summary:"`JsonDocument` returns garbage"},{id:"changing-strings",page:122,label:"The strings in the <code>JsonDocument</code> change for no reason",summary:"The strings in the `JsonDocument` change for no reason"},{id:"altered",page:126,label:"<code>deserializeJson()</code> alters the content of the input",summary:"Input buffer is modified"},{id:"truncated-strings",page:142,label:"Some strings are truncated",summary:"Some strings are truncated"}]},{content:`<p>What's the first character of your input?</p>
`,options:[{id:"brace",page:119,label:"An opening brace: <code>{</code>",summary:"The first character is `{`"},{id:"bracket",page:120,label:"An opening bracket: <code>[</code>",summary:"The first character is `[`"},{id:"quote",page:121,label:"A quote: <code>&quot;</code>",summary:'The first character is `"`'},{id:"other",page:149,label:"None of the above",summary:'The first character is neither `{`, nor `[`, nor `"`'}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> stops reading as soon as the JSON document ends.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Garbage characters follow the input"},{id:"lint",page:129,label:"No",summary:"No garbage characters follow the input"}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> stops reading as soon as the JSON document ends.
In your case, it will read the input until it reaches the matching <code>]</code> and ignore any remaining characters.</p>
<p>Suppose the input looks like this:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Garbage characters follow the input"},{id:"lint",page:129,label:"No",summary:"No garbage characters follow the input"}]},{content:`<p>What is the type of the second argument passed to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>?</p>
`,options:[{id:"char-ptr",page:125,label:"<code>char*</code> (or <code>char[]</code>)",summary:"Input type is `char*`"},{id:"const-char-ptr",page:37,label:"<code>const char*</code>",summary:"Input type is `const char*`"},{id:"string",page:37,label:"<code>String</code> (or <code>std::string</code>)",summary:"Input type is `String`"},{id:"stream",page:37,label:"<code>Stream</code> (or <code>std::istream)</code>",summary:"Input type is `Stream`"}]},{content:`<p>The easiest solution is to disable the zero-copy mode by passing a read-only input buffer. Casting the pointer will do the trick:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// replace this:</span>
<span class="hljs-built_in">deserializeJson</span>(doc, input, inputSize);
...
<p>Now that the zero-copy mode is disabled, you probably need a larger <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, so don't forget to update the capacity. As usual, use the <a href="/v6/assistant/">ArduinoJson Assistant</a> to compute the right capacity for your project.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Casting the pointer fixes the issue"},{id:"cast",page:37,label:"No",summary:"Casting the pointer doesn't fix the issue"}]},{content:`<p>The easiest solution is to remove the buffer and pass the input stream directly to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>.</p>
...
`,options:[{id:"success",page:124,label:"Yes, the input comes from a stream",summary:"Input comes from a stream"},{id:"cast",page:123,label:"No, it doesn't",summary:"Input doesn't come from a stream"}]},{content:`<p>When you pass a writeable buffer as the input of <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, ArduinoJson uses the zero-copy mode. Instead of copying the strings from the input into the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, it stores pointers to the input buffer.</p>
<p>While doing this, the parser modifies the input buffer to unescape special characters and add string terminator.
...
<p>Now that the zero-copy mode is disabled, you probably need a larger <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, so don't forget to update the capacity. As usual, use the <a href="/v6/assistant/">ArduinoJson Assistant</a> to compute the right capacity for your project.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Casting the pointer fixes the issue"},{id:"cast",page:37,label:"No",summary:"Casting the pointer doesn't fix the issue"}]},{content:`<p>ArduinoJson isn't very picky about the input: its implementation favors code size and speed over strict conformance.
...
<p>Did this solve your issue?</p>
`,options:[{id:"acceptable",page:164,label:"Yes",summary:"`deserializeJson()` tolerates the error, and that's OK"},{id:"unacceptable",page:149,label:"No",summary:"`deserializeJson()` should not let this error pass"}]},{content:`<p>So, <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> returns <code>Ok</code>, and jsonlint confirms that the input is valid.</p>
...
`,options:[{id:"valid",page:128,label:"Document is valid",summary:"jsonlint says the document is valid"},{id:"invalid",page:127,label:"Document is invalid",summary:"jsonlint says the document is invalid"}]},{content:`<p>Do you use a filter (with <code>DeserializationOption::Filter</code>)?</p>
`,options:[{id:"filter",page:133,label:"Yes",summary:"Program uses `DeserializationOption::Filter`"},{id:"no-filter",page:137,label:"No",summary:"Program doesn't use `DeserializationOption::Filter`"}]},{content:`<p>When a program fails to extract the values from a <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, it's often because there is a confusion between arrays and objects.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Issue is a confusion between array and object"},{id:"array-object",page:37,label:"No",summary:"Issue is not a confusion between array and object"}]},{content:`<p>Maybe the filter excludes the part that it should keep. Let's verify that it's doing its job correctly.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Fixing the filter solves the issue"},{id:"filter-ok",page:137,label:"No",summary:"Fixing the filter doesn't solve the issue"}]},{content:`<p>Please print the filter to the serial port like so:</p>
...
`,options:[{id:"size-ok",page:132,label:"Yes",summary:"The filter looks correct"},{id:"too-small",page:134,label:"No, some values are missing",summary:"The filter lacks some values"}]},{content:`<p>The filter's <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> is too small; please increase its capacity and try again.</p>
<p>If you want, you can use the <a href="/v6/assistant/">ArduinoJson Assistant</a> to compute the required capacity.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Increasing the filter's capacity fixes the issue"},{id:"size-increased",page:132,label:"No",summary:"Increasing the filter's capacity doesn't fix the issue"}]},{content:`<p>Which function do you call to deserialize the input?</p>
`,options:[{id:"json",page:37,label:"<code>deserializeJson()</code>",summary:"Program calls `deserializeJson()`"},{id:"msgpack",page:136,label:"<code>deserializeMsgPack()</code>",summary:"Program calls `deserializeMsgPack()`"}]},{content:`<p>It seems that your program fed <a href="/v6/api/msgpack/deserializemsgpack/"><code>deserializeMsgPack()</code></a> with garbage input.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"The input was incorrect"},{id:"not-garbage",page:37,label:"No",summary:"The input is correct"}]},{content:`<p>Please print the content of the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> to the serial port like so:</p>
...
`,options:[{id:"quote",page:140,label:"A quote (<code>&quot;</code>)",summary:"Serialized document starts with a quote"},{id:"bracket",page:131,label:"A square bracket (<code>[</code>)",summary:"Serialized document starts with a square bracket"},{id:"brace",page:131,label:"A curly brace (<code>{</code>)",summary:"Serialized document starts with a curly brace"},{id:"not-in-list",page:135,label:"None of the above",summary:"Serialized document starts with neither a quote, a bracket, nor a brace."}]},{content:`<p>If you cannot fix the server, you can at least reverse the double serialization (stringification) to get back the original object.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Calling `deserializeJson()` twice fixes the issue"},{id:"call-twice",page:37,label:"No",summary:"Calling `deserializeJson()` twice doesn't fix the issue"}]},{content:`<p>In the server implementation, please look at the view that returns the faulty JSON.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"`ReadBufferingStream` solves the issue"},{id:"buffered",page:37,label:"No",summary:"`ReadBufferingStream` doesn't solve the issue"}]},{content:`<p>Does the JSON input contain the Unicode character <code>\\u0000</code>?</p>
`,options:[{id:"nul",page:165,label:"Yes",summary:"The input contains `\\u0000`"},{id:"no-nul",page:148,label:"No",summary:"The input doesn't contain `\\u0000`"}]},{content:`<p>When you call <code>HTTPClient::getStream()</code>, you bypass the part that handles <a href="https://en.wikipedia.org/wiki/Chunked_transfer_encoding">Chunked Transfer Encoding</a>.
...
<p>Did this solve your problem?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Calling `HTTPClient::useHTTP10(true)` solves the issue"},{id:"http10",page:37,label:"No",summary:"Calling `HTTPClient::useHTTP10(true)` doesn't solve the issue"}]},{content:`<p>Which function of <code>HTTPClient</code> do you call to get the response?</p>
`,options:[{id:"getstream",page:143,label:"<code>getStream()</code>",summary:"Response comes from `HTTPClient::getStream()`"},{id:"getstring",page:37,label:"<code>getString()</code>",summary:"Response comes from `HTTPClient::getString()`"}]},{content:`<p>When you use HTTP 1.1, the server can send the response with <a href="https://en.wikipedia.org/wiki/Chunked_transfer_encoding">Chunked Transfer Encoding</a>.
As a result, the response's body may be split in multiple chunks, making some strings look like they are truncated (in reality, they contain a line-break).</p>
<p>The most straightforward workaround is to downgrade the connection to HTTP 1.0.
To do this, replace <code>HTTP/1.1</code> with <code>HTTP/1.0</code> in the first line of the request.</p>
<p>Did this solve your problem?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Using `HTTP/1.0` solves the issue"},{id:"http10",page:37,label:"No",summary:"Using `HTTP/1.0` doesn't solve the issue"}]},{content:`<p>Unfortunately, I only know how to use the following HTTP libraries:</p>
<ul>
<li><a href="https://github.com/esp8266/Arduino/tree/master/libraries/ESP8266HTTPClient">ESP8266HTTPClient</a></li>
<li><a href="https://github.com/espressif/arduino-esp32/tree/master/libraries/HTTPClient">HTTPClient for ESP32</a></li>
</ul>
`,tags:["needs_assistance"]},{content:`<p>Do you use an HTTP library?</p>
`,options:[{id:"httpclient",page:144,label:"Yes, I'm using <code>HTTPClient</code>",summary:"Program uses `HTTPClient`"},{id:"http-library",page:146,label:"Yes, but it's not <code>HTTPClient</code>",summary:"Program uses an unknown HTTP library"},{id:"no-library",page:145,label:"No",summary:"Program doesn't use an HTTP library"}]},{content:`<p>Does the JSON input come from an HTTP response?</p>
`,options:[{id:"http",page:147,label:"Yes",summary:"The input comes from an HTTP response"},{id:"no-nul",page:37,label:"No",summary:"The input doesn't come from an HTTP response"}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> accepted a JSON document that was clearly invalid.<br>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Increasing the capacity of the `JsonDocument` fixes the issue"},{id:"increased-capacity",page:157,label:"No",summary:"Increasing the capacity of the `JsonDocument` doesn't fix the issue"}]},{content:`<p>I'm pretty confident the Assistant computes the right capacity; however, some settings can affect the result:</p>
<ol>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Changing the Assistant settings solves the issue"},{id:"failure",page:37,label:"No",summary:"Changing the Assistant settings doesn't solve the issue"}]},{content:`<p><code>doc.capacity()</code> returns <code>0</code>, which means <code>allocate()</code> returned <code>NULL</code>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Making `doc` local fixes the issue."},{id:"failure",page:37,label:"No",summary:"Making `doc` local doesn't fix the issue."}]},{content:`<p>Is <code>doc</code> a global variable?</p>
`,options:[{id:"global",page:152,label:"Yes",summary:"`doc` is a global variable"},{id:"local",page:151,label:"No",summary:"`doc` is not a global variable"}]},{content:`<p>Let's verify that the memory allocation succeeded.</p>
<p>Please print the capacity of the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> to the serial port, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">capacity</span>());
</code></pre>
<p>What value does it show?</p>
`,options:[{id:"capacity-0",page:153,label:"<code>0</code>",summary:"`doc.capacity()` returns `0`"},{id:"capacity-ok",page:151,label:"The value passed to the constructor of <code>DynamicJsonDocument</code>",summary:"`doc.capacity()` returns the right value"}]},{content:`<p>Well, that's very bad news. It seems that your microcontroller doesn't have enough RAM to hold the JSON document.</p>
...
Hopefully, you'll make enough room for the memory pool.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Reducing memory usage fixes the issue"},{id:"failure",page:37,label:"No",summary:"Reducing memory usage doesn't fix the issue"}]},{content:`<p>It's possible that the <a href="/v6/api/dynamicjsondocument/"><code>DynamicJsonDocument</code></a> failed to allocate the memory pool.</p>
<p>Please print the capacity of the <a href="/v6/api/dynamicjsondocument/"><code>DynamicJsonDocument</code></a> to the serial port, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">capacity</span>());
</code></pre>
<p>What value does it show?</p>
`,options:[{id:"capacity-0",page:155,label:"<code>0</code>",summary:"`doc.capacity()` returns `0`"},{id:"capacity-ok",page:151,label:"The value passed to the constructor of <code>DynamicJsonDocument</code>",summary:"`doc.capacity()` returns the right value"}]},{content:`<p>What kind of <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> are you using?</p>
`,options:[{id:"basic",page:154,label:"<code>BasicJsonDocument&lt;T&gt;</code>",summary:"The document is a `BasicJsonDocument<T>`"},{id:"dynamicjsondocument",page:156,label:"<code>DynamicJsonDocument</code>",summary:"The `JsonDocument` is a `DynamicJsonDocument`"},{id:"staticjsondocument",page:151,label:"<code>StaticJsonDocument</code>",summary:"The `JsonDocument` is a `StaticJsonDocument`"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#notsupported"><code>NotSupported</code></a> means that the document was valid but contained features not supported by the library.</p>
...
`,options:[{id:"can-uprade",page:162,label:"Yes",summary:"Library can be upgraded"},{id:"cannot-upgrade",page:160,label:"No",summary:"Library cannot be upgraded"}]},{content:`<p>So, I guess that you're not using <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> but <a href="/v6/api/msgpack/deserializemsgpack/"><code>deserializeMsgPack()</code></a>, right?</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Upgrading solve the issue"},{id:"upgraded",page:37,label:"No",summary:"Upgrading doesn't solve the issue"}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> returns <a href="/v6/api/misc/deserializationerror/#notsupported"><code>NotSupported</code></a> when is read an UTF-16 escape sequence but support is disabled.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Defining `ARDUINOJSON_DECODE_UNICODE` solves the issue"},{id:"decode-unicode-set",page:159,label:"No",summary:"Defining `ARDUINOJSON_DECODE_UNICODE` doesn't solve the issue"}]},{content:`<p>If you're still seeing <code>NotSupported</code> after upgrading the library, it means that your code is not using the upgraded library.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Removing duplicates fixes the issue"},{id:"duplicates-removed",page:160,label:"No",summary:"Removing duplicates doesn't fix the issue"}]},{content:`<p>Please upgrade ArduinoJson to the latest version.<br>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Upgrading solves the issue"},{id:"updraded",page:161,label:"No",summary:"Upgrading doesn't solves the issue"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#toodeep"><code>TooDeep</code></a> means that the input document has too many levels of nesting.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Increasing the limit fixes the issue"},{id:"limit-increased",page:37,label:"No",summary:"Increasing the limit doesn't fix the issue"}]},{content:`<p class="display-4">🙋🏻‍♂️</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Using `JsonString` solves the issue"},{id:"failure",page:37,label:"No",summary:"Using `JsonString` doesn't solves the issue"}]},{content:`<p>Does your issue concern serialization or deserialization?</p>
`,options:[{id:"serialization",page:167,label:"Serialization",summary:"The issue concerns serialization"},{id:"deserialization",page:38,label:"Deserialization",summary:"The issue concerns deserialization"}]},{content:`<p>What's the problem?</p>
`,options:[{id:"crash",page:168,label:"The program crashes",summary:"Program crashes"},{id:"empty",page:178,label:"The output is empty (e.g. <code>{}</code>, <code>[]</code>, or <code>null</code>)",summary:"Output is empty"},{id:"incomplete",page:207,label:"The output is incomplete",summary:"Output is incomplete"},{id:"garbage",page:190,label:"The output contains garbage",summary:"Output contains garbage"},{id:"empty-strings",page:184,label:"The output contains empty strings",summary:"Output contains empty strings"},{id:"null",page:207,label:"The output contains <code>null</code>",summary:"Output contains null"},{id:"float",page:187,label:"Floating-point values contain too many decimal digits",summary:"Floating-point values contain too many decimal digits"},{id:"slow",page:215,label:"It's slow",summary:"Serialization is slow"}]},{content:`<p>Do you use <a href="/v6/api/dynamicjsondocument/"><code>DynamicJsonDocument</code></a> or <a href="/v6/api/staticjsondocument/"><code>StaticJsonDocument</code></a>?</p>
`,options:[{id:"dynamicjsondocument",page:176,label:"<code>DynamicJsonDocument</code>",summary:"Program uses `DynamicJsonDocument`"},{id:"staticjsondocument",page:177,label:"<code>StaticJsonDocument</code>",summary:"Program uses `StaticJsonDocument`"}]},{content:`<p>Please replace all those string pointers with literals.</p>
...
<p>Does your program still crash?</p>
`,options:[{id:"crash-with-literals",page:172,label:"Yes",summary:"Replacing string pointers with literals doesn't fix the crash"},{id:"no-crash-with-literals",page:170,label:"No",summary:"Replacing string pointers with literals fixes the crash"}]},{content:`<p>One of these string pointers is probably dangling or points to a non-zero-terminated string.</p>
...
`,options:[{id:"success",page:164,label:"Yes",summary:"Printing the string reveals the faulty pointer"},{id:"no-faulty-pointer",page:37,label:"No",summary:"Printing the string doesn't show any faulty pointer"}]},{content:`<p>Does your program insert string pointers in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>?<br>
(for example, <code>doc[&quot;name&quot;] = name</code> where <code>name</code> is a <code>const char*</code>)</p>
`,options:[{id:"charptr",page:169,label:"Yes",summary:"Program inserts string pointers into the `JsonDocument`"},{id:"no-charptr",page:172,label:"No",summary:"Program doesn't insert string pointers into the `JsonDocument`"}]},{content:`<p>What is the type of the second argument passed to <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a>?</p>
`,options:[{id:"char-array",page:173,label:"<code>char[]</code>",summary:"Output type is `char[]`"},{id:"char-ptr",page:174,label:"<code>char*</code>",summary:"Output type is `char*`"},{id:"arduino-string",page:37,label:"<code>String</code>",summary:"Output type is `String`"},{id:"arduino-stream",page:37,label:"<code>Stream</code>",summary:"Output type is `Stream`"}]},{content:`<p>I think this output buffer could cause a <a href="https://en.wikipedia.org/wiki/Stack_buffer_overflow">stack overflow</a>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Switching to `String` solves the issue"},{id:"failure",page:37,label:"No",summary:"Switching to `String` doesn't solve the issue"}]},{content:`<p>I think the output pointer is dangling.</p>
...
<p>Does your program still crash?</p>
`,options:[{id:"crash-with-char-array",page:37,label:"Yes",summary:"Replacing the output pointer with an array doesn't fix the crash"},{id:"no-crash-with-char-array",page:164,label:"No",summary:"Replacing the output pointer with an array fixes the crash"}]},{content:`<p>When you use <code>PROGMEM</code> with ArduinoJson (and any other Arduino code, really), you must make sure that the addresses in Flash memory aren't interpreted as addresses in RAM.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Casting the pointer solves the issue"},{id:"failure",page:37,label:"No",summary:"Casting the pointer doesn't solve the issue"}]},{content:`<p>Do you use <code>PROGMEM</code> (Flash memory) in your program?</p>
`,options:[{id:"progmem",page:175,label:"Yes",summary:"Program uses `PROGMEM`"},{id:"no-progmem",page:171,label:"No",summary:"Program doesn't use `PROGMEM`"}]},{content:`<p>Because a <a href="/v6/api/staticjsondocument/"><code>StaticJsonDocument</code></a> resides on the stack, it may cause a <a href="https://en.wikipedia.org/wiki/Stack_buffer_overflow">stack-overflow</a>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Switching to `DynamicJsonDocument` fixes the issue"},{id:"dynamicjsondocument-tried",page:176,label:"No",summary:"Switching to `DynamicJsonDocument` doesn't fix the issue"}]},{content:`<p>Please print the capacity of the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> to the serial port, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">capacity</span>());
</code></pre>
<p>What value does it show?</p>
`,options:[{id:"capacity-0",page:182,label:"<code>0</code>",summary:"`doc.capacity()` returns `0`"},{id:"capacity-ok",page:183,label:"a positive integer",summary:"`doc.capacity()` looks good"}]},{content:`<p><code>doc.capacity()</code> returns <code>0</code>, which means <code>allocate()</code> returned <code>NULL</code>.</p>
<p>I think that, because <code>doc</code> is declared global, <code>allocate()</code> is called too early and the heap isn't ready.
I know this happens on ESP32 with the <code>SpiRamJsonDocument</code> shown in <a href="/v6/how-to/use-external-ram-on-esp32/">How to use external RAM on ESP32?</a>.</p>
<p>Please try to make <code>doc</code> a local variable.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Making `doc` local fixes the issue."},{id:"failure",page:37,label:"No",summary:"Making `doc` local doesn't fix the issue."}]},{content:`<p>Is <code>doc</code> a global variable?</p>
`,options:[{id:"global",page:179,label:"Yes",summary:"`doc` is a global variable"},{id:"local",page:181,label:"No",summary:"`doc` is not a global variable"}]},{content:`<p>Well, that's very bad news. It seems that your microcontroller doesn't have enough RAM to hold the JSON document.</p>
<p>Please read <a href="/v6/how-to/reduce-memory-usage/">How to reduce memory usage</a>.
It shows several techniques you can use to use less RAM.
Hopefully, you'll make enough room for the memory pool.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Reducing memory usage fixes the issue"},{id:"failure",page:37,label:"No",summary:"Reducing memory usage doesn't fix the issue"}]},{content:`<p>What kind of <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> do you use?</p>
`,options:[{id:"basic",page:180,label:"<code>BasicJsonDocument&lt;T&gt;</code>",summary:"The document is a `BasicJsonDocument<T>`"},{id:"dynamic",page:181,label:"<code>DynamicJsonDocument</code>",summary:"The document is a `DynamicJsonDocument`"},{id:"static",page:37,label:"<code>StaticJsonDocument</code>",summary:"The document is a `StaticJsonDocument`"}]},{content:`<p>Please print the value of <a href="/v6/api/jsondocument/overflowed/"><code>JsonDocument::overflowed()</code></a>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:214,label:"<code>1</code> (or <code>true</code>)",summary:"`JsonDocument::overflowed()` returns `true`"},{id:"overflowed-0",page:37,label:"<code>0</code> (or <code>false</code>)",summary:"`JsonDocument::overflowed()` returns `false`"}]},{content:`<p>Do you call <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> before calling <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a>? (with the same <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>)</p>
`,options:[{id:"deserialize-yes",page:186,label:"Yes",summary:"Program calls `deserializeJson()`"},{id:"deserialize-no",page:37,label:"No",summary:"Program doesn't call `deserializeJson()`"}]},{content:`<p>When you pass a writeable buffer as the input of <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, ArduinoJson uses the <strong>zero-copy mode</strong>. Instead of copying the strings from the input into the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, it stores pointers to the input buffer.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Replacing `float` with `double` fixes the issue"},{id:"double",page:189,label:"No",summary:"Replacing `float` with `double` doesn't fix the issue"}]},{content:`<p>I'm surprised that the previous solution didn't work.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Defining `ARDUINOJSON_USE_DOUBLE` to `0` fixes the issue"},{id:"failure",page:37,label:"No",summary:"Defining `ARDUINOJSON_USE_DOUBLE` to `0` doesn't fix the issue"}]},{content:`<p>Please add the following function somewhere in your program:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Rounding the value fixes the issue"},{id:"double",page:188,label:"No",summary:"Rounding the value doesn't fix the issue"}]},{content:`<p>What function produces the garbage?</p>
`,options:[{id:"json",page:197,label:"<code>serializeJson()</code> (or <code>serializeJsonPretty()</code>)",summary:"`serializeJson()` produces garbage"},{id:"msg",page:202,label:"<code>serializeMsgPack()</code>",summary:"`serializeMsgPack()` produces garbage"}]},{content:`<p>When you pass a writeable buffer as the input of <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, ArduinoJson uses the <strong>zero-copy mode</strong>. Instead of copying the strings from the input into the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, it stores pointers to the input buffer.
Therefore, the input buffer must stay alive during the whole lifetime of the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>; otherwise, all the strings in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> will be dangling pointers.</p>
<p>The easiest solution is to disable the zero-copy mode by passing a read-only input buffer. Casting the pointer will do the trick:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// replace this:</span>
<span class="hljs-built_in">deserializeJson</span>(doc, input, inputSize);
...
<p>Now that the zero-copy mode is disabled, you probably need a larger <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, so don't forget to update the capacity. As usual, use the <a href="/v6/assistant/">ArduinoJson Assistant</a> to compute the right capacity for your project.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Casting the pointer fixes the issue"},{id:"casting-fails",page:206,label:"No",summary:"Casting the pointer doesn't fix the issue"}]},{content:`<p>What's the type of the second argument passed to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>?</p>
`,options:[{id:"char-ptr",page:191,label:"<code>char*</code> (or <code>char[]</code>)",summary:"Input type is `char*`"},{id:"const-char-ptr",page:206,label:"<code>const char*</code>",summary:"Input type is `const char*`"},{id:"string",page:206,label:"<code>String</code> (or <code>std::string</code>)",summary:"Input type is `String`"},{id:"stream",page:206,label:"<code>Stream</code> (or <code>std::istream)</code>",summary:"Input type is `Stream`"}]},{content:`<p>You can insert <a href="https://www.arduino.cc/reference/en/language/variables/data-types/stringobject/"><code>String</code></a> objects in a <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, but make sure you don't store the result of <a href="https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/c_str/"><code>String::c_str()</code></a>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Removing `.c_str()` fixes the issue"},{id:"failure",page:37,label:"No",summary:"Removing `.c_str()` doesn't fix the issue"}]},{content:`<p>Do you use <a href="https://www.arduino.cc/reference/en/language/variables/data-types/stringobject/"><code>String</code></a> in your program?</p>
`,options:[{id:"string",page:193,label:"Yes",summary:"Program uses `String`"},{id:"no-string",page:37,label:"No",summary:"Program doesn't use `String`"}]},{content:`<p><a href="/v6/api/staticjsondocument/"><code>StaticJsonDocument</code></a> stores its memory pool in the stack.
...
<p>Please switch to a <a href="/v6/api/dynamicjsondocument/"><code>DynamicJsonDocument</code></a>.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Switching to `DynamicJsonDocument` fixes the issue"},{id:"dynamic",page:194,label:"No",summary:"Switching to `DynamicJsonDocument` doesn't fix the issue"}]},{content:`<p>Which kind of <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> do you use?</p>
`,options:[{id:"dynamic",page:194,label:"<code>DynamicJsonDocument</code>",summary:"Program uses `DynamicJsonDocument`"},{id:"static",page:195,label:"<code>StaticJsonDocument</code>",summary:"Program uses `StaticJsonDocument`"}]},{content:`<p>Do you call <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> before calling <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a>? (with the same <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>)</p>
`,options:[{id:"deserialize-yes",page:192,label:"Yes",summary:"Program calls `deserializeJson()`"},{id:"deserialize-no",page:206,label:"No",summary:"Program doesn't call `deserializeJson()`"}]},{content:`<p><a href="/v6/api/jsonarray/"><code>JsonArray</code></a> doesn't contain any data: it is a reference to an object stored in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>. It becomes invalid as soon as the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> is destroyed; this could explain the garbage you see in the output.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:205,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><a href="/v6/api/jsonobject/"><code>JsonObject</code></a> doesn't contain any data: it is a reference to an object stored in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>. It becomes invalid as soon as the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> is destroyed; this could explain the garbage you see in the output.</p>
...
<p>This way, you can keep the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> alive when you call <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a></p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:205,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><a href="/v6/api/jsonvariant/"><code>JsonVariant</code></a> doesn't contain any data: it is a reference to an object stored in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>. It becomes invalid as soon as the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> is destroyed; this could explain the garbage you see in the output.</p>
...
`,options:[{id:"json",page:197,label:"Yes, <code>serializeJson()</code> produces garbage too",summary:"`serializeJson()` produces garbage too"},{id:"deserialize-no",page:201,label:"No, <code>serializeJson()</code> doesn't produces garbage",summary:"`serializeJson()` doesn't produces garbage"}]},{content:`<p><a href="/v6/api/jsondocument/garbagecollect/"><code>JsonDocument::garbageCollect()</code></a> invalidates all previously acquired <a href="/v6/api/jsonarray/"><code>JsonArray</code></a>, <a href="/v6/api/jsonobject/"><code>JsonObject</code></a>, and <a href="/v6/api/jsonvariant/"><code>JsonVariant</code></a>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Reassigning references fixes the issue"},{id:"reassigned",page:196,label:"No",summary:"Reassigning references doesn't fix the issue"}]},{content:`<p><a href="/v6/api/basicjsondocument/shrinktofit/"><code>JsonDocument::shrinkToFit()</code></a> invalidates all previously acquired <a href="/v6/api/jsonarray/"><code>JsonArray</code></a>, <a href="/v6/api/jsonobject/"><code>JsonObject</code></a>, and <a href="/v6/api/jsonvariant/"><code>JsonVariant</code></a>.</p>
<p>After you call it, make sure to reassign  every references, like so:</p>
<pre><code class="hljs language-c++">JsonObject cfg = doc.<span class="hljs-built_in">createNestedObject</span>(<span class="hljs-string">&quot;config&quot;</span>);
<span class="hljs-comment">// ...</span>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Reassigning references fixes the issue"},{id:"reassigned",page:196,label:"No",summary:"Reassigning references doesn't fix the issue"}]},{content:`<p>Do you use one of the following function?</p>
`,options:[{id:"garbagecollect",page:203,label:"<code>JsonDocument::garbageCollect()</code>",summary:"Program calls `JsonDocument::garbageCollect()`"},{id:"shrinktofit",page:204,label:"<code>JsonDocument::shrinkToFit()</code>",summary:"Program calls `JsonDocument::shrinkToFit()`"},{id:"none",page:196,label:"No",summary:"Program doesn't call an invalidating function"}]},{content:`<p>What is the type of the first argument passed to <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a>?</p>
`,options:[{id:"document",page:196,label:"<code>JsonDocument</code>",summary:"Program calls `serializeJson(const JsonDocument&, ...)`"},{id:"array",page:198,label:"<code>JsonArray</code> (or <code>JsonArrayConst</code>)",summary:"Program calls `serializeJson(JsonArrayConst, ...)`"},{id:"object",page:199,label:"<code>JsonObject</code> (or <code>JsonObjectConst</code>)",summary:"Program calls `serializeJson(JsonObjectConst, ...)`"},{id:"variant",page:200,label:"<code>JsonVariant</code> (or <code>JsonVariantConst</code>)",summary:"Program calls `serializeJson(JsonVariantConst, ...)`"}]},{content:`<p>Does your program call <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a> in a loop?</p>
`,options:[{id:"loop",page:211,label:"Yes",summary:"Program calls `serializeJson()` in a loop"},{id:"no-loop",page:212,label:"No",summary:"Program doesn't call `serializeJson()` in a loop"}]},{content:`<p>The ArduinoJson Assistant suggested a too small capacity because you didn't configure it properly.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Reconfiguring the ArduinoJson Assistant solves the issue"},{id:"still-wrong",page:37,label:"No",summary:"Reconfiguring the ArduinoJson Assistant doesn't solve the issue."}]},{content:`<p>Please replace the call to <a href="/v6/api/jsondocument/clear/"><code>JsonDocument::clear()</code></a> with <a href="/v6/api/jsondocument/garbagecollect/"><code>JsonDocument::garbageCollect()</code></a>.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Calling `JsonDocument::garbageCollect()` solves the issue"},{id:"gc",page:212,label:"No",summary:"Calling `JsonDocument::garbageCollect()` doesn't solve the issue"}]},{content:`<p>We can try to clear the content of the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>.</p>
<p>Please call <a href="/v6/api/jsondocument/clear/"><code>JsonDocument::clear()</code></a> at the beginning of the loop.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Calling `JsonDocument::clear()` solves the issue"},{id:"clear",page:212,label:"No",summary:"Calling `JsonDocument::clear()` doesn't solve the issue"},{id:"missing",page:209,label:"Yes, but now some values are missing",summary:"Calling `JsonDocument::clear()` solves the issue but removes other values"}]},{content:`<p>Calling <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a> is safe, but you'll run into issues if you modify the same <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> in a loop.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Moving the `JsonDocument` inside the loop solves the issue"},{id:"inside",page:212,label:"No",summary:"Moving the `JsonDocument` inside the loop doesn't solve the issue"},{id:"outside",page:210,label:"I cannot move the declaration inside the loop",summary:"The `JsonDocument` cannot be moved inside the loop"}]},{content:`<p>Please print the value of <a href="/v6/api/jsondocument/overflowed/"><code>JsonDocument::overflowed()</code></a>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:214,label:"<code>1</code> (or <code>true</code>)",summary:"`JsonDocument::overflowed()` returns `true`"},{id:"overflowed-0",page:213,label:"<code>0</code> (or <code>false</code>)",summary:"`JsonDocument::overflowed()` returns `false`"}]},{content:`<p>Does one of the strings in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> contains a NUL (i.e.,  ASCII code 0, or <code>\\u0000</code>)?</p>
`,options:[{id:"nul",page:165,label:"Yes",summary:"One or more strings contain a NUL"},{id:"no-nul",page:37,label:"No",summary:"No string contains a NUL"}]},{content:`<p><a href="/v6/api/jsondocument/overflowed/"><code>JsonDocument::overflowed()</code></a> returns <code>true</code> when you try to insert a value in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, but there isn't enough room to store it.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:164,label:"Yes",summary:"Increasing the capacity of the `JsonDocument` solves the issue."},{id:"assistant-is-wrong",page:208,label:"Yes, but the required capacity is greater than what the ArduinJson Assistant says.",summary:"The required capacity is greater than what the ArduinJson Assistant says."},{id:"capacity-increased",page:37,label:"No",summary:"Increasing the capacity of the `JsonDocument` doesn't solve the issue."}]},{content:`<p><a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a> writes the JSON document mostly one character at a time, which can be pretty slow with unbuffered streams (such as <a href="https://www.arduino.cc/en/Reference/EthernetClient"><code>EthernetClient</code></a>, <a href="https://www.arduino.cc/en/Reference/WiFiClient"><code>WifiClient</code></a>, <a href="https://www.arduino.cc/en/Reference/SD"><code>File</code></a>, and <a href="https://github.com/knolleary/pubsubclient/">PubSubClient</a>).</p>
