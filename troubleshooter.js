...
`,options:[{id:"filter",page:301,label:"Yes",summary:"Program uses `DeserializationOption::Filter`"},{id:"no-filter",page:306,label:"No",summary:"Program doesn't use `DeserializationOption::Filter`"}]},{content:`<p>When a program fails to extract the values from a <code>JsonDocument</code>, it's often because of confusion between arrays and objects.</p>
<p>For example, a common mistake is to write:</p>
<pre><code class="hljs language-c++"><span class="hljs-type">const</span> <span class="hljs-type">char</span>* temperature = doc[<span class="hljs-string">&quot;list&quot;</span>][<span class="hljs-string">&quot;main&quot;</span>][<span class="hljs-string">&quot;temp&quot;</span>];
</code></pre>
<p>instead of</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"The issue is confusion between array and object"},{id:"array-object",page:310,label:"No",summary:"The issue is not confusion between array and object"}]},{content:`<p>Please print the value of <code>JsonDocument::overflowed()</code>, like so:</p>
...
<p>So, the bug isn't in the Arduino code, but on the other size, most likely a server.</p>
<p>Can you modify the code of the server?</p>
`,options:[{id:"server-fixable",page:308,label:"Yes",summary:"User can modify the server"},{id:"server-unfixable",page:307,label:"No",summary:"User cannot modify the server"}]},{content:`<p>What type of value are you trying to read?</p>
`,options:[{id:"bool",page:1,label:"<code>bool</code>",summary:"The program fails to extract a `bool` value"},{id:"const-char-ptr",page:1,label:"<code>const char*</code>",summary:"The program fails to extract a `const char*` value"},{id:"double",page:1,label:"<code>double</code>",summary:"The program fails to extract a `double` value"},{id:"float",page:1,label:"<code>float</code>",summary:"The program fails to extract a `float` value"},{id:"int",page:1,label:"<code>int</code>",summary:"The program fails to extract an `int` value"},{id:"int8",page:315,label:"<code>int8_t</code>",summary:"The program fails to extract an `int8_t` value"},{id:"int16",page:313,label:"<code>int16_t</code>",summary:"The program fails to extract an `int16_t` value"},{id:"int32",page:314,label:"<code>int32_t</code>",summary:"The program fails to extract an `int32_t` value"},{id:"int64",page:1,label:"<code>int64_t</code>",summary:"The program fails to extract an `int64_t` value"},{id:"long",page:314,label:"<code>long</code>",summary:"The program fails to extract a `long` value"},{id:"long-long",page:1,label:"<code>long long</code>",summary:"The program fails to extract a `long long` value"},{id:"short",page:313,label:"<code>short</code>",summary:"The program fails to extract a `short` value"},{id:"signed-char",page:315,label:"<code>signed char</code>",summary:"The program fails to extract a `signed char` value"},{id:"signed-int",page:313,label:"<code>signed int</code>",summary:"The program fails to extract a `signed int` value"},{id:"signed-long",page:314,label:"<code>signed long</code>",summary:"The program fails to extract a `signed long` value"},{id:"signed-long-long",page:1,label:"<code>signed long long</code>",summary:"The program fails to extract a `signed long long` value"},{id:"signed-short",page:313,label:"<code>signed short</code>",summary:"The program fails to extract a `signed short` value"},{id:"std-string",page:1,label:"<code>std::string</code>",summary:"The program fails to extract a `std::string` value"},{id:"uint8",page:320,label:"<code>uint8_t</code>",summary:"The program fails to extract a `uint8_t` value"},{id:"uint16",page:318,label:"<code>uint16_t</code>",summary:"The program fails to extract a `uint16_t` value"},{id:"uint32",page:318,label:"<code>uint32_t</code>",summary:"The program fails to extract a `uint32_t` value"},{id:"uint64",page:1,label:"<code>uint64_t</code>",summary:"The program fails to extract a `uint64_t` value"},{id:"unsigned-char",page:320,label:"<code>unsigned char</code>",summary:"The program fails to extract an `unsigned char` value"},{id:"unsigned-int",page:319,label:"<code>unsigned int</code>",summary:"The program fails to extract an `unsigned int` value"},{id:"unsigned-long",page:319,label:"<code>unsigned long</code>",summary:"The program fails to extract an `unsigned long` value"},{id:"unsigned-long-long",page:1,label:"<code>unsigned long long</code>",summary:"The program fails to extract an `unsigned long long` value"},{id:"unsigned-short",page:318,label:"<code>unsigned short</code>",summary:"The program fails to extract an `unsigned short` value"},{id:"array",page:312,label:"<code>JsonArray</code>",summary:"The program fails to extract a `JsonArray`"},{id:"object",page:317,label:"<code>JsonObject</code>",summary:"The program fails to extract a `JsonObject`"},{id:"other",page:1,label:"None of the above",summary:"The type of the extracted value is not listed"}]},{content:`<p><code>to&lt;JsonArray&gt;()</code> replaces the existing value with a new empty array.</p>
...
`,options:[{id:"implicit",page:1,label:"<code>JsonObject object = doc[&quot;key&quot;];</code>",summary:"The program uses implicit conversion to `JsonObject`"},{id:"as",page:1,label:"<code>doc[&quot;key&quot;].as&lt;JsonObject&gt;()</code>",summary:"The program uses `as<JsonObject>()`"},{id:"to",page:316,label:"<code>doc[&quot;key&quot;].to&lt;JsonObject&gt;()</code>",summary:"The program uses `to<JsonObject>()`"}]},{content:`<p>This type can only store values between 0 and 65,535.<br>
If you try to extract a value outside this range, ArduinoJson will return 0.<br>
If that's your case, you must use a larger integer type.</p>
<p>Did this solve your issue?</p>
...
`,options:[{id:"jsonarray",page:322,label:"<code>JsonArray</code>",summary:"The first argument of `deserializeJson()` is a `JsonArray`"},{id:"jsondocument",page:325,label:"<code>JsonDocument</code>",summary:"The first argument of `deserializeJson()` is a `JsonDocument`"},{id:"jsonobject",page:323,label:"<code>JsonObject</code>",summary:"The first argument of `deserializeJson()` is a `JsonObject`"},{id:"jsonvariant",page:324,label:"<code>JsonVariant</code>",summary:"The first argument of `deserializeJson()` is a `JsonVariant`"}]},{content:`<p>You can pass a <code>JsonArray</code> as the first argument of <code>deserializeJson()</code>, but it has to point to an existing array.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Initializing the array fixes the issue"},{id:"server-ok",page:325,label:"No",summary:"Initializing the array doesn't fix the issue"}]},{content:`<p>You can pass a <code>JsonObject</code> as the first argument of <code>deserializeJson()</code>, but it has to point to an existing object.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Initializing the variant fixes the issue"},{id:"server-ok",page:325,label:"No",summary:"Initializing the variant doesn't fix the issue"}]},{content:`<p>Let's check with the <a href="/v7/assistant/">ArduinoJson Assistant</a> to see if you have enough memory for your JSON document.</p>
<ol>
...
`,options:[{id:"loose",page:326,label:"There is a lot more memory than required",summary:"The Assistant says there is a lot more memory than required."},{id:"tight",page:327,label:"There should be enough memory",summary:"The Assistant says there should be just enough memory."},{id:"too-small",page:332,label:"There is not enough memory",summary:"The Assistant says there is not enough memory."}]},{content:`<p>What CPU architecture is this code running on?</p>
`,options:[{id:"8-bit",page:328,label:"8-bit",summary:"The code is running on an 8-bit CPU"},{id:"32-bit",page:329,label:"32-bit",summary:"The code is running on a 32-bit CPU"},{id:"64-bit",page:331,label:"64-bit",summary:"The code is running on a 64-bit CPU"}]},{content:`<p>This means that ArduinoJson couldn't allocate enough memory for the JSON document.<br>
So you must free some memory.</p>
<p>See <a href="/v7/how-to/reduce-memory-usage/">How to reduce memory usage?</a> for some tips.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Freeing some memory solves the issue."},{id:"failure",page:332,label:"No",summary:"Freeing some memory doesn't solve the issue."}]},{content:`<p>Due to an optimization, a <code>JsonDocument</code> can only contain up to 255 nodes on an 8-bit CPU.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Setting `ARDUINOJSON_SLOT_ID_SIZE` to 2 solves the issue."},{id:"slot-id-size-2",page:330,label:"No",summary:"Setting `ARDUINOJSON_SLOT_ID_SIZE` to 2 doesn't solve the issue."},{id:"fewer-than-255",page:330,label:"My JSON document contains fewer than 255 nodes",summary:"The JSON document contains fewer than 255 nodes."}]},{content:`<p>Due to an optimization, a <code>JsonDocument</code> can only contain up to 65,535 nodes on a 32-bit CPU.
A node is a value, a key, or a member of an array.</p>
<p>You can push this limit by increasing <code>ARDUINOJSON_SLOT_ID_SIZE</code>, like so:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Setting `ARDUINOJSON_SLOT_ID_SIZE` to 4 solves the issue."},{id:"slot-id-size-2",page:331,label:"No",summary:"Setting `ARDUINOJSON_SLOT_ID_SIZE` to 4 doesn't solve the issue."},{id:"fewer-than-255",page:331,label:"My JSON document contains fewer than 65,535 nodes",summary:"The JSON document contains fewer than 65,535 nodes."}]},{content:`<p>Due to another optimization, strings in a <code>JsonDocument</code> can only contain up to 255 characters on an 8-bit CPU.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Setting `ARDUINOJSON_STRING_LENGTH_SIZE` to 2 solves the issue"},{id:"string-length-size-2",page:327,label:"No",summary:"Setting `ARDUINOJSON_STRING_LENGTH_SIZE` to 2 doesn't solve the issue"},{id:"fewer-than-255",page:327,label:"No string contains more than 255 characters",summary:"No string contains more than 255 characters"}]},{content:`<p>Due to another optimization, strings in a <code>JsonDocument</code> can only contain up to 65,535 characters.</p>
<p>You can push this limit by increasing <code>ARDUINOJSON_STRING_LENGTH_SIZE</code>, like so:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Setting `ARDUINOJSON_STRING_LENGTH_SIZE` to 4 solves the issue"},{id:"string-length-size-4",page:327,label:"No",summary:"Setting `ARDUINOJSON_STRING_LENGTH_SIZE` to 4 doesn't solve the issue"},{id:"fewer-than-255",page:327,label:"No string contains more than 65,535 characters",summary:"No string contains more than 65,535 characters"}]},{content:`<p class="display-4">☹️</p>
...
`,options:[{id:"crash",page:225,label:"The program crashes",summary:"Program crashes"},{id:"empty",page:334,label:"The output is empty (e.g. <code>{}</code>, <code>[]</code>, or <code>null</code>)",summary:"Output is empty"},{id:"incomplete",page:343,label:"The output is incomplete",summary:"Output is incomplete"},{id:"garbage",page:335,label:"The output contains garbage",summary:"Output contains garbage"},{id:"null",page:343,label:"The output contains <code>null</code>",summary:"Output contains null"},{id:"float",page:236,label:"Floating-point values contain too many decimal digits",summary:"Floating-point values contain too many decimal digits"},{id:"slow",page:268,label:"It's slow",summary:"Serialization is slow"}]},{content:`<p>Please print the value of <code>JsonDocument::overflowed()</code>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:325,label:"<code>1</code> (or <code>true</code>)",summary:"`JsonDocument::overflowed()` returns `true`"},{id:"overflowed-0",page:1,label:"<code>0</code> (or <code>false</code>)",summary:"`JsonDocument::overflowed()` returns `false`"}]},{content:`<p>Which function produces the garbage?</p>
`,options:[{id:"json",page:337,label:"<code>serializeJson()</code> (or <code>serializeJsonPretty()</code>)",summary:"`serializeJson()` produces garbage"},{id:"msg",page:342,label:"<code>serializeMsgPack()</code>",summary:"`serializeMsgPack()` produces garbage"}]},{content:`<p>Do you use <a href="https://www.arduino.cc/reference/en/language/variables/data-types/stringobject/"><code>String</code></a> in your program?</p>
...
`,options:[{id:"document",page:336,label:"<code>JsonDocument</code>",summary:"Program calls `serializeJson(const JsonDocument&, ...)`"},{id:"array",page:338,label:"<code>JsonArray</code> (or <code>JsonArrayConst</code>)",summary:"Program calls `serializeJson(JsonArrayConst, ...)`"},{id:"object",page:339,label:"<code>JsonObject</code> (or <code>JsonObjectConst</code>)",summary:"Program calls `serializeJson(JsonObjectConst, ...)`"},{id:"variant",page:340,label:"<code>JsonVariant</code> (or <code>JsonVariantConst</code>)",summary:"Program calls `serializeJson(JsonVariantConst, ...)`"}]},{content:`<p><code>JsonArray</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonArray</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonArray <span class="hljs-title">createArray</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:336,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>JsonObject</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonObject</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonObject <span class="hljs-title">createObject</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:336,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>JsonVariant</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonVariant</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonVariant <span class="hljs-title">createVariant</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:336,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>serializeMsgPack()</code> share a lot of code with <code>serializeJson()</code>. There is no reason you should produce garbage with one and not the other. You may have found a bug.</p>
`,tags:["needs_assistance"]},{content:`<p><a href="https://msgpack.org/">MessagePack</a> is a binary format, so if you print a document to the serial port, the result would look weird.</p>
<p>For example, the following program:</p>
<pre><code class="hljs language-c++">JsonDocument doc;
doc[<span class="hljs-string">&quot;val&quot;</span>] = <span class="hljs-number">42</span>;
...
<p>I need you to edit your program to replace <code>serializeMsgPack()</code> with <code>serializeJson()</code>.</p>
<p>Do you see the garbage in the JSON output?</p>
`,options:[{id:"json",page:337,label:"Yes, <code>serializeJson()</code> produces garbage too",summary:"`serializeJson()` produces garbage too"},{id:"deserialize-no",page:341,label:"No, <code>serializeJson()</code> doesn't produces garbage",summary:"`serializeJson()` doesn't produces garbage"}]},{content:`<p>Please print the value of <code>JsonDocument::overflowed()</code>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:325,label:"<code>1</code> (or <code>true</code>)",summary:"`JsonDocument::overflowed()` returns `true`"},{id:"overflowed-0",page:344,label:"<code>0</code> (or <code>false</code>)",summary:"`JsonDocument::overflowed()` returns `false`"}]},{content:`<p>Does one of the strings in the <code>JsonDocument</code> contains a NUL (i.e.,  ASCII code 0, or <code>\\u0000</code>)?</p>
