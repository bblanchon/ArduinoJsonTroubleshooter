...
`,options:[{id:"bool",page:1,label:"<code>bool</code>",summary:"The program fails to extract a `bool` value"},{id:"const-char-ptr",page:1,label:"<code>const char*</code>",summary:"The program fails to extract a `const char*` value"},{id:"double",page:1,label:"<code>double</code>",summary:"The program fails to extract a `double` value"},{id:"float",page:1,label:"<code>float</code>",summary:"The program fails to extract a `float` value"},{id:"int",page:1,label:"<code>int</code>",summary:"The program fails to extract an `int` value"},{id:"int8",page:313,label:"<code>int8_t</code>",summary:"The program fails to extract an `int8_t` value"},{id:"int16",page:311,label:"<code>int16_t</code>",summary:"The program fails to extract an `int16_t` value"},{id:"int32",page:312,label:"<code>int32_t</code>",summary:"The program fails to extract an `int32_t` value"},{id:"int64",page:1,label:"<code>int64_t</code>",summary:"The program fails to extract an `int64_t` value"},{id:"long",page:312,label:"<code>long</code>",summary:"The program fails to extract a `long` value"},{id:"long-long",page:1,label:"<code>long long</code>",summary:"The program fails to extract a `long long` value"},{id:"short",page:311,label:"<code>short</code>",summary:"The program fails to extract a `short` value"},{id:"signed-char",page:313,label:"<code>signed char</code>",summary:"The program fails to extract a `signed char` value"},{id:"signed-int",page:311,label:"<code>signed int</code>",summary:"The program fails to extract a `signed int` value"},{id:"signed-long",page:312,label:"<code>signed long</code>",summary:"The program fails to extract a `signed long` value"},{id:"signed-long-long",page:1,label:"<code>signed long long</code>",summary:"The program fails to extract a `signed long long` value"},{id:"signed-short",page:311,label:"<code>signed short</code>",summary:"The program fails to extract a `signed short` value"},{id:"std-string",page:1,label:"<code>std::string</code>",summary:"The program fails to extract a `std::string` value"},{id:"uint8",page:316,label:"<code>uint8_t</code>",summary:"The program fails to extract a `uint8_t` value"},{id:"uint16",page:314,label:"<code>uint16_t</code>",summary:"The program fails to extract a `uint16_t` value"},{id:"uint32",page:314,label:"<code>uint32_t</code>",summary:"The program fails to extract a `uint32_t` value"},{id:"uint64",page:1,label:"<code>uint64_t</code>",summary:"The program fails to extract a `uint64_t` value"},{id:"unsigned-char",page:316,label:"<code>unsigned char</code>",summary:"The program fails to extract an `unsigned char` value"},{id:"unsigned-int",page:315,label:"<code>unsigned int</code>",summary:"The program fails to extract an `unsigned int` value"},{id:"unsigned-long",page:315,label:"<code>unsigned long</code>",summary:"The program fails to extract an `unsigned long` value"},{id:"unsigned-long-long",page:1,label:"<code>unsigned long long</code>",summary:"The program fails to extract an `unsigned long long` value"},{id:"unsigned-short",page:314,label:"<code>unsigned short</code>",summary:"The program fails to extract an `unsigned short` value"}]},{content:`<p>This type can only store values between -32,768 and 32,767.<br>
...
If that's your case, you must use a larger integer type.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Switching to a larger integer type solves the issue"},{id:"failure",page:1,label:"No",summary:"Switching to a larger integer type doesn't solve the issue"}]},{content:`<p>This type can only store values between 0 and 65,535.<br>
If you try to extract a value outside this range, ArduinoJson will return 0.<br>
If that's your case, you must use a larger integer type.</p>
<p>Did this solve your issue?</p>
...
`,options:[{id:"jsonarray",page:318,label:"<code>JsonArray</code>",summary:"The first argument of `deserializeJson()` is a `JsonArray`"},{id:"jsondocument",page:321,label:"<code>JsonDocument</code>",summary:"The first argument of `deserializeJson()` is a `JsonDocument`"},{id:"jsonobject",page:319,label:"<code>JsonObject</code>",summary:"The first argument of `deserializeJson()` is a `JsonObject`"},{id:"jsonvariant",page:320,label:"<code>JsonVariant</code>",summary:"The first argument of `deserializeJson()` is a `JsonVariant`"}]},{content:`<p>You can pass a <code>JsonArray</code> as the first argument of <code>deserializeJson()</code>, but it has to point to an existing array.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Initializing the array fixes the issue"},{id:"server-ok",page:321,label:"No",summary:"Initializing the array doesn't fix the issue"}]},{content:`<p>You can pass a <code>JsonObject</code> as the first argument of <code>deserializeJson()</code>, but it has to point to an existing object.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Initializing the variant fixes the issue"},{id:"server-ok",page:321,label:"No",summary:"Initializing the variant doesn't fix the issue"}]},{content:`<p>Let's check with the <a href="/v7/assistant/">ArduinoJson Assistant</a> to see if you have enough memory for your JSON document.</p>
<ol>
...
`,options:[{id:"loose",page:322,label:"There is a lot more memory than required",summary:"The Assistant says there is a lot more memory than required."},{id:"tight",page:325,label:"There should be enough memory",summary:"The Assistant says there should be just enough memory."},{id:"too-small",page:326,label:"There is not enough memory",summary:"The Assistant says there is not enough memory."}]},{content:`<p>What CPU architecture is this code running on?</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Setting `ARDUINOJSON_SLOT_ID_SIZE` to 2 solves the issue."},{id:"slot-id-size-2",page:325,label:"No",summary:"Setting `ARDUINOJSON_SLOT_ID_SIZE` to 2 doesn't solve the issue."},{id:"fewer-than-255",page:325,label:"My JSON document contains fewer than 255 nodes",summary:"The JSON document contains fewer than 255 nodes."}]},{content:`<p>This means that ArduinoJson couldn't allocate enough memory for the JSON document.<br>
So you must free some memory.</p>
<p>See <a href="/v7/how-to/reduce-memory-usage/">How to reduce memory usage?</a> for some tips.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Freeing some memory solves the issue."},{id:"failure",page:326,label:"No",summary:"Freeing some memory doesn't solve the issue."}]},{content:`<p class="display-4">☹️</p>
...
`,options:[{id:"crash",page:225,label:"The program crashes",summary:"Program crashes"},{id:"empty",page:328,label:"The output is empty (e.g. <code>{}</code>, <code>[]</code>, or <code>null</code>)",summary:"Output is empty"},{id:"incomplete",page:337,label:"The output is incomplete",summary:"Output is incomplete"},{id:"garbage",page:329,label:"The output contains garbage",summary:"Output contains garbage"},{id:"null",page:337,label:"The output contains <code>null</code>",summary:"Output contains null"},{id:"float",page:236,label:"Floating-point values contain too many decimal digits",summary:"Floating-point values contain too many decimal digits"},{id:"slow",page:268,label:"It's slow",summary:"Serialization is slow"}]},{content:`<p>Please print the value of <code>JsonDocument::overflowed()</code>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
...
`,options:[{id:"json",page:331,label:"<code>serializeJson()</code> (or <code>serializeJsonPretty()</code>)",summary:"`serializeJson()` produces garbage"},{id:"msg",page:336,label:"<code>serializeMsgPack()</code>",summary:"`serializeMsgPack()` produces garbage"}]},{content:`<p>Do you use <a href="https://www.arduino.cc/reference/en/language/variables/data-types/stringobject/"><code>String</code></a> in your program?</p>
...
`,options:[{id:"document",page:330,label:"<code>JsonDocument</code>",summary:"Program calls `serializeJson(const JsonDocument&, ...)`"},{id:"array",page:332,label:"<code>JsonArray</code> (or <code>JsonArrayConst</code>)",summary:"Program calls `serializeJson(JsonArrayConst, ...)`"},{id:"object",page:333,label:"<code>JsonObject</code> (or <code>JsonObjectConst</code>)",summary:"Program calls `serializeJson(JsonObjectConst, ...)`"},{id:"variant",page:334,label:"<code>JsonVariant</code> (or <code>JsonVariantConst</code>)",summary:"Program calls `serializeJson(JsonVariantConst, ...)`"}]},{content:`<p><code>JsonArray</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonArray</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonArray <span class="hljs-title">createArray</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:330,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>JsonObject</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonObject</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonObject <span class="hljs-title">createObject</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:330,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>JsonVariant</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonVariant</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonVariant <span class="hljs-title">createVariant</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:330,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>serializeMsgPack()</code> share a lot of code with <code>serializeJson()</code>. There is no reason you should produce garbage with one and not the other. You may have found a bug.</p>
`,tags:["needs_assistance"]},{content:`<p><a href="https://msgpack.org/">MessagePack</a> is a binary format, so if you print a document to the serial port, the result would look weird.</p>
<p>For example, the following program:</p>
<pre><code class="hljs language-c++">JsonDocument doc;
doc[<span class="hljs-string">&quot;val&quot;</span>] = <span class="hljs-number">42</span>;
...
<p>I need you to edit your program to replace <code>serializeMsgPack()</code> with <code>serializeJson()</code>.</p>
<p>Do you see the garbage in the JSON output?</p>
`,options:[{id:"json",page:331,label:"Yes, <code>serializeJson()</code> produces garbage too",summary:"`serializeJson()` produces garbage too"},{id:"deserialize-no",page:335,label:"No, <code>serializeJson()</code> doesn't produces garbage",summary:"`serializeJson()` doesn't produces garbage"}]},{content:`<p>Please print the value of <code>JsonDocument::overflowed()</code>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:321,label:"<code>1</code> (or <code>true</code>)",summary:"`JsonDocument::overflowed()` returns `true`"},{id:"overflowed-0",page:338,label:"<code>0</code> (or <code>false</code>)",summary:"`JsonDocument::overflowed()` returns `false`"}]},{content:`<p>Does one of the strings in the <code>JsonDocument</code> contains a NUL (i.e.,  ASCII code 0, or <code>\\u0000</code>)?</p>
