(function(){"use strict";function ln(e,s){const n=Object.create(null),t=e.split(",");for(let a=0;a<t.length;a++)n[t[a]]=!0;return s?a=>!!n[a.toLowerCase()]:a=>!!n[a]}const U={},ts=[],je=()=>{},$a=()=>!1,Ka=/^on[^a-z]/,As=e=>Ka.test(e),cn=e=>e.startsWith("onUpdate:"),Z=Object.assign,pn=(e,s)=>{const n=e.indexOf(s);n>-1&&e.splice(n,1)},Ga=Object.prototype.hasOwnProperty,C=(e,s)=>Ga.call(e,s),A=Array.isArray,as=e=>Ds(e)==="[object Map]",rt=e=>Ds(e)==="[object Set]",O=e=>typeof e=="function",Q=e=>typeof e=="string",un=e=>typeof e=="symbol",B=e=>e!==null&&typeof e=="object",lt=e=>B(e)&&O(e.then)&&O(e.catch),ct=Object.prototype.toString,Ds=e=>ct.call(e),Xa=e=>Ds(e).slice(8,-1),pt=e=>Ds(e)==="[object Object]",dn=e=>Q(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,Ns=ln(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Is=e=>{const s=Object.create(null);return n=>s[n]||(s[n]=e(n))},Za=/-(\w)/g,Se=Is(e=>e.replace(Za,(s,n)=>n?n.toUpperCase():"")),Qa=/\B([A-Z])/g,os=Is(e=>e.replace(Qa,"-$1").toLowerCase()),Os=Is(e=>e.charAt(0).toUpperCase()+e.slice(1)),hn=Is(e=>e?`on${Os(e)}`:""),qs=(e,s)=>!Object.is(e,s),mn=(e,s)=>{for(let n=0;n<e.length;n++)e[n](s)},zs=(e,s,n)=>{Object.defineProperty(e,s,{configurable:!0,enumerable:!1,value:n})},eo=e=>{const s=parseFloat(e);return isNaN(s)?e:s},so=e=>{const s=Q(e)?Number(e):NaN;return isNaN(s)?e:s};let ut;const fn=()=>ut||(ut=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function gn(e){if(A(e)){const s={};for(let n=0;n<e.length;n++){const t=e[n],a=Q(t)?oo(t):gn(t);if(a)for(const o in a)s[o]=a[o]}return s}else{if(Q(e))return e;if(B(e))return e}}const no=/;(?![^(]*\))/g,to=/:([^]+)/,ao=/\/\*[^]*?\*\//g;function oo(e){const s={};return e.replace(ao,"").split(no).forEach(n=>{if(n){const t=n.split(to);t.length>1&&(s[t[0].trim()]=t[1].trim())}}),s}function fs(e){let s="";if(Q(e))s=e;else if(A(e))for(let n=0;n<e.length;n++){const t=fs(e[n]);t&&(s+=t+" ")}else if(B(e))for(const n in e)e[n]&&(s+=n+" ");return s.trim()}const io=ln("itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly");function dt(e){return!!e||e===""}const Cs=e=>Q(e)?e:e==null?"":A(e)||B(e)&&(e.toString===ct||!O(e.toString))?JSON.stringify(e,ht,2):String(e),ht=(e,s)=>s&&s.__v_isRef?ht(e,s.value):as(s)?{[`Map(${s.size})`]:[...s.entries()].reduce((n,[t,a])=>(n[`${t} =>`]=a,n),{})}:rt(s)?{[`Set(${s.size})`]:[...s.values()]}:B(s)&&!A(s)&&!pt(s)?String(s):s;let ve;class ro{constructor(s=!1){this.detached=s,this._active=!0,this.effects=[],this.cleanups=[],this.parent=ve,!s&&ve&&(this.index=(ve.scopes||(ve.scopes=[])).push(this)-1)}get active(){return this._active}run(s){if(this._active){const n=ve;try{return ve=this,s()}finally{ve=n}}}on(){ve=this}off(){ve=this.parent}stop(s){if(this._active){let n,t;for(n=0,t=this.effects.length;n<t;n++)this.effects[n].stop();for(n=0,t=this.cleanups.length;n<t;n++)this.cleanups[n]();if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!s){const a=this.parent.scopes.pop();a&&a!==this&&(this.parent.scopes[this.index]=a,a.index=this.index)}this.parent=void 0,this._active=!1}}}function lo(e,s=ve){s&&s.active&&s.effects.push(e)}function co(){return ve}const yn=e=>{const s=new Set(e);return s.w=0,s.n=0,s},mt=e=>(e.w&Re)>0,ft=e=>(e.n&Re)>0,po=({deps:e})=>{if(e.length)for(let s=0;s<e.length;s++)e[s].w|=Re},uo=e=>{const{deps:s}=e;if(s.length){let n=0;for(let t=0;t<s.length;t++){const a=s[t];mt(a)&&!ft(a)?a.delete(e):s[n++]=a,a.w&=~Re,a.n&=~Re}s.length=n}},bn=new WeakMap;let gs=0,Re=1;const jn=30;let we;const We=Symbol(""),vn=Symbol("");class wn{constructor(s,n=null,t){this.fn=s,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,lo(this,t)}run(){if(!this.active)return this.fn();let s=we,n=Fe;for(;s;){if(s===this)return;s=s.parent}try{return this.parent=we,we=this,Fe=!0,Re=1<<++gs,gs<=jn?po(this):gt(this),this.fn()}finally{gs<=jn&&uo(this),Re=1<<--gs,we=this.parent,Fe=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){we===this?this.deferStop=!0:this.active&&(gt(this),this.onStop&&this.onStop(),this.active=!1)}}function gt(e){const{deps:s}=e;if(s.length){for(let n=0;n<s.length;n++)s[n].delete(e);s.length=0}}let Fe=!0;const yt=[];function is(){yt.push(Fe),Fe=!1}function rs(){const e=yt.pop();Fe=e===void 0?!0:e}function pe(e,s,n){if(Fe&&we){let t=bn.get(e);t||bn.set(e,t=new Map);let a=t.get(n);a||t.set(n,a=yn()),bt(a)}}function bt(e,s){let n=!1;gs<=jn?ft(e)||(e.n|=Re,n=!mt(e)):n=!e.has(we),n&&(e.add(we),we.deps.push(e))}function ze(e,s,n,t,a,o){const i=bn.get(e);if(!i)return;let l=[];if(s==="clear")l=[...i.values()];else if(n==="length"&&A(e)){const c=Number(t);i.forEach((u,h)=>{(h==="length"||h>=c)&&l.push(u)})}else switch(n!==void 0&&l.push(i.get(n)),s){case"add":A(e)?dn(n)&&l.push(i.get("length")):(l.push(i.get(We)),as(e)&&l.push(i.get(vn)));break;case"delete":A(e)||(l.push(i.get(We)),as(e)&&l.push(i.get(vn)));break;case"set":as(e)&&l.push(i.get(We));break}if(l.length===1)l[0]&&Jn(l[0]);else{const c=[];for(const u of l)u&&c.push(...u);Jn(yn(c))}}function Jn(e,s){const n=A(e)?e:[...e];for(const t of n)t.computed&&jt(t);for(const t of n)t.computed||jt(t)}function jt(e,s){(e!==we||e.allowRecurse)&&(e.scheduler?e.scheduler():e.run())}const ho=ln("__proto__,__v_isRef,__isVue"),vt=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(un)),mo=_n(),fo=_n(!1,!0),go=_n(!0),wt=yo();function yo(){const e={};return["includes","indexOf","lastIndexOf"].forEach(s=>{e[s]=function(...n){const t=E(this);for(let o=0,i=this.length;o<i;o++)pe(t,"get",o+"");const a=t[s](...n);return a===-1||a===!1?t[s](...n.map(E)):a}}),["push","pop","shift","unshift","splice"].forEach(s=>{e[s]=function(...n){is();const t=E(this)[s].apply(this,n);return rs(),t}}),e}function bo(e){const s=E(this);return pe(s,"has",e),s.hasOwnProperty(e)}function _n(e=!1,s=!1){return function(t,a,o){if(a==="__v_isReactive")return!e;if(a==="__v_isReadonly")return e;if(a==="__v_isShallow")return s;if(a==="__v_raw"&&o===(e?s?zo:Nt:s?Dt:At).get(t))return t;const i=A(t);if(!e){if(i&&C(wt,a))return Reflect.get(wt,a,o);if(a==="hasOwnProperty")return bo}const l=Reflect.get(t,a,o);return(un(a)?vt.has(a):ho(a))||(e||pe(t,"get",a),s)?l:re(l)?i&&dn(a)?l:l.value:B(l)?e?It(l):kn(l):l}}const jo=Jt(),vo=Jt(!0);function Jt(e=!1){return function(n,t,a,o){let i=n[t];if(ys(i)&&re(i)&&!re(a))return!1;if(!e&&(!An(a)&&!ys(a)&&(i=E(i),a=E(a)),!A(n)&&re(i)&&!re(a)))return i.value=a,!0;const l=A(n)&&dn(t)?Number(t)<n.length:C(n,t),c=Reflect.set(n,t,a,o);return n===E(o)&&(l?qs(a,i)&&ze(n,"set",t,a):ze(n,"add",t,a)),c}}function wo(e,s){const n=C(e,s);e[s];const t=Reflect.deleteProperty(e,s);return t&&n&&ze(e,"delete",s,void 0),t}function Jo(e,s){const n=Reflect.has(e,s);return(!un(s)||!vt.has(s))&&pe(e,"has",s),n}function _o(e){return pe(e,"iterate",A(e)?"length":We),Reflect.ownKeys(e)}const _t={get:mo,set:jo,deleteProperty:wo,has:Jo,ownKeys:_o},To={get:go,set(e,s){return!0},deleteProperty(e,s){return!0}},So=Z({},_t,{get:fo,set:vo}),Tn=e=>e,Ps=e=>Reflect.getPrototypeOf(e);function Es(e,s,n=!1,t=!1){e=e.__v_raw;const a=E(e),o=E(s);n||(s!==o&&pe(a,"get",s),pe(a,"get",o));const{has:i}=Ps(a),l=t?Tn:n?Nn:Dn;if(i.call(a,s))return l(e.get(s));if(i.call(a,o))return l(e.get(o));e!==a&&e.get(s)}function Rs(e,s=!1){const n=this.__v_raw,t=E(n),a=E(e);return s||(e!==a&&pe(t,"has",e),pe(t,"has",a)),e===a?n.has(e):n.has(e)||n.has(a)}function Fs(e,s=!1){return e=e.__v_raw,!s&&pe(E(e),"iterate",We),Reflect.get(e,"size",e)}function Tt(e){e=E(e);const s=E(this);return Ps(s).has.call(s,e)||(s.add(e),ze(s,"add",e,e)),this}function St(e,s){s=E(s);const n=E(this),{has:t,get:a}=Ps(n);let o=t.call(n,e);o||(e=E(e),o=t.call(n,e));const i=a.call(n,e);return n.set(e,s),o?qs(s,i)&&ze(n,"set",e,s):ze(n,"add",e,s),this}function kt(e){const s=E(this),{has:n,get:t}=Ps(s);let a=n.call(s,e);a||(e=E(e),a=n.call(s,e)),t&&t.call(s,e);const o=s.delete(e);return a&&ze(s,"delete",e,void 0),o}function xt(){const e=E(this),s=e.size!==0,n=e.clear();return s&&ze(e,"clear",void 0,void 0),n}function Hs(e,s){return function(t,a){const o=this,i=o.__v_raw,l=E(i),c=s?Tn:e?Nn:Dn;return!e&&pe(l,"iterate",We),i.forEach((u,h)=>t.call(a,c(u),c(h),o))}}function Bs(e,s,n){return function(...t){const a=this.__v_raw,o=E(a),i=as(o),l=e==="entries"||e===Symbol.iterator&&i,c=e==="keys"&&i,u=a[e](...t),h=n?Tn:s?Nn:Dn;return!s&&pe(o,"iterate",c?vn:We),{next(){const{value:y,done:v}=u.next();return v?{value:y,done:v}:{value:l?[h(y[0]),h(y[1])]:h(y),done:v}},[Symbol.iterator](){return this}}}}function He(e){return function(...s){return e==="delete"?!1:this}}function ko(){const e={get(o){return Es(this,o)},get size(){return Fs(this)},has:Rs,add:Tt,set:St,delete:kt,clear:xt,forEach:Hs(!1,!1)},s={get(o){return Es(this,o,!1,!0)},get size(){return Fs(this)},has:Rs,add:Tt,set:St,delete:kt,clear:xt,forEach:Hs(!1,!0)},n={get(o){return Es(this,o,!0)},get size(){return Fs(this,!0)},has(o){return Rs.call(this,o,!0)},add:He("add"),set:He("set"),delete:He("delete"),clear:He("clear"),forEach:Hs(!0,!1)},t={get(o){return Es(this,o,!0,!0)},get size(){return Fs(this,!0)},has(o){return Rs.call(this,o,!0)},add:He("add"),set:He("set"),delete:He("delete"),clear:He("clear"),forEach:Hs(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(o=>{e[o]=Bs(o,!1,!1),n[o]=Bs(o,!0,!1),s[o]=Bs(o,!1,!0),t[o]=Bs(o,!0,!0)}),[e,n,s,t]}const[xo,Ao,Do,No]=ko();function Sn(e,s){const n=s?e?No:Do:e?Ao:xo;return(t,a,o)=>a==="__v_isReactive"?!e:a==="__v_isReadonly"?e:a==="__v_raw"?t:Reflect.get(C(n,a)&&a in t?n:t,a,o)}const Io={get:Sn(!1,!1)},Oo={get:Sn(!1,!0)},qo={get:Sn(!0,!1)},At=new WeakMap,Dt=new WeakMap,Nt=new WeakMap,zo=new WeakMap;function Co(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Po(e){return e.__v_skip||!Object.isExtensible(e)?0:Co(Xa(e))}function kn(e){return ys(e)?e:xn(e,!1,_t,Io,At)}function Eo(e){return xn(e,!1,So,Oo,Dt)}function It(e){return xn(e,!0,To,qo,Nt)}function xn(e,s,n,t,a){if(!B(e)||e.__v_raw&&!(s&&e.__v_isReactive))return e;const o=a.get(e);if(o)return o;const i=Po(e);if(i===0)return e;const l=new Proxy(e,i===2?t:n);return a.set(e,l),l}function ls(e){return ys(e)?ls(e.__v_raw):!!(e&&e.__v_isReactive)}function ys(e){return!!(e&&e.__v_isReadonly)}function An(e){return!!(e&&e.__v_isShallow)}function Ot(e){return ls(e)||ys(e)}function E(e){const s=e&&e.__v_raw;return s?E(s):e}function qt(e){return zs(e,"__v_skip",!0),e}const Dn=e=>B(e)?kn(e):e,Nn=e=>B(e)?It(e):e;function Ro(e){Fe&&we&&(e=E(e),bt(e.dep||(e.dep=yn())))}function Fo(e,s){e=E(e);const n=e.dep;n&&Jn(n)}function re(e){return!!(e&&e.__v_isRef===!0)}function Ho(e){return re(e)?e.value:e}const Bo={get:(e,s,n)=>Ho(Reflect.get(e,s,n)),set:(e,s,n,t)=>{const a=e[s];return re(a)&&!re(n)?(a.value=n,!0):Reflect.set(e,s,n,t)}};function zt(e){return ls(e)?e:new Proxy(e,Bo)}class Mo{constructor(s,n,t,a){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this._dirty=!0,this.effect=new wn(s,()=>{this._dirty||(this._dirty=!0,Fo(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!a,this.__v_isReadonly=t}get value(){const s=E(this);return Ro(s),(s._dirty||!s._cacheable)&&(s._dirty=!1,s._value=s.effect.run()),s._value}set value(s){this._setter(s)}}function Yo(e,s,n=!1){let t,a;const o=O(e);return o?(t=e,a=je):(t=e.get,a=e.set),new Mo(t,a,o||!a,n)}function dl(e,...s){}function Be(e,s,n,t){let a;try{a=t?e(...t):e()}catch(o){Ms(o,s,n)}return a}function fe(e,s,n,t){if(O(e)){const o=Be(e,s,n,t);return o&&lt(o)&&o.catch(i=>{Ms(i,s,n)}),o}const a=[];for(let o=0;o<e.length;o++)a.push(fe(e[o],s,n,t));return a}function Ms(e,s,n,t=!0){const a=s?s.vnode:null;if(s){let o=s.parent;const i=s.proxy,l=n;for(;o;){const u=o.ec;if(u){for(let h=0;h<u.length;h++)if(u[h](e,i,l)===!1)return}o=o.parent}const c=s.appContext.config.errorHandler;if(c){Be(c,null,10,[e,i,l]);return}}Uo(e,n,a,t)}function Uo(e,s,n,t=!0){console.error(e)}let bs=!1,In=!1;const oe=[];let ke=0;const cs=[];let Ce=null,Ve=0;const Ct=Promise.resolve();let On=null;function Lo(e){const s=On||Ct;return e?s.then(this?e.bind(this):e):s}function Wo(e){let s=ke+1,n=oe.length;for(;s<n;){const t=s+n>>>1;js(oe[t])<e?s=t+1:n=t}return s}function qn(e){(!oe.length||!oe.includes(e,bs&&e.allowRecurse?ke+1:ke))&&(e.id==null?oe.push(e):oe.splice(Wo(e.id),0,e),Pt())}function Pt(){!bs&&!In&&(In=!0,On=Ct.then(Ft))}function Vo(e){const s=oe.indexOf(e);s>ke&&oe.splice(s,1)}function $o(e){A(e)?cs.push(...e):(!Ce||!Ce.includes(e,e.allowRecurse?Ve+1:Ve))&&cs.push(e),Pt()}function Et(e,s=bs?ke+1:0){for(;s<oe.length;s++){const n=oe[s];n&&n.pre&&(oe.splice(s,1),s--,n())}}function Rt(e){if(cs.length){const s=[...new Set(cs)];if(cs.length=0,Ce){Ce.push(...s);return}for(Ce=s,Ce.sort((n,t)=>js(n)-js(t)),Ve=0;Ve<Ce.length;Ve++)Ce[Ve]();Ce=null,Ve=0}}const js=e=>e.id==null?1/0:e.id,Ko=(e,s)=>{const n=js(e)-js(s);if(n===0){if(e.pre&&!s.pre)return-1;if(s.pre&&!e.pre)return 1}return n};function Ft(e){In=!1,bs=!0,oe.sort(Ko);const s=je;try{for(ke=0;ke<oe.length;ke++){const n=oe[ke];n&&n.active!==!1&&Be(n,null,14)}}finally{ke=0,oe.length=0,Rt(),bs=!1,On=null,(oe.length||cs.length)&&Ft()}}function Go(e,s,...n){if(e.isUnmounted)return;const t=e.vnode.props||U;let a=n;const o=s.startsWith("update:"),i=o&&s.slice(7);if(i&&i in t){const h=`${i==="modelValue"?"model":i}Modifiers`,{number:y,trim:v}=t[h]||U;v&&(a=n.map(x=>Q(x)?x.trim():x)),y&&(a=n.map(eo))}let l,c=t[l=hn(s)]||t[l=hn(Se(s))];!c&&o&&(c=t[l=hn(os(s))]),c&&fe(c,e,6,a);const u=t[l+"Once"];if(u){if(!e.emitted)e.emitted={};else if(e.emitted[l])return;e.emitted[l]=!0,fe(u,e,6,a)}}function Ht(e,s,n=!1){const t=s.emitsCache,a=t.get(e);if(a!==void 0)return a;const o=e.emits;let i={},l=!1;if(!O(e)){const c=u=>{const h=Ht(u,s,!0);h&&(l=!0,Z(i,h))};!n&&s.mixins.length&&s.mixins.forEach(c),e.extends&&c(e.extends),e.mixins&&e.mixins.forEach(c)}return!o&&!l?(B(e)&&t.set(e,null),null):(A(o)?o.forEach(c=>i[c]=null):Z(i,o),B(e)&&t.set(e,i),i)}function Ys(e,s){return!e||!As(s)?!1:(s=s.slice(2).replace(/Once$/,""),C(e,s[0].toLowerCase()+s.slice(1))||C(e,os(s))||C(e,s))}let ge=null,Bt=null;function Us(e){const s=ge;return ge=e,Bt=e&&e.type.__scopeId||null,s}function Mt(e,s=ge,n){if(!s||e._n)return e;const t=(...a)=>{t._d&&va(-1);const o=Us(s);let i;try{i=e(...a)}finally{Us(o),t._d&&va(1)}return i};return t._n=!0,t._c=!0,t._d=!0,t}function hl(){}function zn(e){const{type:s,vnode:n,proxy:t,withProxy:a,props:o,propsOptions:[i],slots:l,attrs:c,emit:u,render:h,renderCache:y,data:v,setupState:x,ctx:P,inheritAttrs:D}=e;let M,L;const W=Us(e);try{if(n.shapeFlag&4){const N=a||t;M=Ae(h.call(N,N,y,o,x,v,P)),L=c}else{const N=s;M=Ae(N.length>1?N(o,{attrs:c,slots:l,emit:u}):N(o,null)),L=s.props?c:Xo(c)}}catch(N){Js.length=0,Ms(N,e,1),M=ce(Je)}let V=M;if(L&&D!==!1){const N=Object.keys(L),{shapeFlag:te}=V;N.length&&te&7&&(i&&N.some(cn)&&(L=Zo(L,i)),V=Me(V,L))}return n.dirs&&(V=Me(V),V.dirs=V.dirs?V.dirs.concat(n.dirs):n.dirs),n.transition&&(V.transition=n.transition),M=V,Us(W),M}const Xo=e=>{let s;for(const n in e)(n==="class"||n==="style"||As(n))&&((s||(s={}))[n]=e[n]);return s},Zo=(e,s)=>{const n={};for(const t in e)(!cn(t)||!(t.slice(9)in s))&&(n[t]=e[t]);return n};function Qo(e,s,n){const{props:t,children:a,component:o}=e,{props:i,children:l,patchFlag:c}=s,u=o.emitsOptions;if(s.dirs||s.transition)return!0;if(n&&c>=0){if(c&1024)return!0;if(c&16)return t?Yt(t,i,u):!!i;if(c&8){const h=s.dynamicProps;for(let y=0;y<h.length;y++){const v=h[y];if(i[v]!==t[v]&&!Ys(u,v))return!0}}}else return(a||l)&&(!l||!l.$stable)?!0:t===i?!1:t?i?Yt(t,i,u):!0:!!i;return!1}function Yt(e,s,n){const t=Object.keys(s);if(t.length!==Object.keys(e).length)return!0;for(let a=0;a<t.length;a++){const o=t[a];if(s[o]!==e[o]&&!Ys(n,o))return!0}return!1}function ei({vnode:e,parent:s},n){for(;s&&s.subTree===e;)(e=s.vnode).el=n,s=s.parent}const si=e=>e.__isSuspense;function ni(e,s){s&&s.pendingBranch?A(e)?s.effects.push(...e):s.effects.push(e):$o(e)}const Ls={};function Cn(e,s,n){return Ut(e,s,n)}function Ut(e,s,{immediate:n,deep:t,flush:a,onTrack:o,onTrigger:i}=U){var l;const c=co()===((l=ne)==null?void 0:l.scope)?ne:null;let u,h=!1,y=!1;if(re(e)?(u=()=>e.value,h=An(e)):ls(e)?(u=()=>e,t=!0):A(e)?(y=!0,h=e.some(N=>ls(N)||An(N)),u=()=>e.map(N=>{if(re(N))return N.value;if(ls(N))return ps(N);if(O(N))return Be(N,c,2)})):O(e)?s?u=()=>Be(e,c,2):u=()=>{if(!(c&&c.isUnmounted))return v&&v(),fe(e,c,3,[x])}:u=je,s&&t){const N=u;u=()=>ps(N())}let v,x=N=>{v=W.onStop=()=>{Be(N,c,4)}},P;if(Ts)if(x=je,s?n&&fe(s,c,3,[u(),y?[]:void 0,x]):u(),a==="sync"){const N=er();P=N.__watcherHandles||(N.__watcherHandles=[])}else return je;let D=y?new Array(e.length).fill(Ls):Ls;const M=()=>{if(W.active)if(s){const N=W.run();(t||h||(y?N.some((te,Ne)=>qs(te,D[Ne])):qs(N,D)))&&(v&&v(),fe(s,c,3,[N,D===Ls?void 0:y&&D[0]===Ls?[]:D,x]),D=N)}else W.run()};M.allowRecurse=!!s;let L;a==="sync"?L=M:a==="post"?L=()=>ue(M,c&&c.suspense):(M.pre=!0,c&&(M.id=c.uid),L=()=>qn(M));const W=new wn(u,L);s?n?M():D=W.run():a==="post"?ue(W.run.bind(W),c&&c.suspense):W.run();const V=()=>{W.stop(),c&&c.scope&&pn(c.scope.effects,W)};return P&&P.push(V),V}function ti(e,s,n){const t=this.proxy,a=Q(e)?e.includes(".")?Lt(t,e):()=>t[e]:e.bind(t,t);let o;O(s)?o=s:(o=s.handler,n=s);const i=ne;ds(this);const l=Ut(a,o.bind(t),n);return i?ds(i):Xe(),l}function Lt(e,s){const n=s.split(".");return()=>{let t=e;for(let a=0;a<n.length&&t;a++)t=t[n[a]];return t}}function ps(e,s){if(!B(e)||e.__v_skip||(s=s||new Set,s.has(e)))return e;if(s.add(e),re(e))ps(e.value,s);else if(A(e))for(let n=0;n<e.length;n++)ps(e[n],s);else if(rt(e)||as(e))e.forEach(n=>{ps(n,s)});else if(pt(e))for(const n in e)ps(e[n],s);return e}function $e(e,s,n,t){const a=e.dirs,o=s&&s.dirs;for(let i=0;i<a.length;i++){const l=a[i];o&&(l.oldValue=o[i].value);let c=l.dir[t];c&&(is(),fe(c,n,8,[e.el,l,e,s]),rs())}}function ai(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Xt(()=>{e.isMounted=!0}),Zt(()=>{e.isUnmounting=!0}),e}const ye=[Function,Array],Wt={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:ye,onEnter:ye,onAfterEnter:ye,onEnterCancelled:ye,onBeforeLeave:ye,onLeave:ye,onAfterLeave:ye,onLeaveCancelled:ye,onBeforeAppear:ye,onAppear:ye,onAfterAppear:ye,onAppearCancelled:ye},oi={name:"BaseTransition",props:Wt,setup(e,{slots:s}){const n=Ui(),t=ai();let a;return()=>{const o=s.default&&Kt(s.default(),!0);if(!o||!o.length)return;let i=o[0];if(o.length>1){for(const D of o)if(D.type!==Je){i=D;break}}const l=E(e),{mode:c}=l;if(t.isLeaving)return En(i);const u=$t(i);if(!u)return En(i);const h=Pn(u,l,t,n);Rn(u,h);const y=n.subTree,v=y&&$t(y);let x=!1;const{getTransitionKey:P}=u.type;if(P){const D=P();a===void 0?a=D:D!==a&&(a=D,x=!0)}if(v&&v.type!==Je&&(!Ge(u,v)||x)){const D=Pn(v,l,t,n);if(Rn(v,D),c==="out-in")return t.isLeaving=!0,D.afterLeave=()=>{t.isLeaving=!1,n.update.active!==!1&&n.update()},En(i);c==="in-out"&&u.type!==Je&&(D.delayLeave=(M,L,W)=>{const V=Vt(t,v);V[String(v.key)]=v,M._leaveCb=()=>{L(),M._leaveCb=void 0,delete h.delayedLeave},h.delayedLeave=W})}return i}}};function Vt(e,s){const{leavingVNodes:n}=e;let t=n.get(s.type);return t||(t=Object.create(null),n.set(s.type,t)),t}function Pn(e,s,n,t){const{appear:a,mode:o,persisted:i=!1,onBeforeEnter:l,onEnter:c,onAfterEnter:u,onEnterCancelled:h,onBeforeLeave:y,onLeave:v,onAfterLeave:x,onLeaveCancelled:P,onBeforeAppear:D,onAppear:M,onAfterAppear:L,onAppearCancelled:W}=s,V=String(e.key),N=Vt(n,e),te=(q,G)=>{q&&fe(q,t,9,G)},Ne=(q,G)=>{const Y=G[1];te(q,G),A(q)?q.every(ie=>ie.length<=1)&&Y():q.length<=1&&Y()},Ie={mode:o,persisted:i,beforeEnter(q){let G=l;if(!n.isMounted)if(a)G=D||l;else return;q._leaveCb&&q._leaveCb(!0);const Y=N[V];Y&&Ge(e,Y)&&Y.el._leaveCb&&Y.el._leaveCb(),te(G,[q])},enter(q){let G=c,Y=u,ie=h;if(!n.isMounted)if(a)G=M||c,Y=L||u,ie=W||h;else return;let T=!1;const K=q._enterCb=he=>{T||(T=!0,he?te(ie,[q]):te(Y,[q]),Ie.delayedLeave&&Ie.delayedLeave(),q._enterCb=void 0)};G?Ne(G,[q,K]):K()},leave(q,G){const Y=String(e.key);if(q._enterCb&&q._enterCb(!0),n.isUnmounting)return G();te(y,[q]);let ie=!1;const T=q._leaveCb=K=>{ie||(ie=!0,G(),K?te(P,[q]):te(x,[q]),q._leaveCb=void 0,N[Y]===e&&delete N[Y])};N[Y]=e,v?Ne(v,[q,T]):T()},clone(q){return Pn(q,s,n,t)}};return Ie}function En(e){if(Vs(e))return e=Me(e),e.children=null,e}function $t(e){return Vs(e)?e.children?e.children[0]:void 0:e}function Rn(e,s){e.shapeFlag&6&&e.component?Rn(e.component.subTree,s):e.shapeFlag&128?(e.ssContent.transition=s.clone(e.ssContent),e.ssFallback.transition=s.clone(e.ssFallback)):e.transition=s}function Kt(e,s=!1,n){let t=[],a=0;for(let o=0;o<e.length;o++){let i=e[o];const l=n==null?i.key:String(n)+String(i.key!=null?i.key:o);i.type===be?(i.patchFlag&128&&a++,t=t.concat(Kt(i.children,s,l))):(s||i.type!==Je)&&t.push(l!=null?Me(i,{key:l}):i)}if(a>1)for(let o=0;o<t.length;o++)t[o].patchFlag=-2;return t}function Fn(e,s){return O(e)?(()=>Z({name:e.name},s,{setup:e}))():e}const Ws=e=>!!e.type.__asyncLoader,Vs=e=>e.type.__isKeepAlive;function ii(e,s){Gt(e,"a",s)}function ri(e,s){Gt(e,"da",s)}function Gt(e,s,n=ne){const t=e.__wdc||(e.__wdc=()=>{let a=n;for(;a;){if(a.isDeactivated)return;a=a.parent}return e()});if($s(s,t,n),n){let a=n.parent;for(;a&&a.parent;)Vs(a.parent.vnode)&&li(t,s,n,a),a=a.parent}}function li(e,s,n,t){const a=$s(s,e,t,!0);Qt(()=>{pn(t[s],a)},n)}function $s(e,s,n=ne,t=!1){if(n){const a=n[e]||(n[e]=[]),o=s.__weh||(s.__weh=(...i)=>{if(n.isUnmounted)return;is(),ds(n);const l=fe(s,n,e,i);return Xe(),rs(),l});return t?a.unshift(o):a.push(o),o}}const Pe=e=>(s,n=ne)=>(!Ts||e==="sp")&&$s(e,(...t)=>s(...t),n),ci=Pe("bm"),Xt=Pe("m"),pi=Pe("bu"),ui=Pe("u"),Zt=Pe("bum"),Qt=Pe("um"),di=Pe("sp"),hi=Pe("rtg"),mi=Pe("rtc");function fi(e,s=ne){$s("ec",e,s)}const ea="components";function Hn(e,s){return yi(ea,e,!0,s)||e}const gi=Symbol.for("v-ndc");function yi(e,s,n=!0,t=!1){const a=ge||ne;if(a){const o=a.type;if(e===ea){const l=Ki(o,!1);if(l&&(l===s||l===Se(s)||l===Os(Se(s))))return o}const i=sa(a[e]||o[e],s)||sa(a.appContext[e],s);return!i&&t?o:i}}function sa(e,s){return e&&(e[s]||e[Se(s)]||e[Os(Se(s))])}function na(e,s,n,t){let a;const o=n&&n[t];if(A(e)||Q(e)){a=new Array(e.length);for(let i=0,l=e.length;i<l;i++)a[i]=s(e[i],i,void 0,o&&o[i])}else if(typeof e=="number"){a=new Array(e);for(let i=0;i<e;i++)a[i]=s(i+1,i,void 0,o&&o[i])}else if(B(e))if(e[Symbol.iterator])a=Array.from(e,(i,l)=>s(i,l,void 0,o&&o[l]));else{const i=Object.keys(e);a=new Array(i.length);for(let l=0,c=i.length;l<c;l++){const u=i[l];a[l]=s(e[u],u,l,o&&o[l])}}else a=[];return n&&(n[t]=a),a}const Bn=e=>e?Ta(e)?Qn(e)||e.proxy:Bn(e.parent):null,vs=Z(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Bn(e.parent),$root:e=>Bn(e.root),$emit:e=>e.emit,$options:e=>Un(e),$forceUpdate:e=>e.f||(e.f=()=>qn(e.update)),$nextTick:e=>e.n||(e.n=Lo.bind(e.proxy)),$watch:e=>ti.bind(e)}),Mn=(e,s)=>e!==U&&!e.__isScriptSetup&&C(e,s),bi={get({_:e},s){const{ctx:n,setupState:t,data:a,props:o,accessCache:i,type:l,appContext:c}=e;let u;if(s[0]!=="$"){const x=i[s];if(x!==void 0)switch(x){case 1:return t[s];case 2:return a[s];case 4:return n[s];case 3:return o[s]}else{if(Mn(t,s))return i[s]=1,t[s];if(a!==U&&C(a,s))return i[s]=2,a[s];if((u=e.propsOptions[0])&&C(u,s))return i[s]=3,o[s];if(n!==U&&C(n,s))return i[s]=4,n[s];Yn&&(i[s]=0)}}const h=vs[s];let y,v;if(h)return s==="$attrs"&&pe(e,"get",s),h(e);if((y=l.__cssModules)&&(y=y[s]))return y;if(n!==U&&C(n,s))return i[s]=4,n[s];if(v=c.config.globalProperties,C(v,s))return v[s]},set({_:e},s,n){const{data:t,setupState:a,ctx:o}=e;return Mn(a,s)?(a[s]=n,!0):t!==U&&C(t,s)?(t[s]=n,!0):C(e.props,s)||s[0]==="$"&&s.slice(1)in e?!1:(o[s]=n,!0)},has({_:{data:e,setupState:s,accessCache:n,ctx:t,appContext:a,propsOptions:o}},i){let l;return!!n[i]||e!==U&&C(e,i)||Mn(s,i)||(l=o[0])&&C(l,i)||C(t,i)||C(vs,i)||C(a.config.globalProperties,i)},defineProperty(e,s,n){return n.get!=null?e._.accessCache[s]=0:C(n,"value")&&this.set(e,s,n.value,null),Reflect.defineProperty(e,s,n)}};function ta(e){return A(e)?e.reduce((s,n)=>(s[n]=null,s),{}):e}let Yn=!0;function ji(e){const s=Un(e),n=e.proxy,t=e.ctx;Yn=!1,s.beforeCreate&&aa(s.beforeCreate,e,"bc");const{data:a,computed:o,methods:i,watch:l,provide:c,inject:u,created:h,beforeMount:y,mounted:v,beforeUpdate:x,updated:P,activated:D,deactivated:M,beforeDestroy:L,beforeUnmount:W,destroyed:V,unmounted:N,render:te,renderTracked:Ne,renderTriggered:Ie,errorCaptured:q,serverPrefetch:G,expose:Y,inheritAttrs:ie,components:T,directives:K,filters:he}=s;if(u&&vi(u,t,null),i)for(const X in i){const F=i[X];O(F)&&(t[X]=F.bind(n))}if(a){const X=a.call(n,n);B(X)&&(e.data=kn(X))}if(Yn=!0,o)for(const X in o){const F=o[X],ss=O(F)?F.bind(n,n):O(F.get)?F.get.bind(n,n):je,on=!O(F)&&O(F.set)?F.set.bind(n):je,ns=Xi({get:ss,set:on});Object.defineProperty(t,X,{enumerable:!0,configurable:!0,get:()=>ns.value,set:Oe=>ns.value=Oe})}if(l)for(const X in l)oa(l[X],t,n,X);if(c){const X=O(c)?c.call(n):c;Reflect.ownKeys(X).forEach(F=>{ki(F,X[F])})}h&&aa(h,e,"c");function ae(X,F){A(F)?F.forEach(ss=>X(ss.bind(n))):F&&X(F.bind(n))}if(ae(ci,y),ae(Xt,v),ae(pi,x),ae(ui,P),ae(ii,D),ae(ri,M),ae(fi,q),ae(mi,Ne),ae(hi,Ie),ae(Zt,W),ae(Qt,N),ae(di,G),A(Y))if(Y.length){const X=e.exposed||(e.exposed={});Y.forEach(F=>{Object.defineProperty(X,F,{get:()=>n[F],set:ss=>n[F]=ss})})}else e.exposed||(e.exposed={});te&&e.render===je&&(e.render=te),ie!=null&&(e.inheritAttrs=ie),T&&(e.components=T),K&&(e.directives=K)}function vi(e,s,n=je){A(e)&&(e=Ln(e));for(const t in e){const a=e[t];let o;B(a)?"default"in a?o=Xs(a.from||t,a.default,!0):o=Xs(a.from||t):o=Xs(a),re(o)?Object.defineProperty(s,t,{enumerable:!0,configurable:!0,get:()=>o.value,set:i=>o.value=i}):s[t]=o}}function aa(e,s,n){fe(A(e)?e.map(t=>t.bind(s.proxy)):e.bind(s.proxy),s,n)}function oa(e,s,n,t){const a=t.includes(".")?Lt(n,t):()=>n[t];if(Q(e)){const o=s[e];O(o)&&Cn(a,o)}else if(O(e))Cn(a,e.bind(n));else if(B(e))if(A(e))e.forEach(o=>oa(o,s,n,t));else{const o=O(e.handler)?e.handler.bind(n):s[e.handler];O(o)&&Cn(a,o,e)}}function Un(e){const s=e.type,{mixins:n,extends:t}=s,{mixins:a,optionsCache:o,config:{optionMergeStrategies:i}}=e.appContext,l=o.get(s);let c;return l?c=l:!a.length&&!n&&!t?c=s:(c={},a.length&&a.forEach(u=>Ks(c,u,i,!0)),Ks(c,s,i)),B(s)&&o.set(s,c),c}function Ks(e,s,n,t=!1){const{mixins:a,extends:o}=s;o&&Ks(e,o,n,!0),a&&a.forEach(i=>Ks(e,i,n,!0));for(const i in s)if(!(t&&i==="expose")){const l=wi[i]||n&&n[i];e[i]=l?l(e[i],s[i]):s[i]}return e}const wi={data:ia,props:ra,emits:ra,methods:ws,computed:ws,beforeCreate:le,created:le,beforeMount:le,mounted:le,beforeUpdate:le,updated:le,beforeDestroy:le,beforeUnmount:le,destroyed:le,unmounted:le,activated:le,deactivated:le,errorCaptured:le,serverPrefetch:le,components:ws,directives:ws,watch:_i,provide:ia,inject:Ji};function ia(e,s){return s?e?function(){return Z(O(e)?e.call(this,this):e,O(s)?s.call(this,this):s)}:s:e}function Ji(e,s){return ws(Ln(e),Ln(s))}function Ln(e){if(A(e)){const s={};for(let n=0;n<e.length;n++)s[e[n]]=e[n];return s}return e}function le(e,s){return e?[...new Set([].concat(e,s))]:s}function ws(e,s){return e?Z(Object.create(null),e,s):s}function ra(e,s){return e?A(e)&&A(s)?[...new Set([...e,...s])]:Z(Object.create(null),ta(e),ta(s??{})):s}function _i(e,s){if(!e)return s;if(!s)return e;const n=Z(Object.create(null),e);for(const t in s)n[t]=le(e[t],s[t]);return n}function la(){return{app:null,config:{isNativeTag:$a,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Ti=0;function Si(e,s){return function(t,a=null){O(t)||(t=Z({},t)),a!=null&&!B(a)&&(a=null);const o=la(),i=new Set;let l=!1;const c=o.app={_uid:Ti++,_component:t,_props:a,_container:null,_context:o,_instance:null,version:sr,get config(){return o.config},set config(u){},use(u,...h){return i.has(u)||(u&&O(u.install)?(i.add(u),u.install(c,...h)):O(u)&&(i.add(u),u(c,...h))),c},mixin(u){return o.mixins.includes(u)||o.mixins.push(u),c},component(u,h){return h?(o.components[u]=h,c):o.components[u]},directive(u,h){return h?(o.directives[u]=h,c):o.directives[u]},mount(u,h,y){if(!l){const v=ce(t,a);return v.appContext=o,h&&s?s(v,u):e(v,u,y),l=!0,c._container=u,u.__vue_app__=c,Qn(v.component)||v.component.proxy}},unmount(){l&&(e(null,c._container),delete c._container.__vue_app__)},provide(u,h){return o.provides[u]=h,c},runWithContext(u){Gs=c;try{return u()}finally{Gs=null}}};return c}}let Gs=null;function ki(e,s){if(ne){let n=ne.provides;const t=ne.parent&&ne.parent.provides;t===n&&(n=ne.provides=Object.create(t)),n[e]=s}}function Xs(e,s,n=!1){const t=ne||ge;if(t||Gs){const a=t?t.parent==null?t.vnode.appContext&&t.vnode.appContext.provides:t.parent.provides:Gs._context.provides;if(a&&e in a)return a[e];if(arguments.length>1)return n&&O(s)?s.call(t&&t.proxy):s}}function xi(e,s,n,t=!1){const a={},o={};zs(o,sn,1),e.propsDefaults=Object.create(null),ca(e,s,a,o);for(const i in e.propsOptions[0])i in a||(a[i]=void 0);n?e.props=t?a:Eo(a):e.type.props?e.props=a:e.props=o,e.attrs=o}function Ai(e,s,n,t){const{props:a,attrs:o,vnode:{patchFlag:i}}=e,l=E(a),[c]=e.propsOptions;let u=!1;if((t||i>0)&&!(i&16)){if(i&8){const h=e.vnode.dynamicProps;for(let y=0;y<h.length;y++){let v=h[y];if(Ys(e.emitsOptions,v))continue;const x=s[v];if(c)if(C(o,v))x!==o[v]&&(o[v]=x,u=!0);else{const P=Se(v);a[P]=Wn(c,l,P,x,e,!1)}else x!==o[v]&&(o[v]=x,u=!0)}}}else{ca(e,s,a,o)&&(u=!0);let h;for(const y in l)(!s||!C(s,y)&&((h=os(y))===y||!C(s,h)))&&(c?n&&(n[y]!==void 0||n[h]!==void 0)&&(a[y]=Wn(c,l,y,void 0,e,!0)):delete a[y]);if(o!==l)for(const y in o)(!s||!C(s,y))&&(delete o[y],u=!0)}u&&ze(e,"set","$attrs")}function ca(e,s,n,t){const[a,o]=e.propsOptions;let i=!1,l;if(s)for(let c in s){if(Ns(c))continue;const u=s[c];let h;a&&C(a,h=Se(c))?!o||!o.includes(h)?n[h]=u:(l||(l={}))[h]=u:Ys(e.emitsOptions,c)||(!(c in t)||u!==t[c])&&(t[c]=u,i=!0)}if(o){const c=E(n),u=l||U;for(let h=0;h<o.length;h++){const y=o[h];n[y]=Wn(a,c,y,u[y],e,!C(u,y))}}return i}function Wn(e,s,n,t,a,o){const i=e[n];if(i!=null){const l=C(i,"default");if(l&&t===void 0){const c=i.default;if(i.type!==Function&&!i.skipFactory&&O(c)){const{propsDefaults:u}=a;n in u?t=u[n]:(ds(a),t=u[n]=c.call(null,s),Xe())}else t=c}i[0]&&(o&&!l?t=!1:i[1]&&(t===""||t===os(n))&&(t=!0))}return t}function pa(e,s,n=!1){const t=s.propsCache,a=t.get(e);if(a)return a;const o=e.props,i={},l=[];let c=!1;if(!O(e)){const h=y=>{c=!0;const[v,x]=pa(y,s,!0);Z(i,v),x&&l.push(...x)};!n&&s.mixins.length&&s.mixins.forEach(h),e.extends&&h(e.extends),e.mixins&&e.mixins.forEach(h)}if(!o&&!c)return B(e)&&t.set(e,ts),ts;if(A(o))for(let h=0;h<o.length;h++){const y=Se(o[h]);ua(y)&&(i[y]=U)}else if(o)for(const h in o){const y=Se(h);if(ua(y)){const v=o[h],x=i[y]=A(v)||O(v)?{type:v}:Z({},v);if(x){const P=ma(Boolean,x.type),D=ma(String,x.type);x[0]=P>-1,x[1]=D<0||P<D,(P>-1||C(x,"default"))&&l.push(y)}}}const u=[i,l];return B(e)&&t.set(e,u),u}function ua(e){return e[0]!=="$"}function da(e){const s=e&&e.toString().match(/^\s*(function|class) (\w+)/);return s?s[2]:e===null?"null":""}function ha(e,s){return da(e)===da(s)}function ma(e,s){return A(s)?s.findIndex(n=>ha(n,e)):O(s)&&ha(s,e)?0:-1}const fa=e=>e[0]==="_"||e==="$stable",Vn=e=>A(e)?e.map(Ae):[Ae(e)],Di=(e,s,n)=>{if(s._n)return s;const t=Mt((...a)=>Vn(s(...a)),n);return t._c=!1,t},ya=(e,s,n)=>{const t=e._ctx;for(const a in e){if(fa(a))continue;const o=e[a];if(O(o))s[a]=Di(a,o,t);else if(o!=null){const i=Vn(o);s[a]=()=>i}}},ba=(e,s)=>{const n=Vn(s);e.slots.default=()=>n},Ni=(e,s)=>{if(e.vnode.shapeFlag&32){const n=s._;n?(e.slots=E(s),zs(s,"_",n)):ya(s,e.slots={})}else e.slots={},s&&ba(e,s);zs(e.slots,sn,1)},Ii=(e,s,n)=>{const{vnode:t,slots:a}=e;let o=!0,i=U;if(t.shapeFlag&32){const l=s._;l?n&&l===1?o=!1:(Z(a,s),!n&&l===1&&delete a._):(o=!s.$stable,ya(s,a)),i=s}else s&&(ba(e,s),i={default:1});if(o)for(const l in a)!fa(l)&&!(l in i)&&delete a[l]};function $n(e,s,n,t,a=!1){if(A(e)){e.forEach((v,x)=>$n(v,s&&(A(s)?s[x]:s),n,t,a));return}if(Ws(t)&&!a)return;const o=t.shapeFlag&4?Qn(t.component)||t.component.proxy:t.el,i=a?null:o,{i:l,r:c}=e,u=s&&s.r,h=l.refs===U?l.refs={}:l.refs,y=l.setupState;if(u!=null&&u!==c&&(Q(u)?(h[u]=null,C(y,u)&&(y[u]=null)):re(u)&&(u.value=null)),O(c))Be(c,l,12,[i,h]);else{const v=Q(c),x=re(c);if(v||x){const P=()=>{if(e.f){const D=v?C(y,c)?y[c]:h[c]:c.value;a?A(D)&&pn(D,o):A(D)?D.includes(o)||D.push(o):v?(h[c]=[o],C(y,c)&&(y[c]=h[c])):(c.value=[o],e.k&&(h[e.k]=c.value))}else v?(h[c]=i,C(y,c)&&(y[c]=i)):x&&(c.value=i,e.k&&(h[e.k]=i))};i?(P.id=-1,ue(P,n)):P()}}}const ue=ni;function Oi(e){return qi(e)}function qi(e,s){const n=fn();n.__VUE__=!0;const{insert:t,remove:a,patchProp:o,createElement:i,createText:l,createComment:c,setText:u,setElementText:h,parentNode:y,nextSibling:v,setScopeId:x=je,insertStaticContent:P}=e,D=(r,p,d,f=null,m=null,j=null,J=!1,b=null,w=!!p.dynamicChildren)=>{if(r===p)return;r&&!Ge(r,p)&&(f=rn(r),Oe(r,m,j,!0),r=null),p.patchFlag===-2&&(w=!1,p.dynamicChildren=null);const{type:g,ref:S,shapeFlag:_}=p;switch(g){case Zs:M(r,p,d,f);break;case Je:L(r,p,d,f);break;case Qs:r==null&&W(p,d,f,J);break;case be:T(r,p,d,f,m,j,J,b,w);break;default:_&1?te(r,p,d,f,m,j,J,b,w):_&6?K(r,p,d,f,m,j,J,b,w):(_&64||_&128)&&g.process(r,p,d,f,m,j,J,b,w,hs)}S!=null&&m&&$n(S,r&&r.ref,j,p||r,!p)},M=(r,p,d,f)=>{if(r==null)t(p.el=l(p.children),d,f);else{const m=p.el=r.el;p.children!==r.children&&u(m,p.children)}},L=(r,p,d,f)=>{r==null?t(p.el=c(p.children||""),d,f):p.el=r.el},W=(r,p,d,f)=>{[r.el,r.anchor]=P(r.children,p,d,f,r.el,r.anchor)},V=({el:r,anchor:p},d,f)=>{let m;for(;r&&r!==p;)m=v(r),t(r,d,f),r=m;t(p,d,f)},N=({el:r,anchor:p})=>{let d;for(;r&&r!==p;)d=v(r),a(r),r=d;a(p)},te=(r,p,d,f,m,j,J,b,w)=>{J=J||p.type==="svg",r==null?Ne(p,d,f,m,j,J,b,w):G(r,p,m,j,J,b,w)},Ne=(r,p,d,f,m,j,J,b)=>{let w,g;const{type:S,props:_,shapeFlag:k,transition:I,dirs:z}=r;if(w=r.el=i(r.type,j,_&&_.is,_),k&8?h(w,r.children):k&16&&q(r.children,w,null,f,m,j&&S!=="foreignObject",J,b),z&&$e(r,null,f,"created"),Ie(w,r,r.scopeId,J,f),_){for(const R in _)R!=="value"&&!Ns(R)&&o(w,R,null,_[R],j,r.children,f,m,Ee);"value"in _&&o(w,"value",null,_.value),(g=_.onVnodeBeforeMount)&&De(g,f,r)}z&&$e(r,null,f,"beforeMount");const H=(!m||m&&!m.pendingBranch)&&I&&!I.persisted;H&&I.beforeEnter(w),t(w,p,d),((g=_&&_.onVnodeMounted)||H||z)&&ue(()=>{g&&De(g,f,r),H&&I.enter(w),z&&$e(r,null,f,"mounted")},m)},Ie=(r,p,d,f,m)=>{if(d&&x(r,d),f)for(let j=0;j<f.length;j++)x(r,f[j]);if(m){let j=m.subTree;if(p===j){const J=m.vnode;Ie(r,J,J.scopeId,J.slotScopeIds,m.parent)}}},q=(r,p,d,f,m,j,J,b,w=0)=>{for(let g=w;g<r.length;g++){const S=r[g]=b?Ye(r[g]):Ae(r[g]);D(null,S,p,d,f,m,j,J,b)}},G=(r,p,d,f,m,j,J)=>{const b=p.el=r.el;let{patchFlag:w,dynamicChildren:g,dirs:S}=p;w|=r.patchFlag&16;const _=r.props||U,k=p.props||U;let I;d&&Ke(d,!1),(I=k.onVnodeBeforeUpdate)&&De(I,d,p,r),S&&$e(p,r,d,"beforeUpdate"),d&&Ke(d,!0);const z=m&&p.type!=="foreignObject";if(g?Y(r.dynamicChildren,g,b,d,f,z,j):J||F(r,p,b,null,d,f,z,j,!1),w>0){if(w&16)ie(b,p,_,k,d,f,m);else if(w&2&&_.class!==k.class&&o(b,"class",null,k.class,m),w&4&&o(b,"style",_.style,k.style,m),w&8){const H=p.dynamicProps;for(let R=0;R<H.length;R++){const ee=H[R],Te=_[ee],ms=k[ee];(ms!==Te||ee==="value")&&o(b,ee,Te,ms,m,r.children,d,f,Ee)}}w&1&&r.children!==p.children&&h(b,p.children)}else!J&&g==null&&ie(b,p,_,k,d,f,m);((I=k.onVnodeUpdated)||S)&&ue(()=>{I&&De(I,d,p,r),S&&$e(p,r,d,"updated")},f)},Y=(r,p,d,f,m,j,J)=>{for(let b=0;b<p.length;b++){const w=r[b],g=p[b],S=w.el&&(w.type===be||!Ge(w,g)||w.shapeFlag&70)?y(w.el):d;D(w,g,S,null,f,m,j,J,!0)}},ie=(r,p,d,f,m,j,J)=>{if(d!==f){if(d!==U)for(const b in d)!Ns(b)&&!(b in f)&&o(r,b,d[b],null,J,p.children,m,j,Ee);for(const b in f){if(Ns(b))continue;const w=f[b],g=d[b];w!==g&&b!=="value"&&o(r,b,g,w,J,p.children,m,j,Ee)}"value"in f&&o(r,"value",d.value,f.value)}},T=(r,p,d,f,m,j,J,b,w)=>{const g=p.el=r?r.el:l(""),S=p.anchor=r?r.anchor:l("");let{patchFlag:_,dynamicChildren:k,slotScopeIds:I}=p;I&&(b=b?b.concat(I):I),r==null?(t(g,d,f),t(S,d,f),q(p.children,d,S,m,j,J,b,w)):_>0&&_&64&&k&&r.dynamicChildren?(Y(r.dynamicChildren,k,d,m,j,J,b),(p.key!=null||m&&p===m.subTree)&&ja(r,p,!0)):F(r,p,d,S,m,j,J,b,w)},K=(r,p,d,f,m,j,J,b,w)=>{p.slotScopeIds=b,r==null?p.shapeFlag&512?m.ctx.activate(p,d,f,J,w):he(p,d,f,m,j,J,w):ks(r,p,w)},he=(r,p,d,f,m,j,J)=>{const b=r.component=Yi(r,f,m);if(Vs(r)&&(b.ctx.renderer=hs),Li(b),b.asyncDep){if(m&&m.registerDep(b,ae),!r.el){const w=b.subTree=ce(Je);L(null,w,p,d)}return}ae(b,r,p,d,m,j,J)},ks=(r,p,d)=>{const f=p.component=r.component;if(Qo(r,p,d))if(f.asyncDep&&!f.asyncResolved){X(f,p,d);return}else f.next=p,Vo(f.update),f.update();else p.el=r.el,f.vnode=p},ae=(r,p,d,f,m,j,J)=>{const b=()=>{if(r.isMounted){let{next:S,bu:_,u:k,parent:I,vnode:z}=r,H=S,R;Ke(r,!1),S?(S.el=z.el,X(r,S,J)):S=z,_&&mn(_),(R=S.props&&S.props.onVnodeBeforeUpdate)&&De(R,I,S,z),Ke(r,!0);const ee=zn(r),Te=r.subTree;r.subTree=ee,D(Te,ee,y(Te.el),rn(Te),r,m,j),S.el=ee.el,H===null&&ei(r,ee.el),k&&ue(k,m),(R=S.props&&S.props.onVnodeUpdated)&&ue(()=>De(R,I,S,z),m)}else{let S;const{el:_,props:k}=p,{bm:I,m:z,parent:H}=r,R=Ws(p);if(Ke(r,!1),I&&mn(I),!R&&(S=k&&k.onVnodeBeforeMount)&&De(S,H,p),Ke(r,!0),_&&it){const ee=()=>{r.subTree=zn(r),it(_,r.subTree,r,m,null)};R?p.type.__asyncLoader().then(()=>!r.isUnmounted&&ee()):ee()}else{const ee=r.subTree=zn(r);D(null,ee,d,f,r,m,j),p.el=ee.el}if(z&&ue(z,m),!R&&(S=k&&k.onVnodeMounted)){const ee=p;ue(()=>De(S,H,ee),m)}(p.shapeFlag&256||H&&Ws(H.vnode)&&H.vnode.shapeFlag&256)&&r.a&&ue(r.a,m),r.isMounted=!0,p=d=f=null}},w=r.effect=new wn(b,()=>qn(g),r.scope),g=r.update=()=>w.run();g.id=r.uid,Ke(r,!0),g()},X=(r,p,d)=>{p.component=r;const f=r.vnode.props;r.vnode=p,r.next=null,Ai(r,p.props,f,d),Ii(r,p.children,d),is(),Et(),rs()},F=(r,p,d,f,m,j,J,b,w=!1)=>{const g=r&&r.children,S=r?r.shapeFlag:0,_=p.children,{patchFlag:k,shapeFlag:I}=p;if(k>0){if(k&128){on(g,_,d,f,m,j,J,b,w);return}else if(k&256){ss(g,_,d,f,m,j,J,b,w);return}}I&8?(S&16&&Ee(g,m,j),_!==g&&h(d,_)):S&16?I&16?on(g,_,d,f,m,j,J,b,w):Ee(g,m,j,!0):(S&8&&h(d,""),I&16&&q(_,d,f,m,j,J,b,w))},ss=(r,p,d,f,m,j,J,b,w)=>{r=r||ts,p=p||ts;const g=r.length,S=p.length,_=Math.min(g,S);let k;for(k=0;k<_;k++){const I=p[k]=w?Ye(p[k]):Ae(p[k]);D(r[k],I,d,null,m,j,J,b,w)}g>S?Ee(r,m,j,!0,!1,_):q(p,d,f,m,j,J,b,w,_)},on=(r,p,d,f,m,j,J,b,w)=>{let g=0;const S=p.length;let _=r.length-1,k=S-1;for(;g<=_&&g<=k;){const I=r[g],z=p[g]=w?Ye(p[g]):Ae(p[g]);if(Ge(I,z))D(I,z,d,null,m,j,J,b,w);else break;g++}for(;g<=_&&g<=k;){const I=r[_],z=p[k]=w?Ye(p[k]):Ae(p[k]);if(Ge(I,z))D(I,z,d,null,m,j,J,b,w);else break;_--,k--}if(g>_){if(g<=k){const I=k+1,z=I<S?p[I].el:f;for(;g<=k;)D(null,p[g]=w?Ye(p[g]):Ae(p[g]),d,z,m,j,J,b,w),g++}}else if(g>k)for(;g<=_;)Oe(r[g],m,j,!0),g++;else{const I=g,z=g,H=new Map;for(g=z;g<=k;g++){const me=p[g]=w?Ye(p[g]):Ae(p[g]);me.key!=null&&H.set(me.key,g)}let R,ee=0;const Te=k-z+1;let ms=!1,La=0;const xs=new Array(Te);for(g=0;g<Te;g++)xs[g]=0;for(g=I;g<=_;g++){const me=r[g];if(ee>=Te){Oe(me,m,j,!0);continue}let qe;if(me.key!=null)qe=H.get(me.key);else for(R=z;R<=k;R++)if(xs[R-z]===0&&Ge(me,p[R])){qe=R;break}qe===void 0?Oe(me,m,j,!0):(xs[qe-z]=g+1,qe>=La?La=qe:ms=!0,D(me,p[qe],d,null,m,j,J,b,w),ee++)}const Wa=ms?zi(xs):ts;for(R=Wa.length-1,g=Te-1;g>=0;g--){const me=z+g,qe=p[me],Va=me+1<S?p[me+1].el:f;xs[g]===0?D(null,qe,d,Va,m,j,J,b,w):ms&&(R<0||g!==Wa[R]?ns(qe,d,Va,2):R--)}}},ns=(r,p,d,f,m=null)=>{const{el:j,type:J,transition:b,children:w,shapeFlag:g}=r;if(g&6){ns(r.component.subTree,p,d,f);return}if(g&128){r.suspense.move(p,d,f);return}if(g&64){J.move(r,p,d,hs);return}if(J===be){t(j,p,d);for(let _=0;_<w.length;_++)ns(w[_],p,d,f);t(r.anchor,p,d);return}if(J===Qs){V(r,p,d);return}if(f!==2&&g&1&&b)if(f===0)b.beforeEnter(j),t(j,p,d),ue(()=>b.enter(j),m);else{const{leave:_,delayLeave:k,afterLeave:I}=b,z=()=>t(j,p,d),H=()=>{_(j,()=>{z(),I&&I()})};k?k(j,z,H):H()}else t(j,p,d)},Oe=(r,p,d,f=!1,m=!1)=>{const{type:j,props:J,ref:b,children:w,dynamicChildren:g,shapeFlag:S,patchFlag:_,dirs:k}=r;if(b!=null&&$n(b,null,d,r,!0),S&256){p.ctx.deactivate(r);return}const I=S&1&&k,z=!Ws(r);let H;if(z&&(H=J&&J.onVnodeBeforeUnmount)&&De(H,p,r),S&6)pl(r.component,d,f);else{if(S&128){r.suspense.unmount(d,f);return}I&&$e(r,null,p,"beforeUnmount"),S&64?r.type.remove(r,p,d,m,hs,f):g&&(j!==be||_>0&&_&64)?Ee(g,p,d,!1,!0):(j===be&&_&384||!m&&S&16)&&Ee(w,p,d),f&&Ya(r)}(z&&(H=J&&J.onVnodeUnmounted)||I)&&ue(()=>{H&&De(H,p,r),I&&$e(r,null,p,"unmounted")},d)},Ya=r=>{const{type:p,el:d,anchor:f,transition:m}=r;if(p===be){cl(d,f);return}if(p===Qs){N(r);return}const j=()=>{a(d),m&&!m.persisted&&m.afterLeave&&m.afterLeave()};if(r.shapeFlag&1&&m&&!m.persisted){const{leave:J,delayLeave:b}=m,w=()=>J(d,j);b?b(r.el,j,w):w()}else j()},cl=(r,p)=>{let d;for(;r!==p;)d=v(r),a(r),r=d;a(p)},pl=(r,p,d)=>{const{bum:f,scope:m,update:j,subTree:J,um:b}=r;f&&mn(f),m.stop(),j&&(j.active=!1,Oe(J,r,p,d)),b&&ue(b,p),ue(()=>{r.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&r.asyncDep&&!r.asyncResolved&&r.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},Ee=(r,p,d,f=!1,m=!1,j=0)=>{for(let J=j;J<r.length;J++)Oe(r[J],p,d,f,m)},rn=r=>r.shapeFlag&6?rn(r.component.subTree):r.shapeFlag&128?r.suspense.next():v(r.anchor||r.el),Ua=(r,p,d)=>{r==null?p._vnode&&Oe(p._vnode,null,null,!0):D(p._vnode||null,r,p,null,null,null,d),Et(),Rt(),p._vnode=r},hs={p:D,um:Oe,m:ns,r:Ya,mt:he,mc:q,pc:F,pbc:Y,n:rn,o:e};let ot,it;return s&&([ot,it]=s(hs)),{render:Ua,hydrate:ot,createApp:Si(Ua,ot)}}function Ke({effect:e,update:s},n){e.allowRecurse=s.allowRecurse=n}function ja(e,s,n=!1){const t=e.children,a=s.children;if(A(t)&&A(a))for(let o=0;o<t.length;o++){const i=t[o];let l=a[o];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=a[o]=Ye(a[o]),l.el=i.el),n||ja(i,l)),l.type===Zs&&(l.el=i.el)}}function zi(e){const s=e.slice(),n=[0];let t,a,o,i,l;const c=e.length;for(t=0;t<c;t++){const u=e[t];if(u!==0){if(a=n[n.length-1],e[a]<u){s[t]=a,n.push(t);continue}for(o=0,i=n.length-1;o<i;)l=o+i>>1,e[n[l]]<u?o=l+1:i=l;u<e[n[o]]&&(o>0&&(s[t]=n[o-1]),n[o]=t)}}for(o=n.length,i=n[o-1];o-- >0;)n[o]=i,i=s[i];return n}const Ci=e=>e.__isTeleport,be=Symbol.for("v-fgt"),Zs=Symbol.for("v-txt"),Je=Symbol.for("v-cmt"),Qs=Symbol.for("v-stc"),Js=[];let _e=null;function de(e=!1){Js.push(_e=e?null:[])}function Pi(){Js.pop(),_e=Js[Js.length-1]||null}let _s=1;function va(e){_s+=e}function wa(e){return e.dynamicChildren=_s>0?_e||ts:null,Pi(),_s>0&&_e&&_e.push(e),e}function xe(e,s,n,t,a,o){return wa(se(e,s,n,t,a,o,!0))}function en(e,s,n,t,a){return wa(ce(e,s,n,t,a,!0))}function Kn(e){return e?e.__v_isVNode===!0:!1}function Ge(e,s){return e.type===s.type&&e.key===s.key}const sn="__vInternal",Ja=({key:e})=>e??null,nn=({ref:e,ref_key:s,ref_for:n})=>(typeof e=="number"&&(e=""+e),e!=null?Q(e)||re(e)||O(e)?{i:ge,r:e,k:s,f:!!n}:e:null);function se(e,s=null,n=null,t=0,a=null,o=e===be?0:1,i=!1,l=!1){const c={__v_isVNode:!0,__v_skip:!0,type:e,props:s,key:s&&Ja(s),ref:s&&nn(s),scopeId:Bt,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:o,patchFlag:t,dynamicProps:a,dynamicChildren:null,appContext:null,ctx:ge};return l?(Xn(c,n),o&128&&e.normalize(c)):n&&(c.shapeFlag|=Q(n)?8:16),_s>0&&!i&&_e&&(c.patchFlag>0||o&6)&&c.patchFlag!==32&&_e.push(c),c}const ce=Ei;function Ei(e,s=null,n=null,t=0,a=null,o=!1){if((!e||e===gi)&&(e=Je),Kn(e)){const l=Me(e,s,!0);return n&&Xn(l,n),_s>0&&!o&&_e&&(l.shapeFlag&6?_e[_e.indexOf(e)]=l:_e.push(l)),l.patchFlag|=-2,l}if(Gi(e)&&(e=e.__vccOpts),s){s=Ri(s);let{class:l,style:c}=s;l&&!Q(l)&&(s.class=fs(l)),B(c)&&(Ot(c)&&!A(c)&&(c=Z({},c)),s.style=gn(c))}const i=Q(e)?1:si(e)?128:Ci(e)?64:B(e)?4:O(e)?2:0;return se(e,s,n,t,a,i,o,!0)}function Ri(e){return e?Ot(e)||sn in e?Z({},e):e:null}function Me(e,s,n=!1){const{props:t,ref:a,patchFlag:o,children:i}=e,l=s?Hi(t||{},s):t;return{__v_isVNode:!0,__v_skip:!0,type:e.type,props:l,key:l&&Ja(l),ref:s&&s.ref?n&&a?A(a)?a.concat(nn(s)):[a,nn(s)]:nn(s):a,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:i,target:e.target,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:s&&e.type!==be?o===-1?16:o|16:o,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:e.transition,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Me(e.ssContent),ssFallback:e.ssFallback&&Me(e.ssFallback),el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce}}function tn(e=" ",s=0){return ce(Zs,null,e,s)}function Fi(e,s){const n=ce(Qs,null,e);return n.staticCount=s,n}function Gn(e="",s=!1){return s?(de(),en(Je,null,e)):ce(Je,null,e)}function Ae(e){return e==null||typeof e=="boolean"?ce(Je):A(e)?ce(be,null,e.slice()):typeof e=="object"?Ye(e):ce(Zs,null,String(e))}function Ye(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Me(e)}function Xn(e,s){let n=0;const{shapeFlag:t}=e;if(s==null)s=null;else if(A(s))n=16;else if(typeof s=="object")if(t&65){const a=s.default;a&&(a._c&&(a._d=!1),Xn(e,a()),a._c&&(a._d=!0));return}else{n=32;const a=s._;!a&&!(sn in s)?s._ctx=ge:a===3&&ge&&(ge.slots._===1?s._=1:(s._=2,e.patchFlag|=1024))}else O(s)?(s={default:s,_ctx:ge},n=32):(s=String(s),t&64?(n=16,s=[tn(s)]):n=8);e.children=s,e.shapeFlag|=n}function Hi(...e){const s={};for(let n=0;n<e.length;n++){const t=e[n];for(const a in t)if(a==="class")s.class!==t.class&&(s.class=fs([s.class,t.class]));else if(a==="style")s.style=gn([s.style,t.style]);else if(As(a)){const o=s[a],i=t[a];i&&o!==i&&!(A(o)&&o.includes(i))&&(s[a]=o?[].concat(o,i):i)}else a!==""&&(s[a]=t[a])}return s}function De(e,s,n,t=null){fe(e,s,7,[n,t])}const Bi=la();let Mi=0;function Yi(e,s,n){const t=e.type,a=(s?s.appContext:e.appContext)||Bi,o={uid:Mi++,vnode:e,type:t,parent:s,appContext:a,root:null,next:null,subTree:null,effect:null,update:null,scope:new ro(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:s?s.provides:Object.create(a.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:pa(t,a),emitsOptions:Ht(t,a),emit:null,emitted:null,propsDefaults:U,inheritAttrs:t.inheritAttrs,ctx:U,data:U,props:U,attrs:U,slots:U,refs:U,setupState:U,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return o.ctx={_:o},o.root=s?s.root:o,o.emit=Go.bind(null,o),e.ce&&e.ce(o),o}let ne=null;const Ui=()=>ne||ge;let Zn,us,_a="__VUE_INSTANCE_SETTERS__";(us=fn()[_a])||(us=fn()[_a]=[]),us.push(e=>ne=e),Zn=e=>{us.length>1?us.forEach(s=>s(e)):us[0](e)};const ds=e=>{Zn(e),e.scope.on()},Xe=()=>{ne&&ne.scope.off(),Zn(null)};function Ta(e){return e.vnode.shapeFlag&4}let Ts=!1;function Li(e,s=!1){Ts=s;const{props:n,children:t}=e.vnode,a=Ta(e);xi(e,n,a,s),Ni(e,t);const o=a?Wi(e,s):void 0;return Ts=!1,o}function Wi(e,s){const n=e.type;e.accessCache=Object.create(null),e.proxy=qt(new Proxy(e.ctx,bi));const{setup:t}=n;if(t){const a=e.setupContext=t.length>1?$i(e):null;ds(e),is();const o=Be(t,e,0,[e.props,a]);if(rs(),Xe(),lt(o)){if(o.then(Xe,Xe),s)return o.then(i=>{Sa(e,i,s)}).catch(i=>{Ms(i,e,0)});e.asyncDep=o}else Sa(e,o,s)}else xa(e,s)}function Sa(e,s,n){O(s)?e.type.__ssrInlineRender?e.ssrRender=s:e.render=s:B(s)&&(e.setupState=zt(s)),xa(e,n)}let ka;function xa(e,s,n){const t=e.type;if(!e.render){if(!s&&ka&&!t.render){const a=t.template||Un(e).template;if(a){const{isCustomElement:o,compilerOptions:i}=e.appContext.config,{delimiters:l,compilerOptions:c}=t,u=Z(Z({isCustomElement:o,delimiters:l},i),c);t.render=ka(a,u)}}e.render=t.render||je}ds(e),is(),ji(e),rs(),Xe()}function Vi(e){return e.attrsProxy||(e.attrsProxy=new Proxy(e.attrs,{get(s,n){return pe(e,"get","$attrs"),s[n]}}))}function $i(e){const s=n=>{e.exposed=n||{}};return{get attrs(){return Vi(e)},slots:e.slots,emit:e.emit,expose:s}}function Qn(e){if(e.exposed)return e.exposeProxy||(e.exposeProxy=new Proxy(zt(qt(e.exposed)),{get(s,n){if(n in s)return s[n];if(n in vs)return vs[n](e)},has(s,n){return n in s||n in vs}}))}function Ki(e,s=!0){return O(e)?e.displayName||e.name:e.name||s&&e.__name}function Gi(e){return O(e)&&"__vccOpts"in e}const Xi=(e,s)=>Yo(e,s,Ts);function Zi(e,s,n){const t=arguments.length;return t===2?B(s)&&!A(s)?Kn(s)?ce(e,null,[s]):ce(e,s):ce(e,null,s):(t>3?n=Array.prototype.slice.call(arguments,2):t===3&&Kn(n)&&(n=[n]),ce(e,s,n))}const Qi=Symbol.for("v-scx"),er=()=>Xs(Qi),sr="3.3.4",nr="http://www.w3.org/2000/svg",Ze=typeof document<"u"?document:null,Aa=Ze&&Ze.createElement("template"),tr={insert:(e,s,n)=>{s.insertBefore(e,n||null)},remove:e=>{const s=e.parentNode;s&&s.removeChild(e)},createElement:(e,s,n,t)=>{const a=s?Ze.createElementNS(nr,e):Ze.createElement(e,n?{is:n}:void 0);return e==="select"&&t&&t.multiple!=null&&a.setAttribute("multiple",t.multiple),a},createText:e=>Ze.createTextNode(e),createComment:e=>Ze.createComment(e),setText:(e,s)=>{e.nodeValue=s},setElementText:(e,s)=>{e.textContent=s},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Ze.querySelector(e),setScopeId(e,s){e.setAttribute(s,"")},insertStaticContent(e,s,n,t,a,o){const i=n?n.previousSibling:s.lastChild;if(a&&(a===o||a.nextSibling))for(;s.insertBefore(a.cloneNode(!0),n),!(a===o||!(a=a.nextSibling)););else{Aa.innerHTML=t?`<svg>${e}</svg>`:e;const l=Aa.content;if(t){const c=l.firstChild;for(;c.firstChild;)l.appendChild(c.firstChild);l.removeChild(c)}s.insertBefore(l,n)}return[i?i.nextSibling:s.firstChild,n?n.previousSibling:s.lastChild]}};function ar(e,s,n){const t=e._vtc;t&&(s=(s?[s,...t]:[...t]).join(" ")),s==null?e.removeAttribute("class"):n?e.setAttribute("class",s):e.className=s}function or(e,s,n){const t=e.style,a=Q(n);if(n&&!a){if(s&&!Q(s))for(const o in s)n[o]==null&&et(t,o,"");for(const o in n)et(t,o,n[o])}else{const o=t.display;a?s!==n&&(t.cssText=n):s&&e.removeAttribute("style"),"_vod"in e&&(t.display=o)}}const Da=/\s*!important$/;function et(e,s,n){if(A(n))n.forEach(t=>et(e,s,t));else if(n==null&&(n=""),s.startsWith("--"))e.setProperty(s,n);else{const t=ir(e,s);Da.test(n)?e.setProperty(os(t),n.replace(Da,""),"important"):e[t]=n}}const Na=["Webkit","Moz","ms"],st={};function ir(e,s){const n=st[s];if(n)return n;let t=Se(s);if(t!=="filter"&&t in e)return st[s]=t;t=Os(t);for(let a=0;a<Na.length;a++){const o=Na[a]+t;if(o in e)return st[s]=o}return s}const Ia="http://www.w3.org/1999/xlink";function rr(e,s,n,t,a){if(t&&s.startsWith("xlink:"))n==null?e.removeAttributeNS(Ia,s.slice(6,s.length)):e.setAttributeNS(Ia,s,n);else{const o=io(s);n==null||o&&!dt(n)?e.removeAttribute(s):e.setAttribute(s,o?"":n)}}function lr(e,s,n,t,a,o,i){if(s==="innerHTML"||s==="textContent"){t&&i(t,a,o),e[s]=n??"";return}const l=e.tagName;if(s==="value"&&l!=="PROGRESS"&&!l.includes("-")){e._value=n;const u=l==="OPTION"?e.getAttribute("value"):e.value,h=n??"";u!==h&&(e.value=h),n==null&&e.removeAttribute(s);return}let c=!1;if(n===""||n==null){const u=typeof e[s];u==="boolean"?n=dt(n):n==null&&u==="string"?(n="",c=!0):u==="number"&&(n=0,c=!0)}try{e[s]=n}catch{}c&&e.removeAttribute(s)}function cr(e,s,n,t){e.addEventListener(s,n,t)}function pr(e,s,n,t){e.removeEventListener(s,n,t)}function ur(e,s,n,t,a=null){const o=e._vei||(e._vei={}),i=o[s];if(t&&i)i.value=t;else{const[l,c]=dr(s);if(t){const u=o[s]=fr(t,a);cr(e,l,u,c)}else i&&(pr(e,l,i,c),o[s]=void 0)}}const Oa=/(?:Once|Passive|Capture)$/;function dr(e){let s;if(Oa.test(e)){s={};let t;for(;t=e.match(Oa);)e=e.slice(0,e.length-t[0].length),s[t[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):os(e.slice(2)),s]}let nt=0;const hr=Promise.resolve(),mr=()=>nt||(hr.then(()=>nt=0),nt=Date.now());function fr(e,s){const n=t=>{if(!t._vts)t._vts=Date.now();else if(t._vts<=n.attached)return;fe(gr(t,n.value),s,5,[t])};return n.value=e,n.attached=mr(),n}function gr(e,s){if(A(s)){const n=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{n.call(e),e._stopped=!0},s.map(t=>a=>!a._stopped&&t&&t(a))}else return s}const qa=/^on[a-z]/,yr=(e,s,n,t,a=!1,o,i,l,c)=>{s==="class"?ar(e,t,a):s==="style"?or(e,n,t):As(s)?cn(s)||ur(e,s,n,t,i):(s[0]==="."?(s=s.slice(1),!0):s[0]==="^"?(s=s.slice(1),!1):br(e,s,t,a))?lr(e,s,t,o,i,l,c):(s==="true-value"?e._trueValue=t:s==="false-value"&&(e._falseValue=t),rr(e,s,t,a))};function br(e,s,n,t){return t?!!(s==="innerHTML"||s==="textContent"||s in e&&qa.test(s)&&O(n)):s==="spellcheck"||s==="draggable"||s==="translate"||s==="form"||s==="list"&&e.tagName==="INPUT"||s==="type"&&e.tagName==="TEXTAREA"||qa.test(s)&&Q(n)?!1:s in e}const Ue="transition",Ss="animation",tt=(e,{slots:s})=>Zi(oi,jr(e),s);tt.displayName="Transition";const za={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};tt.props=Z({},Wt,za);const Qe=(e,s=[])=>{A(e)?e.forEach(n=>n(...s)):e&&e(...s)},Ca=e=>e?A(e)?e.some(s=>s.length>1):e.length>1:!1;function jr(e){const s={};for(const T in e)T in za||(s[T]=e[T]);if(e.css===!1)return s;const{name:n="v",type:t,duration:a,enterFromClass:o=`${n}-enter-from`,enterActiveClass:i=`${n}-enter-active`,enterToClass:l=`${n}-enter-to`,appearFromClass:c=o,appearActiveClass:u=i,appearToClass:h=l,leaveFromClass:y=`${n}-leave-from`,leaveActiveClass:v=`${n}-leave-active`,leaveToClass:x=`${n}-leave-to`}=e,P=vr(a),D=P&&P[0],M=P&&P[1],{onBeforeEnter:L,onEnter:W,onEnterCancelled:V,onLeave:N,onLeaveCancelled:te,onBeforeAppear:Ne=L,onAppear:Ie=W,onAppearCancelled:q=V}=s,G=(T,K,he)=>{es(T,K?h:l),es(T,K?u:i),he&&he()},Y=(T,K)=>{T._isLeaving=!1,es(T,y),es(T,x),es(T,v),K&&K()},ie=T=>(K,he)=>{const ks=T?Ie:W,ae=()=>G(K,T,he);Qe(ks,[K,ae]),Pa(()=>{es(K,T?c:o),Le(K,T?h:l),Ca(ks)||Ea(K,t,D,ae)})};return Z(s,{onBeforeEnter(T){Qe(L,[T]),Le(T,o),Le(T,i)},onBeforeAppear(T){Qe(Ne,[T]),Le(T,c),Le(T,u)},onEnter:ie(!1),onAppear:ie(!0),onLeave(T,K){T._isLeaving=!0;const he=()=>Y(T,K);Le(T,y),_r(),Le(T,v),Pa(()=>{T._isLeaving&&(es(T,y),Le(T,x),Ca(N)||Ea(T,t,M,he))}),Qe(N,[T,he])},onEnterCancelled(T){G(T,!1),Qe(V,[T])},onAppearCancelled(T){G(T,!0),Qe(q,[T])},onLeaveCancelled(T){Y(T),Qe(te,[T])}})}function vr(e){if(e==null)return null;if(B(e))return[at(e.enter),at(e.leave)];{const s=at(e);return[s,s]}}function at(e){return so(e)}function Le(e,s){s.split(/\s+/).forEach(n=>n&&e.classList.add(n)),(e._vtc||(e._vtc=new Set)).add(s)}function es(e,s){s.split(/\s+/).forEach(t=>t&&e.classList.remove(t));const{_vtc:n}=e;n&&(n.delete(s),n.size||(e._vtc=void 0))}function Pa(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let wr=0;function Ea(e,s,n,t){const a=e._endId=++wr,o=()=>{a===e._endId&&t()};if(n)return setTimeout(o,n);const{type:i,timeout:l,propCount:c}=Jr(e,s);if(!i)return t();const u=i+"end";let h=0;const y=()=>{e.removeEventListener(u,v),o()},v=x=>{x.target===e&&++h>=c&&y()};setTimeout(()=>{h<c&&y()},l+1),e.addEventListener(u,v)}function Jr(e,s){const n=window.getComputedStyle(e),t=P=>(n[P]||"").split(", "),a=t(`${Ue}Delay`),o=t(`${Ue}Duration`),i=Ra(a,o),l=t(`${Ss}Delay`),c=t(`${Ss}Duration`),u=Ra(l,c);let h=null,y=0,v=0;s===Ue?i>0&&(h=Ue,y=i,v=o.length):s===Ss?u>0&&(h=Ss,y=u,v=c.length):(y=Math.max(i,u),h=y>0?i>u?Ue:Ss:null,v=h?h===Ue?o.length:c.length:0);const x=h===Ue&&/\b(transform|all)(,|$)/.test(t(`${Ue}Property`).toString());return{type:h,timeout:y,propCount:v,hasTransform:x}}function Ra(e,s){for(;e.length<s.length;)e=e.concat(e);return Math.max(...s.map((n,t)=>Fa(n)+Fa(e[t])))}function Fa(e){return Number(e.slice(0,-1).replace(",","."))*1e3}function _r(){return document.body.offsetHeight}const Tr=["ctrl","shift","alt","meta"],Sr={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,s)=>Tr.some(n=>e[`${n}Key`]&&!s.includes(n))},kr=(e,s)=>(n,...t)=>{for(let a=0;a<s.length;a++){const o=Sr[s[a]];if(o&&o(n,s))return}return e(n,...t)},xr=Z({patchProp:yr},tr);let Ha;function Ar(){return Ha||(Ha=Oi(xr))}const Dr=(...e)=>{const s=Ar().createApp(...e),{mount:n}=s;return s.mount=t=>{const a=Nr(t);if(!a)return;const o=s._component;!O(o)&&!o.render&&!o.template&&(o.template=a.innerHTML),a.innerHTML="";const i=n(a,!1,a instanceof SVGElement);return a instanceof Element&&(a.removeAttribute("v-cloak"),a.setAttribute("data-v-app","")),i},s};function Nr(e){return Q(e)?document.querySelector(e):e}const an=(e,s)=>{const n=e.__vccOpts||e;for(const[t,a]of s)n[t]=a;return n},Ir=Fn({props:{report:{type:String,required:!0}},methods:{createIssue(){const e=new FormData(this.$refs.issueForm),s=e.get("title");let n="";const t=e.get("description");t&&(n+=`**Description**
${t}
...
`,options:[{id:"compiletime",page:34,label:"At compile time",summary:"The issue happens at compile time"},{id:"runtime",page:73,label:"At run time",summary:"The issue happens at run time"}]},{content:`<p>Please look at the <strong>first</strong> error in the compiler output, and tell me what it is...</p>
`,options:[{id:"requires-cpp-compiler",page:72,label:"ArduinoJson requires a C++ compiler...",summary:'Error says "ArduinoJson requires a C++ compiler..."'},{id:"assignment-of-read-only-location",page:36,label:"assignment of read-only location",summary:'Error says "assignment of read-only location"'},{id:"ambiguous-string-assign",page:35,label:"ambiguous overload for <code>operator=</code> (operand types are <code>String</code> and ...)",summary:'Error says "ambiguous overload for `operator=` (operand types are `String` and ...)"'},{id:"begin-not-found",page:50,label:"<code>begin</code>: no matching overloaded function found",summary:'Error says "`begin`: no matching overloaded function found"'},{id:"error-constants",page:70,label:"<code>bits/error_constants.h</code>: No such file or directory",summary:'Error says "`bits/error_constants.h`: No such file or directory'},{id:"print-ambiguous",page:71,label:"call of overloaded <code>print(...)</code> is ambiguous",summary:'Error says "call of overloaded `print(...)` is ambiguous"'},{id:"cannot-bind-object-ref",page:68,label:"cannot bind non-const lvalue reference of type <code>ArduinoJson::JsonObject&amp;</code> ...",summary:'Error says "cannot bind non-const lvalue reference of type `ArduinoJson::JsonObject&` ..."'},{id:"class-has-no-member-named-read",page:63,label:"<code>class Xxx</code> has no member named <code>read</code>",summary:'Error says "`class Xxx` has no member named `read`"'},{id:"pointer-to-object",page:67,label:"<code>const void*</code> is not a pointer-to-object type",summary:'Error says "`const void*` is not a pointer-to-object type"'},{id:"doesnt-name-a-type",page:43,label:"<code>doc</code> does not name a type",summary:'Error says "`doc` does not name a type"'},{id:"dynamicjsonbuffer",page:42,label:"<code>DynamicJsonBuffer</code> is a class from ArduinoJson 5",summary:'Error says "`DynamicJsonBuffer` is a class from ArduinoJson 5"'},{id:"dynamicjsondocument-not-declared",page:64,label:"<code>DynamicJsonDocument</code> was not declared in this scope",summary:'Error says "`DynamicJsonDocument` was not declared in this scope"'},{id:"expected-identifier-before-string-constant",page:45,label:"expected identifier before string constant",summary:'Error says "expected identifier before string constant"'},{id:"char-pointer-conversion",page:39,label:"invalid conversion from <code>const char*</code> to <code>char*</code> [-fpermissive]",summary:'Error says "invalid conversion from `const char*` to `char*` [-fpermissive]"'},{id:"invalid-conversion",page:49,label:"invalid use of incomplete type <code>class InvalidConversion&lt;...&gt;</code>",summary:'Error says "invalid use of incomplete type `class InvalidConversion<...>`"'},{id:"jsondocument-copy",page:51,label:"<code>JsonDocument::JsonDocument(const JsonDocument&amp;)</code> is private",summary:'Error says "`JsonDocument::JsonDocument(const JsonDocument&)` is private"'},{id:"jsondocument-constructor",page:52,label:"<code>JsonDocument::JsonDocument()</code> is protected within this context",summary:'Error says "`JsonDocument::JsonDocument()` is protected within this context"'},{id:"macro-min",page:53,label:"macro <code>min</code> passed 3 arguments, but takes just 2",summary:'Error says "macro `min` passed 3 arguments, but takes just 2"'},{id:"basicjsondocument-default-constructor",page:37,label:"no default constructor exists for class <code>BasicJsonDocument</code>",summary:'Error says "no default constructor exists for class `BasicJsonDocument`"'},{id:"no-matching-function",page:55,label:"no matching function for call to ...",summary:'Error says "no matching function for call to ..."'},{id:"passing-volatile-as-this-argument-discards-qualifiers",page:69,label:"passing <code>volatile ...</code> as <code>this</code> argument discards qualifiers [-fpermissive]",summary:'Error says "passing `volatile ...` as `this` argument discards qualifiers [-fpermissive]"'},{id:"cast-void-to-flashstringhelper",page:38,label:"reinterpret_cast from <code>const void</code> to <code>const __FlashStringHelper *</code> is not allowed",summary:'Error says "reinterpret_cast from `const void` to `const __FlashStringHelper *` is not allowed"'},{id:"member-write-in-char-ptr",page:54,label:"request for member <code>write</code> in ..., which is of non-class type <code>char*</code>",summary:'Error says "request for member `write` in ..., which is of non-class type `char*`"'},{id:"staticjsonbuffer",page:42,label:"<code>StaticJsonBuffer</code> is a class from ArduinoJson 5",summary:'Error says "`StaticJsonBuffer` is a class from ArduinoJson 5"'},{id:"staticjsondocument-not-declared",page:64,label:"<code>StaticJsonDocument</code> was not declared in this scope",summary:'Error says "`StaticJsonDocument` was not declared in this scope"'},{id:"struct-has-no-member-named-read",page:63,label:"<code>struct Xxx</code> has no member named <code>read</code>",summary:'Error says "`struct Xxx` has no member named `read`"'},{id:"range-based-for-requires-begin",page:50,label:"this range-based <code>for</code> statement requires a suitable &quot;begin&quot; function and none was found",summary:'Error says "this range-based `for` statement requires a suitable "begin" function and none was found"'},{id:"not-in-list",page:3,label:"None of the above",summary:"The error is not in the list"}]},{content:`<p>This error occurs when you try to assign a <a href="/v6/api/jsonvariant/"><code>JsonVariant</code></a> to a <a href="https://www.arduino.cc/reference/en/language/variables/data-types/stringobject/"><code>String</code></a>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Moving statement to `setup()` fixes the issue"},{id:"failure",page:1,label:"No",summary:"Moving statement to `setup()` doesn't fix the issue"}]},{content:`<p>This a known bug in the RAK RUI core for Arduino.
...
`,options:[{id:"array",page:46,label:"<code>class InvalidConversion&lt;VariantConstRef, ArrayRef&gt;</code>",summary:"Specialization is `InvalidConversion<VariantConstRef, ArrayRef>`"},{id:"object",page:47,label:"<code>class InvalidConversion&lt;VariantConstRef, ObjectRef&gt;</code>",summary:"Specialization is `InvalidConversion<VariantConstRef, ObjectRef>`"},{id:"variant",page:48,label:"<code>class InvalidConversion&lt;VariantConstRef, VariantRef&gt;</code>",summary:"Specialization is `InvalidConversion<VariantConstRef, VariantRef>`"}]},{content:`<p>You get this error when you try to iterate over a <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> or a <a href="/v6/api/jsonvariant/"><code>JsonVariant</code></a>.</p>
...
`,options:[{id:"basicjsondocument",page:58,label:"no matching function for call to <code>BasicJsonDocument::BasicJsonDocument()</code>",summary:'Error says "no matching function for call to `BasicJsonDocument::BasicJsonDocument()`"'},{id:"converttojson",page:59,label:"no matching function for call to <code>convertToJson(...)</code>",summary:'Error says "no matching function for call to `convertToJson(...)`"'},{id:"deserializejson",page:60,label:"no matching function for call to <code>deserializeJson(StaticJsonDocument&lt;200&gt; (&amp;)(), ...)</code>",summary:'Error says "no matching function for call to `deserializeJson(StaticJsonDocument<200> (&)(), ...)`"'},{id:"unresolved-overloaded-function-type",page:62,label:"no matching function for call to <code>...(&lt;unresolved overloaded function type&gt;)</code>",summary:'Error says "no matching function for call to `...(<unresolved overloaded function type>)`"'},{id:"as-char",page:57,label:"no matching function for call to <code>...as&lt;char&gt;() const</code>",summary:'Error says "no matching function for call to `...as<char>()` const"'},{id:"as-char-ptr",page:56,label:"no matching function for call to <code>...as&lt;char*&gt;() const</code>",summary:'Error says "no matching function for call to `...as<char*>()` const"'},{id:"is-char-ptr",page:61,label:"no matching function for call to <code>...is&lt;char*&gt;() const</code>",summary:'Error says "no matching function for call to `...is<char*>()` const"'},{id:"not-in-list",page:3,label:"None of the above",summary:"The error is not in the list"}]},{content:`<p>This error happens when you write the following:</p>
...
`,options:[{id:"arduinojson-h",page:1,label:"<code>ArduinoJson.h</code>",summary:"The file includes `ArduinoJson.h`"},{id:"arduinojson-hpp",page:65,label:"<code>ArduinoJson.hpp</code>",summary:"The file includes `ArduinoJson.hpp`"},{id:"none",page:66,label:"None of the above",summary:"The file includes neither `ArduinoJson.h` nor  `ArduinoJson.hpp`"}]},{content:`<p>Unlike <code>ArduinoJson.h</code>, <code>ArduinoJson.hpp</code> keeps everything in the <code>ArduinoJson</code> namespace.</p>
...
`,options:[{id:"serialization",page:201,label:"Serialization",summary:"The issue concerns serialization"},{id:"deserialization",page:74,label:"Deserialization",summary:"The issue concerns deserialization"}]},{content:`<p>What is the value of <a href="/v6/api/misc/deserializationerror/"><code>DeserializationError</code></a>?</p>
`,options:[{id:"ok",page:153,label:"<code>Ok</code>",summary:"`deserializeJson()` returns `Ok`"},{id:"emptyinput",page:89,label:"<code>EmptyInput</code>",summary:"`deserializeJson()` returns `EmptyInput`"},{id:"incompleteinput",page:104,label:"<code>IncompleteInput</code>",summary:"`deserializeJson()` returns `IncompleteInput`"},{id:"invalidinput",page:111,label:"<code>InvalidInput</code>",summary:"`deserializeJson()` returns `InvalidInput`"},{id:"nomemory",page:186,label:"<code>NoMemory</code>",summary:"`deserializeJson()` returns `NoMemory`"},{id:"notsupported",page:194,label:"<code>NotSupported</code>",summary:"`deserializeJson()` returns `NotSupported`"},{id:"toodeep",page:199,label:"<code>TooDeep</code>",summary:"`deserializeJson()` returns `TooDeep`"},{id:"crash",page:76,label:"I can't tell because the program crashes",summary:"The program crashes"},{id:"unknown",page:75,label:"I don't know what you're talking about",summary:"The program doesn't check the error"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/"><code>DeserializationError</code></a> is the return type of <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>. It tells whether the operation succeeded and indicates the cause of the error.</p>
...
`,options:[{id:"before",page:82,label:"None: program crashes before calling <code>deserializeJson()</code>",summary:"Program crashes before calling `deserializeJson()`"},{id:"inside",page:84,label:"Only one: program crashes inside <code>deserializeJson()</code>",summary:"Program crashes inside `deserializeJson()`"},{id:"after",page:77,label:"Two traces: program crashes after calling <code>deserializeJson()</code>",summary:"Program crashes after calling `deserializeJson()`"}]},{content:`<p>Most of the time, when a program crashes after <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, it's because it dereferences a null pointer returned by the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>.</p>
...
`,options:[{id:"strcmp",page:80,label:"Yes, there is a call to <code>strcmp()</code>",summary:"Program calls `strcmp()`"},{id:"strcpy",page:81,label:"Yes, there is a call to <code>strcpy()</code>",summary:"Program calls `strcpy()`"},{id:"printf",page:79,label:"Yes, there is a call to <code>printf()</code>, <code>sprintf()</code>, or <code>snprintf()</code>",summary:"Program calls `printf()`, `sprintf()`, or `snprintf()`"},{id:"success",page:2,label:"Yes, I found the issue",summary:"Program dereferences a null pointer"},{id:"no-usual-suspect",page:78,label:"No",summary:"Program calls neither `strcmp()`, nor `strcpy()`, not `printf()`"}]},{content:`<p>A programs can also crash after calling <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> because it keeps a pointer to a string stored in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>.</p>
...
`,options:[{id:"static",page:88,label:"Yes",summary:"Program uses `StaticJsonDocument`"},{id:"no-static",page:83,label:"No",summary:"Program doesn't use `StaticJsonDocument`"}]},{content:`<p>I still think this could be a stack-overflow.</p>
...
`,options:[{id:"success",page:2,label:"Yes",summary:"Switching to `DynamicJsonDocument` prevents the crash"},{id:"nomemory",page:87,label:"Yes, but now <code>deserializeJson()</code> returns <code>NoMemory</code>",summary:"Switching to `DynamicJsonDocument` produces `NoMemory`"},{id:"dynamicjsondocument-too",page:83,label:"No",summary:"Switching to `DynamicJsonDocument` doesn't prevent the crash"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#emptyinput"><code>EmptyInput</code></a> means that the input was empty or contained only spaces or comments.</p>
<p>Where does your JSON input come from?</p>
`,options:[{id:"http",page:96,label:"An HTTP response",summary:"Input comes from an HTTP response"},{id:"file",page:90,label:"A file",summary:"Input comes from a file"},{id:"serial",page:103,label:"A serial port",summary:"Input comes from a serial port"},{id:"other",page:101,label:"Something else",summary:"Input comes neither from an HTTP response, nor a file, nor a serial port"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#emptyinput"><code>EmptyInput</code></a> in the context of a file usually means:</p>
<ul>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Following the redirection fixes the issue"},{id:"follow",page:97,label:"No",summary:"Following the redirection doesn't fix the issue"}]},{content:`<p>A negative number indicates an error on the client side.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"certificate-problem",page:93,label:"Yes",summary:"Calling `WiFiClientSecure::setInsecure()` solves the issue."},{id:"certificate-ok",page:92,label:"No",summary:"Calling `WiFiClientSecure::setInsecure()` doesn't solve the issue."}]},{content:`<p>Please check the HTTP status</p>
<p>For example, if you use <code>HTTPClient</code>, what value is returned by <code>http.GET()</code>?</p>
`,options:[{id:"redirect",page:94,label:"<code>300</code> to <code>399</code>",summary:"The status code indicates a redirection"},{id:"negative",page:95,label:"A negative number",summary:"The status code is negative"},{id:"status-ok",page:97,label:"None of the above",summary:"The status code is not in the list"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#emptyinput"><code>EmptyInput</code></a> could be caused by a timeout while reading the response.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Increasing the timeout fixes the issue"},{id:"timeout-increased",page:91,label:"No",summary:"Increasing the timeout doesn't fix the issue"}]},{content:`<p>This confirms that the problem comes from the input: it is indeed empty, or at least starts with a NUL character.</p>
...
<p>What do you see?</p>
`,options:[{id:"zero",page:98,label:"<code>0</code>",summary:"The first character is NUL"},{id:"non-zero",page:1,label:"Something else",summary:"The first character is not NUL"}]},{content:`<p>Please print the ASCII code for the first character, like so:</p>
...
<p>What do you see?</p>
`,options:[{id:"zero",page:98,label:"<code>0</code>",summary:"The first character is NUL"},{id:"non-zero",page:1,label:"Something else",summary:"The first character is not NUL"}]},{content:`<p>The input is probably starting with a NUL character.</p>
<p>What type of input are you passing to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>?</p>
`,options:[{id:"string",page:100,label:"A string (<code>const char*</code>, <code>String</code>, <code>std::string</code>...)",summary:"Input type is a string"},{id:"stream",page:99,label:"A stream (<code>Serial</code>, <code>WiFiClient</code>, <code>File</code>...)",summary:"Input type is a stream"}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> also returns <a href="/v6/api/misc/deserializationerror/#emptyinput"><code>EmptyInput</code></a> when the input contains only spaces.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Adding a wait loop fixes the issue"},{id:"available",page:102,label:"No",summary:"Adding a wait loop doesn't fix the issue"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#incompleteinput"><code>IncompleteInput</code></a> means that <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> managed to parse the beginning of the JSON document, but the end was missing.</p>
<p>What type of input do you pass to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>?</p>
`,options:[{id:"stream",page:107,label:"A stream",summary:"Input comes from a stream"},{id:"string",page:108,label:"A string object (like <code>String</code>)",summary:"Input comes from a string object"},{id:"pointer",page:109,label:"A pointer (like <code>char*</code> or <code>const char*</code>)",summary:"Input comes from a pointer"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#incompleteinput"><code>IncompleteInput</code></a> can be caused by an interruped connection. For example, this problem happens when the client reads to slowly.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Adding a buffer solves the issue"},{id:"same-with-buffer",page:106,label:"No",summary:"Adding a buffer doesn't solve the issue"}]},{content:`<p>Maybe seeing where the input stops will give you an idea of what's going wrong.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Inreasing the timeout solves the issue"},{id:"timeout-increased",page:105,label:"No",summary:"Inreasing the timeout doesn't solve the issue"}]},{content:`<p>Please print the content of the string to the serial port, like so:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:2,label:"Yes",summary:"Calling `String::reserve()` solves the issue"},{id:"1",page:110,label:"No",summary:"Calling `String::reserve()` doesn't solve the issue"}]},{content:`<p>I'll assume that your input is stored in a buffer similar to this one:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:2,label:"Yes",summary:"Increasing the buffer size solves the issue"},{id:"1",page:110,label:"No",summary:"Increasing the buffer size doesn't solve the issue"}]},{content:`<p>To reduce the memory usage, you should try to pass the source (file, connection, stream, etc) directly to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, either via the <a href="https://www.arduino.cc/reference/en/language/functions/communication/stream/"><code>Stream</code></a> interface or via a <a href="/news/2019/11/01/version-6-13-0/">custom reader</a>. This will avoid the need for an intermediate buffer.</p>
...
`,options:[{id:"http",page:120,label:"An HTTP response",summary:"Input comes from HTTP"},{id:"serial",page:147,label:"A serial port",summary:"Input comes from a serial port"},{id:"file",page:119,label:"A file",summary:"Input comes from a file"},{id:"stream",page:150,label:"A stream",summary:"Input comes from a stream"},{id:"string",page:152,label:"A string (like <code>String</code> or <code>const char*</code>)",summary:"Input comes from a string"},{id:"char-ptr",page:114,label:"A char array or pointer (like <code>char[]</code> or <code>char*</code>)",summary:"Input comes from a char array"}]},{content:`<p>If you must keep the two calls to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, you need to disable the zero-copy mode by passing a read-only input buffer. Casting the pointer will do the trick:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// replace this:</span>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Casting the pointer fixes the issue"},{id:"cast",page:152,label:"No",summary:"Casting the pointer doesn't fix the issue"}]},{content:`<p>When you pass a writeable buffer as the input of <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, ArduinoJson uses the zero-copy mode. Instead of copying the strings from the input into the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, it stores pointers to the input buffer.</p>
...
`,options:[{id:"success",page:2,label:"Yes, and it fixes the issue",summary:"Removing the second call fixes the issue"},{id:"second-removed",page:152,label:"Yes, but it doesn't fix the issue",summary:"Removing the second call doesn't fix the issue"},{id:"cannot-remove",page:112,label:"No",summary:"The second call cannot be removed"}]},{content:`<p>Did you call <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> twice with the same input buffer?</p>
`,options:[{id:"two-calls",page:113,label:"Yes",summary:"Program calls `deserializeJson()` twice"},{id:"one-call",page:152,label:"No",summary:"Program doesn't call `deserializeJson()` twice"}]},{content:`<p>So, the JSON document is valid and not preceded by anything; yet, <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> returns <a href="/v6/api/misc/deserializationerror/#invalidinput"><code>InvalidInput</code></a>.</p>
...
`,options:[{id:"utf8",page:117,label:"<code>239</code>",summary:"Input's first byte suggests a UTF-8 BOM"},{id:"utf16",page:116,label:"<code>254</code> or <code>255</code>",summary:"Input's first byte suggests a UTF-16 BOM"},{id:"no-bom",page:115,label:"Something else",summary:"Input's first byte doesn't suggest a BOM"}]},{content:`<p>We need to make sure that the JSON document is valid.
...
`,options:[{id:"valid",page:118,label:"Yes",summary:"`jsonlint` says the document is valid"},{id:"invalid",page:136,label:"No",summary:"`jsonlint` says the document is invalid"}]},{content:`<p>Do you use an HTTP library?</p>
`,options:[{id:"httpclient",page:121,label:"Yes, I'm using <code>HTTPClient</code>",summary:"Program uses `HTTPClient`"},{id:"http-library",page:134,label:"Yes, but it's not <code>HTTPClient</code>",summary:"Program uses an unknown HTTP library"},{id:"no-library",page:130,label:"No",summary:"Program doesn't use an HTTP library"}]},{content:`<p>Did you check the status code?</p>
`,options:[{id:"status-ok",page:123,label:"Yes",summary:"The program already checks the status code"},{id:"check-status",page:122,label:"No",summary:"The program doesn't check the status code"}]},{content:`<p>Please check the status code like so:</p>
...
<p>What do you get?</p>
`,options:[{id:"ok",page:123,label:"<code>200</code>",summary:"The status code is `200`"},{id:"positive",page:126,label:"A positive number (but not <code>200</code>)",summary:"The status code is positive"},{id:"negative",page:125,label:"A negative number",summary:"The status code is negative"}]},{content:`<p>Which function of <code>HTTPClient</code> do you call to get the response?</p>
`,options:[{id:"getstream",page:129,label:"<code>getStream()</code>",summary:"Response comes from `HTTPClient::getStream()`"},{id:"getstring",page:152,label:"<code>getString()</code>",summary:"Response comes from `HTTPClient::getString()`"},{id:"readstring",page:124,label:"<code>readString()</code>",summary:"Response comes from `HTTPClient::readString()`"}]},{content:`<p>You're calling the wrong function:</p>
<ul>
...
`,options:[{id:"success",page:2,label:"Yes",summary:"Calling `HTTPClient::getString()` solves the issue"},{id:"getstring",page:152,label:"No",summary:"Calling `HTTPClient::getString()` doesn't solves the issue"}]},{content:`<p>A negative number indicates an error on the client side.</p>
<p>Here are the possible values that I'm aware of:</p>
<table class="table">
<thead>
<tr>
...
<p>Did this solve your problem?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Calling `HTTPClient::useHTTP10(true)` solves the issue"},{id:"changed",page:128,label:"No",summary:"Calling `HTTPClient::useHTTP10(true)` doesn't solve the issue"}]},{content:`<p>We need to make sure that the JSON document is valid.
...
<p>Is the JSON document valid?</p>
`,options:[{id:"valid",page:148,label:"Yes",summary:"jsonlint says the document is valid"},{id:"invalid",page:136,label:"No",summary:"jsonlint says the document is invalid"}]},{content:`<p>Did you call <code>HTTPClient::useHTTP10(true)</code>?</p>
`,options:[{id:"http10-true",page:128,label:"Yes",summary:"Program calls `HTTPClient::useHTTP10(true)`"},{id:"http10-false",page:127,label:"No",summary:"Program doesn't call `HTTPClient::useHTTP10(true)`"}]},{content:`<p>Before calling <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, did you skip the HTTP headers?</p>
`,options:[{id:"headers-skipped",page:133,label:"Yes",summary:"HTTP headers are skipped"},{id:"headers-not-skipped",page:132,label:"No",summary:"HTTP headers are not skipped"}]},{content:`<p>On some Arduino core (most notably <a href="https://github.com/arduino/ArduinoCore-avr/blob/master/cores/arduino/Stream.h">AVR core</a>), <a href="https://www.arduino.cc/reference/en/language/functions/communication/stream/streamfind/"><code>Stream::find()</code></a> takes a <code>char*</code> instead of a <code>const char*</code>. In this case, you'll get a compiler warning, which you can fix by extracting a char array, like so:</p>
...
<p>Did this fix your problem?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Skipping HTTP headers solves the issue"},{id:"warning",page:131,label:"Yes, but there is a compiler warning about <code>client.find()</code>",summary:"Skipping HTTP headers solves the issue, but there is a warning"},{id:"header-skipped",page:133,label:"No",summary:"Skipping HTTP headers doesn't solve the issue"}]},{content:`<p>When you use HTTP 1.1, the server can send the response with <a href="https://en.wikipedia.org/wiki/Chunked_transfer_encoding">Chunked Transfer Encoding</a>.
As a result, the response's body may contain some hexadecimal number at the begining of each chunk.
The most straightforward workaround is to downgrade the connection to HTTP 1.0.</p>
<p>To do this, replace <code>HTTP/1.1</code> with <code>HTTP/1.0</code> in the first line of the request.</p>
<p>Did this solve your problem?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Using `HTTP/1.0` solves the issue"},{id:"http10",page:135,label:"No",summary:"Using `HTTP/1.0` doesn't solve the issue"}]},{content:`<p>Unfortunately, I only know how to use the following HTTP libraries:</p>
<ul>
...
`,options:[{id:"stream",page:148,label:"A stream",summary:"The input is a stream"},{id:"string",page:151,label:"A string",summary:"The input is a string"}]},{content:`<p>What is wrong with this JSON document?</p>
`,options:[{id:"comments",page:137,label:"It contains comments",summary:"The document contains comments"},{id:"other-error",page:138,label:"Something else",summary:"The document doesn't contain comments"}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> can read JSON documents that contain comments, but the support is disabled by default to reduce the footprint of the library.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Increasing serial buffer size solves the issue"},{id:"larger-buffer",page:148,label:"No",summary:"Increasing serial buffer size doesn't solves the issue"}]},{content:`<p>Any electric wire acts as an antenna; the longer the wire, the stronger the effect. This antenna picks up every electromagnetic field in the environment, which induces a current in the wire. On long wires, this current is strong enough to introduce errors in the communication.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Upgrading the cables solves the issue"},{id:"improved",page:142,label:"Somehow",summary:"Upgrading the cables improves the situation"},{id:"no-improvment",page:143,label:"No",summary:"Upgrading the cables doesn't solve the issue"}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> may return <a href="/v6/api/misc/deserializationerror/#invalidinput"><code>InvalidInput</code></a> because it starts reading the input mid-stream.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Flushing the serial buffer fixes the issue"},{id:"flush",page:146,label:"No",summary:"Flushing the serial buffer doesn't fix the issue"}]},{content:`<p><a href="https://en.wikipedia.org/wiki/Error_correction_code">Error-correction codes (ECC)</a> are a way of transmitting the data with redundant information that allows the receiver to fix most of the errors.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Error-correction codes fix the issue"},{id:"ecc",page:143,label:"No",summary:"Error-correction codes doesn't fix the issue"}]},{content:`<p>We need to make sure that the JSON document is valid.
To do that, please print the input to the serial port, like so:</p>
...
<p>Then, copy the response and paste it in a JSON linter, like <a href="https://jsonlint.com/">jsonlint.com</a>.</p>
<p>Is the JSON document valid?</p>
`,options:[{id:"valid",page:139,label:"Yes",summary:"`jsonlint` says the document is valid"},{id:"invalid",page:136,label:"No",summary:"`jsonlint` says the document is invalid"}]},{content:`<p>Any kind of communication is subject to errors: sometimes you send a <code>1</code> and receive a <code>0</code>.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Removing `SoftwareSerial` solves the issue"},{id:"removed",page:146,label:"No",summary:"Removing `SoftwareSerial` doesn't solve the issue"}]},{content:`<p>Not all microcontrollers use the same voltage for the serial port.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"The issue is a voltage mismatch"},{id:"voltage-ok",page:144,label:"No",summary:"The issue is not a voltage mismatch"}]},{content:`<p>Are you using <a href="https://www.arduino.cc/en/Reference/SoftwareSerial"><code>SoftwareSerial</code></a>?</p>
`,options:[{id:"software",page:145,label:"Yes",summary:"Program uses `SoftwareSerial`"},{id:"hardware",page:141,label:"No",summary:"Program doesn't use `SoftwareSerial`"}]},{content:`<p>We must check that the JSON document is not preceded by a  <a href="https://en.wikipedia.org/wiki/Byte_order_mark">Byte Order Mark</a> (BOM).</p>
...
<p>What value does it print?</p>
`,options:[{id:"utf8",page:117,label:"<code>239</code>",summary:"Input's first byte suggests a UTF-8 BOM"},{id:"utf16",page:116,label:"<code>254</code> or <code>255</code>",summary:"Input's first byte suggests a UTF-16 BOM"},{id:"no-bom",page:115,label:"Something else",summary:"Input's first byte doesn't suggest a BOM"}]},{content:`<p>Sometimes, the input is invalid because some bytes were dropped when receiving the document.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Adding a buffer solves the issue"},{id:"buffer",page:148,label:"No",summary:"Adding a buffer doesn't solve the issue"}]},{content:`<p>We need to make sure that the JSON document is valid.
To do that, please print the input to the serial port, like so:</p>
...
<p>Then, copy the response and paste it in a JSON linter, like <a href="https://jsonlint.com/">jsonlint.com</a>.</p>
<p>Is the JSON document valid?</p>
`,options:[{id:"valid",page:149,label:"Yes",summary:"`jsonlint` says the document is valid"},{id:"invalid",page:136,label:"No",summary:"`jsonlint` says the document is invalid"}]},{content:`<p>We must check that the JSON document is not preceded by a  <a href="https://en.wikipedia.org/wiki/Byte_order_mark">Byte Order Mark</a> (BOM).</p>
...
<p>Then, copy the response and paste it in a JSON linter, like <a href="https://jsonlint.com/">jsonlint.com</a>.</p>
<p>Is the JSON document valid?</p>
`,options:[{id:"valid",page:151,label:"Yes",summary:"`jsonlint` says the document is valid"},{id:"invalid",page:136,label:"No",summary:"`jsonlint` says the document is invalid"}]},{content:`<p>So, what's the problem then?</p>
`,options:[{id:"slow",page:177,label:"It's slow",summary:"Deserialisation is slow"},{id:"invalid",page:154,label:"I expected <code>InvalidInput</code> instead of <code>Ok</code>",summary:"`Ok` is incorrect; it should be `InvalidInput`"},{id:"crash",page:77,label:"My program crashes after calling <code>deserializeJson()</code>",summary:"Program crashes after calling `deserializeJson()`"},{id:"empty",page:166,label:"<code>JsonDocument</code> returns empty/null values",summary:"Program fails to extract values from the `JsonDocument`"},{id:"garbage",page:158,label:"<code>JsonDocument</code> returns garbage",summary:"`JsonDocument` returns garbage"},{id:"changing-strings",page:158,label:"The strings in the <code>JsonDocument</code> change for no reason",summary:"The strings in the `JsonDocument` change for no reason"},{id:"altered",page:162,label:"<code>deserializeJson()</code> alters the content of the input",summary:"Input buffer is modified"},{id:"truncated-strings",page:178,label:"Some strings are truncated",summary:"Some strings are truncated"}]},{content:`<p>What's the first character of your input?</p>
`,options:[{id:"brace",page:155,label:"An opening brace: <code>{</code>",summary:"The first character is `{`"},{id:"bracket",page:156,label:"An opening bracket: <code>[</code>",summary:"The first character is `[`"},{id:"quote",page:157,label:"A quote: <code>&quot;</code>",summary:'The first character is `"`'},{id:"other",page:185,label:"None of the above",summary:'The first character is neither `{`, nor `[`, nor `"`'}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> stops reading as soon as the JSON document ends.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Garbage characters follow the input"},{id:"lint",page:165,label:"No",summary:"No garbage characters follow the input"}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> stops reading as soon as the JSON document ends.
In your case, it will read the input until it reaches the matching <code>]</code> and ignore any remaining characters.</p>
<p>Suppose the input looks like this:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Garbage characters follow the input"},{id:"lint",page:165,label:"No",summary:"No garbage characters follow the input"}]},{content:`<p>What is the type of the second argument passed to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>?</p>
`,options:[{id:"char-ptr",page:161,label:"<code>char*</code> (or <code>char[]</code>)",summary:"Input type is `char*`"},{id:"const-char-ptr",page:1,label:"<code>const char*</code>",summary:"Input type is `const char*`"},{id:"string",page:1,label:"<code>String</code> (or <code>std::string</code>)",summary:"Input type is `String`"},{id:"stream",page:1,label:"<code>Stream</code> (or <code>std::istream)</code>",summary:"Input type is `Stream`"}]},{content:`<p>The easiest solution is to disable the zero-copy mode by passing a read-only input buffer. Casting the pointer will do the trick:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// replace this:</span>
<span class="hljs-built_in">deserializeJson</span>(doc, input, inputSize);
...
`,options:[{id:"success",page:160,label:"Yes, the input comes from a stream",summary:"Input comes from a stream"},{id:"cast",page:159,label:"No, it doesn't",summary:"Input doesn't come from a stream"}]},{content:`<p>When you pass a writeable buffer as the input of <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, ArduinoJson uses the zero-copy mode. Instead of copying the strings from the input into the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, it stores pointers to the input buffer.</p>
<p>While doing this, the parser modifies the input buffer to unescape special characters and add string terminator.
...
<p>Did this solve your issue?</p>
`,options:[{id:"acceptable",page:2,label:"Yes",summary:"`deserializeJson()` tolerates the error, and that's OK"},{id:"unacceptable",page:185,label:"No",summary:"`deserializeJson()` should not let this error pass"}]},{content:`<p>So, <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> returns <code>Ok</code>, and jsonlint confirms that the input is valid.</p>
...
`,options:[{id:"valid",page:164,label:"Document is valid",summary:"jsonlint says the document is valid"},{id:"invalid",page:163,label:"Document is invalid",summary:"jsonlint says the document is invalid"}]},{content:`<p>Do you use a filter (with <code>DeserializationOption::Filter</code>)?</p>
`,options:[{id:"filter",page:169,label:"Yes",summary:"Program uses `DeserializationOption::Filter`"},{id:"no-filter",page:173,label:"No",summary:"Program doesn't use `DeserializationOption::Filter`"}]},{content:`<p>When a program fails to extract the values from a <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, it's often because there is a confusion between arrays and objects.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Fixing the filter solves the issue"},{id:"filter-ok",page:173,label:"No",summary:"Fixing the filter doesn't solve the issue"}]},{content:`<p>Please print the filter to the serial port like so:</p>
...
`,options:[{id:"size-ok",page:168,label:"Yes",summary:"The filter looks correct"},{id:"too-small",page:170,label:"No, some values are missing",summary:"The filter lacks some values"}]},{content:`<p>The filter's <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> is too small; please increase its capacity and try again.</p>
<p>If you want, you can use the <a href="/v6/assistant/">ArduinoJson Assistant</a> to compute the required capacity.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Increasing the filter's capacity fixes the issue"},{id:"size-increased",page:168,label:"No",summary:"Increasing the filter's capacity doesn't fix the issue"}]},{content:`<p>Which function do you call to deserialize the input?</p>
`,options:[{id:"json",page:1,label:"<code>deserializeJson()</code>",summary:"Program calls `deserializeJson()`"},{id:"msgpack",page:172,label:"<code>deserializeMsgPack()</code>",summary:"Program calls `deserializeMsgPack()`"}]},{content:`<p>It seems that your program fed <a href="/v6/api/msgpack/deserializemsgpack/"><code>deserializeMsgPack()</code></a> with garbage input.</p>
...
`,options:[{id:"quote",page:176,label:"A quote (<code>&quot;</code>)",summary:"Serialized document starts with a quote"},{id:"bracket",page:167,label:"A square bracket (<code>[</code>)",summary:"Serialized document starts with a square bracket"},{id:"brace",page:167,label:"A curly brace (<code>{</code>)",summary:"Serialized document starts with a curly brace"},{id:"not-in-list",page:171,label:"None of the above",summary:"Serialized document starts with neither a quote, a bracket, nor a brace."}]},{content:`<p>If you cannot fix the server, you can at least reverse the double serialization (stringification) to get back the original object.</p>
...
`,options:[{id:"nul",page:200,label:"Yes",summary:"The input contains `\\u0000`"},{id:"no-nul",page:184,label:"No",summary:"The input doesn't contain `\\u0000`"}]},{content:`<p>When you call <code>HTTPClient::getStream()</code>, you bypass the part that handles <a href="https://en.wikipedia.org/wiki/Chunked_transfer_encoding">Chunked Transfer Encoding</a>.
...
`,options:[{id:"getstream",page:179,label:"<code>getStream()</code>",summary:"Response comes from `HTTPClient::getStream()`"},{id:"getstring",page:1,label:"<code>getString()</code>",summary:"Response comes from `HTTPClient::getString()`"}]},{content:`<p>When you use HTTP 1.1, the server can send the response with <a href="https://en.wikipedia.org/wiki/Chunked_transfer_encoding">Chunked Transfer Encoding</a>.
As a result, the response's body may be split in multiple chunks, making some strings look like they are truncated (in reality, they contain a line-break).</p>
<p>The most straightforward workaround is to downgrade the connection to HTTP 1.0.
...
`,options:[{id:"httpclient",page:180,label:"Yes, I'm using <code>HTTPClient</code>",summary:"Program uses `HTTPClient`"},{id:"http-library",page:182,label:"Yes, but it's not <code>HTTPClient</code>",summary:"Program uses an unknown HTTP library"},{id:"no-library",page:181,label:"No",summary:"Program doesn't use an HTTP library"}]},{content:`<p>Does the JSON input come from an HTTP response?</p>
`,options:[{id:"http",page:183,label:"Yes",summary:"The input comes from an HTTP response"},{id:"no-nul",page:1,label:"No",summary:"The input doesn't come from an HTTP response"}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> accepted a JSON document that was clearly invalid.<br>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Increasing the capacity of the `JsonDocument` fixes the issue"},{id:"increased-capacity",page:193,label:"No",summary:"Increasing the capacity of the `JsonDocument` doesn't fix the issue"}]},{content:`<p>I'm pretty confident the Assistant computes the right capacity; however, some settings can affect the result:</p>
<ol>
...
`,options:[{id:"global",page:188,label:"Yes",summary:"`doc` is a global variable"},{id:"local",page:187,label:"No",summary:"`doc` is not a global variable"}]},{content:`<p>Let's verify that the memory allocation succeeded.</p>
<p>Please print the capacity of the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> to the serial port, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">capacity</span>());
</code></pre>
<p>What value does it show?</p>
`,options:[{id:"capacity-0",page:189,label:"<code>0</code>",summary:"`doc.capacity()` returns `0`"},{id:"capacity-ok",page:187,label:"The value passed to the constructor of <code>DynamicJsonDocument</code>",summary:"`doc.capacity()` returns the right value"}]},{content:`<p>Well, that's very bad news. It seems that your microcontroller doesn't have enough RAM to hold the JSON document.</p>
...
`,options:[{id:"can-uprade",page:198,label:"Yes",summary:"Library can be upgraded"},{id:"cannot-upgrade",page:196,label:"No",summary:"Library cannot be upgraded"}]},{content:`<p>So, I guess that you're not using <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> but <a href="/v6/api/msgpack/deserializemsgpack/"><code>deserializeMsgPack()</code></a>, right?</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Defining `ARDUINOJSON_DECODE_UNICODE` solves the issue"},{id:"decode-unicode-set",page:195,label:"No",summary:"Defining `ARDUINOJSON_DECODE_UNICODE` doesn't solve the issue"}]},{content:`<p>If you're still seeing <code>NotSupported</code> after upgrading the library, it means that your code is not using the upgraded library.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Removing duplicates fixes the issue"},{id:"duplicates-removed",page:196,label:"No",summary:"Removing duplicates doesn't fix the issue"}]},{content:`<p>Please upgrade ArduinoJson to the latest version.<br>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Upgrading solves the issue"},{id:"updraded",page:197,label:"No",summary:"Upgrading doesn't solves the issue"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#toodeep"><code>TooDeep</code></a> means that the input document has too many levels of nesting.</p>
...
`,options:[{id:"crash",page:202,label:"The program crashes",summary:"Program crashes"},{id:"empty",page:212,label:"The output is empty (e.g. <code>{}</code>, <code>[]</code>, or <code>null</code>)",summary:"Output is empty"},{id:"incomplete",page:241,label:"The output is incomplete",summary:"Output is incomplete"},{id:"garbage",page:224,label:"The output contains garbage",summary:"Output contains garbage"},{id:"empty-strings",page:218,label:"The output contains empty strings",summary:"Output contains empty strings"},{id:"null",page:241,label:"The output contains <code>null</code>",summary:"Output contains null"},{id:"float",page:221,label:"Floating-point values contain too many decimal digits",summary:"Floating-point values contain too many decimal digits"},{id:"slow",page:249,label:"It's slow",summary:"Serialization is slow"}]},{content:`<p>Do you use <a href="/v6/api/dynamicjsondocument/"><code>DynamicJsonDocument</code></a> or <a href="/v6/api/staticjsondocument/"><code>StaticJsonDocument</code></a>?</p>
`,options:[{id:"dynamicjsondocument",page:210,label:"<code>DynamicJsonDocument</code>",summary:"Program uses `DynamicJsonDocument`"},{id:"staticjsondocument",page:211,label:"<code>StaticJsonDocument</code>",summary:"Program uses `StaticJsonDocument`"}]},{content:`<p>Please replace all those string pointers with literals.</p>
...
<p>Does your program still crash?</p>
`,options:[{id:"crash-with-literals",page:206,label:"Yes",summary:"Replacing string pointers with literals doesn't fix the crash"},{id:"no-crash-with-literals",page:204,label:"No",summary:"Replacing string pointers with literals fixes the crash"}]},{content:`<p>One of these string pointers is probably dangling or points to a non-zero-terminated string.</p>
...
`,options:[{id:"charptr",page:203,label:"Yes",summary:"Program inserts string pointers into the `JsonDocument`"},{id:"no-charptr",page:206,label:"No",summary:"Program doesn't insert string pointers into the `JsonDocument`"}]},{content:`<p>What is the type of the second argument passed to <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a>?</p>
`,options:[{id:"char-array",page:207,label:"<code>char[]</code>",summary:"Output type is `char[]`"},{id:"char-ptr",page:208,label:"<code>char*</code>",summary:"Output type is `char*`"},{id:"arduino-string",page:1,label:"<code>String</code>",summary:"Output type is `String`"},{id:"arduino-stream",page:1,label:"<code>Stream</code>",summary:"Output type is `Stream`"}]},{content:`<p>I think this output buffer could cause a <a href="https://en.wikipedia.org/wiki/Stack_buffer_overflow">stack overflow</a>.</p>
...
`,options:[{id:"progmem",page:209,label:"Yes",summary:"Program uses `PROGMEM`"},{id:"no-progmem",page:205,label:"No",summary:"Program doesn't use `PROGMEM`"}]},{content:`<p>Because a <a href="/v6/api/staticjsondocument/"><code>StaticJsonDocument</code></a> resides on the stack, it may cause a <a href="https://en.wikipedia.org/wiki/Stack_buffer_overflow">stack-overflow</a>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Switching to `DynamicJsonDocument` fixes the issue"},{id:"dynamicjsondocument-tried",page:210,label:"No",summary:"Switching to `DynamicJsonDocument` doesn't fix the issue"}]},{content:`<p>Please print the capacity of the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> to the serial port, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">capacity</span>());
</code></pre>
<p>What value does it show?</p>
`,options:[{id:"capacity-0",page:216,label:"<code>0</code>",summary:"`doc.capacity()` returns `0`"},{id:"capacity-ok",page:217,label:"a positive integer",summary:"`doc.capacity()` looks good"}]},{content:`<p><code>doc.capacity()</code> returns <code>0</code>, which means <code>allocate()</code> returned <code>NULL</code>.</p>
<p>I think that, because <code>doc</code> is declared global, <code>allocate()</code> is called too early and the heap isn't ready.
I know this happens on ESP32 with the <code>SpiRamJsonDocument</code> shown in <a href="/v6/how-to/use-external-ram-on-esp32/">How to use external RAM on ESP32?</a>.</p>
<p>Please try to make <code>doc</code> a local variable.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Making `doc` local fixes the issue."},{id:"failure",page:1,label:"No",summary:"Making `doc` local doesn't fix the issue."}]},{content:`<p>Is <code>doc</code> a global variable?</p>
`,options:[{id:"global",page:213,label:"Yes",summary:"`doc` is a global variable"},{id:"local",page:215,label:"No",summary:"`doc` is not a global variable"}]},{content:`<p>Well, that's very bad news. It seems that your microcontroller doesn't have enough RAM to hold the JSON document.</p>
<p>Please read <a href="/v6/how-to/reduce-memory-usage/">How to reduce memory usage</a>.
It shows several techniques you can use to use less RAM.
Hopefully, you'll make enough room for the memory pool.</p>
<p>Did this solve your issue?</p>
...
`,options:[{id:"basic",page:214,label:"<code>BasicJsonDocument&lt;T&gt;</code>",summary:"The document is a `BasicJsonDocument<T>`"},{id:"dynamic",page:215,label:"<code>DynamicJsonDocument</code>",summary:"The document is a `DynamicJsonDocument`"},{id:"static",page:1,label:"<code>StaticJsonDocument</code>",summary:"The document is a `StaticJsonDocument`"}]},{content:`<p>Please print the value of <a href="/v6/api/jsondocument/overflowed/"><code>JsonDocument::overflowed()</code></a>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:248,label:"<code>1</code> (or <code>true</code>)",summary:"`JsonDocument::overflowed()` returns `true`"},{id:"overflowed-0",page:1,label:"<code>0</code> (or <code>false</code>)",summary:"`JsonDocument::overflowed()` returns `false`"}]},{content:`<p>Do you call <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> before calling <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a>? (with the same <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>)</p>
`,options:[{id:"deserialize-yes",page:220,label:"Yes",summary:"Program calls `deserializeJson()`"},{id:"deserialize-no",page:1,label:"No",summary:"Program doesn't call `deserializeJson()`"}]},{content:`<p>When you pass a writeable buffer as the input of <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, ArduinoJson uses the <strong>zero-copy mode</strong>. Instead of copying the strings from the input into the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, it stores pointers to the input buffer.
...
`,options:[{id:"char-ptr",page:219,label:"<code>char*</code> (or <code>char[]</code>)",summary:"Input type is `char*`"},{id:"const-char-ptr",page:1,label:"<code>const char*</code>",summary:"Input type is `const char*`"},{id:"string",page:1,label:"<code>String</code> (or <code>std::string</code>)",summary:"Input type is `String`"},{id:"stream",page:1,label:"<code>Stream</code> (or <code>std::istream)</code>",summary:"Input type is `Stream`"}]},{content:`<p>Supposing that the JSON output looks like this:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Replacing `float` with `double` fixes the issue"},{id:"double",page:223,label:"No",summary:"Replacing `float` with `double` doesn't fix the issue"}]},{content:`<p>I'm surprised that the previous solution didn't work.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Rounding the value fixes the issue"},{id:"double",page:222,label:"No",summary:"Rounding the value doesn't fix the issue"}]},{content:`<p>What function produces the garbage?</p>
`,options:[{id:"json",page:231,label:"<code>serializeJson()</code> (or <code>serializeJsonPretty()</code>)",summary:"`serializeJson()` produces garbage"},{id:"msg",page:236,label:"<code>serializeMsgPack()</code>",summary:"`serializeMsgPack()` produces garbage"}]},{content:`<p>When you pass a writeable buffer as the input of <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, ArduinoJson uses the <strong>zero-copy mode</strong>. Instead of copying the strings from the input into the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, it stores pointers to the input buffer.
Therefore, the input buffer must stay alive during the whole lifetime of the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>; otherwise, all the strings in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> will be dangling pointers.</p>
<p>The easiest solution is to disable the zero-copy mode by passing a read-only input buffer. Casting the pointer will do the trick:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// replace this:</span>
<span class="hljs-built_in">deserializeJson</span>(doc, input, inputSize);
...
<p>Now that the zero-copy mode is disabled, you probably need a larger <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, so don't forget to update the capacity. As usual, use the <a href="/v6/assistant/">ArduinoJson Assistant</a> to compute the right capacity for your project.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Casting the pointer fixes the issue"},{id:"casting-fails",page:240,label:"No",summary:"Casting the pointer doesn't fix the issue"}]},{content:`<p>What's the type of the second argument passed to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>?</p>
`,options:[{id:"char-ptr",page:225,label:"<code>char*</code> (or <code>char[]</code>)",summary:"Input type is `char*`"},{id:"const-char-ptr",page:240,label:"<code>const char*</code>",summary:"Input type is `const char*`"},{id:"string",page:240,label:"<code>String</code> (or <code>std::string</code>)",summary:"Input type is `String`"},{id:"stream",page:240,label:"<code>Stream</code> (or <code>std::istream)</code>",summary:"Input type is `Stream`"}]},{content:`<p>You can insert <a href="https://www.arduino.cc/reference/en/language/variables/data-types/stringobject/"><code>String</code></a> objects in a <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, but make sure you don't store the result of <a href="https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/c_str/"><code>String::c_str()</code></a>.</p>
...
`,options:[{id:"string",page:227,label:"Yes",summary:"Program uses `String`"},{id:"no-string",page:1,label:"No",summary:"Program doesn't use `String`"}]},{content:`<p><a href="/v6/api/staticjsondocument/"><code>StaticJsonDocument</code></a> stores its memory pool in the stack.
...
<p>Please switch to a <a href="/v6/api/dynamicjsondocument/"><code>DynamicJsonDocument</code></a>.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Switching to `DynamicJsonDocument` fixes the issue"},{id:"dynamic",page:228,label:"No",summary:"Switching to `DynamicJsonDocument` doesn't fix the issue"}]},{content:`<p>Which kind of <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> do you use?</p>
`,options:[{id:"dynamic",page:228,label:"<code>DynamicJsonDocument</code>",summary:"Program uses `DynamicJsonDocument`"},{id:"static",page:229,label:"<code>StaticJsonDocument</code>",summary:"Program uses `StaticJsonDocument`"}]},{content:`<p>Do you call <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> before calling <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a>? (with the same <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>)</p>
`,options:[{id:"deserialize-yes",page:226,label:"Yes",summary:"Program calls `deserializeJson()`"},{id:"deserialize-no",page:240,label:"No",summary:"Program doesn't call `deserializeJson()`"}]},{content:`<p><a href="/v6/api/jsonarray/"><code>JsonArray</code></a> doesn't contain any data: it is a reference to an object stored in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>. It becomes invalid as soon as the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> is destroyed; this could explain the garbage you see in the output.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:239,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><a href="/v6/api/jsonobject/"><code>JsonObject</code></a> doesn't contain any data: it is a reference to an object stored in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>. It becomes invalid as soon as the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> is destroyed; this could explain the garbage you see in the output.</p>
...
<p>This way, you can keep the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> alive when you call <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a></p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:239,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><a href="/v6/api/jsonvariant/"><code>JsonVariant</code></a> doesn't contain any data: it is a reference to an object stored in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>. It becomes invalid as soon as the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> is destroyed; this could explain the garbage you see in the output.</p>
...
`,options:[{id:"json",page:231,label:"Yes, <code>serializeJson()</code> produces garbage too",summary:"`serializeJson()` produces garbage too"},{id:"deserialize-no",page:235,label:"No, <code>serializeJson()</code> doesn't produces garbage",summary:"`serializeJson()` doesn't produces garbage"}]},{content:`<p><a href="/v6/api/jsondocument/garbagecollect/"><code>JsonDocument::garbageCollect()</code></a> invalidates all previously acquired <a href="/v6/api/jsonarray/"><code>JsonArray</code></a>, <a href="/v6/api/jsonobject/"><code>JsonObject</code></a>, and <a href="/v6/api/jsonvariant/"><code>JsonVariant</code></a>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Reassigning references fixes the issue"},{id:"reassigned",page:230,label:"No",summary:"Reassigning references doesn't fix the issue"}]},{content:`<p><a href="/v6/api/basicjsondocument/shrinktofit/"><code>JsonDocument::shrinkToFit()</code></a> invalidates all previously acquired <a href="/v6/api/jsonarray/"><code>JsonArray</code></a>, <a href="/v6/api/jsonobject/"><code>JsonObject</code></a>, and <a href="/v6/api/jsonvariant/"><code>JsonVariant</code></a>.</p>
<p>After you call it, make sure to reassign  every references, like so:</p>
<pre><code class="hljs language-c++">JsonObject cfg = doc.<span class="hljs-built_in">createNestedObject</span>(<span class="hljs-string">&quot;config&quot;</span>);
<span class="hljs-comment">// ...</span>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Reassigning references fixes the issue"},{id:"reassigned",page:230,label:"No",summary:"Reassigning references doesn't fix the issue"}]},{content:`<p>Do you use one of the following function?</p>
`,options:[{id:"garbagecollect",page:237,label:"<code>JsonDocument::garbageCollect()</code>",summary:"Program calls `JsonDocument::garbageCollect()`"},{id:"shrinktofit",page:238,label:"<code>JsonDocument::shrinkToFit()</code>",summary:"Program calls `JsonDocument::shrinkToFit()`"},{id:"none",page:230,label:"No",summary:"Program doesn't call an invalidating function"}]},{content:`<p>What is the type of the first argument passed to <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a>?</p>
`,options:[{id:"document",page:230,label:"<code>JsonDocument</code>",summary:"Program calls `serializeJson(const JsonDocument&, ...)`"},{id:"array",page:232,label:"<code>JsonArray</code> (or <code>JsonArrayConst</code>)",summary:"Program calls `serializeJson(JsonArrayConst, ...)`"},{id:"object",page:233,label:"<code>JsonObject</code> (or <code>JsonObjectConst</code>)",summary:"Program calls `serializeJson(JsonObjectConst, ...)`"},{id:"variant",page:234,label:"<code>JsonVariant</code> (or <code>JsonVariantConst</code>)",summary:"Program calls `serializeJson(JsonVariantConst, ...)`"}]},{content:`<p>Does your program call <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a> in a loop?</p>
`,options:[{id:"loop",page:245,label:"Yes",summary:"Program calls `serializeJson()` in a loop"},{id:"no-loop",page:246,label:"No",summary:"Program doesn't call `serializeJson()` in a loop"}]},{content:`<p>The ArduinoJson Assistant suggested a too small capacity because you didn't configure it properly.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Calling `JsonDocument::garbageCollect()` solves the issue"},{id:"gc",page:246,label:"No",summary:"Calling `JsonDocument::garbageCollect()` doesn't solve the issue"}]},{content:`<p>We can try to clear the content of the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>.</p>
<p>Please call <a href="/v6/api/jsondocument/clear/"><code>JsonDocument::clear()</code></a> at the beginning of the loop.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Calling `JsonDocument::clear()` solves the issue"},{id:"clear",page:246,label:"No",summary:"Calling `JsonDocument::clear()` doesn't solve the issue"},{id:"missing",page:243,label:"Yes, but now some values are missing",summary:"Calling `JsonDocument::clear()` solves the issue but removes other values"}]},{content:`<p>Calling <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a> is safe, but you'll run into issues if you modify the same <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> in a loop.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Moving the `JsonDocument` inside the loop solves the issue"},{id:"inside",page:246,label:"No",summary:"Moving the `JsonDocument` inside the loop doesn't solve the issue"},{id:"outside",page:244,label:"I cannot move the declaration inside the loop",summary:"The `JsonDocument` cannot be moved inside the loop"}]},{content:`<p>Please print the value of <a href="/v6/api/jsondocument/overflowed/"><code>JsonDocument::overflowed()</code></a>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:248,label:"<code>1</code> (or <code>true</code>)",summary:"`JsonDocument::overflowed()` returns `true`"},{id:"overflowed-0",page:247,label:"<code>0</code> (or <code>false</code>)",summary:"`JsonDocument::overflowed()` returns `false`"}]},{content:`<p>Does one of the strings in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> contains a NUL (i.e.,  ASCII code 0, or <code>\\u0000</code>)?</p>
`,options:[{id:"nul",page:200,label:"Yes",summary:"One or more strings contain a NUL"},{id:"no-nul",page:1,label:"No",summary:"No string contains a NUL"}]},{content:`<p><a href="/v6/api/jsondocument/overflowed/"><code>JsonDocument::overflowed()</code></a> returns <code>true</code> when you try to insert a value in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, but there isn't enough room to store it.</p>
