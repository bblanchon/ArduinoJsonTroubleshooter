(function(){"use strict";function dn(e,s){const n=Object.create(null),t=e.split(",");for(let o=0;o<t.length;o++)n[t[o]]=!0;return s?o=>!!n[o.toLowerCase()]:o=>!!n[o]}const U={},os=[],ke=()=>{},Zo=()=>!1,Os=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),hn=e=>e.startsWith("onUpdate:"),se=Object.assign,mn=(e,s)=>{const n=e.indexOf(s);n>-1&&e.splice(n,1)},Qo=Object.prototype.hasOwnProperty,P=(e,s)=>Qo.call(e,s),A=Array.isArray,as=e=>qs(e)==="[object Map]",pt=e=>qs(e)==="[object Set]",O=e=>typeof e=="function",Z=e=>typeof e=="string",is=e=>typeof e=="symbol",H=e=>e!==null&&typeof e=="object",ut=e=>(H(e)||O(e))&&O(e.then)&&O(e.catch),dt=Object.prototype.toString,qs=e=>dt.call(e),ea=e=>qs(e).slice(8,-1),ht=e=>qs(e)==="[object Object]",fn=e=>Z(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,zs=dn(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Ps=e=>{const s=Object.create(null);return n=>s[n]||(s[n]=e(n))},sa=/-(\w)/g,De=Ps(e=>e.replace(sa,(s,n)=>n?n.toUpperCase():"")),na=/\B([A-Z])/g,rs=Ps(e=>e.replace(na,"-$1").toLowerCase()),Es=Ps(e=>e.charAt(0).toUpperCase()+e.slice(1)),gn=Ps(e=>e?`on${Es(e)}`:""),ls=(e,s)=>!Object.is(e,s),yn=(e,s)=>{for(let n=0;n<e.length;n++)e[n](s)},Cs=(e,s,n)=>{Object.defineProperty(e,s,{configurable:!0,enumerable:!1,value:n})},ta=e=>{const s=parseFloat(e);return isNaN(s)?e:s},oa=e=>{const s=Z(e)?Number(e):NaN;return isNaN(s)?e:s};let mt;const bn=()=>mt||(mt=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function jn(e){if(A(e)){const s={};for(let n=0;n<e.length;n++){const t=e[n],o=Z(t)?la(t):jn(t);if(o)for(const a in o)s[a]=o[a]}return s}else if(Z(e)||H(e))return e}const aa=/;(?![^(]*\))/g,ia=/:([^]+)/,ra=/\/\*[^]*?\*\//g;function la(e){const s={};return e.replace(ra,"").split(aa).forEach(n=>{if(n){const t=n.split(ia);t.length>1&&(s[t[0].trim()]=t[1].trim())}}),s}function bs(e){let s="";if(Z(e))s=e;else if(A(e))for(let n=0;n<e.length;n++){const t=bs(e[n]);t&&(s+=t+" ")}else if(H(e))for(const n in e)e[n]&&(s+=n+" ");return s.trim()}const ca=dn("itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly");function ft(e){return!!e||e===""}const Rs=e=>Z(e)?e:e==null?"":A(e)||H(e)&&(e.toString===dt||!O(e.toString))?JSON.stringify(e,gt,2):String(e),gt=(e,s)=>s&&s.__v_isRef?gt(e,s.value):as(s)?{[`Map(${s.size})`]:[...s.entries()].reduce((n,[t,o],a)=>(n[wn(t,a)+" =>"]=o,n),{})}:pt(s)?{[`Set(${s.size})`]:[...s.values()].map(n=>wn(n))}:is(s)?wn(s):H(s)&&!A(s)&&!ht(s)?String(s):s,wn=(e,s="")=>{var n;return is(e)?`Symbol(${(n=e.description)!=null?n:s})`:e};let je;class pa{constructor(s=!1){this.detached=s,this._active=!0,this.effects=[],this.cleanups=[],this.parent=je,!s&&je&&(this.index=(je.scopes||(je.scopes=[])).push(this)-1)}get active(){return this._active}run(s){if(this._active){const n=je;try{return je=this,s()}finally{je=n}}}on(){je=this}off(){je=this.parent}stop(s){if(this._active){let n,t;for(n=0,t=this.effects.length;n<t;n++)this.effects[n].stop();for(n=0,t=this.cleanups.length;n<t;n++)this.cleanups[n]();if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!s){const o=this.parent.scopes.pop();o&&o!==this&&(this.parent.scopes[this.index]=o,o.index=this.index)}this.parent=void 0,this._active=!1}}}function ua(e,s=je){s&&s.active&&s.effects.push(e)}function da(){return je}const vn=e=>{const s=new Set(e);return s.w=0,s.n=0,s},yt=e=>(e.w&Re)>0,bt=e=>(e.n&Re)>0,ha=({deps:e})=>{if(e.length)for(let s=0;s<e.length;s++)e[s].w|=Re},ma=e=>{const{deps:s}=e;if(s.length){let n=0;for(let t=0;t<s.length;t++){const o=s[t];yt(o)&&!bt(o)?o.delete(e):s[n++]=o,o.w&=~Re,o.n&=~Re}s.length=n}},Jn=new WeakMap;let js=0,Re=1;const Sn=30;let we;const Ve=Symbol(""),_n=Symbol("");class Tn{constructor(s,n=null,t){this.fn=s,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,ua(this,t)}run(){if(!this.active)return this.fn();let s=we,n=Fe;for(;s;){if(s===this)return;s=s.parent}try{return this.parent=we,we=this,Fe=!0,Re=1<<++js,js<=Sn?ha(this):jt(this),this.fn()}finally{js<=Sn&&ma(this),Re=1<<--js,we=this.parent,Fe=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){we===this?this.deferStop=!0:this.active&&(jt(this),this.onStop&&this.onStop(),this.active=!1)}}function jt(e){const{deps:s}=e;if(s.length){for(let n=0;n<s.length;n++)s[n].delete(e);s.length=0}}let Fe=!0;const wt=[];function cs(){wt.push(Fe),Fe=!1}function ps(){const e=wt.pop();Fe=e===void 0?!0:e}function ce(e,s,n){if(Fe&&we){let t=Jn.get(e);t||Jn.set(e,t=new Map);let o=t.get(n);o||t.set(n,o=vn()),vt(o)}}function vt(e,s){let n=!1;js<=Sn?bt(e)||(e.n|=Re,n=!yt(e)):n=!e.has(we),n&&(e.add(we),we.deps.push(e))}function ze(e,s,n,t,o,a){const i=Jn.get(e);if(!i)return;let l=[];if(s==="clear")l=[...i.values()];else if(n==="length"&&A(e)){const c=Number(t);i.forEach((u,h)=>{(h==="length"||!is(h)&&h>=c)&&l.push(u)})}else switch(n!==void 0&&l.push(i.get(n)),s){case"add":A(e)?fn(n)&&l.push(i.get("length")):(l.push(i.get(Ve)),as(e)&&l.push(i.get(_n)));break;case"delete":A(e)||(l.push(i.get(Ve)),as(e)&&l.push(i.get(_n)));break;case"set":as(e)&&l.push(i.get(Ve));break}if(l.length===1)l[0]&&kn(l[0]);else{const c=[];for(const u of l)u&&c.push(...u);kn(vn(c))}}function kn(e,s){const n=A(e)?e:[...e];for(const t of n)t.computed&&Jt(t);for(const t of n)t.computed||Jt(t)}function Jt(e,s){(e!==we||e.allowRecurse)&&(e.scheduler?e.scheduler():e.run())}const fa=dn("__proto__,__v_isRef,__isVue"),St=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(is)),_t=ya();function ya(){const e={};return["includes","indexOf","lastIndexOf"].forEach(s=>{e[s]=function(...n){const t=C(this);for(let a=0,i=this.length;a<i;a++)ce(t,"get",a+"");const o=t[s](...n);return o===-1||o===!1?t[s](...n.map(C)):o}}),["push","pop","shift","unshift","splice"].forEach(s=>{e[s]=function(...n){cs();const t=C(this)[s].apply(this,n);return ps(),t}}),e}function ba(e){const s=C(this);return ce(s,"has",e),s.hasOwnProperty(e)}class Tt{constructor(s=!1,n=!1){this._isReadonly=s,this._shallow=n}get(s,n,t){const o=this._isReadonly,a=this._shallow;if(n==="__v_isReactive")return!o;if(n==="__v_isReadonly")return o;if(n==="__v_isShallow")return a;if(n==="__v_raw")return t===(o?a?Na:qt:a?Ot:Nt).get(s)||Object.getPrototypeOf(s)===Object.getPrototypeOf(t)?s:void 0;const i=A(s);if(!o){if(i&&P(_t,n))return Reflect.get(_t,n,t);if(n==="hasOwnProperty")return ba}const l=Reflect.get(s,n,t);return(is(n)?St.has(n):fa(n))||(o||ce(s,"get",n),a)?l:de(l)?i&&fn(n)?l:l.value:H(l)?o?zt(l):xn(l):l}}class kt extends Tt{constructor(s=!1){super(!1,s)}set(s,n,t,o){let a=s[n];if(!this._shallow){const c=ws(a);if(!Nn(t)&&!ws(t)&&(a=C(a),t=C(t)),!A(s)&&de(a)&&!de(t))return c?!1:(a.value=t,!0)}const i=A(s)&&fn(n)?Number(n)<s.length:P(s,n),l=Reflect.set(s,n,t,o);return s===C(o)&&(i?ls(t,a)&&ze(s,"set",n,t):ze(s,"add",n,t)),l}deleteProperty(s,n){const t=P(s,n);s[n];const o=Reflect.deleteProperty(s,n);return o&&t&&ze(s,"delete",n,void 0),o}has(s,n){const t=Reflect.has(s,n);return(!is(n)||!St.has(n))&&ce(s,"has",n),t}ownKeys(s){return ce(s,"iterate",A(s)?"length":Ve),Reflect.ownKeys(s)}}class ja extends Tt{constructor(s=!1){super(!0,s)}set(s,n){return!0}deleteProperty(s,n){return!0}}const wa=new kt,va=new ja,Ja=new kt(!0),Dn=e=>e,Fs=e=>Reflect.getPrototypeOf(e);function Ms(e,s,n=!1,t=!1){e=e.__v_raw;const o=C(e),a=C(s);n||(ls(s,a)&&ce(o,"get",s),ce(o,"get",a));const{has:i}=Fs(o),l=t?Dn:n?qn:On;if(i.call(o,s))return l(e.get(s));if(i.call(o,a))return l(e.get(a));e!==o&&e.get(s)}function Hs(e,s=!1){const n=this.__v_raw,t=C(n),o=C(e);return s||(ls(e,o)&&ce(t,"has",e),ce(t,"has",o)),e===o?n.has(e):n.has(e)||n.has(o)}function Ys(e,s=!1){return e=e.__v_raw,!s&&ce(C(e),"iterate",Ve),Reflect.get(e,"size",e)}function Dt(e){e=C(e);const s=C(this);return Fs(s).has.call(s,e)||(s.add(e),ze(s,"add",e,e)),this}function At(e,s){s=C(s);const n=C(this),{has:t,get:o}=Fs(n);let a=t.call(n,e);a||(e=C(e),a=t.call(n,e));const i=o.call(n,e);return n.set(e,s),a?ls(s,i)&&ze(n,"set",e,s):ze(n,"add",e,s),this}function xt(e){const s=C(this),{has:n,get:t}=Fs(s);let o=n.call(s,e);o||(e=C(e),o=n.call(s,e)),t&&t.call(s,e);const a=s.delete(e);return o&&ze(s,"delete",e,void 0),a}function It(){const e=C(this),s=e.size!==0,n=e.clear();return s&&ze(e,"clear",void 0,void 0),n}function Bs(e,s){return function(t,o){const a=this,i=a.__v_raw,l=C(i),c=s?Dn:e?qn:On;return!e&&ce(l,"iterate",Ve),i.forEach((u,h)=>t.call(o,c(u),c(h),a))}}function Us(e,s,n){return function(...t){const o=this.__v_raw,a=C(o),i=as(a),l=e==="entries"||e===Symbol.iterator&&i,c=e==="keys"&&i,u=o[e](...t),h=n?Dn:s?qn:On;return!s&&ce(a,"iterate",c?_n:Ve),{next(){const{value:y,done:w}=u.next();return w?{value:y,done:w}:{value:l?[h(y[0]),h(y[1])]:h(y),done:w}},[Symbol.iterator](){return this}}}}function Me(e){return function(...s){return e==="delete"?!1:e==="clear"?void 0:this}}function Sa(){const e={get(a){return Ms(this,a)},get size(){return Ys(this)},has:Hs,add:Dt,set:At,delete:xt,clear:It,forEach:Bs(!1,!1)},s={get(a){return Ms(this,a,!1,!0)},get size(){return Ys(this)},has:Hs,add:Dt,set:At,delete:xt,clear:It,forEach:Bs(!1,!0)},n={get(a){return Ms(this,a,!0)},get size(){return Ys(this,!0)},has(a){return Hs.call(this,a,!0)},add:Me("add"),set:Me("set"),delete:Me("delete"),clear:Me("clear"),forEach:Bs(!0,!1)},t={get(a){return Ms(this,a,!0,!0)},get size(){return Ys(this,!0)},has(a){return Hs.call(this,a,!0)},add:Me("add"),set:Me("set"),delete:Me("delete"),clear:Me("clear"),forEach:Bs(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(a=>{e[a]=Us(a,!1,!1),n[a]=Us(a,!0,!1),s[a]=Us(a,!1,!0),t[a]=Us(a,!0,!0)}),[e,n,s,t]}const[_a,Ta,ka,Da]=Sa();function An(e,s){const n=s?e?Da:ka:e?Ta:_a;return(t,o,a)=>o==="__v_isReactive"?!e:o==="__v_isReadonly"?e:o==="__v_raw"?t:Reflect.get(P(n,o)&&o in t?n:t,o,a)}const Aa={get:An(!1,!1)},xa={get:An(!1,!0)},Ia={get:An(!0,!1)},Nt=new WeakMap,Ot=new WeakMap,qt=new WeakMap,Na=new WeakMap;function Oa(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function qa(e){return e.__v_skip||!Object.isExtensible(e)?0:Oa(ea(e))}function xn(e){return ws(e)?e:In(e,!1,wa,Aa,Nt)}function za(e){return In(e,!1,Ja,xa,Ot)}function zt(e){return In(e,!0,va,Ia,qt)}function In(e,s,n,t,o){if(!H(e)||e.__v_raw&&!(s&&e.__v_isReactive))return e;const a=o.get(e);if(a)return a;const i=qa(e);if(i===0)return e;const l=new Proxy(e,i===2?t:n);return o.set(e,l),l}function us(e){return ws(e)?us(e.__v_raw):!!(e&&e.__v_isReactive)}function ws(e){return!!(e&&e.__v_isReadonly)}function Nn(e){return!!(e&&e.__v_isShallow)}function Pt(e){return us(e)||ws(e)}function C(e){const s=e&&e.__v_raw;return s?C(s):e}function Et(e){return Cs(e,"__v_skip",!0),e}const On=e=>H(e)?xn(e):e,qn=e=>H(e)?zt(e):e;function Pa(e){Fe&&we&&(e=C(e),vt(e.dep||(e.dep=vn())))}function Ea(e,s){e=C(e);const n=e.dep;n&&kn(n)}function de(e){return!!(e&&e.__v_isRef===!0)}function Ca(e){return de(e)?e.value:e}const Ra={get:(e,s,n)=>Ca(Reflect.get(e,s,n)),set:(e,s,n,t)=>{const o=e[s];return de(o)&&!de(n)?(o.value=n,!0):Reflect.set(e,s,n,t)}};function Ct(e){return us(e)?e:new Proxy(e,Ra)}class Fa{constructor(s,n,t,o){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this._dirty=!0,this.effect=new Tn(s,()=>{this._dirty||(this._dirty=!0,Ea(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!o,this.__v_isReadonly=t}get value(){const s=C(this);return Pa(s),(s._dirty||!s._cacheable)&&(s._dirty=!1,s._value=s.effect.run()),s._value}set value(s){this._setter(s)}}function Ma(e,s,n=!1){let t,o;const a=O(e);return a?(t=e,o=ke):(t=e.get,o=e.set),new Fa(t,o,a||!o,n)}function ul(e,...s){}function He(e,s,n,t){let o;try{o=t?e(...t):e()}catch(a){Ls(a,s,n)}return o}function fe(e,s,n,t){if(O(e)){const a=He(e,s,n,t);return a&&ut(a)&&a.catch(i=>{Ls(i,s,n)}),a}const o=[];for(let a=0;a<e.length;a++)o.push(fe(e[a],s,n,t));return o}function Ls(e,s,n,t=!0){const o=s?s.vnode:null;if(s){let a=s.parent;const i=s.proxy,l=n;for(;a;){const u=a.ec;if(u){for(let h=0;h<u.length;h++)if(u[h](e,i,l)===!1)return}a=a.parent}const c=s.appContext.config.errorHandler;if(c){He(c,null,10,[e,i,l]);return}}Ha(e,n,o,t)}function Ha(e,s,n,t=!0){console.error(e)}let vs=!1,zn=!1;const ae=[];let Ae=0;const ds=[];let Pe=null,$e=0;const Rt=Promise.resolve();let Pn=null;function Ya(e){const s=Pn||Rt;return e?s.then(this?e.bind(this):e):s}function Ba(e){let s=Ae+1,n=ae.length;for(;s<n;){const t=s+n>>>1,o=ae[t],a=Js(o);a<e||a===e&&o.pre?s=t+1:n=t}return s}function En(e){(!ae.length||!ae.includes(e,vs&&e.allowRecurse?Ae+1:Ae))&&(e.id==null?ae.push(e):ae.splice(Ba(e.id),0,e),Ft())}function Ft(){!vs&&!zn&&(zn=!0,Pn=Rt.then(Yt))}function Ua(e){const s=ae.indexOf(e);s>Ae&&ae.splice(s,1)}function La(e){A(e)?ds.push(...e):(!Pe||!Pe.includes(e,e.allowRecurse?$e+1:$e))&&ds.push(e),Ft()}function Mt(e,s,n=vs?Ae+1:0){for(;n<ae.length;n++){const t=ae[n];if(t&&t.pre){if(e&&t.id!==e.uid)continue;ae.splice(n,1),n--,t()}}}function Ht(e){if(ds.length){const s=[...new Set(ds)];if(ds.length=0,Pe){Pe.push(...s);return}for(Pe=s,Pe.sort((n,t)=>Js(n)-Js(t)),$e=0;$e<Pe.length;$e++)Pe[$e]();Pe=null,$e=0}}const Js=e=>e.id==null?1/0:e.id,Wa=(e,s)=>{const n=Js(e)-Js(s);if(n===0){if(e.pre&&!s.pre)return-1;if(s.pre&&!e.pre)return 1}return n};function Yt(e){zn=!1,vs=!0,ae.sort(Wa);try{for(Ae=0;Ae<ae.length;Ae++){const s=ae[Ae];s&&s.active!==!1&&He(s,null,14)}}finally{Ae=0,ae.length=0,Ht(),vs=!1,Pn=null,(ae.length||ds.length)&&Yt()}}function Va(e,s,...n){if(e.isUnmounted)return;const t=e.vnode.props||U;let o=n;const a=s.startsWith("update:"),i=a&&s.slice(7);if(i&&i in t){const h=`${i==="modelValue"?"model":i}Modifiers`,{number:y,trim:w}=t[h]||U;w&&(o=n.map(D=>Z(D)?D.trim():D)),y&&(o=n.map(ta))}let l,c=t[l=gn(s)]||t[l=gn(De(s))];!c&&a&&(c=t[l=gn(rs(s))]),c&&fe(c,e,6,o);const u=t[l+"Once"];if(u){if(!e.emitted)e.emitted={};else if(e.emitted[l])return;e.emitted[l]=!0,fe(u,e,6,o)}}function Bt(e,s,n=!1){const t=s.emitsCache,o=t.get(e);if(o!==void 0)return o;const a=e.emits;let i={},l=!1;if(!O(e)){const c=u=>{const h=Bt(u,s,!0);h&&(l=!0,se(i,h))};!n&&s.mixins.length&&s.mixins.forEach(c),e.extends&&c(e.extends),e.mixins&&e.mixins.forEach(c)}return!a&&!l?(H(e)&&t.set(e,null),null):(A(a)?a.forEach(c=>i[c]=null):se(i,a),H(e)&&t.set(e,i),i)}function Ws(e,s){return!e||!Os(s)?!1:(s=s.slice(2).replace(/Once$/,""),P(e,s[0].toLowerCase()+s.slice(1))||P(e,rs(s))||P(e,s))}let ge=null,Ut=null;function Vs(e){const s=ge;return ge=e,Ut=e&&e.type.__scopeId||null,s}function Lt(e,s=ge,n){if(!s||e._n)return e;const t=(...o)=>{t._d&&So(-1);const a=Vs(s);let i;try{i=e(...o)}finally{Vs(a),t._d&&So(1)}return i};return t._n=!0,t._c=!0,t._d=!0,t}function dl(){}function Cn(e){const{type:s,vnode:n,proxy:t,withProxy:o,props:a,propsOptions:[i],slots:l,attrs:c,emit:u,render:h,renderCache:y,data:w,setupState:D,ctx:E,inheritAttrs:x}=e;let Y,W;const L=Vs(e);try{if(n.shapeFlag&4){const I=o||t,Q=I;Y=Ie(h.call(Q,I,y,a,D,w,E)),W=c}else{const I=s;Y=Ie(I.length>1?I(a,{attrs:c,slots:l,emit:u}):I(a,null)),W=s.props?c:$a(c)}}catch(I){Ts.length=0,Ls(I,e,1),Y=le(ve)}let V=Y;if(W&&x!==!1){const I=Object.keys(W),{shapeFlag:Q}=V;I.length&&Q&7&&(i&&I.some(hn)&&(W=Ka(W,i)),V=Be(V,W))}return n.dirs&&(V=Be(V),V.dirs=V.dirs?V.dirs.concat(n.dirs):n.dirs),n.transition&&(V.transition=n.transition),Y=V,Vs(L),Y}const $a=e=>{let s;for(const n in e)(n==="class"||n==="style"||Os(n))&&((s||(s={}))[n]=e[n]);return s},Ka=(e,s)=>{const n={};for(const t in e)(!hn(t)||!(t.slice(9)in s))&&(n[t]=e[t]);return n};function Ga(e,s,n){const{props:t,children:o,component:a}=e,{props:i,children:l,patchFlag:c}=s,u=a.emitsOptions;if(s.dirs||s.transition)return!0;if(n&&c>=0){if(c&1024)return!0;if(c&16)return t?Wt(t,i,u):!!i;if(c&8){const h=s.dynamicProps;for(let y=0;y<h.length;y++){const w=h[y];if(i[w]!==t[w]&&!Ws(u,w))return!0}}}else return(o||l)&&(!l||!l.$stable)?!0:t===i?!1:t?i?Wt(t,i,u):!0:!!i;return!1}function Wt(e,s,n){const t=Object.keys(s);if(t.length!==Object.keys(e).length)return!0;for(let o=0;o<t.length;o++){const a=t[o];if(s[a]!==e[a]&&!Ws(n,a))return!0}return!1}function Xa({vnode:e,parent:s},n){for(;s&&s.subTree===e;)(e=s.vnode).el=n,s=s.parent}const Vt="components";function Rn(e,s){return Qa(Vt,e,!0,s)||e}const Za=Symbol.for("v-ndc");function Qa(e,s,n=!0,t=!1){const o=ge||te;if(o){const a=o.type;if(e===Vt){const l=Vi(a,!1);if(l&&(l===s||l===De(s)||l===Es(De(s))))return a}const i=$t(o[e]||a[e],s)||$t(o.appContext[e],s);return!i&&t?a:i}}function $t(e,s){return e&&(e[s]||e[De(s)]||e[Es(De(s))])}const ei=e=>e.__isSuspense;function si(e,s){s&&s.pendingBranch?A(e)?s.effects.push(...e):s.effects.push(e):La(e)}const $s={};function Fn(e,s,n){return Kt(e,s,n)}function Kt(e,s,{immediate:n,deep:t,flush:o,onTrack:a,onTrigger:i}=U){var l;const c=da()===((l=te)==null?void 0:l.scope)?te:null;let u,h=!1,y=!1;if(de(e)?(u=()=>e.value,h=Nn(e)):us(e)?(u=()=>e,t=!0):A(e)?(y=!0,h=e.some(I=>us(I)||Nn(I)),u=()=>e.map(I=>{if(de(I))return I.value;if(us(I))return hs(I);if(O(I))return He(I,c,2)})):O(e)?s?u=()=>He(e,c,2):u=()=>{if(!(c&&c.isUnmounted))return w&&w(),fe(e,c,3,[D])}:u=ke,s&&t){const I=u;u=()=>hs(I())}let w,D=I=>{w=L.onStop=()=>{He(I,c,4),w=L.onStop=void 0}},E;if(Ds)if(D=ke,s?n&&fe(s,c,3,[u(),y?[]:void 0,D]):u(),o==="sync"){const I=Zi();E=I.__watcherHandles||(I.__watcherHandles=[])}else return ke;let x=y?new Array(e.length).fill($s):$s;const Y=()=>{if(L.active)if(s){const I=L.run();(t||h||(y?I.some((Q,Se)=>ls(Q,x[Se])):ls(I,x)))&&(w&&w(),fe(s,c,3,[I,x===$s?void 0:y&&x[0]===$s?[]:x,D]),x=I)}else L.run()};Y.allowRecurse=!!s;let W;o==="sync"?W=Y:o==="post"?W=()=>pe(Y,c&&c.suspense):(Y.pre=!0,c&&(Y.id=c.uid),W=()=>En(Y));const L=new Tn(u,W);s?n?Y():x=L.run():o==="post"?pe(L.run.bind(L),c&&c.suspense):L.run();const V=()=>{L.stop(),c&&c.scope&&mn(c.scope.effects,L)};return E&&E.push(V),V}function ni(e,s,n){const t=this.proxy,o=Z(e)?e.includes(".")?Gt(t,e):()=>t[e]:e.bind(t,t);let a;O(s)?a=s:(a=s.handler,n=s);const i=te;fs(this);const l=Kt(o,a.bind(t),n);return i?fs(i):Ze(),l}function Gt(e,s){const n=s.split(".");return()=>{let t=e;for(let o=0;o<n.length&&t;o++)t=t[n[o]];return t}}function hs(e,s){if(!H(e)||e.__v_skip||(s=s||new Set,s.has(e)))return e;if(s.add(e),de(e))hs(e.value,s);else if(A(e))for(let n=0;n<e.length;n++)hs(e[n],s);else if(pt(e)||as(e))e.forEach(n=>{hs(n,s)});else if(ht(e))for(const n in e)hs(e[n],s);return e}function Ke(e,s,n,t){const o=e.dirs,a=s&&s.dirs;for(let i=0;i<o.length;i++){const l=o[i];a&&(l.oldValue=a[i].value);let c=l.dir[t];c&&(cs(),fe(c,n,8,[e.el,l,e,s]),ps())}}const Ye=Symbol("_leaveCb"),Ks=Symbol("_enterCb");function ti(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return no(()=>{e.isMounted=!0}),to(()=>{e.isUnmounting=!0}),e}const ye=[Function,Array],Xt={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:ye,onEnter:ye,onAfterEnter:ye,onEnterCancelled:ye,onBeforeLeave:ye,onLeave:ye,onAfterLeave:ye,onLeaveCancelled:ye,onBeforeAppear:ye,onAppear:ye,onAfterAppear:ye,onAppearCancelled:ye},oi={name:"BaseTransition",props:Xt,setup(e,{slots:s}){const n=Yi(),t=ti();let o;return()=>{const a=s.default&&eo(s.default(),!0);if(!a||!a.length)return;let i=a[0];if(a.length>1){for(const x of a)if(x.type!==ve){i=x;break}}const l=C(e),{mode:c}=l;if(t.isLeaving)return Hn(i);const u=Qt(i);if(!u)return Hn(i);const h=Mn(u,l,t,n);Yn(u,h);const y=n.subTree,w=y&&Qt(y);let D=!1;const{getTransitionKey:E}=u.type;if(E){const x=E();o===void 0?o=x:x!==o&&(o=x,D=!0)}if(w&&w.type!==ve&&(!Xe(u,w)||D)){const x=Mn(w,l,t,n);if(Yn(w,x),c==="out-in")return t.isLeaving=!0,x.afterLeave=()=>{t.isLeaving=!1,n.update.active!==!1&&n.update()},Hn(i);c==="in-out"&&u.type!==ve&&(x.delayLeave=(Y,W,L)=>{const V=Zt(t,w);V[String(w.key)]=w,Y[Ye]=()=>{W(),Y[Ye]=void 0,delete h.delayedLeave},h.delayedLeave=L})}return i}}};function Zt(e,s){const{leavingVNodes:n}=e;let t=n.get(s.type);return t||(t=Object.create(null),n.set(s.type,t)),t}function Mn(e,s,n,t){const{appear:o,mode:a,persisted:i=!1,onBeforeEnter:l,onEnter:c,onAfterEnter:u,onEnterCancelled:h,onBeforeLeave:y,onLeave:w,onAfterLeave:D,onLeaveCancelled:E,onBeforeAppear:x,onAppear:Y,onAfterAppear:W,onAppearCancelled:L}=s,V=String(e.key),I=Zt(n,e),Q=(q,G)=>{q&&fe(q,t,9,G)},Se=(q,G)=>{const B=G[1];Q(q,G),A(q)?q.every(ie=>ie.length<=1)&&B():q.length<=1&&B()},_e={mode:a,persisted:i,beforeEnter(q){let G=l;if(!n.isMounted)if(o)G=x||l;else return;q[Ye]&&q[Ye](!0);const B=I[V];B&&Xe(e,B)&&B.el[Ye]&&B.el[Ye](),Q(G,[q])},enter(q){let G=c,B=u,ie=h;if(!n.isMounted)if(o)G=Y||c,B=W||u,ie=L||h;else return;let _=!1;const K=q[Ks]=he=>{_||(_=!0,he?Q(ie,[q]):Q(B,[q]),_e.delayedLeave&&_e.delayedLeave(),q[Ks]=void 0)};G?Se(G,[q,K]):K()},leave(q,G){const B=String(e.key);if(q[Ks]&&q[Ks](!0),n.isUnmounting)return G();Q(y,[q]);let ie=!1;const _=q[Ye]=K=>{ie||(ie=!0,G(),K?Q(E,[q]):Q(D,[q]),q[Ye]=void 0,I[B]===e&&delete I[B])};I[B]=e,w?Se(w,[q,_]):_()},clone(q){return Mn(q,s,n,t)}};return _e}function Hn(e){if(Xs(e))return e=Be(e),e.children=null,e}function Qt(e){return Xs(e)?e.children?e.children[0]:void 0:e}function Yn(e,s){e.shapeFlag&6&&e.component?Yn(e.component.subTree,s):e.shapeFlag&128?(e.ssContent.transition=s.clone(e.ssContent),e.ssFallback.transition=s.clone(e.ssFallback)):e.transition=s}function eo(e,s=!1,n){let t=[],o=0;for(let a=0;a<e.length;a++){let i=e[a];const l=n==null?i.key:String(n)+String(i.key!=null?i.key:a);i.type===be?(i.patchFlag&128&&o++,t=t.concat(eo(i.children,s,l))):(s||i.type!==ve)&&t.push(l!=null?Be(i,{key:l}):i)}if(o>1)for(let a=0;a<t.length;a++)t[a].patchFlag=-2;return t}/*! #__NO_SIDE_EFFECTS__ */function Bn(e,s){return O(e)?se({name:e.name},s,{setup:e}):e}const Gs=e=>!!e.type.__asyncLoader,Xs=e=>e.type.__isKeepAlive;function ai(e,s){so(e,"a",s)}function ii(e,s){so(e,"da",s)}function so(e,s,n=te){const t=e.__wdc||(e.__wdc=()=>{let o=n;for(;o;){if(o.isDeactivated)return;o=o.parent}return e()});if(Zs(s,t,n),n){let o=n.parent;for(;o&&o.parent;)Xs(o.parent.vnode)&&ri(t,s,n,o),o=o.parent}}function ri(e,s,n,t){const o=Zs(s,e,t,!0);oo(()=>{mn(t[s],o)},n)}function Zs(e,s,n=te,t=!1){if(n){const o=n[e]||(n[e]=[]),a=s.__weh||(s.__weh=(...i)=>{if(n.isUnmounted)return;cs(),fs(n);const l=fe(s,n,e,i);return Ze(),ps(),l});return t?o.unshift(a):o.push(a),a}}const Ee=e=>(s,n=te)=>(!Ds||e==="sp")&&Zs(e,(...t)=>s(...t),n),li=Ee("bm"),no=Ee("m"),ci=Ee("bu"),pi=Ee("u"),to=Ee("bum"),oo=Ee("um"),ui=Ee("sp"),di=Ee("rtg"),hi=Ee("rtc");function mi(e,s=te){Zs("ec",e,s)}function ao(e,s,n,t){let o;const a=n&&n[t];if(A(e)||Z(e)){o=new Array(e.length);for(let i=0,l=e.length;i<l;i++)o[i]=s(e[i],i,void 0,a&&a[i])}else if(typeof e=="number"){o=new Array(e);for(let i=0;i<e;i++)o[i]=s(i+1,i,void 0,a&&a[i])}else if(H(e))if(e[Symbol.iterator])o=Array.from(e,(i,l)=>s(i,l,void 0,a&&a[l]));else{const i=Object.keys(e);o=new Array(i.length);for(let l=0,c=i.length;l<c;l++){const u=i[l];o[l]=s(e[u],u,l,a&&a[l])}}else o=[];return n&&(n[t]=o),o}const Un=e=>e?Do(e)?nt(e)||e.proxy:Un(e.parent):null,Ss=se(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Un(e.parent),$root:e=>Un(e.root),$emit:e=>e.emit,$options:e=>Vn(e),$forceUpdate:e=>e.f||(e.f=()=>En(e.update)),$nextTick:e=>e.n||(e.n=Ya.bind(e.proxy)),$watch:e=>ni.bind(e)}),Ln=(e,s)=>e!==U&&!e.__isScriptSetup&&P(e,s),fi={get({_:e},s){const{ctx:n,setupState:t,data:o,props:a,accessCache:i,type:l,appContext:c}=e;let u;if(s[0]!=="$"){const D=i[s];if(D!==void 0)switch(D){case 1:return t[s];case 2:return o[s];case 4:return n[s];case 3:return a[s]}else{if(Ln(t,s))return i[s]=1,t[s];if(o!==U&&P(o,s))return i[s]=2,o[s];if((u=e.propsOptions[0])&&P(u,s))return i[s]=3,a[s];if(n!==U&&P(n,s))return i[s]=4,n[s];Wn&&(i[s]=0)}}const h=Ss[s];let y,w;if(h)return s==="$attrs"&&ce(e,"get",s),h(e);if((y=l.__cssModules)&&(y=y[s]))return y;if(n!==U&&P(n,s))return i[s]=4,n[s];if(w=c.config.globalProperties,P(w,s))return w[s]},set({_:e},s,n){const{data:t,setupState:o,ctx:a}=e;return Ln(o,s)?(o[s]=n,!0):t!==U&&P(t,s)?(t[s]=n,!0):P(e.props,s)||s[0]==="$"&&s.slice(1)in e?!1:(a[s]=n,!0)},has({_:{data:e,setupState:s,accessCache:n,ctx:t,appContext:o,propsOptions:a}},i){let l;return!!n[i]||e!==U&&P(e,i)||Ln(s,i)||(l=a[0])&&P(l,i)||P(t,i)||P(Ss,i)||P(o.config.globalProperties,i)},defineProperty(e,s,n){return n.get!=null?e._.accessCache[s]=0:P(n,"value")&&this.set(e,s,n.value,null),Reflect.defineProperty(e,s,n)}};function io(e){return A(e)?e.reduce((s,n)=>(s[n]=null,s),{}):e}let Wn=!0;function gi(e){const s=Vn(e),n=e.proxy,t=e.ctx;Wn=!1,s.beforeCreate&&ro(s.beforeCreate,e,"bc");const{data:o,computed:a,methods:i,watch:l,provide:c,inject:u,created:h,beforeMount:y,mounted:w,beforeUpdate:D,updated:E,activated:x,deactivated:Y,beforeDestroy:W,beforeUnmount:L,destroyed:V,unmounted:I,render:Q,renderTracked:Se,renderTriggered:_e,errorCaptured:q,serverPrefetch:G,expose:B,inheritAttrs:ie,components:_,directives:K,filters:he}=s;if(u&&yi(u,t,null),i)for(const X in i){const F=i[X];O(F)&&(t[X]=F.bind(n))}if(o){const X=o.call(n,n);H(X)&&(e.data=xn(X))}if(Wn=!0,a)for(const X in a){const F=a[X],ns=O(F)?F.bind(n,n):O(F.get)?F.get.bind(n,n):ke,pn=!O(F)&&O(F.set)?F.set.bind(n):ke,ts=Ki({get:ns,set:pn});Object.defineProperty(t,X,{enumerable:!0,configurable:!0,get:()=>ts.value,set:Oe=>ts.value=Oe})}if(l)for(const X in l)lo(l[X],t,n,X);if(c){const X=O(c)?c.call(n):c;Reflect.ownKeys(X).forEach(F=>{Si(F,X[F])})}h&&ro(h,e,"c");function oe(X,F){A(F)?F.forEach(ns=>X(ns.bind(n))):F&&X(F.bind(n))}if(oe(li,y),oe(no,w),oe(ci,D),oe(pi,E),oe(ai,x),oe(ii,Y),oe(mi,q),oe(hi,Se),oe(di,_e),oe(to,L),oe(oo,I),oe(ui,G),A(B))if(B.length){const X=e.exposed||(e.exposed={});B.forEach(F=>{Object.defineProperty(X,F,{get:()=>n[F],set:ns=>n[F]=ns})})}else e.exposed||(e.exposed={});Q&&e.render===ke&&(e.render=Q),ie!=null&&(e.inheritAttrs=ie),_&&(e.components=_),K&&(e.directives=K)}function yi(e,s,n=ke){A(e)&&(e=$n(e));for(const t in e){const o=e[t];let a;H(o)?"default"in o?a=sn(o.from||t,o.default,!0):a=sn(o.from||t):a=sn(o),de(a)?Object.defineProperty(s,t,{enumerable:!0,configurable:!0,get:()=>a.value,set:i=>a.value=i}):s[t]=a}}function ro(e,s,n){fe(A(e)?e.map(t=>t.bind(s.proxy)):e.bind(s.proxy),s,n)}function lo(e,s,n,t){const o=t.includes(".")?Gt(n,t):()=>n[t];if(Z(e)){const a=s[e];O(a)&&Fn(o,a)}else if(O(e))Fn(o,e.bind(n));else if(H(e))if(A(e))e.forEach(a=>lo(a,s,n,t));else{const a=O(e.handler)?e.handler.bind(n):s[e.handler];O(a)&&Fn(o,a,e)}}function Vn(e){const s=e.type,{mixins:n,extends:t}=s,{mixins:o,optionsCache:a,config:{optionMergeStrategies:i}}=e.appContext,l=a.get(s);let c;return l?c=l:!o.length&&!n&&!t?c=s:(c={},o.length&&o.forEach(u=>Qs(c,u,i,!0)),Qs(c,s,i)),H(s)&&a.set(s,c),c}function Qs(e,s,n,t=!1){const{mixins:o,extends:a}=s;a&&Qs(e,a,n,!0),o&&o.forEach(i=>Qs(e,i,n,!0));for(const i in s)if(!(t&&i==="expose")){const l=bi[i]||n&&n[i];e[i]=l?l(e[i],s[i]):s[i]}return e}const bi={data:co,props:po,emits:po,methods:_s,computed:_s,beforeCreate:re,created:re,beforeMount:re,mounted:re,beforeUpdate:re,updated:re,beforeDestroy:re,beforeUnmount:re,destroyed:re,unmounted:re,activated:re,deactivated:re,errorCaptured:re,serverPrefetch:re,components:_s,directives:_s,watch:wi,provide:co,inject:ji};function co(e,s){return s?e?function(){return se(O(e)?e.call(this,this):e,O(s)?s.call(this,this):s)}:s:e}function ji(e,s){return _s($n(e),$n(s))}function $n(e){if(A(e)){const s={};for(let n=0;n<e.length;n++)s[e[n]]=e[n];return s}return e}function re(e,s){return e?[...new Set([].concat(e,s))]:s}function _s(e,s){return e?se(Object.create(null),e,s):s}function po(e,s){return e?A(e)&&A(s)?[...new Set([...e,...s])]:se(Object.create(null),io(e),io(s??{})):s}function wi(e,s){if(!e)return s;if(!s)return e;const n=se(Object.create(null),e);for(const t in s)n[t]=re(e[t],s[t]);return n}function uo(){return{app:null,config:{isNativeTag:Zo,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let vi=0;function Ji(e,s){return function(t,o=null){O(t)||(t=se({},t)),o!=null&&!H(o)&&(o=null);const a=uo(),i=new WeakSet;let l=!1;const c=a.app={_uid:vi++,_component:t,_props:o,_container:null,_context:a,_instance:null,version:Qi,get config(){return a.config},set config(u){},use(u,...h){return i.has(u)||(u&&O(u.install)?(i.add(u),u.install(c,...h)):O(u)&&(i.add(u),u(c,...h))),c},mixin(u){return a.mixins.includes(u)||a.mixins.push(u),c},component(u,h){return h?(a.components[u]=h,c):a.components[u]},directive(u,h){return h?(a.directives[u]=h,c):a.directives[u]},mount(u,h,y){if(!l){const w=le(t,o);return w.appContext=a,h&&s?s(w,u):e(w,u,y),l=!0,c._container=u,u.__vue_app__=c,nt(w.component)||w.component.proxy}},unmount(){l&&(e(null,c._container),delete c._container.__vue_app__)},provide(u,h){return a.provides[u]=h,c},runWithContext(u){en=c;try{return u()}finally{en=null}}};return c}}let en=null;function Si(e,s){if(te){let n=te.provides;const t=te.parent&&te.parent.provides;t===n&&(n=te.provides=Object.create(t)),n[e]=s}}function sn(e,s,n=!1){const t=te||ge;if(t||en){const o=t?t.parent==null?t.vnode.appContext&&t.vnode.appContext.provides:t.parent.provides:en._context.provides;if(o&&e in o)return o[e];if(arguments.length>1)return n&&O(s)?s.call(t&&t.proxy):s}}function _i(e,s,n,t=!1){const o={},a={};Cs(a,an,1),e.propsDefaults=Object.create(null),ho(e,s,o,a);for(const i in e.propsOptions[0])i in o||(o[i]=void 0);n?e.props=t?o:za(o):e.type.props?e.props=o:e.props=a,e.attrs=a}function Ti(e,s,n,t){const{props:o,attrs:a,vnode:{patchFlag:i}}=e,l=C(o),[c]=e.propsOptions;let u=!1;if((t||i>0)&&!(i&16)){if(i&8){const h=e.vnode.dynamicProps;for(let y=0;y<h.length;y++){let w=h[y];if(Ws(e.emitsOptions,w))continue;const D=s[w];if(c)if(P(a,w))D!==a[w]&&(a[w]=D,u=!0);else{const E=De(w);o[E]=Kn(c,l,E,D,e,!1)}else D!==a[w]&&(a[w]=D,u=!0)}}}else{ho(e,s,o,a)&&(u=!0);let h;for(const y in l)(!s||!P(s,y)&&((h=rs(y))===y||!P(s,h)))&&(c?n&&(n[y]!==void 0||n[h]!==void 0)&&(o[y]=Kn(c,l,y,void 0,e,!0)):delete o[y]);if(a!==l)for(const y in a)(!s||!P(s,y))&&(delete a[y],u=!0)}u&&ze(e,"set","$attrs")}function ho(e,s,n,t){const[o,a]=e.propsOptions;let i=!1,l;if(s)for(let c in s){if(zs(c))continue;const u=s[c];let h;o&&P(o,h=De(c))?!a||!a.includes(h)?n[h]=u:(l||(l={}))[h]=u:Ws(e.emitsOptions,c)||(!(c in t)||u!==t[c])&&(t[c]=u,i=!0)}if(a){const c=C(n),u=l||U;for(let h=0;h<a.length;h++){const y=a[h];n[y]=Kn(o,c,y,u[y],e,!P(u,y))}}return i}function Kn(e,s,n,t,o,a){const i=e[n];if(i!=null){const l=P(i,"default");if(l&&t===void 0){const c=i.default;if(i.type!==Function&&!i.skipFactory&&O(c)){const{propsDefaults:u}=o;n in u?t=u[n]:(fs(o),t=u[n]=c.call(null,s),Ze())}else t=c}i[0]&&(a&&!l?t=!1:i[1]&&(t===""||t===rs(n))&&(t=!0))}return t}function mo(e,s,n=!1){const t=s.propsCache,o=t.get(e);if(o)return o;const a=e.props,i={},l=[];let c=!1;if(!O(e)){const h=y=>{c=!0;const[w,D]=mo(y,s,!0);se(i,w),D&&l.push(...D)};!n&&s.mixins.length&&s.mixins.forEach(h),e.extends&&h(e.extends),e.mixins&&e.mixins.forEach(h)}if(!a&&!c)return H(e)&&t.set(e,os),os;if(A(a))for(let h=0;h<a.length;h++){const y=De(a[h]);fo(y)&&(i[y]=U)}else if(a)for(const h in a){const y=De(h);if(fo(y)){const w=a[h],D=i[y]=A(w)||O(w)?{type:w}:se({},w);if(D){const E=bo(Boolean,D.type),x=bo(String,D.type);D[0]=E>-1,D[1]=x<0||E<x,(E>-1||P(D,"default"))&&l.push(y)}}}const u=[i,l];return H(e)&&t.set(e,u),u}function fo(e){return e[0]!=="$"}function go(e){const s=e&&e.toString().match(/^\s*(function|class) (\w+)/);return s?s[2]:e===null?"null":""}function yo(e,s){return go(e)===go(s)}function bo(e,s){return A(s)?s.findIndex(n=>yo(n,e)):O(s)&&yo(s,e)?0:-1}const jo=e=>e[0]==="_"||e==="$stable",Gn=e=>A(e)?e.map(Ie):[Ie(e)],ki=(e,s,n)=>{if(s._n)return s;const t=Lt((...o)=>Gn(s(...o)),n);return t._c=!1,t},wo=(e,s,n)=>{const t=e._ctx;for(const o in e){if(jo(o))continue;const a=e[o];if(O(a))s[o]=ki(o,a,t);else if(a!=null){const i=Gn(a);s[o]=()=>i}}},vo=(e,s)=>{const n=Gn(s);e.slots.default=()=>n},Di=(e,s)=>{if(e.vnode.shapeFlag&32){const n=s._;n?(e.slots=C(s),Cs(s,"_",n)):wo(s,e.slots={})}else e.slots={},s&&vo(e,s);Cs(e.slots,an,1)},Ai=(e,s,n)=>{const{vnode:t,slots:o}=e;let a=!0,i=U;if(t.shapeFlag&32){const l=s._;l?n&&l===1?a=!1:(se(o,s),!n&&l===1&&delete o._):(a=!s.$stable,wo(s,o)),i=s}else s&&(vo(e,s),i={default:1});if(a)for(const l in o)!jo(l)&&i[l]==null&&delete o[l]};function Xn(e,s,n,t,o=!1){if(A(e)){e.forEach((w,D)=>Xn(w,s&&(A(s)?s[D]:s),n,t,o));return}if(Gs(t)&&!o)return;const a=t.shapeFlag&4?nt(t.component)||t.component.proxy:t.el,i=o?null:a,{i:l,r:c}=e,u=s&&s.r,h=l.refs===U?l.refs={}:l.refs,y=l.setupState;if(u!=null&&u!==c&&(Z(u)?(h[u]=null,P(y,u)&&(y[u]=null)):de(u)&&(u.value=null)),O(c))He(c,l,12,[i,h]);else{const w=Z(c),D=de(c);if(w||D){const E=()=>{if(e.f){const x=w?P(y,c)?y[c]:h[c]:c.value;o?A(x)&&mn(x,a):A(x)?x.includes(a)||x.push(a):w?(h[c]=[a],P(y,c)&&(y[c]=h[c])):(c.value=[a],e.k&&(h[e.k]=c.value))}else w?(h[c]=i,P(y,c)&&(y[c]=i)):D&&(c.value=i,e.k&&(h[e.k]=i))};i?(E.id=-1,pe(E,n)):E()}}}const pe=si;function xi(e){return Ii(e)}function Ii(e,s){const n=bn();n.__VUE__=!0;const{insert:t,remove:o,patchProp:a,createElement:i,createText:l,createComment:c,setText:u,setElementText:h,parentNode:y,nextSibling:w,setScopeId:D=ke,insertStaticContent:E}=e,x=(r,p,d,m=null,f=null,j=null,J=!1,b=null,v=!!p.dynamicChildren)=>{if(r===p)return;r&&!Xe(r,p)&&(m=un(r),Oe(r,f,j,!0),r=null),p.patchFlag===-2&&(v=!1,p.dynamicChildren=null);const{type:g,ref:T,shapeFlag:S}=p;switch(g){case nn:Y(r,p,d,m);break;case ve:W(r,p,d,m);break;case tn:r==null&&L(p,d,m,J);break;case be:_(r,p,d,m,f,j,J,b,v);break;default:S&1?Q(r,p,d,m,f,j,J,b,v):S&6?K(r,p,d,m,f,j,J,b,v):(S&64||S&128)&&g.process(r,p,d,m,f,j,J,b,v,gs)}T!=null&&f&&Xn(T,r&&r.ref,j,p||r,!p)},Y=(r,p,d,m)=>{if(r==null)t(p.el=l(p.children),d,m);else{const f=p.el=r.el;p.children!==r.children&&u(f,p.children)}},W=(r,p,d,m)=>{r==null?t(p.el=c(p.children||""),d,m):p.el=r.el},L=(r,p,d,m)=>{[r.el,r.anchor]=E(r.children,p,d,m,r.el,r.anchor)},V=({el:r,anchor:p},d,m)=>{let f;for(;r&&r!==p;)f=w(r),t(r,d,m),r=f;t(p,d,m)},I=({el:r,anchor:p})=>{let d;for(;r&&r!==p;)d=w(r),o(r),r=d;o(p)},Q=(r,p,d,m,f,j,J,b,v)=>{J=J||p.type==="svg",r==null?Se(p,d,m,f,j,J,b,v):G(r,p,f,j,J,b,v)},Se=(r,p,d,m,f,j,J,b)=>{let v,g;const{type:T,props:S,shapeFlag:k,transition:N,dirs:z}=r;if(v=r.el=i(r.type,j,S&&S.is,S),k&8?h(v,r.children):k&16&&q(r.children,v,null,m,f,j&&T!=="foreignObject",J,b),z&&Ke(r,null,m,"created"),_e(v,r,r.scopeId,J,m),S){for(const R in S)R!=="value"&&!zs(R)&&a(v,R,null,S[R],j,r.children,m,f,Ce);"value"in S&&a(v,"value",null,S.value),(g=S.onVnodeBeforeMount)&&Ne(g,m,r)}z&&Ke(r,null,m,"beforeMount");const M=Ni(f,N);M&&N.beforeEnter(v),t(v,p,d),((g=S&&S.onVnodeMounted)||M||z)&&pe(()=>{g&&Ne(g,m,r),M&&N.enter(v),z&&Ke(r,null,m,"mounted")},f)},_e=(r,p,d,m,f)=>{if(d&&D(r,d),m)for(let j=0;j<m.length;j++)D(r,m[j]);if(f){let j=f.subTree;if(p===j){const J=f.vnode;_e(r,J,J.scopeId,J.slotScopeIds,f.parent)}}},q=(r,p,d,m,f,j,J,b,v=0)=>{for(let g=v;g<r.length;g++){const T=r[g]=b?Ue(r[g]):Ie(r[g]);x(null,T,p,d,m,f,j,J,b)}},G=(r,p,d,m,f,j,J)=>{const b=p.el=r.el;let{patchFlag:v,dynamicChildren:g,dirs:T}=p;v|=r.patchFlag&16;const S=r.props||U,k=p.props||U;let N;d&&Ge(d,!1),(N=k.onVnodeBeforeUpdate)&&Ne(N,d,p,r),T&&Ke(p,r,d,"beforeUpdate"),d&&Ge(d,!0);const z=f&&p.type!=="foreignObject";if(g?B(r.dynamicChildren,g,b,d,m,z,j):J||F(r,p,b,null,d,m,z,j,!1),v>0){if(v&16)ie(b,p,S,k,d,m,f);else if(v&2&&S.class!==k.class&&a(b,"class",null,k.class,f),v&4&&a(b,"style",S.style,k.style,f),v&8){const M=p.dynamicProps;for(let R=0;R<M.length;R++){const ee=M[R],Te=S[ee],ys=k[ee];(ys!==Te||ee==="value")&&a(b,ee,Te,ys,f,r.children,d,m,Ce)}}v&1&&r.children!==p.children&&h(b,p.children)}else!J&&g==null&&ie(b,p,S,k,d,m,f);((N=k.onVnodeUpdated)||T)&&pe(()=>{N&&Ne(N,d,p,r),T&&Ke(p,r,d,"updated")},m)},B=(r,p,d,m,f,j,J)=>{for(let b=0;b<p.length;b++){const v=r[b],g=p[b],T=v.el&&(v.type===be||!Xe(v,g)||v.shapeFlag&70)?y(v.el):d;x(v,g,T,null,m,f,j,J,!0)}},ie=(r,p,d,m,f,j,J)=>{if(d!==m){if(d!==U)for(const b in d)!zs(b)&&!(b in m)&&a(r,b,d[b],null,J,p.children,f,j,Ce);for(const b in m){if(zs(b))continue;const v=m[b],g=d[b];v!==g&&b!=="value"&&a(r,b,g,v,J,p.children,f,j,Ce)}"value"in m&&a(r,"value",d.value,m.value)}},_=(r,p,d,m,f,j,J,b,v)=>{const g=p.el=r?r.el:l(""),T=p.anchor=r?r.anchor:l("");let{patchFlag:S,dynamicChildren:k,slotScopeIds:N}=p;N&&(b=b?b.concat(N):N),r==null?(t(g,d,m),t(T,d,m),q(p.children,d,T,f,j,J,b,v)):S>0&&S&64&&k&&r.dynamicChildren?(B(r.dynamicChildren,k,d,f,j,J,b),(p.key!=null||f&&p===f.subTree)&&Jo(r,p,!0)):F(r,p,d,T,f,j,J,b,v)},K=(r,p,d,m,f,j,J,b,v)=>{p.slotScopeIds=b,r==null?p.shapeFlag&512?f.ctx.activate(p,d,m,J,v):he(p,d,m,f,j,J,v):Is(r,p,v)},he=(r,p,d,m,f,j,J)=>{const b=r.component=Hi(r,m,f);if(Xs(r)&&(b.ctx.renderer=gs),Bi(b),b.asyncDep){if(f&&f.registerDep(b,oe),!r.el){const v=b.subTree=le(ve);W(null,v,p,d)}return}oe(b,r,p,d,f,j,J)},Is=(r,p,d)=>{const m=p.component=r.component;if(Ga(r,p,d))if(m.asyncDep&&!m.asyncResolved){X(m,p,d);return}else m.next=p,Ua(m.update),m.update();else p.el=r.el,m.vnode=p},oe=(r,p,d,m,f,j,J)=>{const b=()=>{if(r.isMounted){let{next:T,bu:S,u:k,parent:N,vnode:z}=r,M=T,R;Ge(r,!1),T?(T.el=z.el,X(r,T,J)):T=z,S&&yn(S),(R=T.props&&T.props.onVnodeBeforeUpdate)&&Ne(R,N,T,z),Ge(r,!0);const ee=Cn(r),Te=r.subTree;r.subTree=ee,x(Te,ee,y(Te.el),un(Te),r,f,j),T.el=ee.el,M===null&&Xa(r,ee.el),k&&pe(k,f),(R=T.props&&T.props.onVnodeUpdated)&&pe(()=>Ne(R,N,T,z),f)}else{let T;const{el:S,props:k}=p,{bm:N,m:z,parent:M}=r,R=Gs(p);if(Ge(r,!1),N&&yn(N),!R&&(T=k&&k.onVnodeBeforeMount)&&Ne(T,M,p),Ge(r,!0),S&&ct){const ee=()=>{r.subTree=Cn(r),ct(S,r.subTree,r,f,null)};R?p.type.__asyncLoader().then(()=>!r.isUnmounted&&ee()):ee()}else{const ee=r.subTree=Cn(r);x(null,ee,d,m,r,f,j),p.el=ee.el}if(z&&pe(z,f),!R&&(T=k&&k.onVnodeMounted)){const ee=p;pe(()=>Ne(T,M,ee),f)}(p.shapeFlag&256||M&&Gs(M.vnode)&&M.vnode.shapeFlag&256)&&r.a&&pe(r.a,f),r.isMounted=!0,p=d=m=null}},v=r.effect=new Tn(b,()=>En(g),r.scope),g=r.update=()=>v.run();g.id=r.uid,Ge(r,!0),g()},X=(r,p,d)=>{p.component=r;const m=r.vnode.props;r.vnode=p,r.next=null,Ti(r,p.props,m,d),Ai(r,p.children,d),cs(),Mt(r),ps()},F=(r,p,d,m,f,j,J,b,v=!1)=>{const g=r&&r.children,T=r?r.shapeFlag:0,S=p.children,{patchFlag:k,shapeFlag:N}=p;if(k>0){if(k&128){pn(g,S,d,m,f,j,J,b,v);return}else if(k&256){ns(g,S,d,m,f,j,J,b,v);return}}N&8?(T&16&&Ce(g,f,j),S!==g&&h(d,S)):T&16?N&16?pn(g,S,d,m,f,j,J,b,v):Ce(g,f,j,!0):(T&8&&h(d,""),N&16&&q(S,d,m,f,j,J,b,v))},ns=(r,p,d,m,f,j,J,b,v)=>{r=r||os,p=p||os;const g=r.length,T=p.length,S=Math.min(g,T);let k;for(k=0;k<S;k++){const N=p[k]=v?Ue(p[k]):Ie(p[k]);x(r[k],N,d,null,f,j,J,b,v)}g>T?Ce(r,f,j,!0,!1,S):q(p,d,m,f,j,J,b,v,S)},pn=(r,p,d,m,f,j,J,b,v)=>{let g=0;const T=p.length;let S=r.length-1,k=T-1;for(;g<=S&&g<=k;){const N=r[g],z=p[g]=v?Ue(p[g]):Ie(p[g]);if(Xe(N,z))x(N,z,d,null,f,j,J,b,v);else break;g++}for(;g<=S&&g<=k;){const N=r[S],z=p[k]=v?Ue(p[k]):Ie(p[k]);if(Xe(N,z))x(N,z,d,null,f,j,J,b,v);else break;S--,k--}if(g>S){if(g<=k){const N=k+1,z=N<T?p[N].el:m;for(;g<=k;)x(null,p[g]=v?Ue(p[g]):Ie(p[g]),d,z,f,j,J,b,v),g++}}else if(g>k)for(;g<=S;)Oe(r[g],f,j,!0),g++;else{const N=g,z=g,M=new Map;for(g=z;g<=k;g++){const me=p[g]=v?Ue(p[g]):Ie(p[g]);me.key!=null&&M.set(me.key,g)}let R,ee=0;const Te=k-z+1;let ys=!1,Ko=0;const Ns=new Array(Te);for(g=0;g<Te;g++)Ns[g]=0;for(g=N;g<=S;g++){const me=r[g];if(ee>=Te){Oe(me,f,j,!0);continue}let qe;if(me.key!=null)qe=M.get(me.key);else for(R=z;R<=k;R++)if(Ns[R-z]===0&&Xe(me,p[R])){qe=R;break}qe===void 0?Oe(me,f,j,!0):(Ns[qe-z]=g+1,qe>=Ko?Ko=qe:ys=!0,x(me,p[qe],d,null,f,j,J,b,v),ee++)}const Go=ys?Oi(Ns):os;for(R=Go.length-1,g=Te-1;g>=0;g--){const me=z+g,qe=p[me],Xo=me+1<T?p[me+1].el:m;Ns[g]===0?x(null,qe,d,Xo,f,j,J,b,v):ys&&(R<0||g!==Go[R]?ts(qe,d,Xo,2):R--)}}},ts=(r,p,d,m,f=null)=>{const{el:j,type:J,transition:b,children:v,shapeFlag:g}=r;if(g&6){ts(r.component.subTree,p,d,m);return}if(g&128){r.suspense.move(p,d,m);return}if(g&64){J.move(r,p,d,gs);return}if(J===be){t(j,p,d);for(let S=0;S<v.length;S++)ts(v[S],p,d,m);t(r.anchor,p,d);return}if(J===tn){V(r,p,d);return}if(m!==2&&g&1&&b)if(m===0)b.beforeEnter(j),t(j,p,d),pe(()=>b.enter(j),f);else{const{leave:S,delayLeave:k,afterLeave:N}=b,z=()=>t(j,p,d),M=()=>{S(j,()=>{z(),N&&N()})};k?k(j,z,M):M()}else t(j,p,d)},Oe=(r,p,d,m=!1,f=!1)=>{const{type:j,props:J,ref:b,children:v,dynamicChildren:g,shapeFlag:T,patchFlag:S,dirs:k}=r;if(b!=null&&Xn(b,null,d,r,!0),T&256){p.ctx.deactivate(r);return}const N=T&1&&k,z=!Gs(r);let M;if(z&&(M=J&&J.onVnodeBeforeUnmount)&&Ne(M,p,r),T&6)cl(r.component,d,m);else{if(T&128){r.suspense.unmount(d,m);return}N&&Ke(r,null,p,"beforeUnmount"),T&64?r.type.remove(r,p,d,f,gs,m):g&&(j!==be||S>0&&S&64)?Ce(g,p,d,!1,!0):(j===be&&S&384||!f&&T&16)&&Ce(v,p,d),m&&Vo(r)}(z&&(M=J&&J.onVnodeUnmounted)||N)&&pe(()=>{M&&Ne(M,p,r),N&&Ke(r,null,p,"unmounted")},d)},Vo=r=>{const{type:p,el:d,anchor:m,transition:f}=r;if(p===be){ll(d,m);return}if(p===tn){I(r);return}const j=()=>{o(d),f&&!f.persisted&&f.afterLeave&&f.afterLeave()};if(r.shapeFlag&1&&f&&!f.persisted){const{leave:J,delayLeave:b}=f,v=()=>J(d,j);b?b(r.el,j,v):v()}else j()},ll=(r,p)=>{let d;for(;r!==p;)d=w(r),o(r),r=d;o(p)},cl=(r,p,d)=>{const{bum:m,scope:f,update:j,subTree:J,um:b}=r;m&&yn(m),f.stop(),j&&(j.active=!1,Oe(J,r,p,d)),b&&pe(b,p),pe(()=>{r.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&r.asyncDep&&!r.asyncResolved&&r.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},Ce=(r,p,d,m=!1,f=!1,j=0)=>{for(let J=j;J<r.length;J++)Oe(r[J],p,d,m,f)},un=r=>r.shapeFlag&6?un(r.component.subTree):r.shapeFlag&128?r.suspense.next():w(r.anchor||r.el),$o=(r,p,d)=>{r==null?p._vnode&&Oe(p._vnode,null,null,!0):x(p._vnode||null,r,p,null,null,null,d),Mt(),Ht(),p._vnode=r},gs={p:x,um:Oe,m:ts,r:Vo,mt:he,mc:q,pc:F,pbc:B,n:un,o:e};let lt,ct;return s&&([lt,ct]=s(gs)),{render:$o,hydrate:lt,createApp:Ji($o,lt)}}function Ge({effect:e,update:s},n){e.allowRecurse=s.allowRecurse=n}function Ni(e,s){return(!e||e&&!e.pendingBranch)&&s&&!s.persisted}function Jo(e,s,n=!1){const t=e.children,o=s.children;if(A(t)&&A(o))for(let a=0;a<t.length;a++){const i=t[a];let l=o[a];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=o[a]=Ue(o[a]),l.el=i.el),n||Jo(i,l)),l.type===nn&&(l.el=i.el)}}function Oi(e){const s=e.slice(),n=[0];let t,o,a,i,l;const c=e.length;for(t=0;t<c;t++){const u=e[t];if(u!==0){if(o=n[n.length-1],e[o]<u){s[t]=o,n.push(t);continue}for(a=0,i=n.length-1;a<i;)l=a+i>>1,e[n[l]]<u?a=l+1:i=l;u<e[n[a]]&&(a>0&&(s[t]=n[a-1]),n[a]=t)}}for(a=n.length,i=n[a-1];a-- >0;)n[a]=i,i=s[i];return n}const qi=e=>e.__isTeleport,be=Symbol.for("v-fgt"),nn=Symbol.for("v-txt"),ve=Symbol.for("v-cmt"),tn=Symbol.for("v-stc"),Ts=[];let Je=null;function ue(e=!1){Ts.push(Je=e?null:[])}function zi(){Ts.pop(),Je=Ts[Ts.length-1]||null}let ks=1;function So(e){ks+=e}function _o(e){return e.dynamicChildren=ks>0?Je||os:null,zi(),ks>0&&Je&&Je.push(e),e}function xe(e,s,n,t,o,a){return _o(ne(e,s,n,t,o,a,!0))}function on(e,s,n,t,o){return _o(le(e,s,n,t,o,!0))}function Zn(e){return e?e.__v_isVNode===!0:!1}function Xe(e,s){return e.type===s.type&&e.key===s.key}const an="__vInternal",To=({key:e})=>e??null,rn=({ref:e,ref_key:s,ref_for:n})=>(typeof e=="number"&&(e=""+e),e!=null?Z(e)||de(e)||O(e)?{i:ge,r:e,k:s,f:!!n}:e:null);function ne(e,s=null,n=null,t=0,o=null,a=e===be?0:1,i=!1,l=!1){const c={__v_isVNode:!0,__v_skip:!0,type:e,props:s,key:s&&To(s),ref:s&&rn(s),scopeId:Ut,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:a,patchFlag:t,dynamicProps:o,dynamicChildren:null,appContext:null,ctx:ge};return l?(et(c,n),a&128&&e.normalize(c)):n&&(c.shapeFlag|=Z(n)?8:16),ks>0&&!i&&Je&&(c.patchFlag>0||a&6)&&c.patchFlag!==32&&Je.push(c),c}const le=Pi;function Pi(e,s=null,n=null,t=0,o=null,a=!1){if((!e||e===Za)&&(e=ve),Zn(e)){const l=Be(e,s,!0);return n&&et(l,n),ks>0&&!a&&Je&&(l.shapeFlag&6?Je[Je.indexOf(e)]=l:Je.push(l)),l.patchFlag|=-2,l}if($i(e)&&(e=e.__vccOpts),s){s=Ei(s);let{class:l,style:c}=s;l&&!Z(l)&&(s.class=bs(l)),H(c)&&(Pt(c)&&!A(c)&&(c=se({},c)),s.style=jn(c))}const i=Z(e)?1:ei(e)?128:qi(e)?64:H(e)?4:O(e)?2:0;return ne(e,s,n,t,o,i,a,!0)}function Ei(e){return e?Pt(e)||an in e?se({},e):e:null}function Be(e,s,n=!1){const{props:t,ref:o,patchFlag:a,children:i}=e,l=s?Ri(t||{},s):t;return{__v_isVNode:!0,__v_skip:!0,type:e.type,props:l,key:l&&To(l),ref:s&&s.ref?n&&o?A(o)?o.concat(rn(s)):[o,rn(s)]:rn(s):o,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:i,target:e.target,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:s&&e.type!==be?a===-1?16:a|16:a,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:e.transition,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Be(e.ssContent),ssFallback:e.ssFallback&&Be(e.ssFallback),el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce}}function ln(e=" ",s=0){return le(nn,null,e,s)}function Ci(e,s){const n=le(tn,null,e);return n.staticCount=s,n}function Qn(e="",s=!1){return s?(ue(),on(ve,null,e)):le(ve,null,e)}function Ie(e){return e==null||typeof e=="boolean"?le(ve):A(e)?le(be,null,e.slice()):typeof e=="object"?Ue(e):le(nn,null,String(e))}function Ue(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Be(e)}function et(e,s){let n=0;const{shapeFlag:t}=e;if(s==null)s=null;else if(A(s))n=16;else if(typeof s=="object")if(t&65){const o=s.default;o&&(o._c&&(o._d=!1),et(e,o()),o._c&&(o._d=!0));return}else{n=32;const o=s._;!o&&!(an in s)?s._ctx=ge:o===3&&ge&&(ge.slots._===1?s._=1:(s._=2,e.patchFlag|=1024))}else O(s)?(s={default:s,_ctx:ge},n=32):(s=String(s),t&64?(n=16,s=[ln(s)]):n=8);e.children=s,e.shapeFlag|=n}function Ri(...e){const s={};for(let n=0;n<e.length;n++){const t=e[n];for(const o in t)if(o==="class")s.class!==t.class&&(s.class=bs([s.class,t.class]));else if(o==="style")s.style=jn([s.style,t.style]);else if(Os(o)){const a=s[o],i=t[o];i&&a!==i&&!(A(a)&&a.includes(i))&&(s[o]=a?[].concat(a,i):i)}else o!==""&&(s[o]=t[o])}return s}function Ne(e,s,n,t=null){fe(e,s,7,[n,t])}const Fi=uo();let Mi=0;function Hi(e,s,n){const t=e.type,o=(s?s.appContext:e.appContext)||Fi,a={uid:Mi++,vnode:e,type:t,parent:s,appContext:o,root:null,next:null,subTree:null,effect:null,update:null,scope:new pa(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:s?s.provides:Object.create(o.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:mo(t,o),emitsOptions:Bt(t,o),emit:null,emitted:null,propsDefaults:U,inheritAttrs:t.inheritAttrs,ctx:U,data:U,props:U,attrs:U,slots:U,refs:U,setupState:U,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return a.ctx={_:a},a.root=s?s.root:a,a.emit=Va.bind(null,a),e.ce&&e.ce(a),a}let te=null;const Yi=()=>te||ge;let st,ms,ko="__VUE_INSTANCE_SETTERS__";(ms=bn()[ko])||(ms=bn()[ko]=[]),ms.push(e=>te=e),st=e=>{ms.length>1?ms.forEach(s=>s(e)):ms[0](e)};const fs=e=>{st(e),e.scope.on()},Ze=()=>{te&&te.scope.off(),st(null)};function Do(e){return e.vnode.shapeFlag&4}let Ds=!1;function Bi(e,s=!1){Ds=s;const{props:n,children:t}=e.vnode,o=Do(e);_i(e,n,o,s),Di(e,t);const a=o?Ui(e,s):void 0;return Ds=!1,a}function Ui(e,s){const n=e.type;e.accessCache=Object.create(null),e.proxy=Et(new Proxy(e.ctx,fi));const{setup:t}=n;if(t){const o=e.setupContext=t.length>1?Wi(e):null;fs(e),cs();const a=He(t,e,0,[e.props,o]);if(ps(),Ze(),ut(a)){if(a.then(Ze,Ze),s)return a.then(i=>{Ao(e,i,s)}).catch(i=>{Ls(i,e,0)});e.asyncDep=a}else Ao(e,a,s)}else Io(e,s)}function Ao(e,s,n){O(s)?e.type.__ssrInlineRender?e.ssrRender=s:e.render=s:H(s)&&(e.setupState=Ct(s)),Io(e,n)}let xo;function Io(e,s,n){const t=e.type;if(!e.render){if(!s&&xo&&!t.render){const o=t.template||Vn(e).template;if(o){const{isCustomElement:a,compilerOptions:i}=e.appContext.config,{delimiters:l,compilerOptions:c}=t,u=se(se({isCustomElement:a,delimiters:l},i),c);t.render=xo(o,u)}}e.render=t.render||ke}{fs(e),cs();try{gi(e)}finally{ps(),Ze()}}}function Li(e){return e.attrsProxy||(e.attrsProxy=new Proxy(e.attrs,{get(s,n){return ce(e,"get","$attrs"),s[n]}}))}function Wi(e){const s=n=>{e.exposed=n||{}};return{get attrs(){return Li(e)},slots:e.slots,emit:e.emit,expose:s}}function nt(e){if(e.exposed)return e.exposeProxy||(e.exposeProxy=new Proxy(Ct(Et(e.exposed)),{get(s,n){if(n in s)return s[n];if(n in Ss)return Ss[n](e)},has(s,n){return n in s||n in Ss}}))}function Vi(e,s=!0){return O(e)?e.displayName||e.name:e.name||s&&e.__name}function $i(e){return O(e)&&"__vccOpts"in e}const Ki=(e,s)=>Ma(e,s,Ds);function Gi(e,s,n){const t=arguments.length;return t===2?H(s)&&!A(s)?Zn(s)?le(e,null,[s]):le(e,s):le(e,null,s):(t>3?n=Array.prototype.slice.call(arguments,2):t===3&&Zn(n)&&(n=[n]),le(e,s,n))}const Xi=Symbol.for("v-scx"),Zi=()=>sn(Xi),Qi="3.3.12",er="http://www.w3.org/2000/svg",Qe=typeof document<"u"?document:null,No=Qe&&Qe.createElement("template"),sr={insert:(e,s,n)=>{s.insertBefore(e,n||null)},remove:e=>{const s=e.parentNode;s&&s.removeChild(e)},createElement:(e,s,n,t)=>{const o=s?Qe.createElementNS(er,e):Qe.createElement(e,n?{is:n}:void 0);return e==="select"&&t&&t.multiple!=null&&o.setAttribute("multiple",t.multiple),o},createText:e=>Qe.createTextNode(e),createComment:e=>Qe.createComment(e),setText:(e,s)=>{e.nodeValue=s},setElementText:(e,s)=>{e.textContent=s},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Qe.querySelector(e),setScopeId(e,s){e.setAttribute(s,"")},insertStaticContent(e,s,n,t,o,a){const i=n?n.previousSibling:s.lastChild;if(o&&(o===a||o.nextSibling))for(;s.insertBefore(o.cloneNode(!0),n),!(o===a||!(o=o.nextSibling)););else{No.innerHTML=t?`<svg>${e}</svg>`:e;const l=No.content;if(t){const c=l.firstChild;for(;c.firstChild;)l.appendChild(c.firstChild);l.removeChild(c)}s.insertBefore(l,n)}return[i?i.nextSibling:s.firstChild,n?n.previousSibling:s.lastChild]}},Le="transition",As="animation",xs=Symbol("_vtc"),tt=(e,{slots:s})=>Gi(oi,nr(e),s);tt.displayName="Transition";const Oo={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};tt.props=se({},Xt,Oo);const es=(e,s=[])=>{A(e)?e.forEach(n=>n(...s)):e&&e(...s)},qo=e=>e?A(e)?e.some(s=>s.length>1):e.length>1:!1;function nr(e){const s={};for(const _ in e)_ in Oo||(s[_]=e[_]);if(e.css===!1)return s;const{name:n="v",type:t,duration:o,enterFromClass:a=`${n}-enter-from`,enterActiveClass:i=`${n}-enter-active`,enterToClass:l=`${n}-enter-to`,appearFromClass:c=a,appearActiveClass:u=i,appearToClass:h=l,leaveFromClass:y=`${n}-leave-from`,leaveActiveClass:w=`${n}-leave-active`,leaveToClass:D=`${n}-leave-to`}=e,E=tr(o),x=E&&E[0],Y=E&&E[1],{onBeforeEnter:W,onEnter:L,onEnterCancelled:V,onLeave:I,onLeaveCancelled:Q,onBeforeAppear:Se=W,onAppear:_e=L,onAppearCancelled:q=V}=s,G=(_,K,he)=>{ss(_,K?h:l),ss(_,K?u:i),he&&he()},B=(_,K)=>{_._isLeaving=!1,ss(_,y),ss(_,D),ss(_,w),K&&K()},ie=_=>(K,he)=>{const Is=_?_e:L,oe=()=>G(K,_,he);es(Is,[K,oe]),zo(()=>{ss(K,_?c:a),We(K,_?h:l),qo(Is)||Po(K,t,x,oe)})};return se(s,{onBeforeEnter(_){es(W,[_]),We(_,a),We(_,i)},onBeforeAppear(_){es(Se,[_]),We(_,c),We(_,u)},onEnter:ie(!1),onAppear:ie(!0),onLeave(_,K){_._isLeaving=!0;const he=()=>B(_,K);We(_,y),ir(),We(_,w),zo(()=>{_._isLeaving&&(ss(_,y),We(_,D),qo(I)||Po(_,t,Y,he))}),es(I,[_,he])},onEnterCancelled(_){G(_,!1),es(V,[_])},onAppearCancelled(_){G(_,!0),es(q,[_])},onLeaveCancelled(_){B(_),es(Q,[_])}})}function tr(e){if(e==null)return null;if(H(e))return[ot(e.enter),ot(e.leave)];{const s=ot(e);return[s,s]}}function ot(e){return oa(e)}function We(e,s){s.split(/\s+/).forEach(n=>n&&e.classList.add(n)),(e[xs]||(e[xs]=new Set)).add(s)}function ss(e,s){s.split(/\s+/).forEach(t=>t&&e.classList.remove(t));const n=e[xs];n&&(n.delete(s),n.size||(e[xs]=void 0))}function zo(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let or=0;function Po(e,s,n,t){const o=e._endId=++or,a=()=>{o===e._endId&&t()};if(n)return setTimeout(a,n);const{type:i,timeout:l,propCount:c}=ar(e,s);if(!i)return t();const u=i+"end";let h=0;const y=()=>{e.removeEventListener(u,w),a()},w=D=>{D.target===e&&++h>=c&&y()};setTimeout(()=>{h<c&&y()},l+1),e.addEventListener(u,w)}function ar(e,s){const n=window.getComputedStyle(e),t=E=>(n[E]||"").split(", "),o=t(`${Le}Delay`),a=t(`${Le}Duration`),i=Eo(o,a),l=t(`${As}Delay`),c=t(`${As}Duration`),u=Eo(l,c);let h=null,y=0,w=0;s===Le?i>0&&(h=Le,y=i,w=a.length):s===As?u>0&&(h=As,y=u,w=c.length):(y=Math.max(i,u),h=y>0?i>u?Le:As:null,w=h?h===Le?a.length:c.length:0);const D=h===Le&&/\b(transform|all)(,|$)/.test(t(`${Le}Property`).toString());return{type:h,timeout:y,propCount:w,hasTransform:D}}function Eo(e,s){for(;e.length<s.length;)e=e.concat(e);return Math.max(...s.map((n,t)=>Co(n)+Co(e[t])))}function Co(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function ir(){return document.body.offsetHeight}function rr(e,s,n){const t=e[xs];t&&(s=(s?[s,...t]:[...t]).join(" ")),s==null?e.removeAttribute("class"):n?e.setAttribute("class",s):e.className=s}const lr=Symbol("_vod"),cr=Symbol("");function pr(e,s,n){const t=e.style,o=Z(n);if(n&&!o){if(s&&!Z(s))for(const a in s)n[a]==null&&at(t,a,"");for(const a in n)at(t,a,n[a])}else{const a=t.display;if(o){if(s!==n){const i=t[cr];i&&(n+=";"+i),t.cssText=n}}else s&&e.removeAttribute("style");lr in e&&(t.display=a)}}const Ro=/\s*!important$/;function at(e,s,n){if(A(n))n.forEach(t=>at(e,s,t));else if(n==null&&(n=""),s.startsWith("--"))e.setProperty(s,n);else{const t=ur(e,s);Ro.test(n)?e.setProperty(rs(t),n.replace(Ro,""),"important"):e[t]=n}}const Fo=["Webkit","Moz","ms"],it={};function ur(e,s){const n=it[s];if(n)return n;let t=De(s);if(t!=="filter"&&t in e)return it[s]=t;t=Es(t);for(let o=0;o<Fo.length;o++){const a=Fo[o]+t;if(a in e)return it[s]=a}return s}const Mo="http://www.w3.org/1999/xlink";function dr(e,s,n,t,o){if(t&&s.startsWith("xlink:"))n==null?e.removeAttributeNS(Mo,s.slice(6,s.length)):e.setAttributeNS(Mo,s,n);else{const a=ca(s);n==null||a&&!ft(n)?e.removeAttribute(s):e.setAttribute(s,a?"":n)}}function hr(e,s,n,t,o,a,i){if(s==="innerHTML"||s==="textContent"){t&&i(t,o,a),e[s]=n??"";return}const l=e.tagName;if(s==="value"&&l!=="PROGRESS"&&!l.includes("-")){e._value=n;const u=l==="OPTION"?e.getAttribute("value"):e.value,h=n??"";u!==h&&(e.value=h),n==null&&e.removeAttribute(s);return}let c=!1;if(n===""||n==null){const u=typeof e[s];u==="boolean"?n=ft(n):n==null&&u==="string"?(n="",c=!0):u==="number"&&(n=0,c=!0)}try{e[s]=n}catch{}c&&e.removeAttribute(s)}function mr(e,s,n,t){e.addEventListener(s,n,t)}function fr(e,s,n,t){e.removeEventListener(s,n,t)}const Ho=Symbol("_vei");function gr(e,s,n,t,o=null){const a=e[Ho]||(e[Ho]={}),i=a[s];if(t&&i)i.value=t;else{const[l,c]=yr(s);if(t){const u=a[s]=wr(t,o);mr(e,l,u,c)}else i&&(fr(e,l,i,c),a[s]=void 0)}}const Yo=/(?:Once|Passive|Capture)$/;function yr(e){let s;if(Yo.test(e)){s={};let t;for(;t=e.match(Yo);)e=e.slice(0,e.length-t[0].length),s[t[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):rs(e.slice(2)),s]}let rt=0;const br=Promise.resolve(),jr=()=>rt||(br.then(()=>rt=0),rt=Date.now());function wr(e,s){const n=t=>{if(!t._vts)t._vts=Date.now();else if(t._vts<=n.attached)return;fe(vr(t,n.value),s,5,[t])};return n.value=e,n.attached=jr(),n}function vr(e,s){if(A(s)){const n=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{n.call(e),e._stopped=!0},s.map(t=>o=>!o._stopped&&t&&t(o))}else return s}const Bo=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,Jr=(e,s,n,t,o=!1,a,i,l,c)=>{s==="class"?rr(e,t,o):s==="style"?pr(e,n,t):Os(s)?hn(s)||gr(e,s,n,t,i):(s[0]==="."?(s=s.slice(1),!0):s[0]==="^"?(s=s.slice(1),!1):Sr(e,s,t,o))?hr(e,s,t,a,i,l,c):(s==="true-value"?e._trueValue=t:s==="false-value"&&(e._falseValue=t),dr(e,s,t,o))};function Sr(e,s,n,t){if(t)return!!(s==="innerHTML"||s==="textContent"||s in e&&Bo(s)&&O(n));if(s==="spellcheck"||s==="draggable"||s==="translate"||s==="form"||s==="list"&&e.tagName==="INPUT"||s==="type"&&e.tagName==="TEXTAREA")return!1;if(s==="width"||s==="height"){const o=e.tagName;if(o==="IMG"||o==="VIDEO"||o==="CANVAS"||o==="SOURCE")return!1}return Bo(s)&&Z(n)?!1:s in e}const _r=["ctrl","shift","alt","meta"],Tr={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,s)=>_r.some(n=>e[`${n}Key`]&&!s.includes(n))},kr=(e,s)=>e._withMods||(e._withMods=(n,...t)=>{for(let o=0;o<s.length;o++){const a=Tr[s[o]];if(a&&a(n,s))return}return e(n,...t)}),Dr=se({patchProp:Jr},sr);let Uo;function Ar(){return Uo||(Uo=xi(Dr))}const xr=(...e)=>{const s=Ar().createApp(...e),{mount:n}=s;return s.mount=t=>{const o=Ir(t);if(!o)return;const a=s._component;!O(a)&&!a.render&&!a.template&&(a.template=o.innerHTML),o.innerHTML="";const i=n(o,!1,o instanceof SVGElement);return o instanceof Element&&(o.removeAttribute("v-cloak"),o.setAttribute("data-v-app","")),i},s};function Ir(e){return Z(e)?document.querySelector(e):e}const cn=(e,s)=>{const n=e.__vccOpts||e;for(const[t,o]of s)n[t]=o;return n},Nr=Bn({props:{report:{type:String,required:!0}},methods:{createIssue(){const e=new FormData(this.$refs.issueForm),s=e.get("title");let n="";const t=e.get("description");t&&(n+=`**Description**
${t}
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Defining `ARDUINOJSON_ENABLE_STD_STRING` and `ARDUINOJSON_ENABLE_STD_STREAM` to `0` solves the issue"},{id:"failure",page:1,label:"No",summary:"Defining `ARDUINOJSON_ENABLE_STD_STRING` and `ARDUINOJSON_ENABLE_STD_STREAM` to `0` doesn't solve the issue"}]},{content:`<p>This error occurs when you pass a <code>char*</code> to <code>serializeJson()</code> but forget to pass the third argument.
For example:</p>
...
`,options:[{id:"serialization",page:207,label:"Serialization",summary:"The issue concerns serialization"},{id:"deserialization",page:78,label:"Deserialization",summary:"The issue concerns deserialization"}]},{content:`<p>What is the value of <code>DeserializationError</code>?</p>
...
`,options:[{id:"before",page:86,label:"None: program crashes before calling <code>deserializeJson()</code>",summary:"Program crashes before calling `deserializeJson()`"},{id:"inside",page:88,label:"Only one: program crashes inside <code>deserializeJson()</code>",summary:"Program crashes inside `deserializeJson()`"},{id:"after",page:81,label:"Two traces: program crashes after calling <code>deserializeJson()</code>",summary:"Program crashes after calling `deserializeJson()`"}]},{content:`<p>Sometimes, a program crashes after calling <code>deserializeJson()</code> because it keeps a pointer to a string stored in the <code>JsonDocument</code>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Replacing pointer with a `String` solves the issue"},{id:"no-dangling-pointer",page:83,label:"No",summary:"Replacing pointer with a `String` doesn't solve the issue"}]},{content:`<p>As far as the standard is concerned, the behavior of <code>printf()</code>, <code>sprintf()</code>, and <code>snprintf()</code> is undefined if a <code>%s</code> refers to a null string.</p>
...
`,options:[{id:"capacity-0",page:89,label:"<code>0</code>",summary:"`doc.capacity()` returns `0`"},{id:"capacity-ok",page:90,label:"The value passed to the constructor of <code>DynamicJsonDocument</code>",summary:"`doc.capacity()` returns the right value"}]},{content:`<p>A big <code>StaticJsonDocument</code> might indeed overflow the stack.
...
`,options:[{id:"redirect",page:98,label:"<code>300</code> to <code>399</code>",summary:"The status code indicates a redirection"},{id:"negative",page:99,label:"A negative number",summary:"The status code is negative"},{id:"status-ok",page:101,label:"None of the above",summary:"The status code is not in the list"}]},{content:`<p><code>EmptyInput</code> could be caused by a timeout while reading the response.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Adding a wait loop fixes the issue"},{id:"available",page:106,label:"No",summary:"Adding a wait loop doesn't fix the issue"}]},{content:`<p><code>IncompleteInput</code> means that <code>deserializeJson()</code> managed to parse the beginning of the JSON document, but the end was missing.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:2,label:"Yes",summary:"Increasing the buffer size solves the issue"},{id:"1",page:114,label:"No",summary:"Increasing the buffer size doesn't solve the issue"}]},{content:`<p>To reduce the memory usage, you should try to pass the source (file, connection, stream, etc) directly to <code>deserializeJson()</code>, either via the <a href="https://www.arduino.cc/reference/en/language/functions/communication/stream/"><code>Stream</code></a> interface or via a <a href="/news/2019/11/01/version-6-13-0/">custom reader</a>. This will avoid the need for an intermediate buffer.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Casting the pointer fixes the issue"},{id:"cast",page:156,label:"No",summary:"Casting the pointer doesn't fix the issue"}]},{content:`<p>When you pass a writeable buffer as the input of <code>deserializeJson()</code>, ArduinoJson uses the zero-copy mode. Instead of copying the strings from the input into the <code>JsonDocument</code>, it stores pointers to the input buffer.</p>
...
`,options:[{id:"success",page:2,label:"Yes, and it fixes the issue",summary:"Removing the second call fixes the issue"},{id:"second-removed",page:156,label:"Yes, but it doesn't fix the issue",summary:"Removing the second call doesn't fix the issue"},{id:"cannot-remove",page:116,label:"No",summary:"The second call cannot be removed"}]},{content:`<p>Did you call <code>deserializeJson()</code> twice with the same input buffer?</p>
`,options:[{id:"two-calls",page:117,label:"Yes",summary:"Program calls `deserializeJson()` twice"},{id:"one-call",page:156,label:"No",summary:"Program doesn't call `deserializeJson()` twice"}]},{content:`<p>So, the JSON document is valid and not preceded by anything; yet, <code>deserializeJson()</code> returns <code>InvalidInput</code>.</p>
...
`,options:[{id:"http10-true",page:132,label:"Yes",summary:"Program calls `HTTPClient::useHTTP10(true)`"},{id:"http10-false",page:131,label:"No",summary:"Program doesn't call `HTTPClient::useHTTP10(true)`"}]},{content:`<p>Before calling <code>deserializeJson()</code>, did you skip the HTTP headers?</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Upgrading the cables solves the issue"},{id:"improved",page:146,label:"Somehow",summary:"Upgrading the cables improves the situation"},{id:"no-improvment",page:147,label:"No",summary:"Upgrading the cables doesn't solve the issue"}]},{content:`<p><code>deserializeJson()</code> may return <code>InvalidInput</code> because it starts reading the input mid-stream.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Garbage characters follow the input"},{id:"lint",page:169,label:"No",summary:"No garbage characters follow the input"}]},{content:`<p><code>deserializeJson()</code> stops reading as soon as the JSON document ends.
In your case, it will read the input until it reaches the matching <code>]</code> and ignore any remaining characters.</p>
<p>Suppose the input looks like this:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Garbage characters follow the input"},{id:"lint",page:169,label:"No",summary:"No garbage characters follow the input"}]},{content:`<p>What is the type of the second argument passed to <code>deserializeJson()</code>?</p>
...
`,options:[{id:"success",page:164,label:"Yes, the input comes from a stream",summary:"Input comes from a stream"},{id:"cast",page:163,label:"No, it doesn't",summary:"Input doesn't come from a stream"}]},{content:`<p>When you pass a writeable buffer as the input of <code>deserializeJson()</code>, ArduinoJson uses the zero-copy mode. Instead of copying the strings from the input into the <code>JsonDocument</code>, it stores pointers to the input buffer.</p>
<p>While doing this, the parser modifies the input buffer to unescape special characters and add string terminator.
...
<p>Did this solve your issue?</p>
`,options:[{id:"acceptable",page:2,label:"Yes",summary:"`deserializeJson()` tolerates the error, and that's OK"},{id:"unacceptable",page:191,label:"No",summary:"`deserializeJson()` should not let this error pass"}]},{content:`<p>So, <code>deserializeJson()</code> returns <code>Ok</code>, and jsonlint confirms that the input is valid.</p>
...
`,options:[{id:"filter",page:175,label:"Yes",summary:"Program uses `DeserializationOption::Filter`"},{id:"no-filter",page:179,label:"No",summary:"Program doesn't use `DeserializationOption::Filter`"}]},{content:`<p>When a program fails to extract the values from a <code>JsonDocument</code>, it's often because there is a confusion between arrays and objects.</p>
...
`,options:[{id:"size-ok",page:174,label:"Yes",summary:"The filter looks correct"},{id:"too-small",page:176,label:"No, some values are missing",summary:"The filter lacks some values"}]},{content:`<p>The filter's <code>JsonDocument</code> is too small; please increase its capacity and try again.</p>
...
`,options:[{id:"json",page:1,label:"<code>deserializeJson()</code>",summary:"Program calls `deserializeJson()`"},{id:"msgpack",page:178,label:"<code>deserializeMsgPack()</code>",summary:"Program calls `deserializeMsgPack()`"}]},{content:`<p>It seems that your program fed <code>deserializeMsgPack()</code> with garbage input.</p>
...
`,options:[{id:"http",page:189,label:"Yes",summary:"The input comes from an HTTP response"},{id:"no-nul",page:1,label:"No",summary:"The input doesn't come from an HTTP response"}]},{content:`<p><code>deserializeJson()</code> accepted a JSON document that was clearly invalid.<br>
...
<p>What value does it show?</p>
`,options:[{id:"capacity-0",page:197,label:"<code>0</code>",summary:"`doc.capacity()` returns `0`"},{id:"capacity-ok",page:193,label:"The value passed to the constructor of <code>DynamicJsonDocument</code>",summary:"`doc.capacity()` returns the right value"}]},{content:`<p>What kind of <code>JsonDocument</code> are you using?</p>
...
`,options:[{id:"can-uprade",page:204,label:"Yes",summary:"Library can be upgraded"},{id:"cannot-upgrade",page:202,label:"No",summary:"Library cannot be upgraded"}]},{content:`<p>So, I guess that you're not using <code>deserializeJson()</code> but <code>deserializeMsgPack()</code>, right?</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Upgrading solves the issue"},{id:"updraded",page:203,label:"No",summary:"Upgrading doesn't solves the issue"}]},{content:`<p><code>TooDeep</code> means that the input document has too many levels of nesting.</p>
...
`,options:[{id:"charptr",page:209,label:"Yes",summary:"Program inserts string pointers into the `JsonDocument`"},{id:"no-charptr",page:212,label:"No",summary:"Program doesn't insert string pointers into the `JsonDocument`"}]},{content:`<p>What is the type of the second argument passed to <code>serializeJson()</code>?</p>
...
`,options:[{id:"progmem",page:215,label:"Yes",summary:"Program uses `PROGMEM`"},{id:"no-progmem",page:211,label:"No",summary:"Program doesn't use `PROGMEM`"}]},{content:`<p>Because a <code>StaticJsonDocument</code> resides on the stack, it may cause a <a href="https://en.wikipedia.org/wiki/Stack_buffer_overflow">stack-overflow</a>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Switching to `DynamicJsonDocument` fixes the issue"},{id:"dynamicjsondocument-tried",page:216,label:"No",summary:"Switching to `DynamicJsonDocument` doesn't fix the issue"}]},{content:`<p>Please print the capacity of the <code>JsonDocument</code> to the serial port, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">capacity</span>());
</code></pre>
<p>What value does it show?</p>
...
`,options:[{id:"deserialize-yes",page:226,label:"Yes",summary:"Program calls `deserializeJson()`"},{id:"deserialize-no",page:1,label:"No",summary:"Program doesn't call `deserializeJson()`"}]},{content:`<p>When you pass a writeable buffer as the input of <code>deserializeJson()</code>, ArduinoJson uses the <strong>zero-copy mode</strong>. Instead of copying the strings from the input into the <code>JsonDocument</code>, it stores pointers to the input buffer.
...
`,options:[{id:"json",page:237,label:"<code>serializeJson()</code> (or <code>serializeJsonPretty()</code>)",summary:"`serializeJson()` produces garbage"},{id:"msg",page:242,label:"<code>serializeMsgPack()</code>",summary:"`serializeMsgPack()` produces garbage"}]},{content:`<p>When you pass a writeable buffer as the input of <code>deserializeJson()</code>, ArduinoJson uses the <strong>zero-copy mode</strong>. Instead of copying the strings from the input into the <code>JsonDocument</code>, it stores pointers to the input buffer.
Therefore, the input buffer must stay alive during the whole lifetime of the <code>JsonDocument</code>; otherwise, all the strings in the <code>JsonDocument</code> will be dangling pointers.</p>
<p>The easiest solution is to disable the zero-copy mode by passing a read-only input buffer. Casting the pointer will do the trick:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// replace this:</span>
<span class="hljs-built_in">deserializeJson</span>(doc, input, inputSize);
...
<p>Now that the zero-copy mode is disabled, you probably need a larger <code>JsonDocument</code>, so don't forget to update the capacity. As usual, use the <a href="/v6/assistant/">ArduinoJson Assistant</a> to compute the right capacity for your project.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Casting the pointer fixes the issue"},{id:"casting-fails",page:246,label:"No",summary:"Casting the pointer doesn't fix the issue"}]},{content:`<p>What's the type of the second argument passed to <code>deserializeJson()</code>?</p>
...
`,options:[{id:"string",page:233,label:"Yes",summary:"Program uses `String`"},{id:"no-string",page:1,label:"No",summary:"Program doesn't use `String`"}]},{content:`<p><code>StaticJsonDocument</code> stores its memory pool in the stack.
...
<p>Please switch to a <code>DynamicJsonDocument</code>.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Switching to `DynamicJsonDocument` fixes the issue"},{id:"dynamic",page:234,label:"No",summary:"Switching to `DynamicJsonDocument` doesn't fix the issue"}]},{content:`<p>Which kind of <code>JsonDocument</code> do you use?</p>
...
`,options:[{id:"deserialize-yes",page:232,label:"Yes",summary:"Program calls `deserializeJson()`"},{id:"deserialize-no",page:246,label:"No",summary:"Program doesn't call `deserializeJson()`"}]},{content:`<p><code>JsonArray</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:245,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>JsonObject</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
...
<p>This way, you can keep the <code>JsonDocument</code> alive when you call <code>serializeJson()</code></p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:245,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>JsonVariant</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
...
<p>This way, you can keep the <code>JsonDocument</code> alive when you call <code>serializeJson()</code></p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:245,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>serializeMsgPack()</code> share a lot of code with <code>serializeJson()</code>. There is no reason you should produce garbage with one and not the other. You may have found a bug.</p>
...
`,options:[{id:"json",page:237,label:"Yes, <code>serializeJson()</code> produces garbage too",summary:"`serializeJson()` produces garbage too"},{id:"deserialize-no",page:241,label:"No, <code>serializeJson()</code> doesn't produces garbage",summary:"`serializeJson()` doesn't produces garbage"}]},{content:`<p><code>JsonDocument::garbageCollect()</code> invalidates all previously acquired <code>JsonArray</code>, <code>JsonObject</code>, and <code>JsonVariant</code>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Reassigning references fixes the issue"},{id:"reassigned",page:236,label:"No",summary:"Reassigning references doesn't fix the issue"}]},{content:`<p><code>JsonDocument::shrinkToFit()</code> invalidates all previously acquired <code>JsonArray</code>, <code>JsonObject</code>, and <code>JsonVariant</code>.</p>
<p>After you call it, make sure to reassign  every references, like so:</p>
<pre><code class="hljs language-c++">JsonObject cfg = doc.<span class="hljs-built_in">createNestedObject</span>(<span class="hljs-string">&quot;config&quot;</span>);
<span class="hljs-comment">// ...</span>
...
`,options:[{id:"garbagecollect",page:243,label:"<code>JsonDocument::garbageCollect()</code>",summary:"Program calls `JsonDocument::garbageCollect()`"},{id:"shrinktofit",page:244,label:"<code>JsonDocument::shrinkToFit()</code>",summary:"Program calls `JsonDocument::shrinkToFit()`"},{id:"none",page:236,label:"No",summary:"Program doesn't call an invalidating function"}]},{content:`<p>What is the type of the first argument passed to <code>serializeJson()</code>?</p>
...
`,options:[{id:"big",page:258,label:"Yes, it contains hundred of values",summary:"The JSON document is large"},{id:"small",page:1,label:"No, it doesn't contain that many values",summary:"The JSON document is not large"}]},{content:`<p>Please replace the call to <code>JsonDocument::clear()</code> with <code>JsonDocument::garbageCollect()</code>.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Calling `JsonDocument::garbageCollect()` solves the issue"},{id:"gc",page:255,label:"No",summary:"Calling `JsonDocument::garbageCollect()` doesn't solve the issue"}]},{content:`<p>We can try to clear the content of the <code>JsonDocument</code>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Moving the `JsonDocument` inside the loop solves the issue"},{id:"inside",page:255,label:"No",summary:"Moving the `JsonDocument` inside the loop doesn't solve the issue"},{id:"outside",page:253,label:"I cannot move the declaration inside the loop",summary:"The `JsonDocument` cannot be moved inside the loop"}]},{content:`<p>Please print the value of <code>JsonDocument::overflowed()</code>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:257,label:"<code>1</code> (or <code>true</code>)",summary:"`JsonDocument::overflowed()` returns `true`"},{id:"overflowed-0",page:256,label:"<code>0</code> (or <code>false</code>)",summary:"`JsonDocument::overflowed()` returns `false`"}]},{content:`<p>Does one of the strings in the <code>JsonDocument</code> contains a NUL (i.e.,  ASCII code 0, or <code>\\u0000</code>)?</p>
`,options:[{id:"nul",page:206,label:"Yes",summary:"One or more strings contain a NUL"},{id:"no-nul",page:251,label:"No",summary:"No string contains a NUL"}]},{content:`<p><code>JsonDocument::overflowed()</code> returns <code>true</code> when you try to insert a value in the <code>JsonDocument</code>, but there isn't enough room to store it.</p>
...
`,options:[{id:"compiletime",page:261,label:"At compile time",summary:"The issue happens at compile time"},{id:"runtime",page:270,label:"At run time",summary:"The issue happens at run time"}]},{content:`<p>Please look at the <strong>first</strong> error in the compiler output, and tell me what it is...</p>
`,options:[{id:"requires-cpp-compiler",page:76,label:"ArduinoJson requires a C++ compiler...",summary:'Error says "ArduinoJson requires a C++ compiler..."'},{id:"assignment-of-read-only-location",page:262,label:"assignment of read-only location",summary:'Error says "assignment of read-only location"'},{id:"ambiguous-string-assign",page:35,label:"ambiguous overload for <code>operator=</code> (operand types are <code>String</code> and ...)",summary:'Error says "ambiguous overload for `operator=` (operand types are `String` and ...)"'},{id:"begin-not-found",page:54,label:"<code>begin</code>: no matching overloaded function found",summary:'Error says "`begin`: no matching overloaded function found"'},{id:"error-constants",page:74,label:"<code>bits/error_constants.h</code>: No such file or directory",summary:'Error says "`bits/error_constants.h`: No such file or directory'},{id:"print-ambiguous",page:75,label:"call of overloaded <code>print(...)</code> is ambiguous",summary:'Error says "call of overloaded `print(...)` is ambiguous"'},{id:"cannot-bind-object-ref",page:72,label:"cannot bind non-const lvalue reference of type <code>ArduinoJson::JsonObject&amp;</code> ...",summary:'Error says "cannot bind non-const lvalue reference of type `ArduinoJson::JsonObject&` ..."'},{id:"class-has-no-member-named-read",page:269,label:"<code>class Xxx</code> has no member named <code>read</code>",summary:'Error says "`class Xxx` has no member named `read`"'},{id:"pointer-to-object",page:71,label:"<code>const void*</code> is not a pointer-to-object type",summary:'Error says "`const void*` is not a pointer-to-object type"'},{id:"doesnt-name-a-type",page:268,label:"<code>doc</code> does not name a type",summary:'Error says "`doc` does not name a type"'},{id:"dynamicjsonbuffer",page:263,label:"<code>DynamicJsonBuffer</code> is a class from ArduinoJson 5",summary:'Error says "`DynamicJsonBuffer` is a class from ArduinoJson 5"'},{id:"expected-identifier-before-string-constant",page:49,label:"expected identifier before string constant",summary:'Error says "expected identifier before string constant"'},{id:"char-pointer-conversion",page:39,label:"invalid conversion from <code>const char*</code> to <code>char*</code> [-fpermissive]",summary:'Error says "invalid conversion from `const char*` to `char*` [-fpermissive]"'},{id:"invalid-conversion",page:50,label:"invalid use of incomplete type <code>class InvalidConversion&lt;...&gt;</code>",summary:'Error says "invalid use of incomplete type `class InvalidConversion<...>`"'},{id:"jsondocument-not-declared",page:70,label:"<code>JsonDocument</code> was not declared in this scope",summary:'Error says "`JsonDocument` was not declared in this scope"'},{id:"no-matching-function",page:59,label:"no matching function for call to ...",summary:'Error says "no matching function for call to ..."'},{id:"passing-volatile-as-this-argument-discards-qualifiers",page:73,label:"passing <code>volatile ...</code> as <code>this</code> argument discards qualifiers [-fpermissive]",summary:'Error says "passing `volatile ...` as `this` argument discards qualifiers [-fpermissive]"'},{id:"cast-void-to-flashstringhelper",page:38,label:"reinterpret_cast from <code>const void</code> to <code>const __FlashStringHelper *</code> is not allowed",summary:'Error says "reinterpret_cast from `const void` to `const __FlashStringHelper *` is not allowed"'},{id:"member-write-in-char-ptr",page:58,label:"request for member <code>write</code> in ..., which is of non-class type <code>char*</code>",summary:'Error says "request for member `write` in ..., which is of non-class type `char*`"'},{id:"staticjsonbuffer",page:263,label:"<code>StaticJsonBuffer</code> is a class from ArduinoJson 5",summary:'Error says "`StaticJsonBuffer` is a class from ArduinoJson 5"'},{id:"struct-has-no-member-named-read",page:269,label:"<code>struct Xxx</code> has no member named <code>read</code>",summary:'Error says "`struct Xxx` has no member named `read`"'},{id:"range-based-for-requires-begin",page:54,label:"this range-based <code>for</code> statement requires a suitable &quot;begin&quot; function and none was found",summary:'Error says "this range-based `for` statement requires a suitable "begin" function and none was found"'},{id:"not-in-list",page:3,label:"None of the above",summary:"The error is not in the list"}]},{content:`<p>This error occurs when you pass a string to <code>JsonArray::operator[]</code>; i.e., when you use an array like an object.</p>
<p>For example, if you try to compile the following code:</p>
<pre><code class="hljs language-c++">JsonDocument doc;
...
<p>Is your program directly using ArduinoJson, or is it using a library that depends on ArduinoJson?</p>
`,options:[{id:"upgrade",page:264,label:"My program uses ArduinoJson directly",summary:"Program uses ArduinoJson directly"},{id:"keep-v5",page:266,label:"My program uses a library that depends on ArduinoJson",summary:"Program uses a library that depends on ArduinoJson"}]},{content:`<p>Can you upgrade the program or do you prefer keeping it as it is?</p>
`,options:[{id:"upgrade",page:267,label:"I'd like to upgrade to ArduinoJson 7",summary:"User prefers upgrading to ArduinoJson 7"},{id:"keep-v5",page:265,label:"I prefer not touching the program",summary:"User prefers keeping ArduinoJson 5"}]},{content:`<p>I recommend that you download <a href="https://github.com/bblanchon/ArduinoJson/releases/download/v5.13.5/ArduinoJson-v5.13.5.h"><code>ArduinoJson-v5.13.5.h</code></a> and save it among the project files, this way you're sure that the project is distributed with the right version of the library.</p>
<p>You can choose to keep the name <code>ArduinoJson-v5.13.5.h</code> and update the <code>#include</code> directive, or you can rename the file to <code>ArduinoJson.h</code>; either way is fine, as long as the header is in the same folder as the file that includes it.</p>
<p>Please see <a href="/v5/doc/installation/">installation instructions</a> for details</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Downloading ArduinoJson 5 fixes the issue"},{id:"failure",page:1,label:"No",summary:"Downloading ArduinoJson 5 doesn't fix the issue"}]},{content:`<p>Since you cannot upgrade the code of the library depending on ArduinoJson, the simplest solution is to downgrade ArduinoJson to version 5.</p>
...
`,options:[{id:"serialization",page:301,label:"Serialization",summary:"The issue concerns serialization"},{id:"deserialization",page:271,label:"Deserialization",summary:"The issue concerns deserialization"}]},{content:`<p>What is the value of <code>DeserializationError</code>?</p>
`,options:[{id:"ok",page:288,label:"<code>Ok</code>",summary:"`deserializeJson()` returns `Ok`"},{id:"emptyinput",page:277,label:"<code>EmptyInput</code>",summary:"`deserializeJson()` returns `EmptyInput`"},{id:"incompleteinput",page:281,label:"<code>IncompleteInput</code>",summary:"`deserializeJson()` returns `IncompleteInput`"},{id:"invalidinput",page:285,label:"<code>InvalidInput</code>",summary:"`deserializeJson()` returns `InvalidInput`"},{id:"nomemory",page:300,label:"<code>NoMemory</code>",summary:"`deserializeJson()` returns `NoMemory`"},{id:"toodeep",page:205,label:"<code>TooDeep</code>",summary:"`deserializeJson()` returns `TooDeep`"},{id:"crash",page:273,label:"I can't tell because the program crashes",summary:"The program crashes"},{id:"unknown",page:272,label:"I don't know what you're talking about",summary:"The program doesn't check the error"}]},{content:`<p><code>DeserializationError</code> is the return type of <code>deserializeJson()</code>. It tells whether the operation succeeded and indicates the cause of the error.</p>
<p>Modify your program to show the error code, like so:</p>
<pre><code class="hljs language-c++">DeserializationError error = <span class="hljs-built_in">deserializeJson</span>(doc, input);
...
<p>How many traces can you see in the Serial Monitor?</p>
`,options:[{id:"before",page:275,label:"None: program crashes before calling <code>deserializeJson()</code>",summary:"Program crashes before calling `deserializeJson()`"},{id:"inside",page:276,label:"Only one: program crashes inside <code>deserializeJson()</code>",summary:"Program crashes inside `deserializeJson()`"},{id:"after",page:274,label:"Two traces: program crashes after calling <code>deserializeJson()</code>",summary:"Program crashes after calling `deserializeJson()`"}]},{content:`<p>A programs can also crash after calling <code>deserializeJson()</code> because it keeps a pointer to a string stored in the <code>JsonDocument</code>.</p>
<p>Indeed, when <code>JsonDocument</code> returns a <code>const char*</code>, it doesn't return a copy of the string, but the address of the string in the memory pool. When the <code>JsonDocument</code> is destructed, the memory pool gets released and the pointer dangles. Later, when the program tries to use the string, it reads at an invalid memory location and crashes.</p>
<p>For example, it happens with the following program:</p>
<pre><code class="hljs language-c++"><span class="hljs-type">const</span> <span class="hljs-type">char</span>* username;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Replacing pointer with a `String` solves the issue"},{id:"no-dangling-pointer",page:83,label:"No",summary:"Replacing pointer with a `String` doesn't solve the issue"}]},{content:`<p>I think this could be a stack-overflow.</p>
<p>Please check in your code if there aren't some large variable in the stack. Look for things like:</p>
<ul>
<li><code>char buffer[1024]</code></li>
<li><code>int matrix[64][64][64]</code></li>
...
<p>Please review your code to make sure you're not passsing a dangling pointer to <code>deserializeJson()</code>.</p>
<p>Does your program still crash?</p>
`,options:[{id:"no-dangling-ptr",page:275,label:"Yes",summary:"Removing dangling pointers doesn't prevent the crash"},{id:"success",page:2,label:"No",summary:"Removing dangling pointers prevents the crash"}]},{content:`<p><code>EmptyInput</code> means that the input was empty or contained only spaces or comments.</p>
<p>Where does your JSON input come from?</p>
`,options:[{id:"http",page:100,label:"An HTTP response",summary:"Input comes from an HTTP response"},{id:"file",page:278,label:"A file",summary:"Input comes from a file"},{id:"serial",page:280,label:"A serial port",summary:"Input comes from a serial port"},{id:"other",page:105,label:"Something else",summary:"Input comes neither from an HTTP response, nor a file, nor a serial port"}]},{content:`<p><code>EmptyInput</code> in the context of a file usually means:</p>
<ul>
<li>the file is closed</li>
<li>the file is opened in the wrong mode</li>
<li>the file is empty</li>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Adding a wait loop fixes the issue"},{id:"available",page:279,label:"No",summary:"Adding a wait loop doesn't fix the issue"}]},{content:`<p><code>IncompleteInput</code> means that <code>deserializeJson()</code> managed to parse the beginning of the JSON document, but the end was missing.</p>
<p>What type of input do you pass to <code>deserializeJson()</code>?</p>
`,options:[{id:"stream",page:111,label:"A stream",summary:"Input comes from a stream"},{id:"string",page:282,label:"A string object (like <code>String</code>)",summary:"Input comes from a string object"},{id:"pointer",page:283,label:"A pointer (like <code>char*</code> or <code>const char*</code>)",summary:"Input comes from a pointer"}]},{content:`<p>Please print the content of the string to the serial port, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(input);
</code></pre>
<p>You should see that the JSON document is truncated.
This can be caused by a lack of RAM: the string object failed to allocate a buffer large enough for the whole document.</p>
...
<p>Hopefully, you'll be able to reserve a buffer large enough to store the whole string.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:2,label:"Yes",summary:"Calling `String::reserve()` solves the issue"},{id:"1",page:284,label:"No",summary:"Calling `String::reserve()` doesn't solve the issue"}]},{content:`<p>I'll assume that your input is stored in a buffer similar to this one:</p>
<pre><code class="hljs language-c++"><span class="hljs-type">char</span> input[<span class="hljs-number">1024</span>];
<span class="hljs-type">size_t</span> input_size;
</code></pre>
<p>Please print the content of the string to the serial port, like so:</p>
...
<p>Please increase the capacity of the buffer, but remember that the size of the stack is limited so you may need to move your buffer to the heap.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:2,label:"Yes",summary:"Increasing the buffer size solves the issue"},{id:"1",page:284,label:"No",summary:"Increasing the buffer size doesn't solve the issue"}]},{content:`<p>To reduce the memory usage, you should try to pass the source (file, connection, stream, etc) directly to <code>deserializeJson()</code>, either via the <a href="https://www.arduino.cc/reference/en/language/functions/communication/stream/"><code>Stream</code></a> interface or via a <a href="/news/2019/11/01/version-6-13-0/">custom reader</a>. This will avoid the need for an intermediate buffer.</p>
<p>Additionaly, you can add a <a href="/news/2020/03/22/version-6-15-0/">filter</a> to remove all unneeded information from the <code>JsonDocument</code>.</p>
<p>You can see examples here:</p>
<ul>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Flushing the serial buffer fixes the issue"},{id:"flush",page:150,label:"No",summary:"Flushing the serial buffer doesn't fix the issue"}]},{content:`<p>Are you using <a href="https://www.arduino.cc/en/Reference/SoftwareSerial"><code>SoftwareSerial</code></a>?</p>
`,options:[{id:"software",page:149,label:"Yes",summary:"Program uses `SoftwareSerial`"},{id:"hardware",page:286,label:"No",summary:"Program doesn't use `SoftwareSerial`"}]},{content:`<p>So, what's the problem then?</p>
`,options:[{id:"slow",page:183,label:"It's slow",summary:"Deserialisation is slow"},{id:"invalid",page:158,label:"I expected <code>InvalidInput</code> instead of <code>Ok</code>",summary:"`Ok` is incorrect; it should be `InvalidInput`"},{id:"crash",page:274,label:"My program crashes after calling <code>deserializeJson()</code>",summary:"Program crashes after calling `deserializeJson()`"},{id:"empty",page:289,label:"<code>JsonDocument</code> returns empty/null values",summary:"Program fails to extract values from the `JsonDocument`"},{id:"truncated-strings",page:184,label:"Some strings are truncated",summary:"Some strings are truncated"}]},{content:`<p>Do you use a filter (with <code>DeserializationOption::Filter</code>)?</p>
`,options:[{id:"filter",page:291,label:"Yes",summary:"Program uses `DeserializationOption::Filter`"},{id:"no-filter",page:296,label:"No",summary:"Program doesn't use `DeserializationOption::Filter`"}]},{content:`<p>When a program fails to extract the values from a <code>JsonDocument</code>, it's often because there is a confusion between arrays and objects.</p>
<p>For example, a common mistake is to write:</p>
<pre><code class="hljs language-c++"><span class="hljs-type">const</span> <span class="hljs-type">char</span>* temperature = doc[<span class="hljs-string">&quot;list&quot;</span>][<span class="hljs-string">&quot;main&quot;</span>][<span class="hljs-string">&quot;temp&quot;</span>];
</code></pre>
<p>instead of</p>
...
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:293,label:"<code>1</code> (or <code>true</code>)",summary:"`filter.overflowed()` returns `true`"},{id:"overflowed-0",page:292,label:"<code>0</code> (or <code>false</code>)",summary:"`filter.overflowed()` returns `false`"}]},{content:`<p>Maybe the filter excludes the part that it should keep. Let's verify that it's doing its job correctly.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Freeing some memory solves the issue."},{id:"failure",page:292,label:"No",summary:"Freeing some memory doesn't solve the issue."}]},{content:`<p>Which function do you call to deserialize the input?</p>
`,options:[{id:"json",page:1,label:"<code>deserializeJson()</code>",summary:"Program calls `deserializeJson()`"},{id:"msgpack",page:295,label:"<code>deserializeMsgPack()</code>",summary:"Program calls `deserializeMsgPack()`"}]},{content:`<p>It seems that your program fed <code>deserializeMsgPack()</code> with garbage input.</p>
<p>Indeed, any byte in the following ranges is a valid one-byte MessagePack document:</p>
<ul>
<li><code>0x00</code>-<code>0x7f</code>: positive fixint</li>
<li><code>0xc0</code>: nil</li>
...
<p>What's the first character?</p>
`,options:[{id:"quote",page:299,label:"A quote (<code>&quot;</code>)",summary:"Serialized document starts with a quote"},{id:"bracket",page:290,label:"A square bracket (<code>[</code>)",summary:"Serialized document starts with a square bracket"},{id:"brace",page:290,label:"A curly brace (<code>{</code>)",summary:"Serialized document starts with a curly brace"},{id:"not-in-list",page:294,label:"None of the above",summary:"Serialized document starts with neither a quote, a bracket, nor a brace."}]},{content:`<p>If you cannot fix the server, you can at least reverse the double serialization (stringification) to get back the original object.</p>
<p>To do this, you must call <code>deserializeJson()</code> twice, like so:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Fixing the server fixes the issue"},{id:"server-ok",page:297,label:"No",summary:"Fixing the server doesn't fix the issue"}]},{content:`<p>If you see a double-quote at the beginning of the JSON input, it means that the whole document is neither an object or an array; it's a string. This happens when the input was incorrectly generated, by serializing (stringifying) to JSON twice.</p>
<p>For example, the following document:</p>
<pre><code class="hljs language-json"><span class="hljs-string">&quot;{\\&quot;hello\\&quot;:\\&quot;world\\&quot;}&quot;</span>
</code></pre>
<p>...is not a JSON <em>object</em> but a <em>string</em>.
...
<p>So, the bug isn't in the Arduino code, but on the other size, most likely a server.</p>
<p>Can you modify the code of the server?</p>
`,options:[{id:"server-fixable",page:298,label:"Yes",summary:"User can modify the server"},{id:"server-unfixable",page:297,label:"No",summary:"User cannot modify the server"}]},{content:`<p>Well, that's very bad news. It seems that your microcontroller doesn't have enough RAM to hold the JSON document.</p>
...
`,options:[{id:"crash",page:216,label:"The program crashes",summary:"Program crashes"},{id:"empty",page:302,label:"The output is empty (e.g. <code>{}</code>, <code>[]</code>, or <code>null</code>)",summary:"Output is empty"},{id:"incomplete",page:311,label:"The output is incomplete",summary:"Output is incomplete"},{id:"garbage",page:303,label:"The output contains garbage",summary:"Output contains garbage"},{id:"null",page:311,label:"The output contains <code>null</code>",summary:"Output contains null"},{id:"float",page:227,label:"Floating-point values contain too many decimal digits",summary:"Floating-point values contain too many decimal digits"},{id:"slow",page:259,label:"It's slow",summary:"Serialization is slow"}]},{content:`<p>Please print the value of <code>JsonDocument::overflowed()</code>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
...
`,options:[{id:"json",page:305,label:"<code>serializeJson()</code> (or <code>serializeJsonPretty()</code>)",summary:"`serializeJson()` produces garbage"},{id:"msg",page:310,label:"<code>serializeMsgPack()</code>",summary:"`serializeMsgPack()` produces garbage"}]},{content:`<p>Do you use <a href="https://www.arduino.cc/reference/en/language/variables/data-types/stringobject/"><code>String</code></a> in your program?</p>
`,options:[{id:"string",page:233,label:"Yes",summary:"Program uses `String`"},{id:"no-string",page:1,label:"No",summary:"Program doesn't use `String`"}]},{content:`<p>What is the type of the first argument passed to <code>serializeJson()</code>?</p>
`,options:[{id:"document",page:304,label:"<code>JsonDocument</code>",summary:"Program calls `serializeJson(const JsonDocument&, ...)`"},{id:"array",page:306,label:"<code>JsonArray</code> (or <code>JsonArrayConst</code>)",summary:"Program calls `serializeJson(JsonArrayConst, ...)`"},{id:"object",page:307,label:"<code>JsonObject</code> (or <code>JsonObjectConst</code>)",summary:"Program calls `serializeJson(JsonObjectConst, ...)`"},{id:"variant",page:308,label:"<code>JsonVariant</code> (or <code>JsonVariantConst</code>)",summary:"Program calls `serializeJson(JsonVariantConst, ...)`"}]},{content:`<p><code>JsonArray</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonArray</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonArray <span class="hljs-title">createArray</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:304,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>JsonObject</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonObject</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonObject <span class="hljs-title">createObject</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:304,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>JsonVariant</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonVariant</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonVariant <span class="hljs-title">createVariant</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:304,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>serializeMsgPack()</code> share a lot of code with <code>serializeJson()</code>. There is no reason you should produce garbage with one and not the other. You may have found a bug.</p>
`,tags:["needs_assistance"]},{content:`<p><a href="https://msgpack.org/">MessagePack</a> is a binary format, so if you print a document to the serial port, the result would look weird.</p>
<p>For example, the following program:</p>
<pre><code class="hljs language-c++">JsonDocument doc;
doc[<span class="hljs-string">&quot;val&quot;</span>] = <span class="hljs-number">42</span>;
...
<p>I need you to edit your program to replace <code>serializeMsgPack()</code> with <code>serializeJson()</code>.</p>
<p>Do you see the garbage in the JSON output?</p>
`,options:[{id:"json",page:305,label:"Yes, <code>serializeJson()</code> produces garbage too",summary:"`serializeJson()` produces garbage too"},{id:"deserialize-no",page:309,label:"No, <code>serializeJson()</code> doesn't produces garbage",summary:"`serializeJson()` doesn't produces garbage"}]},{content:`<p>Please print the value of <code>JsonDocument::overflowed()</code>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:314,label:"<code>1</code> (or <code>true</code>)",summary:"`JsonDocument::overflowed()` returns `true`"},{id:"overflowed-0",page:313,label:"<code>0</code> (or <code>false</code>)",summary:"`JsonDocument::overflowed()` returns `false`"}]},{content:`<p>Is the JSON document big?</p>
`,options:[{id:"big",page:315,label:"Yes, it contains hundred of values",summary:"The JSON document is large"},{id:"small",page:1,label:"No, it doesn't contain that many values",summary:"The JSON document is not large"}]},{content:`<p>Does one of the strings in the <code>JsonDocument</code> contains a NUL (i.e.,  ASCII code 0, or <code>\\u0000</code>)?</p>
`,options:[{id:"nul",page:206,label:"Yes",summary:"One or more strings contain a NUL"},{id:"no-nul",page:312,label:"No",summary:"No string contains a NUL"}]},{content:`<p><code>JsonDocument::overflowed()</code> returns <code>true</code> when you try to insert a value in the <code>JsonDocument</code>, but the memory allocation fails.</p>
<p>The solution is to free some memory or upgrade your microcontroller.
You can use the <a href="/v7/assistant/">ArduinoJson Assistant</a> to check if your microcontroller has enough memory.</p>
<p>Did this solve your issue?</p>
