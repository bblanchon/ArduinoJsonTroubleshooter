(function(){"use strict";function dn(e,s){const n=Object.create(null),t=e.split(",");for(let a=0;a<t.length;a++)n[t[a]]=!0;return s?a=>!!n[a.toLowerCase()]:a=>!!n[a]}const U={},as=[],ke=()=>{},Xa=()=>!1,Za=/^on[^a-z]/,Os=e=>Za.test(e),hn=e=>e.startsWith("onUpdate:"),se=Object.assign,mn=(e,s)=>{const n=e.indexOf(s);n>-1&&e.splice(n,1)},Qa=Object.prototype.hasOwnProperty,P=(e,s)=>Qa.call(e,s),x=Array.isArray,os=e=>qs(e)==="[object Map]",ct=e=>qs(e)==="[object Set]",I=e=>typeof e=="function",Z=e=>typeof e=="string",Is=e=>typeof e=="symbol",M=e=>e!==null&&typeof e=="object",pt=e=>(M(e)||I(e))&&I(e.then)&&I(e.catch),ut=Object.prototype.toString,qs=e=>ut.call(e),eo=e=>qs(e).slice(8,-1),dt=e=>qs(e)==="[object Object]",fn=e=>Z(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,zs=dn(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Ps=e=>{const s=Object.create(null);return n=>s[n]||(s[n]=e(n))},so=/-(\w)/g,Ae=Ps(e=>e.replace(so,(s,n)=>n?n.toUpperCase():"")),no=/\B([A-Z])/g,is=Ps(e=>e.replace(no,"-$1").toLowerCase()),Es=Ps(e=>e.charAt(0).toUpperCase()+e.slice(1)),gn=Ps(e=>e?`on${Es(e)}`:""),rs=(e,s)=>!Object.is(e,s),yn=(e,s)=>{for(let n=0;n<e.length;n++)e[n](s)},Cs=(e,s,n)=>{Object.defineProperty(e,s,{configurable:!0,enumerable:!1,value:n})},to=e=>{const s=parseFloat(e);return isNaN(s)?e:s},ao=e=>{const s=Z(e)?Number(e):NaN;return isNaN(s)?e:s};let ht;const bn=()=>ht||(ht=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function jn(e){if(x(e)){const s={};for(let n=0;n<e.length;n++){const t=e[n],a=Z(t)?lo(t):jn(t);if(a)for(const o in a)s[o]=a[o]}return s}else if(Z(e)||M(e))return e}const oo=/;(?![^(]*\))/g,io=/:([^]+)/,ro=/\/\*[^]*?\*\//g;function lo(e){const s={};return e.replace(ro,"").split(oo).forEach(n=>{if(n){const t=n.split(io);t.length>1&&(s[t[0].trim()]=t[1].trim())}}),s}function ys(e){let s="";if(Z(e))s=e;else if(x(e))for(let n=0;n<e.length;n++){const t=ys(e[n]);t&&(s+=t+" ")}else if(M(e))for(const n in e)e[n]&&(s+=n+" ");return s.trim()}const co=dn("itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly");function mt(e){return!!e||e===""}const Rs=e=>Z(e)?e:e==null?"":x(e)||M(e)&&(e.toString===ut||!I(e.toString))?JSON.stringify(e,ft,2):String(e),ft=(e,s)=>s&&s.__v_isRef?ft(e,s.value):os(s)?{[`Map(${s.size})`]:[...s.entries()].reduce((n,[t,a])=>(n[`${t} =>`]=a,n),{})}:ct(s)?{[`Set(${s.size})`]:[...s.values()]}:M(s)&&!x(s)&&!dt(s)?String(s):s;let je;class po{constructor(s=!1){this.detached=s,this._active=!0,this.effects=[],this.cleanups=[],this.parent=je,!s&&je&&(this.index=(je.scopes||(je.scopes=[])).push(this)-1)}get active(){return this._active}run(s){if(this._active){const n=je;try{return je=this,s()}finally{je=n}}}on(){je=this}off(){je=this.parent}stop(s){if(this._active){let n,t;for(n=0,t=this.effects.length;n<t;n++)this.effects[n].stop();for(n=0,t=this.cleanups.length;n<t;n++)this.cleanups[n]();if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!s){const a=this.parent.scopes.pop();a&&a!==this&&(this.parent.scopes[this.index]=a,a.index=this.index)}this.parent=void 0,this._active=!1}}}function uo(e,s=je){s&&s.active&&s.effects.push(e)}function ho(){return je}const vn=e=>{const s=new Set(e);return s.w=0,s.n=0,s},gt=e=>(e.w&Re)>0,yt=e=>(e.n&Re)>0,mo=({deps:e})=>{if(e.length)for(let s=0;s<e.length;s++)e[s].w|=Re},fo=e=>{const{deps:s}=e;if(s.length){let n=0;for(let t=0;t<s.length;t++){const a=s[t];gt(a)&&!yt(a)?a.delete(e):s[n++]=a,a.w&=~Re,a.n&=~Re}s.length=n}},wn=new WeakMap;let bs=0,Re=1;const Jn=30;let ve;const Ve=Symbol(""),_n=Symbol("");class Tn{constructor(s,n=null,t){this.fn=s,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,uo(this,t)}run(){if(!this.active)return this.fn();let s=ve,n=Fe;for(;s;){if(s===this)return;s=s.parent}try{return this.parent=ve,ve=this,Fe=!0,Re=1<<++bs,bs<=Jn?mo(this):bt(this),this.fn()}finally{bs<=Jn&&fo(this),Re=1<<--bs,ve=this.parent,Fe=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){ve===this?this.deferStop=!0:this.active&&(bt(this),this.onStop&&this.onStop(),this.active=!1)}}function bt(e){const{deps:s}=e;if(s.length){for(let n=0;n<s.length;n++)s[n].delete(e);s.length=0}}let Fe=!0;const jt=[];function ls(){jt.push(Fe),Fe=!1}function cs(){const e=jt.pop();Fe=e===void 0?!0:e}function pe(e,s,n){if(Fe&&ve){let t=wn.get(e);t||wn.set(e,t=new Map);let a=t.get(n);a||t.set(n,a=vn()),vt(a)}}function vt(e,s){let n=!1;bs<=Jn?yt(e)||(e.n|=Re,n=!gt(e)):n=!e.has(ve),n&&(e.add(ve),ve.deps.push(e))}function ze(e,s,n,t,a,o){const i=wn.get(e);if(!i)return;let l=[];if(s==="clear")l=[...i.values()];else if(n==="length"&&x(e)){const c=Number(t);i.forEach((u,h)=>{(h==="length"||!Is(h)&&h>=c)&&l.push(u)})}else switch(n!==void 0&&l.push(i.get(n)),s){case"add":x(e)?fn(n)&&l.push(i.get("length")):(l.push(i.get(Ve)),os(e)&&l.push(i.get(_n)));break;case"delete":x(e)||(l.push(i.get(Ve)),os(e)&&l.push(i.get(_n)));break;case"set":os(e)&&l.push(i.get(Ve));break}if(l.length===1)l[0]&&Sn(l[0]);else{const c=[];for(const u of l)u&&c.push(...u);Sn(vn(c))}}function Sn(e,s){const n=x(e)?e:[...e];for(const t of n)t.computed&&wt(t);for(const t of n)t.computed||wt(t)}function wt(e,s){(e!==ve||e.allowRecurse)&&(e.scheduler?e.scheduler():e.run())}const go=dn("__proto__,__v_isRef,__isVue"),Jt=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(Is)),_t=yo();function yo(){const e={};return["includes","indexOf","lastIndexOf"].forEach(s=>{e[s]=function(...n){const t=C(this);for(let o=0,i=this.length;o<i;o++)pe(t,"get",o+"");const a=t[s](...n);return a===-1||a===!1?t[s](...n.map(C)):a}}),["push","pop","shift","unshift","splice"].forEach(s=>{e[s]=function(...n){ls();const t=C(this)[s].apply(this,n);return cs(),t}}),e}function bo(e){const s=C(this);return pe(s,"has",e),s.hasOwnProperty(e)}class Tt{constructor(s=!1,n=!1){this._isReadonly=s,this._shallow=n}get(s,n,t){const a=this._isReadonly,o=this._shallow;if(n==="__v_isReactive")return!a;if(n==="__v_isReadonly")return a;if(n==="__v_isShallow")return o;if(n==="__v_raw"&&t===(a?o?Oo:It:o?Ot:Nt).get(s))return s;const i=x(s);if(!a){if(i&&P(_t,n))return Reflect.get(_t,n,t);if(n==="hasOwnProperty")return bo}const l=Reflect.get(s,n,t);return(Is(n)?Jt.has(n):go(n))||(a||pe(s,"get",n),o)?l:re(l)?i&&fn(n)?l:l.value:M(l)?a?qt(l):xn(l):l}}class St extends Tt{constructor(s=!1){super(!1,s)}set(s,n,t,a){let o=s[n];if(js(o)&&re(o)&&!re(t))return!1;if(!this._shallow&&(!Nn(t)&&!js(t)&&(o=C(o),t=C(t)),!x(s)&&re(o)&&!re(t)))return o.value=t,!0;const i=x(s)&&fn(n)?Number(n)<s.length:P(s,n),l=Reflect.set(s,n,t,a);return s===C(a)&&(i?rs(t,o)&&ze(s,"set",n,t):ze(s,"add",n,t)),l}deleteProperty(s,n){const t=P(s,n);s[n];const a=Reflect.deleteProperty(s,n);return a&&t&&ze(s,"delete",n,void 0),a}has(s,n){const t=Reflect.has(s,n);return(!Is(n)||!Jt.has(n))&&pe(s,"has",n),t}ownKeys(s){return pe(s,"iterate",x(s)?"length":Ve),Reflect.ownKeys(s)}}class jo extends Tt{constructor(s=!1){super(!0,s)}set(s,n){return!0}deleteProperty(s,n){return!0}}const vo=new St,wo=new jo,Jo=new St(!0),kn=e=>e,Fs=e=>Reflect.getPrototypeOf(e);function Hs(e,s,n=!1,t=!1){e=e.__v_raw;const a=C(e),o=C(s);n||(rs(s,o)&&pe(a,"get",s),pe(a,"get",o));const{has:i}=Fs(a),l=t?kn:n?In:On;if(i.call(a,s))return l(e.get(s));if(i.call(a,o))return l(e.get(o));e!==a&&e.get(s)}function Ms(e,s=!1){const n=this.__v_raw,t=C(n),a=C(e);return s||(rs(e,a)&&pe(t,"has",e),pe(t,"has",a)),e===a?n.has(e):n.has(e)||n.has(a)}function Bs(e,s=!1){return e=e.__v_raw,!s&&pe(C(e),"iterate",Ve),Reflect.get(e,"size",e)}function kt(e){e=C(e);const s=C(this);return Fs(s).has.call(s,e)||(s.add(e),ze(s,"add",e,e)),this}function At(e,s){s=C(s);const n=C(this),{has:t,get:a}=Fs(n);let o=t.call(n,e);o||(e=C(e),o=t.call(n,e));const i=a.call(n,e);return n.set(e,s),o?rs(s,i)&&ze(n,"set",e,s):ze(n,"add",e,s),this}function xt(e){const s=C(this),{has:n,get:t}=Fs(s);let a=n.call(s,e);a||(e=C(e),a=n.call(s,e)),t&&t.call(s,e);const o=s.delete(e);return a&&ze(s,"delete",e,void 0),o}function Dt(){const e=C(this),s=e.size!==0,n=e.clear();return s&&ze(e,"clear",void 0,void 0),n}function Ys(e,s){return function(t,a){const o=this,i=o.__v_raw,l=C(i),c=s?kn:e?In:On;return!e&&pe(l,"iterate",Ve),i.forEach((u,h)=>t.call(a,c(u),c(h),o))}}function Us(e,s,n){return function(...t){const a=this.__v_raw,o=C(a),i=os(o),l=e==="entries"||e===Symbol.iterator&&i,c=e==="keys"&&i,u=a[e](...t),h=n?kn:s?In:On;return!s&&pe(o,"iterate",c?_n:Ve),{next(){const{value:y,done:v}=u.next();return v?{value:y,done:v}:{value:l?[h(y[0]),h(y[1])]:h(y),done:v}},[Symbol.iterator](){return this}}}}function He(e){return function(...s){return e==="delete"?!1:e==="clear"?void 0:this}}function _o(){const e={get(o){return Hs(this,o)},get size(){return Bs(this)},has:Ms,add:kt,set:At,delete:xt,clear:Dt,forEach:Ys(!1,!1)},s={get(o){return Hs(this,o,!1,!0)},get size(){return Bs(this)},has:Ms,add:kt,set:At,delete:xt,clear:Dt,forEach:Ys(!1,!0)},n={get(o){return Hs(this,o,!0)},get size(){return Bs(this,!0)},has(o){return Ms.call(this,o,!0)},add:He("add"),set:He("set"),delete:He("delete"),clear:He("clear"),forEach:Ys(!0,!1)},t={get(o){return Hs(this,o,!0,!0)},get size(){return Bs(this,!0)},has(o){return Ms.call(this,o,!0)},add:He("add"),set:He("set"),delete:He("delete"),clear:He("clear"),forEach:Ys(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(o=>{e[o]=Us(o,!1,!1),n[o]=Us(o,!0,!1),s[o]=Us(o,!1,!0),t[o]=Us(o,!0,!0)}),[e,n,s,t]}const[To,So,ko,Ao]=_o();function An(e,s){const n=s?e?Ao:ko:e?So:To;return(t,a,o)=>a==="__v_isReactive"?!e:a==="__v_isReadonly"?e:a==="__v_raw"?t:Reflect.get(P(n,a)&&a in t?n:t,a,o)}const xo={get:An(!1,!1)},Do={get:An(!1,!0)},No={get:An(!0,!1)},Nt=new WeakMap,Ot=new WeakMap,It=new WeakMap,Oo=new WeakMap;function Io(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function qo(e){return e.__v_skip||!Object.isExtensible(e)?0:Io(eo(e))}function xn(e){return js(e)?e:Dn(e,!1,vo,xo,Nt)}function zo(e){return Dn(e,!1,Jo,Do,Ot)}function qt(e){return Dn(e,!0,wo,No,It)}function Dn(e,s,n,t,a){if(!M(e)||e.__v_raw&&!(s&&e.__v_isReactive))return e;const o=a.get(e);if(o)return o;const i=qo(e);if(i===0)return e;const l=new Proxy(e,i===2?t:n);return a.set(e,l),l}function ps(e){return js(e)?ps(e.__v_raw):!!(e&&e.__v_isReactive)}function js(e){return!!(e&&e.__v_isReadonly)}function Nn(e){return!!(e&&e.__v_isShallow)}function zt(e){return ps(e)||js(e)}function C(e){const s=e&&e.__v_raw;return s?C(s):e}function Pt(e){return Cs(e,"__v_skip",!0),e}const On=e=>M(e)?xn(e):e,In=e=>M(e)?qt(e):e;function Po(e){Fe&&ve&&(e=C(e),vt(e.dep||(e.dep=vn())))}function Eo(e,s){e=C(e);const n=e.dep;n&&Sn(n)}function re(e){return!!(e&&e.__v_isRef===!0)}function Co(e){return re(e)?e.value:e}const Ro={get:(e,s,n)=>Co(Reflect.get(e,s,n)),set:(e,s,n,t)=>{const a=e[s];return re(a)&&!re(n)?(a.value=n,!0):Reflect.set(e,s,n,t)}};function Et(e){return ps(e)?e:new Proxy(e,Ro)}class Fo{constructor(s,n,t,a){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this._dirty=!0,this.effect=new Tn(s,()=>{this._dirty||(this._dirty=!0,Eo(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!a,this.__v_isReadonly=t}get value(){const s=C(this);return Po(s),(s._dirty||!s._cacheable)&&(s._dirty=!1,s._value=s.effect.run()),s._value}set value(s){this._setter(s)}}function Ho(e,s,n=!1){let t,a;const o=I(e);return o?(t=e,a=ke):(t=e.get,a=e.set),new Fo(t,a,o||!a,n)}function pl(e,...s){}function Me(e,s,n,t){let a;try{a=t?e(...t):e()}catch(o){Ls(o,s,n)}return a}function fe(e,s,n,t){if(I(e)){const o=Me(e,s,n,t);return o&&pt(o)&&o.catch(i=>{Ls(i,s,n)}),o}const a=[];for(let o=0;o<e.length;o++)a.push(fe(e[o],s,n,t));return a}function Ls(e,s,n,t=!0){const a=s?s.vnode:null;if(s){let o=s.parent;const i=s.proxy,l=n;for(;o;){const u=o.ec;if(u){for(let h=0;h<u.length;h++)if(u[h](e,i,l)===!1)return}o=o.parent}const c=s.appContext.config.errorHandler;if(c){Me(c,null,10,[e,i,l]);return}}Mo(e,n,a,t)}function Mo(e,s,n,t=!0){console.error(e)}let vs=!1,qn=!1;const oe=[];let xe=0;const us=[];let Pe=null,$e=0;const Ct=Promise.resolve();let zn=null;function Bo(e){const s=zn||Ct;return e?s.then(this?e.bind(this):e):s}function Yo(e){let s=xe+1,n=oe.length;for(;s<n;){const t=s+n>>>1,a=oe[t],o=ws(a);o<e||o===e&&a.pre?s=t+1:n=t}return s}function Pn(e){(!oe.length||!oe.includes(e,vs&&e.allowRecurse?xe+1:xe))&&(e.id==null?oe.push(e):oe.splice(Yo(e.id),0,e),Rt())}function Rt(){!vs&&!qn&&(qn=!0,zn=Ct.then(Mt))}function Uo(e){const s=oe.indexOf(e);s>xe&&oe.splice(s,1)}function Lo(e){x(e)?us.push(...e):(!Pe||!Pe.includes(e,e.allowRecurse?$e+1:$e))&&us.push(e),Rt()}function Ft(e,s=vs?xe+1:0){for(;s<oe.length;s++){const n=oe[s];n&&n.pre&&(oe.splice(s,1),s--,n())}}function Ht(e){if(us.length){const s=[...new Set(us)];if(us.length=0,Pe){Pe.push(...s);return}for(Pe=s,Pe.sort((n,t)=>ws(n)-ws(t)),$e=0;$e<Pe.length;$e++)Pe[$e]();Pe=null,$e=0}}const ws=e=>e.id==null?1/0:e.id,Wo=(e,s)=>{const n=ws(e)-ws(s);if(n===0){if(e.pre&&!s.pre)return-1;if(s.pre&&!e.pre)return 1}return n};function Mt(e){qn=!1,vs=!0,oe.sort(Wo);try{for(xe=0;xe<oe.length;xe++){const s=oe[xe];s&&s.active!==!1&&Me(s,null,14)}}finally{xe=0,oe.length=0,Ht(),vs=!1,zn=null,(oe.length||us.length)&&Mt()}}function Vo(e,s,...n){if(e.isUnmounted)return;const t=e.vnode.props||U;let a=n;const o=s.startsWith("update:"),i=o&&s.slice(7);if(i&&i in t){const h=`${i==="modelValue"?"model":i}Modifiers`,{number:y,trim:v}=t[h]||U;v&&(a=n.map(A=>Z(A)?A.trim():A)),y&&(a=n.map(to))}let l,c=t[l=gn(s)]||t[l=gn(Ae(s))];!c&&o&&(c=t[l=gn(is(s))]),c&&fe(c,e,6,a);const u=t[l+"Once"];if(u){if(!e.emitted)e.emitted={};else if(e.emitted[l])return;e.emitted[l]=!0,fe(u,e,6,a)}}function Bt(e,s,n=!1){const t=s.emitsCache,a=t.get(e);if(a!==void 0)return a;const o=e.emits;let i={},l=!1;if(!I(e)){const c=u=>{const h=Bt(u,s,!0);h&&(l=!0,se(i,h))};!n&&s.mixins.length&&s.mixins.forEach(c),e.extends&&c(e.extends),e.mixins&&e.mixins.forEach(c)}return!o&&!l?(M(e)&&t.set(e,null),null):(x(o)?o.forEach(c=>i[c]=null):se(i,o),M(e)&&t.set(e,i),i)}function Ws(e,s){return!e||!Os(s)?!1:(s=s.slice(2).replace(/Once$/,""),P(e,s[0].toLowerCase()+s.slice(1))||P(e,is(s))||P(e,s))}let ge=null,Yt=null;function Vs(e){const s=ge;return ge=e,Yt=e&&e.type.__scopeId||null,s}function Ut(e,s=ge,n){if(!s||e._n)return e;const t=(...a)=>{t._d&&Ja(-1);const o=Vs(s);let i;try{i=e(...a)}finally{Vs(o),t._d&&Ja(1)}return i};return t._n=!0,t._c=!0,t._d=!0,t}function ul(){}function En(e){const{type:s,vnode:n,proxy:t,withProxy:a,props:o,propsOptions:[i],slots:l,attrs:c,emit:u,render:h,renderCache:y,data:v,setupState:A,ctx:E,inheritAttrs:D}=e;let B,W;const L=Vs(e);try{if(n.shapeFlag&4){const N=a||t,Q=N;B=Ne(h.call(Q,N,y,o,A,v,E)),W=c}else{const N=s;B=Ne(N.length>1?N(o,{attrs:c,slots:l,emit:u}):N(o,null)),W=s.props?c:$o(c)}}catch(N){Ts.length=0,Ls(N,e,1),B=ce(we)}let V=B;if(W&&D!==!1){const N=Object.keys(W),{shapeFlag:Q}=V;N.length&&Q&7&&(i&&N.some(hn)&&(W=Ko(W,i)),V=Ye(V,W))}return n.dirs&&(V=Ye(V),V.dirs=V.dirs?V.dirs.concat(n.dirs):n.dirs),n.transition&&(V.transition=n.transition),B=V,Vs(L),B}const $o=e=>{let s;for(const n in e)(n==="class"||n==="style"||Os(n))&&((s||(s={}))[n]=e[n]);return s},Ko=(e,s)=>{const n={};for(const t in e)(!hn(t)||!(t.slice(9)in s))&&(n[t]=e[t]);return n};function Go(e,s,n){const{props:t,children:a,component:o}=e,{props:i,children:l,patchFlag:c}=s,u=o.emitsOptions;if(s.dirs||s.transition)return!0;if(n&&c>=0){if(c&1024)return!0;if(c&16)return t?Lt(t,i,u):!!i;if(c&8){const h=s.dynamicProps;for(let y=0;y<h.length;y++){const v=h[y];if(i[v]!==t[v]&&!Ws(u,v))return!0}}}else return(a||l)&&(!l||!l.$stable)?!0:t===i?!1:t?i?Lt(t,i,u):!0:!!i;return!1}function Lt(e,s,n){const t=Object.keys(s);if(t.length!==Object.keys(e).length)return!0;for(let a=0;a<t.length;a++){const o=t[a];if(s[o]!==e[o]&&!Ws(n,o))return!0}return!1}function Xo({vnode:e,parent:s},n){for(;s&&s.subTree===e;)(e=s.vnode).el=n,s=s.parent}const Wt="components";function Cn(e,s){return Qo(Wt,e,!0,s)||e}const Zo=Symbol.for("v-ndc");function Qo(e,s,n=!0,t=!1){const a=ge||te;if(a){const o=a.type;if(e===Wt){const l=Vi(o,!1);if(l&&(l===s||l===Ae(s)||l===Es(Ae(s))))return o}const i=Vt(a[e]||o[e],s)||Vt(a.appContext[e],s);return!i&&t?o:i}}function Vt(e,s){return e&&(e[s]||e[Ae(s)]||e[Es(Ae(s))])}const ei=e=>e.__isSuspense;function si(e,s){s&&s.pendingBranch?x(e)?s.effects.push(...e):s.effects.push(e):Lo(e)}const $s={};function Rn(e,s,n){return $t(e,s,n)}function $t(e,s,{immediate:n,deep:t,flush:a,onTrack:o,onTrigger:i}=U){var l;const c=ho()===((l=te)==null?void 0:l.scope)?te:null;let u,h=!1,y=!1;if(re(e)?(u=()=>e.value,h=Nn(e)):ps(e)?(u=()=>e,t=!0):x(e)?(y=!0,h=e.some(N=>ps(N)||Nn(N)),u=()=>e.map(N=>{if(re(N))return N.value;if(ps(N))return ds(N);if(I(N))return Me(N,c,2)})):I(e)?s?u=()=>Me(e,c,2):u=()=>{if(!(c&&c.isUnmounted))return v&&v(),fe(e,c,3,[A])}:u=ke,s&&t){const N=u;u=()=>ds(N())}let v,A=N=>{v=L.onStop=()=>{Me(N,c,4),v=L.onStop=void 0}},E;if(ks)if(A=ke,s?n&&fe(s,c,3,[u(),y?[]:void 0,A]):u(),a==="sync"){const N=Zi();E=N.__watcherHandles||(N.__watcherHandles=[])}else return ke;let D=y?new Array(e.length).fill($s):$s;const B=()=>{if(L.active)if(s){const N=L.run();(t||h||(y?N.some((Q,_e)=>rs(Q,D[_e])):rs(N,D)))&&(v&&v(),fe(s,c,3,[N,D===$s?void 0:y&&D[0]===$s?[]:D,A]),D=N)}else L.run()};B.allowRecurse=!!s;let W;a==="sync"?W=B:a==="post"?W=()=>ue(B,c&&c.suspense):(B.pre=!0,c&&(B.id=c.uid),W=()=>Pn(B));const L=new Tn(u,W);s?n?B():D=L.run():a==="post"?ue(L.run.bind(L),c&&c.suspense):L.run();const V=()=>{L.stop(),c&&c.scope&&mn(c.scope.effects,L)};return E&&E.push(V),V}function ni(e,s,n){const t=this.proxy,a=Z(e)?e.includes(".")?Kt(t,e):()=>t[e]:e.bind(t,t);let o;I(s)?o=s:(o=s.handler,n=s);const i=te;ms(this);const l=$t(a,o.bind(t),n);return i?ms(i):Ze(),l}function Kt(e,s){const n=s.split(".");return()=>{let t=e;for(let a=0;a<n.length&&t;a++)t=t[n[a]];return t}}function ds(e,s){if(!M(e)||e.__v_skip||(s=s||new Set,s.has(e)))return e;if(s.add(e),re(e))ds(e.value,s);else if(x(e))for(let n=0;n<e.length;n++)ds(e[n],s);else if(ct(e)||os(e))e.forEach(n=>{ds(n,s)});else if(dt(e))for(const n in e)ds(e[n],s);return e}function Ke(e,s,n,t){const a=e.dirs,o=s&&s.dirs;for(let i=0;i<a.length;i++){const l=a[i];o&&(l.oldValue=o[i].value);let c=l.dir[t];c&&(ls(),fe(c,n,8,[e.el,l,e,s]),cs())}}const Be=Symbol("_leaveCb"),Ks=Symbol("_enterCb");function ti(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return sa(()=>{e.isMounted=!0}),na(()=>{e.isUnmounting=!0}),e}const ye=[Function,Array],Gt={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:ye,onEnter:ye,onAfterEnter:ye,onEnterCancelled:ye,onBeforeLeave:ye,onLeave:ye,onAfterLeave:ye,onLeaveCancelled:ye,onBeforeAppear:ye,onAppear:ye,onAfterAppear:ye,onAppearCancelled:ye},ai={name:"BaseTransition",props:Gt,setup(e,{slots:s}){const n=Bi(),t=ti();let a;return()=>{const o=s.default&&Qt(s.default(),!0);if(!o||!o.length)return;let i=o[0];if(o.length>1){for(const D of o)if(D.type!==we){i=D;break}}const l=C(e),{mode:c}=l;if(t.isLeaving)return Hn(i);const u=Zt(i);if(!u)return Hn(i);const h=Fn(u,l,t,n);Mn(u,h);const y=n.subTree,v=y&&Zt(y);let A=!1;const{getTransitionKey:E}=u.type;if(E){const D=E();a===void 0?a=D:D!==a&&(a=D,A=!0)}if(v&&v.type!==we&&(!Xe(u,v)||A)){const D=Fn(v,l,t,n);if(Mn(v,D),c==="out-in")return t.isLeaving=!0,D.afterLeave=()=>{t.isLeaving=!1,n.update.active!==!1&&n.update()},Hn(i);c==="in-out"&&u.type!==we&&(D.delayLeave=(B,W,L)=>{const V=Xt(t,v);V[String(v.key)]=v,B[Be]=()=>{W(),B[Be]=void 0,delete h.delayedLeave},h.delayedLeave=L})}return i}}};function Xt(e,s){const{leavingVNodes:n}=e;let t=n.get(s.type);return t||(t=Object.create(null),n.set(s.type,t)),t}function Fn(e,s,n,t){const{appear:a,mode:o,persisted:i=!1,onBeforeEnter:l,onEnter:c,onAfterEnter:u,onEnterCancelled:h,onBeforeLeave:y,onLeave:v,onAfterLeave:A,onLeaveCancelled:E,onBeforeAppear:D,onAppear:B,onAfterAppear:W,onAppearCancelled:L}=s,V=String(e.key),N=Xt(n,e),Q=(q,G)=>{q&&fe(q,t,9,G)},_e=(q,G)=>{const Y=G[1];Q(q,G),x(q)?q.every(ie=>ie.length<=1)&&Y():q.length<=1&&Y()},Te={mode:o,persisted:i,beforeEnter(q){let G=l;if(!n.isMounted)if(a)G=D||l;else return;q[Be]&&q[Be](!0);const Y=N[V];Y&&Xe(e,Y)&&Y.el[Be]&&Y.el[Be](),Q(G,[q])},enter(q){let G=c,Y=u,ie=h;if(!n.isMounted)if(a)G=B||c,Y=W||u,ie=L||h;else return;let T=!1;const K=q[Ks]=he=>{T||(T=!0,he?Q(ie,[q]):Q(Y,[q]),Te.delayedLeave&&Te.delayedLeave(),q[Ks]=void 0)};G?_e(G,[q,K]):K()},leave(q,G){const Y=String(e.key);if(q[Ks]&&q[Ks](!0),n.isUnmounting)return G();Q(y,[q]);let ie=!1;const T=q[Be]=K=>{ie||(ie=!0,G(),K?Q(E,[q]):Q(A,[q]),q[Be]=void 0,N[Y]===e&&delete N[Y])};N[Y]=e,v?_e(v,[q,T]):T()},clone(q){return Fn(q,s,n,t)}};return Te}function Hn(e){if(Xs(e))return e=Ye(e),e.children=null,e}function Zt(e){return Xs(e)?e.children?e.children[0]:void 0:e}function Mn(e,s){e.shapeFlag&6&&e.component?Mn(e.component.subTree,s):e.shapeFlag&128?(e.ssContent.transition=s.clone(e.ssContent),e.ssFallback.transition=s.clone(e.ssFallback)):e.transition=s}function Qt(e,s=!1,n){let t=[],a=0;for(let o=0;o<e.length;o++){let i=e[o];const l=n==null?i.key:String(n)+String(i.key!=null?i.key:o);i.type===be?(i.patchFlag&128&&a++,t=t.concat(Qt(i.children,s,l))):(s||i.type!==we)&&t.push(l!=null?Ye(i,{key:l}):i)}if(a>1)for(let o=0;o<t.length;o++)t[o].patchFlag=-2;return t}/*! #__NO_SIDE_EFFECTS__ */function Bn(e,s){return I(e)?se({name:e.name},s,{setup:e}):e}const Gs=e=>!!e.type.__asyncLoader,Xs=e=>e.type.__isKeepAlive;function oi(e,s){ea(e,"a",s)}function ii(e,s){ea(e,"da",s)}function ea(e,s,n=te){const t=e.__wdc||(e.__wdc=()=>{let a=n;for(;a;){if(a.isDeactivated)return;a=a.parent}return e()});if(Zs(s,t,n),n){let a=n.parent;for(;a&&a.parent;)Xs(a.parent.vnode)&&ri(t,s,n,a),a=a.parent}}function ri(e,s,n,t){const a=Zs(s,e,t,!0);ta(()=>{mn(t[s],a)},n)}function Zs(e,s,n=te,t=!1){if(n){const a=n[e]||(n[e]=[]),o=s.__weh||(s.__weh=(...i)=>{if(n.isUnmounted)return;ls(),ms(n);const l=fe(s,n,e,i);return Ze(),cs(),l});return t?a.unshift(o):a.push(o),o}}const Ee=e=>(s,n=te)=>(!ks||e==="sp")&&Zs(e,(...t)=>s(...t),n),li=Ee("bm"),sa=Ee("m"),ci=Ee("bu"),pi=Ee("u"),na=Ee("bum"),ta=Ee("um"),ui=Ee("sp"),di=Ee("rtg"),hi=Ee("rtc");function mi(e,s=te){Zs("ec",e,s)}function aa(e,s,n,t){let a;const o=n&&n[t];if(x(e)||Z(e)){a=new Array(e.length);for(let i=0,l=e.length;i<l;i++)a[i]=s(e[i],i,void 0,o&&o[i])}else if(typeof e=="number"){a=new Array(e);for(let i=0;i<e;i++)a[i]=s(i+1,i,void 0,o&&o[i])}else if(M(e))if(e[Symbol.iterator])a=Array.from(e,(i,l)=>s(i,l,void 0,o&&o[l]));else{const i=Object.keys(e);a=new Array(i.length);for(let l=0,c=i.length;l<c;l++){const u=i[l];a[l]=s(e[u],u,l,o&&o[l])}}else a=[];return n&&(n[t]=a),a}const Yn=e=>e?ka(e)?st(e)||e.proxy:Yn(e.parent):null,Js=se(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Yn(e.parent),$root:e=>Yn(e.root),$emit:e=>e.emit,$options:e=>Wn(e),$forceUpdate:e=>e.f||(e.f=()=>Pn(e.update)),$nextTick:e=>e.n||(e.n=Bo.bind(e.proxy)),$watch:e=>ni.bind(e)}),Un=(e,s)=>e!==U&&!e.__isScriptSetup&&P(e,s),fi={get({_:e},s){const{ctx:n,setupState:t,data:a,props:o,accessCache:i,type:l,appContext:c}=e;let u;if(s[0]!=="$"){const A=i[s];if(A!==void 0)switch(A){case 1:return t[s];case 2:return a[s];case 4:return n[s];case 3:return o[s]}else{if(Un(t,s))return i[s]=1,t[s];if(a!==U&&P(a,s))return i[s]=2,a[s];if((u=e.propsOptions[0])&&P(u,s))return i[s]=3,o[s];if(n!==U&&P(n,s))return i[s]=4,n[s];Ln&&(i[s]=0)}}const h=Js[s];let y,v;if(h)return s==="$attrs"&&pe(e,"get",s),h(e);if((y=l.__cssModules)&&(y=y[s]))return y;if(n!==U&&P(n,s))return i[s]=4,n[s];if(v=c.config.globalProperties,P(v,s))return v[s]},set({_:e},s,n){const{data:t,setupState:a,ctx:o}=e;return Un(a,s)?(a[s]=n,!0):t!==U&&P(t,s)?(t[s]=n,!0):P(e.props,s)||s[0]==="$"&&s.slice(1)in e?!1:(o[s]=n,!0)},has({_:{data:e,setupState:s,accessCache:n,ctx:t,appContext:a,propsOptions:o}},i){let l;return!!n[i]||e!==U&&P(e,i)||Un(s,i)||(l=o[0])&&P(l,i)||P(t,i)||P(Js,i)||P(a.config.globalProperties,i)},defineProperty(e,s,n){return n.get!=null?e._.accessCache[s]=0:P(n,"value")&&this.set(e,s,n.value,null),Reflect.defineProperty(e,s,n)}};function oa(e){return x(e)?e.reduce((s,n)=>(s[n]=null,s),{}):e}let Ln=!0;function gi(e){const s=Wn(e),n=e.proxy,t=e.ctx;Ln=!1,s.beforeCreate&&ia(s.beforeCreate,e,"bc");const{data:a,computed:o,methods:i,watch:l,provide:c,inject:u,created:h,beforeMount:y,mounted:v,beforeUpdate:A,updated:E,activated:D,deactivated:B,beforeDestroy:W,beforeUnmount:L,destroyed:V,unmounted:N,render:Q,renderTracked:_e,renderTriggered:Te,errorCaptured:q,serverPrefetch:G,expose:Y,inheritAttrs:ie,components:T,directives:K,filters:he}=s;if(u&&yi(u,t,null),i)for(const X in i){const F=i[X];I(F)&&(t[X]=F.bind(n))}if(a){const X=a.call(n,n);M(X)&&(e.data=xn(X))}if(Ln=!0,o)for(const X in o){const F=o[X],ns=I(F)?F.bind(n,n):I(F.get)?F.get.bind(n,n):ke,pn=!I(F)&&I(F.set)?F.set.bind(n):ke,ts=Ki({get:ns,set:pn});Object.defineProperty(t,X,{enumerable:!0,configurable:!0,get:()=>ts.value,set:Ie=>ts.value=Ie})}if(l)for(const X in l)ra(l[X],t,n,X);if(c){const X=I(c)?c.call(n):c;Reflect.ownKeys(X).forEach(F=>{_i(F,X[F])})}h&&ia(h,e,"c");function ae(X,F){x(F)?F.forEach(ns=>X(ns.bind(n))):F&&X(F.bind(n))}if(ae(li,y),ae(sa,v),ae(ci,A),ae(pi,E),ae(oi,D),ae(ii,B),ae(mi,q),ae(hi,_e),ae(di,Te),ae(na,L),ae(ta,N),ae(ui,G),x(Y))if(Y.length){const X=e.exposed||(e.exposed={});Y.forEach(F=>{Object.defineProperty(X,F,{get:()=>n[F],set:ns=>n[F]=ns})})}else e.exposed||(e.exposed={});Q&&e.render===ke&&(e.render=Q),ie!=null&&(e.inheritAttrs=ie),T&&(e.components=T),K&&(e.directives=K)}function yi(e,s,n=ke){x(e)&&(e=Vn(e));for(const t in e){const a=e[t];let o;M(a)?"default"in a?o=sn(a.from||t,a.default,!0):o=sn(a.from||t):o=sn(a),re(o)?Object.defineProperty(s,t,{enumerable:!0,configurable:!0,get:()=>o.value,set:i=>o.value=i}):s[t]=o}}function ia(e,s,n){fe(x(e)?e.map(t=>t.bind(s.proxy)):e.bind(s.proxy),s,n)}function ra(e,s,n,t){const a=t.includes(".")?Kt(n,t):()=>n[t];if(Z(e)){const o=s[e];I(o)&&Rn(a,o)}else if(I(e))Rn(a,e.bind(n));else if(M(e))if(x(e))e.forEach(o=>ra(o,s,n,t));else{const o=I(e.handler)?e.handler.bind(n):s[e.handler];I(o)&&Rn(a,o,e)}}function Wn(e){const s=e.type,{mixins:n,extends:t}=s,{mixins:a,optionsCache:o,config:{optionMergeStrategies:i}}=e.appContext,l=o.get(s);let c;return l?c=l:!a.length&&!n&&!t?c=s:(c={},a.length&&a.forEach(u=>Qs(c,u,i,!0)),Qs(c,s,i)),M(s)&&o.set(s,c),c}function Qs(e,s,n,t=!1){const{mixins:a,extends:o}=s;o&&Qs(e,o,n,!0),a&&a.forEach(i=>Qs(e,i,n,!0));for(const i in s)if(!(t&&i==="expose")){const l=bi[i]||n&&n[i];e[i]=l?l(e[i],s[i]):s[i]}return e}const bi={data:la,props:ca,emits:ca,methods:_s,computed:_s,beforeCreate:le,created:le,beforeMount:le,mounted:le,beforeUpdate:le,updated:le,beforeDestroy:le,beforeUnmount:le,destroyed:le,unmounted:le,activated:le,deactivated:le,errorCaptured:le,serverPrefetch:le,components:_s,directives:_s,watch:vi,provide:la,inject:ji};function la(e,s){return s?e?function(){return se(I(e)?e.call(this,this):e,I(s)?s.call(this,this):s)}:s:e}function ji(e,s){return _s(Vn(e),Vn(s))}function Vn(e){if(x(e)){const s={};for(let n=0;n<e.length;n++)s[e[n]]=e[n];return s}return e}function le(e,s){return e?[...new Set([].concat(e,s))]:s}function _s(e,s){return e?se(Object.create(null),e,s):s}function ca(e,s){return e?x(e)&&x(s)?[...new Set([...e,...s])]:se(Object.create(null),oa(e),oa(s??{})):s}function vi(e,s){if(!e)return s;if(!s)return e;const n=se(Object.create(null),e);for(const t in s)n[t]=le(e[t],s[t]);return n}function pa(){return{app:null,config:{isNativeTag:Xa,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let wi=0;function Ji(e,s){return function(t,a=null){I(t)||(t=se({},t)),a!=null&&!M(a)&&(a=null);const o=pa(),i=new WeakSet;let l=!1;const c=o.app={_uid:wi++,_component:t,_props:a,_container:null,_context:o,_instance:null,version:Qi,get config(){return o.config},set config(u){},use(u,...h){return i.has(u)||(u&&I(u.install)?(i.add(u),u.install(c,...h)):I(u)&&(i.add(u),u(c,...h))),c},mixin(u){return o.mixins.includes(u)||o.mixins.push(u),c},component(u,h){return h?(o.components[u]=h,c):o.components[u]},directive(u,h){return h?(o.directives[u]=h,c):o.directives[u]},mount(u,h,y){if(!l){const v=ce(t,a);return v.appContext=o,h&&s?s(v,u):e(v,u,y),l=!0,c._container=u,u.__vue_app__=c,st(v.component)||v.component.proxy}},unmount(){l&&(e(null,c._container),delete c._container.__vue_app__)},provide(u,h){return o.provides[u]=h,c},runWithContext(u){en=c;try{return u()}finally{en=null}}};return c}}let en=null;function _i(e,s){if(te){let n=te.provides;const t=te.parent&&te.parent.provides;t===n&&(n=te.provides=Object.create(t)),n[e]=s}}function sn(e,s,n=!1){const t=te||ge;if(t||en){const a=t?t.parent==null?t.vnode.appContext&&t.vnode.appContext.provides:t.parent.provides:en._context.provides;if(a&&e in a)return a[e];if(arguments.length>1)return n&&I(s)?s.call(t&&t.proxy):s}}function Ti(e,s,n,t=!1){const a={},o={};Cs(o,on,1),e.propsDefaults=Object.create(null),ua(e,s,a,o);for(const i in e.propsOptions[0])i in a||(a[i]=void 0);n?e.props=t?a:zo(a):e.type.props?e.props=a:e.props=o,e.attrs=o}function Si(e,s,n,t){const{props:a,attrs:o,vnode:{patchFlag:i}}=e,l=C(a),[c]=e.propsOptions;let u=!1;if((t||i>0)&&!(i&16)){if(i&8){const h=e.vnode.dynamicProps;for(let y=0;y<h.length;y++){let v=h[y];if(Ws(e.emitsOptions,v))continue;const A=s[v];if(c)if(P(o,v))A!==o[v]&&(o[v]=A,u=!0);else{const E=Ae(v);a[E]=$n(c,l,E,A,e,!1)}else A!==o[v]&&(o[v]=A,u=!0)}}}else{ua(e,s,a,o)&&(u=!0);let h;for(const y in l)(!s||!P(s,y)&&((h=is(y))===y||!P(s,h)))&&(c?n&&(n[y]!==void 0||n[h]!==void 0)&&(a[y]=$n(c,l,y,void 0,e,!0)):delete a[y]);if(o!==l)for(const y in o)(!s||!P(s,y))&&(delete o[y],u=!0)}u&&ze(e,"set","$attrs")}function ua(e,s,n,t){const[a,o]=e.propsOptions;let i=!1,l;if(s)for(let c in s){if(zs(c))continue;const u=s[c];let h;a&&P(a,h=Ae(c))?!o||!o.includes(h)?n[h]=u:(l||(l={}))[h]=u:Ws(e.emitsOptions,c)||(!(c in t)||u!==t[c])&&(t[c]=u,i=!0)}if(o){const c=C(n),u=l||U;for(let h=0;h<o.length;h++){const y=o[h];n[y]=$n(a,c,y,u[y],e,!P(u,y))}}return i}function $n(e,s,n,t,a,o){const i=e[n];if(i!=null){const l=P(i,"default");if(l&&t===void 0){const c=i.default;if(i.type!==Function&&!i.skipFactory&&I(c)){const{propsDefaults:u}=a;n in u?t=u[n]:(ms(a),t=u[n]=c.call(null,s),Ze())}else t=c}i[0]&&(o&&!l?t=!1:i[1]&&(t===""||t===is(n))&&(t=!0))}return t}function da(e,s,n=!1){const t=s.propsCache,a=t.get(e);if(a)return a;const o=e.props,i={},l=[];let c=!1;if(!I(e)){const h=y=>{c=!0;const[v,A]=da(y,s,!0);se(i,v),A&&l.push(...A)};!n&&s.mixins.length&&s.mixins.forEach(h),e.extends&&h(e.extends),e.mixins&&e.mixins.forEach(h)}if(!o&&!c)return M(e)&&t.set(e,as),as;if(x(o))for(let h=0;h<o.length;h++){const y=Ae(o[h]);ha(y)&&(i[y]=U)}else if(o)for(const h in o){const y=Ae(h);if(ha(y)){const v=o[h],A=i[y]=x(v)||I(v)?{type:v}:se({},v);if(A){const E=ya(Boolean,A.type),D=ya(String,A.type);A[0]=E>-1,A[1]=D<0||E<D,(E>-1||P(A,"default"))&&l.push(y)}}}const u=[i,l];return M(e)&&t.set(e,u),u}function ha(e){return e[0]!=="$"}function ma(e){const s=e&&e.toString().match(/^\s*(function|class) (\w+)/);return s?s[2]:e===null?"null":""}function fa(e,s){return ma(e)===ma(s)}function ya(e,s){return x(s)?s.findIndex(n=>fa(n,e)):I(s)&&fa(s,e)?0:-1}const ba=e=>e[0]==="_"||e==="$stable",Kn=e=>x(e)?e.map(Ne):[Ne(e)],ki=(e,s,n)=>{if(s._n)return s;const t=Ut((...a)=>Kn(s(...a)),n);return t._c=!1,t},ja=(e,s,n)=>{const t=e._ctx;for(const a in e){if(ba(a))continue;const o=e[a];if(I(o))s[a]=ki(a,o,t);else if(o!=null){const i=Kn(o);s[a]=()=>i}}},va=(e,s)=>{const n=Kn(s);e.slots.default=()=>n},Ai=(e,s)=>{if(e.vnode.shapeFlag&32){const n=s._;n?(e.slots=C(s),Cs(s,"_",n)):ja(s,e.slots={})}else e.slots={},s&&va(e,s);Cs(e.slots,on,1)},xi=(e,s,n)=>{const{vnode:t,slots:a}=e;let o=!0,i=U;if(t.shapeFlag&32){const l=s._;l?n&&l===1?o=!1:(se(a,s),!n&&l===1&&delete a._):(o=!s.$stable,ja(s,a)),i=s}else s&&(va(e,s),i={default:1});if(o)for(const l in a)!ba(l)&&i[l]==null&&delete a[l]};function Gn(e,s,n,t,a=!1){if(x(e)){e.forEach((v,A)=>Gn(v,s&&(x(s)?s[A]:s),n,t,a));return}if(Gs(t)&&!a)return;const o=t.shapeFlag&4?st(t.component)||t.component.proxy:t.el,i=a?null:o,{i:l,r:c}=e,u=s&&s.r,h=l.refs===U?l.refs={}:l.refs,y=l.setupState;if(u!=null&&u!==c&&(Z(u)?(h[u]=null,P(y,u)&&(y[u]=null)):re(u)&&(u.value=null)),I(c))Me(c,l,12,[i,h]);else{const v=Z(c),A=re(c);if(v||A){const E=()=>{if(e.f){const D=v?P(y,c)?y[c]:h[c]:c.value;a?x(D)&&mn(D,o):x(D)?D.includes(o)||D.push(o):v?(h[c]=[o],P(y,c)&&(y[c]=h[c])):(c.value=[o],e.k&&(h[e.k]=c.value))}else v?(h[c]=i,P(y,c)&&(y[c]=i)):A&&(c.value=i,e.k&&(h[e.k]=i))};i?(E.id=-1,ue(E,n)):E()}}}const ue=si;function Di(e){return Ni(e)}function Ni(e,s){const n=bn();n.__VUE__=!0;const{insert:t,remove:a,patchProp:o,createElement:i,createText:l,createComment:c,setText:u,setElementText:h,parentNode:y,nextSibling:v,setScopeId:A=ke,insertStaticContent:E}=e,D=(r,p,d,m=null,f=null,j=null,J=!1,b=null,w=!!p.dynamicChildren)=>{if(r===p)return;r&&!Xe(r,p)&&(m=un(r),Ie(r,f,j,!0),r=null),p.patchFlag===-2&&(w=!1,p.dynamicChildren=null);const{type:g,ref:S,shapeFlag:_}=p;switch(g){case nn:B(r,p,d,m);break;case we:W(r,p,d,m);break;case tn:r==null&&L(p,d,m,J);break;case be:T(r,p,d,m,f,j,J,b,w);break;default:_&1?Q(r,p,d,m,f,j,J,b,w):_&6?K(r,p,d,m,f,j,J,b,w):(_&64||_&128)&&g.process(r,p,d,m,f,j,J,b,w,fs)}S!=null&&f&&Gn(S,r&&r.ref,j,p||r,!p)},B=(r,p,d,m)=>{if(r==null)t(p.el=l(p.children),d,m);else{const f=p.el=r.el;p.children!==r.children&&u(f,p.children)}},W=(r,p,d,m)=>{r==null?t(p.el=c(p.children||""),d,m):p.el=r.el},L=(r,p,d,m)=>{[r.el,r.anchor]=E(r.children,p,d,m,r.el,r.anchor)},V=({el:r,anchor:p},d,m)=>{let f;for(;r&&r!==p;)f=v(r),t(r,d,m),r=f;t(p,d,m)},N=({el:r,anchor:p})=>{let d;for(;r&&r!==p;)d=v(r),a(r),r=d;a(p)},Q=(r,p,d,m,f,j,J,b,w)=>{J=J||p.type==="svg",r==null?_e(p,d,m,f,j,J,b,w):G(r,p,f,j,J,b,w)},_e=(r,p,d,m,f,j,J,b)=>{let w,g;const{type:S,props:_,shapeFlag:k,transition:O,dirs:z}=r;if(w=r.el=i(r.type,j,_&&_.is,_),k&8?h(w,r.children):k&16&&q(r.children,w,null,m,f,j&&S!=="foreignObject",J,b),z&&Ke(r,null,m,"created"),Te(w,r,r.scopeId,J,m),_){for(const R in _)R!=="value"&&!zs(R)&&o(w,R,null,_[R],j,r.children,m,f,Ce);"value"in _&&o(w,"value",null,_.value),(g=_.onVnodeBeforeMount)&&Oe(g,m,r)}z&&Ke(r,null,m,"beforeMount");const H=Oi(f,O);H&&O.beforeEnter(w),t(w,p,d),((g=_&&_.onVnodeMounted)||H||z)&&ue(()=>{g&&Oe(g,m,r),H&&O.enter(w),z&&Ke(r,null,m,"mounted")},f)},Te=(r,p,d,m,f)=>{if(d&&A(r,d),m)for(let j=0;j<m.length;j++)A(r,m[j]);if(f){let j=f.subTree;if(p===j){const J=f.vnode;Te(r,J,J.scopeId,J.slotScopeIds,f.parent)}}},q=(r,p,d,m,f,j,J,b,w=0)=>{for(let g=w;g<r.length;g++){const S=r[g]=b?Ue(r[g]):Ne(r[g]);D(null,S,p,d,m,f,j,J,b)}},G=(r,p,d,m,f,j,J)=>{const b=p.el=r.el;let{patchFlag:w,dynamicChildren:g,dirs:S}=p;w|=r.patchFlag&16;const _=r.props||U,k=p.props||U;let O;d&&Ge(d,!1),(O=k.onVnodeBeforeUpdate)&&Oe(O,d,p,r),S&&Ke(p,r,d,"beforeUpdate"),d&&Ge(d,!0);const z=f&&p.type!=="foreignObject";if(g?Y(r.dynamicChildren,g,b,d,m,z,j):J||F(r,p,b,null,d,m,z,j,!1),w>0){if(w&16)ie(b,p,_,k,d,m,f);else if(w&2&&_.class!==k.class&&o(b,"class",null,k.class,f),w&4&&o(b,"style",_.style,k.style,f),w&8){const H=p.dynamicProps;for(let R=0;R<H.length;R++){const ee=H[R],Se=_[ee],gs=k[ee];(gs!==Se||ee==="value")&&o(b,ee,Se,gs,f,r.children,d,m,Ce)}}w&1&&r.children!==p.children&&h(b,p.children)}else!J&&g==null&&ie(b,p,_,k,d,m,f);((O=k.onVnodeUpdated)||S)&&ue(()=>{O&&Oe(O,d,p,r),S&&Ke(p,r,d,"updated")},m)},Y=(r,p,d,m,f,j,J)=>{for(let b=0;b<p.length;b++){const w=r[b],g=p[b],S=w.el&&(w.type===be||!Xe(w,g)||w.shapeFlag&70)?y(w.el):d;D(w,g,S,null,m,f,j,J,!0)}},ie=(r,p,d,m,f,j,J)=>{if(d!==m){if(d!==U)for(const b in d)!zs(b)&&!(b in m)&&o(r,b,d[b],null,J,p.children,f,j,Ce);for(const b in m){if(zs(b))continue;const w=m[b],g=d[b];w!==g&&b!=="value"&&o(r,b,g,w,J,p.children,f,j,Ce)}"value"in m&&o(r,"value",d.value,m.value)}},T=(r,p,d,m,f,j,J,b,w)=>{const g=p.el=r?r.el:l(""),S=p.anchor=r?r.anchor:l("");let{patchFlag:_,dynamicChildren:k,slotScopeIds:O}=p;O&&(b=b?b.concat(O):O),r==null?(t(g,d,m),t(S,d,m),q(p.children,d,S,f,j,J,b,w)):_>0&&_&64&&k&&r.dynamicChildren?(Y(r.dynamicChildren,k,d,f,j,J,b),(p.key!=null||f&&p===f.subTree)&&wa(r,p,!0)):F(r,p,d,S,f,j,J,b,w)},K=(r,p,d,m,f,j,J,b,w)=>{p.slotScopeIds=b,r==null?p.shapeFlag&512?f.ctx.activate(p,d,m,J,w):he(p,d,m,f,j,J,w):Ds(r,p,w)},he=(r,p,d,m,f,j,J)=>{const b=r.component=Mi(r,m,f);if(Xs(r)&&(b.ctx.renderer=fs),Yi(b),b.asyncDep){if(f&&f.registerDep(b,ae),!r.el){const w=b.subTree=ce(we);W(null,w,p,d)}return}ae(b,r,p,d,f,j,J)},Ds=(r,p,d)=>{const m=p.component=r.component;if(Go(r,p,d))if(m.asyncDep&&!m.asyncResolved){X(m,p,d);return}else m.next=p,Uo(m.update),m.update();else p.el=r.el,m.vnode=p},ae=(r,p,d,m,f,j,J)=>{const b=()=>{if(r.isMounted){let{next:S,bu:_,u:k,parent:O,vnode:z}=r,H=S,R;Ge(r,!1),S?(S.el=z.el,X(r,S,J)):S=z,_&&yn(_),(R=S.props&&S.props.onVnodeBeforeUpdate)&&Oe(R,O,S,z),Ge(r,!0);const ee=En(r),Se=r.subTree;r.subTree=ee,D(Se,ee,y(Se.el),un(Se),r,f,j),S.el=ee.el,H===null&&Xo(r,ee.el),k&&ue(k,f),(R=S.props&&S.props.onVnodeUpdated)&&ue(()=>Oe(R,O,S,z),f)}else{let S;const{el:_,props:k}=p,{bm:O,m:z,parent:H}=r,R=Gs(p);if(Ge(r,!1),O&&yn(O),!R&&(S=k&&k.onVnodeBeforeMount)&&Oe(S,H,p),Ge(r,!0),_&&lt){const ee=()=>{r.subTree=En(r),lt(_,r.subTree,r,f,null)};R?p.type.__asyncLoader().then(()=>!r.isUnmounted&&ee()):ee()}else{const ee=r.subTree=En(r);D(null,ee,d,m,r,f,j),p.el=ee.el}if(z&&ue(z,f),!R&&(S=k&&k.onVnodeMounted)){const ee=p;ue(()=>Oe(S,H,ee),f)}(p.shapeFlag&256||H&&Gs(H.vnode)&&H.vnode.shapeFlag&256)&&r.a&&ue(r.a,f),r.isMounted=!0,p=d=m=null}},w=r.effect=new Tn(b,()=>Pn(g),r.scope),g=r.update=()=>w.run();g.id=r.uid,Ge(r,!0),g()},X=(r,p,d)=>{p.component=r;const m=r.vnode.props;r.vnode=p,r.next=null,Si(r,p.props,m,d),xi(r,p.children,d),ls(),Ft(),cs()},F=(r,p,d,m,f,j,J,b,w=!1)=>{const g=r&&r.children,S=r?r.shapeFlag:0,_=p.children,{patchFlag:k,shapeFlag:O}=p;if(k>0){if(k&128){pn(g,_,d,m,f,j,J,b,w);return}else if(k&256){ns(g,_,d,m,f,j,J,b,w);return}}O&8?(S&16&&Ce(g,f,j),_!==g&&h(d,_)):S&16?O&16?pn(g,_,d,m,f,j,J,b,w):Ce(g,f,j,!0):(S&8&&h(d,""),O&16&&q(_,d,m,f,j,J,b,w))},ns=(r,p,d,m,f,j,J,b,w)=>{r=r||as,p=p||as;const g=r.length,S=p.length,_=Math.min(g,S);let k;for(k=0;k<_;k++){const O=p[k]=w?Ue(p[k]):Ne(p[k]);D(r[k],O,d,null,f,j,J,b,w)}g>S?Ce(r,f,j,!0,!1,_):q(p,d,m,f,j,J,b,w,_)},pn=(r,p,d,m,f,j,J,b,w)=>{let g=0;const S=p.length;let _=r.length-1,k=S-1;for(;g<=_&&g<=k;){const O=r[g],z=p[g]=w?Ue(p[g]):Ne(p[g]);if(Xe(O,z))D(O,z,d,null,f,j,J,b,w);else break;g++}for(;g<=_&&g<=k;){const O=r[_],z=p[k]=w?Ue(p[k]):Ne(p[k]);if(Xe(O,z))D(O,z,d,null,f,j,J,b,w);else break;_--,k--}if(g>_){if(g<=k){const O=k+1,z=O<S?p[O].el:m;for(;g<=k;)D(null,p[g]=w?Ue(p[g]):Ne(p[g]),d,z,f,j,J,b,w),g++}}else if(g>k)for(;g<=_;)Ie(r[g],f,j,!0),g++;else{const O=g,z=g,H=new Map;for(g=z;g<=k;g++){const me=p[g]=w?Ue(p[g]):Ne(p[g]);me.key!=null&&H.set(me.key,g)}let R,ee=0;const Se=k-z+1;let gs=!1,$a=0;const Ns=new Array(Se);for(g=0;g<Se;g++)Ns[g]=0;for(g=O;g<=_;g++){const me=r[g];if(ee>=Se){Ie(me,f,j,!0);continue}let qe;if(me.key!=null)qe=H.get(me.key);else for(R=z;R<=k;R++)if(Ns[R-z]===0&&Xe(me,p[R])){qe=R;break}qe===void 0?Ie(me,f,j,!0):(Ns[qe-z]=g+1,qe>=$a?$a=qe:gs=!0,D(me,p[qe],d,null,f,j,J,b,w),ee++)}const Ka=gs?Ii(Ns):as;for(R=Ka.length-1,g=Se-1;g>=0;g--){const me=z+g,qe=p[me],Ga=me+1<S?p[me+1].el:m;Ns[g]===0?D(null,qe,d,Ga,f,j,J,b,w):gs&&(R<0||g!==Ka[R]?ts(qe,d,Ga,2):R--)}}},ts=(r,p,d,m,f=null)=>{const{el:j,type:J,transition:b,children:w,shapeFlag:g}=r;if(g&6){ts(r.component.subTree,p,d,m);return}if(g&128){r.suspense.move(p,d,m);return}if(g&64){J.move(r,p,d,fs);return}if(J===be){t(j,p,d);for(let _=0;_<w.length;_++)ts(w[_],p,d,m);t(r.anchor,p,d);return}if(J===tn){V(r,p,d);return}if(m!==2&&g&1&&b)if(m===0)b.beforeEnter(j),t(j,p,d),ue(()=>b.enter(j),f);else{const{leave:_,delayLeave:k,afterLeave:O}=b,z=()=>t(j,p,d),H=()=>{_(j,()=>{z(),O&&O()})};k?k(j,z,H):H()}else t(j,p,d)},Ie=(r,p,d,m=!1,f=!1)=>{const{type:j,props:J,ref:b,children:w,dynamicChildren:g,shapeFlag:S,patchFlag:_,dirs:k}=r;if(b!=null&&Gn(b,null,d,r,!0),S&256){p.ctx.deactivate(r);return}const O=S&1&&k,z=!Gs(r);let H;if(z&&(H=J&&J.onVnodeBeforeUnmount)&&Oe(H,p,r),S&6)ll(r.component,d,m);else{if(S&128){r.suspense.unmount(d,m);return}O&&Ke(r,null,p,"beforeUnmount"),S&64?r.type.remove(r,p,d,f,fs,m):g&&(j!==be||_>0&&_&64)?Ce(g,p,d,!1,!0):(j===be&&_&384||!f&&S&16)&&Ce(w,p,d),m&&Wa(r)}(z&&(H=J&&J.onVnodeUnmounted)||O)&&ue(()=>{H&&Oe(H,p,r),O&&Ke(r,null,p,"unmounted")},d)},Wa=r=>{const{type:p,el:d,anchor:m,transition:f}=r;if(p===be){rl(d,m);return}if(p===tn){N(r);return}const j=()=>{a(d),f&&!f.persisted&&f.afterLeave&&f.afterLeave()};if(r.shapeFlag&1&&f&&!f.persisted){const{leave:J,delayLeave:b}=f,w=()=>J(d,j);b?b(r.el,j,w):w()}else j()},rl=(r,p)=>{let d;for(;r!==p;)d=v(r),a(r),r=d;a(p)},ll=(r,p,d)=>{const{bum:m,scope:f,update:j,subTree:J,um:b}=r;m&&yn(m),f.stop(),j&&(j.active=!1,Ie(J,r,p,d)),b&&ue(b,p),ue(()=>{r.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&r.asyncDep&&!r.asyncResolved&&r.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},Ce=(r,p,d,m=!1,f=!1,j=0)=>{for(let J=j;J<r.length;J++)Ie(r[J],p,d,m,f)},un=r=>r.shapeFlag&6?un(r.component.subTree):r.shapeFlag&128?r.suspense.next():v(r.anchor||r.el),Va=(r,p,d)=>{r==null?p._vnode&&Ie(p._vnode,null,null,!0):D(p._vnode||null,r,p,null,null,null,d),Ft(),Ht(),p._vnode=r},fs={p:D,um:Ie,m:ts,r:Wa,mt:he,mc:q,pc:F,pbc:Y,n:un,o:e};let rt,lt;return s&&([rt,lt]=s(fs)),{render:Va,hydrate:rt,createApp:Ji(Va,rt)}}function Ge({effect:e,update:s},n){e.allowRecurse=s.allowRecurse=n}function Oi(e,s){return(!e||e&&!e.pendingBranch)&&s&&!s.persisted}function wa(e,s,n=!1){const t=e.children,a=s.children;if(x(t)&&x(a))for(let o=0;o<t.length;o++){const i=t[o];let l=a[o];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=a[o]=Ue(a[o]),l.el=i.el),n||wa(i,l)),l.type===nn&&(l.el=i.el)}}function Ii(e){const s=e.slice(),n=[0];let t,a,o,i,l;const c=e.length;for(t=0;t<c;t++){const u=e[t];if(u!==0){if(a=n[n.length-1],e[a]<u){s[t]=a,n.push(t);continue}for(o=0,i=n.length-1;o<i;)l=o+i>>1,e[n[l]]<u?o=l+1:i=l;u<e[n[o]]&&(o>0&&(s[t]=n[o-1]),n[o]=t)}}for(o=n.length,i=n[o-1];o-- >0;)n[o]=i,i=s[i];return n}const qi=e=>e.__isTeleport,be=Symbol.for("v-fgt"),nn=Symbol.for("v-txt"),we=Symbol.for("v-cmt"),tn=Symbol.for("v-stc"),Ts=[];let Je=null;function de(e=!1){Ts.push(Je=e?null:[])}function zi(){Ts.pop(),Je=Ts[Ts.length-1]||null}let Ss=1;function Ja(e){Ss+=e}function _a(e){return e.dynamicChildren=Ss>0?Je||as:null,zi(),Ss>0&&Je&&Je.push(e),e}function De(e,s,n,t,a,o){return _a(ne(e,s,n,t,a,o,!0))}function an(e,s,n,t,a){return _a(ce(e,s,n,t,a,!0))}function Xn(e){return e?e.__v_isVNode===!0:!1}function Xe(e,s){return e.type===s.type&&e.key===s.key}const on="__vInternal",Ta=({key:e})=>e??null,rn=({ref:e,ref_key:s,ref_for:n})=>(typeof e=="number"&&(e=""+e),e!=null?Z(e)||re(e)||I(e)?{i:ge,r:e,k:s,f:!!n}:e:null);function ne(e,s=null,n=null,t=0,a=null,o=e===be?0:1,i=!1,l=!1){const c={__v_isVNode:!0,__v_skip:!0,type:e,props:s,key:s&&Ta(s),ref:s&&rn(s),scopeId:Yt,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:o,patchFlag:t,dynamicProps:a,dynamicChildren:null,appContext:null,ctx:ge};return l?(Qn(c,n),o&128&&e.normalize(c)):n&&(c.shapeFlag|=Z(n)?8:16),Ss>0&&!i&&Je&&(c.patchFlag>0||o&6)&&c.patchFlag!==32&&Je.push(c),c}const ce=Pi;function Pi(e,s=null,n=null,t=0,a=null,o=!1){if((!e||e===Zo)&&(e=we),Xn(e)){const l=Ye(e,s,!0);return n&&Qn(l,n),Ss>0&&!o&&Je&&(l.shapeFlag&6?Je[Je.indexOf(e)]=l:Je.push(l)),l.patchFlag|=-2,l}if($i(e)&&(e=e.__vccOpts),s){s=Ei(s);let{class:l,style:c}=s;l&&!Z(l)&&(s.class=ys(l)),M(c)&&(zt(c)&&!x(c)&&(c=se({},c)),s.style=jn(c))}const i=Z(e)?1:ei(e)?128:qi(e)?64:M(e)?4:I(e)?2:0;return ne(e,s,n,t,a,i,o,!0)}function Ei(e){return e?zt(e)||on in e?se({},e):e:null}function Ye(e,s,n=!1){const{props:t,ref:a,patchFlag:o,children:i}=e,l=s?Ri(t||{},s):t;return{__v_isVNode:!0,__v_skip:!0,type:e.type,props:l,key:l&&Ta(l),ref:s&&s.ref?n&&a?x(a)?a.concat(rn(s)):[a,rn(s)]:rn(s):a,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:i,target:e.target,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:s&&e.type!==be?o===-1?16:o|16:o,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:e.transition,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Ye(e.ssContent),ssFallback:e.ssFallback&&Ye(e.ssFallback),el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce}}function ln(e=" ",s=0){return ce(nn,null,e,s)}function Ci(e,s){const n=ce(tn,null,e);return n.staticCount=s,n}function Zn(e="",s=!1){return s?(de(),an(we,null,e)):ce(we,null,e)}function Ne(e){return e==null||typeof e=="boolean"?ce(we):x(e)?ce(be,null,e.slice()):typeof e=="object"?Ue(e):ce(nn,null,String(e))}function Ue(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Ye(e)}function Qn(e,s){let n=0;const{shapeFlag:t}=e;if(s==null)s=null;else if(x(s))n=16;else if(typeof s=="object")if(t&65){const a=s.default;a&&(a._c&&(a._d=!1),Qn(e,a()),a._c&&(a._d=!0));return}else{n=32;const a=s._;!a&&!(on in s)?s._ctx=ge:a===3&&ge&&(ge.slots._===1?s._=1:(s._=2,e.patchFlag|=1024))}else I(s)?(s={default:s,_ctx:ge},n=32):(s=String(s),t&64?(n=16,s=[ln(s)]):n=8);e.children=s,e.shapeFlag|=n}function Ri(...e){const s={};for(let n=0;n<e.length;n++){const t=e[n];for(const a in t)if(a==="class")s.class!==t.class&&(s.class=ys([s.class,t.class]));else if(a==="style")s.style=jn([s.style,t.style]);else if(Os(a)){const o=s[a],i=t[a];i&&o!==i&&!(x(o)&&o.includes(i))&&(s[a]=o?[].concat(o,i):i)}else a!==""&&(s[a]=t[a])}return s}function Oe(e,s,n,t=null){fe(e,s,7,[n,t])}const Fi=pa();let Hi=0;function Mi(e,s,n){const t=e.type,a=(s?s.appContext:e.appContext)||Fi,o={uid:Hi++,vnode:e,type:t,parent:s,appContext:a,root:null,next:null,subTree:null,effect:null,update:null,scope:new po(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:s?s.provides:Object.create(a.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:da(t,a),emitsOptions:Bt(t,a),emit:null,emitted:null,propsDefaults:U,inheritAttrs:t.inheritAttrs,ctx:U,data:U,props:U,attrs:U,slots:U,refs:U,setupState:U,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return o.ctx={_:o},o.root=s?s.root:o,o.emit=Vo.bind(null,o),e.ce&&e.ce(o),o}let te=null;const Bi=()=>te||ge;let et,hs,Sa="__VUE_INSTANCE_SETTERS__";(hs=bn()[Sa])||(hs=bn()[Sa]=[]),hs.push(e=>te=e),et=e=>{hs.length>1?hs.forEach(s=>s(e)):hs[0](e)};const ms=e=>{et(e),e.scope.on()},Ze=()=>{te&&te.scope.off(),et(null)};function ka(e){return e.vnode.shapeFlag&4}let ks=!1;function Yi(e,s=!1){ks=s;const{props:n,children:t}=e.vnode,a=ka(e);Ti(e,n,a,s),Ai(e,t);const o=a?Ui(e,s):void 0;return ks=!1,o}function Ui(e,s){const n=e.type;e.accessCache=Object.create(null),e.proxy=Pt(new Proxy(e.ctx,fi));const{setup:t}=n;if(t){const a=e.setupContext=t.length>1?Wi(e):null;ms(e),ls();const o=Me(t,e,0,[e.props,a]);if(cs(),Ze(),pt(o)){if(o.then(Ze,Ze),s)return o.then(i=>{Aa(e,i,s)}).catch(i=>{Ls(i,e,0)});e.asyncDep=o}else Aa(e,o,s)}else Da(e,s)}function Aa(e,s,n){I(s)?e.type.__ssrInlineRender?e.ssrRender=s:e.render=s:M(s)&&(e.setupState=Et(s)),Da(e,n)}let xa;function Da(e,s,n){const t=e.type;if(!e.render){if(!s&&xa&&!t.render){const a=t.template||Wn(e).template;if(a){const{isCustomElement:o,compilerOptions:i}=e.appContext.config,{delimiters:l,compilerOptions:c}=t,u=se(se({isCustomElement:o,delimiters:l},i),c);t.render=xa(a,u)}}e.render=t.render||ke}{ms(e),ls();try{gi(e)}finally{cs(),Ze()}}}function Li(e){return e.attrsProxy||(e.attrsProxy=new Proxy(e.attrs,{get(s,n){return pe(e,"get","$attrs"),s[n]}}))}function Wi(e){const s=n=>{e.exposed=n||{}};return{get attrs(){return Li(e)},slots:e.slots,emit:e.emit,expose:s}}function st(e){if(e.exposed)return e.exposeProxy||(e.exposeProxy=new Proxy(Et(Pt(e.exposed)),{get(s,n){if(n in s)return s[n];if(n in Js)return Js[n](e)},has(s,n){return n in s||n in Js}}))}function Vi(e,s=!0){return I(e)?e.displayName||e.name:e.name||s&&e.__name}function $i(e){return I(e)&&"__vccOpts"in e}const Ki=(e,s)=>Ho(e,s,ks);function Gi(e,s,n){const t=arguments.length;return t===2?M(s)&&!x(s)?Xn(s)?ce(e,null,[s]):ce(e,s):ce(e,null,s):(t>3?n=Array.prototype.slice.call(arguments,2):t===3&&Xn(n)&&(n=[n]),ce(e,s,n))}const Xi=Symbol.for("v-scx"),Zi=()=>sn(Xi),Qi="3.3.9",er="http://www.w3.org/2000/svg",Qe=typeof document<"u"?document:null,Na=Qe&&Qe.createElement("template"),sr={insert:(e,s,n)=>{s.insertBefore(e,n||null)},remove:e=>{const s=e.parentNode;s&&s.removeChild(e)},createElement:(e,s,n,t)=>{const a=s?Qe.createElementNS(er,e):Qe.createElement(e,n?{is:n}:void 0);return e==="select"&&t&&t.multiple!=null&&a.setAttribute("multiple",t.multiple),a},createText:e=>Qe.createTextNode(e),createComment:e=>Qe.createComment(e),setText:(e,s)=>{e.nodeValue=s},setElementText:(e,s)=>{e.textContent=s},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Qe.querySelector(e),setScopeId(e,s){e.setAttribute(s,"")},insertStaticContent(e,s,n,t,a,o){const i=n?n.previousSibling:s.lastChild;if(a&&(a===o||a.nextSibling))for(;s.insertBefore(a.cloneNode(!0),n),!(a===o||!(a=a.nextSibling)););else{Na.innerHTML=t?`<svg>${e}</svg>`:e;const l=Na.content;if(t){const c=l.firstChild;for(;c.firstChild;)l.appendChild(c.firstChild);l.removeChild(c)}s.insertBefore(l,n)}return[i?i.nextSibling:s.firstChild,n?n.previousSibling:s.lastChild]}},Le="transition",As="animation",xs=Symbol("_vtc"),nt=(e,{slots:s})=>Gi(ai,nr(e),s);nt.displayName="Transition";const Oa={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};nt.props=se({},Gt,Oa);const es=(e,s=[])=>{x(e)?e.forEach(n=>n(...s)):e&&e(...s)},Ia=e=>e?x(e)?e.some(s=>s.length>1):e.length>1:!1;function nr(e){const s={};for(const T in e)T in Oa||(s[T]=e[T]);if(e.css===!1)return s;const{name:n="v",type:t,duration:a,enterFromClass:o=`${n}-enter-from`,enterActiveClass:i=`${n}-enter-active`,enterToClass:l=`${n}-enter-to`,appearFromClass:c=o,appearActiveClass:u=i,appearToClass:h=l,leaveFromClass:y=`${n}-leave-from`,leaveActiveClass:v=`${n}-leave-active`,leaveToClass:A=`${n}-leave-to`}=e,E=tr(a),D=E&&E[0],B=E&&E[1],{onBeforeEnter:W,onEnter:L,onEnterCancelled:V,onLeave:N,onLeaveCancelled:Q,onBeforeAppear:_e=W,onAppear:Te=L,onAppearCancelled:q=V}=s,G=(T,K,he)=>{ss(T,K?h:l),ss(T,K?u:i),he&&he()},Y=(T,K)=>{T._isLeaving=!1,ss(T,y),ss(T,A),ss(T,v),K&&K()},ie=T=>(K,he)=>{const Ds=T?Te:L,ae=()=>G(K,T,he);es(Ds,[K,ae]),qa(()=>{ss(K,T?c:o),We(K,T?h:l),Ia(Ds)||za(K,t,D,ae)})};return se(s,{onBeforeEnter(T){es(W,[T]),We(T,o),We(T,i)},onBeforeAppear(T){es(_e,[T]),We(T,c),We(T,u)},onEnter:ie(!1),onAppear:ie(!0),onLeave(T,K){T._isLeaving=!0;const he=()=>Y(T,K);We(T,y),ir(),We(T,v),qa(()=>{T._isLeaving&&(ss(T,y),We(T,A),Ia(N)||za(T,t,B,he))}),es(N,[T,he])},onEnterCancelled(T){G(T,!1),es(V,[T])},onAppearCancelled(T){G(T,!0),es(q,[T])},onLeaveCancelled(T){Y(T),es(Q,[T])}})}function tr(e){if(e==null)return null;if(M(e))return[tt(e.enter),tt(e.leave)];{const s=tt(e);return[s,s]}}function tt(e){return ao(e)}function We(e,s){s.split(/\s+/).forEach(n=>n&&e.classList.add(n)),(e[xs]||(e[xs]=new Set)).add(s)}function ss(e,s){s.split(/\s+/).forEach(t=>t&&e.classList.remove(t));const n=e[xs];n&&(n.delete(s),n.size||(e[xs]=void 0))}function qa(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let ar=0;function za(e,s,n,t){const a=e._endId=++ar,o=()=>{a===e._endId&&t()};if(n)return setTimeout(o,n);const{type:i,timeout:l,propCount:c}=or(e,s);if(!i)return t();const u=i+"end";let h=0;const y=()=>{e.removeEventListener(u,v),o()},v=A=>{A.target===e&&++h>=c&&y()};setTimeout(()=>{h<c&&y()},l+1),e.addEventListener(u,v)}function or(e,s){const n=window.getComputedStyle(e),t=E=>(n[E]||"").split(", "),a=t(`${Le}Delay`),o=t(`${Le}Duration`),i=Pa(a,o),l=t(`${As}Delay`),c=t(`${As}Duration`),u=Pa(l,c);let h=null,y=0,v=0;s===Le?i>0&&(h=Le,y=i,v=o.length):s===As?u>0&&(h=As,y=u,v=c.length):(y=Math.max(i,u),h=y>0?i>u?Le:As:null,v=h?h===Le?o.length:c.length:0);const A=h===Le&&/\b(transform|all)(,|$)/.test(t(`${Le}Property`).toString());return{type:h,timeout:y,propCount:v,hasTransform:A}}function Pa(e,s){for(;e.length<s.length;)e=e.concat(e);return Math.max(...s.map((n,t)=>Ea(n)+Ea(e[t])))}function Ea(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function ir(){return document.body.offsetHeight}function rr(e,s,n){const t=e[xs];t&&(s=(s?[s,...t]:[...t]).join(" ")),s==null?e.removeAttribute("class"):n?e.setAttribute("class",s):e.className=s}const lr=Symbol("_vod");function cr(e,s,n){const t=e.style,a=Z(n);if(n&&!a){if(s&&!Z(s))for(const o in s)n[o]==null&&at(t,o,"");for(const o in n)at(t,o,n[o])}else{const o=t.display;a?s!==n&&(t.cssText=n):s&&e.removeAttribute("style"),lr in e&&(t.display=o)}}const Ca=/\s*!important$/;function at(e,s,n){if(x(n))n.forEach(t=>at(e,s,t));else if(n==null&&(n=""),s.startsWith("--"))e.setProperty(s,n);else{const t=pr(e,s);Ca.test(n)?e.setProperty(is(t),n.replace(Ca,""),"important"):e[t]=n}}const Ra=["Webkit","Moz","ms"],ot={};function pr(e,s){const n=ot[s];if(n)return n;let t=Ae(s);if(t!=="filter"&&t in e)return ot[s]=t;t=Es(t);for(let a=0;a<Ra.length;a++){const o=Ra[a]+t;if(o in e)return ot[s]=o}return s}const Fa="http://www.w3.org/1999/xlink";function ur(e,s,n,t,a){if(t&&s.startsWith("xlink:"))n==null?e.removeAttributeNS(Fa,s.slice(6,s.length)):e.setAttributeNS(Fa,s,n);else{const o=co(s);n==null||o&&!mt(n)?e.removeAttribute(s):e.setAttribute(s,o?"":n)}}function dr(e,s,n,t,a,o,i){if(s==="innerHTML"||s==="textContent"){t&&i(t,a,o),e[s]=n??"";return}const l=e.tagName;if(s==="value"&&l!=="PROGRESS"&&!l.includes("-")){e._value=n;const u=l==="OPTION"?e.getAttribute("value"):e.value,h=n??"";u!==h&&(e.value=h),n==null&&e.removeAttribute(s);return}let c=!1;if(n===""||n==null){const u=typeof e[s];u==="boolean"?n=mt(n):n==null&&u==="string"?(n="",c=!0):u==="number"&&(n=0,c=!0)}try{e[s]=n}catch{}c&&e.removeAttribute(s)}function hr(e,s,n,t){e.addEventListener(s,n,t)}function mr(e,s,n,t){e.removeEventListener(s,n,t)}const Ha=Symbol("_vei");function fr(e,s,n,t,a=null){const o=e[Ha]||(e[Ha]={}),i=o[s];if(t&&i)i.value=t;else{const[l,c]=gr(s);if(t){const u=o[s]=jr(t,a);hr(e,l,u,c)}else i&&(mr(e,l,i,c),o[s]=void 0)}}const Ma=/(?:Once|Passive|Capture)$/;function gr(e){let s;if(Ma.test(e)){s={};let t;for(;t=e.match(Ma);)e=e.slice(0,e.length-t[0].length),s[t[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):is(e.slice(2)),s]}let it=0;const yr=Promise.resolve(),br=()=>it||(yr.then(()=>it=0),it=Date.now());function jr(e,s){const n=t=>{if(!t._vts)t._vts=Date.now();else if(t._vts<=n.attached)return;fe(vr(t,n.value),s,5,[t])};return n.value=e,n.attached=br(),n}function vr(e,s){if(x(s)){const n=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{n.call(e),e._stopped=!0},s.map(t=>a=>!a._stopped&&t&&t(a))}else return s}const Ba=/^on[a-z]/,wr=(e,s,n,t,a=!1,o,i,l,c)=>{s==="class"?rr(e,t,a):s==="style"?cr(e,n,t):Os(s)?hn(s)||fr(e,s,n,t,i):(s[0]==="."?(s=s.slice(1),!0):s[0]==="^"?(s=s.slice(1),!1):Jr(e,s,t,a))?dr(e,s,t,o,i,l,c):(s==="true-value"?e._trueValue=t:s==="false-value"&&(e._falseValue=t),ur(e,s,t,a))};function Jr(e,s,n,t){return t?!!(s==="innerHTML"||s==="textContent"||s in e&&Ba.test(s)&&I(n)):s==="spellcheck"||s==="draggable"||s==="translate"||s==="form"||s==="list"&&e.tagName==="INPUT"||s==="type"&&e.tagName==="TEXTAREA"||Ba.test(s)&&Z(n)?!1:s in e}const _r=["ctrl","shift","alt","meta"],Tr={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,s)=>_r.some(n=>e[`${n}Key`]&&!s.includes(n))},Sr=(e,s)=>(n,...t)=>{for(let a=0;a<s.length;a++){const o=Tr[s[a]];if(o&&o(n,s))return}return e(n,...t)},kr=se({patchProp:wr},sr);let Ya;function Ar(){return Ya||(Ya=Di(kr))}const xr=(...e)=>{const s=Ar().createApp(...e),{mount:n}=s;return s.mount=t=>{const a=Dr(t);if(!a)return;const o=s._component;!I(o)&&!o.render&&!o.template&&(o.template=a.innerHTML),a.innerHTML="";const i=n(a,!1,a instanceof SVGElement);return a instanceof Element&&(a.removeAttribute("v-cloak"),a.setAttribute("data-v-app","")),i},s};function Dr(e){return Z(e)?document.querySelector(e):e}const cn=(e,s)=>{const n=e.__vccOpts||e;for(const[t,a]of s)n[t]=a;return n},Nr=Bn({props:{report:{type:String,required:!0}},methods:{createIssue(){const e=new FormData(this.$refs.issueForm),s=e.get("title");let n="";const t=e.get("description");t&&(n+=`**Description**
${t}
...
`,options:[{id:"compiletime",page:34,label:"At compile time",summary:"The issue happens at compile time"},{id:"runtime",page:77,label:"At run time",summary:"The issue happens at run time"}]},{content:`<p>Please look at the <strong>first</strong> error in the compiler output, and tell me what it is...</p>
`,options:[{id:"requires-cpp-compiler",page:76,label:"ArduinoJson requires a C++ compiler...",summary:'Error says "ArduinoJson requires a C++ compiler..."'},{id:"assignment-of-read-only-location",page:36,label:"assignment of read-only location",summary:'Error says "assignment of read-only location"'},{id:"ambiguous-string-assign",page:35,label:"ambiguous overload for <code>operator=</code> (operand types are <code>String</code> and ...)",summary:'Error says "ambiguous overload for `operator=` (operand types are `String` and ...)"'},{id:"begin-not-found",page:54,label:"<code>begin</code>: no matching overloaded function found",summary:'Error says "`begin`: no matching overloaded function found"'},{id:"error-constants",page:74,label:"<code>bits/error_constants.h</code>: No such file or directory",summary:'Error says "`bits/error_constants.h`: No such file or directory'},{id:"print-ambiguous",page:75,label:"call of overloaded <code>print(...)</code> is ambiguous",summary:'Error says "call of overloaded `print(...)` is ambiguous"'},{id:"cannot-bind-object-ref",page:72,label:"cannot bind non-const lvalue reference of type <code>ArduinoJson::JsonObject&amp;</code> ...",summary:'Error says "cannot bind non-const lvalue reference of type `ArduinoJson::JsonObject&` ..."'},{id:"class-has-no-member-named-read",page:67,label:"<code>class Xxx</code> has no member named <code>read</code>",summary:'Error says "`class Xxx` has no member named `read`"'},{id:"pointer-to-object",page:71,label:"<code>const void*</code> is not a pointer-to-object type",summary:'Error says "`const void*` is not a pointer-to-object type"'},{id:"doesnt-name-a-type",page:45,label:"<code>doc</code> does not name a type",summary:'Error says "`doc` does not name a type"'},{id:"dynamicjsonbuffer",page:40,label:"<code>DynamicJsonBuffer</code> is a class from ArduinoJson 5",summary:'Error says "`DynamicJsonBuffer` is a class from ArduinoJson 5"'},{id:"dynamicjsondocument-not-declared",page:68,label:"<code>DynamicJsonDocument</code> was not declared in this scope",summary:'Error says "`DynamicJsonDocument` was not declared in this scope"'},{id:"expected-identifier-before-numeric-constant",page:47,label:"expected identifier before numeric constant",summary:'Error says "expected identifier before numeric constant"'},{id:"expected-identifier-before-string-constant",page:49,label:"expected identifier before string constant",summary:'Error says "expected identifier before string constant"'},{id:"char-pointer-conversion",page:39,label:"invalid conversion from <code>const char*</code> to <code>char*</code> [-fpermissive]",summary:'Error says "invalid conversion from `const char*` to `char*` [-fpermissive]"'},{id:"invalid-conversion",page:53,label:"invalid use of incomplete type <code>class InvalidConversion&lt;...&gt;</code>",summary:'Error says "invalid use of incomplete type `class InvalidConversion<...>`"'},{id:"jsondocument-copy",page:55,label:"<code>JsonDocument::JsonDocument(const JsonDocument&amp;)</code> is private",summary:'Error says "`JsonDocument::JsonDocument(const JsonDocument&)` is private"'},{id:"jsondocument-constructor",page:56,label:"<code>JsonDocument::JsonDocument()</code> is protected within this context",summary:'Error says "`JsonDocument::JsonDocument()` is protected within this context"'},{id:"macro-min",page:57,label:"macro <code>min</code> passed 3 arguments, but takes just 2",summary:'Error says "macro `min` passed 3 arguments, but takes just 2"'},{id:"basicjsondocument-default-constructor",page:37,label:"no default constructor exists for class <code>BasicJsonDocument</code>",summary:'Error says "no default constructor exists for class `BasicJsonDocument`"'},{id:"no-matching-function",page:59,label:"no matching function for call to ...",summary:'Error says "no matching function for call to ..."'},{id:"passing-volatile-as-this-argument-discards-qualifiers",page:73,label:"passing <code>volatile ...</code> as <code>this</code> argument discards qualifiers [-fpermissive]",summary:'Error says "passing `volatile ...` as `this` argument discards qualifiers [-fpermissive]"'},{id:"cast-void-to-flashstringhelper",page:38,label:"reinterpret_cast from <code>const void</code> to <code>const __FlashStringHelper *</code> is not allowed",summary:'Error says "reinterpret_cast from `const void` to `const __FlashStringHelper *` is not allowed"'},{id:"member-write-in-char-ptr",page:58,label:"request for member <code>write</code> in ..., which is of non-class type <code>char*</code>",summary:'Error says "request for member `write` in ..., which is of non-class type `char*`"'},{id:"staticjsonbuffer",page:40,label:"<code>StaticJsonBuffer</code> is a class from ArduinoJson 5",summary:'Error says "`StaticJsonBuffer` is a class from ArduinoJson 5"'},{id:"staticjsondocument-not-declared",page:68,label:"<code>StaticJsonDocument</code> was not declared in this scope",summary:'Error says "`StaticJsonDocument` was not declared in this scope"'},{id:"struct-has-no-member-named-read",page:67,label:"<code>struct Xxx</code> has no member named <code>read</code>",summary:'Error says "`struct Xxx` has no member named `read`"'},{id:"range-based-for-requires-begin",page:54,label:"this range-based <code>for</code> statement requires a suitable &quot;begin&quot; function and none was found",summary:'Error says "this range-based `for` statement requires a suitable "begin" function and none was found"'},{id:"not-in-list",page:3,label:"None of the above",summary:"The error is not in the list"}]},{content:`<p>This error occurs when you try to assign a <a href="/v6/api/jsonvariant/"><code>JsonVariant</code></a> to a <a href="https://www.arduino.cc/reference/en/language/variables/data-types/stringobject/"><code>String</code></a>.</p>
...
`,options:[{id:"array",page:50,label:"<code>class InvalidConversion&lt;VariantConstRef, ArrayRef&gt;</code>",summary:"Specialization is `InvalidConversion<VariantConstRef, ArrayRef>`"},{id:"object",page:51,label:"<code>class InvalidConversion&lt;VariantConstRef, ObjectRef&gt;</code>",summary:"Specialization is `InvalidConversion<VariantConstRef, ObjectRef>`"},{id:"variant",page:52,label:"<code>class InvalidConversion&lt;VariantConstRef, VariantRef&gt;</code>",summary:"Specialization is `InvalidConversion<VariantConstRef, VariantRef>`"}]},{content:`<p>You get this error when you try to iterate over a <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> or a <a href="/v6/api/jsonvariant/"><code>JsonVariant</code></a>.</p>
...
`,options:[{id:"basicjsondocument",page:62,label:"no matching function for call to <code>BasicJsonDocument::BasicJsonDocument()</code>",summary:'Error says "no matching function for call to `BasicJsonDocument::BasicJsonDocument()`"'},{id:"converttojson",page:63,label:"no matching function for call to <code>convertToJson(...)</code>",summary:'Error says "no matching function for call to `convertToJson(...)`"'},{id:"deserializejson",page:64,label:"no matching function for call to <code>deserializeJson(StaticJsonDocument&lt;200&gt; (&amp;)(), ...)</code>",summary:'Error says "no matching function for call to `deserializeJson(StaticJsonDocument<200> (&)(), ...)`"'},{id:"unresolved-overloaded-function-type",page:66,label:"no matching function for call to <code>...(&lt;unresolved overloaded function type&gt;)</code>",summary:'Error says "no matching function for call to `...(<unresolved overloaded function type>)`"'},{id:"as-char",page:61,label:"no matching function for call to <code>...as&lt;char&gt;() const</code>",summary:'Error says "no matching function for call to `...as<char>()` const"'},{id:"as-char-ptr",page:60,label:"no matching function for call to <code>...as&lt;char*&gt;() const</code>",summary:'Error says "no matching function for call to `...as<char*>()` const"'},{id:"is-char-ptr",page:65,label:"no matching function for call to <code>...is&lt;char*&gt;() const</code>",summary:'Error says "no matching function for call to `...is<char*>()` const"'},{id:"not-in-list",page:3,label:"None of the above",summary:"The error is not in the list"}]},{content:`<p>This error happens when you write the following:</p>
...
`,options:[{id:"arduinojson-h",page:1,label:"<code>ArduinoJson.h</code>",summary:"The file includes `ArduinoJson.h`"},{id:"arduinojson-hpp",page:69,label:"<code>ArduinoJson.hpp</code>",summary:"The file includes `ArduinoJson.hpp`"},{id:"none",page:70,label:"None of the above",summary:"The file includes neither `ArduinoJson.h` nor  `ArduinoJson.hpp`"}]},{content:`<p>Unlike <code>ArduinoJson.h</code>, <code>ArduinoJson.hpp</code> keeps everything in the <code>ArduinoJson</code> namespace.</p>
...
`,options:[{id:"serialization",page:207,label:"Serialization",summary:"The issue concerns serialization"},{id:"deserialization",page:78,label:"Deserialization",summary:"The issue concerns deserialization"}]},{content:`<p>What is the value of <a href="/v6/api/misc/deserializationerror/"><code>DeserializationError</code></a>?</p>
`,options:[{id:"ok",page:157,label:"<code>Ok</code>",summary:"`deserializeJson()` returns `Ok`"},{id:"emptyinput",page:93,label:"<code>EmptyInput</code>",summary:"`deserializeJson()` returns `EmptyInput`"},{id:"incompleteinput",page:108,label:"<code>IncompleteInput</code>",summary:"`deserializeJson()` returns `IncompleteInput`"},{id:"invalidinput",page:115,label:"<code>InvalidInput</code>",summary:"`deserializeJson()` returns `InvalidInput`"},{id:"nomemory",page:192,label:"<code>NoMemory</code>",summary:"`deserializeJson()` returns `NoMemory`"},{id:"notsupported",page:200,label:"<code>NotSupported</code>",summary:"`deserializeJson()` returns `NotSupported`"},{id:"toodeep",page:205,label:"<code>TooDeep</code>",summary:"`deserializeJson()` returns `TooDeep`"},{id:"crash",page:80,label:"I can't tell because the program crashes",summary:"The program crashes"},{id:"unknown",page:79,label:"I don't know what you're talking about",summary:"The program doesn't check the error"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/"><code>DeserializationError</code></a> is the return type of <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>. It tells whether the operation succeeded and indicates the cause of the error.</p>
...
`,options:[{id:"before",page:86,label:"None: program crashes before calling <code>deserializeJson()</code>",summary:"Program crashes before calling `deserializeJson()`"},{id:"inside",page:88,label:"Only one: program crashes inside <code>deserializeJson()</code>",summary:"Program crashes inside `deserializeJson()`"},{id:"after",page:81,label:"Two traces: program crashes after calling <code>deserializeJson()</code>",summary:"Program crashes after calling `deserializeJson()`"}]},{content:`<p>Most of the time, when a program crashes after <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, it's because it dereferences a null pointer returned by the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>.</p>
...
`,options:[{id:"strcmp",page:84,label:"Yes, there is a call to <code>strcmp()</code>",summary:"Program calls `strcmp()`"},{id:"strcpy",page:85,label:"Yes, there is a call to <code>strcpy()</code>",summary:"Program calls `strcpy()`"},{id:"printf",page:83,label:"Yes, there is a call to <code>printf()</code>, <code>sprintf()</code>, or <code>snprintf()</code>",summary:"Program calls `printf()`, `sprintf()`, or `snprintf()`"},{id:"success",page:2,label:"Yes, I found the issue",summary:"Program dereferences a null pointer"},{id:"no-usual-suspect",page:82,label:"No",summary:"Program calls neither `strcmp()`, nor `strcpy()`, not `printf()`"}]},{content:`<p>A programs can also crash after calling <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> because it keeps a pointer to a string stored in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>.</p>
...
`,options:[{id:"static",page:92,label:"Yes",summary:"Program uses `StaticJsonDocument`"},{id:"no-static",page:87,label:"No",summary:"Program doesn't use `StaticJsonDocument`"}]},{content:`<p>I still think this could be a stack-overflow.</p>
...
`,options:[{id:"success",page:2,label:"Yes",summary:"Switching to `DynamicJsonDocument` prevents the crash"},{id:"nomemory",page:91,label:"Yes, but now <code>deserializeJson()</code> returns <code>NoMemory</code>",summary:"Switching to `DynamicJsonDocument` produces `NoMemory`"},{id:"dynamicjsondocument-too",page:87,label:"No",summary:"Switching to `DynamicJsonDocument` doesn't prevent the crash"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#emptyinput"><code>EmptyInput</code></a> means that the input was empty or contained only spaces or comments.</p>
<p>Where does your JSON input come from?</p>
`,options:[{id:"http",page:100,label:"An HTTP response",summary:"Input comes from an HTTP response"},{id:"file",page:94,label:"A file",summary:"Input comes from a file"},{id:"serial",page:107,label:"A serial port",summary:"Input comes from a serial port"},{id:"other",page:105,label:"Something else",summary:"Input comes neither from an HTTP response, nor a file, nor a serial port"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#emptyinput"><code>EmptyInput</code></a> in the context of a file usually means:</p>
<ul>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Following the redirection fixes the issue"},{id:"follow",page:101,label:"No",summary:"Following the redirection doesn't fix the issue"}]},{content:`<p>A negative number indicates an error on the client side.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"certificate-problem",page:97,label:"Yes",summary:"Calling `WiFiClientSecure::setInsecure()` solves the issue."},{id:"certificate-ok",page:96,label:"No",summary:"Calling `WiFiClientSecure::setInsecure()` doesn't solve the issue."}]},{content:`<p>Please check the HTTP status</p>
<p>For example, if you use <code>HTTPClient</code>, what value is returned by <code>http.GET()</code>?</p>
`,options:[{id:"redirect",page:98,label:"<code>300</code> to <code>399</code>",summary:"The status code indicates a redirection"},{id:"negative",page:99,label:"A negative number",summary:"The status code is negative"},{id:"status-ok",page:101,label:"None of the above",summary:"The status code is not in the list"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#emptyinput"><code>EmptyInput</code></a> could be caused by a timeout while reading the response.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Increasing the timeout fixes the issue"},{id:"timeout-increased",page:95,label:"No",summary:"Increasing the timeout doesn't fix the issue"}]},{content:`<p>This confirms that the problem comes from the input: it is indeed empty, or at least starts with a NUL character.</p>
...
<p>What do you see?</p>
`,options:[{id:"zero",page:102,label:"<code>0</code>",summary:"The first character is NUL"},{id:"non-zero",page:1,label:"Something else",summary:"The first character is not NUL"}]},{content:`<p>Please print the ASCII code for the first character, like so:</p>
...
<p>What do you see?</p>
`,options:[{id:"zero",page:102,label:"<code>0</code>",summary:"The first character is NUL"},{id:"non-zero",page:1,label:"Something else",summary:"The first character is not NUL"}]},{content:`<p>The input is probably starting with a NUL character.</p>
<p>What type of input are you passing to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>?</p>
`,options:[{id:"string",page:104,label:"A string (<code>const char*</code>, <code>String</code>, <code>std::string</code>...)",summary:"Input type is a string"},{id:"stream",page:103,label:"A stream (<code>Serial</code>, <code>WiFiClient</code>, <code>File</code>...)",summary:"Input type is a stream"}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> also returns <a href="/v6/api/misc/deserializationerror/#emptyinput"><code>EmptyInput</code></a> when the input contains only spaces.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Adding a wait loop fixes the issue"},{id:"available",page:106,label:"No",summary:"Adding a wait loop doesn't fix the issue"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#incompleteinput"><code>IncompleteInput</code></a> means that <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> managed to parse the beginning of the JSON document, but the end was missing.</p>
<p>What type of input do you pass to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>?</p>
`,options:[{id:"stream",page:111,label:"A stream",summary:"Input comes from a stream"},{id:"string",page:112,label:"A string object (like <code>String</code>)",summary:"Input comes from a string object"},{id:"pointer",page:113,label:"A pointer (like <code>char*</code> or <code>const char*</code>)",summary:"Input comes from a pointer"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#incompleteinput"><code>IncompleteInput</code></a> can be caused by an interruped connection. For example, this problem happens when the client reads to slowly.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Adding a buffer solves the issue"},{id:"same-with-buffer",page:110,label:"No",summary:"Adding a buffer doesn't solve the issue"}]},{content:`<p>Maybe seeing where the input stops will give you an idea of what's going wrong.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Inreasing the timeout solves the issue"},{id:"timeout-increased",page:109,label:"No",summary:"Inreasing the timeout doesn't solve the issue"}]},{content:`<p>Please print the content of the string to the serial port, like so:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:2,label:"Yes",summary:"Calling `String::reserve()` solves the issue"},{id:"1",page:114,label:"No",summary:"Calling `String::reserve()` doesn't solve the issue"}]},{content:`<p>I'll assume that your input is stored in a buffer similar to this one:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:2,label:"Yes",summary:"Increasing the buffer size solves the issue"},{id:"1",page:114,label:"No",summary:"Increasing the buffer size doesn't solve the issue"}]},{content:`<p>To reduce the memory usage, you should try to pass the source (file, connection, stream, etc) directly to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, either via the <a href="https://www.arduino.cc/reference/en/language/functions/communication/stream/"><code>Stream</code></a> interface or via a <a href="/news/2019/11/01/version-6-13-0/">custom reader</a>. This will avoid the need for an intermediate buffer.</p>
...
`,options:[{id:"http",page:124,label:"An HTTP response",summary:"Input comes from HTTP"},{id:"serial",page:151,label:"A serial port",summary:"Input comes from a serial port"},{id:"file",page:123,label:"A file",summary:"Input comes from a file"},{id:"stream",page:154,label:"A stream",summary:"Input comes from a stream"},{id:"string",page:156,label:"A string (like <code>String</code> or <code>const char*</code>)",summary:"Input comes from a string"},{id:"char-ptr",page:118,label:"A char array or pointer (like <code>char[]</code> or <code>char*</code>)",summary:"Input comes from a char array"}]},{content:`<p>If you must keep the two calls to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, you need to disable the zero-copy mode by passing a read-only input buffer. Casting the pointer will do the trick:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// replace this:</span>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Casting the pointer fixes the issue"},{id:"cast",page:156,label:"No",summary:"Casting the pointer doesn't fix the issue"}]},{content:`<p>When you pass a writeable buffer as the input of <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, ArduinoJson uses the zero-copy mode. Instead of copying the strings from the input into the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, it stores pointers to the input buffer.</p>
...
`,options:[{id:"success",page:2,label:"Yes, and it fixes the issue",summary:"Removing the second call fixes the issue"},{id:"second-removed",page:156,label:"Yes, but it doesn't fix the issue",summary:"Removing the second call doesn't fix the issue"},{id:"cannot-remove",page:116,label:"No",summary:"The second call cannot be removed"}]},{content:`<p>Did you call <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> twice with the same input buffer?</p>
`,options:[{id:"two-calls",page:117,label:"Yes",summary:"Program calls `deserializeJson()` twice"},{id:"one-call",page:156,label:"No",summary:"Program doesn't call `deserializeJson()` twice"}]},{content:`<p>So, the JSON document is valid and not preceded by anything; yet, <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> returns <a href="/v6/api/misc/deserializationerror/#invalidinput"><code>InvalidInput</code></a>.</p>
...
`,options:[{id:"utf8",page:121,label:"<code>239</code>",summary:"Input's first byte suggests a UTF-8 BOM"},{id:"utf16",page:120,label:"<code>254</code> or <code>255</code>",summary:"Input's first byte suggests a UTF-16 BOM"},{id:"no-bom",page:119,label:"Something else",summary:"Input's first byte doesn't suggest a BOM"}]},{content:`<p>We need to make sure that the JSON document is valid.
...
`,options:[{id:"valid",page:122,label:"Yes",summary:"`jsonlint` says the document is valid"},{id:"invalid",page:140,label:"No",summary:"`jsonlint` says the document is invalid"}]},{content:`<p>Do you use an HTTP library?</p>
`,options:[{id:"httpclient",page:125,label:"Yes, I'm using <code>HTTPClient</code>",summary:"Program uses `HTTPClient`"},{id:"http-library",page:138,label:"Yes, but it's not <code>HTTPClient</code>",summary:"Program uses an unknown HTTP library"},{id:"no-library",page:134,label:"No",summary:"Program doesn't use an HTTP library"}]},{content:`<p>Did you check the status code?</p>
`,options:[{id:"status-ok",page:127,label:"Yes",summary:"The program already checks the status code"},{id:"check-status",page:126,label:"No",summary:"The program doesn't check the status code"}]},{content:`<p>Please check the status code like so:</p>
...
<p>What do you get?</p>
`,options:[{id:"ok",page:127,label:"<code>200</code>",summary:"The status code is `200`"},{id:"positive",page:130,label:"A positive number (but not <code>200</code>)",summary:"The status code is positive"},{id:"negative",page:129,label:"A negative number",summary:"The status code is negative"}]},{content:`<p>Which function of <code>HTTPClient</code> do you call to get the response?</p>
`,options:[{id:"getstream",page:133,label:"<code>getStream()</code>",summary:"Response comes from `HTTPClient::getStream()`"},{id:"getstring",page:156,label:"<code>getString()</code>",summary:"Response comes from `HTTPClient::getString()`"},{id:"readstring",page:128,label:"<code>readString()</code>",summary:"Response comes from `HTTPClient::readString()`"}]},{content:`<p>You're calling the wrong function:</p>
<ul>
...
`,options:[{id:"success",page:2,label:"Yes",summary:"Calling `HTTPClient::getString()` solves the issue"},{id:"getstring",page:156,label:"No",summary:"Calling `HTTPClient::getString()` doesn't solves the issue"}]},{content:`<p>A negative number indicates an error on the client side.</p>
<p>Here are the possible values that I'm aware of:</p>
<table class="table">
<thead>
<tr>
...
<p>Did this solve your problem?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Calling `HTTPClient::useHTTP10(true)` solves the issue"},{id:"changed",page:132,label:"No",summary:"Calling `HTTPClient::useHTTP10(true)` doesn't solve the issue"}]},{content:`<p>We need to make sure that the JSON document is valid.
...
<p>Is the JSON document valid?</p>
`,options:[{id:"valid",page:152,label:"Yes",summary:"jsonlint says the document is valid"},{id:"invalid",page:140,label:"No",summary:"jsonlint says the document is invalid"}]},{content:`<p>Did you call <code>HTTPClient::useHTTP10(true)</code>?</p>
`,options:[{id:"http10-true",page:132,label:"Yes",summary:"Program calls `HTTPClient::useHTTP10(true)`"},{id:"http10-false",page:131,label:"No",summary:"Program doesn't call `HTTPClient::useHTTP10(true)`"}]},{content:`<p>Before calling <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, did you skip the HTTP headers?</p>
`,options:[{id:"headers-skipped",page:137,label:"Yes",summary:"HTTP headers are skipped"},{id:"headers-not-skipped",page:136,label:"No",summary:"HTTP headers are not skipped"}]},{content:`<p>On some Arduino core (most notably <a href="https://github.com/arduino/ArduinoCore-avr/blob/master/cores/arduino/Stream.h">AVR core</a>), <a href="https://www.arduino.cc/reference/en/language/functions/communication/stream/streamfind/"><code>Stream::find()</code></a> takes a <code>char*</code> instead of a <code>const char*</code>. In this case, you'll get a compiler warning, which you can fix by extracting a char array, like so:</p>
...
<p>Did this fix your problem?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Skipping HTTP headers solves the issue"},{id:"warning",page:135,label:"Yes, but there is a compiler warning about <code>client.find()</code>",summary:"Skipping HTTP headers solves the issue, but there is a warning"},{id:"header-skipped",page:137,label:"No",summary:"Skipping HTTP headers doesn't solve the issue"}]},{content:`<p>When you use HTTP 1.1, the server can send the response with <a href="https://en.wikipedia.org/wiki/Chunked_transfer_encoding">Chunked Transfer Encoding</a>.
As a result, the response's body may contain some hexadecimal number at the begining of each chunk.
The most straightforward workaround is to downgrade the connection to HTTP 1.0.</p>
<p>To do this, replace <code>HTTP/1.1</code> with <code>HTTP/1.0</code> in the first line of the request.</p>
<p>Did this solve your problem?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Using `HTTP/1.0` solves the issue"},{id:"http10",page:139,label:"No",summary:"Using `HTTP/1.0` doesn't solve the issue"}]},{content:`<p>Unfortunately, I only know how to use the following HTTP libraries:</p>
<ul>
...
`,options:[{id:"stream",page:152,label:"A stream",summary:"The input is a stream"},{id:"string",page:155,label:"A string",summary:"The input is a string"}]},{content:`<p>What is wrong with this JSON document?</p>
`,options:[{id:"comments",page:141,label:"It contains comments",summary:"The document contains comments"},{id:"other-error",page:142,label:"Something else",summary:"The document doesn't contain comments"}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> can read JSON documents that contain comments, but the support is disabled by default to reduce the footprint of the library.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Increasing serial buffer size solves the issue"},{id:"larger-buffer",page:152,label:"No",summary:"Increasing serial buffer size doesn't solves the issue"}]},{content:`<p>Any electric wire acts as an antenna; the longer the wire, the stronger the effect. This antenna picks up every electromagnetic field in the environment, which induces a current in the wire. On long wires, this current is strong enough to introduce errors in the communication.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Upgrading the cables solves the issue"},{id:"improved",page:146,label:"Somehow",summary:"Upgrading the cables improves the situation"},{id:"no-improvment",page:147,label:"No",summary:"Upgrading the cables doesn't solve the issue"}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> may return <a href="/v6/api/misc/deserializationerror/#invalidinput"><code>InvalidInput</code></a> because it starts reading the input mid-stream.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Flushing the serial buffer fixes the issue"},{id:"flush",page:150,label:"No",summary:"Flushing the serial buffer doesn't fix the issue"}]},{content:`<p><a href="https://en.wikipedia.org/wiki/Error_correction_code">Error-correction codes (ECC)</a> are a way of transmitting the data with redundant information that allows the receiver to fix most of the errors.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Error-correction codes fix the issue"},{id:"ecc",page:147,label:"No",summary:"Error-correction codes doesn't fix the issue"}]},{content:`<p>We need to make sure that the JSON document is valid.
To do that, please print the input to the serial port, like so:</p>
...
<p>Then, copy the response and paste it in a JSON linter, like <a href="https://jsonlint.com/">jsonlint.com</a>.</p>
<p>Is the JSON document valid?</p>
`,options:[{id:"valid",page:143,label:"Yes",summary:"`jsonlint` says the document is valid"},{id:"invalid",page:140,label:"No",summary:"`jsonlint` says the document is invalid"}]},{content:`<p>Any kind of communication is subject to errors: sometimes you send a <code>1</code> and receive a <code>0</code>.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Removing `SoftwareSerial` solves the issue"},{id:"removed",page:150,label:"No",summary:"Removing `SoftwareSerial` doesn't solve the issue"}]},{content:`<p>Not all microcontrollers use the same voltage for the serial port.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"The issue is a voltage mismatch"},{id:"voltage-ok",page:148,label:"No",summary:"The issue is not a voltage mismatch"}]},{content:`<p>Are you using <a href="https://www.arduino.cc/en/Reference/SoftwareSerial"><code>SoftwareSerial</code></a>?</p>
`,options:[{id:"software",page:149,label:"Yes",summary:"Program uses `SoftwareSerial`"},{id:"hardware",page:145,label:"No",summary:"Program doesn't use `SoftwareSerial`"}]},{content:`<p>We must check that the JSON document is not preceded by a  <a href="https://en.wikipedia.org/wiki/Byte_order_mark">Byte Order Mark</a> (BOM).</p>
...
<p>What value does it print?</p>
`,options:[{id:"utf8",page:121,label:"<code>239</code>",summary:"Input's first byte suggests a UTF-8 BOM"},{id:"utf16",page:120,label:"<code>254</code> or <code>255</code>",summary:"Input's first byte suggests a UTF-16 BOM"},{id:"no-bom",page:119,label:"Something else",summary:"Input's first byte doesn't suggest a BOM"}]},{content:`<p>Sometimes, the input is invalid because some bytes were dropped when receiving the document.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Adding a buffer solves the issue"},{id:"buffer",page:152,label:"No",summary:"Adding a buffer doesn't solve the issue"}]},{content:`<p>We need to make sure that the JSON document is valid.
To do that, please print the input to the serial port, like so:</p>
...
<p>Then, copy the response and paste it in a JSON linter, like <a href="https://jsonlint.com/">jsonlint.com</a>.</p>
<p>Is the JSON document valid?</p>
`,options:[{id:"valid",page:153,label:"Yes",summary:"`jsonlint` says the document is valid"},{id:"invalid",page:140,label:"No",summary:"`jsonlint` says the document is invalid"}]},{content:`<p>We must check that the JSON document is not preceded by a  <a href="https://en.wikipedia.org/wiki/Byte_order_mark">Byte Order Mark</a> (BOM).</p>
...
<p>Then, copy the response and paste it in a JSON linter, like <a href="https://jsonlint.com/">jsonlint.com</a>.</p>
<p>Is the JSON document valid?</p>
`,options:[{id:"valid",page:155,label:"Yes",summary:"`jsonlint` says the document is valid"},{id:"invalid",page:140,label:"No",summary:"`jsonlint` says the document is invalid"}]},{content:`<p>So, what's the problem then?</p>
`,options:[{id:"slow",page:183,label:"It's slow",summary:"Deserialisation is slow"},{id:"invalid",page:158,label:"I expected <code>InvalidInput</code> instead of <code>Ok</code>",summary:"`Ok` is incorrect; it should be `InvalidInput`"},{id:"crash",page:81,label:"My program crashes after calling <code>deserializeJson()</code>",summary:"Program crashes after calling `deserializeJson()`"},{id:"empty",page:172,label:"<code>JsonDocument</code> returns empty/null values",summary:"Program fails to extract values from the `JsonDocument`"},{id:"missing",page:170,label:"Some values are missing",summary:"Some values are missing"},{id:"garbage",page:162,label:"<code>JsonDocument</code> returns garbage",summary:"`JsonDocument` returns garbage"},{id:"changing-strings",page:162,label:"The strings in the <code>JsonDocument</code> change for no reason",summary:"The strings in the `JsonDocument` change for no reason"},{id:"altered",page:166,label:"<code>deserializeJson()</code> alters the content of the input",summary:"Input buffer is modified"},{id:"truncated-strings",page:184,label:"Some strings are truncated",summary:"Some strings are truncated"}]},{content:`<p>What's the first character of your input?</p>
`,options:[{id:"brace",page:159,label:"An opening brace: <code>{</code>",summary:"The first character is `{`"},{id:"bracket",page:160,label:"An opening bracket: <code>[</code>",summary:"The first character is `[`"},{id:"quote",page:161,label:"A quote: <code>&quot;</code>",summary:'The first character is `"`'},{id:"other",page:191,label:"None of the above",summary:'The first character is neither `{`, nor `[`, nor `"`'}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> stops reading as soon as the JSON document ends.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Garbage characters follow the input"},{id:"lint",page:169,label:"No",summary:"No garbage characters follow the input"}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> stops reading as soon as the JSON document ends.
In your case, it will read the input until it reaches the matching <code>]</code> and ignore any remaining characters.</p>
<p>Suppose the input looks like this:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Garbage characters follow the input"},{id:"lint",page:169,label:"No",summary:"No garbage characters follow the input"}]},{content:`<p>What is the type of the second argument passed to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>?</p>
`,options:[{id:"char-ptr",page:165,label:"<code>char*</code> (or <code>char[]</code>)",summary:"Input type is `char*`"},{id:"const-char-ptr",page:1,label:"<code>const char*</code>",summary:"Input type is `const char*`"},{id:"string",page:1,label:"<code>String</code> (or <code>std::string</code>)",summary:"Input type is `String`"},{id:"stream",page:1,label:"<code>Stream</code> (or <code>std::istream)</code>",summary:"Input type is `Stream`"}]},{content:`<p>The easiest solution is to disable the zero-copy mode by passing a read-only input buffer. Casting the pointer will do the trick:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// replace this:</span>
<span class="hljs-built_in">deserializeJson</span>(doc, input, inputSize);
...
`,options:[{id:"success",page:164,label:"Yes, the input comes from a stream",summary:"Input comes from a stream"},{id:"cast",page:163,label:"No, it doesn't",summary:"Input doesn't come from a stream"}]},{content:`<p>When you pass a writeable buffer as the input of <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, ArduinoJson uses the zero-copy mode. Instead of copying the strings from the input into the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, it stores pointers to the input buffer.</p>
<p>While doing this, the parser modifies the input buffer to unescape special characters and add string terminator.
...
<p>Did this solve your issue?</p>
`,options:[{id:"acceptable",page:2,label:"Yes",summary:"`deserializeJson()` tolerates the error, and that's OK"},{id:"unacceptable",page:191,label:"No",summary:"`deserializeJson()` should not let this error pass"}]},{content:`<p>So, <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> returns <code>Ok</code>, and jsonlint confirms that the input is valid.</p>
...
`,options:[{id:"filter",page:175,label:"Yes",summary:"Program uses `DeserializationOption::Filter`"},{id:"no-filter",page:179,label:"No",summary:"Program doesn't use `DeserializationOption::Filter`"}]},{content:`<p>When a program fails to extract the values from a <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, it's often because there is a confusion between arrays and objects.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Fixing the filter solves the issue"},{id:"filter-ok",page:179,label:"No",summary:"Fixing the filter doesn't solve the issue"}]},{content:`<p>Please print the filter to the serial port like so:</p>
...
`,options:[{id:"size-ok",page:174,label:"Yes",summary:"The filter looks correct"},{id:"too-small",page:176,label:"No, some values are missing",summary:"The filter lacks some values"}]},{content:`<p>The filter's <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> is too small; please increase its capacity and try again.</p>
<p>If you want, you can use the <a href="/v6/assistant/">ArduinoJson Assistant</a> to compute the required capacity.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Increasing the filter's capacity fixes the issue"},{id:"size-increased",page:174,label:"No",summary:"Increasing the filter's capacity doesn't fix the issue"}]},{content:`<p>Which function do you call to deserialize the input?</p>
`,options:[{id:"json",page:1,label:"<code>deserializeJson()</code>",summary:"Program calls `deserializeJson()`"},{id:"msgpack",page:178,label:"<code>deserializeMsgPack()</code>",summary:"Program calls `deserializeMsgPack()`"}]},{content:`<p>It seems that your program fed <a href="/v6/api/msgpack/deserializemsgpack/"><code>deserializeMsgPack()</code></a> with garbage input.</p>
...
`,options:[{id:"quote",page:182,label:"A quote (<code>&quot;</code>)",summary:"Serialized document starts with a quote"},{id:"bracket",page:173,label:"A square bracket (<code>[</code>)",summary:"Serialized document starts with a square bracket"},{id:"brace",page:173,label:"A curly brace (<code>{</code>)",summary:"Serialized document starts with a curly brace"},{id:"not-in-list",page:177,label:"None of the above",summary:"Serialized document starts with neither a quote, a bracket, nor a brace."}]},{content:`<p>If you cannot fix the server, you can at least reverse the double serialization (stringification) to get back the original object.</p>
...
`,options:[{id:"nul",page:206,label:"Yes",summary:"The input contains `\\u0000`"},{id:"no-nul",page:190,label:"No",summary:"The input doesn't contain `\\u0000`"}]},{content:`<p>When you call <code>HTTPClient::getStream()</code>, you bypass the part that handles <a href="https://en.wikipedia.org/wiki/Chunked_transfer_encoding">Chunked Transfer Encoding</a>.
...
`,options:[{id:"getstream",page:185,label:"<code>getStream()</code>",summary:"Response comes from `HTTPClient::getStream()`"},{id:"getstring",page:1,label:"<code>getString()</code>",summary:"Response comes from `HTTPClient::getString()`"}]},{content:`<p>When you use HTTP 1.1, the server can send the response with <a href="https://en.wikipedia.org/wiki/Chunked_transfer_encoding">Chunked Transfer Encoding</a>.
As a result, the response's body may be split in multiple chunks, making some strings look like they are truncated (in reality, they contain a line-break).</p>
<p>The most straightforward workaround is to downgrade the connection to HTTP 1.0.
...
`,options:[{id:"httpclient",page:186,label:"Yes, I'm using <code>HTTPClient</code>",summary:"Program uses `HTTPClient`"},{id:"http-library",page:188,label:"Yes, but it's not <code>HTTPClient</code>",summary:"Program uses an unknown HTTP library"},{id:"no-library",page:187,label:"No",summary:"Program doesn't use an HTTP library"}]},{content:`<p>Does the JSON input come from an HTTP response?</p>
`,options:[{id:"http",page:189,label:"Yes",summary:"The input comes from an HTTP response"},{id:"no-nul",page:1,label:"No",summary:"The input doesn't come from an HTTP response"}]},{content:`<p><a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> accepted a JSON document that was clearly invalid.<br>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Increasing the capacity of the `JsonDocument` fixes the issue"},{id:"increased-capacity",page:199,label:"No",summary:"Increasing the capacity of the `JsonDocument` doesn't fix the issue"}]},{content:`<p>I'm pretty confident the Assistant computes the right capacity; however, some settings can affect the result:</p>
<ol>
...
`,options:[{id:"global",page:194,label:"Yes",summary:"`doc` is a global variable"},{id:"local",page:193,label:"No",summary:"`doc` is not a global variable"}]},{content:`<p>Let's verify that the memory allocation succeeded.</p>
<p>Please print the capacity of the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> to the serial port, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">capacity</span>());
</code></pre>
<p>What value does it show?</p>
`,options:[{id:"capacity-0",page:195,label:"<code>0</code>",summary:"`doc.capacity()` returns `0`"},{id:"capacity-ok",page:193,label:"The value passed to the constructor of <code>DynamicJsonDocument</code>",summary:"`doc.capacity()` returns the right value"}]},{content:`<p>Well, that's very bad news. It seems that your microcontroller doesn't have enough RAM to hold the JSON document.</p>
...
`,options:[{id:"can-uprade",page:204,label:"Yes",summary:"Library can be upgraded"},{id:"cannot-upgrade",page:202,label:"No",summary:"Library cannot be upgraded"}]},{content:`<p>So, I guess that you're not using <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> but <a href="/v6/api/msgpack/deserializemsgpack/"><code>deserializeMsgPack()</code></a>, right?</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Defining `ARDUINOJSON_DECODE_UNICODE` solves the issue"},{id:"decode-unicode-set",page:201,label:"No",summary:"Defining `ARDUINOJSON_DECODE_UNICODE` doesn't solve the issue"}]},{content:`<p>If you're still seeing <code>NotSupported</code> after upgrading the library, it means that your code is not using the upgraded library.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Removing duplicates fixes the issue"},{id:"duplicates-removed",page:202,label:"No",summary:"Removing duplicates doesn't fix the issue"}]},{content:`<p>Please upgrade ArduinoJson to the latest version.<br>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Upgrading solves the issue"},{id:"updraded",page:203,label:"No",summary:"Upgrading doesn't solves the issue"}]},{content:`<p><a href="/v6/api/misc/deserializationerror/#toodeep"><code>TooDeep</code></a> means that the input document has too many levels of nesting.</p>
...
`,options:[{id:"crash",page:208,label:"The program crashes",summary:"Program crashes"},{id:"empty",page:218,label:"The output is empty (e.g. <code>{}</code>, <code>[]</code>, or <code>null</code>)",summary:"Output is empty"},{id:"incomplete",page:247,label:"The output is incomplete",summary:"Output is incomplete"},{id:"garbage",page:230,label:"The output contains garbage",summary:"Output contains garbage"},{id:"empty-strings",page:224,label:"The output contains empty strings",summary:"Output contains empty strings"},{id:"null",page:247,label:"The output contains <code>null</code>",summary:"Output contains null"},{id:"float",page:227,label:"Floating-point values contain too many decimal digits",summary:"Floating-point values contain too many decimal digits"},{id:"slow",page:259,label:"It's slow",summary:"Serialization is slow"}]},{content:`<p>Do you use <a href="/v6/api/dynamicjsondocument/"><code>DynamicJsonDocument</code></a> or <a href="/v6/api/staticjsondocument/"><code>StaticJsonDocument</code></a>?</p>
`,options:[{id:"dynamicjsondocument",page:216,label:"<code>DynamicJsonDocument</code>",summary:"Program uses `DynamicJsonDocument`"},{id:"staticjsondocument",page:217,label:"<code>StaticJsonDocument</code>",summary:"Program uses `StaticJsonDocument`"}]},{content:`<p>Please replace all those string pointers with literals.</p>
...
<p>Does your program still crash?</p>
`,options:[{id:"crash-with-literals",page:212,label:"Yes",summary:"Replacing string pointers with literals doesn't fix the crash"},{id:"no-crash-with-literals",page:210,label:"No",summary:"Replacing string pointers with literals fixes the crash"}]},{content:`<p>One of these string pointers is probably dangling or points to a non-zero-terminated string.</p>
...
`,options:[{id:"charptr",page:209,label:"Yes",summary:"Program inserts string pointers into the `JsonDocument`"},{id:"no-charptr",page:212,label:"No",summary:"Program doesn't insert string pointers into the `JsonDocument`"}]},{content:`<p>What is the type of the second argument passed to <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a>?</p>
`,options:[{id:"char-array",page:213,label:"<code>char[]</code>",summary:"Output type is `char[]`"},{id:"char-ptr",page:214,label:"<code>char*</code>",summary:"Output type is `char*`"},{id:"arduino-string",page:1,label:"<code>String</code>",summary:"Output type is `String`"},{id:"arduino-stream",page:1,label:"<code>Stream</code>",summary:"Output type is `Stream`"}]},{content:`<p>I think this output buffer could cause a <a href="https://en.wikipedia.org/wiki/Stack_buffer_overflow">stack overflow</a>.</p>
...
`,options:[{id:"progmem",page:215,label:"Yes",summary:"Program uses `PROGMEM`"},{id:"no-progmem",page:211,label:"No",summary:"Program doesn't use `PROGMEM`"}]},{content:`<p>Because a <a href="/v6/api/staticjsondocument/"><code>StaticJsonDocument</code></a> resides on the stack, it may cause a <a href="https://en.wikipedia.org/wiki/Stack_buffer_overflow">stack-overflow</a>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Switching to `DynamicJsonDocument` fixes the issue"},{id:"dynamicjsondocument-tried",page:216,label:"No",summary:"Switching to `DynamicJsonDocument` doesn't fix the issue"}]},{content:`<p>Please print the capacity of the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> to the serial port, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">capacity</span>());
</code></pre>
<p>What value does it show?</p>
`,options:[{id:"capacity-0",page:222,label:"<code>0</code>",summary:"`doc.capacity()` returns `0`"},{id:"capacity-ok",page:223,label:"a positive integer",summary:"`doc.capacity()` looks good"}]},{content:`<p><code>doc.capacity()</code> returns <code>0</code>, which means <code>allocate()</code> returned <code>NULL</code>.</p>
<p>I think that, because <code>doc</code> is declared global, <code>allocate()</code> is called too early and the heap isn't ready.
I know this happens on ESP32 with the <code>SpiRamJsonDocument</code> shown in <a href="/v6/how-to/use-external-ram-on-esp32/">How to use external RAM on ESP32?</a>.</p>
<p>Please try to make <code>doc</code> a local variable.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Making `doc` local fixes the issue."},{id:"failure",page:1,label:"No",summary:"Making `doc` local doesn't fix the issue."}]},{content:`<p>Is <code>doc</code> a global variable?</p>
`,options:[{id:"global",page:219,label:"Yes",summary:"`doc` is a global variable"},{id:"local",page:221,label:"No",summary:"`doc` is not a global variable"}]},{content:`<p>Well, that's very bad news. It seems that your microcontroller doesn't have enough RAM to hold the JSON document.</p>
<p>Please read <a href="/v6/how-to/reduce-memory-usage/">How to reduce memory usage</a>.
It shows several techniques you can use to use less RAM.
Hopefully, you'll make enough room for the memory pool.</p>
<p>Did this solve your issue?</p>
...
`,options:[{id:"basic",page:220,label:"<code>BasicJsonDocument&lt;T&gt;</code>",summary:"The document is a `BasicJsonDocument<T>`"},{id:"dynamic",page:221,label:"<code>DynamicJsonDocument</code>",summary:"The document is a `DynamicJsonDocument`"},{id:"static",page:1,label:"<code>StaticJsonDocument</code>",summary:"The document is a `StaticJsonDocument`"}]},{content:`<p>Please print the value of <a href="/v6/api/jsondocument/overflowed/"><code>JsonDocument::overflowed()</code></a>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:257,label:"<code>1</code> (or <code>true</code>)",summary:"`JsonDocument::overflowed()` returns `true`"},{id:"overflowed-0",page:1,label:"<code>0</code> (or <code>false</code>)",summary:"`JsonDocument::overflowed()` returns `false`"}]},{content:`<p>Do you call <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> before calling <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a>? (with the same <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>)</p>
`,options:[{id:"deserialize-yes",page:226,label:"Yes",summary:"Program calls `deserializeJson()`"},{id:"deserialize-no",page:1,label:"No",summary:"Program doesn't call `deserializeJson()`"}]},{content:`<p>When you pass a writeable buffer as the input of <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, ArduinoJson uses the <strong>zero-copy mode</strong>. Instead of copying the strings from the input into the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, it stores pointers to the input buffer.
...
`,options:[{id:"char-ptr",page:225,label:"<code>char*</code> (or <code>char[]</code>)",summary:"Input type is `char*`"},{id:"const-char-ptr",page:1,label:"<code>const char*</code>",summary:"Input type is `const char*`"},{id:"string",page:1,label:"<code>String</code> (or <code>std::string</code>)",summary:"Input type is `String`"},{id:"stream",page:1,label:"<code>Stream</code> (or <code>std::istream)</code>",summary:"Input type is `Stream`"}]},{content:`<p>Supposing that the JSON output looks like this:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Replacing `float` with `double` fixes the issue"},{id:"double",page:229,label:"No",summary:"Replacing `float` with `double` doesn't fix the issue"}]},{content:`<p>I'm surprised that the previous solution didn't work.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Rounding the value fixes the issue"},{id:"double",page:228,label:"No",summary:"Rounding the value doesn't fix the issue"}]},{content:`<p>What function produces the garbage?</p>
`,options:[{id:"json",page:237,label:"<code>serializeJson()</code> (or <code>serializeJsonPretty()</code>)",summary:"`serializeJson()` produces garbage"},{id:"msg",page:242,label:"<code>serializeMsgPack()</code>",summary:"`serializeMsgPack()` produces garbage"}]},{content:`<p>When you pass a writeable buffer as the input of <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>, ArduinoJson uses the <strong>zero-copy mode</strong>. Instead of copying the strings from the input into the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, it stores pointers to the input buffer.
Therefore, the input buffer must stay alive during the whole lifetime of the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>; otherwise, all the strings in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> will be dangling pointers.</p>
<p>The easiest solution is to disable the zero-copy mode by passing a read-only input buffer. Casting the pointer will do the trick:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// replace this:</span>
<span class="hljs-built_in">deserializeJson</span>(doc, input, inputSize);
...
<p>Now that the zero-copy mode is disabled, you probably need a larger <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, so don't forget to update the capacity. As usual, use the <a href="/v6/assistant/">ArduinoJson Assistant</a> to compute the right capacity for your project.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Casting the pointer fixes the issue"},{id:"casting-fails",page:246,label:"No",summary:"Casting the pointer doesn't fix the issue"}]},{content:`<p>What's the type of the second argument passed to <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a>?</p>
`,options:[{id:"char-ptr",page:231,label:"<code>char*</code> (or <code>char[]</code>)",summary:"Input type is `char*`"},{id:"const-char-ptr",page:246,label:"<code>const char*</code>",summary:"Input type is `const char*`"},{id:"string",page:246,label:"<code>String</code> (or <code>std::string</code>)",summary:"Input type is `String`"},{id:"stream",page:246,label:"<code>Stream</code> (or <code>std::istream)</code>",summary:"Input type is `Stream`"}]},{content:`<p>You can insert <a href="https://www.arduino.cc/reference/en/language/variables/data-types/stringobject/"><code>String</code></a> objects in a <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, but make sure you don't store the result of <a href="https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/c_str/"><code>String::c_str()</code></a>.</p>
...
`,options:[{id:"string",page:233,label:"Yes",summary:"Program uses `String`"},{id:"no-string",page:1,label:"No",summary:"Program doesn't use `String`"}]},{content:`<p><a href="/v6/api/staticjsondocument/"><code>StaticJsonDocument</code></a> stores its memory pool in the stack.
...
<p>Please switch to a <a href="/v6/api/dynamicjsondocument/"><code>DynamicJsonDocument</code></a>.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Switching to `DynamicJsonDocument` fixes the issue"},{id:"dynamic",page:234,label:"No",summary:"Switching to `DynamicJsonDocument` doesn't fix the issue"}]},{content:`<p>Which kind of <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> do you use?</p>
`,options:[{id:"dynamic",page:234,label:"<code>DynamicJsonDocument</code>",summary:"Program uses `DynamicJsonDocument`"},{id:"static",page:235,label:"<code>StaticJsonDocument</code>",summary:"Program uses `StaticJsonDocument`"}]},{content:`<p>Do you call <a href="/v6/api/json/deserializejson/"><code>deserializeJson()</code></a> before calling <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a>? (with the same <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>)</p>
`,options:[{id:"deserialize-yes",page:232,label:"Yes",summary:"Program calls `deserializeJson()`"},{id:"deserialize-no",page:246,label:"No",summary:"Program doesn't call `deserializeJson()`"}]},{content:`<p><a href="/v6/api/jsonarray/"><code>JsonArray</code></a> doesn't contain any data: it is a reference to an object stored in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>. It becomes invalid as soon as the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> is destroyed; this could explain the garbage you see in the output.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:245,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><a href="/v6/api/jsonobject/"><code>JsonObject</code></a> doesn't contain any data: it is a reference to an object stored in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>. It becomes invalid as soon as the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> is destroyed; this could explain the garbage you see in the output.</p>
...
<p>This way, you can keep the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> alive when you call <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a></p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:245,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><a href="/v6/api/jsonvariant/"><code>JsonVariant</code></a> doesn't contain any data: it is a reference to an object stored in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>. It becomes invalid as soon as the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> is destroyed; this could explain the garbage you see in the output.</p>
...
`,options:[{id:"json",page:237,label:"Yes, <code>serializeJson()</code> produces garbage too",summary:"`serializeJson()` produces garbage too"},{id:"deserialize-no",page:241,label:"No, <code>serializeJson()</code> doesn't produces garbage",summary:"`serializeJson()` doesn't produces garbage"}]},{content:`<p><a href="/v6/api/jsondocument/garbagecollect/"><code>JsonDocument::garbageCollect()</code></a> invalidates all previously acquired <a href="/v6/api/jsonarray/"><code>JsonArray</code></a>, <a href="/v6/api/jsonobject/"><code>JsonObject</code></a>, and <a href="/v6/api/jsonvariant/"><code>JsonVariant</code></a>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Reassigning references fixes the issue"},{id:"reassigned",page:236,label:"No",summary:"Reassigning references doesn't fix the issue"}]},{content:`<p><a href="/v6/api/basicjsondocument/shrinktofit/"><code>JsonDocument::shrinkToFit()</code></a> invalidates all previously acquired <a href="/v6/api/jsonarray/"><code>JsonArray</code></a>, <a href="/v6/api/jsonobject/"><code>JsonObject</code></a>, and <a href="/v6/api/jsonvariant/"><code>JsonVariant</code></a>.</p>
<p>After you call it, make sure to reassign  every references, like so:</p>
<pre><code class="hljs language-c++">JsonObject cfg = doc.<span class="hljs-built_in">createNestedObject</span>(<span class="hljs-string">&quot;config&quot;</span>);
<span class="hljs-comment">// ...</span>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Reassigning references fixes the issue"},{id:"reassigned",page:236,label:"No",summary:"Reassigning references doesn't fix the issue"}]},{content:`<p>Do you use one of the following function?</p>
`,options:[{id:"garbagecollect",page:243,label:"<code>JsonDocument::garbageCollect()</code>",summary:"Program calls `JsonDocument::garbageCollect()`"},{id:"shrinktofit",page:244,label:"<code>JsonDocument::shrinkToFit()</code>",summary:"Program calls `JsonDocument::shrinkToFit()`"},{id:"none",page:236,label:"No",summary:"Program doesn't call an invalidating function"}]},{content:`<p>What is the type of the first argument passed to <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a>?</p>
`,options:[{id:"document",page:236,label:"<code>JsonDocument</code>",summary:"Program calls `serializeJson(const JsonDocument&, ...)`"},{id:"array",page:238,label:"<code>JsonArray</code> (or <code>JsonArrayConst</code>)",summary:"Program calls `serializeJson(JsonArrayConst, ...)`"},{id:"object",page:239,label:"<code>JsonObject</code> (or <code>JsonObjectConst</code>)",summary:"Program calls `serializeJson(JsonObjectConst, ...)`"},{id:"variant",page:240,label:"<code>JsonVariant</code> (or <code>JsonVariantConst</code>)",summary:"Program calls `serializeJson(JsonVariantConst, ...)`"}]},{content:`<p>Does your program call <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a> in a loop?</p>
`,options:[{id:"loop",page:254,label:"Yes",summary:"Program calls `serializeJson()` in a loop"},{id:"no-loop",page:255,label:"No",summary:"Program doesn't call `serializeJson()` in a loop"}]},{content:`<p>The ArduinoJson Assistant suggested a too small capacity because you didn't configure it properly.</p>
...
Hopefully, you'll make enough room for the memory pool.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Reducing memory usage fixes the issue"},{id:"failure",page:1,label:"No",summary:"Reducing memory usage doesn't fix the issue"}]},{content:`<p>Please print the value of <a href="/v6/api/jsondocument/capacity/"><code>JsonDocument::capacity()</code></a>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">capacity</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"capacity-zero",page:249,label:"<code>0</code>",summary:"`JsonDocument::capacity()` returns `0`"},{id:"capacity-nonzero",page:1,label:"A number greater than <code>0</code>",summary:"`JsonDocument::capacity()` returns a number greater than `0`"}]},{content:`<p>Is the JSON document big?</p>
`,options:[{id:"big",page:258,label:"Yes, it contains hundred of values",summary:"The JSON document is large"},{id:"small",page:1,label:"No, it doesn't contain that many values",summary:"The JSON document is not large"}]},{content:`<p>Please replace the call to <a href="/v6/api/jsondocument/clear/"><code>JsonDocument::clear()</code></a> with <a href="/v6/api/jsondocument/garbagecollect/"><code>JsonDocument::garbageCollect()</code></a>.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Calling `JsonDocument::garbageCollect()` solves the issue"},{id:"gc",page:255,label:"No",summary:"Calling `JsonDocument::garbageCollect()` doesn't solve the issue"}]},{content:`<p>We can try to clear the content of the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>.</p>
<p>Please call <a href="/v6/api/jsondocument/clear/"><code>JsonDocument::clear()</code></a> at the beginning of the loop.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Calling `JsonDocument::clear()` solves the issue"},{id:"clear",page:255,label:"No",summary:"Calling `JsonDocument::clear()` doesn't solve the issue"},{id:"missing",page:252,label:"Yes, but now some values are missing",summary:"Calling `JsonDocument::clear()` solves the issue but removes other values"}]},{content:`<p>Calling <a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a> is safe, but you'll run into issues if you modify the same <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> in a loop.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Moving the `JsonDocument` inside the loop solves the issue"},{id:"inside",page:255,label:"No",summary:"Moving the `JsonDocument` inside the loop doesn't solve the issue"},{id:"outside",page:253,label:"I cannot move the declaration inside the loop",summary:"The `JsonDocument` cannot be moved inside the loop"}]},{content:`<p>Please print the value of <a href="/v6/api/jsondocument/overflowed/"><code>JsonDocument::overflowed()</code></a>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:257,label:"<code>1</code> (or <code>true</code>)",summary:"`JsonDocument::overflowed()` returns `true`"},{id:"overflowed-0",page:256,label:"<code>0</code> (or <code>false</code>)",summary:"`JsonDocument::overflowed()` returns `false`"}]},{content:`<p>Does one of the strings in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a> contains a NUL (i.e.,  ASCII code 0, or <code>\\u0000</code>)?</p>
`,options:[{id:"nul",page:206,label:"Yes",summary:"One or more strings contain a NUL"},{id:"no-nul",page:251,label:"No",summary:"No string contains a NUL"}]},{content:`<p><a href="/v6/api/jsondocument/overflowed/"><code>JsonDocument::overflowed()</code></a> returns <code>true</code> when you try to insert a value in the <a href="/v6/api/jsondocument/"><code>JsonDocument</code></a>, but there isn't enough room to store it.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Increasing the capacity of the `JsonDocument` solves the issue."},{id:"assistant-is-wrong",page:248,label:"Yes, but the required capacity is greater than what the ArduinJson Assistant says.",summary:"The required capacity is greater than what the ArduinJson Assistant says."},{id:"capacity-increased",page:250,label:"No",summary:"Increasing the capacity of the `JsonDocument` doesn't solve the issue."}]},{content:`<p>Indeed, due to an optimization, a <code>JsonDocument</code> is limited in the number of nodes it can contain.
The following table shows the maximum number of nodes for each capacity:</p>
<table class="table">
<thead>
<tr>
...
Unfortunately, you cannot count on the ArduinoJson Assistant anymore.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"nul",page:2,label:"Yes",summary:"Increasing `ARDUINOJSON_SLOT_OFFSET_SIZE` solves the issue"},{id:"no-nul",page:1,label:"No",summary:"Increasing `ARDUINOJSON_SLOT_OFFSET_SIZE` doesn't solve the issue"}]},{content:`<p><a href="/v6/api/json/serializejson/"><code>serializeJson()</code></a> writes the JSON document mostly one character at a time, which can be pretty slow with unbuffered streams (such as <a href="https://www.arduino.cc/en/Reference/EthernetClient"><code>EthernetClient</code></a>, <a href="https://www.arduino.cc/en/Reference/WiFiClient"><code>WifiClient</code></a>, <a href="https://www.arduino.cc/en/Reference/SD"><code>File</code></a>, and <a href="https://github.com/knolleary/pubsubclient/">PubSubClient</a>).</p>
