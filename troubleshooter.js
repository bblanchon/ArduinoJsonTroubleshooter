...
* @license MIT
**/function pn(e,s){const n=new Set(e.split(","));return s?t=>n.has(t.toLowerCase()):t=>n.has(t)}const W={},as=[],ye=()=>{},ia=()=>!1,xs=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),un=e=>e.startsWith("onUpdate:"),ee=Object.assign,dn=(e,s)=>{const n=e.indexOf(s);n>-1&&e.splice(n,1)},ra=Object.prototype.hasOwnProperty,E=(e,s)=>ra.call(e,s),x=Array.isArray,is=e=>Ds(e)==="[object Map]",pt=e=>Ds(e)==="[object Set]",N=e=>typeof e=="function",Q=e=>typeof e=="string",rs=e=>typeof e=="symbol",B=e=>e!==null&&typeof e=="object",ut=e=>(B(e)||N(e))&&N(e.then)&&N(e.catch),dt=Object.prototype.toString,Ds=e=>dt.call(e),la=e=>Ds(e).slice(8,-1),ht=e=>Ds(e)==="[object Object]",hn=e=>Q(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,Is=pn(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Ns=e=>{const s=Object.create(null);return n=>s[n]||(s[n]=e(n))},ca=/-(\w)/g,ke=Ns(e=>e.replace(ca,(s,n)=>n?n.toUpperCase():"")),pa=/\B([A-Z])/g,ls=Ns(e=>e.replace(pa,"-$1").toLowerCase()),qs=Ns(e=>e.charAt(0).toUpperCase()+e.slice(1)),mn=Ns(e=>e?`on${qs(e)}`:""),$e=(e,s)=>!Object.is(e,s),fn=(e,s)=>{for(let n=0;n<e.length;n++)e[n](s)},Os=(e,s,n)=>{Object.defineProperty(e,s,{configurable:!0,enumerable:!1,value:n})},ua=e=>{const s=parseFloat(e);return isNaN(s)?e:s},da=e=>{const s=Q(e)?Number(e):NaN;return isNaN(s)?e:s};let mt;const ft=()=>mt||(mt=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function gn(e){if(x(e)){const s={};for(let n=0;n<e.length;n++){const t=e[n],o=Q(t)?ya(t):gn(t);if(o)for(const a in o)s[a]=o[a]}return s}else if(Q(e)||B(e))return e}const ha=/;(?![^(]*\))/g,ma=/:([^]+)/,fa=/\/\*[^]*?\*\//g;function ya(e){const s={};return e.replace(fa,"").split(ha).forEach(n=>{if(n){const t=n.split(ma);t.length>1&&(s[t[0].trim()]=t[1].trim())}}),s}function ms(e){let s="";if(Q(e))s=e;else if(x(e))for(let n=0;n<e.length;n++){const t=ms(e[n]);t&&(s+=t+" ")}else if(B(e))for(const n in e)e[n]&&(s+=n+" ");return s.trim()}const ba=pn("itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly");function gt(e){return!!e||e===""}const zs=e=>Q(e)?e:e==null?"":x(e)||B(e)&&(e.toString===dt||!N(e.toString))?JSON.stringify(e,yt,2):String(e),yt=(e,s)=>s&&s.__v_isRef?yt(e,s.value):is(s)?{[`Map(${s.size})`]:[...s.entries()].reduce((n,[t,o],a)=>(n[yn(t,a)+" =>"]=o,n),{})}:pt(s)?{[`Set(${s.size})`]:[...s.values()].map(n=>yn(n))}:rs(s)?yn(s):B(s)&&!x(s)&&!ht(s)?String(s):s,yn=(e,s="")=>{var n;return rs(e)?`Symbol(${(n=e.description)!=null?n:s})`:e};/**
* @vue/reactivity v3.4.9
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Je;class ja{constructor(s=!1){this.detached=s,this._active=!0,this.effects=[],this.cleanups=[],this.parent=Je,!s&&Je&&(this.index=(Je.scopes||(Je.scopes=[])).push(this)-1)}get active(){return this._active}run(s){if(this._active){const n=Je;try{return Je=this,s()}finally{Je=n}}}on(){Je=this}off(){Je=this.parent}stop(s){if(this._active){let n,t;for(n=0,t=this.effects.length;n<t;n++)this.effects[n].stop();for(n=0,t=this.cleanups.length;n<t;n++)this.cleanups[n]();if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!s){const o=this.parent.scopes.pop();o&&o!==this&&(this.parent.scopes[this.index]=o,o.index=this.index)}this.parent=void 0,this._active=!1}}}function wa(e,s=Je){s&&s.active&&s.effects.push(e)}function va(){return Je}let Ge;class bn{constructor(s,n,t,o){this.fn=s,this.trigger=n,this.scheduler=t,this.active=!0,this.deps=[],this._dirtyLevel=3,this._trackId=0,this._runnings=0,this._queryings=0,this._depsLength=0,wa(this,o)}get dirty(){if(this._dirtyLevel===1){this._dirtyLevel=0,this._queryings++,Re();for(const s of this.deps)if(s.computed&&(Ja(s.computed),this._dirtyLevel>=2))break;Fe(),this._queryings--}return this._dirtyLevel>=2}set dirty(s){this._dirtyLevel=s?3:0}run(){if(this._dirtyLevel=0,!this.active)return this.fn();let s=Ce,n=Ge;try{return Ce=!0,Ge=this,this._runnings++,bt(this),this.fn()}finally{jt(this),this._runnings--,Ge=n,Ce=s}}stop(){var s;this.active&&(bt(this),jt(this),(s=this.onStop)==null||s.call(this),this.active=!1)}}function Ja(e){return e.value}function bt(e){e._trackId++,e._depsLength=0}function jt(e){if(e.deps&&e.deps.length>e._depsLength){for(let s=e._depsLength;s<e.deps.length;s++)wt(e.deps[s],e);e.deps.length=e._depsLength}}function wt(e,s){const n=e.get(s);n!==void 0&&s._trackId!==n&&(e.delete(s),e.size===0&&e.cleanup())}let Ce=!0,jn=0;const vt=[];function Re(){vt.push(Ce),Ce=!1}function Fe(){const e=vt.pop();Ce=e===void 0?!0:e}function wn(){jn++}function vn(){for(jn--;!jn&&Jn.length;)Jn.shift()()}function Jt(e,s,n){if(s.get(e)!==e._trackId){s.set(e,e._trackId);const t=e.deps[e._depsLength];t!==s?(t&&wt(t,e),e.deps[e._depsLength++]=s):e._depsLength++}}const Jn=[];function St(e,s,n){wn();for(const t of e.keys())if(!(!t.allowRecurse&&t._runnings)&&t._dirtyLevel<s&&(!t._runnings||s!==2)){const o=t._dirtyLevel;t._dirtyLevel=s,o===0&&(!t._queryings||s!==2)&&(t.trigger(),t.scheduler&&Jn.push(t.scheduler))}vn()}const _t=(e,s)=>{const n=new Map;return n.cleanup=e,n.computed=s,n},Sn=new WeakMap,Ke=Symbol(""),_n=Symbol("");function ue(e,s,n){if(Ce&&Ge){let t=Sn.get(e);t||Sn.set(e,t=new Map);let o=t.get(n);o||t.set(n,o=_t(()=>t.delete(n))),Jt(Ge,o)}}function Oe(e,s,n,t,o,a){const i=Sn.get(e);if(!i)return;let l=[];if(s==="clear")l=[...i.values()];else if(n==="length"&&x(e)){const c=Number(t);i.forEach((u,d)=>{(d==="length"||!rs(d)&&d>=c)&&l.push(u)})}else switch(n!==void 0&&l.push(i.get(n)),s){case"add":x(e)?hn(n)&&l.push(i.get("length")):(l.push(i.get(Ke)),is(e)&&l.push(i.get(_n)));break;case"delete":x(e)||(l.push(i.get(Ke)),is(e)&&l.push(i.get(_n)));break;case"set":is(e)&&l.push(i.get(Ke));break}wn();for(const c of l)c&&St(c,3);vn()}const Sa=pn("__proto__,__v_isRef,__isVue"),Tt=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(rs)),kt=_a();function _a(){const e={};return["includes","indexOf","lastIndexOf"].forEach(s=>{e[s]=function(...n){const t=R(this);for(let a=0,i=this.length;a<i;a++)ue(t,"get",a+"");const o=t[s](...n);return o===-1||o===!1?t[s](...n.map(R)):o}}),["push","pop","shift","unshift","splice"].forEach(s=>{e[s]=function(...n){Re(),wn();const t=R(this)[s].apply(this,n);return vn(),Fe(),t}}),e}function Ta(e){const s=R(this);return ue(s,"has",e),s.hasOwnProperty(e)}class At{constructor(s=!1,n=!1){this._isReadonly=s,this._shallow=n}get(s,n,t){const o=this._isReadonly,a=this._shallow;if(n==="__v_isReactive")return!o;if(n==="__v_isReadonly")return o;if(n==="__v_isShallow")return a;if(n==="__v_raw")return t===(o?a?Ra:Et:a?zt:Ot).get(s)||Object.getPrototypeOf(s)===Object.getPrototypeOf(t)?s:void 0;const i=x(s);if(!o){if(i&&E(kt,n))return Reflect.get(kt,n,t);if(n==="hasOwnProperty")return Ta}const l=Reflect.get(s,n,t);return(rs(n)?Tt.has(n):Sa(n))||(o||ue(s,"get",n),a)?l:de(l)?i&&hn(n)?l:l.value:B(l)?o?Pt(l):An(l):l}}class xt extends At{constructor(s=!1){super(!1,s)}set(s,n,t,o){let a=s[n];if(!this._shallow){const c=fs(a);if(!Dn(t)&&!fs(t)&&(a=R(a),t=R(t)),!x(s)&&de(a)&&!de(t))return c?!1:(a.value=t,!0)}const i=x(s)&&hn(n)?Number(n)<s.length:E(s,n),l=Reflect.set(s,n,t,o);return s===R(o)&&(i?$e(t,a)&&Oe(s,"set",n,t):Oe(s,"add",n,t)),l}deleteProperty(s,n){const t=E(s,n);s[n];const o=Reflect.deleteProperty(s,n);return o&&t&&Oe(s,"delete",n,void 0),o}has(s,n){const t=Reflect.has(s,n);return(!rs(n)||!Tt.has(n))&&ue(s,"has",n),t}ownKeys(s){return ue(s,"iterate",x(s)?"length":Ke),Reflect.ownKeys(s)}}class ka extends At{constructor(s=!1){super(!0,s)}set(s,n){return!0}deleteProperty(s,n){return!0}}const Aa=new xt,xa=new ka,Da=new xt(!0),Tn=e=>e,Es=e=>Reflect.getPrototypeOf(e);function Ps(e,s,n=!1,t=!1){e=e.__v_raw;const o=R(e),a=R(s);n||($e(s,a)&&ue(o,"get",s),ue(o,"get",a));const{has:i}=Es(o),l=t?Tn:n?Nn:In;if(i.call(o,s))return l(e.get(s));if(i.call(o,a))return l(e.get(a));e!==o&&e.get(s)}function Cs(e,s=!1){const n=this.__v_raw,t=R(n),o=R(e);return s||($e(e,o)&&ue(t,"has",e),ue(t,"has",o)),e===o?n.has(e):n.has(e)||n.has(o)}function Rs(e,s=!1){return e=e.__v_raw,!s&&ue(R(e),"iterate",Ke),Reflect.get(e,"size",e)}function Dt(e){e=R(e);const s=R(this);return Es(s).has.call(s,e)||(s.add(e),Oe(s,"add",e,e)),this}function It(e,s){s=R(s);const n=R(this),{has:t,get:o}=Es(n);let a=t.call(n,e);a||(e=R(e),a=t.call(n,e));const i=o.call(n,e);return n.set(e,s),a?$e(s,i)&&Oe(n,"set",e,s):Oe(n,"add",e,s),this}function Nt(e){const s=R(this),{has:n,get:t}=Es(s);let o=n.call(s,e);o||(e=R(e),o=n.call(s,e)),t&&t.call(s,e);const a=s.delete(e);return o&&Oe(s,"delete",e,void 0),a}function qt(){const e=R(this),s=e.size!==0,n=e.clear();return s&&Oe(e,"clear",void 0,void 0),n}function Fs(e,s){return function(t,o){const a=this,i=a.__v_raw,l=R(i),c=s?Tn:e?Nn:In;return!e&&ue(l,"iterate",Ke),i.forEach((u,d)=>t.call(o,c(u),c(d),a))}}function Ms(e,s,n){return function(...t){const o=this.__v_raw,a=R(o),i=is(a),l=e==="entries"||e===Symbol.iterator&&i,c=e==="keys"&&i,u=o[e](...t),d=n?Tn:s?Nn:In;return!s&&ue(a,"iterate",c?_n:Ke),{next(){const{value:y,done:w}=u.next();return w?{value:y,done:w}:{value:l?[d(y[0]),d(y[1])]:d(y),done:w}},[Symbol.iterator](){return this}}}}function Me(e){return function(...s){return e==="delete"?!1:e==="clear"?void 0:this}}function Ia(){const e={get(a){return Ps(this,a)},get size(){return Rs(this)},has:Cs,add:Dt,set:It,delete:Nt,clear:qt,forEach:Fs(!1,!1)},s={get(a){return Ps(this,a,!1,!0)},get size(){return Rs(this)},has:Cs,add:Dt,set:It,delete:Nt,clear:qt,forEach:Fs(!1,!0)},n={get(a){return Ps(this,a,!0)},get size(){return Rs(this,!0)},has(a){return Cs.call(this,a,!0)},add:Me("add"),set:Me("set"),delete:Me("delete"),clear:Me("clear"),forEach:Fs(!0,!1)},t={get(a){return Ps(this,a,!0,!0)},get size(){return Rs(this,!0)},has(a){return Cs.call(this,a,!0)},add:Me("add"),set:Me("set"),delete:Me("delete"),clear:Me("clear"),forEach:Fs(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(a=>{e[a]=Ms(a,!1,!1),n[a]=Ms(a,!0,!1),s[a]=Ms(a,!1,!0),t[a]=Ms(a,!0,!0)}),[e,n,s,t]}const[Na,qa,Oa,za]=Ia();function kn(e,s){const n=s?e?za:Oa:e?qa:Na;return(t,o,a)=>o==="__v_isReactive"?!e:o==="__v_isReadonly"?e:o==="__v_raw"?t:Reflect.get(E(n,o)&&o in t?n:t,o,a)}const Ea={get:kn(!1,!1)},Pa={get:kn(!1,!0)},Ca={get:kn(!0,!1)},Ot=new WeakMap,zt=new WeakMap,Et=new WeakMap,Ra=new WeakMap;function Fa(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Ma(e){return e.__v_skip||!Object.isExtensible(e)?0:Fa(la(e))}function An(e){return fs(e)?e:xn(e,!1,Aa,Ea,Ot)}function Ya(e){return xn(e,!1,Da,Pa,zt)}function Pt(e){return xn(e,!0,xa,Ca,Et)}function xn(e,s,n,t,o){if(!B(e)||e.__v_raw&&!(s&&e.__v_isReactive))return e;const a=o.get(e);if(a)return a;const i=Ma(e);if(i===0)return e;const l=new Proxy(e,i===2?t:n);return o.set(e,l),l}function cs(e){return fs(e)?cs(e.__v_raw):!!(e&&e.__v_isReactive)}function fs(e){return!!(e&&e.__v_isReadonly)}function Dn(e){return!!(e&&e.__v_isShallow)}function Ct(e){return cs(e)||fs(e)}function R(e){const s=e&&e.__v_raw;return s?R(s):e}function Rt(e){return Os(e,"__v_skip",!0),e}const In=e=>B(e)?An(e):e,Nn=e=>B(e)?Pt(e):e;class Ft{constructor(s,n,t,o){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this.effect=new bn(()=>s(this._value),()=>Mt(this,1)),this.effect.computed=this,this.effect.active=this._cacheable=!o,this.__v_isReadonly=t}get value(){const s=R(this);return Ba(s),(!s._cacheable||s.effect.dirty)&&$e(s._value,s._value=s.effect.run())&&Mt(s,2),s._value}set value(s){this._setter(s)}get _dirty(){return this.effect.dirty}set _dirty(s){this.effect.dirty=s}}function Ha(e,s,n=!1){let t,o;const a=N(e);return a?(t=e,o=ye):(t=e.get,o=e.set),new Ft(t,o,a||!o,n)}function Ba(e){Ce&&Ge&&(e=R(e),Jt(Ge,e.dep||(e.dep=_t(()=>e.dep=void 0,e instanceof Ft?e:void 0))))}function Mt(e,s=3,n){e=R(e);const t=e.dep;t&&St(t,s)}function de(e){return!!(e&&e.__v_isRef===!0)}function Ua(e){return de(e)?e.value:e}const La={get:(e,s,n)=>Ua(Reflect.get(e,s,n)),set:(e,s,n,t)=>{const o=e[s];return de(o)&&!de(n)?(o.value=n,!0):Reflect.set(e,s,n,t)}};function Yt(e){return cs(e)?e:new Proxy(e,La)}/**
* @vue/runtime-core v3.4.9
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const gs=[];function Sl(e,...s){Re();const n=gs.length?gs[gs.length-1].component:null,t=n&&n.appContext.config.warnHandler,o=Wa();if(t)ze(t,n,11,[e+s.join(""),n&&n.proxy,o.map(({vnode:a})=>`at <${Ro(n,a.type)}>`).join(`
`),o]);else{const a=[`[Vue warn]: ${e}`,...s];o.length&&a.push(`
`,...Va(o)),console.warn(...a)}Fe()}function Wa(){let e=gs[gs.length-1];if(!e)return[];const s=[];for(;e;){const n=s[0];n&&n.vnode===e?n.recurseCount++:s.push({vnode:e,recurseCount:0});const t=e.component&&e.component.parent;e=t&&t.vnode}return s}function Va(e){const s=[];return e.forEach((n,t)=>{s.push(...t===0?[]:[`
`],...$a(n))}),s}function $a({vnode:e,recurseCount:s}){const n=s>0?`... (${s} recursive calls)`:"",t=e.component?e.component.parent==null:!1,o=` at <${Ro(e.component,e.type,t)}`,a=">"+n;return e.props?[o,...Ga(e.props),a]:[o+a]}function Ga(e){const s=[],n=Object.keys(e);return n.slice(0,3).forEach(t=>{s.push(...Ht(t,e[t]))}),n.length>3&&s.push(" ..."),s}function Ht(e,s,n){return Q(s)?(s=JSON.stringify(s),n?s:[`${e}=${s}`]):typeof s=="number"||typeof s=="boolean"||s==null?n?s:[`${e}=${s}`]:de(s)?(s=Ht(e,R(s.value),!0),n?s:[`${e}=Ref<`,s,">"]):N(s)?[`${e}=fn${s.name?`<${s.name}>`:""}`]:(s=R(s),n?s:[`${e}=`,s])}function ze(e,s,n,t){let o;try{o=t?e(...t):e()}catch(a){Ys(a,s,n)}return o}function be(e,s,n,t){if(N(e)){const a=ze(e,s,n,t);return a&&ut(a)&&a.catch(i=>{Ys(i,s,n)}),a}const o=[];for(let a=0;a<e.length;a++)o.push(be(e[a],s,n,t));return o}function Ys(e,s,n,t=!0){const o=s?s.vnode:null;if(s){let a=s.parent;const i=s.proxy,l=`https://vuejs.org/errors/#runtime-${n}`;for(;a;){const u=a.ec;if(u){for(let d=0;d<u.length;d++)if(u[d](e,i,l)===!1)return}a=a.parent}const c=s.appContext.config.errorHandler;if(c){ze(c,null,10,[e,i,l]);return}}Ka(e,n,o,t)}function Ka(e,s,n,t=!0){console.error(e)}let ys=!1,qn=!1;const ie=[];let Ae=0;const ps=[];let Ye=null,Xe=0;const Bt=Promise.resolve();let On=null;function Xa(e){const s=On||Bt;return e?s.then(this?e.bind(this):e):s}function Za(e){let s=Ae+1,n=ie.length;for(;s<n;){const t=s+n>>>1,o=ie[t],a=bs(o);a<e||a===e&&o.pre?s=t+1:n=t}return s}function zn(e){(!ie.length||!ie.includes(e,ys&&e.allowRecurse?Ae+1:Ae))&&(e.id==null?ie.push(e):ie.splice(Za(e.id),0,e),Ut())}function Ut(){!ys&&!qn&&(qn=!0,On=Bt.then(Vt))}function Qa(e){const s=ie.indexOf(e);s>Ae&&ie.splice(s,1)}function ei(e){x(e)?ps.push(...e):(!Ye||!Ye.includes(e,e.allowRecurse?Xe+1:Xe))&&ps.push(e),Ut()}function Lt(e,s,n=ys?Ae+1:0){for(;n<ie.length;n++){const t=ie[n];if(t&&t.pre){if(e&&t.id!==e.uid)continue;ie.splice(n,1),n--,t()}}}function Wt(e){if(ps.length){const s=[...new Set(ps)].sort((n,t)=>bs(n)-bs(t));if(ps.length=0,Ye){Ye.push(...s);return}for(Ye=s,Xe=0;Xe<Ye.length;Xe++)Ye[Xe]();Ye=null,Xe=0}}const bs=e=>e.id==null?1/0:e.id,si=(e,s)=>{const n=bs(e)-bs(s);if(n===0){if(e.pre&&!s.pre)return-1;if(s.pre&&!e.pre)return 1}return n};function Vt(e){qn=!1,ys=!0,ie.sort(si);try{for(Ae=0;Ae<ie.length;Ae++){const s=ie[Ae];s&&s.active!==!1&&ze(s,null,14)}}finally{Ae=0,ie.length=0,Wt(),ys=!1,On=null,(ie.length||ps.length)&&Vt()}}function ni(e,s,...n){if(e.isUnmounted)return;const t=e.vnode.props||W;let o=n;const a=s.startsWith("update:"),i=a&&s.slice(7);if(i&&i in t){const d=`${i==="modelValue"?"model":i}Modifiers`,{number:y,trim:w}=t[d]||W;w&&(o=n.map(k=>Q(k)?k.trim():k)),y&&(o=n.map(ua))}let l,c=t[l=mn(s)]||t[l=mn(ke(s))];!c&&a&&(c=t[l=mn(ls(s))]),c&&be(c,e,6,o);const u=t[l+"Once"];if(u){if(!e.emitted)e.emitted={};else if(e.emitted[l])return;e.emitted[l]=!0,be(u,e,6,o)}}function $t(e,s,n=!1){const t=s.emitsCache,o=t.get(e);if(o!==void 0)return o;const a=e.emits;let i={},l=!1;if(!N(e)){const c=u=>{const d=$t(u,s,!0);d&&(l=!0,ee(i,d))};!n&&s.mixins.length&&s.mixins.forEach(c),e.extends&&c(e.extends),e.mixins&&e.mixins.forEach(c)}return!a&&!l?(B(e)&&t.set(e,null),null):(x(a)?a.forEach(c=>i[c]=null):ee(i,a),B(e)&&t.set(e,i),i)}function Hs(e,s){return!e||!xs(s)?!1:(s=s.slice(2).replace(/Once$/,""),E(e,s[0].toLowerCase()+s.slice(1))||E(e,ls(s))||E(e,s))}let je=null,Gt=null;function Bs(e){const s=je;return je=e,Gt=e&&e.type.__scopeId||null,s}function Kt(e,s=je,n){if(!s||e._n)return e;const t=(...o)=>{t._d&&Do(-1);const a=Bs(s);let i;try{i=e(...o)}finally{Bs(a),t._d&&Do(1)}return i};return t._n=!0,t._c=!0,t._d=!0,t}function _l(){}function En(e){const{type:s,vnode:n,proxy:t,withProxy:o,props:a,propsOptions:[i],slots:l,attrs:c,emit:u,render:d,renderCache:y,data:w,setupState:k,ctx:P,inheritAttrs:D}=e;let U,M;const ae=Bs(e);try{if(n.shapeFlag&4){const Y=o||t,X=Y;U=De(d.call(X,Y,y,a,k,w,P)),M=c}else{const Y=s;U=De(Y.length>1?Y(a,{attrs:c,slots:l,emit:u}):Y(a,null)),M=s.props?c:ti(c)}}catch(Y){vs.length=0,Ys(Y,e,1),U=ce(Se)}let C=U;if(M&&D!==!1){const Y=Object.keys(M),{shapeFlag:X}=C;Y.length&&X&7&&(i&&Y.some(un)&&(M=oi(M,i)),C=Be(C,M))}return n.dirs&&(C=Be(C),C.dirs=C.dirs?C.dirs.concat(n.dirs):n.dirs),n.transition&&(C.transition=n.transition),U=C,Bs(ae),U}const ti=e=>{let s;for(const n in e)(n==="class"||n==="style"||xs(n))&&((s||(s={}))[n]=e[n]);return s},oi=(e,s)=>{const n={};for(const t in e)(!un(t)||!(t.slice(9)in s))&&(n[t]=e[t]);return n};function ai(e,s,n){const{props:t,children:o,component:a}=e,{props:i,children:l,patchFlag:c}=s,u=a.emitsOptions;if(s.dirs||s.transition)return!0;if(n&&c>=0){if(c&1024)return!0;if(c&16)return t?Xt(t,i,u):!!i;if(c&8){const d=s.dynamicProps;for(let y=0;y<d.length;y++){const w=d[y];if(i[w]!==t[w]&&!Hs(u,w))return!0}}}else return(o||l)&&(!l||!l.$stable)?!0:t===i?!1:t?i?Xt(t,i,u):!0:!!i;return!1}function Xt(e,s,n){const t=Object.keys(s);if(t.length!==Object.keys(e).length)return!0;for(let o=0;o<t.length;o++){const a=t[o];if(s[a]!==e[a]&&!Hs(n,a))return!0}return!1}function ii({vnode:e,parent:s},n){for(;s;){const t=s.subTree;if(t.suspense&&t.suspense.activeBranch===e&&(t.el=e.el),t===e)(e=s.vnode).el=n,s=s.parent;else break}}const Zt="components";function Pn(e,s){return li(Zt,e,!0,s)||e}const ri=Symbol.for("v-ndc");function li(e,s,n=!0,t=!1){const o=je||oe;if(o){const a=o.type;if(e===Zt){const l=Co(a,!1);if(l&&(l===s||l===ke(s)||l===qs(ke(s))))return a}const i=Qt(o[e]||a[e],s)||Qt(o.appContext[e],s);return!i&&t?a:i}}function Qt(e,s){return e&&(e[s]||e[ke(s)]||e[qs(ke(s))])}const ci=e=>e.__isSuspense;function pi(e,s){s&&s.pendingBranch?x(e)?s.effects.push(...e):s.effects.push(e):ei(e)}const ui=Symbol.for("v-scx"),di=()=>Xs(ui),Us={};function Cn(e,s,n){return eo(e,s,n)}function eo(e,s,{immediate:n,deep:t,flush:o,once:a,onTrack:i,onTrigger:l}=W){if(s&&a){const O=s;s=(...pe)=>{O(...pe),X()}}const c=oe,u=O=>t===!0?O:us(O,t===!1?1:void 0);let d,y=!1,w=!1;if(de(e)?(d=()=>e.value,y=Dn(e)):cs(e)?(d=()=>u(e),y=!0):x(e)?(w=!0,y=e.some(O=>cs(O)||Dn(O)),d=()=>e.map(O=>{if(de(O))return O.value;if(cs(O))return u(O);if(N(O))return ze(O,c,2)})):N(e)?s?d=()=>ze(e,c,2):d=()=>(k&&k(),be(e,c,3,[P])):d=ye,s&&t){const O=d;d=()=>us(O())}let k,P=O=>{k=C.onStop=()=>{ze(O,c,4),k=C.onStop=void 0}},D;if(an)if(P=ye,s?n&&be(s,c,3,[d(),w?[]:void 0,P]):d(),o==="sync"){const O=di();D=O.__watcherHandles||(O.__watcherHandles=[])}else return ye;let U=w?new Array(e.length).fill(Us):Us;const M=()=>{if(!(!C.active||!C.dirty))if(s){const O=C.run();(t||y||(w?O.some((pe,q)=>$e(pe,U[q])):$e(O,U)))&&(k&&k(),be(s,c,3,[O,U===Us?void 0:w&&U[0]===Us?[]:U,P]),U=O)}else C.run()};M.allowRecurse=!!s;let ae;o==="sync"?ae=M:o==="post"?ae=()=>he(M,c&&c.suspense):(M.pre=!0,c&&(M.id=c.uid),ae=()=>zn(M));const C=new bn(d,ye,ae),Y=va(),X=()=>{C.stop(),Y&&dn(Y.effects,C)};return s?n?M():U=C.run():o==="post"?he(C.run.bind(C),c&&c.suspense):C.run(),D&&D.push(X),X}function hi(e,s,n){const t=this.proxy,o=Q(e)?e.includes(".")?so(t,e):()=>t[e]:e.bind(t,t);let a;N(s)?a=s:(a=s.handler,n=s);const i=Ss(this),l=eo(o,a.bind(t),n);return i(),l}function so(e,s){const n=s.split(".");return()=>{let t=e;for(let o=0;o<n.length&&t;o++)t=t[n[o]];return t}}function us(e,s,n=0,t){if(!B(e)||e.__v_skip)return e;if(s&&s>0){if(n>=s)return e;n++}if(t=t||new Set,t.has(e))return e;if(t.add(e),de(e))us(e.value,s,n,t);else if(x(e))for(let o=0;o<e.length;o++)us(e[o],s,n,t);else if(pt(e)||is(e))e.forEach(o=>{us(o,s,n,t)});else if(ht(e))for(const o in e)us(e[o],s,n,t);return e}function Ze(e,s,n,t){const o=e.dirs,a=s&&s.dirs;for(let i=0;i<o.length;i++){const l=o[i];a&&(l.oldValue=a[i].value);let c=l.dir[t];c&&(Re(),be(c,n,8,[e.el,l,e,s]),Fe())}}const He=Symbol("_leaveCb"),Ls=Symbol("_enterCb");function mi(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return ro(()=>{e.isMounted=!0}),lo(()=>{e.isUnmounting=!0}),e}const we=[Function,Array],no={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:we,onEnter:we,onAfterEnter:we,onEnterCancelled:we,onBeforeLeave:we,onLeave:we,onAfterLeave:we,onLeaveCancelled:we,onBeforeAppear:we,onAppear:we,onAfterAppear:we,onAppearCancelled:we},fi={name:"BaseTransition",props:no,setup(e,{slots:s}){const n=Qi(),t=mi();let o;return()=>{const a=s.default&&ao(s.default(),!0);if(!a||!a.length)return;let i=a[0];if(a.length>1){for(const D of a)if(D.type!==Se){i=D;break}}const l=R(e),{mode:c}=l;if(t.isLeaving)return Fn(i);const u=oo(i);if(!u)return Fn(i);const d=Rn(u,l,t,n);Mn(u,d);const y=n.subTree,w=y&&oo(y);let k=!1;const{getTransitionKey:P}=u.type;if(P){const D=P();o===void 0?o=D:D!==o&&(o=D,k=!0)}if(w&&w.type!==Se&&(!es(u,w)||k)){const D=Rn(w,l,t,n);if(Mn(w,D),c==="out-in")return t.isLeaving=!0,D.afterLeave=()=>{t.isLeaving=!1,n.update.active!==!1&&(n.effect.dirty=!0,n.update())},Fn(i);c==="in-out"&&u.type!==Se&&(D.delayLeave=(U,M,ae)=>{const C=to(t,w);C[String(w.key)]=w,U[He]=()=>{M(),U[He]=void 0,delete d.delayedLeave},d.delayedLeave=ae})}return i}}};function to(e,s){const{leavingVNodes:n}=e;let t=n.get(s.type);return t||(t=Object.create(null),n.set(s.type,t)),t}function Rn(e,s,n,t){const{appear:o,mode:a,persisted:i=!1,onBeforeEnter:l,onEnter:c,onAfterEnter:u,onEnterCancelled:d,onBeforeLeave:y,onLeave:w,onAfterLeave:k,onLeaveCancelled:P,onBeforeAppear:D,onAppear:U,onAfterAppear:M,onAppearCancelled:ae}=s,C=String(e.key),Y=to(n,e),X=(q,Z)=>{q&&be(q,t,9,Z)},O=(q,Z)=>{const L=Z[1];X(q,Z),x(q)?q.every(re=>re.length<=1)&&L():q.length<=1&&L()},pe={mode:a,persisted:i,beforeEnter(q){let Z=l;if(!n.isMounted)if(o)Z=D||l;else return;q[He]&&q[He](!0);const L=Y[C];L&&es(e,L)&&L.el[He]&&L.el[He](),X(Z,[q])},enter(q){let Z=c,L=u,re=d;if(!n.isMounted)if(o)Z=U||c,L=M||u,re=ae||d;else return;let _=!1;const G=q[Ls]=fe=>{_||(_=!0,fe?X(re,[q]):X(L,[q]),pe.delayedLeave&&pe.delayedLeave(),q[Ls]=void 0)};Z?O(Z,[q,G]):G()},leave(q,Z){const L=String(e.key);if(q[Ls]&&q[Ls](!0),n.isUnmounting)return Z();X(y,[q]);let re=!1;const _=q[He]=G=>{re||(re=!0,Z(),G?X(P,[q]):X(k,[q]),q[He]=void 0,Y[L]===e&&delete Y[L])};Y[L]=e,w?O(w,[q,_]):_()},clone(q){return Rn(q,s,n,t)}};return pe}function Fn(e){if(Vs(e))return e=Be(e),e.children=null,e}function oo(e){return Vs(e)?e.children?e.children[0]:void 0:e}function Mn(e,s){e.shapeFlag&6&&e.component?Mn(e.component.subTree,s):e.shapeFlag&128?(e.ssContent.transition=s.clone(e.ssContent),e.ssFallback.transition=s.clone(e.ssFallback)):e.transition=s}function ao(e,s=!1,n){let t=[],o=0;for(let a=0;a<e.length;a++){let i=e[a];const l=n==null?i.key:String(n)+String(i.key!=null?i.key:a);i.type===ve?(i.patchFlag&128&&o++,t=t.concat(ao(i.children,s,l))):(s||i.type!==Se)&&t.push(l!=null?Be(i,{key:l}):i)}if(o>1)for(let a=0;a<t.length;a++)t[a].patchFlag=-2;return t}/*! #__NO_SIDE_EFFECTS__ */function Yn(e,s){return N(e)?ee({name:e.name},s,{setup:e}):e}const Ws=e=>!!e.type.__asyncLoader,Vs=e=>e.type.__isKeepAlive;function gi(e,s){io(e,"a",s)}function yi(e,s){io(e,"da",s)}function io(e,s,n=oe){const t=e.__wdc||(e.__wdc=()=>{let o=n;for(;o;){if(o.isDeactivated)return;o=o.parent}return e()});if($s(s,t,n),n){let o=n.parent;for(;o&&o.parent;)Vs(o.parent.vnode)&&bi(t,s,n,o),o=o.parent}}function bi(e,s,n,t){const o=$s(s,e,t,!0);co(()=>{dn(t[s],o)},n)}function $s(e,s,n=oe,t=!1){if(n){const o=n[e]||(n[e]=[]),a=s.__weh||(s.__weh=(...i)=>{if(n.isUnmounted)return;Re();const l=Ss(n),c=be(s,n,e,i);return l(),Fe(),c});return t?o.unshift(a):o.push(a),a}}const Ee=e=>(s,n=oe)=>(!an||e==="sp")&&$s(e,(...t)=>s(...t),n),ji=Ee("bm"),ro=Ee("m"),wi=Ee("bu"),vi=Ee("u"),lo=Ee("bum"),co=Ee("um"),Ji=Ee("sp"),Si=Ee("rtg"),_i=Ee("rtc");function Ti(e,s=oe){$s("ec",e,s)}function po(e,s,n,t){let o;const a=n&&n[t];if(x(e)||Q(e)){o=new Array(e.length);for(let i=0,l=e.length;i<l;i++)o[i]=s(e[i],i,void 0,a&&a[i])}else if(typeof e=="number"){o=new Array(e);for(let i=0;i<e;i++)o[i]=s(i+1,i,void 0,a&&a[i])}else if(B(e))if(e[Symbol.iterator])o=Array.from(e,(i,l)=>s(i,l,void 0,a&&a[l]));else{const i=Object.keys(e);o=new Array(i.length);for(let l=0,c=i.length;l<c;l++){const u=i[l];o[l]=s(e[u],u,l,a&&a[l])}}else o=[];return n&&(n[t]=o),o}const Hn=e=>e?Oo(e)?st(e)||e.proxy:Hn(e.parent):null,js=ee(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Hn(e.parent),$root:e=>Hn(e.root),$emit:e=>e.emit,$options:e=>Ln(e),$forceUpdate:e=>e.f||(e.f=()=>{e.effect.dirty=!0,zn(e.update)}),$nextTick:e=>e.n||(e.n=Xa.bind(e.proxy)),$watch:e=>hi.bind(e)}),Bn=(e,s)=>e!==W&&!e.__isScriptSetup&&E(e,s),ki={get({_:e},s){const{ctx:n,setupState:t,data:o,props:a,accessCache:i,type:l,appContext:c}=e;let u;if(s[0]!=="$"){const k=i[s];if(k!==void 0)switch(k){case 1:return t[s];case 2:return o[s];case 4:return n[s];case 3:return a[s]}else{if(Bn(t,s))return i[s]=1,t[s];if(o!==W&&E(o,s))return i[s]=2,o[s];if((u=e.propsOptions[0])&&E(u,s))return i[s]=3,a[s];if(n!==W&&E(n,s))return i[s]=4,n[s];Un&&(i[s]=0)}}const d=js[s];let y,w;if(d)return s==="$attrs"&&ue(e,"get",s),d(e);if((y=l.__cssModules)&&(y=y[s]))return y;if(n!==W&&E(n,s))return i[s]=4,n[s];if(w=c.config.globalProperties,E(w,s))return w[s]},set({_:e},s,n){const{data:t,setupState:o,ctx:a}=e;return Bn(o,s)?(o[s]=n,!0):t!==W&&E(t,s)?(t[s]=n,!0):E(e.props,s)||s[0]==="$"&&s.slice(1)in e?!1:(a[s]=n,!0)},has({_:{data:e,setupState:s,accessCache:n,ctx:t,appContext:o,propsOptions:a}},i){let l;return!!n[i]||e!==W&&E(e,i)||Bn(s,i)||(l=a[0])&&E(l,i)||E(t,i)||E(js,i)||E(o.config.globalProperties,i)},defineProperty(e,s,n){return n.get!=null?e._.accessCache[s]=0:E(n,"value")&&this.set(e,s,n.value,null),Reflect.defineProperty(e,s,n)}};function uo(e){return x(e)?e.reduce((s,n)=>(s[n]=null,s),{}):e}let Un=!0;function Ai(e){const s=Ln(e),n=e.proxy,t=e.ctx;Un=!1,s.beforeCreate&&ho(s.beforeCreate,e,"bc");const{data:o,computed:a,methods:i,watch:l,provide:c,inject:u,created:d,beforeMount:y,mounted:w,beforeUpdate:k,updated:P,activated:D,deactivated:U,beforeDestroy:M,beforeUnmount:ae,destroyed:C,unmounted:Y,render:X,renderTracked:O,renderTriggered:pe,errorCaptured:q,serverPrefetch:Z,expose:L,inheritAttrs:re,components:_,directives:G,filters:fe}=s;if(u&&xi(u,t,null),i)for(const K in i){const H=i[K];N(H)&&(t[K]=H.bind(n))}if(o){const K=o.call(n,n);B(K)&&(e.data=An(K))}if(Un=!0,a)for(const K in a){const H=a[K],ts=N(H)?H.bind(n,n):N(H.get)?H.get.bind(n,n):ye,ln=!N(H)&&N(H.set)?H.set.bind(n):ye,os=rr({get:ts,set:ln});Object.defineProperty(t,K,{enumerable:!0,configurable:!0,get:()=>os.value,set:Ne=>os.value=Ne})}if(l)for(const K in l)mo(l[K],t,n,K);if(c){const K=N(c)?c.call(n):c;Reflect.ownKeys(K).forEach(H=>{zi(H,K[H])})}d&&ho(d,e,"c");function ne(K,H){x(H)?H.forEach(ts=>K(ts.bind(n))):H&&K(H.bind(n))}if(ne(ji,y),ne(ro,w),ne(wi,k),ne(vi,P),ne(gi,D),ne(yi,U),ne(Ti,q),ne(_i,O),ne(Si,pe),ne(lo,ae),ne(co,Y),ne(Ji,Z),x(L))if(L.length){const K=e.exposed||(e.exposed={});L.forEach(H=>{Object.defineProperty(K,H,{get:()=>n[H],set:ts=>n[H]=ts})})}else e.exposed||(e.exposed={});X&&e.render===ye&&(e.render=X),re!=null&&(e.inheritAttrs=re),_&&(e.components=_),G&&(e.directives=G)}function xi(e,s,n=ye){x(e)&&(e=Wn(e));for(const t in e){const o=e[t];let a;B(o)?"default"in o?a=Xs(o.from||t,o.default,!0):a=Xs(o.from||t):a=Xs(o),de(a)?Object.defineProperty(s,t,{enumerable:!0,configurable:!0,get:()=>a.value,set:i=>a.value=i}):s[t]=a}}function ho(e,s,n){be(x(e)?e.map(t=>t.bind(s.proxy)):e.bind(s.proxy),s,n)}function mo(e,s,n,t){const o=t.includes(".")?so(n,t):()=>n[t];if(Q(e)){const a=s[e];N(a)&&Cn(o,a)}else if(N(e))Cn(o,e.bind(n));else if(B(e))if(x(e))e.forEach(a=>mo(a,s,n,t));else{const a=N(e.handler)?e.handler.bind(n):s[e.handler];N(a)&&Cn(o,a,e)}}function Ln(e){const s=e.type,{mixins:n,extends:t}=s,{mixins:o,optionsCache:a,config:{optionMergeStrategies:i}}=e.appContext,l=a.get(s);let c;return l?c=l:!o.length&&!n&&!t?c=s:(c={},o.length&&o.forEach(u=>Gs(c,u,i,!0)),Gs(c,s,i)),B(s)&&a.set(s,c),c}function Gs(e,s,n,t=!1){const{mixins:o,extends:a}=s;a&&Gs(e,a,n,!0),o&&o.forEach(i=>Gs(e,i,n,!0));for(const i in s)if(!(t&&i==="expose")){const l=Di[i]||n&&n[i];e[i]=l?l(e[i],s[i]):s[i]}return e}const Di={data:fo,props:go,emits:go,methods:ws,computed:ws,beforeCreate:le,created:le,beforeMount:le,mounted:le,beforeUpdate:le,updated:le,beforeDestroy:le,beforeUnmount:le,destroyed:le,unmounted:le,activated:le,deactivated:le,errorCaptured:le,serverPrefetch:le,components:ws,directives:ws,watch:Ni,provide:fo,inject:Ii};function fo(e,s){return s?e?function(){return ee(N(e)?e.call(this,this):e,N(s)?s.call(this,this):s)}:s:e}function Ii(e,s){return ws(Wn(e),Wn(s))}function Wn(e){if(x(e)){const s={};for(let n=0;n<e.length;n++)s[e[n]]=e[n];return s}return e}function le(e,s){return e?[...new Set([].concat(e,s))]:s}function ws(e,s){return e?ee(Object.create(null),e,s):s}function go(e,s){return e?x(e)&&x(s)?[...new Set([...e,...s])]:ee(Object.create(null),uo(e),uo(s??{})):s}function Ni(e,s){if(!e)return s;if(!s)return e;const n=ee(Object.create(null),e);for(const t in s)n[t]=le(e[t],s[t]);return n}function yo(){return{app:null,config:{isNativeTag:ia,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let qi=0;function Oi(e,s){return function(t,o=null){N(t)||(t=ee({},t)),o!=null&&!B(o)&&(o=null);const a=yo(),i=new WeakSet;let l=!1;const c=a.app={_uid:qi++,_component:t,_props:o,_container:null,_context:a,_instance:null,version:cr,get config(){return a.config},set config(u){},use(u,...d){return i.has(u)||(u&&N(u.install)?(i.add(u),u.install(c,...d)):N(u)&&(i.add(u),u(c,...d))),c},mixin(u){return a.mixins.includes(u)||a.mixins.push(u),c},component(u,d){return d?(a.components[u]=d,c):a.components[u]},directive(u,d){return d?(a.directives[u]=d,c):a.directives[u]},mount(u,d,y){if(!l){const w=ce(t,o);return w.appContext=a,y===!0?y="svg":y===!1&&(y=void 0),d&&s?s(w,u):e(w,u,y),l=!0,c._container=u,u.__vue_app__=c,st(w.component)||w.component.proxy}},unmount(){l&&(e(null,c._container),delete c._container.__vue_app__)},provide(u,d){return a.provides[u]=d,c},runWithContext(u){Ks=c;try{return u()}finally{Ks=null}}};return c}}let Ks=null;function zi(e,s){if(oe){let n=oe.provides;const t=oe.parent&&oe.parent.provides;t===n&&(n=oe.provides=Object.create(t)),n[e]=s}}function Xs(e,s,n=!1){const t=oe||je;if(t||Ks){const o=t?t.parent==null?t.vnode.appContext&&t.vnode.appContext.provides:t.parent.provides:Ks._context.provides;if(o&&e in o)return o[e];if(arguments.length>1)return n&&N(s)?s.call(t&&t.proxy):s}}function Ei(e,s,n,t=!1){const o={},a={};Os(a,sn,1),e.propsDefaults=Object.create(null),bo(e,s,o,a);for(const i in e.propsOptions[0])i in o||(o[i]=void 0);n?e.props=t?o:Ya(o):e.type.props?e.props=o:e.props=a,e.attrs=a}function Pi(e,s,n,t){const{props:o,attrs:a,vnode:{patchFlag:i}}=e,l=R(o),[c]=e.propsOptions;let u=!1;if((t||i>0)&&!(i&16)){if(i&8){const d=e.vnode.dynamicProps;for(let y=0;y<d.length;y++){let w=d[y];if(Hs(e.emitsOptions,w))continue;const k=s[w];if(c)if(E(a,w))k!==a[w]&&(a[w]=k,u=!0);else{const P=ke(w);o[P]=Vn(c,l,P,k,e,!1)}else k!==a[w]&&(a[w]=k,u=!0)}}}else{bo(e,s,o,a)&&(u=!0);let d;for(const y in l)(!s||!E(s,y)&&((d=ls(y))===y||!E(s,d)))&&(c?n&&(n[y]!==void 0||n[d]!==void 0)&&(o[y]=Vn(c,l,y,void 0,e,!0)):delete o[y]);if(a!==l)for(const y in a)(!s||!E(s,y))&&(delete a[y],u=!0)}u&&Oe(e,"set","$attrs")}function bo(e,s,n,t){const[o,a]=e.propsOptions;let i=!1,l;if(s)for(let c in s){if(Is(c))continue;const u=s[c];let d;o&&E(o,d=ke(c))?!a||!a.includes(d)?n[d]=u:(l||(l={}))[d]=u:Hs(e.emitsOptions,c)||(!(c in t)||u!==t[c])&&(t[c]=u,i=!0)}if(a){const c=R(n),u=l||W;for(let d=0;d<a.length;d++){const y=a[d];n[y]=Vn(o,c,y,u[y],e,!E(u,y))}}return i}function Vn(e,s,n,t,o,a){const i=e[n];if(i!=null){const l=E(i,"default");if(l&&t===void 0){const c=i.default;if(i.type!==Function&&!i.skipFactory&&N(c)){const{propsDefaults:u}=o;if(n in u)t=u[n];else{const d=Ss(o);t=u[n]=c.call(null,s),d()}}else t=c}i[0]&&(a&&!l?t=!1:i[1]&&(t===""||t===ls(n))&&(t=!0))}return t}function jo(e,s,n=!1){const t=s.propsCache,o=t.get(e);if(o)return o;const a=e.props,i={},l=[];let c=!1;if(!N(e)){const d=y=>{c=!0;const[w,k]=jo(y,s,!0);ee(i,w),k&&l.push(...k)};!n&&s.mixins.length&&s.mixins.forEach(d),e.extends&&d(e.extends),e.mixins&&e.mixins.forEach(d)}if(!a&&!c)return B(e)&&t.set(e,as),as;if(x(a))for(let d=0;d<a.length;d++){const y=ke(a[d]);wo(y)&&(i[y]=W)}else if(a)for(const d in a){const y=ke(d);if(wo(y)){const w=a[d],k=i[y]=x(w)||N(w)?{type:w}:ee({},w);if(k){const P=So(Boolean,k.type),D=So(String,k.type);k[0]=P>-1,k[1]=D<0||P<D,(P>-1||E(k,"default"))&&l.push(y)}}}const u=[i,l];return B(e)&&t.set(e,u),u}function wo(e){return e[0]!=="$"}function vo(e){const s=e&&e.toString().match(/^\s*(function|class) (\w+)/);return s?s[2]:e===null?"null":""}function Jo(e,s){return vo(e)===vo(s)}function So(e,s){return x(s)?s.findIndex(n=>Jo(n,e)):N(s)&&Jo(s,e)?0:-1}const _o=e=>e[0]==="_"||e==="$stable",$n=e=>x(e)?e.map(De):[De(e)],Ci=(e,s,n)=>{if(s._n)return s;const t=Kt((...o)=>$n(s(...o)),n);return t._c=!1,t},To=(e,s,n)=>{const t=e._ctx;for(const o in e){if(_o(o))continue;const a=e[o];if(N(a))s[o]=Ci(o,a,t);else if(a!=null){const i=$n(a);s[o]=()=>i}}},ko=(e,s)=>{const n=$n(s);e.slots.default=()=>n},Ri=(e,s)=>{if(e.vnode.shapeFlag&32){const n=s._;n?(e.slots=R(s),Os(s,"_",n)):To(s,e.slots={})}else e.slots={},s&&ko(e,s);Os(e.slots,sn,1)},Fi=(e,s,n)=>{const{vnode:t,slots:o}=e;let a=!0,i=W;if(t.shapeFlag&32){const l=s._;l?n&&l===1?a=!1:(ee(o,s),!n&&l===1&&delete o._):(a=!s.$stable,To(s,o)),i=s}else s&&(ko(e,s),i={default:1});if(a)for(const l in o)!_o(l)&&i[l]==null&&delete o[l]};function Gn(e,s,n,t,o=!1){if(x(e)){e.forEach((w,k)=>Gn(w,s&&(x(s)?s[k]:s),n,t,o));return}if(Ws(t)&&!o)return;const a=t.shapeFlag&4?st(t.component)||t.component.proxy:t.el,i=o?null:a,{i:l,r:c}=e,u=s&&s.r,d=l.refs===W?l.refs={}:l.refs,y=l.setupState;if(u!=null&&u!==c&&(Q(u)?(d[u]=null,E(y,u)&&(y[u]=null)):de(u)&&(u.value=null)),N(c))ze(c,l,12,[i,d]);else{const w=Q(c),k=de(c);if(w||k){const P=()=>{if(e.f){const D=w?E(y,c)?y[c]:d[c]:c.value;o?x(D)&&dn(D,a):x(D)?D.includes(a)||D.push(a):w?(d[c]=[a],E(y,c)&&(y[c]=d[c])):(c.value=[a],e.k&&(d[e.k]=c.value))}else w?(d[c]=i,E(y,c)&&(y[c]=i)):k&&(c.value=i,e.k&&(d[e.k]=i))};i?(P.id=-1,he(P,n)):P()}}}const he=pi;function Mi(e){return Yi(e)}function Yi(e,s){const n=ft();n.__VUE__=!0;const{insert:t,remove:o,patchProp:a,createElement:i,createText:l,createComment:c,setText:u,setElementText:d,parentNode:y,nextSibling:w,setScopeId:k=ye,insertStaticContent:P}=e,D=(r,p,h,m=null,f=null,j=null,J=void 0,b=null,v=!!p.dynamicChildren)=>{if(r===p)return;r&&!es(r,p)&&(m=cn(r),Ne(r,f,j,!0),r=null),p.patchFlag===-2&&(v=!1,p.dynamicChildren=null);const{type:g,ref:S,shapeFlag:A}=p;switch(g){case Zs:U(r,p,h,m);break;case Se:M(r,p,h,m);break;case Qs:r==null&&ae(p,h,m,J);break;case ve:_(r,p,h,m,f,j,J,b,v);break;default:A&1?X(r,p,h,m,f,j,J,b,v):A&6?G(r,p,h,m,f,j,J,b,v):(A&64||A&128)&&g.process(r,p,h,m,f,j,J,b,v,ds)}S!=null&&f&&Gn(S,r&&r.ref,j,p||r,!p)},U=(r,p,h,m)=>{if(r==null)t(p.el=l(p.children),h,m);else{const f=p.el=r.el;p.children!==r.children&&u(f,p.children)}},M=(r,p,h,m)=>{r==null?t(p.el=c(p.children||""),h,m):p.el=r.el},ae=(r,p,h,m)=>{[r.el,r.anchor]=P(r.children,p,h,m,r.el,r.anchor)},C=({el:r,anchor:p},h,m)=>{let f;for(;r&&r!==p;)f=w(r),t(r,h,m),r=f;t(p,h,m)},Y=({el:r,anchor:p})=>{let h;for(;r&&r!==p;)h=w(r),o(r),r=h;o(p)},X=(r,p,h,m,f,j,J,b,v)=>{p.type==="svg"?J="svg":p.type==="math"&&(J="mathml"),r==null?O(p,h,m,f,j,J,b,v):Z(r,p,f,j,J,b,v)},O=(r,p,h,m,f,j,J,b)=>{let v,g;const{props:S,shapeFlag:A,transition:T,dirs:I}=r;if(v=r.el=i(r.type,j,S&&S.is,S),A&8?d(v,r.children):A&16&&q(r.children,v,null,m,f,Kn(r,j),J,b),I&&Ze(r,null,m,"created"),pe(v,r,r.scopeId,J,m),S){for(const F in S)F!=="value"&&!Is(F)&&a(v,F,null,S[F],j,r.children,m,f,Pe);"value"in S&&a(v,"value",null,S.value,j),(g=S.onVnodeBeforeMount)&&Ie(g,m,r)}I&&Ze(r,null,m,"beforeMount");const z=Hi(f,T);z&&T.beforeEnter(v),t(v,p,h),((g=S&&S.onVnodeMounted)||z||I)&&he(()=>{g&&Ie(g,m,r),z&&T.enter(v),I&&Ze(r,null,m,"mounted")},f)},pe=(r,p,h,m,f)=>{if(h&&k(r,h),m)for(let j=0;j<m.length;j++)k(r,m[j]);if(f){let j=f.subTree;if(p===j){const J=f.vnode;pe(r,J,J.scopeId,J.slotScopeIds,f.parent)}}},q=(r,p,h,m,f,j,J,b,v=0)=>{for(let g=v;g<r.length;g++){const S=r[g]=b?Ue(r[g]):De(r[g]);D(null,S,p,h,m,f,j,J,b)}},Z=(r,p,h,m,f,j,J)=>{const b=p.el=r.el;let{patchFlag:v,dynamicChildren:g,dirs:S}=p;v|=r.patchFlag&16;const A=r.props||W,T=p.props||W;let I;if(h&&Qe(h,!1),(I=T.onVnodeBeforeUpdate)&&Ie(I,h,p,r),S&&Ze(p,r,h,"beforeUpdate"),h&&Qe(h,!0),g?L(r.dynamicChildren,g,b,h,m,Kn(p,f),j):J||H(r,p,b,null,h,m,Kn(p,f),j,!1),v>0){if(v&16)re(b,p,A,T,h,m,f);else if(v&2&&A.class!==T.class&&a(b,"class",null,T.class,f),v&4&&a(b,"style",A.style,T.style,f),v&8){const z=p.dynamicProps;for(let F=0;F<z.length;F++){const V=z[F],te=A[V],Te=T[V];(Te!==te||V==="value")&&a(b,V,te,Te,f,r.children,h,m,Pe)}}v&1&&r.children!==p.children&&d(b,p.children)}else!J&&g==null&&re(b,p,A,T,h,m,f);((I=T.onVnodeUpdated)||S)&&he(()=>{I&&Ie(I,h,p,r),S&&Ze(p,r,h,"updated")},m)},L=(r,p,h,m,f,j,J)=>{for(let b=0;b<p.length;b++){const v=r[b],g=p[b],S=v.el&&(v.type===ve||!es(v,g)||v.shapeFlag&70)?y(v.el):h;D(v,g,S,null,m,f,j,J,!0)}},re=(r,p,h,m,f,j,J)=>{if(h!==m){if(h!==W)for(const b in h)!Is(b)&&!(b in m)&&a(r,b,h[b],null,J,p.children,f,j,Pe);for(const b in m){if(Is(b))continue;const v=m[b],g=h[b];v!==g&&b!=="value"&&a(r,b,g,v,J,p.children,f,j,Pe)}"value"in m&&a(r,"value",h.value,m.value,J)}},_=(r,p,h,m,f,j,J,b,v)=>{const g=p.el=r?r.el:l(""),S=p.anchor=r?r.anchor:l("");let{patchFlag:A,dynamicChildren:T,slotScopeIds:I}=p;I&&(b=b?b.concat(I):I),r==null?(t(g,h,m),t(S,h,m),q(p.children||[],h,S,f,j,J,b,v)):A>0&&A&64&&T&&r.dynamicChildren?(L(r.dynamicChildren,T,h,f,j,J,b),(p.key!=null||f&&p===f.subTree)&&Ao(r,p,!0)):H(r,p,h,S,f,j,J,b,v)},G=(r,p,h,m,f,j,J,b,v)=>{p.slotScopeIds=b,r==null?p.shapeFlag&512?f.ctx.activate(p,h,m,J,v):fe(p,h,m,f,j,J,v):ks(r,p,v)},fe=(r,p,h,m,f,j,J)=>{const b=r.component=Zi(r,m,f);if(Vs(r)&&(b.ctx.renderer=ds),er(b),b.asyncDep){if(f&&f.registerDep(b,ne),!r.el){const v=b.subTree=ce(Se);M(null,v,p,h)}}else ne(b,r,p,h,f,j,J)},ks=(r,p,h)=>{const m=p.component=r.component;if(ai(r,p,h))if(m.asyncDep&&!m.asyncResolved){K(m,p,h);return}else m.next=p,Qa(m.update),m.effect.dirty=!0,m.update();else p.el=r.el,m.vnode=p},ne=(r,p,h,m,f,j,J)=>{const b=()=>{if(r.isMounted){let{next:S,bu:A,u:T,parent:I,vnode:z}=r;{const hs=xo(r);if(hs){S&&(S.el=z.el,K(r,S,J)),hs.asyncDep.then(()=>{r.isUnmounted||b()});return}}let F=S,V;Qe(r,!1),S?(S.el=z.el,K(r,S,J)):S=z,A&&fn(A),(V=S.props&&S.props.onVnodeBeforeUpdate)&&Ie(V,I,S,z),Qe(r,!0);const te=En(r),Te=r.subTree;r.subTree=te,D(Te,te,y(Te.el),cn(Te),r,f,j),S.el=te.el,F===null&&ii(r,te.el),T&&he(T,f),(V=S.props&&S.props.onVnodeUpdated)&&he(()=>Ie(V,I,S,z),f)}else{let S;const{el:A,props:T}=p,{bm:I,m:z,parent:F}=r,V=Ws(p);if(Qe(r,!1),I&&fn(I),!V&&(S=T&&T.onVnodeBeforeMount)&&Ie(S,F,p),Qe(r,!0),A&&ct){const te=()=>{r.subTree=En(r),ct(A,r.subTree,r,f,null)};V?p.type.__asyncLoader().then(()=>!r.isUnmounted&&te()):te()}else{const te=r.subTree=En(r);D(null,te,h,m,r,f,j),p.el=te.el}if(z&&he(z,f),!V&&(S=T&&T.onVnodeMounted)){const te=p;he(()=>Ie(S,F,te),f)}(p.shapeFlag&256||F&&Ws(F.vnode)&&F.vnode.shapeFlag&256)&&r.a&&he(r.a,f),r.isMounted=!0,p=h=m=null}},v=r.effect=new bn(b,ye,()=>zn(g),r.scope),g=r.update=()=>{v.dirty&&v.run()};g.id=r.uid,Qe(r,!0),g()},K=(r,p,h)=>{p.component=r;const m=r.vnode.props;r.vnode=p,r.next=null,Pi(r,p.props,m,h),Fi(r,p.children,h),Re(),Lt(r),Fe()},H=(r,p,h,m,f,j,J,b,v=!1)=>{const g=r&&r.children,S=r?r.shapeFlag:0,A=p.children,{patchFlag:T,shapeFlag:I}=p;if(T>0){if(T&128){ln(g,A,h,m,f,j,J,b,v);return}else if(T&256){ts(g,A,h,m,f,j,J,b,v);return}}I&8?(S&16&&Pe(g,f,j),A!==g&&d(h,A)):S&16?I&16?ln(g,A,h,m,f,j,J,b,v):Pe(g,f,j,!0):(S&8&&d(h,""),I&16&&q(A,h,m,f,j,J,b,v))},ts=(r,p,h,m,f,j,J,b,v)=>{r=r||as,p=p||as;const g=r.length,S=p.length,A=Math.min(g,S);let T;for(T=0;T<A;T++){const I=p[T]=v?Ue(p[T]):De(p[T]);D(r[T],I,h,null,f,j,J,b,v)}g>S?Pe(r,f,j,!0,!1,A):q(p,h,m,f,j,J,b,v,A)},ln=(r,p,h,m,f,j,J,b,v)=>{let g=0;const S=p.length;let A=r.length-1,T=S-1;for(;g<=A&&g<=T;){const I=r[g],z=p[g]=v?Ue(p[g]):De(p[g]);if(es(I,z))D(I,z,h,null,f,j,J,b,v);else break;g++}for(;g<=A&&g<=T;){const I=r[A],z=p[T]=v?Ue(p[T]):De(p[T]);if(es(I,z))D(I,z,h,null,f,j,J,b,v);else break;A--,T--}if(g>A){if(g<=T){const I=T+1,z=I<S?p[I].el:m;for(;g<=T;)D(null,p[g]=v?Ue(p[g]):De(p[g]),h,z,f,j,J,b,v),g++}}else if(g>T)for(;g<=A;)Ne(r[g],f,j,!0),g++;else{const I=g,z=g,F=new Map;for(g=z;g<=T;g++){const ge=p[g]=v?Ue(p[g]):De(p[g]);ge.key!=null&&F.set(ge.key,g)}let V,te=0;const Te=T-z+1;let hs=!1,ta=0;const As=new Array(Te);for(g=0;g<Te;g++)As[g]=0;for(g=I;g<=A;g++){const ge=r[g];if(te>=Te){Ne(ge,f,j,!0);continue}let qe;if(ge.key!=null)qe=F.get(ge.key);else for(V=z;V<=T;V++)if(As[V-z]===0&&es(ge,p[V])){qe=V;break}qe===void 0?Ne(ge,f,j,!0):(As[qe-z]=g+1,qe>=ta?ta=qe:hs=!0,D(ge,p[qe],h,null,f,j,J,b,v),te++)}const oa=hs?Bi(As):as;for(V=oa.length-1,g=Te-1;g>=0;g--){const ge=z+g,qe=p[ge],aa=ge+1<S?p[ge+1].el:m;As[g]===0?D(null,qe,h,aa,f,j,J,b,v):hs&&(V<0||g!==oa[V]?os(qe,h,aa,2):V--)}}},os=(r,p,h,m,f=null)=>{const{el:j,type:J,transition:b,children:v,shapeFlag:g}=r;if(g&6){os(r.component.subTree,p,h,m);return}if(g&128){r.suspense.move(p,h,m);return}if(g&64){J.move(r,p,h,ds);return}if(J===ve){t(j,p,h);for(let A=0;A<v.length;A++)os(v[A],p,h,m);t(r.anchor,p,h);return}if(J===Qs){C(r,p,h);return}if(m!==2&&g&1&&b)if(m===0)b.beforeEnter(j),t(j,p,h),he(()=>b.enter(j),f);else{const{leave:A,delayLeave:T,afterLeave:I}=b,z=()=>t(j,p,h),F=()=>{A(j,()=>{z(),I&&I()})};T?T(j,z,F):F()}else t(j,p,h)},Ne=(r,p,h,m=!1,f=!1)=>{const{type:j,props:J,ref:b,children:v,dynamicChildren:g,shapeFlag:S,patchFlag:A,dirs:T}=r;if(b!=null&&Gn(b,null,h,r,!0),S&256){p.ctx.deactivate(r);return}const I=S&1&&T,z=!Ws(r);let F;if(z&&(F=J&&J.onVnodeBeforeUnmount)&&Ie(F,p,r),S&6)vl(r.component,h,m);else{if(S&128){r.suspense.unmount(h,m);return}I&&Ze(r,null,p,"beforeUnmount"),S&64?r.type.remove(r,p,h,f,ds,m):g&&(j!==ve||A>0&&A&64)?Pe(g,p,h,!1,!0):(j===ve&&A&384||!f&&S&16)&&Pe(v,p,h),m&&sa(r)}(z&&(F=J&&J.onVnodeUnmounted)||I)&&he(()=>{F&&Ie(F,p,r),I&&Ze(r,null,p,"unmounted")},h)},sa=r=>{const{type:p,el:h,anchor:m,transition:f}=r;if(p===ve){wl(h,m);return}if(p===Qs){Y(r);return}const j=()=>{o(h),f&&!f.persisted&&f.afterLeave&&f.afterLeave()};if(r.shapeFlag&1&&f&&!f.persisted){const{leave:J,delayLeave:b}=f,v=()=>J(h,j);b?b(r.el,j,v):v()}else j()},wl=(r,p)=>{let h;for(;r!==p;)h=w(r),o(r),r=h;o(p)},vl=(r,p,h)=>{const{bum:m,scope:f,update:j,subTree:J,um:b}=r;m&&fn(m),f.stop(),j&&(j.active=!1,Ne(J,r,p,h)),b&&he(b,p),he(()=>{r.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&r.asyncDep&&!r.asyncResolved&&r.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},Pe=(r,p,h,m=!1,f=!1,j=0)=>{for(let J=j;J<r.length;J++)Ne(r[J],p,h,m,f)},cn=r=>r.shapeFlag&6?cn(r.component.subTree):r.shapeFlag&128?r.suspense.next():w(r.anchor||r.el);let rt=!1;const na=(r,p,h)=>{r==null?p._vnode&&Ne(p._vnode,null,null,!0):D(p._vnode||null,r,p,null,null,null,h),rt||(rt=!0,Lt(),Wt(),rt=!1),p._vnode=r},ds={p:D,um:Ne,m:os,r:sa,mt:fe,mc:q,pc:H,pbc:L,n:cn,o:e};let lt,ct;return s&&([lt,ct]=s(ds)),{render:na,hydrate:lt,createApp:Oi(na,lt)}}function Kn({type:e,props:s},n){return n==="svg"&&e==="foreignObject"||n==="mathml"&&e==="annotation-xml"&&s&&s.encoding&&s.encoding.includes("html")?void 0:n}function Qe({effect:e,update:s},n){e.allowRecurse=s.allowRecurse=n}function Hi(e,s){return(!e||e&&!e.pendingBranch)&&s&&!s.persisted}function Ao(e,s,n=!1){const t=e.children,o=s.children;if(x(t)&&x(o))for(let a=0;a<t.length;a++){const i=t[a];let l=o[a];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=o[a]=Ue(o[a]),l.el=i.el),n||Ao(i,l)),l.type===Zs&&(l.el=i.el)}}function Bi(e){const s=e.slice(),n=[0];let t,o,a,i,l;const c=e.length;for(t=0;t<c;t++){const u=e[t];if(u!==0){if(o=n[n.length-1],e[o]<u){s[t]=o,n.push(t);continue}for(a=0,i=n.length-1;a<i;)l=a+i>>1,e[n[l]]<u?a=l+1:i=l;u<e[n[a]]&&(a>0&&(s[t]=n[a-1]),n[a]=t)}}for(a=n.length,i=n[a-1];a-- >0;)n[a]=i,i=s[i];return n}function xo(e){const s=e.subTree.component;if(s)return s.asyncDep&&!s.asyncResolved?s:xo(s)}const Ui=e=>e.__isTeleport,ve=Symbol.for("v-fgt"),Zs=Symbol.for("v-txt"),Se=Symbol.for("v-cmt"),Qs=Symbol.for("v-stc"),vs=[];let _e=null;function me(e=!1){vs.push(_e=e?null:[])}function Li(){vs.pop(),_e=vs[vs.length-1]||null}let Js=1;function Do(e){Js+=e}function Io(e){return e.dynamicChildren=Js>0?_e||as:null,Li(),Js>0&&_e&&_e.push(e),e}function xe(e,s,n,t,o,a){return Io(se(e,s,n,t,o,a,!0))}function en(e,s,n,t,o){return Io(ce(e,s,n,t,o,!0))}function Xn(e){return e?e.__v_isVNode===!0:!1}function es(e,s){return e.type===s.type&&e.key===s.key}const sn="__vInternal",No=({key:e})=>e??null,nn=({ref:e,ref_key:s,ref_for:n})=>(typeof e=="number"&&(e=""+e),e!=null?Q(e)||de(e)||N(e)?{i:je,r:e,k:s,f:!!n}:e:null);function se(e,s=null,n=null,t=0,o=null,a=e===ve?0:1,i=!1,l=!1){const c={__v_isVNode:!0,__v_skip:!0,type:e,props:s,key:s&&No(s),ref:s&&nn(s),scopeId:Gt,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:a,patchFlag:t,dynamicProps:o,dynamicChildren:null,appContext:null,ctx:je};return l?(Qn(c,n),a&128&&e.normalize(c)):n&&(c.shapeFlag|=Q(n)?8:16),Js>0&&!i&&_e&&(c.patchFlag>0||a&6)&&c.patchFlag!==32&&_e.push(c),c}const ce=Wi;function Wi(e,s=null,n=null,t=0,o=null,a=!1){if((!e||e===ri)&&(e=Se),Xn(e)){const l=Be(e,s,!0);return n&&Qn(l,n),Js>0&&!a&&_e&&(l.shapeFlag&6?_e[_e.indexOf(e)]=l:_e.push(l)),l.patchFlag|=-2,l}if(ir(e)&&(e=e.__vccOpts),s){s=Vi(s);let{class:l,style:c}=s;l&&!Q(l)&&(s.class=ms(l)),B(c)&&(Ct(c)&&!x(c)&&(c=ee({},c)),s.style=gn(c))}const i=Q(e)?1:ci(e)?128:Ui(e)?64:B(e)?4:N(e)?2:0;return se(e,s,n,t,o,i,a,!0)}function Vi(e){return e?Ct(e)||sn in e?ee({},e):e:null}function Be(e,s,n=!1){const{props:t,ref:o,patchFlag:a,children:i}=e,l=s?Gi(t||{},s):t;return{__v_isVNode:!0,__v_skip:!0,type:e.type,props:l,key:l&&No(l),ref:s&&s.ref?n&&o?x(o)?o.concat(nn(s)):[o,nn(s)]:nn(s):o,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:i,target:e.target,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:s&&e.type!==ve?a===-1?16:a|16:a,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:e.transition,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Be(e.ssContent),ssFallback:e.ssFallback&&Be(e.ssFallback),el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce}}function tn(e=" ",s=0){return ce(Zs,null,e,s)}function $i(e,s){const n=ce(Qs,null,e);return n.staticCount=s,n}function Zn(e="",s=!1){return s?(me(),en(Se,null,e)):ce(Se,null,e)}function De(e){return e==null||typeof e=="boolean"?ce(Se):x(e)?ce(ve,null,e.slice()):typeof e=="object"?Ue(e):ce(Zs,null,String(e))}function Ue(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Be(e)}function Qn(e,s){let n=0;const{shapeFlag:t}=e;if(s==null)s=null;else if(x(s))n=16;else if(typeof s=="object")if(t&65){const o=s.default;o&&(o._c&&(o._d=!1),Qn(e,o()),o._c&&(o._d=!0));return}else{n=32;const o=s._;!o&&!(sn in s)?s._ctx=je:o===3&&je&&(je.slots._===1?s._=1:(s._=2,e.patchFlag|=1024))}else N(s)?(s={default:s,_ctx:je},n=32):(s=String(s),t&64?(n=16,s=[tn(s)]):n=8);e.children=s,e.shapeFlag|=n}function Gi(...e){const s={};for(let n=0;n<e.length;n++){const t=e[n];for(const o in t)if(o==="class")s.class!==t.class&&(s.class=ms([s.class,t.class]));else if(o==="style")s.style=gn([s.style,t.style]);else if(xs(o)){const a=s[o],i=t[o];i&&a!==i&&!(x(a)&&a.includes(i))&&(s[o]=a?[].concat(a,i):i)}else o!==""&&(s[o]=t[o])}return s}function Ie(e,s,n,t=null){be(e,s,7,[n,t])}const Ki=yo();let Xi=0;function Zi(e,s,n){const t=e.type,o=(s?s.appContext:e.appContext)||Ki,a={uid:Xi++,vnode:e,type:t,parent:s,appContext:o,root:null,next:null,subTree:null,effect:null,update:null,scope:new ja(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:s?s.provides:Object.create(o.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:jo(t,o),emitsOptions:$t(t,o),emit:null,emitted:null,propsDefaults:W,inheritAttrs:t.inheritAttrs,ctx:W,data:W,props:W,attrs:W,slots:W,refs:W,setupState:W,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return a.ctx={_:a},a.root=s?s.root:a,a.emit=ni.bind(null,a),e.ce&&e.ce(a),a}let oe=null;const Qi=()=>oe||je;let on,et;{const e=ft(),s=(n,t)=>{let o;return(o=e[n])||(o=e[n]=[]),o.push(t),a=>{o.length>1?o.forEach(i=>i(a)):o[0](a)}};on=s("__VUE_INSTANCE_SETTERS__",n=>oe=n),et=s("__VUE_SSR_SETTERS__",n=>an=n)}const Ss=e=>{const s=oe;return on(e),e.scope.on(),()=>{e.scope.off(),on(s)}},qo=()=>{oe&&oe.scope.off(),on(null)};function Oo(e){return e.vnode.shapeFlag&4}let an=!1;function er(e,s=!1){s&&et(s);const{props:n,children:t}=e.vnode,o=Oo(e);Ei(e,n,o,s),Ri(e,t);const a=o?sr(e,s):void 0;return s&&et(!1),a}function sr(e,s){const n=e.type;e.accessCache=Object.create(null),e.proxy=Rt(new Proxy(e.ctx,ki));const{setup:t}=n;if(t){const o=e.setupContext=t.length>1?tr(e):null,a=Ss(e);Re();const i=ze(t,e,0,[e.props,o]);if(Fe(),a(),ut(i)){if(i.then(qo,qo),s)return i.then(l=>{zo(e,l,s)}).catch(l=>{Ys(l,e,0)});e.asyncDep=i}else zo(e,i,s)}else Po(e,s)}function zo(e,s,n){N(s)?e.type.__ssrInlineRender?e.ssrRender=s:e.render=s:B(s)&&(e.setupState=Yt(s)),Po(e,n)}let Eo;function Po(e,s,n){const t=e.type;if(!e.render){if(!s&&Eo&&!t.render){const o=t.template||Ln(e).template;if(o){const{isCustomElement:a,compilerOptions:i}=e.appContext.config,{delimiters:l,compilerOptions:c}=t,u=ee(ee({isCustomElement:a,delimiters:l},i),c);t.render=Eo(o,u)}}e.render=t.render||ye}{const o=Ss(e);Re();try{Ai(e)}finally{Fe(),o()}}}function nr(e){return e.attrsProxy||(e.attrsProxy=new Proxy(e.attrs,{get(s,n){return ue(e,"get","$attrs"),s[n]}}))}function tr(e){const s=n=>{e.exposed=n||{}};return{get attrs(){return nr(e)},slots:e.slots,emit:e.emit,expose:s}}function st(e){if(e.exposed)return e.exposeProxy||(e.exposeProxy=new Proxy(Yt(Rt(e.exposed)),{get(s,n){if(n in s)return s[n];if(n in js)return js[n](e)},has(s,n){return n in s||n in js}}))}const or=/(?:^|[-_])(\w)/g,ar=e=>e.replace(or,s=>s.toUpperCase()).replace(/[-_]/g,"");function Co(e,s=!0){return N(e)?e.displayName||e.name:e.name||s&&e.__name}function Ro(e,s,n=!1){let t=Co(s);if(!t&&s.__file){const o=s.__file.match(/([^/\\]+)\.\w+$/);o&&(t=o[1])}if(!t&&e&&e.parent){const o=a=>{for(const i in a)if(a[i]===s)return i};t=o(e.components||e.parent.type.components)||o(e.appContext.components)}return t?ar(t):n?"App":"Anonymous"}function ir(e){return N(e)&&"__vccOpts"in e}const rr=(e,s)=>Ha(e,s,an);function lr(e,s,n){const t=arguments.length;return t===2?B(s)&&!x(s)?Xn(s)?ce(e,null,[s]):ce(e,s):ce(e,null,s):(t>3?n=Array.prototype.slice.call(arguments,2):t===3&&Xn(n)&&(n=[n]),ce(e,s,n))}const cr="3.4.9";/**
* @vue/runtime-dom v3.4.9
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const pr="http://www.w3.org/2000/svg",ur="http://www.w3.org/1998/Math/MathML",Le=typeof document<"u"?document:null,Fo=Le&&Le.createElement("template"),dr={insert:(e,s,n)=>{s.insertBefore(e,n||null)},remove:e=>{const s=e.parentNode;s&&s.removeChild(e)},createElement:(e,s,n,t)=>{const o=s==="svg"?Le.createElementNS(pr,e):s==="mathml"?Le.createElementNS(ur,e):Le.createElement(e,n?{is:n}:void 0);return e==="select"&&t&&t.multiple!=null&&o.setAttribute("multiple",t.multiple),o},createText:e=>Le.createTextNode(e),createComment:e=>Le.createComment(e),setText:(e,s)=>{e.nodeValue=s},setElementText:(e,s)=>{e.textContent=s},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Le.querySelector(e),setScopeId(e,s){e.setAttribute(s,"")},insertStaticContent(e,s,n,t,o,a){const i=n?n.previousSibling:s.lastChild;if(o&&(o===a||o.nextSibling))for(;s.insertBefore(o.cloneNode(!0),n),!(o===a||!(o=o.nextSibling)););else{Fo.innerHTML=t==="svg"?`<svg>${e}</svg>`:t==="mathml"?`<math>${e}</math>`:e;const l=Fo.content;if(t==="svg"||t==="mathml"){const c=l.firstChild;for(;c.firstChild;)l.appendChild(c.firstChild);l.removeChild(c)}s.insertBefore(l,n)}return[i?i.nextSibling:s.firstChild,n?n.previousSibling:s.lastChild]}},We="transition",_s="animation",Ts=Symbol("_vtc"),nt=(e,{slots:s})=>lr(fi,hr(e),s);nt.displayName="Transition";const Mo={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};nt.props=ee({},no,Mo);const ss=(e,s=[])=>{x(e)?e.forEach(n=>n(...s)):e&&e(...s)},Yo=e=>e?x(e)?e.some(s=>s.length>1):e.length>1:!1;function hr(e){const s={};for(const _ in e)_ in Mo||(s[_]=e[_]);if(e.css===!1)return s;const{name:n="v",type:t,duration:o,enterFromClass:a=`${n}-enter-from`,enterActiveClass:i=`${n}-enter-active`,enterToClass:l=`${n}-enter-to`,appearFromClass:c=a,appearActiveClass:u=i,appearToClass:d=l,leaveFromClass:y=`${n}-leave-from`,leaveActiveClass:w=`${n}-leave-active`,leaveToClass:k=`${n}-leave-to`}=e,P=mr(o),D=P&&P[0],U=P&&P[1],{onBeforeEnter:M,onEnter:ae,onEnterCancelled:C,onLeave:Y,onLeaveCancelled:X,onBeforeAppear:O=M,onAppear:pe=ae,onAppearCancelled:q=C}=s,Z=(_,G,fe)=>{ns(_,G?d:l),ns(_,G?u:i),fe&&fe()},L=(_,G)=>{_._isLeaving=!1,ns(_,y),ns(_,k),ns(_,w),G&&G()},re=_=>(G,fe)=>{const ks=_?pe:ae,ne=()=>Z(G,_,fe);ss(ks,[G,ne]),Ho(()=>{ns(G,_?c:a),Ve(G,_?d:l),Yo(ks)||Bo(G,t,D,ne)})};return ee(s,{onBeforeEnter(_){ss(M,[_]),Ve(_,a),Ve(_,i)},onBeforeAppear(_){ss(O,[_]),Ve(_,c),Ve(_,u)},onEnter:re(!1),onAppear:re(!0),onLeave(_,G){_._isLeaving=!0;const fe=()=>L(_,G);Ve(_,y),yr(),Ve(_,w),Ho(()=>{_._isLeaving&&(ns(_,y),Ve(_,k),Yo(Y)||Bo(_,t,U,fe))}),ss(Y,[_,fe])},onEnterCancelled(_){Z(_,!1),ss(C,[_])},onAppearCancelled(_){Z(_,!0),ss(q,[_])},onLeaveCancelled(_){L(_),ss(X,[_])}})}function mr(e){if(e==null)return null;if(B(e))return[tt(e.enter),tt(e.leave)];{const s=tt(e);return[s,s]}}function tt(e){return da(e)}function Ve(e,s){s.split(/\s+/).forEach(n=>n&&e.classList.add(n)),(e[Ts]||(e[Ts]=new Set)).add(s)}function ns(e,s){s.split(/\s+/).forEach(t=>t&&e.classList.remove(t));const n=e[Ts];n&&(n.delete(s),n.size||(e[Ts]=void 0))}function Ho(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let fr=0;function Bo(e,s,n,t){const o=e._endId=++fr,a=()=>{o===e._endId&&t()};if(n)return setTimeout(a,n);const{type:i,timeout:l,propCount:c}=gr(e,s);if(!i)return t();const u=i+"end";let d=0;const y=()=>{e.removeEventListener(u,w),a()},w=k=>{k.target===e&&++d>=c&&y()};setTimeout(()=>{d<c&&y()},l+1),e.addEventListener(u,w)}function gr(e,s){const n=window.getComputedStyle(e),t=P=>(n[P]||"").split(", "),o=t(`${We}Delay`),a=t(`${We}Duration`),i=Uo(o,a),l=t(`${_s}Delay`),c=t(`${_s}Duration`),u=Uo(l,c);let d=null,y=0,w=0;s===We?i>0&&(d=We,y=i,w=a.length):s===_s?u>0&&(d=_s,y=u,w=c.length):(y=Math.max(i,u),d=y>0?i>u?We:_s:null,w=d?d===We?a.length:c.length:0);const k=d===We&&/\b(transform|all)(,|$)/.test(t(`${We}Property`).toString());return{type:d,timeout:y,propCount:w,hasTransform:k}}function Uo(e,s){for(;e.length<s.length;)e=e.concat(e);return Math.max(...s.map((n,t)=>Lo(n)+Lo(e[t])))}function Lo(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function yr(){return document.body.offsetHeight}function br(e,s,n){const t=e[Ts];t&&(s=(s?[s,...t]:[...t]).join(" ")),s==null?e.removeAttribute("class"):n?e.setAttribute("class",s):e.className=s}const jr=Symbol("_vod"),wr=Symbol("");function vr(e,s,n){const t=e.style,o=t.display,a=Q(n);if(n&&!a){if(s&&!Q(s))for(const i in s)n[i]==null&&ot(t,i,"");for(const i in n)ot(t,i,n[i])}else if(a){if(s!==n){const i=t[wr];i&&(n+=";"+i),t.cssText=n}}else s&&e.removeAttribute("style");jr in e&&(t.display=o)}const Wo=/\s*!important$/;function ot(e,s,n){if(x(n))n.forEach(t=>ot(e,s,t));else if(n==null&&(n=""),s.startsWith("--"))e.setProperty(s,n);else{const t=Jr(e,s);Wo.test(n)?e.setProperty(ls(t),n.replace(Wo,""),"important"):e[t]=n}}const Vo=["Webkit","Moz","ms"],at={};function Jr(e,s){const n=at[s];if(n)return n;let t=ke(s);if(t!=="filter"&&t in e)return at[s]=t;t=qs(t);for(let o=0;o<Vo.length;o++){const a=Vo[o]+t;if(a in e)return at[s]=a}return s}const $o="http://www.w3.org/1999/xlink";function Sr(e,s,n,t,o){if(t&&s.startsWith("xlink:"))n==null?e.removeAttributeNS($o,s.slice(6,s.length)):e.setAttributeNS($o,s,n);else{const a=ba(s);n==null||a&&!gt(n)?e.removeAttribute(s):e.setAttribute(s,a?"":n)}}function _r(e,s,n,t,o,a,i){if(s==="innerHTML"||s==="textContent"){t&&i(t,o,a),e[s]=n??"";return}const l=e.tagName;if(s==="value"&&l!=="PROGRESS"&&!l.includes("-")){e._value=n;const u=l==="OPTION"?e.getAttribute("value"):e.value,d=n??"";u!==d&&(e.value=d),n==null&&e.removeAttribute(s);return}let c=!1;if(n===""||n==null){const u=typeof e[s];u==="boolean"?n=gt(n):n==null&&u==="string"?(n="",c=!0):u==="number"&&(n=0,c=!0)}try{e[s]=n}catch{}c&&e.removeAttribute(s)}function Tr(e,s,n,t){e.addEventListener(s,n,t)}function kr(e,s,n,t){e.removeEventListener(s,n,t)}const Go=Symbol("_vei");function Ar(e,s,n,t,o=null){const a=e[Go]||(e[Go]={}),i=a[s];if(t&&i)i.value=t;else{const[l,c]=xr(s);if(t){const u=a[s]=Nr(t,o);Tr(e,l,u,c)}else i&&(kr(e,l,i,c),a[s]=void 0)}}const Ko=/(?:Once|Passive|Capture)$/;function xr(e){let s;if(Ko.test(e)){s={};let t;for(;t=e.match(Ko);)e=e.slice(0,e.length-t[0].length),s[t[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):ls(e.slice(2)),s]}let it=0;const Dr=Promise.resolve(),Ir=()=>it||(Dr.then(()=>it=0),it=Date.now());function Nr(e,s){const n=t=>{if(!t._vts)t._vts=Date.now();else if(t._vts<=n.attached)return;be(qr(t,n.value),s,5,[t])};return n.value=e,n.attached=Ir(),n}function qr(e,s){if(x(s)){const n=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{n.call(e),e._stopped=!0},s.map(t=>o=>!o._stopped&&t&&t(o))}else return s}const Xo=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,Or=(e,s,n,t,o,a,i,l,c)=>{const u=o==="svg";s==="class"?br(e,t,u):s==="style"?vr(e,n,t):xs(s)?un(s)||Ar(e,s,n,t,i):(s[0]==="."?(s=s.slice(1),!0):s[0]==="^"?(s=s.slice(1),!1):zr(e,s,t,u))?_r(e,s,t,a,i,l,c):(s==="true-value"?e._trueValue=t:s==="false-value"&&(e._falseValue=t),Sr(e,s,t,u))};function zr(e,s,n,t){if(t)return!!(s==="innerHTML"||s==="textContent"||s in e&&Xo(s)&&N(n));if(s==="spellcheck"||s==="draggable"||s==="translate"||s==="form"||s==="list"&&e.tagName==="INPUT"||s==="type"&&e.tagName==="TEXTAREA")return!1;if(s==="width"||s==="height"){const o=e.tagName;if(o==="IMG"||o==="VIDEO"||o==="CANVAS"||o==="SOURCE")return!1}return Xo(s)&&Q(n)?!1:s in e}const Er=["ctrl","shift","alt","meta"],Pr={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,s)=>Er.some(n=>e[`${n}Key`]&&!s.includes(n))},Cr=(e,s)=>{const n=e._withMods||(e._withMods={}),t=s.join(".");return n[t]||(n[t]=(o,...a)=>{for(let i=0;i<s.length;i++){const l=Pr[s[i]];if(l&&l(o,s))return}return e(o,...a)})},Rr=ee({patchProp:Or},dr);let Zo;function Fr(){return Zo||(Zo=Mi(Rr))}const Mr=(...e)=>{const s=Fr().createApp(...e),{mount:n}=s;return s.mount=t=>{const o=Hr(t);if(!o)return;const a=s._component;!N(a)&&!a.render&&!a.template&&(a.template=o.innerHTML),o.innerHTML="";const i=n(o,!1,Yr(o));return o instanceof Element&&(o.removeAttribute("v-cloak"),o.setAttribute("data-v-app","")),i},s};function Yr(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function Hr(e){return Q(e)?document.querySelector(e):e}const rn=(e,s)=>{const n=e.__vccOpts||e;for(const[t,o]of s)n[t]=o;return n},Br=Yn({props:{report:{type:String,required:!0}},methods:{createIssue(){const e=new FormData(this.$refs.issueForm),s=e.get("title");let n="";const t=e.get("description");t&&(n+=`**Description**
${t}
...
`,options:[{id:"serialization",page:310,label:"Serialization",summary:"The issue concerns serialization"},{id:"deserialization",page:280,label:"Deserialization",summary:"The issue concerns deserialization"}]},{content:`<p>What is the value of <code>DeserializationError</code>?</p>
`,options:[{id:"ok",page:297,label:"<code>Ok</code>",summary:"`deserializeJson()` returns `Ok`"},{id:"emptyinput",page:286,label:"<code>EmptyInput</code>",summary:"`deserializeJson()` returns `EmptyInput`"},{id:"incompleteinput",page:290,label:"<code>IncompleteInput</code>",summary:"`deserializeJson()` returns `IncompleteInput`"},{id:"invalidinput",page:294,label:"<code>InvalidInput</code>",summary:"`deserializeJson()` returns `InvalidInput`"},{id:"nomemory",page:309,label:"<code>NoMemory</code>",summary:"`deserializeJson()` returns `NoMemory`"},{id:"toodeep",page:214,label:"<code>TooDeep</code>",summary:"`deserializeJson()` returns `TooDeep`"},{id:"crash",page:282,label:"I can't tell because the program crashes",summary:"The program crashes"},{id:"unknown",page:281,label:"I don't know what you're talking about",summary:"The program doesn't check the error"}]},{content:`<p><code>DeserializationError</code> is the return type of <code>deserializeJson()</code>. It tells whether the operation succeeded and indicates the cause of the error.</p>
<p>Modify your program to show the error code, like so:</p>
<pre><code class="hljs language-c++">DeserializationError error = <span class="hljs-built_in">deserializeJson</span>(doc, input);
...
<p>How many traces can you see in the Serial Monitor?</p>
`,options:[{id:"before",page:284,label:"None: program crashes before calling <code>deserializeJson()</code>",summary:"Program crashes before calling `deserializeJson()`"},{id:"inside",page:285,label:"Only one: program crashes inside <code>deserializeJson()</code>",summary:"Program crashes inside `deserializeJson()`"},{id:"after",page:283,label:"Two traces: program crashes after calling <code>deserializeJson()</code>",summary:"Program crashes after calling `deserializeJson()`"}]},{content:`<p>A programs can also crash after calling <code>deserializeJson()</code> because it keeps a pointer to a string stored in the <code>JsonDocument</code>.</p>
<p>Indeed, when <code>JsonDocument</code> returns a <code>const char*</code>, it doesn't return a copy of the string, but the address of the string in the memory pool. When the <code>JsonDocument</code> is destructed, the memory pool gets released and the pointer dangles. Later, when the program tries to use the string, it reads at an invalid memory location and crashes.</p>
<p>For example, it happens with the following program:</p>
<pre><code class="hljs language-c++"><span class="hljs-type">const</span> <span class="hljs-type">char</span>* username;
...
<p>Please review your code to make sure you're not passsing a dangling pointer to <code>deserializeJson()</code>.</p>
<p>Does your program still crash?</p>
`,options:[{id:"no-dangling-ptr",page:284,label:"Yes",summary:"Removing dangling pointers doesn't prevent the crash"},{id:"success",page:2,label:"No",summary:"Removing dangling pointers prevents the crash"}]},{content:`<p><code>EmptyInput</code> means that the input was empty or contained only spaces or comments.</p>
<p>Where does your JSON input come from?</p>
`,options:[{id:"http",page:109,label:"An HTTP response",summary:"Input comes from an HTTP response"},{id:"file",page:287,label:"A file",summary:"Input comes from a file"},{id:"serial",page:289,label:"A serial port",summary:"Input comes from a serial port"},{id:"other",page:114,label:"Something else",summary:"Input comes neither from an HTTP response, nor a file, nor a serial port"}]},{content:`<p><code>EmptyInput</code> in the context of a file usually means:</p>
<ul>
<li>the file is closed</li>
<li>the file is opened in the wrong mode</li>
<li>the file is empty</li>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Adding a wait loop fixes the issue"},{id:"available",page:288,label:"No",summary:"Adding a wait loop doesn't fix the issue"}]},{content:`<p><code>IncompleteInput</code> means that <code>deserializeJson()</code> managed to parse the beginning of the JSON document, but the end was missing.</p>
<p>What type of input do you pass to <code>deserializeJson()</code>?</p>
`,options:[{id:"stream",page:120,label:"A stream",summary:"Input comes from a stream"},{id:"string",page:291,label:"A string object (like <code>String</code>)",summary:"Input comes from a string object"},{id:"pointer",page:292,label:"A pointer (like <code>char*</code> or <code>const char*</code>)",summary:"Input comes from a pointer"}]},{content:`<p>Please print the content of the string to the serial port, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(input);
</code></pre>
<p>You should see that the JSON document is truncated.
This can be caused by a lack of RAM: the string object failed to allocate a buffer large enough for the whole document.</p>
...
<p>Hopefully, you'll be able to reserve a buffer large enough to store the whole string.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:2,label:"Yes",summary:"Calling `String::reserve()` solves the issue"},{id:"1",page:293,label:"No",summary:"Calling `String::reserve()` doesn't solve the issue"}]},{content:`<p>I'll assume that your input is stored in a buffer similar to this one:</p>
<pre><code class="hljs language-c++"><span class="hljs-type">char</span> input[<span class="hljs-number">1024</span>];
<span class="hljs-type">size_t</span> input_size;
</code></pre>
<p>Please print the content of the string to the serial port, like so:</p>
...
<p>Please increase the capacity of the buffer, but remember that the size of the stack is limited so you may need to move your buffer to the heap.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:2,label:"Yes",summary:"Increasing the buffer size solves the issue"},{id:"1",page:293,label:"No",summary:"Increasing the buffer size doesn't solve the issue"}]},{content:`<p>To reduce the memory usage, you should try to pass the source (file, connection, stream, etc) directly to <code>deserializeJson()</code>, either via the <a href="https://www.arduino.cc/reference/en/language/functions/communication/stream/"><code>Stream</code></a> interface or via a <a href="/news/2019/11/01/version-6-13-0/">custom reader</a>. This will avoid the need for an intermediate buffer.</p>
<p>Additionaly, you can add a <a href="/news/2020/03/22/version-6-15-0/">filter</a> to remove all unneeded information from the <code>JsonDocument</code>.</p>
<p>You can see examples here:</p>
<ul>
...
`,options:[{id:"software",page:158,label:"Yes",summary:"Program uses `SoftwareSerial`"},{id:"hardware",page:295,label:"No",summary:"Program doesn't use `SoftwareSerial`"}]},{content:`<p>So, what's the problem then?</p>
`,options:[{id:"slow",page:192,label:"It's slow",summary:"Deserialisation is slow"},{id:"invalid",page:167,label:"I expected <code>InvalidInput</code> instead of <code>Ok</code>",summary:"`Ok` is incorrect; it should be `InvalidInput`"},{id:"crash",page:283,label:"My program crashes after calling <code>deserializeJson()</code>",summary:"Program crashes after calling `deserializeJson()`"},{id:"empty",page:298,label:"<code>JsonDocument</code> returns empty/null values",summary:"Program fails to extract values from the `JsonDocument`"},{id:"truncated-strings",page:193,label:"Some strings are truncated",summary:"Some strings are truncated"}]},{content:`<p>Do you use a filter (with <code>DeserializationOption::Filter</code>)?</p>
`,options:[{id:"filter",page:300,label:"Yes",summary:"Program uses `DeserializationOption::Filter`"},{id:"no-filter",page:305,label:"No",summary:"Program doesn't use `DeserializationOption::Filter`"}]},{content:`<p>When a program fails to extract the values from a <code>JsonDocument</code>, it's often because there is a confusion between arrays and objects.</p>
<p>For example, a common mistake is to write:</p>
<pre><code class="hljs language-c++"><span class="hljs-type">const</span> <span class="hljs-type">char</span>* temperature = doc[<span class="hljs-string">&quot;list&quot;</span>][<span class="hljs-string">&quot;main&quot;</span>][<span class="hljs-string">&quot;temp&quot;</span>];
</code></pre>
<p>instead of</p>
...
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:302,label:"<code>1</code> (or <code>true</code>)",summary:"`filter.overflowed()` returns `true`"},{id:"overflowed-0",page:301,label:"<code>0</code> (or <code>false</code>)",summary:"`filter.overflowed()` returns `false`"}]},{content:`<p>Maybe the filter excludes the part that it should keep. Let's verify that it's doing its job correctly.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Freeing some memory solves the issue."},{id:"failure",page:301,label:"No",summary:"Freeing some memory doesn't solve the issue."}]},{content:`<p>Which function do you call to deserialize the input?</p>
`,options:[{id:"json",page:1,label:"<code>deserializeJson()</code>",summary:"Program calls `deserializeJson()`"},{id:"msgpack",page:304,label:"<code>deserializeMsgPack()</code>",summary:"Program calls `deserializeMsgPack()`"}]},{content:`<p>It seems that your program fed <code>deserializeMsgPack()</code> with garbage input.</p>
<p>Indeed, any byte in the following ranges is a valid one-byte MessagePack document:</p>
<ul>
<li><code>0x00</code>-<code>0x7f</code>: positive fixint</li>
<li><code>0xc0</code>: nil</li>
...
<p>What's the first character?</p>
`,options:[{id:"quote",page:308,label:"A quote (<code>&quot;</code>)",summary:"Serialized document starts with a quote"},{id:"bracket",page:299,label:"A square bracket (<code>[</code>)",summary:"Serialized document starts with a square bracket"},{id:"brace",page:299,label:"A curly brace (<code>{</code>)",summary:"Serialized document starts with a curly brace"},{id:"not-in-list",page:303,label:"None of the above",summary:"Serialized document starts with neither a quote, a bracket, nor a brace."}]},{content:`<p>If you cannot fix the server, you can at least reverse the double serialization (stringification) to get back the original object.</p>
<p>To do this, you must call <code>deserializeJson()</code> twice, like so:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Fixing the server fixes the issue"},{id:"server-ok",page:306,label:"No",summary:"Fixing the server doesn't fix the issue"}]},{content:`<p>If you see a double-quote at the beginning of the JSON input, it means that the whole document is neither an object or an array; it's a string. This happens when the input was incorrectly generated, by serializing (stringifying) to JSON twice.</p>
<p>For example, the following document:</p>
<pre><code class="hljs language-json"><span class="hljs-string">&quot;{\\&quot;hello\\&quot;:\\&quot;world\\&quot;}&quot;</span>
</code></pre>
<p>...is not a JSON <em>object</em> but a <em>string</em>.
...
<p>So, the bug isn't in the Arduino code, but on the other size, most likely a server.</p>
<p>Can you modify the code of the server?</p>
`,options:[{id:"server-fixable",page:307,label:"Yes",summary:"User can modify the server"},{id:"server-unfixable",page:306,label:"No",summary:"User cannot modify the server"}]},{content:`<p>Well, that's very bad news. It seems that your microcontroller doesn't have enough RAM to hold the JSON document.</p>
...
`,options:[{id:"crash",page:225,label:"The program crashes",summary:"Program crashes"},{id:"empty",page:311,label:"The output is empty (e.g. <code>{}</code>, <code>[]</code>, or <code>null</code>)",summary:"Output is empty"},{id:"incomplete",page:320,label:"The output is incomplete",summary:"Output is incomplete"},{id:"garbage",page:312,label:"The output contains garbage",summary:"Output contains garbage"},{id:"null",page:320,label:"The output contains <code>null</code>",summary:"Output contains null"},{id:"float",page:236,label:"Floating-point values contain too many decimal digits",summary:"Floating-point values contain too many decimal digits"},{id:"slow",page:268,label:"It's slow",summary:"Serialization is slow"}]},{content:`<p>Please print the value of <code>JsonDocument::overflowed()</code>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:323,label:"<code>1</code> (or <code>true</code>)",summary:"`JsonDocument::overflowed()` returns `true`"},{id:"overflowed-0",page:1,label:"<code>0</code> (or <code>false</code>)",summary:"`JsonDocument::overflowed()` returns `false`"}]},{content:`<p>Which function produces the garbage?</p>
`,options:[{id:"json",page:314,label:"<code>serializeJson()</code> (or <code>serializeJsonPretty()</code>)",summary:"`serializeJson()` produces garbage"},{id:"msg",page:319,label:"<code>serializeMsgPack()</code>",summary:"`serializeMsgPack()` produces garbage"}]},{content:`<p>Do you use <a href="https://www.arduino.cc/reference/en/language/variables/data-types/stringobject/"><code>String</code></a> in your program?</p>
...
`,options:[{id:"document",page:313,label:"<code>JsonDocument</code>",summary:"Program calls `serializeJson(const JsonDocument&, ...)`"},{id:"array",page:315,label:"<code>JsonArray</code> (or <code>JsonArrayConst</code>)",summary:"Program calls `serializeJson(JsonArrayConst, ...)`"},{id:"object",page:316,label:"<code>JsonObject</code> (or <code>JsonObjectConst</code>)",summary:"Program calls `serializeJson(JsonObjectConst, ...)`"},{id:"variant",page:317,label:"<code>JsonVariant</code> (or <code>JsonVariantConst</code>)",summary:"Program calls `serializeJson(JsonVariantConst, ...)`"}]},{content:`<p><code>JsonArray</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonArray</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonArray <span class="hljs-title">createArray</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:313,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>JsonObject</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonObject</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonObject <span class="hljs-title">createObject</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:313,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>JsonVariant</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonVariant</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonVariant <span class="hljs-title">createVariant</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:313,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>serializeMsgPack()</code> share a lot of code with <code>serializeJson()</code>. There is no reason you should produce garbage with one and not the other. You may have found a bug.</p>
`,tags:["needs_assistance"]},{content:`<p><a href="https://msgpack.org/">MessagePack</a> is a binary format, so if you print a document to the serial port, the result would look weird.</p>
<p>For example, the following program:</p>
<pre><code class="hljs language-c++">JsonDocument doc;
doc[<span class="hljs-string">&quot;val&quot;</span>] = <span class="hljs-number">42</span>;
...
<p>I need you to edit your program to replace <code>serializeMsgPack()</code> with <code>serializeJson()</code>.</p>
<p>Do you see the garbage in the JSON output?</p>
`,options:[{id:"json",page:314,label:"Yes, <code>serializeJson()</code> produces garbage too",summary:"`serializeJson()` produces garbage too"},{id:"deserialize-no",page:318,label:"No, <code>serializeJson()</code> doesn't produces garbage",summary:"`serializeJson()` doesn't produces garbage"}]},{content:`<p>Please print the value of <code>JsonDocument::overflowed()</code>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:323,label:"<code>1</code> (or <code>true</code>)",summary:"`JsonDocument::overflowed()` returns `true`"},{id:"overflowed-0",page:322,label:"<code>0</code> (or <code>false</code>)",summary:"`JsonDocument::overflowed()` returns `false`"}]},{content:`<p>Is the JSON document big?</p>
`,options:[{id:"big",page:324,label:"Yes, it contains hundred of values",summary:"The JSON document is large"},{id:"small",page:1,label:"No, it doesn't contain that many values",summary:"The JSON document is not large"}]},{content:`<p>Does one of the strings in the <code>JsonDocument</code> contains a NUL (i.e.,  ASCII code 0, or <code>\\u0000</code>)?</p>
`,options:[{id:"nul",page:215,label:"Yes",summary:"One or more strings contain a NUL"},{id:"no-nul",page:321,label:"No",summary:"No string contains a NUL"}]},{content:`<p><code>JsonDocument::overflowed()</code> returns <code>true</code> when you try to insert a value in the <code>JsonDocument</code>, but the memory allocation fails.</p>
<p>The solution is to free some memory or upgrade your microcontroller.
You can use the <a href="/v7/assistant/">ArduinoJson Assistant</a> to check if your microcontroller has enough memory.</p>
<p>Did this solve your issue?</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"nul",page:2,label:"Yes",summary:"Increasing `ARDUINOJSON_SLOT_OFFSET_SIZE` solves the issue"},{id:"no-nul",page:1,label:"No",summary:"Increasing `ARDUINOJSON_SLOT_OFFSET_SIZE` doesn't solve the issue"}]}];function ea(e,s,n){var o;const t=Qo[e];return{...t,number:n||1,hash:s||"#",options:(o=t.options)==null?void 0:o.map((a,i)=>({...a,inputId:`option-${e}-${i}`,hash:(s?s+"/":"#")+a.id,missing:!Qo[a.page],selected:!1}))}}function ul(e){var n;const s=[ea(0)];if(e){let t=s[0];for(let o of e.substring(1).split("/")){const a=(n=t.options)==null?void 0:n.find(i=>i.id===o);if(!a){console.error(`Option "${o}" not found`);break}if(a.selected=!0,t.selectedOption=a,t=ea(a.page,a.hash,t.number+1),!t)break;s.push(t)}}return s}function dl(e){return e.map(s=>s.selectedOption).filter(s=>!!s).map((s,n)=>`${n+1}. ${s.summary}`).join(`
`)}const hl=e=>new Promise(s=>setTimeout(s,e)),ml={components:{AssistanceModal:$r,TroubleshooterStep:pl},data(){return{reportCopied:!1,hash:""}},mounted(){this.hash=location.hash,window.addEventListener("hashchange",()=>this.hash=location.hash)},computed:{needsAssistance(){var s;return!!((s=this.steps[this.steps.length-1].tags)!=null&&s.includes("needs_assistance"))},steps(){return ul(this.hash)},report(){return dl(this.steps)}},methods:{choose(e){document.location.assign(e.hash),ga("set","page",document.location.pathname+document.location.hash),ga("send","pageview"),window.plausible("ArduinoJson Troubleshooter",{props:{hash:document.location.hash}})},async copyReport(){await navigator.clipboard.writeText(this.report),this.reportCopied=!0,await hl(2e3),this.reportCopied=!1}}},fl=se("div",null,[se("p",null,"Hi!"),se("p",null,[tn(" I'm the "),se("i",null,"ArduinoJson Troubleshooter"),tn(", and I'm here to help you fix your problem. I'll ask you a series of questions and give you some instructions along the way. ")]),se("p",null,"Ready? Here we go!")],-1),gl={key:0},yl=se("button",{type:"button",class:"btn btn-primary","data-toggle":"modal","data-target":"#assistance-modal"}," Contact support ",-1),bl=["disabled"];function jl(e,s,n,t,o,a){const i=Pn("TroubleshooterStep"),l=Pn("AssistanceModal");return me(),xe("div",null,[fl,(me(!0),xe(ve,null,po(a.steps,(c,u)=>(me(),en(nt,{key:u,name:"fade",mode:"out-in"},{default:Kt(()=>[(me(),en(i,{key:c.hash,step:c,onChoose:a.choose,active:u==a.steps.length-1},null,8,["step","onChoose","active"]))]),_:2},1024))),128)),a.needsAssistance?(me(),xe("div",gl,[yl,tn(),se("button",{class:ms(["btn",{"btn-outline-primary":!o.reportCopied,"btn-success":o.reportCopied}]),disabled:o.reportCopied,onClick:s[0]||(s[0]=(...c)=>a.copyReport&&a.copyReport(...c))},zs(o.reportCopied?"✓ Report copied":"Copy troubleshooter's report"),11,bl),ce(l,{id:"assistance-modal",report:a.report},null,8,["report"])])):Zn("",!0)])}Mr(rn(ml,[["render",jl]])).provide("debug",!1).mount("#troubleshooter-app")})();
