...
* @license MIT
**/function un(e,s){const n=new Set(e.split(","));return s?t=>n.has(t.toLowerCase()):t=>n.has(t)}const U={},as=[],ye=()=>{},ra=()=>!1,Ns=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),dn=e=>e.startsWith("onUpdate:"),ee=Object.assign,hn=(e,s)=>{const n=e.indexOf(s);n>-1&&e.splice(n,1)},la=Object.prototype.hasOwnProperty,E=(e,s)=>la.call(e,s),x=Array.isArray,is=e=>qs(e)==="[object Map]",ut=e=>qs(e)==="[object Set]",N=e=>typeof e=="function",Q=e=>typeof e=="string",rs=e=>typeof e=="symbol",H=e=>e!==null&&typeof e=="object",dt=e=>(H(e)||N(e))&&N(e.then)&&N(e.catch),ht=Object.prototype.toString,qs=e=>ht.call(e),ca=e=>qs(e).slice(8,-1),mt=e=>qs(e)==="[object Object]",mn=e=>Q(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,ms=un(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Os=e=>{const s=Object.create(null);return n=>s[n]||(s[n]=e(n))},pa=/-(\w)/g,De=Os(e=>e.replace(pa,(s,n)=>n?n.toUpperCase():"")),ua=/\B([A-Z])/g,ls=Os(e=>e.replace(ua,"-$1").toLowerCase()),Is=Os(e=>e.charAt(0).toUpperCase()+e.slice(1)),gn=Os(e=>e?`on${Is(e)}`:""),$e=(e,s)=>!Object.is(e,s),fn=(e,s)=>{for(let n=0;n<e.length;n++)e[n](s)},zs=(e,s,n)=>{Object.defineProperty(e,s,{configurable:!0,enumerable:!1,value:n})},da=e=>{const s=parseFloat(e);return isNaN(s)?e:s},ha=e=>{const s=Q(e)?Number(e):NaN;return isNaN(s)?e:s};let gt;const ft=()=>gt||(gt=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function yn(e){if(x(e)){const s={};for(let n=0;n<e.length;n++){const t=e[n],o=Q(t)?ba(t):yn(t);if(o)for(const a in o)s[a]=o[a]}return s}else if(Q(e)||H(e))return e}const ma=/;(?![^(]*\))/g,fa=/:([^]+)/,ya=/\/\*[^]*?\*\//g;function ba(e){const s={};return e.replace(ya,"").split(ma).forEach(n=>{if(n){const t=n.split(fa);t.length>1&&(s[t[0].trim()]=t[1].trim())}}),s}function gs(e){let s="";if(Q(e))s=e;else if(x(e))for(let n=0;n<e.length;n++){const t=gs(e[n]);t&&(s+=t+" ")}else if(H(e))for(const n in e)e[n]&&(s+=n+" ");return s.trim()}const ja=un("itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly");function yt(e){return!!e||e===""}const Es=e=>Q(e)?e:e==null?"":x(e)||H(e)&&(e.toString===ht||!N(e.toString))?JSON.stringify(e,bt,2):String(e),bt=(e,s)=>s&&s.__v_isRef?bt(e,s.value):is(s)?{[`Map(${s.size})`]:[...s.entries()].reduce((n,[t,o],a)=>(n[bn(t,a)+" =>"]=o,n),{})}:ut(s)?{[`Set(${s.size})`]:[...s.values()].map(n=>bn(n))}:rs(s)?bn(s):H(s)&&!x(s)&&!mt(s)?String(s):s,bn=(e,s="")=>{var n;return rs(e)?`Symbol(${(n=e.description)!=null?n:s})`:e};/**
* @vue/reactivity v3.4.21
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Je;class wa{constructor(s=!1){this.detached=s,this._active=!0,this.effects=[],this.cleanups=[],this.parent=Je,!s&&Je&&(this.index=(Je.scopes||(Je.scopes=[])).push(this)-1)}get active(){return this._active}run(s){if(this._active){const n=Je;try{return Je=this,s()}finally{Je=n}}}on(){Je=this}off(){Je=this.parent}stop(s){if(this._active){let n,t;for(n=0,t=this.effects.length;n<t;n++)this.effects[n].stop();for(n=0,t=this.cleanups.length;n<t;n++)this.cleanups[n]();if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!s){const o=this.parent.scopes.pop();o&&o!==this&&(this.parent.scopes[this.index]=o,o.index=this.index)}this.parent=void 0,this._active=!1}}}function va(e,s=Je){s&&s.active&&s.effects.push(e)}function Ja(){return Je}let Ge;class jn{constructor(s,n,t,o){this.fn=s,this.trigger=n,this.scheduler=t,this.active=!0,this.deps=[],this._dirtyLevel=4,this._trackId=0,this._runnings=0,this._shouldSchedule=!1,this._depsLength=0,va(this,o)}get dirty(){if(this._dirtyLevel===2||this._dirtyLevel===3){this._dirtyLevel=1,Re();for(let s=0;s<this._depsLength;s++){const n=this.deps[s];if(n.computed&&(Sa(n.computed),this._dirtyLevel>=4))break}this._dirtyLevel===1&&(this._dirtyLevel=0),Fe()}return this._dirtyLevel>=4}set dirty(s){this._dirtyLevel=s?4:0}run(){if(this._dirtyLevel=0,!this.active)return this.fn();let s=Ce,n=Ge;try{return Ce=!0,Ge=this,this._runnings++,jt(this),this.fn()}finally{wt(this),this._runnings--,Ge=n,Ce=s}}stop(){var s;this.active&&(jt(this),wt(this),(s=this.onStop)==null||s.call(this),this.active=!1)}}function Sa(e){return e.value}function jt(e){e._trackId++,e._depsLength=0}function wt(e){if(e.deps.length>e._depsLength){for(let s=e._depsLength;s<e.deps.length;s++)vt(e.deps[s],e);e.deps.length=e._depsLength}}function vt(e,s){const n=e.get(s);n!==void 0&&s._trackId!==n&&(e.delete(s),e.size===0&&e.cleanup())}let Ce=!0,wn=0;const Jt=[];function Re(){Jt.push(Ce),Ce=!1}function Fe(){const e=Jt.pop();Ce=e===void 0?!0:e}function vn(){wn++}function Jn(){for(wn--;!wn&&Sn.length;)Sn.shift()()}function St(e,s,n){if(s.get(e)!==e._trackId){s.set(e,e._trackId);const t=e.deps[e._depsLength];t!==s?(t&&vt(t,e),e.deps[e._depsLength++]=s):e._depsLength++}}const Sn=[];function _t(e,s,n){vn();for(const t of e.keys()){let o;t._dirtyLevel<s&&(o??(o=e.get(t)===t._trackId))&&(t._shouldSchedule||(t._shouldSchedule=t._dirtyLevel===0),t._dirtyLevel=s),t._shouldSchedule&&(o??(o=e.get(t)===t._trackId))&&(t.trigger(),(!t._runnings||t.allowRecurse)&&t._dirtyLevel!==2&&(t._shouldSchedule=!1,t.scheduler&&Sn.push(t.scheduler)))}Jn()}const Tt=(e,s)=>{const n=new Map;return n.cleanup=e,n.computed=s,n},_n=new WeakMap,Ke=Symbol(""),Tn=Symbol("");function ue(e,s,n){if(Ce&&Ge){let t=_n.get(e);t||_n.set(e,t=new Map);let o=t.get(n);o||t.set(n,o=Tt(()=>t.delete(n))),St(Ge,o)}}function Ie(e,s,n,t,o,a){const i=_n.get(e);if(!i)return;let l=[];if(s==="clear")l=[...i.values()];else if(n==="length"&&x(e)){const c=Number(t);i.forEach((u,d)=>{(d==="length"||!rs(d)&&d>=c)&&l.push(u)})}else switch(n!==void 0&&l.push(i.get(n)),s){case"add":x(e)?mn(n)&&l.push(i.get("length")):(l.push(i.get(Ke)),is(e)&&l.push(i.get(Tn)));break;case"delete":x(e)||(l.push(i.get(Ke)),is(e)&&l.push(i.get(Tn)));break;case"set":is(e)&&l.push(i.get(Ke));break}vn();for(const c of l)c&&_t(c,4);Jn()}const _a=un("__proto__,__v_isRef,__isVue"),Dt=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(rs)),At=Ta();function Ta(){const e={};return["includes","indexOf","lastIndexOf"].forEach(s=>{e[s]=function(...n){const t=P(this);for(let a=0,i=this.length;a<i;a++)ue(t,"get",a+"");const o=t[s](...n);return o===-1||o===!1?t[s](...n.map(P)):o}}),["push","pop","shift","unshift","splice"].forEach(s=>{e[s]=function(...n){Re(),vn();const t=P(this)[s].apply(this,n);return Jn(),Fe(),t}}),e}function Da(e){const s=P(this);return ue(s,"has",e),s.hasOwnProperty(e)}class xt{constructor(s=!1,n=!1){this._isReadonly=s,this._isShallow=n}get(s,n,t){const o=this._isReadonly,a=this._isShallow;if(n==="__v_isReactive")return!o;if(n==="__v_isReadonly")return o;if(n==="__v_isShallow")return a;if(n==="__v_raw")return t===(o?a?Fa:Pt:a?Et:zt).get(s)||Object.getPrototypeOf(s)===Object.getPrototypeOf(t)?s:void 0;const i=x(s);if(!o){if(i&&E(At,n))return Reflect.get(At,n,t);if(n==="hasOwnProperty")return Da}const l=Reflect.get(s,n,t);return(rs(n)?Dt.has(n):_a(n))||(o||ue(s,"get",n),a)?l:de(l)?i&&mn(n)?l:l.value:H(l)?o?Ct(l):xn(l):l}}class kt extends xt{constructor(s=!1){super(!1,s)}set(s,n,t,o){let a=s[n];if(!this._isShallow){const c=fs(a);if(!Nn(t)&&!fs(t)&&(a=P(a),t=P(t)),!x(s)&&de(a)&&!de(t))return c?!1:(a.value=t,!0)}const i=x(s)&&mn(n)?Number(n)<s.length:E(s,n),l=Reflect.set(s,n,t,o);return s===P(o)&&(i?$e(t,a)&&Ie(s,"set",n,t):Ie(s,"add",n,t)),l}deleteProperty(s,n){const t=E(s,n);s[n];const o=Reflect.deleteProperty(s,n);return o&&t&&Ie(s,"delete",n,void 0),o}has(s,n){const t=Reflect.has(s,n);return(!rs(n)||!Dt.has(n))&&ue(s,"has",n),t}ownKeys(s){return ue(s,"iterate",x(s)?"length":Ke),Reflect.ownKeys(s)}}class Aa extends xt{constructor(s=!1){super(!0,s)}set(s,n){return!0}deleteProperty(s,n){return!0}}const xa=new kt,ka=new Aa,Na=new kt(!0),Dn=e=>e,Ps=e=>Reflect.getPrototypeOf(e);function Cs(e,s,n=!1,t=!1){e=e.__v_raw;const o=P(e),a=P(s);n||($e(s,a)&&ue(o,"get",s),ue(o,"get",a));const{has:i}=Ps(o),l=t?Dn:n?On:qn;if(i.call(o,s))return l(e.get(s));if(i.call(o,a))return l(e.get(a));e!==o&&e.get(s)}function Rs(e,s=!1){const n=this.__v_raw,t=P(n),o=P(e);return s||($e(e,o)&&ue(t,"has",e),ue(t,"has",o)),e===o?n.has(e):n.has(e)||n.has(o)}function Fs(e,s=!1){return e=e.__v_raw,!s&&ue(P(e),"iterate",Ke),Reflect.get(e,"size",e)}function Nt(e){e=P(e);const s=P(this);return Ps(s).has.call(s,e)||(s.add(e),Ie(s,"add",e,e)),this}function qt(e,s){s=P(s);const n=P(this),{has:t,get:o}=Ps(n);let a=t.call(n,e);a||(e=P(e),a=t.call(n,e));const i=o.call(n,e);return n.set(e,s),a?$e(s,i)&&Ie(n,"set",e,s):Ie(n,"add",e,s),this}function Ot(e){const s=P(this),{has:n,get:t}=Ps(s);let o=n.call(s,e);o||(e=P(e),o=n.call(s,e)),t&&t.call(s,e);const a=s.delete(e);return o&&Ie(s,"delete",e,void 0),a}function It(){const e=P(this),s=e.size!==0,n=e.clear();return s&&Ie(e,"clear",void 0,void 0),n}function Ys(e,s){return function(t,o){const a=this,i=a.__v_raw,l=P(i),c=s?Dn:e?On:qn;return!e&&ue(l,"iterate",Ke),i.forEach((u,d)=>t.call(o,c(u),c(d),a))}}function Ms(e,s,n){return function(...t){const o=this.__v_raw,a=P(o),i=is(a),l=e==="entries"||e===Symbol.iterator&&i,c=e==="keys"&&i,u=o[e](...t),d=n?Dn:s?On:qn;return!s&&ue(a,"iterate",c?Tn:Ke),{next(){const{value:f,done:w}=u.next();return w?{value:f,done:w}:{value:l?[d(f[0]),d(f[1])]:d(f),done:w}},[Symbol.iterator](){return this}}}}function Ye(e){return function(...s){return e==="delete"?!1:e==="clear"?void 0:this}}function qa(){const e={get(a){return Cs(this,a)},get size(){return Fs(this)},has:Rs,add:Nt,set:qt,delete:Ot,clear:It,forEach:Ys(!1,!1)},s={get(a){return Cs(this,a,!1,!0)},get size(){return Fs(this)},has:Rs,add:Nt,set:qt,delete:Ot,clear:It,forEach:Ys(!1,!0)},n={get(a){return Cs(this,a,!0)},get size(){return Fs(this,!0)},has(a){return Rs.call(this,a,!0)},add:Ye("add"),set:Ye("set"),delete:Ye("delete"),clear:Ye("clear"),forEach:Ys(!0,!1)},t={get(a){return Cs(this,a,!0,!0)},get size(){return Fs(this,!0)},has(a){return Rs.call(this,a,!0)},add:Ye("add"),set:Ye("set"),delete:Ye("delete"),clear:Ye("clear"),forEach:Ys(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(a=>{e[a]=Ms(a,!1,!1),n[a]=Ms(a,!0,!1),s[a]=Ms(a,!1,!0),t[a]=Ms(a,!0,!0)}),[e,n,s,t]}const[Oa,Ia,za,Ea]=qa();function An(e,s){const n=s?e?Ea:za:e?Ia:Oa;return(t,o,a)=>o==="__v_isReactive"?!e:o==="__v_isReadonly"?e:o==="__v_raw"?t:Reflect.get(E(n,o)&&o in t?n:t,o,a)}const Pa={get:An(!1,!1)},Ca={get:An(!1,!0)},Ra={get:An(!0,!1)},zt=new WeakMap,Et=new WeakMap,Pt=new WeakMap,Fa=new WeakMap;function Ya(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Ma(e){return e.__v_skip||!Object.isExtensible(e)?0:Ya(ca(e))}function xn(e){return fs(e)?e:kn(e,!1,xa,Pa,zt)}function Ha(e){return kn(e,!1,Na,Ca,Et)}function Ct(e){return kn(e,!0,ka,Ra,Pt)}function kn(e,s,n,t,o){if(!H(e)||e.__v_raw&&!(s&&e.__v_isReactive))return e;const a=o.get(e);if(a)return a;const i=Ma(e);if(i===0)return e;const l=new Proxy(e,i===2?t:n);return o.set(e,l),l}function cs(e){return fs(e)?cs(e.__v_raw):!!(e&&e.__v_isReactive)}function fs(e){return!!(e&&e.__v_isReadonly)}function Nn(e){return!!(e&&e.__v_isShallow)}function Rt(e){return cs(e)||fs(e)}function P(e){const s=e&&e.__v_raw;return s?P(s):e}function Ft(e){return Object.isExtensible(e)&&zs(e,"__v_skip",!0),e}const qn=e=>H(e)?xn(e):e,On=e=>H(e)?Ct(e):e;class Yt{constructor(s,n,t,o){this.getter=s,this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this.effect=new jn(()=>s(this._value),()=>In(this,this.effect._dirtyLevel===2?2:3)),this.effect.computed=this,this.effect.active=this._cacheable=!o,this.__v_isReadonly=t}get value(){const s=P(this);return(!s._cacheable||s.effect.dirty)&&$e(s._value,s._value=s.effect.run())&&In(s,4),Ua(s),s.effect._dirtyLevel>=2&&In(s,2),s._value}set value(s){this._setter(s)}get _dirty(){return this.effect.dirty}set _dirty(s){this.effect.dirty=s}}function Ba(e,s,n=!1){let t,o;const a=N(e);return a?(t=e,o=ye):(t=e.get,o=e.set),new Yt(t,o,a||!o,n)}function Ua(e){var s;Ce&&Ge&&(e=P(e),St(Ge,(s=e.dep)!=null?s:e.dep=Tt(()=>e.dep=void 0,e instanceof Yt?e:void 0)))}function In(e,s=4,n){e=P(e);const t=e.dep;t&&_t(t,s)}function de(e){return!!(e&&e.__v_isRef===!0)}function La(e){return de(e)?e.value:e}const Wa={get:(e,s,n)=>La(Reflect.get(e,s,n)),set:(e,s,n,t)=>{const o=e[s];return de(o)&&!de(n)?(o.value=n,!0):Reflect.set(e,s,n,t)}};function Mt(e){return cs(e)?e:new Proxy(e,Wa)}/**
* @vue/runtime-core v3.4.21
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const ys=[];function Tl(e,...s){Re();const n=ys.length?ys[ys.length-1].component:null,t=n&&n.appContext.config.warnHandler,o=Va();if(t)ze(t,n,11,[e+s.map(a=>{var i,l;return(l=(i=a.toString)==null?void 0:i.call(a))!=null?l:JSON.stringify(a)}).join(""),n&&n.proxy,o.map(({vnode:a})=>`at <${Ro(n,a.type)}>`).join(`
`),o]);else{const a=[`[Vue warn]: ${e}`,...s];o.length&&a.push(`
`,...$a(o)),console.warn(...a)}Fe()}function Va(){let e=ys[ys.length-1];if(!e)return[];const s=[];for(;e;){const n=s[0];n&&n.vnode===e?n.recurseCount++:s.push({vnode:e,recurseCount:0});const t=e.component&&e.component.parent;e=t&&t.vnode}return s}function $a(e){const s=[];return e.forEach((n,t)=>{s.push(...t===0?[]:[`
`],...Ga(n))}),s}function Ga({vnode:e,recurseCount:s}){const n=s>0?`... (${s} recursive calls)`:"",t=e.component?e.component.parent==null:!1,o=` at <${Ro(e.component,e.type,t)}`,a=">"+n;return e.props?[o,...Ka(e.props),a]:[o+a]}function Ka(e){const s=[],n=Object.keys(e);return n.slice(0,3).forEach(t=>{s.push(...Ht(t,e[t]))}),n.length>3&&s.push(" ..."),s}function Ht(e,s,n){return Q(s)?(s=JSON.stringify(s),n?s:[`${e}=${s}`]):typeof s=="number"||typeof s=="boolean"||s==null?n?s:[`${e}=${s}`]:de(s)?(s=Ht(e,P(s.value),!0),n?s:[`${e}=Ref<`,s,">"]):N(s)?[`${e}=fn${s.name?`<${s.name}>`:""}`]:(s=P(s),n?s:[`${e}=`,s])}function ze(e,s,n,t){try{return t?e(...t):e()}catch(o){Hs(o,s,n)}}function be(e,s,n,t){if(N(e)){const a=ze(e,s,n,t);return a&&dt(a)&&a.catch(i=>{Hs(i,s,n)}),a}const o=[];for(let a=0;a<e.length;a++)o.push(be(e[a],s,n,t));return o}function Hs(e,s,n,t=!0){const o=s?s.vnode:null;if(s){let a=s.parent;const i=s.proxy,l=`https://vuejs.org/error-reference/#runtime-${n}`;for(;a;){const u=a.ec;if(u){for(let d=0;d<u.length;d++)if(u[d](e,i,l)===!1)return}a=a.parent}const c=s.appContext.config.errorHandler;if(c){ze(c,null,10,[e,i,l]);return}}Za(e,n,o,t)}function Za(e,s,n,t=!0){console.error(e)}let bs=!1,zn=!1;const ae=[];let Ae=0;const ps=[];let Me=null,Ze=0;const Bt=Promise.resolve();let En=null;function Xa(e){const s=En||Bt;return e?s.then(this?e.bind(this):e):s}function Qa(e){let s=Ae+1,n=ae.length;for(;s<n;){const t=s+n>>>1,o=ae[t],a=js(o);a<e||a===e&&o.pre?s=t+1:n=t}return s}function Pn(e){(!ae.length||!ae.includes(e,bs&&e.allowRecurse?Ae+1:Ae))&&(e.id==null?ae.push(e):ae.splice(Qa(e.id),0,e),Ut())}function Ut(){!bs&&!zn&&(zn=!0,En=Bt.then(Vt))}function ei(e){const s=ae.indexOf(e);s>Ae&&ae.splice(s,1)}function si(e){x(e)?ps.push(...e):(!Me||!Me.includes(e,e.allowRecurse?Ze+1:Ze))&&ps.push(e),Ut()}function Lt(e,s,n=bs?Ae+1:0){for(;n<ae.length;n++){const t=ae[n];if(t&&t.pre){if(e&&t.id!==e.uid)continue;ae.splice(n,1),n--,t()}}}function Wt(e){if(ps.length){const s=[...new Set(ps)].sort((n,t)=>js(n)-js(t));if(ps.length=0,Me){Me.push(...s);return}for(Me=s,Ze=0;Ze<Me.length;Ze++)Me[Ze]();Me=null,Ze=0}}const js=e=>e.id==null?1/0:e.id,ni=(e,s)=>{const n=js(e)-js(s);if(n===0){if(e.pre&&!s.pre)return-1;if(s.pre&&!e.pre)return 1}return n};function Vt(e){zn=!1,bs=!0,ae.sort(ni);try{for(Ae=0;Ae<ae.length;Ae++){const s=ae[Ae];s&&s.active!==!1&&ze(s,null,14)}}finally{Ae=0,ae.length=0,Wt(),bs=!1,En=null,(ae.length||ps.length)&&Vt()}}function ti(e,s,...n){if(e.isUnmounted)return;const t=e.vnode.props||U;let o=n;const a=s.startsWith("update:"),i=a&&s.slice(7);if(i&&i in t){const d=`${i==="modelValue"?"model":i}Modifiers`,{number:f,trim:w}=t[d]||U;w&&(o=n.map(D=>Q(D)?D.trim():D)),f&&(o=n.map(da))}let l,c=t[l=gn(s)]||t[l=gn(De(s))];!c&&a&&(c=t[l=gn(ls(s))]),c&&be(c,e,6,o);const u=t[l+"Once"];if(u){if(!e.emitted)e.emitted={};else if(e.emitted[l])return;e.emitted[l]=!0,be(u,e,6,o)}}function $t(e,s,n=!1){const t=s.emitsCache,o=t.get(e);if(o!==void 0)return o;const a=e.emits;let i={},l=!1;if(!N(e)){const c=u=>{const d=$t(u,s,!0);d&&(l=!0,ee(i,d))};!n&&s.mixins.length&&s.mixins.forEach(c),e.extends&&c(e.extends),e.mixins&&e.mixins.forEach(c)}return!a&&!l?(H(e)&&t.set(e,null),null):(x(a)?a.forEach(c=>i[c]=null):ee(i,a),H(e)&&t.set(e,i),i)}function Bs(e,s){return!e||!Ns(s)?!1:(s=s.slice(2).replace(/Once$/,""),E(e,s[0].toLowerCase()+s.slice(1))||E(e,ls(s))||E(e,s))}let je=null,Gt=null;function Us(e){const s=je;return je=e,Gt=e&&e.type.__scopeId||null,s}function Kt(e,s=je,n){if(!s||e._n)return e;const t=(...o)=>{t._d&&ko(-1);const a=Us(s);let i;try{i=e(...o)}finally{Us(a),t._d&&ko(1)}return i};return t._n=!0,t._c=!0,t._d=!0,t}function Dl(){}function Cn(e){const{type:s,vnode:n,proxy:t,withProxy:o,props:a,propsOptions:[i],slots:l,attrs:c,emit:u,render:d,renderCache:f,data:w,setupState:D,ctx:C,inheritAttrs:z}=e;let L,W;const ce=Us(e);try{if(n.shapeFlag&4){const Y=o||t,Z=Y;L=ke(d.call(Z,Y,f,a,D,w,C)),W=c}else{const Y=s;L=ke(Y.length>1?Y(a,{attrs:c,slots:l,emit:u}):Y(a,null)),W=s.props?c:oi(c)}}catch(Y){Ss.length=0,Hs(Y,e,1),L=le(Se)}let R=L;if(W&&z!==!1){const Y=Object.keys(W),{shapeFlag:Z}=R;Y.length&&Z&7&&(i&&Y.some(dn)&&(W=ai(W,i)),R=Be(R,W))}return n.dirs&&(R=Be(R),R.dirs=R.dirs?R.dirs.concat(n.dirs):n.dirs),n.transition&&(R.transition=n.transition),L=R,Us(ce),L}const oi=e=>{let s;for(const n in e)(n==="class"||n==="style"||Ns(n))&&((s||(s={}))[n]=e[n]);return s},ai=(e,s)=>{const n={};for(const t in e)(!dn(t)||!(t.slice(9)in s))&&(n[t]=e[t]);return n};function ii(e,s,n){const{props:t,children:o,component:a}=e,{props:i,children:l,patchFlag:c}=s,u=a.emitsOptions;if(s.dirs||s.transition)return!0;if(n&&c>=0){if(c&1024)return!0;if(c&16)return t?Zt(t,i,u):!!i;if(c&8){const d=s.dynamicProps;for(let f=0;f<d.length;f++){const w=d[f];if(i[w]!==t[w]&&!Bs(u,w))return!0}}}else return(o||l)&&(!l||!l.$stable)?!0:t===i?!1:t?i?Zt(t,i,u):!0:!!i;return!1}function Zt(e,s,n){const t=Object.keys(s);if(t.length!==Object.keys(e).length)return!0;for(let o=0;o<t.length;o++){const a=t[o];if(s[a]!==e[a]&&!Bs(n,a))return!0}return!1}function ri({vnode:e,parent:s},n){for(;s;){const t=s.subTree;if(t.suspense&&t.suspense.activeBranch===e&&(t.el=e.el),t===e)(e=s.vnode).el=n,s=s.parent;else break}}const Xt="components";function Rn(e,s){return ci(Xt,e,!0,s)||e}const li=Symbol.for("v-ndc");function ci(e,s,n=!0,t=!1){const o=je||oe;if(o){const a=o.type;if(e===Xt){const l=Co(a,!1);if(l&&(l===s||l===De(s)||l===Is(De(s))))return a}const i=Qt(o[e]||a[e],s)||Qt(o.appContext[e],s);return!i&&t?a:i}}function Qt(e,s){return e&&(e[s]||e[De(s)]||e[Is(De(s))])}const pi=e=>e.__isSuspense;function ui(e,s){s&&s.pendingBranch?x(e)?s.effects.push(...e):s.effects.push(e):si(e)}const di=Symbol.for("v-scx"),hi=()=>Zs(di),Ls={};function Fn(e,s,n){return eo(e,s,n)}function eo(e,s,{immediate:n,deep:t,flush:o,once:a,onTrack:i,onTrigger:l}=U){if(s&&a){const O=s;s=(...pe)=>{O(...pe),Z()}}const c=oe,u=O=>t===!0?O:us(O,t===!1?1:void 0);let d,f=!1,w=!1;if(de(e)?(d=()=>e.value,f=Nn(e)):cs(e)?(d=()=>u(e),f=!0):x(e)?(w=!0,f=e.some(O=>cs(O)||Nn(O)),d=()=>e.map(O=>{if(de(O))return O.value;if(cs(O))return u(O);if(N(O))return ze(O,c,2)})):N(e)?s?d=()=>ze(e,c,2):d=()=>(D&&D(),be(e,c,3,[C])):d=ye,s&&t){const O=d;d=()=>us(O())}let D,C=O=>{D=R.onStop=()=>{ze(O,c,4),D=R.onStop=void 0}},z;if(an)if(C=ye,s?n&&be(s,c,3,[d(),w?[]:void 0,C]):d(),o==="sync"){const O=hi();z=O.__watcherHandles||(O.__watcherHandles=[])}else return ye;let L=w?new Array(e.length).fill(Ls):Ls;const W=()=>{if(!(!R.active||!R.dirty))if(s){const O=R.run();(t||f||(w?O.some((pe,q)=>$e(pe,L[q])):$e(O,L)))&&(D&&D(),be(s,c,3,[O,L===Ls?void 0:w&&L[0]===Ls?[]:L,C]),L=O)}else R.run()};W.allowRecurse=!!s;let ce;o==="sync"?ce=W:o==="post"?ce=()=>he(W,c&&c.suspense):(W.pre=!0,c&&(W.id=c.uid),ce=()=>Pn(W));const R=new jn(d,ye,ce),Y=Ja(),Z=()=>{R.stop(),Y&&hn(Y.effects,R)};return s?n?W():L=R.run():o==="post"?he(R.run.bind(R),c&&c.suspense):R.run(),z&&z.push(Z),Z}function mi(e,s,n){const t=this.proxy,o=Q(e)?e.includes(".")?so(t,e):()=>t[e]:e.bind(t,t);let a;N(s)?a=s:(a=s.handler,n=s);const i=Ts(this),l=eo(o,a.bind(t),n);return i(),l}function so(e,s){const n=s.split(".");return()=>{let t=e;for(let o=0;o<n.length&&t;o++)t=t[n[o]];return t}}function us(e,s,n=0,t){if(!H(e)||e.__v_skip)return e;if(s&&s>0){if(n>=s)return e;n++}if(t=t||new Set,t.has(e))return e;if(t.add(e),de(e))us(e.value,s,n,t);else if(x(e))for(let o=0;o<e.length;o++)us(e[o],s,n,t);else if(ut(e)||is(e))e.forEach(o=>{us(o,s,n,t)});else if(mt(e))for(const o in e)us(e[o],s,n,t);return e}function Xe(e,s,n,t){const o=e.dirs,a=s&&s.dirs;for(let i=0;i<o.length;i++){const l=o[i];a&&(l.oldValue=a[i].value);let c=l.dir[t];c&&(Re(),be(c,n,8,[e.el,l,e,s]),Fe())}}const He=Symbol("_leaveCb"),Ws=Symbol("_enterCb");function gi(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return ro(()=>{e.isMounted=!0}),lo(()=>{e.isUnmounting=!0}),e}const we=[Function,Array],no={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:we,onEnter:we,onAfterEnter:we,onEnterCancelled:we,onBeforeLeave:we,onLeave:we,onAfterLeave:we,onLeaveCancelled:we,onBeforeAppear:we,onAppear:we,onAfterAppear:we,onAppearCancelled:we},fi={name:"BaseTransition",props:no,setup(e,{slots:s}){const n=er(),t=gi();return()=>{const o=s.default&&ao(s.default(),!0);if(!o||!o.length)return;let a=o[0];if(o.length>1){for(const w of o)if(w.type!==Se){a=w;break}}const i=P(e),{mode:l}=i;if(t.isLeaving)return Mn(a);const c=oo(a);if(!c)return Mn(a);const u=Yn(c,i,t,n);Hn(c,u);const d=n.subTree,f=d&&oo(d);if(f&&f.type!==Se&&!es(c,f)){const w=Yn(f,i,t,n);if(Hn(f,w),l==="out-in")return t.isLeaving=!0,w.afterLeave=()=>{t.isLeaving=!1,n.update.active!==!1&&(n.effect.dirty=!0,n.update())},Mn(a);l==="in-out"&&c.type!==Se&&(w.delayLeave=(D,C,z)=>{const L=to(t,f);L[String(f.key)]=f,D[He]=()=>{C(),D[He]=void 0,delete u.delayedLeave},u.delayedLeave=z})}return a}}};function to(e,s){const{leavingVNodes:n}=e;let t=n.get(s.type);return t||(t=Object.create(null),n.set(s.type,t)),t}function Yn(e,s,n,t){const{appear:o,mode:a,persisted:i=!1,onBeforeEnter:l,onEnter:c,onAfterEnter:u,onEnterCancelled:d,onBeforeLeave:f,onLeave:w,onAfterLeave:D,onLeaveCancelled:C,onBeforeAppear:z,onAppear:L,onAfterAppear:W,onAppearCancelled:ce}=s,R=String(e.key),Y=to(n,e),Z=(q,X)=>{q&&be(q,t,9,X)},O=(q,X)=>{const B=X[1];Z(q,X),x(q)?q.every(ie=>ie.length<=1)&&B():q.length<=1&&B()},pe={mode:a,persisted:i,beforeEnter(q){let X=l;if(!n.isMounted)if(o)X=z||l;else return;q[He]&&q[He](!0);const B=Y[R];B&&es(e,B)&&B.el[He]&&B.el[He](),Z(X,[q])},enter(q){let X=c,B=u,ie=d;if(!n.isMounted)if(o)X=L||c,B=W||u,ie=ce||d;else return;let _=!1;const G=q[Ws]=ge=>{_||(_=!0,ge?Z(ie,[q]):Z(B,[q]),pe.delayedLeave&&pe.delayedLeave(),q[Ws]=void 0)};X?O(X,[q,G]):G()},leave(q,X){const B=String(e.key);if(q[Ws]&&q[Ws](!0),n.isUnmounting)return X();Z(f,[q]);let ie=!1;const _=q[He]=G=>{ie||(ie=!0,X(),G?Z(C,[q]):Z(D,[q]),q[He]=void 0,Y[B]===e&&delete Y[B])};Y[B]=e,w?O(w,[q,_]):_()},clone(q){return Yn(q,s,n,t)}};return pe}function Mn(e){if($s(e))return e=Be(e),e.children=null,e}function oo(e){return $s(e)?e.children?e.children[0]:void 0:e}function Hn(e,s){e.shapeFlag&6&&e.component?Hn(e.component.subTree,s):e.shapeFlag&128?(e.ssContent.transition=s.clone(e.ssContent),e.ssFallback.transition=s.clone(e.ssFallback)):e.transition=s}function ao(e,s=!1,n){let t=[],o=0;for(let a=0;a<e.length;a++){let i=e[a];const l=n==null?i.key:String(n)+String(i.key!=null?i.key:a);i.type===ve?(i.patchFlag&128&&o++,t=t.concat(ao(i.children,s,l))):(s||i.type!==Se)&&t.push(l!=null?Be(i,{key:l}):i)}if(o>1)for(let a=0;a<t.length;a++)t[a].patchFlag=-2;return t}/*! #__NO_SIDE_EFFECTS__ */function Bn(e,s){return N(e)?ee({name:e.name},s,{setup:e}):e}const Vs=e=>!!e.type.__asyncLoader,$s=e=>e.type.__isKeepAlive;function yi(e,s){io(e,"a",s)}function bi(e,s){io(e,"da",s)}function io(e,s,n=oe){const t=e.__wdc||(e.__wdc=()=>{let o=n;for(;o;){if(o.isDeactivated)return;o=o.parent}return e()});if(Gs(s,t,n),n){let o=n.parent;for(;o&&o.parent;)$s(o.parent.vnode)&&ji(t,s,n,o),o=o.parent}}function ji(e,s,n,t){const o=Gs(s,e,t,!0);co(()=>{hn(t[s],o)},n)}function Gs(e,s,n=oe,t=!1){if(n){const o=n[e]||(n[e]=[]),a=s.__weh||(s.__weh=(...i)=>{if(n.isUnmounted)return;Re();const l=Ts(n),c=be(s,n,e,i);return l(),Fe(),c});return t?o.unshift(a):o.push(a),a}}const Ee=e=>(s,n=oe)=>(!an||e==="sp")&&Gs(e,(...t)=>s(...t),n),wi=Ee("bm"),ro=Ee("m"),vi=Ee("bu"),Ji=Ee("u"),lo=Ee("bum"),co=Ee("um"),Si=Ee("sp"),_i=Ee("rtg"),Ti=Ee("rtc");function Di(e,s=oe){Gs("ec",e,s)}function po(e,s,n,t){let o;const a=n&&n[t];if(x(e)||Q(e)){o=new Array(e.length);for(let i=0,l=e.length;i<l;i++)o[i]=s(e[i],i,void 0,a&&a[i])}else if(typeof e=="number"){o=new Array(e);for(let i=0;i<e;i++)o[i]=s(i+1,i,void 0,a&&a[i])}else if(H(e))if(e[Symbol.iterator])o=Array.from(e,(i,l)=>s(i,l,void 0,a&&a[l]));else{const i=Object.keys(e);o=new Array(i.length);for(let l=0,c=i.length;l<c;l++){const u=i[l];o[l]=s(e[u],u,l,a&&a[l])}}else o=[];return n&&(n[t]=o),o}const Un=e=>e?Io(e)?tt(e)||e.proxy:Un(e.parent):null,ws=ee(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Un(e.parent),$root:e=>Un(e.root),$emit:e=>e.emit,$options:e=>Vn(e),$forceUpdate:e=>e.f||(e.f=()=>{e.effect.dirty=!0,Pn(e.update)}),$nextTick:e=>e.n||(e.n=Xa.bind(e.proxy)),$watch:e=>mi.bind(e)}),Ln=(e,s)=>e!==U&&!e.__isScriptSetup&&E(e,s),Ai={get({_:e},s){const{ctx:n,setupState:t,data:o,props:a,accessCache:i,type:l,appContext:c}=e;let u;if(s[0]!=="$"){const D=i[s];if(D!==void 0)switch(D){case 1:return t[s];case 2:return o[s];case 4:return n[s];case 3:return a[s]}else{if(Ln(t,s))return i[s]=1,t[s];if(o!==U&&E(o,s))return i[s]=2,o[s];if((u=e.propsOptions[0])&&E(u,s))return i[s]=3,a[s];if(n!==U&&E(n,s))return i[s]=4,n[s];Wn&&(i[s]=0)}}const d=ws[s];let f,w;if(d)return s==="$attrs"&&ue(e,"get",s),d(e);if((f=l.__cssModules)&&(f=f[s]))return f;if(n!==U&&E(n,s))return i[s]=4,n[s];if(w=c.config.globalProperties,E(w,s))return w[s]},set({_:e},s,n){const{data:t,setupState:o,ctx:a}=e;return Ln(o,s)?(o[s]=n,!0):t!==U&&E(t,s)?(t[s]=n,!0):E(e.props,s)||s[0]==="$"&&s.slice(1)in e?!1:(a[s]=n,!0)},has({_:{data:e,setupState:s,accessCache:n,ctx:t,appContext:o,propsOptions:a}},i){let l;return!!n[i]||e!==U&&E(e,i)||Ln(s,i)||(l=a[0])&&E(l,i)||E(t,i)||E(ws,i)||E(o.config.globalProperties,i)},defineProperty(e,s,n){return n.get!=null?e._.accessCache[s]=0:E(n,"value")&&this.set(e,s,n.value,null),Reflect.defineProperty(e,s,n)}};function uo(e){return x(e)?e.reduce((s,n)=>(s[n]=null,s),{}):e}let Wn=!0;function xi(e){const s=Vn(e),n=e.proxy,t=e.ctx;Wn=!1,s.beforeCreate&&ho(s.beforeCreate,e,"bc");const{data:o,computed:a,methods:i,watch:l,provide:c,inject:u,created:d,beforeMount:f,mounted:w,beforeUpdate:D,updated:C,activated:z,deactivated:L,beforeDestroy:W,beforeUnmount:ce,destroyed:R,unmounted:Y,render:Z,renderTracked:O,renderTriggered:pe,errorCaptured:q,serverPrefetch:X,expose:B,inheritAttrs:ie,components:_,directives:G,filters:ge}=s;if(u&&ki(u,t,null),i)for(const K in i){const M=i[K];N(M)&&(t[K]=M.bind(n))}if(o){const K=o.call(n,n);H(K)&&(e.data=xn(K))}if(Wn=!0,a)for(const K in a){const M=a[K],ts=N(M)?M.bind(n,n):N(M.get)?M.get.bind(n,n):ye,cn=!N(M)&&N(M.set)?M.set.bind(n):ye,os=lr({get:ts,set:cn});Object.defineProperty(t,K,{enumerable:!0,configurable:!0,get:()=>os.value,set:qe=>os.value=qe})}if(l)for(const K in l)mo(l[K],t,n,K);if(c){const K=N(c)?c.call(n):c;Reflect.ownKeys(K).forEach(M=>{Ei(M,K[M])})}d&&ho(d,e,"c");function ne(K,M){x(M)?M.forEach(ts=>K(ts.bind(n))):M&&K(M.bind(n))}if(ne(wi,f),ne(ro,w),ne(vi,D),ne(Ji,C),ne(yi,z),ne(bi,L),ne(Di,q),ne(Ti,O),ne(_i,pe),ne(lo,ce),ne(co,Y),ne(Si,X),x(B))if(B.length){const K=e.exposed||(e.exposed={});B.forEach(M=>{Object.defineProperty(K,M,{get:()=>n[M],set:ts=>n[M]=ts})})}else e.exposed||(e.exposed={});Z&&e.render===ye&&(e.render=Z),ie!=null&&(e.inheritAttrs=ie),_&&(e.components=_),G&&(e.directives=G)}function ki(e,s,n=ye){x(e)&&(e=$n(e));for(const t in e){const o=e[t];let a;H(o)?"default"in o?a=Zs(o.from||t,o.default,!0):a=Zs(o.from||t):a=Zs(o),de(a)?Object.defineProperty(s,t,{enumerable:!0,configurable:!0,get:()=>a.value,set:i=>a.value=i}):s[t]=a}}function ho(e,s,n){be(x(e)?e.map(t=>t.bind(s.proxy)):e.bind(s.proxy),s,n)}function mo(e,s,n,t){const o=t.includes(".")?so(n,t):()=>n[t];if(Q(e)){const a=s[e];N(a)&&Fn(o,a)}else if(N(e))Fn(o,e.bind(n));else if(H(e))if(x(e))e.forEach(a=>mo(a,s,n,t));else{const a=N(e.handler)?e.handler.bind(n):s[e.handler];N(a)&&Fn(o,a,e)}}function Vn(e){const s=e.type,{mixins:n,extends:t}=s,{mixins:o,optionsCache:a,config:{optionMergeStrategies:i}}=e.appContext,l=a.get(s);let c;return l?c=l:!o.length&&!n&&!t?c=s:(c={},o.length&&o.forEach(u=>Ks(c,u,i,!0)),Ks(c,s,i)),H(s)&&a.set(s,c),c}function Ks(e,s,n,t=!1){const{mixins:o,extends:a}=s;a&&Ks(e,a,n,!0),o&&o.forEach(i=>Ks(e,i,n,!0));for(const i in s)if(!(t&&i==="expose")){const l=Ni[i]||n&&n[i];e[i]=l?l(e[i],s[i]):s[i]}return e}const Ni={data:go,props:fo,emits:fo,methods:vs,computed:vs,beforeCreate:re,created:re,beforeMount:re,mounted:re,beforeUpdate:re,updated:re,beforeDestroy:re,beforeUnmount:re,destroyed:re,unmounted:re,activated:re,deactivated:re,errorCaptured:re,serverPrefetch:re,components:vs,directives:vs,watch:Oi,provide:go,inject:qi};function go(e,s){return s?e?function(){return ee(N(e)?e.call(this,this):e,N(s)?s.call(this,this):s)}:s:e}function qi(e,s){return vs($n(e),$n(s))}function $n(e){if(x(e)){const s={};for(let n=0;n<e.length;n++)s[e[n]]=e[n];return s}return e}function re(e,s){return e?[...new Set([].concat(e,s))]:s}function vs(e,s){return e?ee(Object.create(null),e,s):s}function fo(e,s){return e?x(e)&&x(s)?[...new Set([...e,...s])]:ee(Object.create(null),uo(e),uo(s??{})):s}function Oi(e,s){if(!e)return s;if(!s)return e;const n=ee(Object.create(null),e);for(const t in s)n[t]=re(e[t],s[t]);return n}function yo(){return{app:null,config:{isNativeTag:ra,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Ii=0;function zi(e,s){return function(t,o=null){N(t)||(t=ee({},t)),o!=null&&!H(o)&&(o=null);const a=yo(),i=new WeakSet;let l=!1;const c=a.app={_uid:Ii++,_component:t,_props:o,_container:null,_context:a,_instance:null,version:pr,get config(){return a.config},set config(u){},use(u,...d){return i.has(u)||(u&&N(u.install)?(i.add(u),u.install(c,...d)):N(u)&&(i.add(u),u(c,...d))),c},mixin(u){return a.mixins.includes(u)||a.mixins.push(u),c},component(u,d){return d?(a.components[u]=d,c):a.components[u]},directive(u,d){return d?(a.directives[u]=d,c):a.directives[u]},mount(u,d,f){if(!l){const w=le(t,o);return w.appContext=a,f===!0?f="svg":f===!1&&(f=void 0),d&&s?s(w,u):e(w,u,f),l=!0,c._container=u,u.__vue_app__=c,tt(w.component)||w.component.proxy}},unmount(){l&&(e(null,c._container),delete c._container.__vue_app__)},provide(u,d){return a.provides[u]=d,c},runWithContext(u){const d=Js;Js=c;try{return u()}finally{Js=d}}};return c}}let Js=null;function Ei(e,s){if(oe){let n=oe.provides;const t=oe.parent&&oe.parent.provides;t===n&&(n=oe.provides=Object.create(t)),n[e]=s}}function Zs(e,s,n=!1){const t=oe||je;if(t||Js){const o=t?t.parent==null?t.vnode.appContext&&t.vnode.appContext.provides:t.parent.provides:Js._context.provides;if(o&&e in o)return o[e];if(arguments.length>1)return n&&N(s)?s.call(t&&t.proxy):s}}function Pi(e,s,n,t=!1){const o={},a={};zs(a,sn,1),e.propsDefaults=Object.create(null),bo(e,s,o,a);for(const i in e.propsOptions[0])i in o||(o[i]=void 0);n?e.props=t?o:Ha(o):e.type.props?e.props=o:e.props=a,e.attrs=a}function Ci(e,s,n,t){const{props:o,attrs:a,vnode:{patchFlag:i}}=e,l=P(o),[c]=e.propsOptions;let u=!1;if((t||i>0)&&!(i&16)){if(i&8){const d=e.vnode.dynamicProps;for(let f=0;f<d.length;f++){let w=d[f];if(Bs(e.emitsOptions,w))continue;const D=s[w];if(c)if(E(a,w))D!==a[w]&&(a[w]=D,u=!0);else{const C=De(w);o[C]=Gn(c,l,C,D,e,!1)}else D!==a[w]&&(a[w]=D,u=!0)}}}else{bo(e,s,o,a)&&(u=!0);let d;for(const f in l)(!s||!E(s,f)&&((d=ls(f))===f||!E(s,d)))&&(c?n&&(n[f]!==void 0||n[d]!==void 0)&&(o[f]=Gn(c,l,f,void 0,e,!0)):delete o[f]);if(a!==l)for(const f in a)(!s||!E(s,f))&&(delete a[f],u=!0)}u&&Ie(e,"set","$attrs")}function bo(e,s,n,t){const[o,a]=e.propsOptions;let i=!1,l;if(s)for(let c in s){if(ms(c))continue;const u=s[c];let d;o&&E(o,d=De(c))?!a||!a.includes(d)?n[d]=u:(l||(l={}))[d]=u:Bs(e.emitsOptions,c)||(!(c in t)||u!==t[c])&&(t[c]=u,i=!0)}if(a){const c=P(n),u=l||U;for(let d=0;d<a.length;d++){const f=a[d];n[f]=Gn(o,c,f,u[f],e,!E(u,f))}}return i}function Gn(e,s,n,t,o,a){const i=e[n];if(i!=null){const l=E(i,"default");if(l&&t===void 0){const c=i.default;if(i.type!==Function&&!i.skipFactory&&N(c)){const{propsDefaults:u}=o;if(n in u)t=u[n];else{const d=Ts(o);t=u[n]=c.call(null,s),d()}}else t=c}i[0]&&(a&&!l?t=!1:i[1]&&(t===""||t===ls(n))&&(t=!0))}return t}function jo(e,s,n=!1){const t=s.propsCache,o=t.get(e);if(o)return o;const a=e.props,i={},l=[];let c=!1;if(!N(e)){const d=f=>{c=!0;const[w,D]=jo(f,s,!0);ee(i,w),D&&l.push(...D)};!n&&s.mixins.length&&s.mixins.forEach(d),e.extends&&d(e.extends),e.mixins&&e.mixins.forEach(d)}if(!a&&!c)return H(e)&&t.set(e,as),as;if(x(a))for(let d=0;d<a.length;d++){const f=De(a[d]);wo(f)&&(i[f]=U)}else if(a)for(const d in a){const f=De(d);if(wo(f)){const w=a[d],D=i[f]=x(w)||N(w)?{type:w}:ee({},w);if(D){const C=So(Boolean,D.type),z=So(String,D.type);D[0]=C>-1,D[1]=z<0||C<z,(C>-1||E(D,"default"))&&l.push(f)}}}const u=[i,l];return H(e)&&t.set(e,u),u}function wo(e){return e[0]!=="$"&&!ms(e)}function vo(e){return e===null?"null":typeof e=="function"?e.name||"":typeof e=="object"&&e.constructor&&e.constructor.name||""}function Jo(e,s){return vo(e)===vo(s)}function So(e,s){return x(s)?s.findIndex(n=>Jo(n,e)):N(s)&&Jo(s,e)?0:-1}const _o=e=>e[0]==="_"||e==="$stable",Kn=e=>x(e)?e.map(ke):[ke(e)],Ri=(e,s,n)=>{if(s._n)return s;const t=Kt((...o)=>Kn(s(...o)),n);return t._c=!1,t},To=(e,s,n)=>{const t=e._ctx;for(const o in e){if(_o(o))continue;const a=e[o];if(N(a))s[o]=Ri(o,a,t);else if(a!=null){const i=Kn(a);s[o]=()=>i}}},Do=(e,s)=>{const n=Kn(s);e.slots.default=()=>n},Fi=(e,s)=>{if(e.vnode.shapeFlag&32){const n=s._;n?(e.slots=P(s),zs(s,"_",n)):To(s,e.slots={})}else e.slots={},s&&Do(e,s);zs(e.slots,sn,1)},Yi=(e,s,n)=>{const{vnode:t,slots:o}=e;let a=!0,i=U;if(t.shapeFlag&32){const l=s._;l?n&&l===1?a=!1:(ee(o,s),!n&&l===1&&delete o._):(a=!s.$stable,To(s,o)),i=s}else s&&(Do(e,s),i={default:1});if(a)for(const l in o)!_o(l)&&i[l]==null&&delete o[l]};function Zn(e,s,n,t,o=!1){if(x(e)){e.forEach((w,D)=>Zn(w,s&&(x(s)?s[D]:s),n,t,o));return}if(Vs(t)&&!o)return;const a=t.shapeFlag&4?tt(t.component)||t.component.proxy:t.el,i=o?null:a,{i:l,r:c}=e,u=s&&s.r,d=l.refs===U?l.refs={}:l.refs,f=l.setupState;if(u!=null&&u!==c&&(Q(u)?(d[u]=null,E(f,u)&&(f[u]=null)):de(u)&&(u.value=null)),N(c))ze(c,l,12,[i,d]);else{const w=Q(c),D=de(c);if(w||D){const C=()=>{if(e.f){const z=w?E(f,c)?f[c]:d[c]:c.value;o?x(z)&&hn(z,a):x(z)?z.includes(a)||z.push(a):w?(d[c]=[a],E(f,c)&&(f[c]=d[c])):(c.value=[a],e.k&&(d[e.k]=c.value))}else w?(d[c]=i,E(f,c)&&(f[c]=i)):D&&(c.value=i,e.k&&(d[e.k]=i))};i?(C.id=-1,he(C,n)):C()}}}const he=ui;function Mi(e){return Hi(e)}function Hi(e,s){const n=ft();n.__VUE__=!0;const{insert:t,remove:o,patchProp:a,createElement:i,createText:l,createComment:c,setText:u,setElementText:d,parentNode:f,nextSibling:w,setScopeId:D=ye,insertStaticContent:C}=e,z=(r,p,h,m=null,g=null,j=null,J=void 0,b=null,v=!!p.dynamicChildren)=>{if(r===p)return;r&&!es(r,p)&&(m=pn(r),qe(r,g,j,!0),r=null),p.patchFlag===-2&&(v=!1,p.dynamicChildren=null);const{type:y,ref:S,shapeFlag:A}=p;switch(y){case Xs:L(r,p,h,m);break;case Se:W(r,p,h,m);break;case Qs:r==null&&ce(p,h,m,J);break;case ve:_(r,p,h,m,g,j,J,b,v);break;default:A&1?Z(r,p,h,m,g,j,J,b,v):A&6?G(r,p,h,m,g,j,J,b,v):(A&64||A&128)&&y.process(r,p,h,m,g,j,J,b,v,ds)}S!=null&&g&&Zn(S,r&&r.ref,j,p||r,!p)},L=(r,p,h,m)=>{if(r==null)t(p.el=l(p.children),h,m);else{const g=p.el=r.el;p.children!==r.children&&u(g,p.children)}},W=(r,p,h,m)=>{r==null?t(p.el=c(p.children||""),h,m):p.el=r.el},ce=(r,p,h,m)=>{[r.el,r.anchor]=C(r.children,p,h,m,r.el,r.anchor)},R=({el:r,anchor:p},h,m)=>{let g;for(;r&&r!==p;)g=w(r),t(r,h,m),r=g;t(p,h,m)},Y=({el:r,anchor:p})=>{let h;for(;r&&r!==p;)h=w(r),o(r),r=h;o(p)},Z=(r,p,h,m,g,j,J,b,v)=>{p.type==="svg"?J="svg":p.type==="math"&&(J="mathml"),r==null?O(p,h,m,g,j,J,b,v):X(r,p,g,j,J,b,v)},O=(r,p,h,m,g,j,J,b)=>{let v,y;const{props:S,shapeFlag:A,transition:T,dirs:k}=r;if(v=r.el=i(r.type,j,S&&S.is,S),A&8?d(v,r.children):A&16&&q(r.children,v,null,m,g,Xn(r,j),J,b),k&&Xe(r,null,m,"created"),pe(v,r,r.scopeId,J,m),S){for(const F in S)F!=="value"&&!ms(F)&&a(v,F,null,S[F],j,r.children,m,g,Pe);"value"in S&&a(v,"value",null,S.value,j),(y=S.onVnodeBeforeMount)&&Ne(y,m,r)}k&&Xe(r,null,m,"beforeMount");const I=Bi(g,T);I&&T.beforeEnter(v),t(v,p,h),((y=S&&S.onVnodeMounted)||I||k)&&he(()=>{y&&Ne(y,m,r),I&&T.enter(v),k&&Xe(r,null,m,"mounted")},g)},pe=(r,p,h,m,g)=>{if(h&&D(r,h),m)for(let j=0;j<m.length;j++)D(r,m[j]);if(g){let j=g.subTree;if(p===j){const J=g.vnode;pe(r,J,J.scopeId,J.slotScopeIds,g.parent)}}},q=(r,p,h,m,g,j,J,b,v=0)=>{for(let y=v;y<r.length;y++){const S=r[y]=b?Ue(r[y]):ke(r[y]);z(null,S,p,h,m,g,j,J,b)}},X=(r,p,h,m,g,j,J)=>{const b=p.el=r.el;let{patchFlag:v,dynamicChildren:y,dirs:S}=p;v|=r.patchFlag&16;const A=r.props||U,T=p.props||U;let k;if(h&&Qe(h,!1),(k=T.onVnodeBeforeUpdate)&&Ne(k,h,p,r),S&&Xe(p,r,h,"beforeUpdate"),h&&Qe(h,!0),y?B(r.dynamicChildren,y,b,h,m,Xn(p,g),j):J||M(r,p,b,null,h,m,Xn(p,g),j,!1),v>0){if(v&16)ie(b,p,A,T,h,m,g);else if(v&2&&A.class!==T.class&&a(b,"class",null,T.class,g),v&4&&a(b,"style",A.style,T.style,g),v&8){const I=p.dynamicProps;for(let F=0;F<I.length;F++){const V=I[F],te=A[V],Te=T[V];(Te!==te||V==="value")&&a(b,V,te,Te,g,r.children,h,m,Pe)}}v&1&&r.children!==p.children&&d(b,p.children)}else!J&&y==null&&ie(b,p,A,T,h,m,g);((k=T.onVnodeUpdated)||S)&&he(()=>{k&&Ne(k,h,p,r),S&&Xe(p,r,h,"updated")},m)},B=(r,p,h,m,g,j,J)=>{for(let b=0;b<p.length;b++){const v=r[b],y=p[b],S=v.el&&(v.type===ve||!es(v,y)||v.shapeFlag&70)?f(v.el):h;z(v,y,S,null,m,g,j,J,!0)}},ie=(r,p,h,m,g,j,J)=>{if(h!==m){if(h!==U)for(const b in h)!ms(b)&&!(b in m)&&a(r,b,h[b],null,J,p.children,g,j,Pe);for(const b in m){if(ms(b))continue;const v=m[b],y=h[b];v!==y&&b!=="value"&&a(r,b,y,v,J,p.children,g,j,Pe)}"value"in m&&a(r,"value",h.value,m.value,J)}},_=(r,p,h,m,g,j,J,b,v)=>{const y=p.el=r?r.el:l(""),S=p.anchor=r?r.anchor:l("");let{patchFlag:A,dynamicChildren:T,slotScopeIds:k}=p;k&&(b=b?b.concat(k):k),r==null?(t(y,h,m),t(S,h,m),q(p.children||[],h,S,g,j,J,b,v)):A>0&&A&64&&T&&r.dynamicChildren?(B(r.dynamicChildren,T,h,g,j,J,b),(p.key!=null||g&&p===g.subTree)&&Ao(r,p,!0)):M(r,p,h,S,g,j,J,b,v)},G=(r,p,h,m,g,j,J,b,v)=>{p.slotScopeIds=b,r==null?p.shapeFlag&512?g.ctx.activate(p,h,m,J,v):ge(p,h,m,g,j,J,v):xs(r,p,v)},ge=(r,p,h,m,g,j,J)=>{const b=r.component=Qi(r,m,g);if($s(r)&&(b.ctx.renderer=ds),sr(b),b.asyncDep){if(g&&g.registerDep(b,ne),!r.el){const v=b.subTree=le(Se);W(null,v,p,h)}}else ne(b,r,p,h,g,j,J)},xs=(r,p,h)=>{const m=p.component=r.component;if(ii(r,p,h))if(m.asyncDep&&!m.asyncResolved){K(m,p,h);return}else m.next=p,ei(m.update),m.effect.dirty=!0,m.update();else p.el=r.el,m.vnode=p},ne=(r,p,h,m,g,j,J)=>{const b=()=>{if(r.isMounted){let{next:S,bu:A,u:T,parent:k,vnode:I}=r;{const hs=xo(r);if(hs){S&&(S.el=I.el,K(r,S,J)),hs.asyncDep.then(()=>{r.isUnmounted||b()});return}}let F=S,V;Qe(r,!1),S?(S.el=I.el,K(r,S,J)):S=I,A&&fn(A),(V=S.props&&S.props.onVnodeBeforeUpdate)&&Ne(V,k,S,I),Qe(r,!0);const te=Cn(r),Te=r.subTree;r.subTree=te,z(Te,te,f(Te.el),pn(Te),r,g,j),S.el=te.el,F===null&&ri(r,te.el),T&&he(T,g),(V=S.props&&S.props.onVnodeUpdated)&&he(()=>Ne(V,k,S,I),g)}else{let S;const{el:A,props:T}=p,{bm:k,m:I,parent:F}=r,V=Vs(p);if(Qe(r,!1),k&&fn(k),!V&&(S=T&&T.onVnodeBeforeMount)&&Ne(S,F,p),Qe(r,!0),A&&pt){const te=()=>{r.subTree=Cn(r),pt(A,r.subTree,r,g,null)};V?p.type.__asyncLoader().then(()=>!r.isUnmounted&&te()):te()}else{const te=r.subTree=Cn(r);z(null,te,h,m,r,g,j),p.el=te.el}if(I&&he(I,g),!V&&(S=T&&T.onVnodeMounted)){const te=p;he(()=>Ne(S,F,te),g)}(p.shapeFlag&256||F&&Vs(F.vnode)&&F.vnode.shapeFlag&256)&&r.a&&he(r.a,g),r.isMounted=!0,p=h=m=null}},v=r.effect=new jn(b,ye,()=>Pn(y),r.scope),y=r.update=()=>{v.dirty&&v.run()};y.id=r.uid,Qe(r,!0),y()},K=(r,p,h)=>{p.component=r;const m=r.vnode.props;r.vnode=p,r.next=null,Ci(r,p.props,m,h),Yi(r,p.children,h),Re(),Lt(r),Fe()},M=(r,p,h,m,g,j,J,b,v=!1)=>{const y=r&&r.children,S=r?r.shapeFlag:0,A=p.children,{patchFlag:T,shapeFlag:k}=p;if(T>0){if(T&128){cn(y,A,h,m,g,j,J,b,v);return}else if(T&256){ts(y,A,h,m,g,j,J,b,v);return}}k&8?(S&16&&Pe(y,g,j),A!==y&&d(h,A)):S&16?k&16?cn(y,A,h,m,g,j,J,b,v):Pe(y,g,j,!0):(S&8&&d(h,""),k&16&&q(A,h,m,g,j,J,b,v))},ts=(r,p,h,m,g,j,J,b,v)=>{r=r||as,p=p||as;const y=r.length,S=p.length,A=Math.min(y,S);let T;for(T=0;T<A;T++){const k=p[T]=v?Ue(p[T]):ke(p[T]);z(r[T],k,h,null,g,j,J,b,v)}y>S?Pe(r,g,j,!0,!1,A):q(p,h,m,g,j,J,b,v,A)},cn=(r,p,h,m,g,j,J,b,v)=>{let y=0;const S=p.length;let A=r.length-1,T=S-1;for(;y<=A&&y<=T;){const k=r[y],I=p[y]=v?Ue(p[y]):ke(p[y]);if(es(k,I))z(k,I,h,null,g,j,J,b,v);else break;y++}for(;y<=A&&y<=T;){const k=r[A],I=p[T]=v?Ue(p[T]):ke(p[T]);if(es(k,I))z(k,I,h,null,g,j,J,b,v);else break;A--,T--}if(y>A){if(y<=T){const k=T+1,I=k<S?p[k].el:m;for(;y<=T;)z(null,p[y]=v?Ue(p[y]):ke(p[y]),h,I,g,j,J,b,v),y++}}else if(y>T)for(;y<=A;)qe(r[y],g,j,!0),y++;else{const k=y,I=y,F=new Map;for(y=I;y<=T;y++){const fe=p[y]=v?Ue(p[y]):ke(p[y]);fe.key!=null&&F.set(fe.key,y)}let V,te=0;const Te=T-I+1;let hs=!1,oa=0;const ks=new Array(Te);for(y=0;y<Te;y++)ks[y]=0;for(y=k;y<=A;y++){const fe=r[y];if(te>=Te){qe(fe,g,j,!0);continue}let Oe;if(fe.key!=null)Oe=F.get(fe.key);else for(V=I;V<=T;V++)if(ks[V-I]===0&&es(fe,p[V])){Oe=V;break}Oe===void 0?qe(fe,g,j,!0):(ks[Oe-I]=y+1,Oe>=oa?oa=Oe:hs=!0,z(fe,p[Oe],h,null,g,j,J,b,v),te++)}const aa=hs?Ui(ks):as;for(V=aa.length-1,y=Te-1;y>=0;y--){const fe=I+y,Oe=p[fe],ia=fe+1<S?p[fe+1].el:m;ks[y]===0?z(null,Oe,h,ia,g,j,J,b,v):hs&&(V<0||y!==aa[V]?os(Oe,h,ia,2):V--)}}},os=(r,p,h,m,g=null)=>{const{el:j,type:J,transition:b,children:v,shapeFlag:y}=r;if(y&6){os(r.component.subTree,p,h,m);return}if(y&128){r.suspense.move(p,h,m);return}if(y&64){J.move(r,p,h,ds);return}if(J===ve){t(j,p,h);for(let A=0;A<v.length;A++)os(v[A],p,h,m);t(r.anchor,p,h);return}if(J===Qs){R(r,p,h);return}if(m!==2&&y&1&&b)if(m===0)b.beforeEnter(j),t(j,p,h),he(()=>b.enter(j),g);else{const{leave:A,delayLeave:T,afterLeave:k}=b,I=()=>t(j,p,h),F=()=>{A(j,()=>{I(),k&&k()})};T?T(j,I,F):F()}else t(j,p,h)},qe=(r,p,h,m=!1,g=!1)=>{const{type:j,props:J,ref:b,children:v,dynamicChildren:y,shapeFlag:S,patchFlag:A,dirs:T}=r;if(b!=null&&Zn(b,null,h,r,!0),S&256){p.ctx.deactivate(r);return}const k=S&1&&T,I=!Vs(r);let F;if(I&&(F=J&&J.onVnodeBeforeUnmount)&&Ne(F,p,r),S&6)Sl(r.component,h,m);else{if(S&128){r.suspense.unmount(h,m);return}k&&Xe(r,null,p,"beforeUnmount"),S&64?r.type.remove(r,p,h,g,ds,m):y&&(j!==ve||A>0&&A&64)?Pe(y,p,h,!1,!0):(j===ve&&A&384||!g&&S&16)&&Pe(v,p,h),m&&na(r)}(I&&(F=J&&J.onVnodeUnmounted)||k)&&he(()=>{F&&Ne(F,p,r),k&&Xe(r,null,p,"unmounted")},h)},na=r=>{const{type:p,el:h,anchor:m,transition:g}=r;if(p===ve){Jl(h,m);return}if(p===Qs){Y(r);return}const j=()=>{o(h),g&&!g.persisted&&g.afterLeave&&g.afterLeave()};if(r.shapeFlag&1&&g&&!g.persisted){const{leave:J,delayLeave:b}=g,v=()=>J(h,j);b?b(r.el,j,v):v()}else j()},Jl=(r,p)=>{let h;for(;r!==p;)h=w(r),o(r),r=h;o(p)},Sl=(r,p,h)=>{const{bum:m,scope:g,update:j,subTree:J,um:b}=r;m&&fn(m),g.stop(),j&&(j.active=!1,qe(J,r,p,h)),b&&he(b,p),he(()=>{r.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&r.asyncDep&&!r.asyncResolved&&r.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},Pe=(r,p,h,m=!1,g=!1,j=0)=>{for(let J=j;J<r.length;J++)qe(r[J],p,h,m,g)},pn=r=>r.shapeFlag&6?pn(r.component.subTree):r.shapeFlag&128?r.suspense.next():w(r.anchor||r.el);let lt=!1;const ta=(r,p,h)=>{r==null?p._vnode&&qe(p._vnode,null,null,!0):z(p._vnode||null,r,p,null,null,null,h),lt||(lt=!0,Lt(),Wt(),lt=!1),p._vnode=r},ds={p:z,um:qe,m:os,r:na,mt:ge,mc:q,pc:M,pbc:B,n:pn,o:e};let ct,pt;return s&&([ct,pt]=s(ds)),{render:ta,hydrate:ct,createApp:zi(ta,ct)}}function Xn({type:e,props:s},n){return n==="svg"&&e==="foreignObject"||n==="mathml"&&e==="annotation-xml"&&s&&s.encoding&&s.encoding.includes("html")?void 0:n}function Qe({effect:e,update:s},n){e.allowRecurse=s.allowRecurse=n}function Bi(e,s){return(!e||e&&!e.pendingBranch)&&s&&!s.persisted}function Ao(e,s,n=!1){const t=e.children,o=s.children;if(x(t)&&x(o))for(let a=0;a<t.length;a++){const i=t[a];let l=o[a];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=o[a]=Ue(o[a]),l.el=i.el),n||Ao(i,l)),l.type===Xs&&(l.el=i.el)}}function Ui(e){const s=e.slice(),n=[0];let t,o,a,i,l;const c=e.length;for(t=0;t<c;t++){const u=e[t];if(u!==0){if(o=n[n.length-1],e[o]<u){s[t]=o,n.push(t);continue}for(a=0,i=n.length-1;a<i;)l=a+i>>1,e[n[l]]<u?a=l+1:i=l;u<e[n[a]]&&(a>0&&(s[t]=n[a-1]),n[a]=t)}}for(a=n.length,i=n[a-1];a-- >0;)n[a]=i,i=s[i];return n}function xo(e){const s=e.subTree.component;if(s)return s.asyncDep&&!s.asyncResolved?s:xo(s)}const Li=e=>e.__isTeleport,ve=Symbol.for("v-fgt"),Xs=Symbol.for("v-txt"),Se=Symbol.for("v-cmt"),Qs=Symbol.for("v-stc"),Ss=[];let _e=null;function me(e=!1){Ss.push(_e=e?null:[])}function Wi(){Ss.pop(),_e=Ss[Ss.length-1]||null}let _s=1;function ko(e){_s+=e}function No(e){return e.dynamicChildren=_s>0?_e||as:null,Wi(),_s>0&&_e&&_e.push(e),e}function xe(e,s,n,t,o,a){return No(se(e,s,n,t,o,a,!0))}function en(e,s,n,t,o){return No(le(e,s,n,t,o,!0))}function Qn(e){return e?e.__v_isVNode===!0:!1}function es(e,s){return e.type===s.type&&e.key===s.key}const sn="__vInternal",qo=({key:e})=>e??null,nn=({ref:e,ref_key:s,ref_for:n})=>(typeof e=="number"&&(e=""+e),e!=null?Q(e)||de(e)||N(e)?{i:je,r:e,k:s,f:!!n}:e:null);function se(e,s=null,n=null,t=0,o=null,a=e===ve?0:1,i=!1,l=!1){const c={__v_isVNode:!0,__v_skip:!0,type:e,props:s,key:s&&qo(s),ref:s&&nn(s),scopeId:Gt,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:a,patchFlag:t,dynamicProps:o,dynamicChildren:null,appContext:null,ctx:je};return l?(st(c,n),a&128&&e.normalize(c)):n&&(c.shapeFlag|=Q(n)?8:16),_s>0&&!i&&_e&&(c.patchFlag>0||a&6)&&c.patchFlag!==32&&_e.push(c),c}const le=Vi;function Vi(e,s=null,n=null,t=0,o=null,a=!1){if((!e||e===li)&&(e=Se),Qn(e)){const l=Be(e,s,!0);return n&&st(l,n),_s>0&&!a&&_e&&(l.shapeFlag&6?_e[_e.indexOf(e)]=l:_e.push(l)),l.patchFlag|=-2,l}if(rr(e)&&(e=e.__vccOpts),s){s=$i(s);let{class:l,style:c}=s;l&&!Q(l)&&(s.class=gs(l)),H(c)&&(Rt(c)&&!x(c)&&(c=ee({},c)),s.style=yn(c))}const i=Q(e)?1:pi(e)?128:Li(e)?64:H(e)?4:N(e)?2:0;return se(e,s,n,t,o,i,a,!0)}function $i(e){return e?Rt(e)||sn in e?ee({},e):e:null}function Be(e,s,n=!1){const{props:t,ref:o,patchFlag:a,children:i}=e,l=s?Ki(t||{},s):t;return{__v_isVNode:!0,__v_skip:!0,type:e.type,props:l,key:l&&qo(l),ref:s&&s.ref?n&&o?x(o)?o.concat(nn(s)):[o,nn(s)]:nn(s):o,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:i,target:e.target,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:s&&e.type!==ve?a===-1?16:a|16:a,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:e.transition,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Be(e.ssContent),ssFallback:e.ssFallback&&Be(e.ssFallback),el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce}}function tn(e=" ",s=0){return le(Xs,null,e,s)}function Gi(e,s){const n=le(Qs,null,e);return n.staticCount=s,n}function et(e="",s=!1){return s?(me(),en(Se,null,e)):le(Se,null,e)}function ke(e){return e==null||typeof e=="boolean"?le(Se):x(e)?le(ve,null,e.slice()):typeof e=="object"?Ue(e):le(Xs,null,String(e))}function Ue(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Be(e)}function st(e,s){let n=0;const{shapeFlag:t}=e;if(s==null)s=null;else if(x(s))n=16;else if(typeof s=="object")if(t&65){const o=s.default;o&&(o._c&&(o._d=!1),st(e,o()),o._c&&(o._d=!0));return}else{n=32;const o=s._;!o&&!(sn in s)?s._ctx=je:o===3&&je&&(je.slots._===1?s._=1:(s._=2,e.patchFlag|=1024))}else N(s)?(s={default:s,_ctx:je},n=32):(s=String(s),t&64?(n=16,s=[tn(s)]):n=8);e.children=s,e.shapeFlag|=n}function Ki(...e){const s={};for(let n=0;n<e.length;n++){const t=e[n];for(const o in t)if(o==="class")s.class!==t.class&&(s.class=gs([s.class,t.class]));else if(o==="style")s.style=yn([s.style,t.style]);else if(Ns(o)){const a=s[o],i=t[o];i&&a!==i&&!(x(a)&&a.includes(i))&&(s[o]=a?[].concat(a,i):i)}else o!==""&&(s[o]=t[o])}return s}function Ne(e,s,n,t=null){be(e,s,7,[n,t])}const Zi=yo();let Xi=0;function Qi(e,s,n){const t=e.type,o=(s?s.appContext:e.appContext)||Zi,a={uid:Xi++,vnode:e,type:t,parent:s,appContext:o,root:null,next:null,subTree:null,effect:null,update:null,scope:new wa(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:s?s.provides:Object.create(o.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:jo(t,o),emitsOptions:$t(t,o),emit:null,emitted:null,propsDefaults:U,inheritAttrs:t.inheritAttrs,ctx:U,data:U,props:U,attrs:U,slots:U,refs:U,setupState:U,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return a.ctx={_:a},a.root=s?s.root:a,a.emit=ti.bind(null,a),e.ce&&e.ce(a),a}let oe=null;const er=()=>oe||je;let on,nt;{const e=ft(),s=(n,t)=>{let o;return(o=e[n])||(o=e[n]=[]),o.push(t),a=>{o.length>1?o.forEach(i=>i(a)):o[0](a)}};on=s("__VUE_INSTANCE_SETTERS__",n=>oe=n),nt=s("__VUE_SSR_SETTERS__",n=>an=n)}const Ts=e=>{const s=oe;return on(e),e.scope.on(),()=>{e.scope.off(),on(s)}},Oo=()=>{oe&&oe.scope.off(),on(null)};function Io(e){return e.vnode.shapeFlag&4}let an=!1;function sr(e,s=!1){s&&nt(s);const{props:n,children:t}=e.vnode,o=Io(e);Pi(e,n,o,s),Fi(e,t);const a=o?nr(e,s):void 0;return s&&nt(!1),a}function nr(e,s){const n=e.type;e.accessCache=Object.create(null),e.proxy=Ft(new Proxy(e.ctx,Ai));const{setup:t}=n;if(t){const o=e.setupContext=t.length>1?or(e):null,a=Ts(e);Re();const i=ze(t,e,0,[e.props,o]);if(Fe(),a(),dt(i)){if(i.then(Oo,Oo),s)return i.then(l=>{zo(e,l,s)}).catch(l=>{Hs(l,e,0)});e.asyncDep=i}else zo(e,i,s)}else Po(e,s)}function zo(e,s,n){N(s)?e.type.__ssrInlineRender?e.ssrRender=s:e.render=s:H(s)&&(e.setupState=Mt(s)),Po(e,n)}let Eo;function Po(e,s,n){const t=e.type;if(!e.render){if(!s&&Eo&&!t.render){const o=t.template||Vn(e).template;if(o){const{isCustomElement:a,compilerOptions:i}=e.appContext.config,{delimiters:l,compilerOptions:c}=t,u=ee(ee({isCustomElement:a,delimiters:l},i),c);t.render=Eo(o,u)}}e.render=t.render||ye}{const o=Ts(e);Re();try{xi(e)}finally{Fe(),o()}}}function tr(e){return e.attrsProxy||(e.attrsProxy=new Proxy(e.attrs,{get(s,n){return ue(e,"get","$attrs"),s[n]}}))}function or(e){const s=n=>{e.exposed=n||{}};return{get attrs(){return tr(e)},slots:e.slots,emit:e.emit,expose:s}}function tt(e){if(e.exposed)return e.exposeProxy||(e.exposeProxy=new Proxy(Mt(Ft(e.exposed)),{get(s,n){if(n in s)return s[n];if(n in ws)return ws[n](e)},has(s,n){return n in s||n in ws}}))}const ar=/(?:^|[-_])(\w)/g,ir=e=>e.replace(ar,s=>s.toUpperCase()).replace(/[-_]/g,"");function Co(e,s=!0){return N(e)?e.displayName||e.name:e.name||s&&e.__name}function Ro(e,s,n=!1){let t=Co(s);if(!t&&s.__file){const o=s.__file.match(/([^/\\]+)\.\w+$/);o&&(t=o[1])}if(!t&&e&&e.parent){const o=a=>{for(const i in a)if(a[i]===s)return i};t=o(e.components||e.parent.type.components)||o(e.appContext.components)}return t?ir(t):n?"App":"Anonymous"}function rr(e){return N(e)&&"__vccOpts"in e}const lr=(e,s)=>Ba(e,s,an);function cr(e,s,n){const t=arguments.length;return t===2?H(s)&&!x(s)?Qn(s)?le(e,null,[s]):le(e,s):le(e,null,s):(t>3?n=Array.prototype.slice.call(arguments,2):t===3&&Qn(n)&&(n=[n]),le(e,s,n))}const pr="3.4.21";/**
* @vue/runtime-dom v3.4.21
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const ur="http://www.w3.org/2000/svg",dr="http://www.w3.org/1998/Math/MathML",Le=typeof document<"u"?document:null,Fo=Le&&Le.createElement("template"),hr={insert:(e,s,n)=>{s.insertBefore(e,n||null)},remove:e=>{const s=e.parentNode;s&&s.removeChild(e)},createElement:(e,s,n,t)=>{const o=s==="svg"?Le.createElementNS(ur,e):s==="mathml"?Le.createElementNS(dr,e):Le.createElement(e,n?{is:n}:void 0);return e==="select"&&t&&t.multiple!=null&&o.setAttribute("multiple",t.multiple),o},createText:e=>Le.createTextNode(e),createComment:e=>Le.createComment(e),setText:(e,s)=>{e.nodeValue=s},setElementText:(e,s)=>{e.textContent=s},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Le.querySelector(e),setScopeId(e,s){e.setAttribute(s,"")},insertStaticContent(e,s,n,t,o,a){const i=n?n.previousSibling:s.lastChild;if(o&&(o===a||o.nextSibling))for(;s.insertBefore(o.cloneNode(!0),n),!(o===a||!(o=o.nextSibling)););else{Fo.innerHTML=t==="svg"?`<svg>${e}</svg>`:t==="mathml"?`<math>${e}</math>`:e;const l=Fo.content;if(t==="svg"||t==="mathml"){const c=l.firstChild;for(;c.firstChild;)l.appendChild(c.firstChild);l.removeChild(c)}s.insertBefore(l,n)}return[i?i.nextSibling:s.firstChild,n?n.previousSibling:s.lastChild]}},We="transition",Ds="animation",As=Symbol("_vtc"),ot=(e,{slots:s})=>cr(fi,mr(e),s);ot.displayName="Transition";const Yo={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};ot.props=ee({},no,Yo);const ss=(e,s=[])=>{x(e)?e.forEach(n=>n(...s)):e&&e(...s)},Mo=e=>e?x(e)?e.some(s=>s.length>1):e.length>1:!1;function mr(e){const s={};for(const _ in e)_ in Yo||(s[_]=e[_]);if(e.css===!1)return s;const{name:n="v",type:t,duration:o,enterFromClass:a=`${n}-enter-from`,enterActiveClass:i=`${n}-enter-active`,enterToClass:l=`${n}-enter-to`,appearFromClass:c=a,appearActiveClass:u=i,appearToClass:d=l,leaveFromClass:f=`${n}-leave-from`,leaveActiveClass:w=`${n}-leave-active`,leaveToClass:D=`${n}-leave-to`}=e,C=gr(o),z=C&&C[0],L=C&&C[1],{onBeforeEnter:W,onEnter:ce,onEnterCancelled:R,onLeave:Y,onLeaveCancelled:Z,onBeforeAppear:O=W,onAppear:pe=ce,onAppearCancelled:q=R}=s,X=(_,G,ge)=>{ns(_,G?d:l),ns(_,G?u:i),ge&&ge()},B=(_,G)=>{_._isLeaving=!1,ns(_,f),ns(_,D),ns(_,w),G&&G()},ie=_=>(G,ge)=>{const xs=_?pe:ce,ne=()=>X(G,_,ge);ss(xs,[G,ne]),Ho(()=>{ns(G,_?c:a),Ve(G,_?d:l),Mo(xs)||Bo(G,t,z,ne)})};return ee(s,{onBeforeEnter(_){ss(W,[_]),Ve(_,a),Ve(_,i)},onBeforeAppear(_){ss(O,[_]),Ve(_,c),Ve(_,u)},onEnter:ie(!1),onAppear:ie(!0),onLeave(_,G){_._isLeaving=!0;const ge=()=>B(_,G);Ve(_,f),br(),Ve(_,w),Ho(()=>{_._isLeaving&&(ns(_,f),Ve(_,D),Mo(Y)||Bo(_,t,L,ge))}),ss(Y,[_,ge])},onEnterCancelled(_){X(_,!1),ss(R,[_])},onAppearCancelled(_){X(_,!0),ss(q,[_])},onLeaveCancelled(_){B(_),ss(Z,[_])}})}function gr(e){if(e==null)return null;if(H(e))return[at(e.enter),at(e.leave)];{const s=at(e);return[s,s]}}function at(e){return ha(e)}function Ve(e,s){s.split(/\s+/).forEach(n=>n&&e.classList.add(n)),(e[As]||(e[As]=new Set)).add(s)}function ns(e,s){s.split(/\s+/).forEach(t=>t&&e.classList.remove(t));const n=e[As];n&&(n.delete(s),n.size||(e[As]=void 0))}function Ho(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let fr=0;function Bo(e,s,n,t){const o=e._endId=++fr,a=()=>{o===e._endId&&t()};if(n)return setTimeout(a,n);const{type:i,timeout:l,propCount:c}=yr(e,s);if(!i)return t();const u=i+"end";let d=0;const f=()=>{e.removeEventListener(u,w),a()},w=D=>{D.target===e&&++d>=c&&f()};setTimeout(()=>{d<c&&f()},l+1),e.addEventListener(u,w)}function yr(e,s){const n=window.getComputedStyle(e),t=C=>(n[C]||"").split(", "),o=t(`${We}Delay`),a=t(`${We}Duration`),i=Uo(o,a),l=t(`${Ds}Delay`),c=t(`${Ds}Duration`),u=Uo(l,c);let d=null,f=0,w=0;s===We?i>0&&(d=We,f=i,w=a.length):s===Ds?u>0&&(d=Ds,f=u,w=c.length):(f=Math.max(i,u),d=f>0?i>u?We:Ds:null,w=d?d===We?a.length:c.length:0);const D=d===We&&/\b(transform|all)(,|$)/.test(t(`${We}Property`).toString());return{type:d,timeout:f,propCount:w,hasTransform:D}}function Uo(e,s){for(;e.length<s.length;)e=e.concat(e);return Math.max(...s.map((n,t)=>Lo(n)+Lo(e[t])))}function Lo(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function br(){return document.body.offsetHeight}function jr(e,s,n){const t=e[As];t&&(s=(s?[s,...t]:[...t]).join(" ")),s==null?e.removeAttribute("class"):n?e.setAttribute("class",s):e.className=s}const Wo=Symbol("_vod"),wr=Symbol("_vsh"),vr=Symbol(""),Jr=/(^|;)\s*display\s*:/;function Sr(e,s,n){const t=e.style,o=Q(n);let a=!1;if(n&&!o){if(s)if(Q(s))for(const i of s.split(";")){const l=i.slice(0,i.indexOf(":")).trim();n[l]==null&&rn(t,l,"")}else for(const i in s)n[i]==null&&rn(t,i,"");for(const i in n)i==="display"&&(a=!0),rn(t,i,n[i])}else if(o){if(s!==n){const i=t[vr];i&&(n+=";"+i),t.cssText=n,a=Jr.test(n)}}else s&&e.removeAttribute("style");Wo in e&&(e[Wo]=a?t.display:"",e[wr]&&(t.display="none"))}const Vo=/\s*!important$/;function rn(e,s,n){if(x(n))n.forEach(t=>rn(e,s,t));else if(n==null&&(n=""),s.startsWith("--"))e.setProperty(s,n);else{const t=_r(e,s);Vo.test(n)?e.setProperty(ls(t),n.replace(Vo,""),"important"):e[t]=n}}const $o=["Webkit","Moz","ms"],it={};function _r(e,s){const n=it[s];if(n)return n;let t=De(s);if(t!=="filter"&&t in e)return it[s]=t;t=Is(t);for(let o=0;o<$o.length;o++){const a=$o[o]+t;if(a in e)return it[s]=a}return s}const Go="http://www.w3.org/1999/xlink";function Tr(e,s,n,t,o){if(t&&s.startsWith("xlink:"))n==null?e.removeAttributeNS(Go,s.slice(6,s.length)):e.setAttributeNS(Go,s,n);else{const a=ja(s);n==null||a&&!yt(n)?e.removeAttribute(s):e.setAttribute(s,a?"":n)}}function Dr(e,s,n,t,o,a,i){if(s==="innerHTML"||s==="textContent"){t&&i(t,o,a),e[s]=n??"";return}const l=e.tagName;if(s==="value"&&l!=="PROGRESS"&&!l.includes("-")){const u=l==="OPTION"?e.getAttribute("value")||"":e.value,d=n??"";(u!==d||!("_value"in e))&&(e.value=d),n==null&&e.removeAttribute(s),e._value=n;return}let c=!1;if(n===""||n==null){const u=typeof e[s];u==="boolean"?n=yt(n):n==null&&u==="string"?(n="",c=!0):u==="number"&&(n=0,c=!0)}try{e[s]=n}catch{}c&&e.removeAttribute(s)}function Ar(e,s,n,t){e.addEventListener(s,n,t)}function xr(e,s,n,t){e.removeEventListener(s,n,t)}const Ko=Symbol("_vei");function kr(e,s,n,t,o=null){const a=e[Ko]||(e[Ko]={}),i=a[s];if(t&&i)i.value=t;else{const[l,c]=Nr(s);if(t){const u=a[s]=Ir(t,o);Ar(e,l,u,c)}else i&&(xr(e,l,i,c),a[s]=void 0)}}const Zo=/(?:Once|Passive|Capture)$/;function Nr(e){let s;if(Zo.test(e)){s={};let t;for(;t=e.match(Zo);)e=e.slice(0,e.length-t[0].length),s[t[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):ls(e.slice(2)),s]}let rt=0;const qr=Promise.resolve(),Or=()=>rt||(qr.then(()=>rt=0),rt=Date.now());function Ir(e,s){const n=t=>{if(!t._vts)t._vts=Date.now();else if(t._vts<=n.attached)return;be(zr(t,n.value),s,5,[t])};return n.value=e,n.attached=Or(),n}function zr(e,s){if(x(s)){const n=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{n.call(e),e._stopped=!0},s.map(t=>o=>!o._stopped&&t&&t(o))}else return s}const Xo=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,Er=(e,s,n,t,o,a,i,l,c)=>{const u=o==="svg";s==="class"?jr(e,t,u):s==="style"?Sr(e,n,t):Ns(s)?dn(s)||kr(e,s,n,t,i):(s[0]==="."?(s=s.slice(1),!0):s[0]==="^"?(s=s.slice(1),!1):Pr(e,s,t,u))?Dr(e,s,t,a,i,l,c):(s==="true-value"?e._trueValue=t:s==="false-value"&&(e._falseValue=t),Tr(e,s,t,u))};function Pr(e,s,n,t){if(t)return!!(s==="innerHTML"||s==="textContent"||s in e&&Xo(s)&&N(n));if(s==="spellcheck"||s==="draggable"||s==="translate"||s==="form"||s==="list"&&e.tagName==="INPUT"||s==="type"&&e.tagName==="TEXTAREA")return!1;if(s==="width"||s==="height"){const o=e.tagName;if(o==="IMG"||o==="VIDEO"||o==="CANVAS"||o==="SOURCE")return!1}return Xo(s)&&Q(n)?!1:s in e}const Cr=["ctrl","shift","alt","meta"],Rr={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,s)=>Cr.some(n=>e[`${n}Key`]&&!s.includes(n))},Fr=(e,s)=>{const n=e._withMods||(e._withMods={}),t=s.join(".");return n[t]||(n[t]=(o,...a)=>{for(let i=0;i<s.length;i++){const l=Rr[s[i]];if(l&&l(o,s))return}return e(o,...a)})},Yr=ee({patchProp:Er},hr);let Qo;function Mr(){return Qo||(Qo=Mi(Yr))}const Hr=(...e)=>{const s=Mr().createApp(...e),{mount:n}=s;return s.mount=t=>{const o=Ur(t);if(!o)return;const a=s._component;!N(a)&&!a.render&&!a.template&&(a.template=o.innerHTML),o.innerHTML="";const i=n(o,!1,Br(o));return o instanceof Element&&(o.removeAttribute("v-cloak"),o.setAttribute("data-v-app","")),i},s};function Br(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function Ur(e){return Q(e)?document.querySelector(e):e}const ln=(e,s)=>{const n=e.__vccOpts||e;for(const[t,o]of s)n[t]=o;return n},Lr=Bn({props:{report:{type:String,required:!0}},methods:{createIssue(){const e=new FormData(this.$refs.issueForm),s=e.get("title");let n="";const t=e.get("description");t&&(n+=`**Description**
${t}
...
`,options:[{id:"serialization",page:218,label:"Serialization",summary:"The issue concerns serialization"},{id:"deserialization",page:87,label:"Deserialization",summary:"The issue concerns deserialization"}]},{content:`<p>What is the value of <code>DeserializationError</code>?</p>
`,options:[{id:"ok",page:168,label:"<code>Ok</code>",summary:"`deserializeJson()` returns `Ok`"},{id:"emptyinput",page:102,label:"<code>EmptyInput</code>",summary:"`deserializeJson()` returns `EmptyInput`"},{id:"incompleteinput",page:119,label:"<code>IncompleteInput</code>",summary:"`deserializeJson()` returns `IncompleteInput`"},{id:"invalidinput",page:126,label:"<code>InvalidInput</code>",summary:"`deserializeJson()` returns `InvalidInput`"},{id:"nomemory",page:203,label:"<code>NoMemory</code>",summary:"`deserializeJson()` returns `NoMemory`"},{id:"notsupported",page:211,label:"<code>NotSupported</code>",summary:"`deserializeJson()` returns `NotSupported`"},{id:"toodeep",page:216,label:"<code>TooDeep</code>",summary:"`deserializeJson()` returns `TooDeep`"},{id:"crash",page:89,label:"I can't tell because the program crashes",summary:"The program crashes"},{id:"unknown",page:88,label:"I don't know what you're talking about",summary:"The program doesn't check the error"}]},{content:`<p><code>DeserializationError</code> is the return type of <code>deserializeJson()</code>. It tells whether the operation succeeded and indicates the cause of the error.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Following the redirection fixes the issue"},{id:"follow",page:112,label:"No",summary:"Following the redirection doesn't fix the issue"}]},{content:`<p>A negative number indicates an error on the client side.</p>
...
`,options:[{id:"redirect",page:107,label:"<code>300</code> to <code>399</code>",summary:"The status code indicates a redirection"},{id:"negative",page:108,label:"A negative number",summary:"The status code is negative"},{id:"status-ok",page:112,label:"None of the above",summary:"The status code is not in the list"}]},{content:`<p>What is the type of the second argument of <code>deserializeJson()</code>?</p>
`,options:[{id:"string",page:111,label:"<code>String</code>",summary:"The input is a `String`"},{id:"stream",page:104,label:"<code>Stream</code>",summary:"The input is a `Stream`"},{id:"other",page:1,label:"None of the above",summary:"The input type is neither `String` nor `Stream`"}]},{content:`<p>I suspect the <code>String</code> allocation fails because the heap is exhausted or <a href="https://cpp4arduino.com/2018/11/06/what-is-heap-fragmentation.html">fragmented</a>.</p>
<p>Pass the input stream directly to <code>deserializeJson()</code> to avoid the allocation of a <code>String</code>.</p>
<p>For example, if you use <code>HTTPClient</code>:</p>
<pre><code class="hljs language-diff"><span class="hljs-deletion">- deserializeJson(doc, http.getString());</span>
<span class="hljs-addition">+ deserializeJson(doc, http.getStream());</span>
</code></pre>
<p>Or, if you use <code>EthernetClient</code>, <code>WiFiClient</code>, or <code>WiFiClientSecure</code>:</p>
<pre><code class="hljs language-diff"><span class="hljs-deletion">- deserializeJson(doc, client.readString());</span>
<span class="hljs-addition">+ deserializeJson(doc, client);</span>
</code></pre>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Passing a `Stream` to `deserializeJson()` fixes the issue"},{id:"stream",page:104,label:"No",summary:"Passing a `Stream` to `deserializeJson()` doesn't fix the issue"}]},{content:`<p><code>EmptyInput</code> could be caused by a timeout while reading the response.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Increasing the timeout fixes the issue"},{id:"timeout-increased",page:110,label:"No",summary:"Increasing the timeout doesn't fix the issue"}]},{content:`<p>This confirms that the problem comes from the input: it is indeed empty, or at least starts with a NUL character.</p>
...
<p>What do you see?</p>
`,options:[{id:"zero",page:113,label:"<code>0</code>",summary:"The first character is NUL"},{id:"non-zero",page:1,label:"Something else",summary:"The first character is not NUL"}]},{content:`<p>Please print the ASCII code for the first character, like so:</p>
...
<p>What do you see?</p>
`,options:[{id:"zero",page:113,label:"<code>0</code>",summary:"The first character is NUL"},{id:"non-zero",page:1,label:"Something else",summary:"The first character is not NUL"}]},{content:`<p>The input is probably starting with a NUL character.</p>
<p>What type of input are you passing to <code>deserializeJson()</code>?</p>
`,options:[{id:"string",page:115,label:"A string (<code>const char*</code>, <code>String</code>, <code>std::string</code>...)",summary:"Input type is a string"},{id:"stream",page:114,label:"A stream (<code>Serial</code>, <code>WiFiClient</code>, <code>File</code>...)",summary:"Input type is a stream"}]},{content:`<p><code>deserializeJson()</code> also returns <code>EmptyInput</code> when the input contains only spaces.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Adding a wait loop fixes the issue"},{id:"available",page:117,label:"No",summary:"Adding a wait loop doesn't fix the issue"}]},{content:`<p><code>IncompleteInput</code> means that <code>deserializeJson()</code> managed to parse the beginning of the JSON document, but the end was missing.</p>
<p>What type of input do you pass to <code>deserializeJson()</code>?</p>
`,options:[{id:"stream",page:122,label:"A stream",summary:"Input comes from a stream"},{id:"string",page:123,label:"A string object (like <code>String</code>)",summary:"Input comes from a string object"},{id:"pointer",page:124,label:"A pointer (like <code>char*</code> or <code>const char*</code>)",summary:"Input comes from a pointer"}]},{content:`<p><code>IncompleteInput</code> can be caused by an interruped connection. For example, this problem happens when the client reads to slowly.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Adding a buffer solves the issue"},{id:"same-with-buffer",page:121,label:"No",summary:"Adding a buffer doesn't solve the issue"}]},{content:`<p>Maybe seeing where the input stops will give you an idea of what's going wrong.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Inreasing the timeout solves the issue"},{id:"timeout-increased",page:120,label:"No",summary:"Inreasing the timeout doesn't solve the issue"}]},{content:`<p>Please print the content of the string to the serial port, like so:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:2,label:"Yes",summary:"Calling `String::reserve()` solves the issue"},{id:"1",page:125,label:"No",summary:"Calling `String::reserve()` doesn't solve the issue"}]},{content:`<p>I'll assume that your input is stored in a buffer similar to this one:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:2,label:"Yes",summary:"Increasing the buffer size solves the issue"},{id:"1",page:125,label:"No",summary:"Increasing the buffer size doesn't solve the issue"}]},{content:`<p>To reduce the memory usage, you should try to pass the source (file, connection, stream, etc) directly to <code>deserializeJson()</code>, either via the <a href="https://www.arduino.cc/reference/en/language/functions/communication/stream/"><code>Stream</code></a> interface or via a <a href="/news/2019/11/01/version-6-13-0/">custom reader</a>. This will avoid the need for an intermediate buffer.</p>
...
`,options:[{id:"http",page:135,label:"An HTTP response",summary:"Input comes from HTTP"},{id:"serial",page:162,label:"A serial port",summary:"Input comes from a serial port"},{id:"file",page:134,label:"A file",summary:"Input comes from a file"},{id:"stream",page:165,label:"A stream",summary:"Input comes from a stream"},{id:"string",page:167,label:"A string (like <code>String</code> or <code>const char*</code>)",summary:"Input comes from a string"},{id:"char-ptr",page:129,label:"A char array or pointer (like <code>char[]</code> or <code>char*</code>)",summary:"Input comes from a char array"}]},{content:`<p>If you must keep the two calls to <code>deserializeJson()</code>, you need to disable the zero-copy mode by passing a read-only input buffer. Casting the pointer will do the trick:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// replace this:</span>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Casting the pointer fixes the issue"},{id:"cast",page:167,label:"No",summary:"Casting the pointer doesn't fix the issue"}]},{content:`<p>When you pass a writeable buffer as the input of <code>deserializeJson()</code>, ArduinoJson uses the zero-copy mode. Instead of copying the strings from the input into the <code>JsonDocument</code>, it stores pointers to the input buffer.</p>
...
`,options:[{id:"success",page:2,label:"Yes, and it fixes the issue",summary:"Removing the second call fixes the issue"},{id:"second-removed",page:167,label:"Yes, but it doesn't fix the issue",summary:"Removing the second call doesn't fix the issue"},{id:"cannot-remove",page:127,label:"No",summary:"The second call cannot be removed"}]},{content:`<p>Did you call <code>deserializeJson()</code> twice with the same input buffer?</p>
`,options:[{id:"two-calls",page:128,label:"Yes",summary:"Program calls `deserializeJson()` twice"},{id:"one-call",page:167,label:"No",summary:"Program doesn't call `deserializeJson()` twice"}]},{content:`<p>So, the JSON document is valid and not preceded by anything; yet, <code>deserializeJson()</code> returns <code>InvalidInput</code>.</p>
...
`,options:[{id:"utf8",page:132,label:"<code>239</code>",summary:"Input's first byte suggests a UTF-8 BOM"},{id:"utf16",page:131,label:"<code>254</code> or <code>255</code>",summary:"Input's first byte suggests a UTF-16 BOM"},{id:"no-bom",page:130,label:"Something else",summary:"Input's first byte doesn't suggest a BOM"}]},{content:`<p>We need to make sure that the JSON document is valid.
...
`,options:[{id:"valid",page:133,label:"Yes",summary:"`jsonlint` says the document is valid"},{id:"invalid",page:151,label:"No",summary:"`jsonlint` says the document is invalid"}]},{content:`<p>Do you use an HTTP library?</p>
`,options:[{id:"httpclient",page:136,label:"Yes, I'm using <code>HTTPClient</code>",summary:"Program uses `HTTPClient`"},{id:"http-library",page:149,label:"Yes, but it's not <code>HTTPClient</code>",summary:"Program uses an unknown HTTP library"},{id:"no-library",page:145,label:"No",summary:"Program doesn't use an HTTP library"}]},{content:`<p>Did you check the status code?</p>
`,options:[{id:"status-ok",page:138,label:"Yes",summary:"The program already checks the status code"},{id:"check-status",page:137,label:"No",summary:"The program doesn't check the status code"}]},{content:`<p>Please check the status code like so:</p>
...
<p>What do you get?</p>
`,options:[{id:"ok",page:138,label:"<code>200</code>",summary:"The status code is `200`"},{id:"positive",page:141,label:"A positive number (but not <code>200</code>)",summary:"The status code is positive"},{id:"negative",page:140,label:"A negative number",summary:"The status code is negative"}]},{content:`<p>Which function of <code>HTTPClient</code> do you call to get the response?</p>
`,options:[{id:"getstream",page:144,label:"<code>getStream()</code>",summary:"Response comes from `HTTPClient::getStream()`"},{id:"getstring",page:167,label:"<code>getString()</code>",summary:"Response comes from `HTTPClient::getString()`"},{id:"readstring",page:139,label:"<code>readString()</code>",summary:"Response comes from `HTTPClient::readString()`"}]},{content:`<p>You're calling the wrong function:</p>
<ul>
...
`,options:[{id:"success",page:2,label:"Yes",summary:"Calling `HTTPClient::getString()` solves the issue"},{id:"getstring",page:167,label:"No",summary:"Calling `HTTPClient::getString()` doesn't solves the issue"}]},{content:`<p>A negative number indicates an error on the client side.</p>
<p>Here are the possible values that I'm aware of:</p>
<table class="table">
<thead>
<tr>
...
<p>Did this solve your problem?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Calling `HTTPClient::useHTTP10(true)` solves the issue"},{id:"changed",page:143,label:"No",summary:"Calling `HTTPClient::useHTTP10(true)` doesn't solve the issue"}]},{content:`<p>We need to make sure that the JSON document is valid.
...
<p>Is the JSON document valid?</p>
`,options:[{id:"valid",page:163,label:"Yes",summary:"jsonlint says the document is valid"},{id:"invalid",page:151,label:"No",summary:"jsonlint says the document is invalid"}]},{content:`<p>Did you call <code>HTTPClient::useHTTP10(true)</code>?</p>
`,options:[{id:"http10-true",page:143,label:"Yes",summary:"Program calls `HTTPClient::useHTTP10(true)`"},{id:"http10-false",page:142,label:"No",summary:"Program doesn't call `HTTPClient::useHTTP10(true)`"}]},{content:`<p>Before calling <code>deserializeJson()</code>, did you skip the HTTP headers?</p>
`,options:[{id:"headers-skipped",page:148,label:"Yes",summary:"HTTP headers are skipped"},{id:"headers-not-skipped",page:147,label:"No",summary:"HTTP headers are not skipped"}]},{content:`<p>On some Arduino core (most notably <a href="https://github.com/arduino/ArduinoCore-avr/blob/master/cores/arduino/Stream.h">AVR core</a>), <a href="https://www.arduino.cc/reference/en/language/functions/communication/stream/streamfind/"><code>Stream::find()</code></a> takes a <code>char*</code> instead of a <code>const char*</code>. In this case, you'll get a compiler warning, which you can fix by extracting a char array, like so:</p>
...
<p>Did this fix your problem?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Skipping HTTP headers solves the issue"},{id:"warning",page:146,label:"Yes, but there is a compiler warning about <code>client.find()</code>",summary:"Skipping HTTP headers solves the issue, but there is a warning"},{id:"header-skipped",page:148,label:"No",summary:"Skipping HTTP headers doesn't solve the issue"}]},{content:`<p>When you use HTTP 1.1, the server can send the response with <a href="https://en.wikipedia.org/wiki/Chunked_transfer_encoding">Chunked Transfer Encoding</a>.
As a result, the response's body may contain some hexadecimal number at the begining of each chunk.
The most straightforward workaround is to downgrade the connection to HTTP 1.0.</p>
<p>To do this, replace <code>HTTP/1.1</code> with <code>HTTP/1.0</code> in the first line of the request.</p>
<p>Did this solve your problem?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Using `HTTP/1.0` solves the issue"},{id:"http10",page:150,label:"No",summary:"Using `HTTP/1.0` doesn't solve the issue"}]},{content:`<p>Unfortunately, I only know how to use the following HTTP libraries:</p>
<ul>
...
`,options:[{id:"stream",page:163,label:"A stream",summary:"The input is a stream"},{id:"string",page:166,label:"A string",summary:"The input is a string"}]},{content:`<p>What is wrong with this JSON document?</p>
`,options:[{id:"comments",page:152,label:"It contains comments",summary:"The document contains comments"},{id:"other-error",page:153,label:"Something else",summary:"The document doesn't contain comments"}]},{content:`<p><code>deserializeJson()</code> can read JSON documents that contain comments, but the support is disabled by default to reduce the footprint of the library.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Increasing serial buffer size solves the issue"},{id:"larger-buffer",page:163,label:"No",summary:"Increasing serial buffer size doesn't solves the issue"}]},{content:`<p>Any electric wire acts as an antenna; the longer the wire, the stronger the effect. This antenna picks up every electromagnetic field in the environment, which induces a current in the wire. On long wires, this current is strong enough to introduce errors in the communication.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Upgrading the cables solves the issue"},{id:"improved",page:157,label:"Somehow",summary:"Upgrading the cables improves the situation"},{id:"no-improvment",page:158,label:"No",summary:"Upgrading the cables doesn't solve the issue"}]},{content:`<p><code>deserializeJson()</code> may return <code>InvalidInput</code> because it starts reading the input mid-stream.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Flushing the serial buffer fixes the issue"},{id:"flush",page:161,label:"No",summary:"Flushing the serial buffer doesn't fix the issue"}]},{content:`<p><a href="https://en.wikipedia.org/wiki/Error_correction_code">Error-correction codes (ECC)</a> are a way of transmitting the data with redundant information that allows the receiver to fix most of the errors.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Error-correction codes fix the issue"},{id:"ecc",page:158,label:"No",summary:"Error-correction codes doesn't fix the issue"}]},{content:`<p>We need to make sure that the JSON document is valid.
To do that, please print the input to the serial port, like so:</p>
...
<p>Then, copy the response and paste it in a JSON linter, like <a href="https://jsonlint.com/">jsonlint.com</a>.</p>
<p>Is the JSON document valid?</p>
`,options:[{id:"valid",page:154,label:"Yes",summary:"`jsonlint` says the document is valid"},{id:"invalid",page:151,label:"No",summary:"`jsonlint` says the document is invalid"}]},{content:`<p>Any kind of communication is subject to errors: sometimes you send a <code>1</code> and receive a <code>0</code>.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Removing `SoftwareSerial` solves the issue"},{id:"removed",page:161,label:"No",summary:"Removing `SoftwareSerial` doesn't solve the issue"}]},{content:`<p>Not all microcontrollers use the same voltage for the serial port.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"The issue is a voltage mismatch"},{id:"voltage-ok",page:159,label:"No",summary:"The issue is not a voltage mismatch"}]},{content:`<p>Are you using <a href="https://www.arduino.cc/en/Reference/SoftwareSerial"><code>SoftwareSerial</code></a>?</p>
`,options:[{id:"software",page:160,label:"Yes",summary:"Program uses `SoftwareSerial`"},{id:"hardware",page:156,label:"No",summary:"Program doesn't use `SoftwareSerial`"}]},{content:`<p>We must check that the JSON document is not preceded by a  <a href="https://en.wikipedia.org/wiki/Byte_order_mark">Byte Order Mark</a> (BOM).</p>
...
<p>What value does it print?</p>
`,options:[{id:"utf8",page:132,label:"<code>239</code>",summary:"Input's first byte suggests a UTF-8 BOM"},{id:"utf16",page:131,label:"<code>254</code> or <code>255</code>",summary:"Input's first byte suggests a UTF-16 BOM"},{id:"no-bom",page:130,label:"Something else",summary:"Input's first byte doesn't suggest a BOM"}]},{content:`<p>Sometimes, the input is invalid because some bytes were dropped when receiving the document.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Adding a buffer solves the issue"},{id:"buffer",page:163,label:"No",summary:"Adding a buffer doesn't solve the issue"}]},{content:`<p>We need to make sure that the JSON document is valid.
To do that, please print the input to the serial port, like so:</p>
...
<p>Then, copy the response and paste it in a JSON linter, like <a href="https://jsonlint.com/">jsonlint.com</a>.</p>
<p>Is the JSON document valid?</p>
`,options:[{id:"valid",page:164,label:"Yes",summary:"`jsonlint` says the document is valid"},{id:"invalid",page:151,label:"No",summary:"`jsonlint` says the document is invalid"}]},{content:`<p>We must check that the JSON document is not preceded by a  <a href="https://en.wikipedia.org/wiki/Byte_order_mark">Byte Order Mark</a> (BOM).</p>
...
<p>Then, copy the response and paste it in a JSON linter, like <a href="https://jsonlint.com/">jsonlint.com</a>.</p>
<p>Is the JSON document valid?</p>
`,options:[{id:"valid",page:166,label:"Yes",summary:"`jsonlint` says the document is valid"},{id:"invalid",page:151,label:"No",summary:"`jsonlint` says the document is invalid"}]},{content:`<p>So, what's the problem then?</p>
`,options:[{id:"slow",page:194,label:"It's slow",summary:"Deserialisation is slow"},{id:"invalid",page:169,label:"I expected <code>InvalidInput</code> instead of <code>Ok</code>",summary:"`Ok` is incorrect; it should be `InvalidInput`"},{id:"crash",page:90,label:"My program crashes after calling <code>deserializeJson()</code>",summary:"Program crashes after calling `deserializeJson()`"},{id:"empty",page:183,label:"<code>JsonDocument</code> returns empty/null values",summary:"Program fails to extract values from the `JsonDocument`"},{id:"missing",page:181,label:"Some values are missing",summary:"Some values are missing"},{id:"garbage",page:173,label:"<code>JsonDocument</code> returns garbage",summary:"`JsonDocument` returns garbage"},{id:"changing-strings",page:173,label:"The strings in the <code>JsonDocument</code> change for no reason",summary:"The strings in the `JsonDocument` change for no reason"},{id:"altered",page:177,label:"<code>deserializeJson()</code> alters the content of the input",summary:"Input buffer is modified"},{id:"truncated-strings",page:195,label:"Some strings are truncated",summary:"Some strings are truncated"}]},{content:`<p>What's the first character of your input?</p>
`,options:[{id:"brace",page:170,label:"An opening brace: <code>{</code>",summary:"The first character is `{`"},{id:"bracket",page:171,label:"An opening bracket: <code>[</code>",summary:"The first character is `[`"},{id:"quote",page:172,label:"A quote: <code>&quot;</code>",summary:'The first character is `"`'},{id:"other",page:202,label:"None of the above",summary:'The first character is neither `{`, nor `[`, nor `"`'}]},{content:`<p><code>deserializeJson()</code> stops reading as soon as the JSON document ends.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Garbage characters follow the input"},{id:"lint",page:180,label:"No",summary:"No garbage characters follow the input"}]},{content:`<p><code>deserializeJson()</code> stops reading as soon as the JSON document ends.
In your case, it will read the input until it reaches the matching <code>]</code> and ignore any remaining characters.</p>
<p>Suppose the input looks like this:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Garbage characters follow the input"},{id:"lint",page:180,label:"No",summary:"No garbage characters follow the input"}]},{content:`<p>What is the type of the second argument passed to <code>deserializeJson()</code>?</p>
`,options:[{id:"char-ptr",page:176,label:"<code>char*</code> (or <code>char[]</code>)",summary:"Input type is `char*`"},{id:"const-char-ptr",page:1,label:"<code>const char*</code>",summary:"Input type is `const char*`"},{id:"string",page:1,label:"<code>String</code> (or <code>std::string</code>)",summary:"Input type is `String`"},{id:"stream",page:1,label:"<code>Stream</code> (or <code>std::istream)</code>",summary:"Input type is `Stream`"}]},{content:`<p>The easiest solution is to disable the zero-copy mode by passing a read-only input buffer. Casting the pointer will do the trick:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// replace this:</span>
<span class="hljs-built_in">deserializeJson</span>(doc, input, inputSize);
...
`,options:[{id:"success",page:175,label:"Yes, the input comes from a stream",summary:"Input comes from a stream"},{id:"cast",page:174,label:"No, it doesn't",summary:"Input doesn't come from a stream"}]},{content:`<p>When you pass a writeable buffer as the input of <code>deserializeJson()</code>, ArduinoJson uses the zero-copy mode. Instead of copying the strings from the input into the <code>JsonDocument</code>, it stores pointers to the input buffer.</p>
<p>While doing this, the parser modifies the input buffer to unescape special characters and add string terminator.
...
<p>Did this solve your issue?</p>
`,options:[{id:"acceptable",page:2,label:"Yes",summary:"`deserializeJson()` tolerates the error, and that's OK"},{id:"unacceptable",page:202,label:"No",summary:"`deserializeJson()` should not let this error pass"}]},{content:`<p>So, <code>deserializeJson()</code> returns <code>Ok</code>, and jsonlint confirms that the input is valid.</p>
...
`,options:[{id:"valid",page:179,label:"Document is valid",summary:"jsonlint says the document is valid"},{id:"invalid",page:178,label:"Document is invalid",summary:"jsonlint says the document is invalid"}]},{content:`<p>Is the JSON document big?</p>
`,options:[{id:"big",page:182,label:"Yes, it contains hundred of values",summary:"The JSON document is large"},{id:"small",page:1,label:"No, it doesn't contain that many values",summary:"The JSON document is not large"}]},{content:`<p>Indeed, due to an optimization, a <code>JsonDocument</code> is limited in the number of nodes it can contain.
...
`,options:[{id:"filter",page:186,label:"Yes",summary:"Program uses `DeserializationOption::Filter`"},{id:"no-filter",page:190,label:"No",summary:"Program doesn't use `DeserializationOption::Filter`"}]},{content:`<p>When a program fails to extract the values from a <code>JsonDocument</code>, it's often because there is a confusion between arrays and objects.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Fixing the filter solves the issue"},{id:"filter-ok",page:190,label:"No",summary:"Fixing the filter doesn't solve the issue"}]},{content:`<p>Please print the filter to the serial port like so:</p>
...
`,options:[{id:"size-ok",page:185,label:"Yes",summary:"The filter looks correct"},{id:"too-small",page:187,label:"No, some values are missing",summary:"The filter lacks some values"}]},{content:`<p>The filter's <code>JsonDocument</code> is too small; please increase its capacity and try again.</p>
<p>If you want, you can use the <a href="/v6/assistant/">ArduinoJson Assistant</a> to compute the required capacity.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Increasing the filter's capacity fixes the issue"},{id:"size-increased",page:185,label:"No",summary:"Increasing the filter's capacity doesn't fix the issue"}]},{content:`<p>Which function do you call to deserialize the input?</p>
`,options:[{id:"json",page:1,label:"<code>deserializeJson()</code>",summary:"Program calls `deserializeJson()`"},{id:"msgpack",page:189,label:"<code>deserializeMsgPack()</code>",summary:"Program calls `deserializeMsgPack()`"}]},{content:`<p>It seems that your program fed <code>deserializeMsgPack()</code> with garbage input.</p>
...
`,options:[{id:"quote",page:193,label:"A quote (<code>&quot;</code>)",summary:"Serialized document starts with a quote"},{id:"bracket",page:184,label:"A square bracket (<code>[</code>)",summary:"Serialized document starts with a square bracket"},{id:"brace",page:184,label:"A curly brace (<code>{</code>)",summary:"Serialized document starts with a curly brace"},{id:"not-in-list",page:188,label:"None of the above",summary:"Serialized document starts with neither a quote, a bracket, nor a brace."}]},{content:`<p>If you cannot fix the server, you can at least reverse the double serialization (stringification) to get back the original object.</p>
...
`,options:[{id:"nul",page:217,label:"Yes",summary:"The input contains `\\u0000`"},{id:"no-nul",page:201,label:"No",summary:"The input doesn't contain `\\u0000`"}]},{content:`<p>When you call <code>HTTPClient::getStream()</code>, you bypass the part that handles <a href="https://en.wikipedia.org/wiki/Chunked_transfer_encoding">Chunked Transfer Encoding</a>.
...
`,options:[{id:"getstream",page:196,label:"<code>getStream()</code>",summary:"Response comes from `HTTPClient::getStream()`"},{id:"getstring",page:1,label:"<code>getString()</code>",summary:"Response comes from `HTTPClient::getString()`"}]},{content:`<p>When you use HTTP 1.1, the server can send the response with <a href="https://en.wikipedia.org/wiki/Chunked_transfer_encoding">Chunked Transfer Encoding</a>.
As a result, the response's body may be split in multiple chunks, making some strings look like they are truncated (in reality, they contain a line-break).</p>
<p>The most straightforward workaround is to downgrade the connection to HTTP 1.0.
...
`,options:[{id:"httpclient",page:197,label:"Yes, I'm using <code>HTTPClient</code>",summary:"Program uses `HTTPClient`"},{id:"http-library",page:199,label:"Yes, but it's not <code>HTTPClient</code>",summary:"Program uses an unknown HTTP library"},{id:"no-library",page:198,label:"No",summary:"Program doesn't use an HTTP library"}]},{content:`<p>Does the JSON input come from an HTTP response?</p>
`,options:[{id:"http",page:200,label:"Yes",summary:"The input comes from an HTTP response"},{id:"no-nul",page:1,label:"No",summary:"The input doesn't come from an HTTP response"}]},{content:`<p><code>deserializeJson()</code> accepted a JSON document that was clearly invalid.<br>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Increasing the capacity of the `JsonDocument` fixes the issue"},{id:"increased-capacity",page:210,label:"No",summary:"Increasing the capacity of the `JsonDocument` doesn't fix the issue"}]},{content:`<p>I'm pretty confident the Assistant computes the right capacity; however, some settings can affect the result:</p>
<ol>
...
`,options:[{id:"global",page:205,label:"Yes",summary:"`doc` is a global variable"},{id:"local",page:204,label:"No",summary:"`doc` is not a global variable"}]},{content:`<p>Let's verify that the memory allocation succeeded.</p>
<p>Please print the capacity of the <code>JsonDocument</code> to the serial port, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">capacity</span>());
</code></pre>
<p>What value does it show?</p>
`,options:[{id:"capacity-0",page:206,label:"<code>0</code>",summary:"`doc.capacity()` returns `0`"},{id:"capacity-ok",page:204,label:"The value passed to the constructor of <code>DynamicJsonDocument</code>",summary:"`doc.capacity()` returns the right value"}]},{content:`<p>Well, that's very bad news. It seems that your microcontroller doesn't have enough RAM to hold the JSON document.</p>
...
<p>What value does it show?</p>
`,options:[{id:"capacity-0",page:208,label:"<code>0</code>",summary:"`doc.capacity()` returns `0`"},{id:"capacity-ok",page:204,label:"The value passed to the constructor of <code>DynamicJsonDocument</code>",summary:"`doc.capacity()` returns the right value"}]},{content:`<p>What kind of <code>JsonDocument</code> are you using?</p>
`,options:[{id:"basic",page:207,label:"<code>BasicJsonDocument&lt;T&gt;</code>",summary:"The document is a `BasicJsonDocument<T>`"},{id:"dynamicjsondocument",page:209,label:"<code>DynamicJsonDocument</code>",summary:"The `JsonDocument` is a `DynamicJsonDocument`"},{id:"staticjsondocument",page:204,label:"<code>StaticJsonDocument</code>",summary:"The `JsonDocument` is a `StaticJsonDocument`"}]},{content:`<p><code>NotSupported</code> means that the document was valid but contained features not supported by the library.</p>
...
`,options:[{id:"can-uprade",page:215,label:"Yes",summary:"Library can be upgraded"},{id:"cannot-upgrade",page:213,label:"No",summary:"Library cannot be upgraded"}]},{content:`<p>So, I guess that you're not using <code>deserializeJson()</code> but <code>deserializeMsgPack()</code>, right?</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Defining `ARDUINOJSON_DECODE_UNICODE` solves the issue"},{id:"decode-unicode-set",page:212,label:"No",summary:"Defining `ARDUINOJSON_DECODE_UNICODE` doesn't solve the issue"}]},{content:`<p>If you're still seeing <code>NotSupported</code> after upgrading the library, it means that your code is not using the upgraded library.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Removing duplicates fixes the issue"},{id:"duplicates-removed",page:213,label:"No",summary:"Removing duplicates doesn't fix the issue"}]},{content:`<p>Please upgrade ArduinoJson to the latest version.<br>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Upgrading solves the issue"},{id:"updraded",page:214,label:"No",summary:"Upgrading doesn't solves the issue"}]},{content:`<p><code>TooDeep</code> means that the input document has too many levels of nesting.</p>
...
`,options:[{id:"crash",page:219,label:"The program crashes",summary:"Program crashes"},{id:"empty",page:229,label:"The output is empty (e.g. <code>{}</code>, <code>[]</code>, or <code>null</code>)",summary:"Output is empty"},{id:"incomplete",page:258,label:"The output is incomplete",summary:"Output is incomplete"},{id:"garbage",page:241,label:"The output contains garbage",summary:"Output contains garbage"},{id:"empty-strings",page:235,label:"The output contains empty strings",summary:"Output contains empty strings"},{id:"null",page:258,label:"The output contains <code>null</code>",summary:"Output contains null"},{id:"float",page:238,label:"Floating-point values contain too many decimal digits",summary:"Floating-point values contain too many decimal digits"},{id:"slow",page:270,label:"It's slow",summary:"Serialization is slow"}]},{content:`<p>Do you use <code>DynamicJsonDocument</code> or <code>StaticJsonDocument</code>?</p>
`,options:[{id:"dynamicjsondocument",page:227,label:"<code>DynamicJsonDocument</code>",summary:"Program uses `DynamicJsonDocument`"},{id:"staticjsondocument",page:228,label:"<code>StaticJsonDocument</code>",summary:"Program uses `StaticJsonDocument`"}]},{content:`<p>Please replace all those string pointers with literals.</p>
...
<p>Does your program still crash?</p>
`,options:[{id:"crash-with-literals",page:223,label:"Yes",summary:"Replacing string pointers with literals doesn't fix the crash"},{id:"no-crash-with-literals",page:221,label:"No",summary:"Replacing string pointers with literals fixes the crash"}]},{content:`<p>One of these string pointers is probably dangling or points to a non-zero-terminated string.</p>
...
`,options:[{id:"charptr",page:220,label:"Yes",summary:"Program inserts string pointers into the `JsonDocument`"},{id:"no-charptr",page:223,label:"No",summary:"Program doesn't insert string pointers into the `JsonDocument`"}]},{content:`<p>What is the type of the second argument passed to <code>serializeJson()</code>?</p>
`,options:[{id:"char-array",page:224,label:"<code>char[]</code>",summary:"Output type is `char[]`"},{id:"char-ptr",page:225,label:"<code>char*</code>",summary:"Output type is `char*`"},{id:"arduino-string",page:1,label:"<code>String</code>",summary:"Output type is `String`"},{id:"arduino-stream",page:1,label:"<code>Stream</code>",summary:"Output type is `Stream`"}]},{content:`<p>I think this output buffer could cause a <a href="https://en.wikipedia.org/wiki/Stack_buffer_overflow">stack overflow</a>.</p>
...
`,options:[{id:"progmem",page:226,label:"Yes",summary:"Program uses `PROGMEM`"},{id:"no-progmem",page:222,label:"No",summary:"Program doesn't use `PROGMEM`"}]},{content:`<p>Because a <code>StaticJsonDocument</code> resides on the stack, it may cause a <a href="https://en.wikipedia.org/wiki/Stack_buffer_overflow">stack-overflow</a>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Switching to `DynamicJsonDocument` fixes the issue"},{id:"dynamicjsondocument-tried",page:227,label:"No",summary:"Switching to `DynamicJsonDocument` doesn't fix the issue"}]},{content:`<p>Please print the capacity of the <code>JsonDocument</code> to the serial port, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">capacity</span>());
</code></pre>
<p>What value does it show?</p>
`,options:[{id:"capacity-0",page:233,label:"<code>0</code>",summary:"`doc.capacity()` returns `0`"},{id:"capacity-ok",page:234,label:"a positive integer",summary:"`doc.capacity()` looks good"}]},{content:`<p><code>doc.capacity()</code> returns <code>0</code>, which means <code>allocate()</code> returned <code>NULL</code>.</p>
<p>I think that, because <code>doc</code> is declared global, <code>allocate()</code> is called too early and the heap isn't ready.
I know this happens on ESP32 with the <code>SpiRamJsonDocument</code> shown in <a href="/v6/how-to/use-external-ram-on-esp32/">How to use external RAM on ESP32?</a>.</p>
<p>Please try to make <code>doc</code> a local variable.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Making `doc` local fixes the issue."},{id:"failure",page:1,label:"No",summary:"Making `doc` local doesn't fix the issue."}]},{content:`<p>Is <code>doc</code> a global variable?</p>
`,options:[{id:"global",page:230,label:"Yes",summary:"`doc` is a global variable"},{id:"local",page:232,label:"No",summary:"`doc` is not a global variable"}]},{content:`<p>Well, that's very bad news. It seems that your microcontroller doesn't have enough RAM to hold the JSON document.</p>
<p>Please read <a href="/v6/how-to/reduce-memory-usage/">How to reduce memory usage</a>.
It shows several techniques you can use to use less RAM.
Hopefully, you'll make enough room for the memory pool.</p>
<p>Did this solve your issue?</p>
...
`,options:[{id:"char-ptr",page:236,label:"<code>char*</code> (or <code>char[]</code>)",summary:"Input type is `char*`"},{id:"const-char-ptr",page:1,label:"<code>const char*</code>",summary:"Input type is `const char*`"},{id:"string",page:1,label:"<code>String</code> (or <code>std::string</code>)",summary:"Input type is `String`"},{id:"stream",page:1,label:"<code>Stream</code> (or <code>std::istream)</code>",summary:"Input type is `Stream`"}]},{content:`<p>Supposing that the JSON output looks like this:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Replacing `float` with `double` fixes the issue"},{id:"double",page:240,label:"No",summary:"Replacing `float` with `double` doesn't fix the issue"}]},{content:`<p>I'm surprised that the previous solution didn't work.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Rounding the value fixes the issue"},{id:"double",page:239,label:"No",summary:"Rounding the value doesn't fix the issue"}]},{content:`<p>What function produces the garbage?</p>
`,options:[{id:"json",page:248,label:"<code>serializeJson()</code> (or <code>serializeJsonPretty()</code>)",summary:"`serializeJson()` produces garbage"},{id:"msg",page:253,label:"<code>serializeMsgPack()</code>",summary:"`serializeMsgPack()` produces garbage"}]},{content:`<p>When you pass a writeable buffer as the input of <code>deserializeJson()</code>, ArduinoJson uses the <strong>zero-copy mode</strong>. Instead of copying the strings from the input into the <code>JsonDocument</code>, it stores pointers to the input buffer.
Therefore, the input buffer must stay alive during the whole lifetime of the <code>JsonDocument</code>; otherwise, all the strings in the <code>JsonDocument</code> will be dangling pointers.</p>
<p>The easiest solution is to disable the zero-copy mode by passing a read-only input buffer. Casting the pointer will do the trick:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// replace this:</span>
<span class="hljs-built_in">deserializeJson</span>(doc, input, inputSize);
...
<p>Now that the zero-copy mode is disabled, you probably need a larger <code>JsonDocument</code>, so don't forget to update the capacity. As usual, use the <a href="/v6/assistant/">ArduinoJson Assistant</a> to compute the right capacity for your project.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Casting the pointer fixes the issue"},{id:"casting-fails",page:257,label:"No",summary:"Casting the pointer doesn't fix the issue"}]},{content:`<p>What's the type of the second argument passed to <code>deserializeJson()</code>?</p>
`,options:[{id:"char-ptr",page:242,label:"<code>char*</code> (or <code>char[]</code>)",summary:"Input type is `char*`"},{id:"const-char-ptr",page:257,label:"<code>const char*</code>",summary:"Input type is `const char*`"},{id:"string",page:257,label:"<code>String</code> (or <code>std::string</code>)",summary:"Input type is `String`"},{id:"stream",page:257,label:"<code>Stream</code> (or <code>std::istream)</code>",summary:"Input type is `Stream`"}]},{content:`<p>You can insert <a href="https://www.arduino.cc/reference/en/language/variables/data-types/stringobject/"><code>String</code></a> objects in a <code>JsonDocument</code>, but make sure you don't store the result of <a href="https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/c_str/"><code>String::c_str()</code></a>.</p>
...
`,options:[{id:"string",page:244,label:"Yes",summary:"Program uses `String`"},{id:"no-string",page:1,label:"No",summary:"Program doesn't use `String`"}]},{content:`<p><code>StaticJsonDocument</code> stores its memory pool in the stack.
...
<p>Please switch to a <code>DynamicJsonDocument</code>.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Switching to `DynamicJsonDocument` fixes the issue"},{id:"dynamic",page:245,label:"No",summary:"Switching to `DynamicJsonDocument` doesn't fix the issue"}]},{content:`<p>Which kind of <code>JsonDocument</code> do you use?</p>
`,options:[{id:"dynamic",page:245,label:"<code>DynamicJsonDocument</code>",summary:"Program uses `DynamicJsonDocument`"},{id:"static",page:246,label:"<code>StaticJsonDocument</code>",summary:"Program uses `StaticJsonDocument`"}]},{content:`<p>Do you call <code>deserializeJson()</code> before calling <code>serializeJson()</code>? (with the same <code>JsonDocument</code>)</p>
`,options:[{id:"deserialize-yes",page:243,label:"Yes",summary:"Program calls `deserializeJson()`"},{id:"deserialize-no",page:257,label:"No",summary:"Program doesn't call `deserializeJson()`"}]},{content:`<p><code>JsonArray</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:256,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>JsonObject</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
...
<p>This way, you can keep the <code>JsonDocument</code> alive when you call <code>serializeJson()</code></p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:256,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>JsonVariant</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
...
<p>This way, you can keep the <code>JsonDocument</code> alive when you call <code>serializeJson()</code></p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:256,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>serializeMsgPack()</code> share a lot of code with <code>serializeJson()</code>. There is no reason you should produce garbage with one and not the other. You may have found a bug.</p>
...
`,options:[{id:"json",page:248,label:"Yes, <code>serializeJson()</code> produces garbage too",summary:"`serializeJson()` produces garbage too"},{id:"deserialize-no",page:252,label:"No, <code>serializeJson()</code> doesn't produces garbage",summary:"`serializeJson()` doesn't produces garbage"}]},{content:`<p><code>JsonDocument::garbageCollect()</code> invalidates all previously acquired <code>JsonArray</code>, <code>JsonObject</code>, and <code>JsonVariant</code>.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Reassigning references fixes the issue"},{id:"reassigned",page:247,label:"No",summary:"Reassigning references doesn't fix the issue"}]},{content:`<p><code>JsonDocument::shrinkToFit()</code> invalidates all previously acquired <code>JsonArray</code>, <code>JsonObject</code>, and <code>JsonVariant</code>.</p>
<p>After you call it, make sure to reassign  every references, like so:</p>
<pre><code class="hljs language-c++">JsonObject cfg = doc.<span class="hljs-built_in">createNestedObject</span>(<span class="hljs-string">&quot;config&quot;</span>);
<span class="hljs-comment">// ...</span>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Reassigning references fixes the issue"},{id:"reassigned",page:247,label:"No",summary:"Reassigning references doesn't fix the issue"}]},{content:`<p>Do you use one of the following function?</p>
`,options:[{id:"garbagecollect",page:254,label:"<code>JsonDocument::garbageCollect()</code>",summary:"Program calls `JsonDocument::garbageCollect()`"},{id:"shrinktofit",page:255,label:"<code>JsonDocument::shrinkToFit()</code>",summary:"Program calls `JsonDocument::shrinkToFit()`"},{id:"none",page:247,label:"No",summary:"Program doesn't call an invalidating function"}]},{content:`<p>What is the type of the first argument passed to <code>serializeJson()</code>?</p>
`,options:[{id:"document",page:247,label:"<code>JsonDocument</code>",summary:"Program calls `serializeJson(const JsonDocument&, ...)`"},{id:"array",page:249,label:"<code>JsonArray</code> (or <code>JsonArrayConst</code>)",summary:"Program calls `serializeJson(JsonArrayConst, ...)`"},{id:"object",page:250,label:"<code>JsonObject</code> (or <code>JsonObjectConst</code>)",summary:"Program calls `serializeJson(JsonObjectConst, ...)`"},{id:"variant",page:251,label:"<code>JsonVariant</code> (or <code>JsonVariantConst</code>)",summary:"Program calls `serializeJson(JsonVariantConst, ...)`"}]},{content:`<p>Does your program call <code>serializeJson()</code> in a loop?</p>
`,options:[{id:"loop",page:265,label:"Yes",summary:"Program calls `serializeJson()` in a loop"},{id:"no-loop",page:266,label:"No",summary:"Program doesn't call `serializeJson()` in a loop"}]},{content:`<p>The ArduinoJson Assistant suggested a too small capacity because you didn't configure it properly.</p>
...
<p>What value does it print?</p>
`,options:[{id:"capacity-zero",page:260,label:"<code>0</code>",summary:"`JsonDocument::capacity()` returns `0`"},{id:"capacity-nonzero",page:1,label:"A number greater than <code>0</code>",summary:"`JsonDocument::capacity()` returns a number greater than `0`"}]},{content:`<p>Is the JSON document big?</p>
`,options:[{id:"big",page:269,label:"Yes, it contains hundred of values",summary:"The JSON document is large"},{id:"small",page:1,label:"No, it doesn't contain that many values",summary:"The JSON document is not large"}]},{content:`<p>Please replace the call to <code>JsonDocument::clear()</code> with <code>JsonDocument::garbageCollect()</code>.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Calling `JsonDocument::garbageCollect()` solves the issue"},{id:"gc",page:266,label:"No",summary:"Calling `JsonDocument::garbageCollect()` doesn't solve the issue"}]},{content:`<p>We can try to clear the content of the <code>JsonDocument</code>.</p>
<p>Please call <code>JsonDocument::clear()</code> at the beginning of the loop.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Calling `JsonDocument::clear()` solves the issue"},{id:"clear",page:266,label:"No",summary:"Calling `JsonDocument::clear()` doesn't solve the issue"},{id:"missing",page:263,label:"Yes, but now some values are missing",summary:"Calling `JsonDocument::clear()` solves the issue but removes other values"}]},{content:`<p>Calling <code>serializeJson()</code> is safe, but you'll run into issues if you modify the same <code>JsonDocument</code> in a loop.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Moving the `JsonDocument` inside the loop solves the issue"},{id:"inside",page:266,label:"No",summary:"Moving the `JsonDocument` inside the loop doesn't solve the issue"},{id:"outside",page:264,label:"I cannot move the declaration inside the loop",summary:"The `JsonDocument` cannot be moved inside the loop"}]},{content:`<p>Please print the value of <code>JsonDocument::overflowed()</code>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:268,label:"<code>1</code> (or <code>true</code>)",summary:"`JsonDocument::overflowed()` returns `true`"},{id:"overflowed-0",page:267,label:"<code>0</code> (or <code>false</code>)",summary:"`JsonDocument::overflowed()` returns `false`"}]},{content:`<p>Does one of the strings in the <code>JsonDocument</code> contains a NUL (i.e.,  ASCII code 0, or <code>\\u0000</code>)?</p>
`,options:[{id:"nul",page:217,label:"Yes",summary:"One or more strings contain a NUL"},{id:"no-nul",page:262,label:"No",summary:"No string contains a NUL"}]},{content:`<p><code>JsonDocument::overflowed()</code> returns <code>true</code> when you try to insert a value in the <code>JsonDocument</code>, but there isn't enough room to store it.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Increasing the capacity of the `JsonDocument` solves the issue."},{id:"assistant-is-wrong",page:259,label:"Yes, but the required capacity is greater than what the ArduinJson Assistant says.",summary:"The required capacity is greater than what the ArduinJson Assistant says."},{id:"capacity-increased",page:261,label:"No",summary:"Increasing the capacity of the `JsonDocument` doesn't solve the issue."}]},{content:`<p>Indeed, due to an optimization, a <code>JsonDocument</code> is limited in the number of nodes it can contain.
...
`,options:[{id:"compiletime",page:272,label:"At compile time",summary:"The issue happens at compile time"},{id:"runtime",page:283,label:"At run time",summary:"The issue happens at run time"}]},{content:`<p>Please look at the <strong>first</strong> error in the compiler output, and tell me what it is...</p>
`,options:[{id:"requires-cpp-compiler",page:85,label:"ArduinoJson requires a C++ compiler...",summary:'Error says "ArduinoJson requires a C++ compiler..."'},{id:"assignment-of-read-only-location",page:273,label:"assignment of read-only location",summary:'Error says "assignment of read-only location"'},{id:"ambiguous-string-assign",page:35,label:"ambiguous overload for <code>operator=</code> (operand types are <code>String</code> and ...)",summary:'Error says "ambiguous overload for `operator=` (operand types are `String` and ...)"'},{id:"begin-not-found",page:54,label:"<code>begin</code>: no matching overloaded function found",summary:'Error says "`begin`: no matching overloaded function found"'},{id:"error-constants",page:75,label:"<code>bits/error_constants.h</code>: No such file or directory",summary:'Error says "`bits/error_constants.h`: No such file or directory'},{id:"print-ambiguous",page:76,label:"call of overloaded <code>print(...)</code> is ambiguous",summary:'Error says "call of overloaded `print(...)` is ambiguous"'},{id:"cannot-bind-object-ref",page:73,label:"cannot bind non-const lvalue reference of type <code>ArduinoJson::JsonObject&amp;</code> ...",summary:'Error says "cannot bind non-const lvalue reference of type `ArduinoJson::JsonObject&` ..."'},{id:"class-has-no-member-named-read",page:282,label:"<code>class Xxx</code> has no member named <code>read</code>",summary:'Error says "`class Xxx` has no member named `read`"'},{id:"pointer-to-object",page:72,label:"<code>const void*</code> is not a pointer-to-object type",summary:'Error says "`const void*` is not a pointer-to-object type"'},{id:"doesnt-name-a-type",page:279,label:"<code>doc</code> does not name a type",summary:'Error says "`doc` does not name a type"'},{id:"dynamicjsonbuffer",page:274,label:"<code>DynamicJsonBuffer</code> is a class from ArduinoJson 5",summary:'Error says "`DynamicJsonBuffer` is a class from ArduinoJson 5"'},{id:"expected-identifier-before-string-constant",page:49,label:"expected identifier before string constant",summary:'Error says "expected identifier before string constant"'},{id:"char-pointer-conversion",page:39,label:"invalid conversion from <code>const char*</code> to <code>char*</code> [-fpermissive]",summary:'Error says "invalid conversion from `const char*` to `char*` [-fpermissive]"'},{id:"invalid-conversion",page:50,label:"invalid use of incomplete type <code>class InvalidConversion&lt;...&gt;</code>",summary:'Error says "invalid use of incomplete type `class InvalidConversion<...>`"'},{id:"jsondocument-not-declared",page:71,label:"<code>JsonDocument</code> was not declared in this scope",summary:'Error says "`JsonDocument` was not declared in this scope"'},{id:"no-matching-function",page:280,label:"no matching function for call to ...",summary:'Error says "no matching function for call to ..."'},{id:"passing-volatile-as-this-argument-discards-qualifiers",page:74,label:"passing <code>volatile ...</code> as <code>this</code> argument discards qualifiers [-fpermissive]",summary:'Error says "passing `volatile ...` as `this` argument discards qualifiers [-fpermissive]"'},{id:"cast-void-to-flashstringhelper",page:38,label:"reinterpret_cast from <code>const void</code> to <code>const __FlashStringHelper *</code> is not allowed",summary:'Error says "reinterpret_cast from `const void` to `const __FlashStringHelper *` is not allowed"'},{id:"request-for-member",page:77,label:"request for member ...",summary:'Error says "request for member ..."'},{id:"staticjsonbuffer",page:274,label:"<code>StaticJsonBuffer</code> is a class from ArduinoJson 5",summary:'Error says "`StaticJsonBuffer` is a class from ArduinoJson 5"'},{id:"struct-has-no-member-named-read",page:282,label:"<code>struct Xxx</code> has no member named <code>read</code>",summary:'Error says "`struct Xxx` has no member named `read`"'},{id:"range-based-for-requires-begin",page:54,label:"this range-based <code>for</code> statement requires a suitable &quot;begin&quot; function and none was found",summary:'Error says "this range-based `for` statement requires a suitable "begin" function and none was found"'},{id:"not-in-list",page:3,label:"None of the above",summary:"The error is not in the list"}]},{content:`<p>This error occurs when you pass a string to <code>JsonArray::operator[]</code>; i.e., when you use an array like an object.</p>
<p>For example, if you try to compile the following code:</p>
<pre><code class="hljs language-c++">JsonDocument doc;
...
<p>Is your program directly using ArduinoJson, or is it using a library that depends on ArduinoJson?</p>
`,options:[{id:"upgrade",page:275,label:"My program uses ArduinoJson directly",summary:"Program uses ArduinoJson directly"},{id:"keep-v5",page:277,label:"My program uses a library that depends on ArduinoJson",summary:"Program uses a library that depends on ArduinoJson"}]},{content:`<p>Can you upgrade the program or do you prefer keeping it as it is?</p>
`,options:[{id:"upgrade",page:278,label:"I'd like to upgrade to ArduinoJson 7",summary:"User prefers upgrading to ArduinoJson 7"},{id:"keep-v5",page:276,label:"I prefer not touching the program",summary:"User prefers keeping ArduinoJson 5"}]},{content:`<p>I recommend that you download <a href="https://github.com/bblanchon/ArduinoJson/releases/download/v5.13.5/ArduinoJson-v5.13.5.h"><code>ArduinoJson-v5.13.5.h</code></a> and save it among the project files, this way you're sure that the project is distributed with the right version of the library.</p>
<p>You can choose to keep the name <code>ArduinoJson-v5.13.5.h</code> and update the <code>#include</code> directive, or you can rename the file to <code>ArduinoJson.h</code>; either way is fine, as long as the header is in the same folder as the file that includes it.</p>
<p>Please see <a href="/v5/doc/installation/">installation instructions</a> for details</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Downloading ArduinoJson 5 fixes the issue"},{id:"failure",page:1,label:"No",summary:"Downloading ArduinoJson 5 doesn't fix the issue"}]},{content:`<p>Since you cannot upgrade the code of the library depending on ArduinoJson, the simplest solution is to downgrade ArduinoJson to version 5.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Moving statement to `setup()` fixes the issue"},{id:"failure",page:1,label:"No",summary:"Moving statement to `setup()` doesn't fix the issue"}]},{content:`<p>What follows &quot;no matching function for call to&quot;?</p>
`,options:[{id:"basicjsondocument",page:63,label:"<code>BasicJsonDocument::BasicJsonDocument()</code>",summary:'Error says "no matching function for call to `BasicJsonDocument::BasicJsonDocument()`"'},{id:"converttojson",page:64,label:"<code>convertToJson(...)</code>",summary:'Error says "no matching function for call to `convertToJson(...)`"'},{id:"deserializejson",page:65,label:"<code>deserializeJson(StaticJsonDocument&lt;200&gt; (&amp;)(), ...)</code>",summary:'Error says "no matching function for call to `deserializeJson(StaticJsonDocument<200> (&)(), ...)`"'},{id:"jsondocument-int",page:281,label:"<code>JsonDocument::JsonDocument(int)</code>",summary:'Error says "no matching function for call to `JsonDocument::JsonDocument(int)`"'},{id:"unresolved-overloaded-function-type",page:67,label:"<code>...(&lt;unresolved overloaded function type&gt;)</code>",summary:'Error says "no matching function for call to `...(<unresolved overloaded function type>)`"'},{id:"add-jsonarray",page:59,label:"<code>...add&lt;JsonArray&gt;()</code>",summary:'Error says "no matching function for call to `...add<JsonArray>()`"'},{id:"add-jsonobject",page:60,label:"<code>...add&lt;JsonObject&gt;()</code>",summary:'Error says "no matching function for call to `...add<JsonObject>()`"'},{id:"not-in-list",page:3,label:"None of the above",summary:"The error is not in the list"}]},{content:`<p>This error tells that <code>JsonDocument</code> has no constructor with an <code>int</code> parameter.<br>
Indeed, unlike <code>DynamicJsonDocument</code>, you don't need to specify the capacity of <code>JsonDocument</code>.</p>
<p>You can fix this error by removing the constructor argument:</p>
<pre><code class="hljs language-diff"><span class="hljs-deletion">- JsonDocument doc(200);</span>
<span class="hljs-addition">+ JsonDocument doc;</span>
</code></pre>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Removing the constructor argument solves the issue"},{id:"failure",page:1,label:"No",summary:"Removing the constructor argument doesn't solve the issue"}]},{content:`<p>This error occurs when you pass an invalid input type to <code>deserializeJson()</code>.</p>
<p>For example, if you write this:</p>
<pre><code class="hljs language-c++"><span class="hljs-keyword">class</span> <span class="hljs-title class_">Input</span> {
  <span class="hljs-comment">// ...</span>
};
...
`,options:[{id:"serialization",page:343,label:"Serialization",summary:"The issue concerns serialization"},{id:"deserialization",page:284,label:"Deserialization",summary:"The issue concerns deserialization"}]},{content:`<p>What is the value of <code>DeserializationError</code>?</p>
`,options:[{id:"ok",page:308,label:"<code>Ok</code>",summary:"`deserializeJson()` returns `Ok`"},{id:"emptyinput",page:297,label:"<code>EmptyInput</code>",summary:"`deserializeJson()` returns `EmptyInput`"},{id:"incompleteinput",page:301,label:"<code>IncompleteInput</code>",summary:"`deserializeJson()` returns `IncompleteInput`"},{id:"invalidinput",page:305,label:"<code>InvalidInput</code>",summary:"`deserializeJson()` returns `InvalidInput`"},{id:"nomemory",page:331,label:"<code>NoMemory</code>",summary:"`deserializeJson()` returns `NoMemory`"},{id:"toodeep",page:216,label:"<code>TooDeep</code>",summary:"`deserializeJson()` returns `TooDeep`"},{id:"crash",page:286,label:"I can't tell because the program crashes",summary:"The program crashes"},{id:"unknown",page:285,label:"I don't know what you're talking about",summary:"The program doesn't check the error"}]},{content:`<p><code>DeserializationError</code> is the return type of <code>deserializeJson()</code>. It tells whether the operation succeeded and indicates the cause of the error.</p>
<p>Modify your program to show the error code, like so:</p>
<pre><code class="hljs language-c++">DeserializationError error = <span class="hljs-built_in">deserializeJson</span>(doc, input);
...
<p>How many traces can you see in the Serial Monitor?</p>
`,options:[{id:"before",page:295,label:"None: program crashes before calling <code>deserializeJson()</code>",summary:"Program crashes before calling `deserializeJson()`"},{id:"inside",page:296,label:"Only one: program crashes inside <code>deserializeJson()</code>",summary:"Program crashes inside `deserializeJson()`"},{id:"after",page:287,label:"Two traces: program crashes after calling <code>deserializeJson()</code>",summary:"Program crashes after calling `deserializeJson()`"}]},{content:`<p>So, the program crashes when you try to extract a value from the JSON document.</p>
<p>What is the type of the variable you're extracting from?</p>
`,options:[{id:"jsonarray",page:290,label:"<code>JsonArray</code>",summary:"The program crashes when reading a value from a `JsonArray`"},{id:"jsondocument",page:288,label:"<code>JsonDocument</code>",summary:"The program crashes when reading a value from the `JsonDocument`"},{id:"jsonobject",page:292,label:"<code>JsonObject</code>",summary:"The program crashes when reading a value from a `JsonObject`"},{id:"jsonvariant",page:294,label:"<code>JsonVariant</code>",summary:"The program crashes when reading a value from a `JsonVariant`"}]},{content:`<p>Programs often crash because they keep a pointer to a string stored in the <code>JsonDocument</code>, even after the <code>JsonDocument</code> has been destructed.</p>
<p>Indeed, when <code>JsonDocument</code> returns a <code>const char*</code>, it doesn't return a copy of the string, but the address of the string in the memory pool. When the <code>JsonDocument</code> is destructed, the memory pool gets released and the pointer dangles. Later, when the program tries to use the string, it reads at an invalid memory location and crashes.</p>
<p>For example, it happens with the following program:</p>
<pre><code class="hljs language-c++"><span class="hljs-type">const</span> <span class="hljs-type">char</span>* username;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Replacing pointer with a `String` solves the issue"},{id:"no-dangling-pointer",page:92,label:"No",summary:"Replacing pointer with a `String` doesn't solve the issue"}]},{content:`<p>You must refactor your program so that it doesn't keep the <code>JsonArray</code> alive longer than the <code>JsonDocument</code>.</p>
<p>For example, if you return a <code>JsonArray</code> from a function, replace the <code>JsonArray</code> with a <code>JsonDocument</code>:</p>
<pre><code class="hljs language-diff"><span class="hljs-deletion">- JsonArray getPorts() {</span>
<span class="hljs-addition">+ JsonDocument getPorts() {</span>
...
`},{content:`<p><code>JsonArray</code> is a reference. As such, it doesn't hold any data but points to an array in the <code>JsonDocument</code>. When the <code>JsonDocument</code> is destructed, the array gets released, and the <code>JsonArray</code> becomes a dangling reference.</p>
<p>Does the <code>JsonArray</code> outlive the <code>JsonDocument</code>?</p>
`,options:[{id:"dangling",page:289,label:"Yes",summary:"The `JsonArray` outlives the `JsonDocument`"},{id:"not-dangling",page:288,label:"No",summary:"The `JsonArray` doesn't outlive the `JsonDocument`"}]},{content:`<p>You must refactor your program so that it doesn't keep the <code>JsonObject</code> alive longer than the <code>JsonDocument</code>.</p>
<p>For example, if you return a <code>JsonObject</code> from a function, replace the <code>JsonObject</code> with a <code>JsonDocument</code>:</p>
<pre><code class="hljs language-diff"><span class="hljs-deletion">- JsonObject getWiFiConfig() {</span>
<span class="hljs-addition">+ JsonDocument getWiFiConfig() {</span>
    File file = SD.open(&quot;config.json&quot;);
    JsonDocument doc;
    deserializeJson(doc, file);
    file.close();
...
`},{content:`<p><code>JsonObject</code> is a reference. As such, it doesn't hold any data but points to an object in the <code>JsonDocument</code>. When the <code>JsonDocument</code> is destructed, the object gets released, and the <code>JsonObject</code> becomes a dangling reference.</p>
<p>Does the <code>JsonObject</code> outlive the <code>JsonDocument</code>?</p>
`,options:[{id:"dangling",page:291,label:"Yes",summary:"The `JsonObject` outlives the `JsonDocument`"},{id:"not-dangling",page:288,label:"No",summary:"The `JsonObject` doesn't outlive the `JsonDocument`"}]},{content:`<p>You must refactor your program so that it doesn't keep the <code>JsonVariant</code> alive longer than the <code>JsonDocument</code>.</p>
<p>For example, if you return a <code>JsonVariant</code> from a function, replace the <code>JsonVariant</code> with a <code>JsonDocument</code>:</p>
<pre><code class="hljs language-diff"><span class="hljs-deletion">- JsonVariant getWiFiConfig() {</span>
<span class="hljs-addition">+ JsonDocument getWiFiConfig() {</span>
    File file = SD.open(&quot;config.json&quot;);
    JsonDocument doc;
    deserializeJson(doc, file);
...
`},{content:`<p><code>JsonVariant</code> is a reference. As such, it doesn't hold any data but points to a value in the <code>JsonDocument</code>. When the <code>JsonDocument</code> is destructed, the value gets released, and the <code>JsonVariant</code> becomes a dangling reference.</p>
<p>Does the <code>JsonVariant</code> outlive the <code>JsonDocument</code>?</p>
`,options:[{id:"dangling",page:293,label:"Yes",summary:"The `JsonVariant` outlives the `JsonDocument`"},{id:"not-dangling",page:288,label:"No",summary:"The `JsonVariant` doesn't outlive the `JsonDocument`"}]},{content:`<p>I think this could be a stack-overflow.</p>
<p>Please check in your code if there aren't some large variable in the stack. Look for things like:</p>
<ul>
<li><code>char buffer[1024]</code></li>
<li><code>int matrix[64][64][64]</code></li>
...
<p>Please review your code to make sure you're not passsing a dangling pointer to <code>deserializeJson()</code>.</p>
<p>Does your program still crash?</p>
`,options:[{id:"no-dangling-ptr",page:295,label:"Yes",summary:"Removing dangling pointers doesn't prevent the crash"},{id:"success",page:2,label:"No",summary:"Removing dangling pointers prevents the crash"}]},{content:`<p><code>EmptyInput</code> means that the input was empty or contained only spaces or comments.</p>
<p>Where does your JSON input come from?</p>
`,options:[{id:"http",page:109,label:"An HTTP response",summary:"Input comes from an HTTP response"},{id:"file",page:298,label:"A file",summary:"Input comes from a file"},{id:"serial",page:300,label:"A serial port",summary:"Input comes from a serial port"},{id:"other",page:116,label:"Something else",summary:"Input comes neither from an HTTP response, nor a file, nor a serial port"}]},{content:`<p><code>EmptyInput</code> in the context of a file usually means:</p>
<ul>
<li>the file is closed</li>
<li>the file is opened in the wrong mode</li>
<li>the file is empty</li>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Adding a wait loop fixes the issue"},{id:"available",page:299,label:"No",summary:"Adding a wait loop doesn't fix the issue"}]},{content:`<p><code>IncompleteInput</code> means that <code>deserializeJson()</code> managed to parse the beginning of the JSON document, but the end was missing.</p>
<p>What type of input do you pass to <code>deserializeJson()</code>?</p>
`,options:[{id:"stream",page:122,label:"A stream",summary:"Input comes from a stream"},{id:"string",page:302,label:"A string object (like <code>String</code>)",summary:"Input comes from a string object"},{id:"pointer",page:303,label:"A pointer (like <code>char*</code> or <code>const char*</code>)",summary:"Input comes from a pointer"}]},{content:`<p>Please print the content of the string to the serial port, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(input);
</code></pre>
<p>You should see that the JSON document is truncated.
This can be caused by a lack of RAM: the string object failed to allocate a buffer large enough for the whole document.</p>
...
<p>Hopefully, you'll be able to reserve a buffer large enough to store the whole string.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:2,label:"Yes",summary:"Calling `String::reserve()` solves the issue"},{id:"1",page:304,label:"No",summary:"Calling `String::reserve()` doesn't solve the issue"}]},{content:`<p>I'll assume that your input is stored in a buffer similar to this one:</p>
<pre><code class="hljs language-c++"><span class="hljs-type">char</span> input[<span class="hljs-number">1024</span>];
<span class="hljs-type">size_t</span> input_size;
</code></pre>
<p>Please print the content of the string to the serial port, like so:</p>
...
<p>Please increase the capacity of the buffer, but remember that the size of the stack is limited so you may need to move your buffer to the heap.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:2,label:"Yes",summary:"Increasing the buffer size solves the issue"},{id:"1",page:304,label:"No",summary:"Increasing the buffer size doesn't solve the issue"}]},{content:`<p>To reduce the memory usage, you should try to pass the source (file, connection, stream, etc) directly to <code>deserializeJson()</code>, either via the <a href="https://www.arduino.cc/reference/en/language/functions/communication/stream/"><code>Stream</code></a> interface or via a <a href="/news/2019/11/01/version-6-13-0/">custom reader</a>. This will avoid the need for an intermediate buffer.</p>
<p>Additionaly, you can add a <a href="/news/2020/03/22/version-6-15-0/">filter</a> to remove all unneeded information from the <code>JsonDocument</code>.</p>
<p>You can see examples here:</p>
<ul>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Flushing the serial buffer fixes the issue"},{id:"flush",page:161,label:"No",summary:"Flushing the serial buffer doesn't fix the issue"}]},{content:`<p>Are you using <a href="https://www.arduino.cc/en/Reference/SoftwareSerial"><code>SoftwareSerial</code></a>?</p>
`,options:[{id:"software",page:160,label:"Yes",summary:"Program uses `SoftwareSerial`"},{id:"hardware",page:306,label:"No",summary:"Program doesn't use `SoftwareSerial`"}]},{content:`<p>So, what's the problem then?</p>
`,options:[{id:"slow",page:194,label:"It's slow",summary:"Deserialisation is slow"},{id:"invalid",page:169,label:"I expected <code>InvalidInput</code> instead of <code>Ok</code>",summary:"`Ok` is incorrect; it should be `InvalidInput`"},{id:"crash",page:287,label:"My program crashes",summary:"Program crashes"},{id:"empty",page:309,label:"<code>JsonDocument</code> returns empty/null values",summary:"Program fails to extract values from the `JsonDocument`"},{id:"truncated-strings",page:195,label:"Some strings are truncated",summary:"Some strings are truncated"}]},{content:`<p>Do you use a filter (with <code>DeserializationOption::Filter</code>)?</p>
`,options:[{id:"filter",page:311,label:"Yes",summary:"Program uses `DeserializationOption::Filter`"},{id:"no-filter",page:316,label:"No",summary:"Program doesn't use `DeserializationOption::Filter`"}]},{content:`<p>When a program fails to extract the values from a <code>JsonDocument</code>, it's often because of confusion between arrays and objects.</p>
<p>For example, a common mistake is to write:</p>
<pre><code class="hljs language-c++"><span class="hljs-type">const</span> <span class="hljs-type">char</span>* temperature = doc[<span class="hljs-string">&quot;list&quot;</span>][<span class="hljs-string">&quot;main&quot;</span>][<span class="hljs-string">&quot;temp&quot;</span>];
</code></pre>
<p>instead of</p>
...
<p>There are many variations on this problem, and I cannot list them all.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"The issue is confusion between array and object"},{id:"array-object",page:320,label:"No",summary:"The issue is not confusion between array and object"}]},{content:`<p>Please print the value of <code>JsonDocument::overflowed()</code>, like so:</p>
...
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:313,label:"<code>1</code> (or <code>true</code>)",summary:"`filter.overflowed()` returns `true`"},{id:"overflowed-0",page:312,label:"<code>0</code> (or <code>false</code>)",summary:"`filter.overflowed()` returns `false`"}]},{content:`<p>Maybe the filter excludes the part that it should keep. Let's verify that it's doing its job correctly.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Freeing some memory solves the issue."},{id:"failure",page:312,label:"No",summary:"Freeing some memory doesn't solve the issue."}]},{content:`<p>Which function do you call to deserialize the input?</p>
`,options:[{id:"json",page:1,label:"<code>deserializeJson()</code>",summary:"Program calls `deserializeJson()`"},{id:"msgpack",page:315,label:"<code>deserializeMsgPack()</code>",summary:"Program calls `deserializeMsgPack()`"}]},{content:`<p>It seems that your program fed <code>deserializeMsgPack()</code> with garbage input.</p>
<p>Indeed, any byte in the following ranges is a valid one-byte MessagePack document:</p>
<ul>
<li><code>0x00</code>-<code>0x7f</code>: positive fixint</li>
<li><code>0xc0</code>: nil</li>
...
<p>What's the first character?</p>
`,options:[{id:"quote",page:319,label:"A quote (<code>&quot;</code>)",summary:"Serialized document starts with a quote"},{id:"bracket",page:310,label:"A square bracket (<code>[</code>)",summary:"Serialized document starts with a square bracket"},{id:"brace",page:310,label:"A curly brace (<code>{</code>)",summary:"Serialized document starts with a curly brace"},{id:"not-in-list",page:314,label:"None of the above",summary:"Serialized document starts with neither a quote, a bracket, nor a brace."}]},{content:`<p>If you cannot fix the server, you can at least reverse the double serialization (stringification) to get back the original object.</p>
<p>To do this, you must call <code>deserializeJson()</code> twice, like so:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Fixing the server fixes the issue"},{id:"server-ok",page:317,label:"No",summary:"Fixing the server doesn't fix the issue"}]},{content:`<p>If you see a double-quote at the beginning of the JSON input, it means that the whole document is neither an object or an array; it's a string. This happens when the input was incorrectly generated, by serializing (stringifying) to JSON twice.</p>
<p>For example, the following document:</p>
<pre><code class="hljs language-json"><span class="hljs-string">&quot;{\\&quot;hello\\&quot;:\\&quot;world\\&quot;}&quot;</span>
</code></pre>
<p>...is not a JSON <em>object</em> but a <em>string</em>.
...
<p>So, the bug isn't in the Arduino code, but on the other size, most likely a server.</p>
<p>Can you modify the code of the server?</p>
`,options:[{id:"server-fixable",page:318,label:"Yes",summary:"User can modify the server"},{id:"server-unfixable",page:317,label:"No",summary:"User cannot modify the server"}]},{content:`<p>What type of value are you trying to read?</p>
`,options:[{id:"bool",page:1,label:"<code>bool</code>",summary:"The program fails to extract a `bool` value"},{id:"const-char-ptr",page:1,label:"<code>const char*</code>",summary:"The program fails to extract a `const char*` value"},{id:"double",page:1,label:"<code>double</code>",summary:"The program fails to extract a `double` value"},{id:"float",page:1,label:"<code>float</code>",summary:"The program fails to extract a `float` value"},{id:"int",page:1,label:"<code>int</code>",summary:"The program fails to extract an `int` value"},{id:"int8",page:325,label:"<code>int8_t</code>",summary:"The program fails to extract an `int8_t` value"},{id:"int16",page:323,label:"<code>int16_t</code>",summary:"The program fails to extract an `int16_t` value"},{id:"int32",page:324,label:"<code>int32_t</code>",summary:"The program fails to extract an `int32_t` value"},{id:"int64",page:1,label:"<code>int64_t</code>",summary:"The program fails to extract an `int64_t` value"},{id:"long",page:324,label:"<code>long</code>",summary:"The program fails to extract a `long` value"},{id:"long-long",page:1,label:"<code>long long</code>",summary:"The program fails to extract a `long long` value"},{id:"short",page:323,label:"<code>short</code>",summary:"The program fails to extract a `short` value"},{id:"signed-char",page:325,label:"<code>signed char</code>",summary:"The program fails to extract a `signed char` value"},{id:"signed-int",page:323,label:"<code>signed int</code>",summary:"The program fails to extract a `signed int` value"},{id:"signed-long",page:324,label:"<code>signed long</code>",summary:"The program fails to extract a `signed long` value"},{id:"signed-long-long",page:1,label:"<code>signed long long</code>",summary:"The program fails to extract a `signed long long` value"},{id:"signed-short",page:323,label:"<code>signed short</code>",summary:"The program fails to extract a `signed short` value"},{id:"std-string",page:1,label:"<code>std::string</code>",summary:"The program fails to extract a `std::string` value"},{id:"uint8",page:330,label:"<code>uint8_t</code>",summary:"The program fails to extract a `uint8_t` value"},{id:"uint16",page:328,label:"<code>uint16_t</code>",summary:"The program fails to extract a `uint16_t` value"},{id:"uint32",page:328,label:"<code>uint32_t</code>",summary:"The program fails to extract a `uint32_t` value"},{id:"uint64",page:1,label:"<code>uint64_t</code>",summary:"The program fails to extract a `uint64_t` value"},{id:"unsigned-char",page:330,label:"<code>unsigned char</code>",summary:"The program fails to extract an `unsigned char` value"},{id:"unsigned-int",page:329,label:"<code>unsigned int</code>",summary:"The program fails to extract an `unsigned int` value"},{id:"unsigned-long",page:329,label:"<code>unsigned long</code>",summary:"The program fails to extract an `unsigned long` value"},{id:"unsigned-long-long",page:1,label:"<code>unsigned long long</code>",summary:"The program fails to extract an `unsigned long long` value"},{id:"unsigned-short",page:328,label:"<code>unsigned short</code>",summary:"The program fails to extract an `unsigned short` value"},{id:"array",page:322,label:"<code>JsonArray</code>",summary:"The program fails to extract a `JsonArray`"},{id:"object",page:327,label:"<code>JsonObject</code>",summary:"The program fails to extract a `JsonObject`"},{id:"other",page:1,label:"None of the above",summary:"The type of the extracted value is not listed"}]},{content:`<p><code>to&lt;JsonArray&gt;()</code> replaces the existing value with a new empty array.</p>
<p>To extract an existing array without replacing it, use <code>as&lt;JsonArray&gt;()</code> instead.</p>
<pre><code class="hljs language-diff"><span class="hljs-deletion">- auto array = doc[&quot;key&quot;].to&lt;JsonArray&gt;();</span>
<span class="hljs-addition">+ auto array = doc[&quot;key&quot;].as&lt;JsonArray&gt;();</span>
</code></pre>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Using `as<JsonArray>()` solves the issue"},{id:"failure",page:1,label:"No",summary:"Using `as<JsonArray>()` doesn't solve the issue"}]},{content:`<p>How do you extract the <code>JsonArray</code> from the <code>JsonDocument</code>?</p>
`,options:[{id:"implicit",page:1,label:"<code>JsonArray array = doc[&quot;key&quot;];</code>",summary:"The program uses implicit conversion to `JsonArray`"},{id:"as",page:1,label:"<code>doc[&quot;key&quot;].as&lt;JsonArray&gt;()</code>",summary:"The program uses `as<JsonArray>()`"},{id:"to",page:321,label:"<code>doc[&quot;key&quot;].to&lt;JsonArray&gt;()</code>",summary:"The program uses `to<JsonArray>()`"}]},{content:`<p>This type can only store values between -32,768 and 32,767.<br>
If you try to extract a value outside this range, ArduinoJson will return 0.<br>
If that's your case, you must use a larger integer type.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Switching to a larger integer type solves the issue"},{id:"failure",page:1,label:"No",summary:"Switching to a larger integer type doesn't solve the issue"}]},{content:`<p>This type can only store values between -2,147,483,648 and 2,147,483,647.<br>
If you try to extract a value outside this range, ArduinoJson will return 0.<br>
If that's your case, you must use a 64-bit integer type or a floating-point type.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Switching to a larger integer type solves the issue"},{id:"failure",page:1,label:"No",summary:"Switching to a larger integer type doesn't solve the issue"}]},{content:`<p>This type can only store values between -128 and 127.<br>
If you try to extract a value outside this range, ArduinoJson will return 0.<br>
If that's your case, you must use a larger integer type.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Switching to a larger integer type solves the issue"},{id:"failure",page:1,label:"No",summary:"Switching to a larger integer type doesn't solve the issue"}]},{content:`<p><code>to&lt;JsonObject&gt;()</code> replaces the existing value with a new empty object.</p>
<p>To extract an existing object without replacing it, use <code>as&lt;JsonObject&gt;()</code> instead.</p>
<pre><code class="hljs language-diff"><span class="hljs-deletion">- auto object = doc[&quot;key&quot;].to&lt;JsonObject&gt;();</span>
<span class="hljs-addition">+ auto object = doc[&quot;key&quot;].as&lt;JsonObject&gt;();</span>
</code></pre>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Using `as<JsonObject>()` solves the issue"},{id:"failure",page:1,label:"No",summary:"Using `as<JsonObject>()` doesn't solve the issue"}]},{content:`<p>How do you extract the <code>JsonObject</code> from the <code>JsonDocument</code>?</p>
`,options:[{id:"implicit",page:1,label:"<code>JsonObject object = doc[&quot;key&quot;];</code>",summary:"The program uses implicit conversion to `JsonObject`"},{id:"as",page:1,label:"<code>doc[&quot;key&quot;].as&lt;JsonObject&gt;()</code>",summary:"The program uses `as<JsonObject>()`"},{id:"to",page:326,label:"<code>doc[&quot;key&quot;].to&lt;JsonObject&gt;()</code>",summary:"The program uses `to<JsonObject>()`"}]},{content:`<p>This type can only store values between 0 and 65,535.<br>
If you try to extract a value outside this range, ArduinoJson will return 0.<br>
If that's your case, you must use a larger integer type.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Switching to a larger integer type solves the issue"},{id:"failure",page:1,label:"No",summary:"Switching to a larger integer type doesn't solve the issue"}]},{content:`<p>This type can only store values between 0 and 4,294,967,295.<br>
If you try to extract a value outside this range, ArduinoJson will return 0.<br>
If that's your case, you must use a 64-bit integer type or a floating-point type.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Switching to a larger integer type solves the issue"},{id:"failure",page:1,label:"No",summary:"Switching to a larger integer type doesn't solve the issue"}]},{content:`<p>This type can only store values between 0 and 255.<br>
If you try to extract a value outside this range, ArduinoJson will return 0.<br>
If that's your case, you must use a larger integer type.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Switching to a larger integer type solves the issue"},{id:"failure",page:1,label:"No",summary:"Switching to a larger integer type doesn't solve the issue"}]},{content:`<p>What type did you pass as <code>deserializeJson()</code>'s first argument?</p>
`,options:[{id:"jsonarray",page:332,label:"<code>JsonArray</code>",summary:"The first argument of `deserializeJson()` is a `JsonArray`"},{id:"jsondocument",page:335,label:"<code>JsonDocument</code>",summary:"The first argument of `deserializeJson()` is a `JsonDocument`"},{id:"jsonobject",page:333,label:"<code>JsonObject</code>",summary:"The first argument of `deserializeJson()` is a `JsonObject`"},{id:"jsonvariant",page:334,label:"<code>JsonVariant</code>",summary:"The first argument of `deserializeJson()` is a `JsonVariant`"}]},{content:`<p>You can pass a <code>JsonArray</code> as the first argument of <code>deserializeJson()</code>, but it has to point to an existing array.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Initializing the array fixes the issue"},{id:"server-ok",page:335,label:"No",summary:"Initializing the array doesn't fix the issue"}]},{content:`<p>You can pass a <code>JsonObject</code> as the first argument of <code>deserializeJson()</code>, but it has to point to an existing object.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Initializing the variant fixes the issue"},{id:"server-ok",page:335,label:"No",summary:"Initializing the variant doesn't fix the issue"}]},{content:`<p>Let's check with the <a href="/v7/assistant/">ArduinoJson Assistant</a> to see if you have enough memory for your JSON document.</p>
<ol>
...
`,options:[{id:"loose",page:336,label:"There is a lot more memory than required",summary:"The Assistant says there is a lot more memory than required."},{id:"tight",page:337,label:"There should be enough memory",summary:"The Assistant says there should be just enough memory."},{id:"too-small",page:342,label:"There is not enough memory",summary:"The Assistant says there is not enough memory."}]},{content:`<p>What CPU architecture is this code running on?</p>
`,options:[{id:"8-bit",page:338,label:"8-bit",summary:"The code is running on an 8-bit CPU"},{id:"32-bit",page:339,label:"32-bit",summary:"The code is running on a 32-bit CPU"},{id:"64-bit",page:341,label:"64-bit",summary:"The code is running on a 64-bit CPU"}]},{content:`<p>This means that ArduinoJson couldn't allocate enough memory for the JSON document.<br>
So you must free some memory.</p>
<p>See <a href="/v7/how-to/reduce-memory-usage/">How to reduce memory usage?</a> for some tips.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Freeing some memory solves the issue."},{id:"failure",page:342,label:"No",summary:"Freeing some memory doesn't solve the issue."}]},{content:`<p>Due to an optimization, a <code>JsonDocument</code> can only contain up to 255 nodes on an 8-bit CPU.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Setting `ARDUINOJSON_SLOT_ID_SIZE` to 2 solves the issue."},{id:"slot-id-size-2",page:340,label:"No",summary:"Setting `ARDUINOJSON_SLOT_ID_SIZE` to 2 doesn't solve the issue."},{id:"fewer-than-255",page:340,label:"My JSON document contains fewer than 255 nodes",summary:"The JSON document contains fewer than 255 nodes."}]},{content:`<p>Due to an optimization, a <code>JsonDocument</code> can only contain up to 65,535 nodes on a 32-bit CPU.
A node is a value, a key, or a member of an array.</p>
<p>You can push this limit by increasing <code>ARDUINOJSON_SLOT_ID_SIZE</code>, like so:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Setting `ARDUINOJSON_SLOT_ID_SIZE` to 4 solves the issue."},{id:"slot-id-size-2",page:341,label:"No",summary:"Setting `ARDUINOJSON_SLOT_ID_SIZE` to 4 doesn't solve the issue."},{id:"fewer-than-255",page:341,label:"My JSON document contains fewer than 65,535 nodes",summary:"The JSON document contains fewer than 65,535 nodes."}]},{content:`<p>Due to another optimization, strings in a <code>JsonDocument</code> can only contain up to 255 characters on an 8-bit CPU.</p>
<p>You can push this limit by increasing <code>ARDUINOJSON_STRING_LENGTH_SIZE</code>, like so:</p>
<pre><code class="hljs language-cpp"><span class="hljs-meta">#<span class="hljs-keyword">define</span> ARDUINOJSON_STRING_LENGTH_SIZE 2</span>
<span class="hljs-meta">#<span class="hljs-keyword">include</span> <span class="hljs-string">&lt;ArduinoJson.h&gt;</span></span>
</code></pre>
<p>This will increase the limit to 65,535 characters, but the memory consumption will increase slightly.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Setting `ARDUINOJSON_STRING_LENGTH_SIZE` to 2 solves the issue"},{id:"string-length-size-2",page:337,label:"No",summary:"Setting `ARDUINOJSON_STRING_LENGTH_SIZE` to 2 doesn't solve the issue"},{id:"fewer-than-255",page:337,label:"No string contains more than 255 characters",summary:"No string contains more than 255 characters"}]},{content:`<p>Due to another optimization, strings in a <code>JsonDocument</code> can only contain up to 65,535 characters.</p>
<p>You can push this limit by increasing <code>ARDUINOJSON_STRING_LENGTH_SIZE</code>, like so:</p>
<pre><code class="hljs language-cpp"><span class="hljs-meta">#<span class="hljs-keyword">define</span> ARDUINOJSON_STRING_LENGTH_SIZE 4</span>
<span class="hljs-meta">#<span class="hljs-keyword">include</span> <span class="hljs-string">&lt;ArduinoJson.h&gt;</span></span>
</code></pre>
<p>This will increase the limit to 4,294,967,295 characters, but the memory consumption will increase slightly.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Setting `ARDUINOJSON_STRING_LENGTH_SIZE` to 4 solves the issue"},{id:"string-length-size-4",page:337,label:"No",summary:"Setting `ARDUINOJSON_STRING_LENGTH_SIZE` to 4 doesn't solve the issue"},{id:"fewer-than-255",page:337,label:"No string contains more than 65,535 characters",summary:"No string contains more than 65,535 characters"}]},{content:`<p class="display-4">☹️</p>
...
`,options:[{id:"crash",page:227,label:"The program crashes",summary:"Program crashes"},{id:"empty",page:344,label:"The output is empty (e.g. <code>{}</code>, <code>[]</code>, or <code>null</code>)",summary:"Output is empty"},{id:"incomplete",page:353,label:"The output is incomplete",summary:"Output is incomplete"},{id:"garbage",page:345,label:"The output contains garbage",summary:"Output contains garbage"},{id:"null",page:353,label:"The output contains <code>null</code>",summary:"Output contains null"},{id:"float",page:238,label:"Floating-point values contain too many decimal digits",summary:"Floating-point values contain too many decimal digits"},{id:"slow",page:270,label:"It's slow",summary:"Serialization is slow"}]},{content:`<p>Please print the value of <code>JsonDocument::overflowed()</code>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:335,label:"<code>1</code> (or <code>true</code>)",summary:"`JsonDocument::overflowed()` returns `true`"},{id:"overflowed-0",page:1,label:"<code>0</code> (or <code>false</code>)",summary:"`JsonDocument::overflowed()` returns `false`"}]},{content:`<p>Which function produces the garbage?</p>
`,options:[{id:"json",page:347,label:"<code>serializeJson()</code> (or <code>serializeJsonPretty()</code>)",summary:"`serializeJson()` produces garbage"},{id:"msg",page:352,label:"<code>serializeMsgPack()</code>",summary:"`serializeMsgPack()` produces garbage"}]},{content:`<p>Do you use <a href="https://www.arduino.cc/reference/en/language/variables/data-types/stringobject/"><code>String</code></a> in your program?</p>
`,options:[{id:"string",page:244,label:"Yes",summary:"Program uses `String`"},{id:"no-string",page:1,label:"No",summary:"Program doesn't use `String`"}]},{content:`<p>What is the type of the first argument passed to <code>serializeJson()</code>?</p>
`,options:[{id:"document",page:346,label:"<code>JsonDocument</code>",summary:"Program calls `serializeJson(const JsonDocument&, ...)`"},{id:"array",page:348,label:"<code>JsonArray</code> (or <code>JsonArrayConst</code>)",summary:"Program calls `serializeJson(JsonArrayConst, ...)`"},{id:"object",page:349,label:"<code>JsonObject</code> (or <code>JsonObjectConst</code>)",summary:"Program calls `serializeJson(JsonObjectConst, ...)`"},{id:"variant",page:350,label:"<code>JsonVariant</code> (or <code>JsonVariantConst</code>)",summary:"Program calls `serializeJson(JsonVariantConst, ...)`"}]},{content:`<p><code>JsonArray</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonArray</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonArray <span class="hljs-title">createArray</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:346,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>JsonObject</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonObject</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonObject <span class="hljs-title">createObject</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:346,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>JsonVariant</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonVariant</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonVariant <span class="hljs-title">createVariant</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:346,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>serializeMsgPack()</code> share a lot of code with <code>serializeJson()</code>. There is no reason you should produce garbage with one and not the other. You may have found a bug.</p>
`,tags:["needs_assistance"]},{content:`<p><a href="https://msgpack.org/">MessagePack</a> is a binary format, so if you print a document to the serial port, the result would look weird.</p>
<p>For example, the following program:</p>
<pre><code class="hljs language-c++">JsonDocument doc;
doc[<span class="hljs-string">&quot;val&quot;</span>] = <span class="hljs-number">42</span>;
...
<p>I need you to edit your program to replace <code>serializeMsgPack()</code> with <code>serializeJson()</code>.</p>
<p>Do you see the garbage in the JSON output?</p>
`,options:[{id:"json",page:347,label:"Yes, <code>serializeJson()</code> produces garbage too",summary:"`serializeJson()` produces garbage too"},{id:"deserialize-no",page:351,label:"No, <code>serializeJson()</code> doesn't produces garbage",summary:"`serializeJson()` doesn't produces garbage"}]},{content:`<p>Please print the value of <code>JsonDocument::overflowed()</code>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:335,label:"<code>1</code> (or <code>true</code>)",summary:"`JsonDocument::overflowed()` returns `true`"},{id:"overflowed-0",page:354,label:"<code>0</code> (or <code>false</code>)",summary:"`JsonDocument::overflowed()` returns `false`"}]},{content:`<p>Does one of the strings in the <code>JsonDocument</code> contains a NUL (i.e.,  ASCII code 0, or <code>\\u0000</code>)?</p>
`,options:[{id:"nul",page:217,label:"Yes",summary:"One or more strings contain a NUL"},{id:"no-nul",page:1,label:"No",summary:"No string contains a NUL"}]}];function sa(e,s,n){var o;const t=ea[e];return{...t,number:n||1,hash:s||"#",options:(o=t.options)==null?void 0:o.map((a,i)=>({...a,inputId:`option-${e}-${i}`,hash:(s?s+"/":"#")+a.id,missing:!ea[a.page],selected:!1}))}}function hl(e){var n;const s=[sa(0)];if(e){let t=s[0];for(let o of e.substring(1).split("/")){const a=(n=t.options)==null?void 0:n.find(i=>i.id===o);if(!a){console.error(`Option "${o}" not found`);break}if(a.selected=!0,t.selectedOption=a,t=sa(a.page,a.hash,t.number+1),!t)break;s.push(t)}}return s}function ml(e){return e.map(s=>s.selectedOption).filter(s=>!!s).map((s,n)=>`${n+1}. ${s.summary}`).join(`
`)}const gl=e=>new Promise(s=>setTimeout(s,e)),fl={components:{AssistanceModal:Kr,TroubleshooterStep:dl},data(){return{reportCopied:!1,hash:""}},mounted(){this.hash=location.hash,window.addEventListener("hashchange",()=>this.hash=location.hash)},computed:{needsAssistance(){var s;return!!((s=this.steps[this.steps.length-1].tags)!=null&&s.includes("needs_assistance"))},steps(){return hl(this.hash)},report(){return ml(this.steps)}},methods:{choose(e){document.location.assign(e.hash),ga("set","page",document.location.pathname+document.location.hash),ga("send","pageview"),window.plausible("ArduinoJson Troubleshooter",{props:{hash:document.location.hash}})},async copyReport(){await navigator.clipboard.writeText(this.report),this.reportCopied=!0,await gl(2e3),this.reportCopied=!1}}},yl=se("div",null,[se("p",null,"Hi!"),se("p",null,[tn(" I'm the "),se("i",null,"ArduinoJson Troubleshooter"),tn(", and I'm here to help you fix your problem. I'll ask you a series of questions and give you some instructions along the way. ")]),se("p",null,"Ready? Here we go!")],-1),bl={key:0},jl=se("button",{type:"button",class:"btn btn-primary","data-toggle":"modal","data-target":"#assistance-modal"}," Contact support ",-1),wl=["disabled"];function vl(e,s,n,t,o,a){const i=Rn("TroubleshooterStep"),l=Rn("AssistanceModal");return me(),xe("div",null,[yl,(me(!0),xe(ve,null,po(a.steps,(c,u)=>(me(),en(ot,{key:u,name:"fade",mode:"out-in"},{default:Kt(()=>[(me(),en(i,{key:c.hash,step:c,onChoose:a.choose,active:u==a.steps.length-1},null,8,["step","onChoose","active"]))]),_:2},1024))),128)),a.needsAssistance?(me(),xe("div",bl,[jl,tn(),se("button",{class:gs(["btn",{"btn-outline-primary":!o.reportCopied,"btn-success":o.reportCopied}]),disabled:o.reportCopied,onClick:s[0]||(s[0]=(...c)=>a.copyReport&&a.copyReport(...c))},Es(o.reportCopied?"✓ Report copied":"Copy troubleshooter's report"),11,wl),le(l,{id:"assistance-modal",report:a.report},null,8,["report"])])):et("",!0)])}Hr(ln(fl,[["render",vl]])).provide("debug",!1).mount("#troubleshooter-app")})();
