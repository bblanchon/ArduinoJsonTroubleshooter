...
* @license MIT
**/function pn(e,s){const n=new Set(e.split(","));return s?t=>n.has(t.toLowerCase()):t=>n.has(t)}const W={},as=[],ye=()=>{},ra=()=>!1,Ns=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),un=e=>e.startsWith("onUpdate:"),ee=Object.assign,dn=(e,s)=>{const n=e.indexOf(s);n>-1&&e.splice(n,1)},la=Object.prototype.hasOwnProperty,E=(e,s)=>la.call(e,s),k=Array.isArray,is=e=>qs(e)==="[object Map]",ut=e=>qs(e)==="[object Set]",q=e=>typeof e=="function",Q=e=>typeof e=="string",rs=e=>typeof e=="symbol",B=e=>e!==null&&typeof e=="object",dt=e=>(B(e)||q(e))&&q(e.then)&&q(e.catch),ht=Object.prototype.toString,qs=e=>ht.call(e),ca=e=>qs(e).slice(8,-1),mt=e=>qs(e)==="[object Object]",hn=e=>Q(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,ms=pn(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Is=e=>{const s=Object.create(null);return n=>s[n]||(s[n]=e(n))},pa=/-(\w)/g,Ae=Is(e=>e.replace(pa,(s,n)=>n?n.toUpperCase():"")),ua=/\B([A-Z])/g,ls=Is(e=>e.replace(ua,"-$1").toLowerCase()),Os=Is(e=>e.charAt(0).toUpperCase()+e.slice(1)),mn=Is(e=>e?`on${Os(e)}`:""),$e=(e,s)=>!Object.is(e,s),gn=(e,s)=>{for(let n=0;n<e.length;n++)e[n](s)},zs=(e,s,n)=>{Object.defineProperty(e,s,{configurable:!0,enumerable:!1,value:n})},da=e=>{const s=parseFloat(e);return isNaN(s)?e:s},ha=e=>{const s=Q(e)?Number(e):NaN;return isNaN(s)?e:s};let gt;const ft=()=>gt||(gt=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function fn(e){if(k(e)){const s={};for(let n=0;n<e.length;n++){const t=e[n],o=Q(t)?ba(t):fn(t);if(o)for(const a in o)s[a]=o[a]}return s}else if(Q(e)||B(e))return e}const ma=/;(?![^(]*\))/g,fa=/:([^]+)/,ya=/\/\*[^]*?\*\//g;function ba(e){const s={};return e.replace(ya,"").split(ma).forEach(n=>{if(n){const t=n.split(fa);t.length>1&&(s[t[0].trim()]=t[1].trim())}}),s}function gs(e){let s="";if(Q(e))s=e;else if(k(e))for(let n=0;n<e.length;n++){const t=gs(e[n]);t&&(s+=t+" ")}else if(B(e))for(const n in e)e[n]&&(s+=n+" ");return s.trim()}const ja=pn("itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly");function yt(e){return!!e||e===""}const Es=e=>Q(e)?e:e==null?"":k(e)||B(e)&&(e.toString===ht||!q(e.toString))?JSON.stringify(e,bt,2):String(e),bt=(e,s)=>s&&s.__v_isRef?bt(e,s.value):is(s)?{[`Map(${s.size})`]:[...s.entries()].reduce((n,[t,o],a)=>(n[yn(t,a)+" =>"]=o,n),{})}:ut(s)?{[`Set(${s.size})`]:[...s.values()].map(n=>yn(n))}:rs(s)?yn(s):B(s)&&!k(s)&&!mt(s)?String(s):s,yn=(e,s="")=>{var n;return rs(e)?`Symbol(${(n=e.description)!=null?n:s})`:e};/**
* @vue/reactivity v3.4.19
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Je;class wa{constructor(s=!1){this.detached=s,this._active=!0,this.effects=[],this.cleanups=[],this.parent=Je,!s&&Je&&(this.index=(Je.scopes||(Je.scopes=[])).push(this)-1)}get active(){return this._active}run(s){if(this._active){const n=Je;try{return Je=this,s()}finally{Je=n}}}on(){Je=this}off(){Je=this.parent}stop(s){if(this._active){let n,t;for(n=0,t=this.effects.length;n<t;n++)this.effects[n].stop();for(n=0,t=this.cleanups.length;n<t;n++)this.cleanups[n]();if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!s){const o=this.parent.scopes.pop();o&&o!==this&&(this.parent.scopes[this.index]=o,o.index=this.index)}this.parent=void 0,this._active=!1}}}function va(e,s=Je){s&&s.active&&s.effects.push(e)}function Ja(){return Je}let Ge;class bn{constructor(s,n,t,o){this.fn=s,this.trigger=n,this.scheduler=t,this.active=!0,this.deps=[],this._dirtyLevel=4,this._trackId=0,this._runnings=0,this._shouldSchedule=!1,this._depsLength=0,va(this,o)}get dirty(){if(this._dirtyLevel===2||this._dirtyLevel===3){this._dirtyLevel=1,Re();for(let s=0;s<this._depsLength;s++){const n=this.deps[s];if(n.computed&&(Sa(n.computed),this._dirtyLevel>=4))break}this._dirtyLevel===1&&(this._dirtyLevel=0),Fe()}return this._dirtyLevel>=4}set dirty(s){this._dirtyLevel=s?4:0}run(){if(this._dirtyLevel=0,!this.active)return this.fn();let s=Ce,n=Ge;try{return Ce=!0,Ge=this,this._runnings++,jt(this),this.fn()}finally{wt(this),this._runnings--,Ge=n,Ce=s}}stop(){var s;this.active&&(jt(this),wt(this),(s=this.onStop)==null||s.call(this),this.active=!1)}}function Sa(e){return e.value}function jt(e){e._trackId++,e._depsLength=0}function wt(e){if(e.deps.length>e._depsLength){for(let s=e._depsLength;s<e.deps.length;s++)vt(e.deps[s],e);e.deps.length=e._depsLength}}function vt(e,s){const n=e.get(s);n!==void 0&&s._trackId!==n&&(e.delete(s),e.size===0&&e.cleanup())}let Ce=!0,jn=0;const Jt=[];function Re(){Jt.push(Ce),Ce=!1}function Fe(){const e=Jt.pop();Ce=e===void 0?!0:e}function wn(){jn++}function vn(){for(jn--;!jn&&Jn.length;)Jn.shift()()}function St(e,s,n){if(s.get(e)!==e._trackId){s.set(e,e._trackId);const t=e.deps[e._depsLength];t!==s?(t&&vt(t,e),e.deps[e._depsLength++]=s):e._depsLength++}}const Jn=[];function _t(e,s,n){wn();for(const t of e.keys()){let o;t._dirtyLevel<s&&(o??(o=e.get(t)===t._trackId))&&(t._shouldSchedule||(t._shouldSchedule=t._dirtyLevel===0),t._dirtyLevel=s),t._shouldSchedule&&(o??(o=e.get(t)===t._trackId))&&(t.trigger(),(!t._runnings||t.allowRecurse)&&t._dirtyLevel!==2&&(t._shouldSchedule=!1,t.scheduler&&Jn.push(t.scheduler)))}vn()}const Tt=(e,s)=>{const n=new Map;return n.cleanup=e,n.computed=s,n},Sn=new WeakMap,Ke=Symbol(""),_n=Symbol("");function ue(e,s,n){if(Ce&&Ge){let t=Sn.get(e);t||Sn.set(e,t=new Map);let o=t.get(n);o||t.set(n,o=Tt(()=>t.delete(n))),St(Ge,o)}}function Oe(e,s,n,t,o,a){const i=Sn.get(e);if(!i)return;let r=[];if(s==="clear")r=[...i.values()];else if(n==="length"&&k(e)){const c=Number(t);i.forEach((u,d)=>{(d==="length"||!rs(d)&&d>=c)&&r.push(u)})}else switch(n!==void 0&&r.push(i.get(n)),s){case"add":k(e)?hn(n)&&r.push(i.get("length")):(r.push(i.get(Ke)),is(e)&&r.push(i.get(_n)));break;case"delete":k(e)||(r.push(i.get(Ke)),is(e)&&r.push(i.get(_n)));break;case"set":is(e)&&r.push(i.get(Ke));break}wn();for(const c of r)c&&_t(c,4);vn()}const _a=pn("__proto__,__v_isRef,__isVue"),At=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(rs)),xt=Ta();function Ta(){const e={};return["includes","indexOf","lastIndexOf"].forEach(s=>{e[s]=function(...n){const t=R(this);for(let a=0,i=this.length;a<i;a++)ue(t,"get",a+"");const o=t[s](...n);return o===-1||o===!1?t[s](...n.map(R)):o}}),["push","pop","shift","unshift","splice"].forEach(s=>{e[s]=function(...n){Re(),wn();const t=R(this)[s].apply(this,n);return vn(),Fe(),t}}),e}function Aa(e){const s=R(this);return ue(s,"has",e),s.hasOwnProperty(e)}class kt{constructor(s=!1,n=!1){this._isReadonly=s,this._shallow=n}get(s,n,t){const o=this._isReadonly,a=this._shallow;if(n==="__v_isReactive")return!o;if(n==="__v_isReadonly")return o;if(n==="__v_isShallow")return a;if(n==="__v_raw")return t===(o?a?Fa:Pt:a?Et:zt).get(s)||Object.getPrototypeOf(s)===Object.getPrototypeOf(t)?s:void 0;const i=k(s);if(!o){if(i&&E(xt,n))return Reflect.get(xt,n,t);if(n==="hasOwnProperty")return Aa}const r=Reflect.get(s,n,t);return(rs(n)?At.has(n):_a(n))||(o||ue(s,"get",n),a)?r:de(r)?i&&hn(n)?r:r.value:B(r)?o?Ct(r):xn(r):r}}class Dt extends kt{constructor(s=!1){super(!1,s)}set(s,n,t,o){let a=s[n];if(!this._shallow){const c=fs(a);if(!Dn(t)&&!fs(t)&&(a=R(a),t=R(t)),!k(s)&&de(a)&&!de(t))return c?!1:(a.value=t,!0)}const i=k(s)&&hn(n)?Number(n)<s.length:E(s,n),r=Reflect.set(s,n,t,o);return s===R(o)&&(i?$e(t,a)&&Oe(s,"set",n,t):Oe(s,"add",n,t)),r}deleteProperty(s,n){const t=E(s,n);s[n];const o=Reflect.deleteProperty(s,n);return o&&t&&Oe(s,"delete",n,void 0),o}has(s,n){const t=Reflect.has(s,n);return(!rs(n)||!At.has(n))&&ue(s,"has",n),t}ownKeys(s){return ue(s,"iterate",k(s)?"length":Ke),Reflect.ownKeys(s)}}class xa extends kt{constructor(s=!1){super(!0,s)}set(s,n){return!0}deleteProperty(s,n){return!0}}const ka=new Dt,Da=new xa,Na=new Dt(!0),Tn=e=>e,Ps=e=>Reflect.getPrototypeOf(e);function Cs(e,s,n=!1,t=!1){e=e.__v_raw;const o=R(e),a=R(s);n||($e(s,a)&&ue(o,"get",s),ue(o,"get",a));const{has:i}=Ps(o),r=t?Tn:n?qn:Nn;if(i.call(o,s))return r(e.get(s));if(i.call(o,a))return r(e.get(a));e!==o&&e.get(s)}function Rs(e,s=!1){const n=this.__v_raw,t=R(n),o=R(e);return s||($e(e,o)&&ue(t,"has",e),ue(t,"has",o)),e===o?n.has(e):n.has(e)||n.has(o)}function Fs(e,s=!1){return e=e.__v_raw,!s&&ue(R(e),"iterate",Ke),Reflect.get(e,"size",e)}function Nt(e){e=R(e);const s=R(this);return Ps(s).has.call(s,e)||(s.add(e),Oe(s,"add",e,e)),this}function qt(e,s){s=R(s);const n=R(this),{has:t,get:o}=Ps(n);let a=t.call(n,e);a||(e=R(e),a=t.call(n,e));const i=o.call(n,e);return n.set(e,s),a?$e(s,i)&&Oe(n,"set",e,s):Oe(n,"add",e,s),this}function It(e){const s=R(this),{has:n,get:t}=Ps(s);let o=n.call(s,e);o||(e=R(e),o=n.call(s,e)),t&&t.call(s,e);const a=s.delete(e);return o&&Oe(s,"delete",e,void 0),a}function Ot(){const e=R(this),s=e.size!==0,n=e.clear();return s&&Oe(e,"clear",void 0,void 0),n}function Ms(e,s){return function(t,o){const a=this,i=a.__v_raw,r=R(i),c=s?Tn:e?qn:Nn;return!e&&ue(r,"iterate",Ke),i.forEach((u,d)=>t.call(o,c(u),c(d),a))}}function Ys(e,s,n){return function(...t){const o=this.__v_raw,a=R(o),i=is(a),r=e==="entries"||e===Symbol.iterator&&i,c=e==="keys"&&i,u=o[e](...t),d=n?Tn:s?qn:Nn;return!s&&ue(a,"iterate",c?_n:Ke),{next(){const{value:y,done:w}=u.next();return w?{value:y,done:w}:{value:r?[d(y[0]),d(y[1])]:d(y),done:w}},[Symbol.iterator](){return this}}}}function Me(e){return function(...s){return e==="delete"?!1:e==="clear"?void 0:this}}function qa(){const e={get(a){return Cs(this,a)},get size(){return Fs(this)},has:Rs,add:Nt,set:qt,delete:It,clear:Ot,forEach:Ms(!1,!1)},s={get(a){return Cs(this,a,!1,!0)},get size(){return Fs(this)},has:Rs,add:Nt,set:qt,delete:It,clear:Ot,forEach:Ms(!1,!0)},n={get(a){return Cs(this,a,!0)},get size(){return Fs(this,!0)},has(a){return Rs.call(this,a,!0)},add:Me("add"),set:Me("set"),delete:Me("delete"),clear:Me("clear"),forEach:Ms(!0,!1)},t={get(a){return Cs(this,a,!0,!0)},get size(){return Fs(this,!0)},has(a){return Rs.call(this,a,!0)},add:Me("add"),set:Me("set"),delete:Me("delete"),clear:Me("clear"),forEach:Ms(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(a=>{e[a]=Ys(a,!1,!1),n[a]=Ys(a,!0,!1),s[a]=Ys(a,!1,!0),t[a]=Ys(a,!0,!0)}),[e,n,s,t]}const[Ia,Oa,za,Ea]=qa();function An(e,s){const n=s?e?Ea:za:e?Oa:Ia;return(t,o,a)=>o==="__v_isReactive"?!e:o==="__v_isReadonly"?e:o==="__v_raw"?t:Reflect.get(E(n,o)&&o in t?n:t,o,a)}const Pa={get:An(!1,!1)},Ca={get:An(!1,!0)},Ra={get:An(!0,!1)},zt=new WeakMap,Et=new WeakMap,Pt=new WeakMap,Fa=new WeakMap;function Ma(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Ya(e){return e.__v_skip||!Object.isExtensible(e)?0:Ma(ca(e))}function xn(e){return fs(e)?e:kn(e,!1,ka,Pa,zt)}function Ha(e){return kn(e,!1,Na,Ca,Et)}function Ct(e){return kn(e,!0,Da,Ra,Pt)}function kn(e,s,n,t,o){if(!B(e)||e.__v_raw&&!(s&&e.__v_isReactive))return e;const a=o.get(e);if(a)return a;const i=Ya(e);if(i===0)return e;const r=new Proxy(e,i===2?t:n);return o.set(e,r),r}function cs(e){return fs(e)?cs(e.__v_raw):!!(e&&e.__v_isReactive)}function fs(e){return!!(e&&e.__v_isReadonly)}function Dn(e){return!!(e&&e.__v_isShallow)}function Rt(e){return cs(e)||fs(e)}function R(e){const s=e&&e.__v_raw;return s?R(s):e}function Ft(e){return Object.isExtensible(e)&&zs(e,"__v_skip",!0),e}const Nn=e=>B(e)?xn(e):e,qn=e=>B(e)?Ct(e):e;class Mt{constructor(s,n,t,o){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this.effect=new bn(()=>s(this._value),()=>In(this,this.effect._dirtyLevel===2?2:3)),this.effect.computed=this,this.effect.active=this._cacheable=!o,this.__v_isReadonly=t}get value(){const s=R(this);return(!s._cacheable||s.effect.dirty)&&$e(s._value,s._value=s.effect.run())&&In(s,4),Ua(s),s.effect._dirtyLevel>=2&&In(s,2),s._value}set value(s){this._setter(s)}get _dirty(){return this.effect.dirty}set _dirty(s){this.effect.dirty=s}}function Ba(e,s,n=!1){let t,o;const a=q(e);return a?(t=e,o=ye):(t=e.get,o=e.set),new Mt(t,o,a||!o,n)}function Ua(e){var s;Ce&&Ge&&(e=R(e),St(Ge,(s=e.dep)!=null?s:e.dep=Tt(()=>e.dep=void 0,e instanceof Mt?e:void 0)))}function In(e,s=4,n){e=R(e);const t=e.dep;t&&_t(t,s)}function de(e){return!!(e&&e.__v_isRef===!0)}function La(e){return de(e)?e.value:e}const Wa={get:(e,s,n)=>La(Reflect.get(e,s,n)),set:(e,s,n,t)=>{const o=e[s];return de(o)&&!de(n)?(o.value=n,!0):Reflect.set(e,s,n,t)}};function Yt(e){return cs(e)?e:new Proxy(e,Wa)}/**
* @vue/runtime-core v3.4.19
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const ys=[];function _l(e,...s){Re();const n=ys.length?ys[ys.length-1].component:null,t=n&&n.appContext.config.warnHandler,o=Va();if(t)ze(t,n,11,[e+s.join(""),n&&n.proxy,o.map(({vnode:a})=>`at <${Ro(n,a.type)}>`).join(`
...
`],...Ga(n))}),s}function Ga({vnode:e,recurseCount:s}){const n=s>0?`... (${s} recursive calls)`:"",t=e.component?e.component.parent==null:!1,o=` at <${Ro(e.component,e.type,t)}`,a=">"+n;return e.props?[o,...Ka(e.props),a]:[o+a]}function Ka(e){const s=[],n=Object.keys(e);return n.slice(0,3).forEach(t=>{s.push(...Ht(t,e[t]))}),n.length>3&&s.push(" ..."),s}function Ht(e,s,n){return Q(s)?(s=JSON.stringify(s),n?s:[`${e}=${s}`]):typeof s=="number"||typeof s=="boolean"||s==null?n?s:[`${e}=${s}`]:de(s)?(s=Ht(e,R(s.value),!0),n?s:[`${e}=Ref<`,s,">"]):q(s)?[`${e}=fn${s.name?`<${s.name}>`:""}`]:(s=R(s),n?s:[`${e}=`,s])}function ze(e,s,n,t){try{return t?e(...t):e()}catch(o){Hs(o,s,n)}}function be(e,s,n,t){if(q(e)){const a=ze(e,s,n,t);return a&&dt(a)&&a.catch(i=>{Hs(i,s,n)}),a}const o=[];for(let a=0;a<e.length;a++)o.push(be(e[a],s,n,t));return o}function Hs(e,s,n,t=!0){const o=s?s.vnode:null;if(s){let a=s.parent;const i=s.proxy,r=`https://vuejs.org/error-reference/#runtime-${n}`;for(;a;){const u=a.ec;if(u){for(let d=0;d<u.length;d++)if(u[d](e,i,r)===!1)return}a=a.parent}const c=s.appContext.config.errorHandler;if(c){ze(c,null,10,[e,i,r]);return}}Za(e,n,o,t)}function Za(e,s,n,t=!0){console.error(e)}let bs=!1,On=!1;const ie=[];let xe=0;const ps=[];let Ye=null,Ze=0;const Bt=Promise.resolve();let zn=null;function Xa(e){const s=zn||Bt;return e?s.then(this?e.bind(this):e):s}function Qa(e){let s=xe+1,n=ie.length;for(;s<n;){const t=s+n>>>1,o=ie[t],a=js(o);a<e||a===e&&o.pre?s=t+1:n=t}return s}function En(e){(!ie.length||!ie.includes(e,bs&&e.allowRecurse?xe+1:xe))&&(e.id==null?ie.push(e):ie.splice(Qa(e.id),0,e),Ut())}function Ut(){!bs&&!On&&(On=!0,zn=Bt.then(Vt))}function ei(e){const s=ie.indexOf(e);s>xe&&ie.splice(s,1)}function si(e){k(e)?ps.push(...e):(!Ye||!Ye.includes(e,e.allowRecurse?Ze+1:Ze))&&ps.push(e),Ut()}function Lt(e,s,n=bs?xe+1:0){for(;n<ie.length;n++){const t=ie[n];if(t&&t.pre){if(e&&t.id!==e.uid)continue;ie.splice(n,1),n--,t()}}}function Wt(e){if(ps.length){const s=[...new Set(ps)].sort((n,t)=>js(n)-js(t));if(ps.length=0,Ye){Ye.push(...s);return}for(Ye=s,Ze=0;Ze<Ye.length;Ze++)Ye[Ze]();Ye=null,Ze=0}}const js=e=>e.id==null?1/0:e.id,ni=(e,s)=>{const n=js(e)-js(s);if(n===0){if(e.pre&&!s.pre)return-1;if(s.pre&&!e.pre)return 1}return n};function Vt(e){On=!1,bs=!0,ie.sort(ni);try{for(xe=0;xe<ie.length;xe++){const s=ie[xe];s&&s.active!==!1&&ze(s,null,14)}}finally{xe=0,ie.length=0,Wt(),bs=!1,zn=null,(ie.length||ps.length)&&Vt()}}function ti(e,s,...n){if(e.isUnmounted)return;const t=e.vnode.props||W;let o=n;const a=s.startsWith("update:"),i=a&&s.slice(7);if(i&&i in t){const d=`${i==="modelValue"?"model":i}Modifiers`,{number:y,trim:w}=t[d]||W;w&&(o=n.map(A=>Q(A)?A.trim():A)),y&&(o=n.map(da))}let r,c=t[r=mn(s)]||t[r=mn(Ae(s))];!c&&a&&(c=t[r=mn(ls(s))]),c&&be(c,e,6,o);const u=t[r+"Once"];if(u){if(!e.emitted)e.emitted={};else if(e.emitted[r])return;e.emitted[r]=!0,be(u,e,6,o)}}function $t(e,s,n=!1){const t=s.emitsCache,o=t.get(e);if(o!==void 0)return o;const a=e.emits;let i={},r=!1;if(!q(e)){const c=u=>{const d=$t(u,s,!0);d&&(r=!0,ee(i,d))};!n&&s.mixins.length&&s.mixins.forEach(c),e.extends&&c(e.extends),e.mixins&&e.mixins.forEach(c)}return!a&&!r?(B(e)&&t.set(e,null),null):(k(a)?a.forEach(c=>i[c]=null):ee(i,a),B(e)&&t.set(e,i),i)}function Bs(e,s){return!e||!Ns(s)?!1:(s=s.slice(2).replace(/Once$/,""),E(e,s[0].toLowerCase()+s.slice(1))||E(e,ls(s))||E(e,s))}let je=null,Gt=null;function Us(e){const s=je;return je=e,Gt=e&&e.type.__scopeId||null,s}function Kt(e,s=je,n){if(!s||e._n)return e;const t=(...o)=>{t._d&&Do(-1);const a=Us(s);let i;try{i=e(...o)}finally{Us(a),t._d&&Do(1)}return i};return t._n=!0,t._c=!0,t._d=!0,t}function Tl(){}function Pn(e){const{type:s,vnode:n,proxy:t,withProxy:o,props:a,propsOptions:[i],slots:r,attrs:c,emit:u,render:d,renderCache:y,data:w,setupState:A,ctx:P,inheritAttrs:D}=e;let U,M;const ae=Us(e);try{if(n.shapeFlag&4){const Y=o||t,Z=Y;U=De(d.call(Z,Y,y,a,A,w,P)),M=c}else{const Y=s;U=De(Y.length>1?Y(a,{attrs:c,slots:r,emit:u}):Y(a,null)),M=s.props?c:oi(c)}}catch(Y){Ss.length=0,Hs(Y,e,1),U=ce(Se)}let C=U;if(M&&D!==!1){const Y=Object.keys(M),{shapeFlag:Z}=C;Y.length&&Z&7&&(i&&Y.some(un)&&(M=ai(M,i)),C=Be(C,M))}return n.dirs&&(C=Be(C),C.dirs=C.dirs?C.dirs.concat(n.dirs):n.dirs),n.transition&&(C.transition=n.transition),U=C,Us(ae),U}const oi=e=>{let s;for(const n in e)(n==="class"||n==="style"||Ns(n))&&((s||(s={}))[n]=e[n]);return s},ai=(e,s)=>{const n={};for(const t in e)(!un(t)||!(t.slice(9)in s))&&(n[t]=e[t]);return n};function ii(e,s,n){const{props:t,children:o,component:a}=e,{props:i,children:r,patchFlag:c}=s,u=a.emitsOptions;if(s.dirs||s.transition)return!0;if(n&&c>=0){if(c&1024)return!0;if(c&16)return t?Zt(t,i,u):!!i;if(c&8){const d=s.dynamicProps;for(let y=0;y<d.length;y++){const w=d[y];if(i[w]!==t[w]&&!Bs(u,w))return!0}}}else return(o||r)&&(!r||!r.$stable)?!0:t===i?!1:t?i?Zt(t,i,u):!0:!!i;return!1}function Zt(e,s,n){const t=Object.keys(s);if(t.length!==Object.keys(e).length)return!0;for(let o=0;o<t.length;o++){const a=t[o];if(s[a]!==e[a]&&!Bs(n,a))return!0}return!1}function ri({vnode:e,parent:s},n){for(;s;){const t=s.subTree;if(t.suspense&&t.suspense.activeBranch===e&&(t.el=e.el),t===e)(e=s.vnode).el=n,s=s.parent;else break}}const Xt="components";function Cn(e,s){return ci(Xt,e,!0,s)||e}const li=Symbol.for("v-ndc");function ci(e,s,n=!0,t=!1){const o=je||oe;if(o){const a=o.type;if(e===Xt){const r=Co(a,!1);if(r&&(r===s||r===Ae(s)||r===Os(Ae(s))))return a}const i=Qt(o[e]||a[e],s)||Qt(o.appContext[e],s);return!i&&t?a:i}}function Qt(e,s){return e&&(e[s]||e[Ae(s)]||e[Os(Ae(s))])}const pi=e=>e.__isSuspense;function ui(e,s){s&&s.pendingBranch?k(e)?s.effects.push(...e):s.effects.push(e):si(e)}const di=Symbol.for("v-scx"),hi=()=>Zs(di),Ls={};function Rn(e,s,n){return eo(e,s,n)}function eo(e,s,{immediate:n,deep:t,flush:o,once:a,onTrack:i,onTrigger:r}=W){if(s&&a){const O=s;s=(...pe)=>{O(...pe),Z()}}const c=oe,u=O=>t===!0?O:us(O,t===!1?1:void 0);let d,y=!1,w=!1;if(de(e)?(d=()=>e.value,y=Dn(e)):cs(e)?(d=()=>u(e),y=!0):k(e)?(w=!0,y=e.some(O=>cs(O)||Dn(O)),d=()=>e.map(O=>{if(de(O))return O.value;if(cs(O))return u(O);if(q(O))return ze(O,c,2)})):q(e)?s?d=()=>ze(e,c,2):d=()=>(A&&A(),be(e,c,3,[P])):d=ye,s&&t){const O=d;d=()=>us(O())}let A,P=O=>{A=C.onStop=()=>{ze(O,c,4),A=C.onStop=void 0}},D;if(an)if(P=ye,s?n&&be(s,c,3,[d(),w?[]:void 0,P]):d(),o==="sync"){const O=hi();D=O.__watcherHandles||(O.__watcherHandles=[])}else return ye;let U=w?new Array(e.length).fill(Ls):Ls;const M=()=>{if(!(!C.active||!C.dirty))if(s){const O=C.run();(t||y||(w?O.some((pe,I)=>$e(pe,U[I])):$e(O,U)))&&(A&&A(),be(s,c,3,[O,U===Ls?void 0:w&&U[0]===Ls?[]:U,P]),U=O)}else C.run()};M.allowRecurse=!!s;let ae;o==="sync"?ae=M:o==="post"?ae=()=>he(M,c&&c.suspense):(M.pre=!0,c&&(M.id=c.uid),ae=()=>En(M));const C=new bn(d,ye,ae),Y=Ja(),Z=()=>{C.stop(),Y&&dn(Y.effects,C)};return s?n?M():U=C.run():o==="post"?he(C.run.bind(C),c&&c.suspense):C.run(),D&&D.push(Z),Z}function mi(e,s,n){const t=this.proxy,o=Q(e)?e.includes(".")?so(t,e):()=>t[e]:e.bind(t,t);let a;q(s)?a=s:(a=s.handler,n=s);const i=Ts(this),r=eo(o,a.bind(t),n);return i(),r}function so(e,s){const n=s.split(".");return()=>{let t=e;for(let o=0;o<n.length&&t;o++)t=t[n[o]];return t}}function us(e,s,n=0,t){if(!B(e)||e.__v_skip)return e;if(s&&s>0){if(n>=s)return e;n++}if(t=t||new Set,t.has(e))return e;if(t.add(e),de(e))us(e.value,s,n,t);else if(k(e))for(let o=0;o<e.length;o++)us(e[o],s,n,t);else if(ut(e)||is(e))e.forEach(o=>{us(o,s,n,t)});else if(mt(e))for(const o in e)us(e[o],s,n,t);return e}function Xe(e,s,n,t){const o=e.dirs,a=s&&s.dirs;for(let i=0;i<o.length;i++){const r=o[i];a&&(r.oldValue=a[i].value);let c=r.dir[t];c&&(Re(),be(c,n,8,[e.el,r,e,s]),Fe())}}const He=Symbol("_leaveCb"),Ws=Symbol("_enterCb");function gi(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return ro(()=>{e.isMounted=!0}),lo(()=>{e.isUnmounting=!0}),e}const we=[Function,Array],no={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:we,onEnter:we,onAfterEnter:we,onEnterCancelled:we,onBeforeLeave:we,onLeave:we,onAfterLeave:we,onLeaveCancelled:we,onBeforeAppear:we,onAppear:we,onAfterAppear:we,onAppearCancelled:we},fi={name:"BaseTransition",props:no,setup(e,{slots:s}){const n=er(),t=gi();let o;return()=>{const a=s.default&&ao(s.default(),!0);if(!a||!a.length)return;let i=a[0];if(a.length>1){for(const D of a)if(D.type!==Se){i=D;break}}const r=R(e),{mode:c}=r;if(t.isLeaving)return Mn(i);const u=oo(i);if(!u)return Mn(i);const d=Fn(u,r,t,n);Yn(u,d);const y=n.subTree,w=y&&oo(y);let A=!1;const{getTransitionKey:P}=u.type;if(P){const D=P();o===void 0?o=D:D!==o&&(o=D,A=!0)}if(w&&w.type!==Se&&(!es(u,w)||A)){const D=Fn(w,r,t,n);if(Yn(w,D),c==="out-in")return t.isLeaving=!0,D.afterLeave=()=>{t.isLeaving=!1,n.update.active!==!1&&(n.effect.dirty=!0,n.update())},Mn(i);c==="in-out"&&u.type!==Se&&(D.delayLeave=(U,M,ae)=>{const C=to(t,w);C[String(w.key)]=w,U[He]=()=>{M(),U[He]=void 0,delete d.delayedLeave},d.delayedLeave=ae})}return i}}};function to(e,s){const{leavingVNodes:n}=e;let t=n.get(s.type);return t||(t=Object.create(null),n.set(s.type,t)),t}function Fn(e,s,n,t){const{appear:o,mode:a,persisted:i=!1,onBeforeEnter:r,onEnter:c,onAfterEnter:u,onEnterCancelled:d,onBeforeLeave:y,onLeave:w,onAfterLeave:A,onLeaveCancelled:P,onBeforeAppear:D,onAppear:U,onAfterAppear:M,onAppearCancelled:ae}=s,C=String(e.key),Y=to(n,e),Z=(I,X)=>{I&&be(I,t,9,X)},O=(I,X)=>{const L=X[1];Z(I,X),k(I)?I.every(re=>re.length<=1)&&L():I.length<=1&&L()},pe={mode:a,persisted:i,beforeEnter(I){let X=r;if(!n.isMounted)if(o)X=D||r;else return;I[He]&&I[He](!0);const L=Y[C];L&&es(e,L)&&L.el[He]&&L.el[He](),Z(X,[I])},enter(I){let X=c,L=u,re=d;if(!n.isMounted)if(o)X=U||c,L=M||u,re=ae||d;else return;let _=!1;const G=I[Ws]=ge=>{_||(_=!0,ge?Z(re,[I]):Z(L,[I]),pe.delayedLeave&&pe.delayedLeave(),I[Ws]=void 0)};X?O(X,[I,G]):G()},leave(I,X){const L=String(e.key);if(I[Ws]&&I[Ws](!0),n.isUnmounting)return X();Z(y,[I]);let re=!1;const _=I[He]=G=>{re||(re=!0,X(),G?Z(P,[I]):Z(A,[I]),I[He]=void 0,Y[L]===e&&delete Y[L])};Y[L]=e,w?O(w,[I,_]):_()},clone(I){return Fn(I,s,n,t)}};return pe}function Mn(e){if($s(e))return e=Be(e),e.children=null,e}function oo(e){return $s(e)?e.children?e.children[0]:void 0:e}function Yn(e,s){e.shapeFlag&6&&e.component?Yn(e.component.subTree,s):e.shapeFlag&128?(e.ssContent.transition=s.clone(e.ssContent),e.ssFallback.transition=s.clone(e.ssFallback)):e.transition=s}function ao(e,s=!1,n){let t=[],o=0;for(let a=0;a<e.length;a++){let i=e[a];const r=n==null?i.key:String(n)+String(i.key!=null?i.key:a);i.type===ve?(i.patchFlag&128&&o++,t=t.concat(ao(i.children,s,r))):(s||i.type!==Se)&&t.push(r!=null?Be(i,{key:r}):i)}if(o>1)for(let a=0;a<t.length;a++)t[a].patchFlag=-2;return t}/*! #__NO_SIDE_EFFECTS__ */function Hn(e,s){return q(e)?ee({name:e.name},s,{setup:e}):e}const Vs=e=>!!e.type.__asyncLoader,$s=e=>e.type.__isKeepAlive;function yi(e,s){io(e,"a",s)}function bi(e,s){io(e,"da",s)}function io(e,s,n=oe){const t=e.__wdc||(e.__wdc=()=>{let o=n;for(;o;){if(o.isDeactivated)return;o=o.parent}return e()});if(Gs(s,t,n),n){let o=n.parent;for(;o&&o.parent;)$s(o.parent.vnode)&&ji(t,s,n,o),o=o.parent}}function ji(e,s,n,t){const o=Gs(s,e,t,!0);co(()=>{dn(t[s],o)},n)}function Gs(e,s,n=oe,t=!1){if(n){const o=n[e]||(n[e]=[]),a=s.__weh||(s.__weh=(...i)=>{if(n.isUnmounted)return;Re();const r=Ts(n),c=be(s,n,e,i);return r(),Fe(),c});return t?o.unshift(a):o.push(a),a}}const Ee=e=>(s,n=oe)=>(!an||e==="sp")&&Gs(e,(...t)=>s(...t),n),wi=Ee("bm"),ro=Ee("m"),vi=Ee("bu"),Ji=Ee("u"),lo=Ee("bum"),co=Ee("um"),Si=Ee("sp"),_i=Ee("rtg"),Ti=Ee("rtc");function Ai(e,s=oe){Gs("ec",e,s)}function po(e,s,n,t){let o;const a=n&&n[t];if(k(e)||Q(e)){o=new Array(e.length);for(let i=0,r=e.length;i<r;i++)o[i]=s(e[i],i,void 0,a&&a[i])}else if(typeof e=="number"){o=new Array(e);for(let i=0;i<e;i++)o[i]=s(i+1,i,void 0,a&&a[i])}else if(B(e))if(e[Symbol.iterator])o=Array.from(e,(i,r)=>s(i,r,void 0,a&&a[r]));else{const i=Object.keys(e);o=new Array(i.length);for(let r=0,c=i.length;r<c;r++){const u=i[r];o[r]=s(e[u],u,r,a&&a[r])}}else o=[];return n&&(n[t]=o),o}const Bn=e=>e?Oo(e)?nt(e)||e.proxy:Bn(e.parent):null,ws=ee(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Bn(e.parent),$root:e=>Bn(e.root),$emit:e=>e.emit,$options:e=>Wn(e),$forceUpdate:e=>e.f||(e.f=()=>{e.effect.dirty=!0,En(e.update)}),$nextTick:e=>e.n||(e.n=Xa.bind(e.proxy)),$watch:e=>mi.bind(e)}),Un=(e,s)=>e!==W&&!e.__isScriptSetup&&E(e,s),xi={get({_:e},s){const{ctx:n,setupState:t,data:o,props:a,accessCache:i,type:r,appContext:c}=e;let u;if(s[0]!=="$"){const A=i[s];if(A!==void 0)switch(A){case 1:return t[s];case 2:return o[s];case 4:return n[s];case 3:return a[s]}else{if(Un(t,s))return i[s]=1,t[s];if(o!==W&&E(o,s))return i[s]=2,o[s];if((u=e.propsOptions[0])&&E(u,s))return i[s]=3,a[s];if(n!==W&&E(n,s))return i[s]=4,n[s];Ln&&(i[s]=0)}}const d=ws[s];let y,w;if(d)return s==="$attrs"&&ue(e,"get",s),d(e);if((y=r.__cssModules)&&(y=y[s]))return y;if(n!==W&&E(n,s))return i[s]=4,n[s];if(w=c.config.globalProperties,E(w,s))return w[s]},set({_:e},s,n){const{data:t,setupState:o,ctx:a}=e;return Un(o,s)?(o[s]=n,!0):t!==W&&E(t,s)?(t[s]=n,!0):E(e.props,s)||s[0]==="$"&&s.slice(1)in e?!1:(a[s]=n,!0)},has({_:{data:e,setupState:s,accessCache:n,ctx:t,appContext:o,propsOptions:a}},i){let r;return!!n[i]||e!==W&&E(e,i)||Un(s,i)||(r=a[0])&&E(r,i)||E(t,i)||E(ws,i)||E(o.config.globalProperties,i)},defineProperty(e,s,n){return n.get!=null?e._.accessCache[s]=0:E(n,"value")&&this.set(e,s,n.value,null),Reflect.defineProperty(e,s,n)}};function uo(e){return k(e)?e.reduce((s,n)=>(s[n]=null,s),{}):e}let Ln=!0;function ki(e){const s=Wn(e),n=e.proxy,t=e.ctx;Ln=!1,s.beforeCreate&&ho(s.beforeCreate,e,"bc");const{data:o,computed:a,methods:i,watch:r,provide:c,inject:u,created:d,beforeMount:y,mounted:w,beforeUpdate:A,updated:P,activated:D,deactivated:U,beforeDestroy:M,beforeUnmount:ae,destroyed:C,unmounted:Y,render:Z,renderTracked:O,renderTriggered:pe,errorCaptured:I,serverPrefetch:X,expose:L,inheritAttrs:re,components:_,directives:G,filters:ge}=s;if(u&&Di(u,t,null),i)for(const K in i){const H=i[K];q(H)&&(t[K]=H.bind(n))}if(o){const K=o.call(n,n);B(K)&&(e.data=xn(K))}if(Ln=!0,a)for(const K in a){const H=a[K],ts=q(H)?H.bind(n,n):q(H.get)?H.get.bind(n,n):ye,ln=!q(H)&&q(H.set)?H.set.bind(n):ye,os=lr({get:ts,set:ln});Object.defineProperty(t,K,{enumerable:!0,configurable:!0,get:()=>os.value,set:qe=>os.value=qe})}if(r)for(const K in r)mo(r[K],t,n,K);if(c){const K=q(c)?c.call(n):c;Reflect.ownKeys(K).forEach(H=>{Ei(H,K[H])})}d&&ho(d,e,"c");function ne(K,H){k(H)?H.forEach(ts=>K(ts.bind(n))):H&&K(H.bind(n))}if(ne(wi,y),ne(ro,w),ne(vi,A),ne(Ji,P),ne(yi,D),ne(bi,U),ne(Ai,I),ne(Ti,O),ne(_i,pe),ne(lo,ae),ne(co,Y),ne(Si,X),k(L))if(L.length){const K=e.exposed||(e.exposed={});L.forEach(H=>{Object.defineProperty(K,H,{get:()=>n[H],set:ts=>n[H]=ts})})}else e.exposed||(e.exposed={});Z&&e.render===ye&&(e.render=Z),re!=null&&(e.inheritAttrs=re),_&&(e.components=_),G&&(e.directives=G)}function Di(e,s,n=ye){k(e)&&(e=Vn(e));for(const t in e){const o=e[t];let a;B(o)?"default"in o?a=Zs(o.from||t,o.default,!0):a=Zs(o.from||t):a=Zs(o),de(a)?Object.defineProperty(s,t,{enumerable:!0,configurable:!0,get:()=>a.value,set:i=>a.value=i}):s[t]=a}}function ho(e,s,n){be(k(e)?e.map(t=>t.bind(s.proxy)):e.bind(s.proxy),s,n)}function mo(e,s,n,t){const o=t.includes(".")?so(n,t):()=>n[t];if(Q(e)){const a=s[e];q(a)&&Rn(o,a)}else if(q(e))Rn(o,e.bind(n));else if(B(e))if(k(e))e.forEach(a=>mo(a,s,n,t));else{const a=q(e.handler)?e.handler.bind(n):s[e.handler];q(a)&&Rn(o,a,e)}}function Wn(e){const s=e.type,{mixins:n,extends:t}=s,{mixins:o,optionsCache:a,config:{optionMergeStrategies:i}}=e.appContext,r=a.get(s);let c;return r?c=r:!o.length&&!n&&!t?c=s:(c={},o.length&&o.forEach(u=>Ks(c,u,i,!0)),Ks(c,s,i)),B(s)&&a.set(s,c),c}function Ks(e,s,n,t=!1){const{mixins:o,extends:a}=s;a&&Ks(e,a,n,!0),o&&o.forEach(i=>Ks(e,i,n,!0));for(const i in s)if(!(t&&i==="expose")){const r=Ni[i]||n&&n[i];e[i]=r?r(e[i],s[i]):s[i]}return e}const Ni={data:go,props:fo,emits:fo,methods:vs,computed:vs,beforeCreate:le,created:le,beforeMount:le,mounted:le,beforeUpdate:le,updated:le,beforeDestroy:le,beforeUnmount:le,destroyed:le,unmounted:le,activated:le,deactivated:le,errorCaptured:le,serverPrefetch:le,components:vs,directives:vs,watch:Ii,provide:go,inject:qi};function go(e,s){return s?e?function(){return ee(q(e)?e.call(this,this):e,q(s)?s.call(this,this):s)}:s:e}function qi(e,s){return vs(Vn(e),Vn(s))}function Vn(e){if(k(e)){const s={};for(let n=0;n<e.length;n++)s[e[n]]=e[n];return s}return e}function le(e,s){return e?[...new Set([].concat(e,s))]:s}function vs(e,s){return e?ee(Object.create(null),e,s):s}function fo(e,s){return e?k(e)&&k(s)?[...new Set([...e,...s])]:ee(Object.create(null),uo(e),uo(s??{})):s}function Ii(e,s){if(!e)return s;if(!s)return e;const n=ee(Object.create(null),e);for(const t in s)n[t]=le(e[t],s[t]);return n}function yo(){return{app:null,config:{isNativeTag:ra,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Oi=0;function zi(e,s){return function(t,o=null){q(t)||(t=ee({},t)),o!=null&&!B(o)&&(o=null);const a=yo(),i=new WeakSet;let r=!1;const c=a.app={_uid:Oi++,_component:t,_props:o,_container:null,_context:a,_instance:null,version:pr,get config(){return a.config},set config(u){},use(u,...d){return i.has(u)||(u&&q(u.install)?(i.add(u),u.install(c,...d)):q(u)&&(i.add(u),u(c,...d))),c},mixin(u){return a.mixins.includes(u)||a.mixins.push(u),c},component(u,d){return d?(a.components[u]=d,c):a.components[u]},directive(u,d){return d?(a.directives[u]=d,c):a.directives[u]},mount(u,d,y){if(!r){const w=ce(t,o);return w.appContext=a,y===!0?y="svg":y===!1&&(y=void 0),d&&s?s(w,u):e(w,u,y),r=!0,c._container=u,u.__vue_app__=c,nt(w.component)||w.component.proxy}},unmount(){r&&(e(null,c._container),delete c._container.__vue_app__)},provide(u,d){return a.provides[u]=d,c},runWithContext(u){const d=Js;Js=c;try{return u()}finally{Js=d}}};return c}}let Js=null;function Ei(e,s){if(oe){let n=oe.provides;const t=oe.parent&&oe.parent.provides;t===n&&(n=oe.provides=Object.create(t)),n[e]=s}}function Zs(e,s,n=!1){const t=oe||je;if(t||Js){const o=t?t.parent==null?t.vnode.appContext&&t.vnode.appContext.provides:t.parent.provides:Js._context.provides;if(o&&e in o)return o[e];if(arguments.length>1)return n&&q(s)?s.call(t&&t.proxy):s}}function Pi(e,s,n,t=!1){const o={},a={};zs(a,sn,1),e.propsDefaults=Object.create(null),bo(e,s,o,a);for(const i in e.propsOptions[0])i in o||(o[i]=void 0);n?e.props=t?o:Ha(o):e.type.props?e.props=o:e.props=a,e.attrs=a}function Ci(e,s,n,t){const{props:o,attrs:a,vnode:{patchFlag:i}}=e,r=R(o),[c]=e.propsOptions;let u=!1;if((t||i>0)&&!(i&16)){if(i&8){const d=e.vnode.dynamicProps;for(let y=0;y<d.length;y++){let w=d[y];if(Bs(e.emitsOptions,w))continue;const A=s[w];if(c)if(E(a,w))A!==a[w]&&(a[w]=A,u=!0);else{const P=Ae(w);o[P]=$n(c,r,P,A,e,!1)}else A!==a[w]&&(a[w]=A,u=!0)}}}else{bo(e,s,o,a)&&(u=!0);let d;for(const y in r)(!s||!E(s,y)&&((d=ls(y))===y||!E(s,d)))&&(c?n&&(n[y]!==void 0||n[d]!==void 0)&&(o[y]=$n(c,r,y,void 0,e,!0)):delete o[y]);if(a!==r)for(const y in a)(!s||!E(s,y))&&(delete a[y],u=!0)}u&&Oe(e,"set","$attrs")}function bo(e,s,n,t){const[o,a]=e.propsOptions;let i=!1,r;if(s)for(let c in s){if(ms(c))continue;const u=s[c];let d;o&&E(o,d=Ae(c))?!a||!a.includes(d)?n[d]=u:(r||(r={}))[d]=u:Bs(e.emitsOptions,c)||(!(c in t)||u!==t[c])&&(t[c]=u,i=!0)}if(a){const c=R(n),u=r||W;for(let d=0;d<a.length;d++){const y=a[d];n[y]=$n(o,c,y,u[y],e,!E(u,y))}}return i}function $n(e,s,n,t,o,a){const i=e[n];if(i!=null){const r=E(i,"default");if(r&&t===void 0){const c=i.default;if(i.type!==Function&&!i.skipFactory&&q(c)){const{propsDefaults:u}=o;if(n in u)t=u[n];else{const d=Ts(o);t=u[n]=c.call(null,s),d()}}else t=c}i[0]&&(a&&!r?t=!1:i[1]&&(t===""||t===ls(n))&&(t=!0))}return t}function jo(e,s,n=!1){const t=s.propsCache,o=t.get(e);if(o)return o;const a=e.props,i={},r=[];let c=!1;if(!q(e)){const d=y=>{c=!0;const[w,A]=jo(y,s,!0);ee(i,w),A&&r.push(...A)};!n&&s.mixins.length&&s.mixins.forEach(d),e.extends&&d(e.extends),e.mixins&&e.mixins.forEach(d)}if(!a&&!c)return B(e)&&t.set(e,as),as;if(k(a))for(let d=0;d<a.length;d++){const y=Ae(a[d]);wo(y)&&(i[y]=W)}else if(a)for(const d in a){const y=Ae(d);if(wo(y)){const w=a[d],A=i[y]=k(w)||q(w)?{type:w}:ee({},w);if(A){const P=So(Boolean,A.type),D=So(String,A.type);A[0]=P>-1,A[1]=D<0||P<D,(P>-1||E(A,"default"))&&r.push(y)}}}const u=[i,r];return B(e)&&t.set(e,u),u}function wo(e){return e[0]!=="$"&&!ms(e)}function vo(e){return e===null?"null":typeof e=="function"?e.name||"":typeof e=="object"&&e.constructor&&e.constructor.name||""}function Jo(e,s){return vo(e)===vo(s)}function So(e,s){return k(s)?s.findIndex(n=>Jo(n,e)):q(s)&&Jo(s,e)?0:-1}const _o=e=>e[0]==="_"||e==="$stable",Gn=e=>k(e)?e.map(De):[De(e)],Ri=(e,s,n)=>{if(s._n)return s;const t=Kt((...o)=>Gn(s(...o)),n);return t._c=!1,t},To=(e,s,n)=>{const t=e._ctx;for(const o in e){if(_o(o))continue;const a=e[o];if(q(a))s[o]=Ri(o,a,t);else if(a!=null){const i=Gn(a);s[o]=()=>i}}},Ao=(e,s)=>{const n=Gn(s);e.slots.default=()=>n},Fi=(e,s)=>{if(e.vnode.shapeFlag&32){const n=s._;n?(e.slots=R(s),zs(s,"_",n)):To(s,e.slots={})}else e.slots={},s&&Ao(e,s);zs(e.slots,sn,1)},Mi=(e,s,n)=>{const{vnode:t,slots:o}=e;let a=!0,i=W;if(t.shapeFlag&32){const r=s._;r?n&&r===1?a=!1:(ee(o,s),!n&&r===1&&delete o._):(a=!s.$stable,To(s,o)),i=s}else s&&(Ao(e,s),i={default:1});if(a)for(const r in o)!_o(r)&&i[r]==null&&delete o[r]};function Kn(e,s,n,t,o=!1){if(k(e)){e.forEach((w,A)=>Kn(w,s&&(k(s)?s[A]:s),n,t,o));return}if(Vs(t)&&!o)return;const a=t.shapeFlag&4?nt(t.component)||t.component.proxy:t.el,i=o?null:a,{i:r,r:c}=e,u=s&&s.r,d=r.refs===W?r.refs={}:r.refs,y=r.setupState;if(u!=null&&u!==c&&(Q(u)?(d[u]=null,E(y,u)&&(y[u]=null)):de(u)&&(u.value=null)),q(c))ze(c,r,12,[i,d]);else{const w=Q(c),A=de(c);if(w||A){const P=()=>{if(e.f){const D=w?E(y,c)?y[c]:d[c]:c.value;o?k(D)&&dn(D,a):k(D)?D.includes(a)||D.push(a):w?(d[c]=[a],E(y,c)&&(y[c]=d[c])):(c.value=[a],e.k&&(d[e.k]=c.value))}else w?(d[c]=i,E(y,c)&&(y[c]=i)):A&&(c.value=i,e.k&&(d[e.k]=i))};i?(P.id=-1,he(P,n)):P()}}}const he=ui;function Yi(e){return Hi(e)}function Hi(e,s){const n=ft();n.__VUE__=!0;const{insert:t,remove:o,patchProp:a,createElement:i,createText:r,createComment:c,setText:u,setElementText:d,parentNode:y,nextSibling:w,setScopeId:A=ye,insertStaticContent:P}=e,D=(l,p,h,m=null,g=null,j=null,J=void 0,b=null,v=!!p.dynamicChildren)=>{if(l===p)return;l&&!es(l,p)&&(m=cn(l),qe(l,g,j,!0),l=null),p.patchFlag===-2&&(v=!1,p.dynamicChildren=null);const{type:f,ref:S,shapeFlag:x}=p;switch(f){case Xs:U(l,p,h,m);break;case Se:M(l,p,h,m);break;case Qs:l==null&&ae(p,h,m,J);break;case ve:_(l,p,h,m,g,j,J,b,v);break;default:x&1?Z(l,p,h,m,g,j,J,b,v):x&6?G(l,p,h,m,g,j,J,b,v):(x&64||x&128)&&f.process(l,p,h,m,g,j,J,b,v,ds)}S!=null&&g&&Kn(S,l&&l.ref,j,p||l,!p)},U=(l,p,h,m)=>{if(l==null)t(p.el=r(p.children),h,m);else{const g=p.el=l.el;p.children!==l.children&&u(g,p.children)}},M=(l,p,h,m)=>{l==null?t(p.el=c(p.children||""),h,m):p.el=l.el},ae=(l,p,h,m)=>{[l.el,l.anchor]=P(l.children,p,h,m,l.el,l.anchor)},C=({el:l,anchor:p},h,m)=>{let g;for(;l&&l!==p;)g=w(l),t(l,h,m),l=g;t(p,h,m)},Y=({el:l,anchor:p})=>{let h;for(;l&&l!==p;)h=w(l),o(l),l=h;o(p)},Z=(l,p,h,m,g,j,J,b,v)=>{p.type==="svg"?J="svg":p.type==="math"&&(J="mathml"),l==null?O(p,h,m,g,j,J,b,v):X(l,p,g,j,J,b,v)},O=(l,p,h,m,g,j,J,b)=>{let v,f;const{props:S,shapeFlag:x,transition:T,dirs:N}=l;if(v=l.el=i(l.type,j,S&&S.is,S),x&8?d(v,l.children):x&16&&I(l.children,v,null,m,g,Zn(l,j),J,b),N&&Xe(l,null,m,"created"),pe(v,l,l.scopeId,J,m),S){for(const F in S)F!=="value"&&!ms(F)&&a(v,F,null,S[F],j,l.children,m,g,Pe);"value"in S&&a(v,"value",null,S.value,j),(f=S.onVnodeBeforeMount)&&Ne(f,m,l)}N&&Xe(l,null,m,"beforeMount");const z=Bi(g,T);z&&T.beforeEnter(v),t(v,p,h),((f=S&&S.onVnodeMounted)||z||N)&&he(()=>{f&&Ne(f,m,l),z&&T.enter(v),N&&Xe(l,null,m,"mounted")},g)},pe=(l,p,h,m,g)=>{if(h&&A(l,h),m)for(let j=0;j<m.length;j++)A(l,m[j]);if(g){let j=g.subTree;if(p===j){const J=g.vnode;pe(l,J,J.scopeId,J.slotScopeIds,g.parent)}}},I=(l,p,h,m,g,j,J,b,v=0)=>{for(let f=v;f<l.length;f++){const S=l[f]=b?Ue(l[f]):De(l[f]);D(null,S,p,h,m,g,j,J,b)}},X=(l,p,h,m,g,j,J)=>{const b=p.el=l.el;let{patchFlag:v,dynamicChildren:f,dirs:S}=p;v|=l.patchFlag&16;const x=l.props||W,T=p.props||W;let N;if(h&&Qe(h,!1),(N=T.onVnodeBeforeUpdate)&&Ne(N,h,p,l),S&&Xe(p,l,h,"beforeUpdate"),h&&Qe(h,!0),f?L(l.dynamicChildren,f,b,h,m,Zn(p,g),j):J||H(l,p,b,null,h,m,Zn(p,g),j,!1),v>0){if(v&16)re(b,p,x,T,h,m,g);else if(v&2&&x.class!==T.class&&a(b,"class",null,T.class,g),v&4&&a(b,"style",x.style,T.style,g),v&8){const z=p.dynamicProps;for(let F=0;F<z.length;F++){const V=z[F],te=x[V],Te=T[V];(Te!==te||V==="value")&&a(b,V,te,Te,g,l.children,h,m,Pe)}}v&1&&l.children!==p.children&&d(b,p.children)}else!J&&f==null&&re(b,p,x,T,h,m,g);((N=T.onVnodeUpdated)||S)&&he(()=>{N&&Ne(N,h,p,l),S&&Xe(p,l,h,"updated")},m)},L=(l,p,h,m,g,j,J)=>{for(let b=0;b<p.length;b++){const v=l[b],f=p[b],S=v.el&&(v.type===ve||!es(v,f)||v.shapeFlag&70)?y(v.el):h;D(v,f,S,null,m,g,j,J,!0)}},re=(l,p,h,m,g,j,J)=>{if(h!==m){if(h!==W)for(const b in h)!ms(b)&&!(b in m)&&a(l,b,h[b],null,J,p.children,g,j,Pe);for(const b in m){if(ms(b))continue;const v=m[b],f=h[b];v!==f&&b!=="value"&&a(l,b,f,v,J,p.children,g,j,Pe)}"value"in m&&a(l,"value",h.value,m.value,J)}},_=(l,p,h,m,g,j,J,b,v)=>{const f=p.el=l?l.el:r(""),S=p.anchor=l?l.anchor:r("");let{patchFlag:x,dynamicChildren:T,slotScopeIds:N}=p;N&&(b=b?b.concat(N):N),l==null?(t(f,h,m),t(S,h,m),I(p.children||[],h,S,g,j,J,b,v)):x>0&&x&64&&T&&l.dynamicChildren?(L(l.dynamicChildren,T,h,g,j,J,b),(p.key!=null||g&&p===g.subTree)&&xo(l,p,!0)):H(l,p,h,S,g,j,J,b,v)},G=(l,p,h,m,g,j,J,b,v)=>{p.slotScopeIds=b,l==null?p.shapeFlag&512?g.ctx.activate(p,h,m,J,v):ge(p,h,m,g,j,J,v):ks(l,p,v)},ge=(l,p,h,m,g,j,J)=>{const b=l.component=Qi(l,m,g);if($s(l)&&(b.ctx.renderer=ds),sr(b),b.asyncDep){if(g&&g.registerDep(b,ne),!l.el){const v=b.subTree=ce(Se);M(null,v,p,h)}}else ne(b,l,p,h,g,j,J)},ks=(l,p,h)=>{const m=p.component=l.component;if(ii(l,p,h))if(m.asyncDep&&!m.asyncResolved){K(m,p,h);return}else m.next=p,ei(m.update),m.effect.dirty=!0,m.update();else p.el=l.el,m.vnode=p},ne=(l,p,h,m,g,j,J)=>{const b=()=>{if(l.isMounted){let{next:S,bu:x,u:T,parent:N,vnode:z}=l;{const hs=ko(l);if(hs){S&&(S.el=z.el,K(l,S,J)),hs.asyncDep.then(()=>{l.isUnmounted||b()});return}}let F=S,V;Qe(l,!1),S?(S.el=z.el,K(l,S,J)):S=z,x&&gn(x),(V=S.props&&S.props.onVnodeBeforeUpdate)&&Ne(V,N,S,z),Qe(l,!0);const te=Pn(l),Te=l.subTree;l.subTree=te,D(Te,te,y(Te.el),cn(Te),l,g,j),S.el=te.el,F===null&&ri(l,te.el),T&&he(T,g),(V=S.props&&S.props.onVnodeUpdated)&&he(()=>Ne(V,N,S,z),g)}else{let S;const{el:x,props:T}=p,{bm:N,m:z,parent:F}=l,V=Vs(p);if(Qe(l,!1),N&&gn(N),!V&&(S=T&&T.onVnodeBeforeMount)&&Ne(S,F,p),Qe(l,!0),x&&pt){const te=()=>{l.subTree=Pn(l),pt(x,l.subTree,l,g,null)};V?p.type.__asyncLoader().then(()=>!l.isUnmounted&&te()):te()}else{const te=l.subTree=Pn(l);D(null,te,h,m,l,g,j),p.el=te.el}if(z&&he(z,g),!V&&(S=T&&T.onVnodeMounted)){const te=p;he(()=>Ne(S,F,te),g)}(p.shapeFlag&256||F&&Vs(F.vnode)&&F.vnode.shapeFlag&256)&&l.a&&he(l.a,g),l.isMounted=!0,p=h=m=null}},v=l.effect=new bn(b,ye,()=>En(f),l.scope),f=l.update=()=>{v.dirty&&v.run()};f.id=l.uid,Qe(l,!0),f()},K=(l,p,h)=>{p.component=l;const m=l.vnode.props;l.vnode=p,l.next=null,Ci(l,p.props,m,h),Mi(l,p.children,h),Re(),Lt(l),Fe()},H=(l,p,h,m,g,j,J,b,v=!1)=>{const f=l&&l.children,S=l?l.shapeFlag:0,x=p.children,{patchFlag:T,shapeFlag:N}=p;if(T>0){if(T&128){ln(f,x,h,m,g,j,J,b,v);return}else if(T&256){ts(f,x,h,m,g,j,J,b,v);return}}N&8?(S&16&&Pe(f,g,j),x!==f&&d(h,x)):S&16?N&16?ln(f,x,h,m,g,j,J,b,v):Pe(f,g,j,!0):(S&8&&d(h,""),N&16&&I(x,h,m,g,j,J,b,v))},ts=(l,p,h,m,g,j,J,b,v)=>{l=l||as,p=p||as;const f=l.length,S=p.length,x=Math.min(f,S);let T;for(T=0;T<x;T++){const N=p[T]=v?Ue(p[T]):De(p[T]);D(l[T],N,h,null,g,j,J,b,v)}f>S?Pe(l,g,j,!0,!1,x):I(p,h,m,g,j,J,b,v,x)},ln=(l,p,h,m,g,j,J,b,v)=>{let f=0;const S=p.length;let x=l.length-1,T=S-1;for(;f<=x&&f<=T;){const N=l[f],z=p[f]=v?Ue(p[f]):De(p[f]);if(es(N,z))D(N,z,h,null,g,j,J,b,v);else break;f++}for(;f<=x&&f<=T;){const N=l[x],z=p[T]=v?Ue(p[T]):De(p[T]);if(es(N,z))D(N,z,h,null,g,j,J,b,v);else break;x--,T--}if(f>x){if(f<=T){const N=T+1,z=N<S?p[N].el:m;for(;f<=T;)D(null,p[f]=v?Ue(p[f]):De(p[f]),h,z,g,j,J,b,v),f++}}else if(f>T)for(;f<=x;)qe(l[f],g,j,!0),f++;else{const N=f,z=f,F=new Map;for(f=z;f<=T;f++){const fe=p[f]=v?Ue(p[f]):De(p[f]);fe.key!=null&&F.set(fe.key,f)}let V,te=0;const Te=T-z+1;let hs=!1,oa=0;const Ds=new Array(Te);for(f=0;f<Te;f++)Ds[f]=0;for(f=N;f<=x;f++){const fe=l[f];if(te>=Te){qe(fe,g,j,!0);continue}let Ie;if(fe.key!=null)Ie=F.get(fe.key);else for(V=z;V<=T;V++)if(Ds[V-z]===0&&es(fe,p[V])){Ie=V;break}Ie===void 0?qe(fe,g,j,!0):(Ds[Ie-z]=f+1,Ie>=oa?oa=Ie:hs=!0,D(fe,p[Ie],h,null,g,j,J,b,v),te++)}const aa=hs?Ui(Ds):as;for(V=aa.length-1,f=Te-1;f>=0;f--){const fe=z+f,Ie=p[fe],ia=fe+1<S?p[fe+1].el:m;Ds[f]===0?D(null,Ie,h,ia,g,j,J,b,v):hs&&(V<0||f!==aa[V]?os(Ie,h,ia,2):V--)}}},os=(l,p,h,m,g=null)=>{const{el:j,type:J,transition:b,children:v,shapeFlag:f}=l;if(f&6){os(l.component.subTree,p,h,m);return}if(f&128){l.suspense.move(p,h,m);return}if(f&64){J.move(l,p,h,ds);return}if(J===ve){t(j,p,h);for(let x=0;x<v.length;x++)os(v[x],p,h,m);t(l.anchor,p,h);return}if(J===Qs){C(l,p,h);return}if(m!==2&&f&1&&b)if(m===0)b.beforeEnter(j),t(j,p,h),he(()=>b.enter(j),g);else{const{leave:x,delayLeave:T,afterLeave:N}=b,z=()=>t(j,p,h),F=()=>{x(j,()=>{z(),N&&N()})};T?T(j,z,F):F()}else t(j,p,h)},qe=(l,p,h,m=!1,g=!1)=>{const{type:j,props:J,ref:b,children:v,dynamicChildren:f,shapeFlag:S,patchFlag:x,dirs:T}=l;if(b!=null&&Kn(b,null,h,l,!0),S&256){p.ctx.deactivate(l);return}const N=S&1&&T,z=!Vs(l);let F;if(z&&(F=J&&J.onVnodeBeforeUnmount)&&Ne(F,p,l),S&6)Jl(l.component,h,m);else{if(S&128){l.suspense.unmount(h,m);return}N&&Xe(l,null,p,"beforeUnmount"),S&64?l.type.remove(l,p,h,g,ds,m):f&&(j!==ve||x>0&&x&64)?Pe(f,p,h,!1,!0):(j===ve&&x&384||!g&&S&16)&&Pe(v,p,h),m&&na(l)}(z&&(F=J&&J.onVnodeUnmounted)||N)&&he(()=>{F&&Ne(F,p,l),N&&Xe(l,null,p,"unmounted")},h)},na=l=>{const{type:p,el:h,anchor:m,transition:g}=l;if(p===ve){vl(h,m);return}if(p===Qs){Y(l);return}const j=()=>{o(h),g&&!g.persisted&&g.afterLeave&&g.afterLeave()};if(l.shapeFlag&1&&g&&!g.persisted){const{leave:J,delayLeave:b}=g,v=()=>J(h,j);b?b(l.el,j,v):v()}else j()},vl=(l,p)=>{let h;for(;l!==p;)h=w(l),o(l),l=h;o(p)},Jl=(l,p,h)=>{const{bum:m,scope:g,update:j,subTree:J,um:b}=l;m&&gn(m),g.stop(),j&&(j.active=!1,qe(J,l,p,h)),b&&he(b,p),he(()=>{l.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&l.asyncDep&&!l.asyncResolved&&l.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},Pe=(l,p,h,m=!1,g=!1,j=0)=>{for(let J=j;J<l.length;J++)qe(l[J],p,h,m,g)},cn=l=>l.shapeFlag&6?cn(l.component.subTree):l.shapeFlag&128?l.suspense.next():w(l.anchor||l.el);let lt=!1;const ta=(l,p,h)=>{l==null?p._vnode&&qe(p._vnode,null,null,!0):D(p._vnode||null,l,p,null,null,null,h),lt||(lt=!0,Lt(),Wt(),lt=!1),p._vnode=l},ds={p:D,um:qe,m:os,r:na,mt:ge,mc:I,pc:H,pbc:L,n:cn,o:e};let ct,pt;return s&&([ct,pt]=s(ds)),{render:ta,hydrate:ct,createApp:zi(ta,ct)}}function Zn({type:e,props:s},n){return n==="svg"&&e==="foreignObject"||n==="mathml"&&e==="annotation-xml"&&s&&s.encoding&&s.encoding.includes("html")?void 0:n}function Qe({effect:e,update:s},n){e.allowRecurse=s.allowRecurse=n}function Bi(e,s){return(!e||e&&!e.pendingBranch)&&s&&!s.persisted}function xo(e,s,n=!1){const t=e.children,o=s.children;if(k(t)&&k(o))for(let a=0;a<t.length;a++){const i=t[a];let r=o[a];r.shapeFlag&1&&!r.dynamicChildren&&((r.patchFlag<=0||r.patchFlag===32)&&(r=o[a]=Ue(o[a]),r.el=i.el),n||xo(i,r)),r.type===Xs&&(r.el=i.el)}}function Ui(e){const s=e.slice(),n=[0];let t,o,a,i,r;const c=e.length;for(t=0;t<c;t++){const u=e[t];if(u!==0){if(o=n[n.length-1],e[o]<u){s[t]=o,n.push(t);continue}for(a=0,i=n.length-1;a<i;)r=a+i>>1,e[n[r]]<u?a=r+1:i=r;u<e[n[a]]&&(a>0&&(s[t]=n[a-1]),n[a]=t)}}for(a=n.length,i=n[a-1];a-- >0;)n[a]=i,i=s[i];return n}function ko(e){const s=e.subTree.component;if(s)return s.asyncDep&&!s.asyncResolved?s:ko(s)}const Li=e=>e.__isTeleport,ve=Symbol.for("v-fgt"),Xs=Symbol.for("v-txt"),Se=Symbol.for("v-cmt"),Qs=Symbol.for("v-stc"),Ss=[];let _e=null;function me(e=!1){Ss.push(_e=e?null:[])}function Wi(){Ss.pop(),_e=Ss[Ss.length-1]||null}let _s=1;function Do(e){_s+=e}function No(e){return e.dynamicChildren=_s>0?_e||as:null,Wi(),_s>0&&_e&&_e.push(e),e}function ke(e,s,n,t,o,a){return No(se(e,s,n,t,o,a,!0))}function en(e,s,n,t,o){return No(ce(e,s,n,t,o,!0))}function Xn(e){return e?e.__v_isVNode===!0:!1}function es(e,s){return e.type===s.type&&e.key===s.key}const sn="__vInternal",qo=({key:e})=>e??null,nn=({ref:e,ref_key:s,ref_for:n})=>(typeof e=="number"&&(e=""+e),e!=null?Q(e)||de(e)||q(e)?{i:je,r:e,k:s,f:!!n}:e:null);function se(e,s=null,n=null,t=0,o=null,a=e===ve?0:1,i=!1,r=!1){const c={__v_isVNode:!0,__v_skip:!0,type:e,props:s,key:s&&qo(s),ref:s&&nn(s),scopeId:Gt,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:a,patchFlag:t,dynamicProps:o,dynamicChildren:null,appContext:null,ctx:je};return r?(et(c,n),a&128&&e.normalize(c)):n&&(c.shapeFlag|=Q(n)?8:16),_s>0&&!i&&_e&&(c.patchFlag>0||a&6)&&c.patchFlag!==32&&_e.push(c),c}const ce=Vi;function Vi(e,s=null,n=null,t=0,o=null,a=!1){if((!e||e===li)&&(e=Se),Xn(e)){const r=Be(e,s,!0);return n&&et(r,n),_s>0&&!a&&_e&&(r.shapeFlag&6?_e[_e.indexOf(e)]=r:_e.push(r)),r.patchFlag|=-2,r}if(rr(e)&&(e=e.__vccOpts),s){s=$i(s);let{class:r,style:c}=s;r&&!Q(r)&&(s.class=gs(r)),B(c)&&(Rt(c)&&!k(c)&&(c=ee({},c)),s.style=fn(c))}const i=Q(e)?1:pi(e)?128:Li(e)?64:B(e)?4:q(e)?2:0;return se(e,s,n,t,o,i,a,!0)}function $i(e){return e?Rt(e)||sn in e?ee({},e):e:null}function Be(e,s,n=!1){const{props:t,ref:o,patchFlag:a,children:i}=e,r=s?Ki(t||{},s):t;return{__v_isVNode:!0,__v_skip:!0,type:e.type,props:r,key:r&&qo(r),ref:s&&s.ref?n&&o?k(o)?o.concat(nn(s)):[o,nn(s)]:nn(s):o,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:i,target:e.target,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:s&&e.type!==ve?a===-1?16:a|16:a,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:e.transition,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Be(e.ssContent),ssFallback:e.ssFallback&&Be(e.ssFallback),el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce}}function tn(e=" ",s=0){return ce(Xs,null,e,s)}function Gi(e,s){const n=ce(Qs,null,e);return n.staticCount=s,n}function Qn(e="",s=!1){return s?(me(),en(Se,null,e)):ce(Se,null,e)}function De(e){return e==null||typeof e=="boolean"?ce(Se):k(e)?ce(ve,null,e.slice()):typeof e=="object"?Ue(e):ce(Xs,null,String(e))}function Ue(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Be(e)}function et(e,s){let n=0;const{shapeFlag:t}=e;if(s==null)s=null;else if(k(s))n=16;else if(typeof s=="object")if(t&65){const o=s.default;o&&(o._c&&(o._d=!1),et(e,o()),o._c&&(o._d=!0));return}else{n=32;const o=s._;!o&&!(sn in s)?s._ctx=je:o===3&&je&&(je.slots._===1?s._=1:(s._=2,e.patchFlag|=1024))}else q(s)?(s={default:s,_ctx:je},n=32):(s=String(s),t&64?(n=16,s=[tn(s)]):n=8);e.children=s,e.shapeFlag|=n}function Ki(...e){const s={};for(let n=0;n<e.length;n++){const t=e[n];for(const o in t)if(o==="class")s.class!==t.class&&(s.class=gs([s.class,t.class]));else if(o==="style")s.style=fn([s.style,t.style]);else if(Ns(o)){const a=s[o],i=t[o];i&&a!==i&&!(k(a)&&a.includes(i))&&(s[o]=a?[].concat(a,i):i)}else o!==""&&(s[o]=t[o])}return s}function Ne(e,s,n,t=null){be(e,s,7,[n,t])}const Zi=yo();let Xi=0;function Qi(e,s,n){const t=e.type,o=(s?s.appContext:e.appContext)||Zi,a={uid:Xi++,vnode:e,type:t,parent:s,appContext:o,root:null,next:null,subTree:null,effect:null,update:null,scope:new wa(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:s?s.provides:Object.create(o.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:jo(t,o),emitsOptions:$t(t,o),emit:null,emitted:null,propsDefaults:W,inheritAttrs:t.inheritAttrs,ctx:W,data:W,props:W,attrs:W,slots:W,refs:W,setupState:W,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return a.ctx={_:a},a.root=s?s.root:a,a.emit=ti.bind(null,a),e.ce&&e.ce(a),a}let oe=null;const er=()=>oe||je;let on,st;{const e=ft(),s=(n,t)=>{let o;return(o=e[n])||(o=e[n]=[]),o.push(t),a=>{o.length>1?o.forEach(i=>i(a)):o[0](a)}};on=s("__VUE_INSTANCE_SETTERS__",n=>oe=n),st=s("__VUE_SSR_SETTERS__",n=>an=n)}const Ts=e=>{const s=oe;return on(e),e.scope.on(),()=>{e.scope.off(),on(s)}},Io=()=>{oe&&oe.scope.off(),on(null)};function Oo(e){return e.vnode.shapeFlag&4}let an=!1;function sr(e,s=!1){s&&st(s);const{props:n,children:t}=e.vnode,o=Oo(e);Pi(e,n,o,s),Fi(e,t);const a=o?nr(e,s):void 0;return s&&st(!1),a}function nr(e,s){const n=e.type;e.accessCache=Object.create(null),e.proxy=Ft(new Proxy(e.ctx,xi));const{setup:t}=n;if(t){const o=e.setupContext=t.length>1?or(e):null,a=Ts(e);Re();const i=ze(t,e,0,[e.props,o]);if(Fe(),a(),dt(i)){if(i.then(Io,Io),s)return i.then(r=>{zo(e,r,s)}).catch(r=>{Hs(r,e,0)});e.asyncDep=i}else zo(e,i,s)}else Po(e,s)}function zo(e,s,n){q(s)?e.type.__ssrInlineRender?e.ssrRender=s:e.render=s:B(s)&&(e.setupState=Yt(s)),Po(e,n)}let Eo;function Po(e,s,n){const t=e.type;if(!e.render){if(!s&&Eo&&!t.render){const o=t.template||Wn(e).template;if(o){const{isCustomElement:a,compilerOptions:i}=e.appContext.config,{delimiters:r,compilerOptions:c}=t,u=ee(ee({isCustomElement:a,delimiters:r},i),c);t.render=Eo(o,u)}}e.render=t.render||ye}{const o=Ts(e);Re();try{ki(e)}finally{Fe(),o()}}}function tr(e){return e.attrsProxy||(e.attrsProxy=new Proxy(e.attrs,{get(s,n){return ue(e,"get","$attrs"),s[n]}}))}function or(e){const s=n=>{e.exposed=n||{}};return{get attrs(){return tr(e)},slots:e.slots,emit:e.emit,expose:s}}function nt(e){if(e.exposed)return e.exposeProxy||(e.exposeProxy=new Proxy(Yt(Ft(e.exposed)),{get(s,n){if(n in s)return s[n];if(n in ws)return ws[n](e)},has(s,n){return n in s||n in ws}}))}const ar=/(?:^|[-_])(\w)/g,ir=e=>e.replace(ar,s=>s.toUpperCase()).replace(/[-_]/g,"");function Co(e,s=!0){return q(e)?e.displayName||e.name:e.name||s&&e.__name}function Ro(e,s,n=!1){let t=Co(s);if(!t&&s.__file){const o=s.__file.match(/([^/\\]+)\.\w+$/);o&&(t=o[1])}if(!t&&e&&e.parent){const o=a=>{for(const i in a)if(a[i]===s)return i};t=o(e.components||e.parent.type.components)||o(e.appContext.components)}return t?ir(t):n?"App":"Anonymous"}function rr(e){return q(e)&&"__vccOpts"in e}const lr=(e,s)=>Ba(e,s,an);function cr(e,s,n){const t=arguments.length;return t===2?B(s)&&!k(s)?Xn(s)?ce(e,null,[s]):ce(e,s):ce(e,null,s):(t>3?n=Array.prototype.slice.call(arguments,2):t===3&&Xn(n)&&(n=[n]),ce(e,s,n))}const pr="3.4.19";/**
* @vue/runtime-dom v3.4.19
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const ur="http://www.w3.org/2000/svg",dr="http://www.w3.org/1998/Math/MathML",Le=typeof document<"u"?document:null,Fo=Le&&Le.createElement("template"),hr={insert:(e,s,n)=>{s.insertBefore(e,n||null)},remove:e=>{const s=e.parentNode;s&&s.removeChild(e)},createElement:(e,s,n,t)=>{const o=s==="svg"?Le.createElementNS(ur,e):s==="mathml"?Le.createElementNS(dr,e):Le.createElement(e,n?{is:n}:void 0);return e==="select"&&t&&t.multiple!=null&&o.setAttribute("multiple",t.multiple),o},createText:e=>Le.createTextNode(e),createComment:e=>Le.createComment(e),setText:(e,s)=>{e.nodeValue=s},setElementText:(e,s)=>{e.textContent=s},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Le.querySelector(e),setScopeId(e,s){e.setAttribute(s,"")},insertStaticContent(e,s,n,t,o,a){const i=n?n.previousSibling:s.lastChild;if(o&&(o===a||o.nextSibling))for(;s.insertBefore(o.cloneNode(!0),n),!(o===a||!(o=o.nextSibling)););else{Fo.innerHTML=t==="svg"?`<svg>${e}</svg>`:t==="mathml"?`<math>${e}</math>`:e;const r=Fo.content;if(t==="svg"||t==="mathml"){const c=r.firstChild;for(;c.firstChild;)r.appendChild(c.firstChild);r.removeChild(c)}s.insertBefore(r,n)}return[i?i.nextSibling:s.firstChild,n?n.previousSibling:s.lastChild]}},We="transition",As="animation",xs=Symbol("_vtc"),tt=(e,{slots:s})=>cr(fi,mr(e),s);tt.displayName="Transition";const Mo={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};tt.props=ee({},no,Mo);const ss=(e,s=[])=>{k(e)?e.forEach(n=>n(...s)):e&&e(...s)},Yo=e=>e?k(e)?e.some(s=>s.length>1):e.length>1:!1;function mr(e){const s={};for(const _ in e)_ in Mo||(s[_]=e[_]);if(e.css===!1)return s;const{name:n="v",type:t,duration:o,enterFromClass:a=`${n}-enter-from`,enterActiveClass:i=`${n}-enter-active`,enterToClass:r=`${n}-enter-to`,appearFromClass:c=a,appearActiveClass:u=i,appearToClass:d=r,leaveFromClass:y=`${n}-leave-from`,leaveActiveClass:w=`${n}-leave-active`,leaveToClass:A=`${n}-leave-to`}=e,P=gr(o),D=P&&P[0],U=P&&P[1],{onBeforeEnter:M,onEnter:ae,onEnterCancelled:C,onLeave:Y,onLeaveCancelled:Z,onBeforeAppear:O=M,onAppear:pe=ae,onAppearCancelled:I=C}=s,X=(_,G,ge)=>{ns(_,G?d:r),ns(_,G?u:i),ge&&ge()},L=(_,G)=>{_._isLeaving=!1,ns(_,y),ns(_,A),ns(_,w),G&&G()},re=_=>(G,ge)=>{const ks=_?pe:ae,ne=()=>X(G,_,ge);ss(ks,[G,ne]),Ho(()=>{ns(G,_?c:a),Ve(G,_?d:r),Yo(ks)||Bo(G,t,D,ne)})};return ee(s,{onBeforeEnter(_){ss(M,[_]),Ve(_,a),Ve(_,i)},onBeforeAppear(_){ss(O,[_]),Ve(_,c),Ve(_,u)},onEnter:re(!1),onAppear:re(!0),onLeave(_,G){_._isLeaving=!0;const ge=()=>L(_,G);Ve(_,y),br(),Ve(_,w),Ho(()=>{_._isLeaving&&(ns(_,y),Ve(_,A),Yo(Y)||Bo(_,t,U,ge))}),ss(Y,[_,ge])},onEnterCancelled(_){X(_,!1),ss(C,[_])},onAppearCancelled(_){X(_,!0),ss(I,[_])},onLeaveCancelled(_){L(_),ss(Z,[_])}})}function gr(e){if(e==null)return null;if(B(e))return[ot(e.enter),ot(e.leave)];{const s=ot(e);return[s,s]}}function ot(e){return ha(e)}function Ve(e,s){s.split(/\s+/).forEach(n=>n&&e.classList.add(n)),(e[xs]||(e[xs]=new Set)).add(s)}function ns(e,s){s.split(/\s+/).forEach(t=>t&&e.classList.remove(t));const n=e[xs];n&&(n.delete(s),n.size||(e[xs]=void 0))}function Ho(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let fr=0;function Bo(e,s,n,t){const o=e._endId=++fr,a=()=>{o===e._endId&&t()};if(n)return setTimeout(a,n);const{type:i,timeout:r,propCount:c}=yr(e,s);if(!i)return t();const u=i+"end";let d=0;const y=()=>{e.removeEventListener(u,w),a()},w=A=>{A.target===e&&++d>=c&&y()};setTimeout(()=>{d<c&&y()},r+1),e.addEventListener(u,w)}function yr(e,s){const n=window.getComputedStyle(e),t=P=>(n[P]||"").split(", "),o=t(`${We}Delay`),a=t(`${We}Duration`),i=Uo(o,a),r=t(`${As}Delay`),c=t(`${As}Duration`),u=Uo(r,c);let d=null,y=0,w=0;s===We?i>0&&(d=We,y=i,w=a.length):s===As?u>0&&(d=As,y=u,w=c.length):(y=Math.max(i,u),d=y>0?i>u?We:As:null,w=d?d===We?a.length:c.length:0);const A=d===We&&/\b(transform|all)(,|$)/.test(t(`${We}Property`).toString());return{type:d,timeout:y,propCount:w,hasTransform:A}}function Uo(e,s){for(;e.length<s.length;)e=e.concat(e);return Math.max(...s.map((n,t)=>Lo(n)+Lo(e[t])))}function Lo(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function br(){return document.body.offsetHeight}function jr(e,s,n){const t=e[xs];t&&(s=(s?[s,...t]:[...t]).join(" ")),s==null?e.removeAttribute("class"):n?e.setAttribute("class",s):e.className=s}const Wo=Symbol("_vod"),wr=Symbol(""),vr=/(^|;)\s*display\s*:/;function Jr(e,s,n){const t=e.style,o=Q(n),a=t.display;let i=!1;if(n&&!o){if(s&&!Q(s))for(const r in s)n[r]==null&&at(t,r,"");for(const r in n)r==="display"&&(i=!0),at(t,r,n[r])}else if(o){if(s!==n){const r=t[wr];r&&(n+=";"+r),t.cssText=n,i=vr.test(n)}}else s&&e.removeAttribute("style");Wo in e&&(e[Wo]=i?t.display:"",t.display=a)}const Vo=/\s*!important$/;function at(e,s,n){if(k(n))n.forEach(t=>at(e,s,t));else if(n==null&&(n=""),s.startsWith("--"))e.setProperty(s,n);else{const t=Sr(e,s);Vo.test(n)?e.setProperty(ls(t),n.replace(Vo,""),"important"):e[t]=n}}const $o=["Webkit","Moz","ms"],it={};function Sr(e,s){const n=it[s];if(n)return n;let t=Ae(s);if(t!=="filter"&&t in e)return it[s]=t;t=Os(t);for(let o=0;o<$o.length;o++){const a=$o[o]+t;if(a in e)return it[s]=a}return s}const Go="http://www.w3.org/1999/xlink";function _r(e,s,n,t,o){if(t&&s.startsWith("xlink:"))n==null?e.removeAttributeNS(Go,s.slice(6,s.length)):e.setAttributeNS(Go,s,n);else{const a=ja(s);n==null||a&&!yt(n)?e.removeAttribute(s):e.setAttribute(s,a?"":n)}}function Tr(e,s,n,t,o,a,i){if(s==="innerHTML"||s==="textContent"){t&&i(t,o,a),e[s]=n??"";return}const r=e.tagName;if(s==="value"&&r!=="PROGRESS"&&!r.includes("-")){e._value=n;const u=r==="OPTION"?e.getAttribute("value"):e.value,d=n??"";u!==d&&(e.value=d),n==null&&e.removeAttribute(s);return}let c=!1;if(n===""||n==null){const u=typeof e[s];u==="boolean"?n=yt(n):n==null&&u==="string"?(n="",c=!0):u==="number"&&(n=0,c=!0)}try{e[s]=n}catch{}c&&e.removeAttribute(s)}function Ar(e,s,n,t){e.addEventListener(s,n,t)}function xr(e,s,n,t){e.removeEventListener(s,n,t)}const Ko=Symbol("_vei");function kr(e,s,n,t,o=null){const a=e[Ko]||(e[Ko]={}),i=a[s];if(t&&i)i.value=t;else{const[r,c]=Dr(s);if(t){const u=a[s]=Ir(t,o);Ar(e,r,u,c)}else i&&(xr(e,r,i,c),a[s]=void 0)}}const Zo=/(?:Once|Passive|Capture)$/;function Dr(e){let s;if(Zo.test(e)){s={};let t;for(;t=e.match(Zo);)e=e.slice(0,e.length-t[0].length),s[t[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):ls(e.slice(2)),s]}let rt=0;const Nr=Promise.resolve(),qr=()=>rt||(Nr.then(()=>rt=0),rt=Date.now());function Ir(e,s){const n=t=>{if(!t._vts)t._vts=Date.now();else if(t._vts<=n.attached)return;be(Or(t,n.value),s,5,[t])};return n.value=e,n.attached=qr(),n}function Or(e,s){if(k(s)){const n=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{n.call(e),e._stopped=!0},s.map(t=>o=>!o._stopped&&t&&t(o))}else return s}const Xo=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,zr=(e,s,n,t,o,a,i,r,c)=>{const u=o==="svg";s==="class"?jr(e,t,u):s==="style"?Jr(e,n,t):Ns(s)?un(s)||kr(e,s,n,t,i):(s[0]==="."?(s=s.slice(1),!0):s[0]==="^"?(s=s.slice(1),!1):Er(e,s,t,u))?Tr(e,s,t,a,i,r,c):(s==="true-value"?e._trueValue=t:s==="false-value"&&(e._falseValue=t),_r(e,s,t,u))};function Er(e,s,n,t){if(t)return!!(s==="innerHTML"||s==="textContent"||s in e&&Xo(s)&&q(n));if(s==="spellcheck"||s==="draggable"||s==="translate"||s==="form"||s==="list"&&e.tagName==="INPUT"||s==="type"&&e.tagName==="TEXTAREA")return!1;if(s==="width"||s==="height"){const o=e.tagName;if(o==="IMG"||o==="VIDEO"||o==="CANVAS"||o==="SOURCE")return!1}return Xo(s)&&Q(n)?!1:s in e}const Pr=["ctrl","shift","alt","meta"],Cr={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,s)=>Pr.some(n=>e[`${n}Key`]&&!s.includes(n))},Rr=(e,s)=>{const n=e._withMods||(e._withMods={}),t=s.join(".");return n[t]||(n[t]=(o,...a)=>{for(let i=0;i<s.length;i++){const r=Cr[s[i]];if(r&&r(o,s))return}return e(o,...a)})},Fr=ee({patchProp:zr},hr);let Qo;function Mr(){return Qo||(Qo=Yi(Fr))}const Yr=(...e)=>{const s=Mr().createApp(...e),{mount:n}=s;return s.mount=t=>{const o=Br(t);if(!o)return;const a=s._component;!q(a)&&!a.render&&!a.template&&(a.template=o.innerHTML),o.innerHTML="";const i=n(o,!1,Hr(o));return o instanceof Element&&(o.removeAttribute("v-cloak"),o.setAttribute("data-v-app","")),i},s};function Hr(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function Br(e){return Q(e)?document.querySelector(e):e}const rn=(e,s)=>{const n=e.__vccOpts||e;for(const[t,o]of s)n[t]=o;return n},Ur=Hn({props:{report:{type:String,required:!0}},methods:{createIssue(){const e=new FormData(this.$refs.issueForm),s=e.get("title");let n="";const t=e.get("description");t&&(n+=`**Description**
${t}
...
`,options:[{id:"serialization",page:335,label:"Serialization",summary:"The issue concerns serialization"},{id:"deserialization",page:283,label:"Deserialization",summary:"The issue concerns deserialization"}]},{content:`<p>What is the value of <code>DeserializationError</code>?</p>
`,options:[{id:"ok",page:300,label:"<code>Ok</code>",summary:"`deserializeJson()` returns `Ok`"},{id:"emptyinput",page:289,label:"<code>EmptyInput</code>",summary:"`deserializeJson()` returns `EmptyInput`"},{id:"incompleteinput",page:293,label:"<code>IncompleteInput</code>",summary:"`deserializeJson()` returns `IncompleteInput`"},{id:"invalidinput",page:297,label:"<code>InvalidInput</code>",summary:"`deserializeJson()` returns `InvalidInput`"},{id:"nomemory",page:323,label:"<code>NoMemory</code>",summary:"`deserializeJson()` returns `NoMemory`"},{id:"toodeep",page:216,label:"<code>TooDeep</code>",summary:"`deserializeJson()` returns `TooDeep`"},{id:"crash",page:285,label:"I can't tell because the program crashes",summary:"The program crashes"},{id:"unknown",page:284,label:"I don't know what you're talking about",summary:"The program doesn't check the error"}]},{content:`<p><code>DeserializationError</code> is the return type of <code>deserializeJson()</code>. It tells whether the operation succeeded and indicates the cause of the error.</p>
<p>Modify your program to show the error code, like so:</p>
<pre><code class="hljs language-c++">DeserializationError error = <span class="hljs-built_in">deserializeJson</span>(doc, input);
...
<p>How many traces can you see in the Serial Monitor?</p>
`,options:[{id:"before",page:287,label:"None: program crashes before calling <code>deserializeJson()</code>",summary:"Program crashes before calling `deserializeJson()`"},{id:"inside",page:288,label:"Only one: program crashes inside <code>deserializeJson()</code>",summary:"Program crashes inside `deserializeJson()`"},{id:"after",page:286,label:"Two traces: program crashes after calling <code>deserializeJson()</code>",summary:"Program crashes after calling `deserializeJson()`"}]},{content:`<p>A programs can also crash after calling <code>deserializeJson()</code> because it keeps a pointer to a string stored in the <code>JsonDocument</code>.</p>
<p>Indeed, when <code>JsonDocument</code> returns a <code>const char*</code>, it doesn't return a copy of the string, but the address of the string in the memory pool. When the <code>JsonDocument</code> is destructed, the memory pool gets released and the pointer dangles. Later, when the program tries to use the string, it reads at an invalid memory location and crashes.</p>
<p>For example, it happens with the following program:</p>
<pre><code class="hljs language-c++"><span class="hljs-type">const</span> <span class="hljs-type">char</span>* username;
...
<p>Please review your code to make sure you're not passsing a dangling pointer to <code>deserializeJson()</code>.</p>
<p>Does your program still crash?</p>
`,options:[{id:"no-dangling-ptr",page:287,label:"Yes",summary:"Removing dangling pointers doesn't prevent the crash"},{id:"success",page:2,label:"No",summary:"Removing dangling pointers prevents the crash"}]},{content:`<p><code>EmptyInput</code> means that the input was empty or contained only spaces or comments.</p>
<p>Where does your JSON input come from?</p>
`,options:[{id:"http",page:109,label:"An HTTP response",summary:"Input comes from an HTTP response"},{id:"file",page:290,label:"A file",summary:"Input comes from a file"},{id:"serial",page:292,label:"A serial port",summary:"Input comes from a serial port"},{id:"other",page:116,label:"Something else",summary:"Input comes neither from an HTTP response, nor a file, nor a serial port"}]},{content:`<p><code>EmptyInput</code> in the context of a file usually means:</p>
<ul>
<li>the file is closed</li>
<li>the file is opened in the wrong mode</li>
<li>the file is empty</li>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Adding a wait loop fixes the issue"},{id:"available",page:291,label:"No",summary:"Adding a wait loop doesn't fix the issue"}]},{content:`<p><code>IncompleteInput</code> means that <code>deserializeJson()</code> managed to parse the beginning of the JSON document, but the end was missing.</p>
<p>What type of input do you pass to <code>deserializeJson()</code>?</p>
`,options:[{id:"stream",page:122,label:"A stream",summary:"Input comes from a stream"},{id:"string",page:294,label:"A string object (like <code>String</code>)",summary:"Input comes from a string object"},{id:"pointer",page:295,label:"A pointer (like <code>char*</code> or <code>const char*</code>)",summary:"Input comes from a pointer"}]},{content:`<p>Please print the content of the string to the serial port, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(input);
</code></pre>
<p>You should see that the JSON document is truncated.
This can be caused by a lack of RAM: the string object failed to allocate a buffer large enough for the whole document.</p>
...
<p>Hopefully, you'll be able to reserve a buffer large enough to store the whole string.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:2,label:"Yes",summary:"Calling `String::reserve()` solves the issue"},{id:"1",page:296,label:"No",summary:"Calling `String::reserve()` doesn't solve the issue"}]},{content:`<p>I'll assume that your input is stored in a buffer similar to this one:</p>
<pre><code class="hljs language-c++"><span class="hljs-type">char</span> input[<span class="hljs-number">1024</span>];
<span class="hljs-type">size_t</span> input_size;
</code></pre>
<p>Please print the content of the string to the serial port, like so:</p>
...
<p>Please increase the capacity of the buffer, but remember that the size of the stack is limited so you may need to move your buffer to the heap.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"0",page:2,label:"Yes",summary:"Increasing the buffer size solves the issue"},{id:"1",page:296,label:"No",summary:"Increasing the buffer size doesn't solve the issue"}]},{content:`<p>To reduce the memory usage, you should try to pass the source (file, connection, stream, etc) directly to <code>deserializeJson()</code>, either via the <a href="https://www.arduino.cc/reference/en/language/functions/communication/stream/"><code>Stream</code></a> interface or via a <a href="/news/2019/11/01/version-6-13-0/">custom reader</a>. This will avoid the need for an intermediate buffer.</p>
<p>Additionaly, you can add a <a href="/news/2020/03/22/version-6-15-0/">filter</a> to remove all unneeded information from the <code>JsonDocument</code>.</p>
<p>You can see examples here:</p>
<ul>
...
`,options:[{id:"software",page:160,label:"Yes",summary:"Program uses `SoftwareSerial`"},{id:"hardware",page:298,label:"No",summary:"Program doesn't use `SoftwareSerial`"}]},{content:`<p>So, what's the problem then?</p>
`,options:[{id:"slow",page:194,label:"It's slow",summary:"Deserialisation is slow"},{id:"invalid",page:169,label:"I expected <code>InvalidInput</code> instead of <code>Ok</code>",summary:"`Ok` is incorrect; it should be `InvalidInput`"},{id:"crash",page:286,label:"My program crashes after calling <code>deserializeJson()</code>",summary:"Program crashes after calling `deserializeJson()`"},{id:"empty",page:301,label:"<code>JsonDocument</code> returns empty/null values",summary:"Program fails to extract values from the `JsonDocument`"},{id:"truncated-strings",page:195,label:"Some strings are truncated",summary:"Some strings are truncated"}]},{content:`<p>Do you use a filter (with <code>DeserializationOption::Filter</code>)?</p>
`,options:[{id:"filter",page:303,label:"Yes",summary:"Program uses `DeserializationOption::Filter`"},{id:"no-filter",page:308,label:"No",summary:"Program doesn't use `DeserializationOption::Filter`"}]},{content:`<p>When a program fails to extract the values from a <code>JsonDocument</code>, it's often because of confusion between arrays and objects.</p>
<p>For example, a common mistake is to write:</p>
<pre><code class="hljs language-c++"><span class="hljs-type">const</span> <span class="hljs-type">char</span>* temperature = doc[<span class="hljs-string">&quot;list&quot;</span>][<span class="hljs-string">&quot;main&quot;</span>][<span class="hljs-string">&quot;temp&quot;</span>];
</code></pre>
<p>instead of</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"The issue is confusion between array and object"},{id:"array-object",page:312,label:"No",summary:"The issue is not confusion between array and object"}]},{content:`<p>Please print the value of <code>JsonDocument::overflowed()</code>, like so:</p>
...
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:305,label:"<code>1</code> (or <code>true</code>)",summary:"`filter.overflowed()` returns `true`"},{id:"overflowed-0",page:304,label:"<code>0</code> (or <code>false</code>)",summary:"`filter.overflowed()` returns `false`"}]},{content:`<p>Maybe the filter excludes the part that it should keep. Let's verify that it's doing its job correctly.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Freeing some memory solves the issue."},{id:"failure",page:304,label:"No",summary:"Freeing some memory doesn't solve the issue."}]},{content:`<p>Which function do you call to deserialize the input?</p>
`,options:[{id:"json",page:1,label:"<code>deserializeJson()</code>",summary:"Program calls `deserializeJson()`"},{id:"msgpack",page:307,label:"<code>deserializeMsgPack()</code>",summary:"Program calls `deserializeMsgPack()`"}]},{content:`<p>It seems that your program fed <code>deserializeMsgPack()</code> with garbage input.</p>
<p>Indeed, any byte in the following ranges is a valid one-byte MessagePack document:</p>
<ul>
<li><code>0x00</code>-<code>0x7f</code>: positive fixint</li>
<li><code>0xc0</code>: nil</li>
...
<p>What's the first character?</p>
`,options:[{id:"quote",page:311,label:"A quote (<code>&quot;</code>)",summary:"Serialized document starts with a quote"},{id:"bracket",page:302,label:"A square bracket (<code>[</code>)",summary:"Serialized document starts with a square bracket"},{id:"brace",page:302,label:"A curly brace (<code>{</code>)",summary:"Serialized document starts with a curly brace"},{id:"not-in-list",page:306,label:"None of the above",summary:"Serialized document starts with neither a quote, a bracket, nor a brace."}]},{content:`<p>If you cannot fix the server, you can at least reverse the double serialization (stringification) to get back the original object.</p>
<p>To do this, you must call <code>deserializeJson()</code> twice, like so:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Fixing the server fixes the issue"},{id:"server-ok",page:309,label:"No",summary:"Fixing the server doesn't fix the issue"}]},{content:`<p>If you see a double-quote at the beginning of the JSON input, it means that the whole document is neither an object or an array; it's a string. This happens when the input was incorrectly generated, by serializing (stringifying) to JSON twice.</p>
<p>For example, the following document:</p>
<pre><code class="hljs language-json"><span class="hljs-string">&quot;{\\&quot;hello\\&quot;:\\&quot;world\\&quot;}&quot;</span>
</code></pre>
<p>...is not a JSON <em>object</em> but a <em>string</em>.
...
<p>So, the bug isn't in the Arduino code, but on the other size, most likely a server.</p>
<p>Can you modify the code of the server?</p>
`,options:[{id:"server-fixable",page:310,label:"Yes",summary:"User can modify the server"},{id:"server-unfixable",page:309,label:"No",summary:"User cannot modify the server"}]},{content:`<p>What type of value are you trying to read?</p>
`,options:[{id:"bool",page:1,label:"<code>bool</code>",summary:"The program fails to extract a `bool` value"},{id:"const-char-ptr",page:1,label:"<code>const char*</code>",summary:"The program fails to extract a `const char*` value"},{id:"double",page:1,label:"<code>double</code>",summary:"The program fails to extract a `double` value"},{id:"float",page:1,label:"<code>float</code>",summary:"The program fails to extract a `float` value"},{id:"int",page:1,label:"<code>int</code>",summary:"The program fails to extract an `int` value"},{id:"int8",page:317,label:"<code>int8_t</code>",summary:"The program fails to extract an `int8_t` value"},{id:"int16",page:315,label:"<code>int16_t</code>",summary:"The program fails to extract an `int16_t` value"},{id:"int32",page:316,label:"<code>int32_t</code>",summary:"The program fails to extract an `int32_t` value"},{id:"int64",page:1,label:"<code>int64_t</code>",summary:"The program fails to extract an `int64_t` value"},{id:"long",page:316,label:"<code>long</code>",summary:"The program fails to extract a `long` value"},{id:"long-long",page:1,label:"<code>long long</code>",summary:"The program fails to extract a `long long` value"},{id:"short",page:315,label:"<code>short</code>",summary:"The program fails to extract a `short` value"},{id:"signed-char",page:317,label:"<code>signed char</code>",summary:"The program fails to extract a `signed char` value"},{id:"signed-int",page:315,label:"<code>signed int</code>",summary:"The program fails to extract a `signed int` value"},{id:"signed-long",page:316,label:"<code>signed long</code>",summary:"The program fails to extract a `signed long` value"},{id:"signed-long-long",page:1,label:"<code>signed long long</code>",summary:"The program fails to extract a `signed long long` value"},{id:"signed-short",page:315,label:"<code>signed short</code>",summary:"The program fails to extract a `signed short` value"},{id:"std-string",page:1,label:"<code>std::string</code>",summary:"The program fails to extract a `std::string` value"},{id:"uint8",page:322,label:"<code>uint8_t</code>",summary:"The program fails to extract a `uint8_t` value"},{id:"uint16",page:320,label:"<code>uint16_t</code>",summary:"The program fails to extract a `uint16_t` value"},{id:"uint32",page:320,label:"<code>uint32_t</code>",summary:"The program fails to extract a `uint32_t` value"},{id:"uint64",page:1,label:"<code>uint64_t</code>",summary:"The program fails to extract a `uint64_t` value"},{id:"unsigned-char",page:322,label:"<code>unsigned char</code>",summary:"The program fails to extract an `unsigned char` value"},{id:"unsigned-int",page:321,label:"<code>unsigned int</code>",summary:"The program fails to extract an `unsigned int` value"},{id:"unsigned-long",page:321,label:"<code>unsigned long</code>",summary:"The program fails to extract an `unsigned long` value"},{id:"unsigned-long-long",page:1,label:"<code>unsigned long long</code>",summary:"The program fails to extract an `unsigned long long` value"},{id:"unsigned-short",page:320,label:"<code>unsigned short</code>",summary:"The program fails to extract an `unsigned short` value"},{id:"array",page:314,label:"<code>JsonArray</code>",summary:"The program fails to extract a `JsonArray`"},{id:"object",page:319,label:"<code>JsonObject</code>",summary:"The program fails to extract a `JsonObject`"},{id:"other",page:1,label:"None of the above",summary:"The type of the extracted value is not listed"}]},{content:`<p><code>to&lt;JsonArray&gt;()</code> replaces the existing value with a new empty array.</p>
...
`,options:[{id:"implicit",page:1,label:"<code>JsonObject object = doc[&quot;key&quot;];</code>",summary:"The program uses implicit conversion to `JsonObject`"},{id:"as",page:1,label:"<code>doc[&quot;key&quot;].as&lt;JsonObject&gt;()</code>",summary:"The program uses `as<JsonObject>()`"},{id:"to",page:318,label:"<code>doc[&quot;key&quot;].to&lt;JsonObject&gt;()</code>",summary:"The program uses `to<JsonObject>()`"}]},{content:`<p>This type can only store values between 0 and 65,535.<br>
If you try to extract a value outside this range, ArduinoJson will return 0.<br>
If that's your case, you must use a larger integer type.</p>
<p>Did this solve your issue?</p>
...
`,options:[{id:"jsonarray",page:324,label:"<code>JsonArray</code>",summary:"The first argument of `deserializeJson()` is a `JsonArray`"},{id:"jsondocument",page:327,label:"<code>JsonDocument</code>",summary:"The first argument of `deserializeJson()` is a `JsonDocument`"},{id:"jsonobject",page:325,label:"<code>JsonObject</code>",summary:"The first argument of `deserializeJson()` is a `JsonObject`"},{id:"jsonvariant",page:326,label:"<code>JsonVariant</code>",summary:"The first argument of `deserializeJson()` is a `JsonVariant`"}]},{content:`<p>You can pass a <code>JsonArray</code> as the first argument of <code>deserializeJson()</code>, but it has to point to an existing array.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Initializing the array fixes the issue"},{id:"server-ok",page:327,label:"No",summary:"Initializing the array doesn't fix the issue"}]},{content:`<p>You can pass a <code>JsonObject</code> as the first argument of <code>deserializeJson()</code>, but it has to point to an existing object.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Initializing the variant fixes the issue"},{id:"server-ok",page:327,label:"No",summary:"Initializing the variant doesn't fix the issue"}]},{content:`<p>Let's check with the <a href="/v7/assistant/">ArduinoJson Assistant</a> to see if you have enough memory for your JSON document.</p>
<ol>
...
`,options:[{id:"loose",page:328,label:"There is a lot more memory than required",summary:"The Assistant says there is a lot more memory than required."},{id:"tight",page:329,label:"There should be enough memory",summary:"The Assistant says there should be just enough memory."},{id:"too-small",page:334,label:"There is not enough memory",summary:"The Assistant says there is not enough memory."}]},{content:`<p>What CPU architecture is this code running on?</p>
`,options:[{id:"8-bit",page:330,label:"8-bit",summary:"The code is running on an 8-bit CPU"},{id:"32-bit",page:331,label:"32-bit",summary:"The code is running on a 32-bit CPU"},{id:"64-bit",page:333,label:"64-bit",summary:"The code is running on a 64-bit CPU"}]},{content:`<p>This means that ArduinoJson couldn't allocate enough memory for the JSON document.<br>
So you must free some memory.</p>
<p>See <a href="/v7/how-to/reduce-memory-usage/">How to reduce memory usage?</a> for some tips.</p>
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Freeing some memory solves the issue."},{id:"failure",page:334,label:"No",summary:"Freeing some memory doesn't solve the issue."}]},{content:`<p>Due to an optimization, a <code>JsonDocument</code> can only contain up to 255 nodes on an 8-bit CPU.
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Setting `ARDUINOJSON_SLOT_ID_SIZE` to 2 solves the issue."},{id:"slot-id-size-2",page:332,label:"No",summary:"Setting `ARDUINOJSON_SLOT_ID_SIZE` to 2 doesn't solve the issue."},{id:"fewer-than-255",page:332,label:"My JSON document contains fewer than 255 nodes",summary:"The JSON document contains fewer than 255 nodes."}]},{content:`<p>Due to an optimization, a <code>JsonDocument</code> can only contain up to 65,535 nodes on a 32-bit CPU.
A node is a value, a key, or a member of an array.</p>
<p>You can push this limit by increasing <code>ARDUINOJSON_SLOT_ID_SIZE</code>, like so:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Setting `ARDUINOJSON_SLOT_ID_SIZE` to 4 solves the issue."},{id:"slot-id-size-2",page:333,label:"No",summary:"Setting `ARDUINOJSON_SLOT_ID_SIZE` to 4 doesn't solve the issue."},{id:"fewer-than-255",page:333,label:"My JSON document contains fewer than 65,535 nodes",summary:"The JSON document contains fewer than 65,535 nodes."}]},{content:`<p>Due to another optimization, strings in a <code>JsonDocument</code> can only contain up to 255 characters on an 8-bit CPU.</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Setting `ARDUINOJSON_STRING_LENGTH_SIZE` to 2 solves the issue"},{id:"string-length-size-2",page:329,label:"No",summary:"Setting `ARDUINOJSON_STRING_LENGTH_SIZE` to 2 doesn't solve the issue"},{id:"fewer-than-255",page:329,label:"No string contains more than 255 characters",summary:"No string contains more than 255 characters"}]},{content:`<p>Due to another optimization, strings in a <code>JsonDocument</code> can only contain up to 65,535 characters.</p>
<p>You can push this limit by increasing <code>ARDUINOJSON_STRING_LENGTH_SIZE</code>, like so:</p>
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Setting `ARDUINOJSON_STRING_LENGTH_SIZE` to 4 solves the issue"},{id:"string-length-size-4",page:329,label:"No",summary:"Setting `ARDUINOJSON_STRING_LENGTH_SIZE` to 4 doesn't solve the issue"},{id:"fewer-than-255",page:329,label:"No string contains more than 65,535 characters",summary:"No string contains more than 65,535 characters"}]},{content:`<p class="display-4">☹️</p>
...
`,options:[{id:"crash",page:227,label:"The program crashes",summary:"Program crashes"},{id:"empty",page:336,label:"The output is empty (e.g. <code>{}</code>, <code>[]</code>, or <code>null</code>)",summary:"Output is empty"},{id:"incomplete",page:345,label:"The output is incomplete",summary:"Output is incomplete"},{id:"garbage",page:337,label:"The output contains garbage",summary:"Output contains garbage"},{id:"null",page:345,label:"The output contains <code>null</code>",summary:"Output contains null"},{id:"float",page:238,label:"Floating-point values contain too many decimal digits",summary:"Floating-point values contain too many decimal digits"},{id:"slow",page:270,label:"It's slow",summary:"Serialization is slow"}]},{content:`<p>Please print the value of <code>JsonDocument::overflowed()</code>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
...
`,options:[{id:"json",page:339,label:"<code>serializeJson()</code> (or <code>serializeJsonPretty()</code>)",summary:"`serializeJson()` produces garbage"},{id:"msg",page:344,label:"<code>serializeMsgPack()</code>",summary:"`serializeMsgPack()` produces garbage"}]},{content:`<p>Do you use <a href="https://www.arduino.cc/reference/en/language/variables/data-types/stringobject/"><code>String</code></a> in your program?</p>
...
`,options:[{id:"document",page:338,label:"<code>JsonDocument</code>",summary:"Program calls `serializeJson(const JsonDocument&, ...)`"},{id:"array",page:340,label:"<code>JsonArray</code> (or <code>JsonArrayConst</code>)",summary:"Program calls `serializeJson(JsonArrayConst, ...)`"},{id:"object",page:341,label:"<code>JsonObject</code> (or <code>JsonObjectConst</code>)",summary:"Program calls `serializeJson(JsonObjectConst, ...)`"},{id:"variant",page:342,label:"<code>JsonVariant</code> (or <code>JsonVariantConst</code>)",summary:"Program calls `serializeJson(JsonVariantConst, ...)`"}]},{content:`<p><code>JsonArray</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonArray</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonArray <span class="hljs-title">createArray</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:338,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>JsonObject</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonObject</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonObject <span class="hljs-title">createObject</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:338,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>JsonVariant</code> doesn't contain any data: it is a reference to an object stored in the <code>JsonDocument</code>. It becomes invalid as soon as the <code>JsonDocument</code> is destroyed; this could explain the garbage you see in the output.</p>
<p>For example, here is a function that creates a dangling <code>JsonVariant</code>:</p>
<pre><code class="hljs language-c++"><span class="hljs-comment">// DON&#x27;T DO THAT!!!  💀</span>
<span class="hljs-function">JsonVariant <span class="hljs-title">createVariant</span><span class="hljs-params">()</span> </span>{
  JsonDocument doc;
...
<p>Did this solve your issue?</p>
`,options:[{id:"success",page:2,label:"Yes",summary:"Extending the lifetime of the `JsonDocument` solves the issue"},{id:"not-destroyed",page:338,label:"No",summary:"Extending the lifetime of the `JsonDocument` doesn't solve the issue"}]},{content:`<p><code>serializeMsgPack()</code> share a lot of code with <code>serializeJson()</code>. There is no reason you should produce garbage with one and not the other. You may have found a bug.</p>
`,tags:["needs_assistance"]},{content:`<p><a href="https://msgpack.org/">MessagePack</a> is a binary format, so if you print a document to the serial port, the result would look weird.</p>
<p>For example, the following program:</p>
<pre><code class="hljs language-c++">JsonDocument doc;
doc[<span class="hljs-string">&quot;val&quot;</span>] = <span class="hljs-number">42</span>;
...
<p>I need you to edit your program to replace <code>serializeMsgPack()</code> with <code>serializeJson()</code>.</p>
<p>Do you see the garbage in the JSON output?</p>
`,options:[{id:"json",page:339,label:"Yes, <code>serializeJson()</code> produces garbage too",summary:"`serializeJson()` produces garbage too"},{id:"deserialize-no",page:343,label:"No, <code>serializeJson()</code> doesn't produces garbage",summary:"`serializeJson()` doesn't produces garbage"}]},{content:`<p>Please print the value of <code>JsonDocument::overflowed()</code>, like so:</p>
<pre><code class="hljs language-c++">Serial.<span class="hljs-built_in">println</span>(doc.<span class="hljs-built_in">overflowed</span>());
</code></pre>
<p>What value does it print?</p>
`,options:[{id:"overflowed-1",page:327,label:"<code>1</code> (or <code>true</code>)",summary:"`JsonDocument::overflowed()` returns `true`"},{id:"overflowed-0",page:346,label:"<code>0</code> (or <code>false</code>)",summary:"`JsonDocument::overflowed()` returns `false`"}]},{content:`<p>Does one of the strings in the <code>JsonDocument</code> contains a NUL (i.e.,  ASCII code 0, or <code>\\u0000</code>)?</p>
