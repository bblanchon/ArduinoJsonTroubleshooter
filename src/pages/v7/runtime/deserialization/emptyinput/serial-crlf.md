...
If you use the default settings of the Arduino Serial Monitor, `err` will contains [`Ok`](/v7/api/misc/deserializationerror/#ok) and then `EmptyInput` each time you press "Send".
