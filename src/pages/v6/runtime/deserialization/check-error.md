...
[`DeserializationError`](/v6/api/misc/deserializationerror/) is the return type of `deserializeJson()`. It tells whether the operation succeeded and indicates the cause of the error.
